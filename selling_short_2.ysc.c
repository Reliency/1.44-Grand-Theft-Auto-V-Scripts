...
void func_31(int iParam0, int iParam1)//Position - 0x2698
{
	...
	*iParam0 = unk_0x1DAA351326EA3537(-7000f, -7000f, -100f, 7000f, 7000f, 315f, 0, 1, 1, 1);
	unk_0xD0FC9D284379BED4("DRIVE", false);
...
void func_36(bool bParam0, bool bParam1)//Position - 0x28B2
{
	if (bParam0)
	{
		if (func_37(0))
...
int func_37(int iParam0)//Position - 0x2926
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
void func_41(int iParam0)//Position - 0x2AB6
{
	...
	unk_0xD0FC9D284379BED4("DRIVE", true);
	unk_0x379ACE23D404525C(-7000f, -7000f, -100f, 7000f, 7000f, 315f, true, 1);
}

void func_42(char* sParam0)//Position - 0x2B19
{
	unk_0x4EA570997E107F35(sParam0);
}

void func_43(int iParam0)//Position - 0x2B27
{
	if (iParam0 != 0)
	{
...
void func_44(var uParam0)//Position - 0x2B3B
{
	...
	sVar1 = func_46(uParam0->f_10);
	sVar2 = func_45(uParam0->f_10);
	iVar0 = 0;
...
char* func_45(int iParam0)//Position - 0x2BB0
{
	char* sVar0;
...
char* func_46(int iParam0)//Position - 0x2BC6
{
	char* sVar0;
...
void func_47(var uParam0)//Position - 0x2BDB
{
	int iVar0;
...
void func_48(int iParam0)//Position - 0x2C27
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_49(var uParam0)//Position - 0x2C68
{
	int iVar0;
...
void func_50(int iParam0)//Position - 0x2C91
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
