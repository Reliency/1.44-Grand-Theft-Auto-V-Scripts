...
int func_1()//Position - 0x1F5
{
	...
	if ((SYSTEM::VDIST2(vVar0, vVar1) > 10000f || unk_0x1D403DFADBC2DE3C(iLocal_38, 0)) || func_4())
	{
		...
		case 0:
			if (unk_0x724D816EA203A79E(iLocal_38) && !unk_0x1D403DFADBC2DE3C(iLocal_38, 0))
			{
				if (unk_0x4DBCE270B354E123(iLocal_38, vLocal_49, 1f, 1f, 1f, 0, 1, 0))
				{
					...
					unk_0xA8E6405305C0D7DF(iLocal_38, uVar2);
					unk_0x02DAF06EA4F08219(&uVar2);
					iLocal_40 = 1;
				}
			}
			...
			if (unk_0x724D816EA203A79E(iLocal_38) && !unk_0x1D403DFADBC2DE3C(iLocal_38, 0))
			{
				if (unk_0xD62938026B30481A(iLocal_38) == 1)
				{
					if (!unk_0x724D816EA203A79E(iLocal_39))
					{
						...
						{
							fVar3 = unk_0x4A3B2CF8BADDD74E(iLocal_38, "amb@world_human_stand_mobile@female@standing@call@enter", "enter");
							if (fVar3 >= 0.157f)
							{
				...
				{
					iVar4 = (unk_0x491B2241281A03B7(0, 65535) % 2);
					if (iVar4 == 0)
					{
