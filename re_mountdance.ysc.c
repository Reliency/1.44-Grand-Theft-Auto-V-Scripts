...
void __EntryFunction__()//Position - 0x0
{
	...
	if (func_35(Global_19B04.f_4E78, 16384))
	{
		func_36(0);
	}
	while (true)
	{
		...
		{
			if (unk_0x1D403DFADBC2DE3C(iLocal_91, 0) && !iLocal_95 == 7)
			{
				func_34(&(Global_19B04.f_4E78), 16384);
				iLocal_95 = 7;
			}
		}
		switch (iLocal_95)
		{
			case 0:
				if ((unk_0x684B06333594F9EA() && !func_33()) && !func_12())
				{
					if (func_11())
					{
						iLocal_91 = unk_0x01B3635C3E8EDD81(26, iLocal_88, vLocal_89, fLocal_90, 1, true);
						unk_0x2E35C4FA5F0ED22F(iLocal_91, true);
						iLocal_92 = unk_0xB6896943DA475493(joaat("prop_tapeplayer_01"), 704.7615f, 4179.574f, 39.7093f, true, true, false);
						unk_0x019CE76D5286C95C(iLocal_92, (233.8288f + 180f));
						unk_0x70FF586D857F1A81(iLocal_91, 0, 0, 0, false);
						iLocal_95 = 1;
					}
				}
				else
			...
			case 1:
				iLocal_97 = unk_0xD0D858E538FD01C3(vLocal_89 + Vector(1f, 0f, 0f), 0f, 0f, fLocal_90, 2);
				unk_0xB62398E536F695FC(iLocal_91, iLocal_97, sLocal_94, "MTN_DNC_if_you_want_to_get_to_heaven", 2f, -2f, 1, 0, 1148846080, 0);
				unk_0xC8446EDF14113B5D("MNT_DNC", iLocal_91);
				iLocal_95 = 2;
				break;
			
			case 2:
				if (unk_0x03ED346BC98A5425(iLocal_97, "MNT_DNC") == 1)
				{
					unk_0x806EBB66B453AFC9(iLocal_97);
					iLocal_95 = 3;
				}
				break;
			
			case 3:
				vVar0 = { unk_0x541C2AEF053615BC(iLocal_91, true) };
				unk_0x4A506C72BFC368E4(iLocal_91, 3f);
				if (func_10(unk_0xBC25C936A095B5BA(), iLocal_91) < 10f)
				{
					unk_0x250AE0E1E9769BA5(unk_0xBC25C936A095B5BA(), 1, iLocal_91, 31086, 0f, 0f, 0f, 0, -1, -1);
					unk_0x250AE0E1E9769BA5(iLocal_91, 1, unk_0xBC25C936A095B5BA(), 31086, 0f, 0f, 0f, 0, -1, -1);
				}
				if (func_9(iLocal_91, unk_0xBC25C936A095B5BA(), 1) < 25f)
				{
					if (!unk_0x2DA8CA50A72528FB(iLocal_96))
					{
						func_5(&iLocal_96, &iLocal_91, 0);
						unk_0x0D5352939CC40C16(iLocal_96, 3);
					}
				}
				else if (unk_0x2DA8CA50A72528FB(iLocal_96))
				{
					func_4(&iLocal_96);
				}
				if (unk_0x8FD30584EB38411B(iLocal_97) > 0.9999999f)
				{
					iLocal_95 = 1;
				}
				if (unk_0x2CDE18D6C89522AD(iLocal_91))
				{
					unk_0xD2B06636F6ECC55F(iLocal_97);
					iLocal_95 = 4;
				}
				if (((((unk_0x36CEFBE9B745A58D(iLocal_91) || unk_0x04880508C862E589(vVar0, 50f, 1)) || unk_0x04880508C862E589(vVar0, 50f, 0)) || unk_0x876474582C5DECDE(vVar0, 20f, 20f, 20f, 0)) || unk_0xC9FA5D38428AB6BE(-1, vVar0, 50f)) || (((unk_0xDF25D3BB3759E7D1(unk_0xB5CEFD608600A09F(), iLocal_91) || unk_0x425BEBAA53B39EBF(unk_0xB5CEFD608600A09F(), iLocal_91)) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vVar0, true) < 25f) && func_1(iLocal_91, unk_0xBC25C936A095B5BA(), 1126825984, 0)))
				{
					unk_0xD2B06636F6ECC55F(iLocal_97);
					iLocal_95 = 4;
					iLocal_93 = 1;
			...
			case 4:
				...
				if (!unk_0x2CDE18D6C89522AD(iLocal_91))
				{
					if (iLocal_93 == 1)
					{
						unk_0x346129B364057FF6(iLocal_91, 723.1315f, 4171.957f, 39.7091f, 2f, -1, 1f, 1024, 1193033728);
					}
					else
					{
						unk_0x346129B364057FF6(iLocal_91, 723.1315f, 4171.957f, 39.7091f, 1f, -1, 1f, 1024, 1193033728);
					}
					unk_0x22321800954A532E(iLocal_91, true);
					iLocal_95 = 6;
				}
				break;
			
			case 6:
				if (unk_0xF4FCC3C1048FF2AB(iLocal_91, 713668775) != 1 && unk_0xF4FCC3C1048FF2AB(iLocal_91, 713668775) != 0)
				{
					unk_0x2E35C4FA5F0ED22F(iLocal_91, false);
					if (iLocal_93 == 1)
					{
						unk_0x5558ED6D4A2DEC93(iLocal_91, unk_0xBC25C936A095B5BA(), 100f, -1, 0, 0);
					}
					else
					{
						unk_0x8CE2798B9A7027EC(iLocal_91, 1193033728, 0);
					}
					unk_0x22321800954A532E(iLocal_91, true);
					iLocal_95 = 5;
				}
			...
			case 5:
				if ((unk_0x41A5D6415E2CC10E(iLocal_91) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(iLocal_91, true), unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), true) > 50f) && !unk_0x684B06333594F9EA())
				{
					func_36(1);
				}
				break;
...
int func_1(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x493
{
	...
	vVar0 = { func_3(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_3(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
int func_7(int iParam0, bool bParam1, bool bParam2)//Position - 0x632
{
	...
	{
		unk_0x3F5F1772D71D5EC4(iVar0, func_8(unk_0x7AF0088ABFA713B6(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x3F5F1772D71D5EC4(iVar0, func_8(unk_0x7AF0088ABFA713B6(), 0.7f, 0.7f));
		unk_0xF9C2945DB5BAB4BF(iVar0, bParam1);
	}
...
int func_11()//Position - 0x75C
{
	...
	unk_0x522053D86D6E1C7A(sLocal_94);
	if (unk_0xD6513D668481290A(iLocal_88) && unk_0xF9E082857622D91E(sLocal_94))
	{
		return 1;
	}
	return 0;
...
int func_12()//Position - 0x789
{
	...
	{
		if (SYSTEM::VMAG2(unk_0xB5D9AE572C19509E(unk_0xBC25C936A095B5BA())) > 1369f && !func_26())
		{
			return 0;
		}
	}
...
void func_20()//Position - 0x22E4
{
	...
	if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
	{
		if (func_23(Global_19B04.f_932.f_21B.f_10CD) != unk_0x6F79ECA8C83E4357(unk_0xBC25C936A095B5BA()))
		{
			...
			if (func_24(iVar0) && (!func_21(14) || Global_196EB))
			{
...
{
	return func_32(iParam0, Global_8C41);
}
...
void func_36(bool bParam0)//Position - 0x27AB
{
	...
	{
		unk_0xA35241BCE4C1A24B(&iLocal_92);
	}
	if (unk_0x2DA8CA50A72528FB(iLocal_96))
	{
		func_4(&iLocal_96);
	...
	if (unk_0x724D816EA203A79E(iLocal_91))
	{
		if (bParam0)
		{
			unk_0xF845620A03C7425B(&iLocal_91);
		}
		else
		{
			unk_0x02537C8C1BEEB477(&iLocal_91);
		}
	}
