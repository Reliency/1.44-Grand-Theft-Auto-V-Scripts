...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_301(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_284(&Var0, 1);
	}
	...
	if (Var0 == 4)
	{
		func_247(&uLocal_59, 3, Var0.f_1C[0], "BARRY", 0, 1);
	...
	while (true)
	{
		...
		if (func_196(Var0.f_1C[0]))
		{
			if (Var0 == 2)
			{
				if (func_194(&Var0, unk_0x541C2AEF053615BC(Var0.f_1C[0], true), "BARY1AU", "BARY1_PRELEA", 5, "BARRY", 10000, 23f))
				{
			...
			{
				if (func_194(&Var0, unk_0x541C2AEF053615BC(Var0.f_1C[0], true), "BARY2AU", "BARY2_AMB", 3, "BARRY", 10000, 23f))
				{
				}
			}
			else if (Var0 == 4)
			{
				func_183(&uLocal_58, unk_0x541C2AEF053615BC(Var0.f_1C[0], true), "BARR3AU", "BARRY3_AMB");
			}
		}
		iVar2 = 0;
		if (func_182(Var0))
		{
			if ((unk_0x105601648511CC64() - iLocal_54) > 5000)
			{
				iVar2 = 1;
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x621A
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6261
{
...
bool func_70(int iParam0)//Position - 0x62BC
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x62CC
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x632C
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6620
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x662B
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x663B
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x66DD
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6C97
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6CF5
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6DA3
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6E38
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6E7C
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x7000
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x700E
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7AD5
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7B57
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7BB5
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7BBE
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7D91
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7DA1
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x803C
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x804D
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x8093
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x8119
{
...
void func_94(var uParam0, int iParam1)//Position - 0x814C
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x819D
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x823F
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8264
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x827B
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x8288
{
...
void func_100(var uParam0, int iParam1)//Position - 0x82C2
{
...
void func_101(var uParam0, int iParam1)//Position - 0x82FD
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x8339
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x8352
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, var uParam1, int iParam2)//Position - 0x83AB
{
...
bool func_105(bool bParam0)//Position - 0x83ED
{
...
struct<2> func_106(int iParam0)//Position - 0x8418
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8865
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9B3D
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9E83
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9F27
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9FC2
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0xA020
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA079
{
...
int func_116(int iParam0)//Position - 0xA0FC
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA12D
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA142
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA1F5
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA210
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA25C
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA2A5
{
	if (func_196(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA2C5
{
	switch (iParam0)
	{
		case 5:
...
int func_126(int iParam0)//Position - 0xA395
{
	switch (iParam0)
	{
		case 5:
...
void func_127(var uParam0, bool bParam1, bool bParam2)//Position - 0xA3E8
{
	int iVar0;
...
void func_129(bool bParam0)//Position - 0xA548
{
	int iVar0;
...
void func_130(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA585
{
	if (bParam0)
	{
...
int func_133(int iParam0, bool bParam1)//Position - 0xA716
{
	int iVar0;
	int iVar1;
...
int func_134(int iParam0)//Position - 0xA757
{
...
bool func_135()//Position - 0xA799
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_136(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA7AA
{
	int iVar0;
...
void func_138(int iParam0)//Position - 0xA804
{
	if (iParam0 == 1)
	{
...
int func_139(char* sParam0)//Position - 0xA827
{
...
void func_140()//Position - 0xA864
{
	Global_394A = 0;
	func_141();
}

void func_141()//Position - 0xA874
{
...
int func_145(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA95A
{
...
void func_146(int iParam0)//Position - 0xAAE9
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_148(int iParam0)//Position - 0xAB66
{
...
void func_149(int iParam0)//Position - 0xAB8F
{
	if (Global_3943)
	{
		func_150(0, 0);
...
void func_150(bool bParam0, bool bParam1)//Position - 0xABFF
{
	if (bParam0)
	{
		if (func_151(0))
...
int func_151(int iParam0)//Position - 0xAC73
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_152(int iParam0)//Position - 0xACCD
{
...
int func_153(int iParam0)//Position - 0xAD0E
{
	int iVar0;
...
void func_154(int iParam0)//Position - 0xAD53
{
...
int func_155(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAD85
{
	int iVar0;
...
void func_156(var uParam0, int iParam1)//Position - 0xAEBC
{
	int iVar0;
...
bool func_157(int iParam0)//Position - 0xAF0B
{
	return func_158(iParam0, Global_8C41);
}

int func_158(int iParam0, int iParam1)//Position - 0xAF1C
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_159(int iParam0)//Position - 0xB0FD
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_160()//Position - 0xB11F
{
	return func_161(unk_0x1377080E9B0BD993(), 0);
}

int func_161(char* sParam0, int iParam1)//Position - 0xB130
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_163(int iParam0, int iParam1)//Position - 0xB19D
{
	switch (iParam0)
	{
		case 0:
...
int func_164(vector3 vParam0, bool bParam1)//Position - 0xB624
{
	int iVar0;
...
float func_165(bool bParam0, float fParam1, float fParam2)//Position - 0xB650
{
	if (bParam0)
	{
		return fParam1;
...
int func_166(int iParam0)//Position - 0xB667
{
	switch (iParam0)
	{
		case 0:
...
int func_167(int iParam0, int iParam1)//Position - 0xB6F6
{
	switch (iParam0->f_10)
	{
		case 0:
...
void func_168()//Position - 0xBED9
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_169(var uParam0)//Position - 0xBEF4
{
	float fVar0;
...
void func_170(int iParam0, int iParam1)//Position - 0xBF82
{
	if (iParam0 == 1)
	{
		if (!func_126(iParam1))
...
int func_171(bool bParam0)//Position - 0xBFE6
{
	int iVar0;
...
int func_172(int iParam0)//Position - 0xC07F
{
	if (func_196(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_173(int iParam0)//Position - 0xC0A9
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_181()) || Global_1974B) || Global_62BF) || func_180()) || func_179(8, -1)) || func_90()) || func_178()) || func_177()) || func_176()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_181()) || Global_62BF) || func_180()) || func_179(8, -1)) || func_177()) || func_90()) || func_178()) || func_176()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_181()) || Global_1974B) || Global_62BF) || func_180()) || func_179(8, -1)) || func_177()) || func_90()) || func_178()) || func_176()) || Global_19B04.f_1DEB.f_397[iVar0] == 5) || Global_8E64 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_181()) || Global_1974B) || Global_62BF) || func_180()) || func_179(8, -1)) || func_90()) || func_178()) || func_176()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_181() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_179(8, -1)) || func_176()) || func_175()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 7:
						if ((((((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || !unk_0x8CC5A4A5615C6420(unk_0xB5CEFD608600A09F())) || !unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F())) || !unk_0x726D9204B160D23E()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || func_181()) || func_178()) || Global_1974B) || Global_62BF) || func_180()) || Global_90C1) || func_179(8, -1)) || func_177()) || func_175()) || func_176()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_174()//Position - 0xC7C6
{
	return Global_16B42.f_1;
}

int func_175()//Position - 0xC7D4
{
	if (Global_15FA6 != -1)
	{
...
bool func_178()//Position - 0xC83E
{
	return Global_16B4F.f_142 > 0;
}

bool func_179(int iParam0, int iParam1)//Position - 0xC84F
{
	switch (iParam0)
	{
		case 5:
...
var func_180()//Position - 0xC88A
{
	return Global_140856;
}

int func_181()//Position - 0xC896
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
int func_182(int iParam0)//Position - 0xC8B2
{
	switch (iParam0)
	{
		case 5:
...
void func_183(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3)//Position - 0xC8D5
{
	switch (*uParam0)
	{
		case 0:
			if ((unk_0x105601648511CC64() - iLocal_224) > 5000)
			{
				*uParam0 = 1;
			}
			break;
		...
		case 1:
			if (func_192(unk_0xBC25C936A095B5BA(), vParam1, 1) <= 20f)
			{
		...
		case 2:
			...
			else if (func_192(unk_0xBC25C936A095B5BA(), vParam1, 1) >= 25f)
			{
				func_140();
				*uParam0 = 0;
			}
...
bool func_184(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xC972
{
...
int func_185(char* sParam0, int iParam1, bool bParam2)//Position - 0xC9C0
{
	Global_3DB9 = 0;
...
void func_191(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCEE6
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
float func_192(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCF3C
{
	vector3 vVar0;
...
void func_193(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, bool bParam9, int iParam10)//Position - 0xCF76
{
	int iVar0;
	int iVar1;
	
	iVar1 = 32768;
	if (!func_196(iParam0->f_1C[iParam10]))
	{
		return;
	}
	if (bParam9)
	...
	unk_0xE896C0AD02364F2A(0, iParam0->f_30, uParam1[uParam1.f_7], 4f, -4f, -1, 0 | iVar1, 0, 0, 0, 0);
	unk_0xE896C0AD02364F2A(0, iParam0->f_30, iParam0->f_30.f_1, 8f, -8f, -1, 1 | iVar1, 0, 0, 0, 0);
	unk_0x535008C596714F9E(iVar0);
	unk_0xA8E6405305C0D7DF(iParam0->f_1C[iParam10], iVar0);
	unk_0x02DAF06EA4F08219(&iVar0);
}

int func_194(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD013
{
	var uVar0;
	
	if ((((func_196(unk_0xBC25C936A095B5BA()) && func_196(iParam0->f_1C[0])) && !func_142()) && (unk_0x105601648511CC64() - iParam0->f_3C) > iParam6) && func_192(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_247(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_195(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD09B
{
...
int func_196(int iParam0)//Position - 0xD0D6
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
...
void func_197(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xD0F7
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
...
void func_198(int iParam0, bool bParam1)//Position - 0xD1E8
{
	if (iParam0 == -1)
	{
		return;
...
int func_199(int iParam0)//Position - 0xD224
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_200(int iParam0, int iParam1)//Position - 0xD25D
{
	bool bVar0;
	int iVar1;
...
bool func_201()//Position - 0xD2FB
{
	return Global_16129;
}

void func_202(int iParam0)//Position - 0xD307
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xD31E
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_204(int iParam0)//Position - 0xD406
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
int func_205(int iParam0, bool bParam1)//Position - 0xD42E
{
	struct<27> Var0;
	...
	func_107(*iParam0, &Var0);
	if ((func_242(*iParam0) || func_240(*iParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
	...
	if (func_209(&(iParam0->f_30)) && bParam1)
	{
		func_206(iParam0->f_1C[0], &(iParam0->f_30), *iParam0);
	}
	return 1;
}

void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD6A1
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_208(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_208(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_207(int iParam0)//Position - 0xD9F9
{
...
int func_208(var uParam0)//Position - 0xDA19
{
...
int func_209(var uParam0)//Position - 0xDA31
{
...
void func_210(var uParam0)//Position - 0xDA56
{
	int iVar0;
	int iVar1;
...
void func_211(int iParam0)//Position - 0xDD5A
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_212(var uParam0)//Position - 0xDD85
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xDE05
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_214(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_214(int iParam0, int iParam1)//Position - 0xDFC3
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xDFF3
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE2AF
{
...
int func_217(int iParam0, float fParam1)//Position - 0xE2E3
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0xE359
{
	return func_219(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE371
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_220(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE432
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE55E
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE66D
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_225(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_225(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_224(vector3 vParam0, vector3 vParam1)//Position - 0xE6FE
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_225(vector3 vParam0)//Position - 0xE71F
{
	float fVar0;
	float fVar1;
...
void func_226(var uParam0)//Position - 0xE75E
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(int iParam0, int iParam1)//Position - 0xE779
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE7B8
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE7E0
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE8DB
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_231(int iParam0, float fParam1)//Position - 0xE9E7
{
	var uVar0;
	vector3 vVar1;
...
int func_232(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xEA7C
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_225(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEB0A
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_234(int iParam0)//Position - 0xEB52
{
...
void func_235(int iParam0)//Position - 0xEB9C
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xEC39
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
int func_237(int iParam0)//Position - 0xECD1
{
...
int func_240(int iParam0)//Position - 0xED53
{
	if ((func_241() && Global_16B1B.f_B == 6) && iParam0 == func_161(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_242(int iParam0)//Position - 0xEDC5
{
	if (func_105(0))
	{
...
void func_243()//Position - 0xEDED
{
	...
	if (func_196(unk_0xBC25C936A095B5BA()))
	{
		if (func_244(unk_0xBC25C936A095B5BA(), vVar0, fVar1))
		{
			func_147();
		}
	}
...
bool func_244(int iParam0, vector3 vParam1, float fParam2)//Position - 0xEE2F
{
	return SYSTEM::VDIST2(unk_0x541C2AEF053615BC(iParam0, true), vParam1) <= (fParam2 * fParam2);
}

void func_245(int iParam0)//Position - 0xEE4C
{
	if (func_196(iParam0->f_1C[0]))
	{
		unk_0x2E9860A2B72187F5(iParam0->f_1C[0], 64, true);
		unk_0x2E9860A2B72187F5(iParam0->f_1C[0], 249, true);
...
void func_246(var uParam0)//Position - 0xEEBB
{
	int iVar0;
	...
	if (*uParam0 == 2 || *uParam0 == 3)
	{
		...
		if (func_196(uParam0->f_1C[0]))
		{
			unk_0x346478B12F69D4E3(uParam0->f_1C[0], false);
			unk_0x50FBC3BBBAC48D06(uParam0->f_1C[0], 100, 500, 0, 1, 1, 0);
			unk_0x5558ED6D4A2DEC93(uParam0->f_1C[0], unk_0xBC25C936A095B5BA(), 10000f, -1, 0, 0);
		}
		func_211(&(uParam0->f_29[2]));
	}
}

void func_247(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xEF55
{
...
void func_250(var uParam0, char* sParam1)//Position - 0xF100
{
...
void func_251(var uParam0)//Position - 0xF129
{
	int iVar0;
...
int func_252(var uParam0)//Position - 0xF156
{
	uParam0->f_10 = 3;
...
int func_253(var uParam0)//Position - 0xF181
{
	int iVar0[3];
	vector3 vVar1;
	vector3 vVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				func_255(&(uParam0->f_23[0]), iVar0[0], vVar1, fVar5);
				if (unk_0x724D816EA203A79E(uParam0->f_23[0]))
				{
					unk_0xEC6E535291C98050(uParam0->f_23[0], 0);
					unk_0x8510BC031C24B862(iVar0[0], true);
					unk_0xE71E3D3EEE5CF489(uParam0->f_23[0], "WEED STASH VEHICLE");
					...
					unk_0x0BD7089C3E314AEA(uParam0->f_23[0], 1);
				}
				else
				{
					bVar8 = false;
			...
			{
				func_254(&(uParam0->f_29[0]), iVar0[1], vVar1 + vVar3, 0f);
				if (unk_0x724D816EA203A79E(uParam0->f_29[0]) && unk_0x724D816EA203A79E(uParam0->f_23[0]))
				{
					unk_0x5DBE04849460E608(uParam0->f_29[0], uParam0->f_23[0], 0, vVar3, vVar4, 0, 0, 0, 0, 2, 1);
				}
				else
				{
					bVar8 = false;
			...
			{
				func_255(&(uParam0->f_23[1]), iVar0[2], vVar2, fVar6);
				unk_0x914C5DE0B15B8B59(uParam0->f_23[1], 39, 43);
			}
			if (bVar8)
			{
				iLocal_51 = 3;
...
void func_254(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF406
{
	func_211(iParam0);
...
void func_255(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF42D
{
	func_256(iParam0);
...
void func_256(int iParam0)//Position - 0xF46F
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_257(int iParam0)//Position - 0xF50B
{
	int iVar0;
...
int func_258(var uParam0)//Position - 0xF53C
{
	int iVar0[4];
	vector3 vVar1;
	vector3 vVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			bVar7 = true;
			func_255(&(uParam0->f_23[0]), iVar0[0], vVar1, fVar4);
			if (unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				unk_0x6012A6A4F2950585(uParam0->f_23[0], 1);
				unk_0xEC6E535291C98050(uParam0->f_23[0], 0);
				...
				unk_0xE54F7105CEA81918(uParam0->f_23[0], 2, true);
				unk_0xE54F7105CEA81918(uParam0->f_23[0], 3, true);
			}
			else
			{
				bVar7 = false;
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_29[0]))
			{
				func_254(&(uParam0->f_29[0]), iVar0[1], vVar1 + vVar2, 0f);
				if (unk_0x724D816EA203A79E(uParam0->f_29[0]) && unk_0x724D816EA203A79E(uParam0->f_23[0]))
				{
					unk_0x5DBE04849460E608(uParam0->f_29[0], uParam0->f_23[0], 0, vVar2, 0f, 0f, 0f, 0, 0, 1, 0, 2, 1);
				}
				else
				{
					bVar7 = false;
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_23[1]))
			{
				func_255(&(uParam0->f_23[1]), iVar0[2], vVar3, fVar5);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				func_259(&(uParam0->f_1C[0]), iVar0[3], vVar3, fVar5, 6);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[1]))
			{
				func_259(&(uParam0->f_1C[1]), iVar0[3], vVar3, fVar5, 6);
			}
			if (bVar7)
			{
				iLocal_51 = 3;
		...
		case 3:
			if (func_196(uParam0->f_23[1]))
			{
				if (func_196(uParam0->f_1C[0]))
				{
					unk_0x717F82C821538DA2(uParam0->f_1C[0], 1);
					unk_0xBD53A029D0155A42(uParam0->f_1C[0], uParam0->f_23[1], -1);
					unk_0x7A853DA478E4882E(uParam0->f_1C[0], joaat("weapon_pistol"), 100, true);
				}
				if (func_196(uParam0->f_1C[1]))
				{
					unk_0x717F82C821538DA2(uParam0->f_1C[1], 1);
					unk_0xBD53A029D0155A42(uParam0->f_1C[1], uParam0->f_23[1], 0);
					unk_0x7A853DA478E4882E(uParam0->f_1C[1], joaat("weapon_pistol"), 100, true);
				}
			}
			iVar6 = 0;
			while (iVar6 <= (iVar0 - 1))
...
void func_259(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xF88B
{
	func_260(iParam0);
	*iParam0 = unk_0x01B3635C3E8EDD81(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_260(int iParam0)//Position - 0xF8AC
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
int func_261(var uParam0)//Position - 0xF8ED
{
	int iVar0[2];
	vector3 vVar1;
	float fVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_266(&(uParam0->f_30), "rcm_barry3", "bar_3_rcm_barry_standing_on_street_base", "bar_3_rcm_barry_standing_on_street_fidget");
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_257(&iVar0) || !func_265(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_262(&(uParam0->f_1C[0]), 49, vVar1, fVar2, "RC LAUNCHER: BARRY 3", 1))
				{
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_29[0]))
			{
				func_254(&(uParam0->f_29[0]), iVar0[1], vVar1 + Vector(0f, 0f, 5f), -115.18f);
				if (func_196(uParam0->f_29[0]) && func_196(uParam0->f_1C[0]))
				{
...
int func_262(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xFAE3
{
...
int func_263(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xFB3F
{
	int iVar0;
...
int func_264(var uParam0, int iParam1)//Position - 0xFBCD
{
	int iVar0;
...
int func_265(var uParam0)//Position - 0xFC13
{
	if (func_209(uParam0))
	{
...
void func_266(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xFC3D
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_267(var uParam0)//Position - 0xFC79
{
	int iVar0[5];
	vector3 vVar1;
	float fVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_266(&(uParam0->f_30), "rcm_barry2", "lead_in_loop", "lead_in_loop");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_262(&(uParam0->f_1C[0]), 49, vVar1, fVar2, "RC LAUNCHER: BARRY 2", 1))
				{
					unk_0x70FF586D857F1A81(uParam0->f_1C[0], 1, 0, 0, false);
				}
				else
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_29[0]))
			{
				...
				func_254(&(uParam0->f_29[0]), iVar0[1], 189.5964f, -956.0344f, 29.09179f, func_269(-2.01f));
				if (func_196(uParam0->f_29[0]))
				{
					unk_0x346478B12F69D4E3(uParam0->f_29[0], true);
					func_254(&(uParam0->f_29[2]), iVar0[3], 189.7901f, -956.1675f, 29.8229f, func_269(-2.01f));
					if (func_196(uParam0->f_29[2]))
					{
			...
			{
				func_254(&(uParam0->f_29[1]), iVar0[2], 190.417f, -956.511f, 29.09179f, -99.157f);
				if (func_196(uParam0->f_29[1]))
				{
		...
		case 3:
			if (func_196(uParam0->f_1C[0]))
			{
				...
				unk_0x641B19E156645A92(uParam0->f_1C[0], vVar1, 1, false, 0, 1);
			...
			func_268(&(uParam0->f_29[3]), iVar0[4]);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
				unk_0x2CA123B0622F495C(iVar0[iVar3]);
...
void func_268(int iParam0, int iParam1)//Position - 0x10018
{
	vector3 vVar0;
	float fVar1;
...
float func_269(float fParam0)//Position - 0x10048
{
	return (fParam0 * 57.29578f);
}

int func_270(var uParam0)//Position - 0x10058
{
	int iVar0[7];
	vector3 vVar1;
	float fVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_266(&(uParam0->f_30), "RCMBarryLeadInOut", "idle", "fidget");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_262(&(uParam0->f_1C[0]), 49, vVar1, fVar2, "RC LAUNCHER: BARRY 1", 1))
				{
					unk_0x70FF586D857F1A81(uParam0->f_1C[0], 1, 0, 0, false);
				}
				else
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_29[1]))
			{
				func_254(&(uParam0->f_29[1]), iVar0[2], 190.2574f, -956.3513f, 29.09179f, func_269(-1.68f));
				if (func_196(uParam0->f_29[1]))
				{
					unk_0x346478B12F69D4E3(uParam0->f_29[1], true);
					unk_0xD434A01DEA38A939(uParam0->f_29[1], false, 0);
		...
		case 3:
			...
			func_254(&(uParam0->f_29[4]), iVar0[5], 189.895f, -955.945f, 29.818f, 0f);
			if (func_196(uParam0->f_29[4]))
			{
				unk_0x784C605D172817C8(uParam0->f_29[4], -90f, 0f, -30.8f, 2, 1);
				unk_0x346478B12F69D4E3(uParam0->f_29[4], true);
			}
			func_254(&(uParam0->f_29[3]), iVar0[4], 189.783f, -956.015f, 29.79f, 0f);
			if (func_196(uParam0->f_29[3]))
			{
				unk_0x784C605D172817C8(uParam0->f_29[3], -90f, 0f, 75f, 2, 1);
				unk_0x346478B12F69D4E3(uParam0->f_29[3], true);
			}
			func_268(&(uParam0->f_29[5]), iVar0[6]);
			iVar3 = 0;
			while (iVar3 <= (iVar0 - 1))
			{
				unk_0x2CA123B0622F495C(iVar0[iVar3]);
...
int func_271(int iParam0)//Position - 0x104B6
{
	struct<27> Var0;
	int iVar1;
...
int func_272(int iParam0)//Position - 0x1050A
{
	char* sVar0;
...
int func_273(int iParam0)//Position - 0x105C3
{
	var uVar0;
...
int func_274(int iParam0)//Position - 0x10684
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_275(int iParam0, char* sParam1)//Position - 0x10709
{
...
bool func_276(int iParam0)//Position - 0x107EB
{
...
bool func_277(int iParam0)//Position - 0x10819
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_278(int iParam0)//Position - 0x10847
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_279(int iParam0)//Position - 0x10875
{
	if (func_237(iParam0))
	{
		return 0;
...
void func_280()//Position - 0x108AA
{
	func_302("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_281(int iParam0, vector3 vParam1, float fParam2)//Position - 0x108C4
{
	int iVar0[4];
	int iVar1;
...
int func_282(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0x10955
{
	int iVar0;
	struct<7> Var1;
...
int func_283(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x109D3
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_284(int iParam0, bool bParam1)//Position - 0x10A4E
{
	char* sVar0;
...
void func_285(char* sParam0)//Position - 0x10AE3
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
		if (func_288(sParam0))
...
void func_286()//Position - 0x10B02
{
	Global_394A = 0;
	func_287();
}

void func_287()//Position - 0x10B12
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
int func_288(char* sParam0)//Position - 0x10B33
{
	struct<6> Var0;
...
struct<6> func_289()//Position - 0x10B53
{
	struct<6> Var0;
...
int func_290(var uParam0)//Position - 0x10B77
{
	if (func_209(uParam0))
	{
		if (unk_0xF9E082857622D91E(*uParam0))
...
void func_291(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x10BAD
{
...
void func_292(var uParam0, bool bParam1)//Position - 0x10BCD
{
	func_293(&(uParam0->f_29), bParam1);
}

void func_293(var uParam0, bool bParam1)//Position - 0x10BDF
{
	int iVar0;
...
void func_294(int iParam0, bool bParam1)//Position - 0x10C1D
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_295(var uParam0, bool bParam1)//Position - 0x10C58
{
	func_296(&(uParam0->f_23), bParam1);
}

void func_296(var uParam0, bool bParam1)//Position - 0x10C6A
{
	int iVar0;
...
void func_297(int iParam0)//Position - 0x10CA7
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_298(var uParam0, int iParam1)//Position - 0x10CDF
{
	func_299(&(uParam0->f_1C), iParam1);
}

void func_299(var uParam0, int iParam1)//Position - 0x10CF1
{
	int iVar0;
...
void func_300(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10D32
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_301(var uParam0)//Position - 0x10D82
{
	if (*uParam0 == -1)
	{
		return;
...
void func_302(char* sParam0)//Position - 0x10DBF
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_303(var uParam0)//Position - 0x10DD1
{
	*uParam0 = -1;
...
void func_304()//Position - 0x10E04
{
	func_302("Running start routines.");
	Global_199EA++;
}

int func_305(int iParam0)//Position - 0x10E1E
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
