	...
	while (true)
	{
		...
		if (Global_389D.f_1 != 9)
		{
			...
			else if (Global_388B)
			{
				...
				{
					iLocal_19 = 1;
					func_7(Global_388A, "SET_DATA_SLOT_EMPTY", 5f, -1082130432, -1082130432, -1082130432, -1082130432);
					func_4(Global_388A, 1);
					func_7(Global_388A, "DISPLAY_VIEW", 5f, -1082130432, -1082130432, -1082130432, -1082130432);
				}
				else
				{
					func_3();
...
void func_3()//Position - 0x148
{
	if (!iLocal_20)
	{
		...
		{
			iLocal_20 = 1;
			func_7(Global_388A, "SET_INPUT_EVENT", 1f, -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	...
	if (!iLocal_21)
	{
		...
		{
			iLocal_21 = 1;
			func_7(Global_388A, "SET_INPUT_EVENT", 3f, -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	...
	if (!iLocal_22)
	{
		...
		{
			iLocal_22 = 1;
			func_7(Global_388A, "SET_INPUT_EVENT", 4f, -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
	...
	if (!iLocal_23)
	{
		...
		{
			iLocal_23 = 1;
			func_7(Global_388A, "SET_INPUT_EVENT", 2f, -1082130432, -1082130432, -1082130432, -1082130432);
		}
	}
...
void func_4(int iParam0, bool bParam1)//Position - 0x25C
{
	...
	{
		iVar4 = iVar3;
		iVar3 = Global_16050[iVar0 /*25*/][iVar1];
		if (!iVar3 == iVar4)
		{
			if (!iVar3 == 0)
			{
		...
		if (iVar0 == Global_1604F && iVar1 == Global_1604E)
		{
			bVar2 = false;
		}
	}
	Global_1604C = Global_1604B;
}
...
void func_8()//Position - 0x475
{
	...
	if (!Global_1604A)
	{
		Global_16102 = unk_0xDD6A91E47ED4D0CF();
		Global_16101 = unk_0xBE14F159908E4EE5();
		Global_16100 = unk_0x6E06C0DB9B43570D();
		Global_1604A = 1;
		Global_1604F = unk_0x8431C7EEBCF8E94F();
		Global_1604E = unk_0x6E06C0DB9B43570D();
		func_12();
		return;
	}
	...
	if (iVar11 > 0)
	{
		...
		if (iVar11 > 7)
		{
			...
			while (iVar8 < 7)
			{
				...
				while (iVar9 < 24)
				{
					if (!Global_16050[iVar6 /*25*/][iVar7] == 0)
					{
						Global_1604B++;
						Global_1604D = (Global_1604D - 1);
					}
					Global_16050[iVar6 /*25*/][iVar7] = 0;
					iVar9++;
				}
				iVar8++;
			}
