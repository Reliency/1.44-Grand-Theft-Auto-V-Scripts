		...
		switch (iLocal_18)
		{
			case 0:
				if (iLocal_19[0])
				{
					...
					{
						Global_4217[3 /*42*/].f_1B[0] = func_48(2);
						func_47(2, 32, Global_4217[3 /*42*/].f_1B[0]);
					}
					StringCopy(&(Global_4217[3 /*42*/]), "PA_TREV1", 16);
					StringCopy(&(Global_4217[3 /*42*/].f_4), "PA_TREV1", 16);
					Global_4217[3 /*42*/].f_8 = 0;
					Global_4217[3 /*42*/].f_9 = 1;
					StringCopy(&(Global_4217[3 /*42*/].f_A[1 /*4*/]), "PA_TREV1A", 16);
					Global_4217[3 /*42*/].f_25[1] = 0;
					if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
					{
						Global_4217[3 /*42*/].f_1B[1] = func_48(2);
					}
					func_40(2, 3, 1, 1);
					func_37("PA_TREV1A", Global_4217[3 /*42*/].f_1B[1]);
					iLocal_18 = 1;
				}
				break;
			...
			case 1:
				if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
				{
					...
					if (func_36(2, 999999))
					{
						...
						Global_4217[3 /*42*/].f_25[1] = 1;
						Global_4217[3 /*42*/].f_8 = 1;
						iLocal_22 = unk_0x105601648511CC64();
						iLocal_18 = 2;
					}
			...
			case 2:
				iLocal_21 = unk_0x105601648511CC64();
...
void func_1(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x1D5
{
	...
	func_2(Global_19B04.f_6D75[iParam0 /*29*/].f_11, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
void func_5(int iParam0)//Position - 0xB97
{
	...
	else if (unk_0xFA30DFD0084E92FE(Global_19B04.f_5037.f_1D7, iParam0) || unk_0xFA30DFD0084E92FE(Global_200000[func_7() /*12171*/].f_1E08.f_A, iParam0))
	{
		bVar0 = true;
		unk_0x7CB6FD92BE491AD9(&(Global_19B04.f_5037.f_1D7), iParam0);
		unk_0x7CB6FD92BE491AD9(&(Global_200000[func_7() /*12171*/].f_1E08.f_A), iParam0);
	}
	if (bVar0)
	{
...
int func_9()//Position - 0x1209
{
	return Global_1407E0;
}

void func_10(int iParam0)//Position - 0x1215
{
	func_32(93, iParam0);
	func_32(29, iParam0);
	func_32(30, iParam0);
...
bool func_11(int iParam0)//Position - 0x1235
{
	if (iParam0 == 8)
	{
	...
	return unk_0xFA30DFD0084E92FE(Global_200000[func_7() /*12171*/].f_1E08.f_A, iParam0);
}

int func_12(int iParam0, int iParam1, int iParam2)//Position - 0x1283
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_13(int iParam0)//Position - 0x12C0
{
	int iVar0;
...
int func_14(int iParam0, int iParam1)//Position - 0x15AC
{
	int iVar0;
...
int func_15(bool bParam0)//Position - 0x1872
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_16(int iParam0, int iParam1)//Position - 0x1929
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_17(int iParam0, int iParam1)//Position - 0x1944
{
	...
	if (func_27(&Global_411EB6))
	{
		if (func_25(&Global_411EB6, iParam0))
		{
			return 0;
		}
		if (func_18(&Global_411EB6, iParam0))
		{
			return 1;
		}
	}
...
int func_18(var uParam0, int iParam1)//Position - 0x19E1
{
	int iVar0;
	var uVar1[78];
...
int func_19(var uParam0, int iParam1)//Position - 0x1A92
{
	int iVar0;
...
bool func_20(var uParam0, int iParam1)//Position - 0x1B0D
{
	return (*uParam0)[iParam1] == 78;
}

void func_21(var uParam0)//Position - 0x1B1E
{
	int iVar0;
	...
	func_23(uParam0, (Global_411EB5 - 0.5f));
}

void func_22(var uParam0, int iParam1)//Position - 0x1B52
{
	(*uParam0)[iParam1] = 78;
}

void func_23(var uParam0, float fParam1)//Position - 0x1B62
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_24(var uParam0)//Position - 0x1B7F
{
	return uParam0->f_50;
}

bool func_25(var uParam0, int iParam1)//Position - 0x1B8B
{
	return func_26(uParam0, iParam1) != -1;
}

int func_26(var uParam0, int iParam1)//Position - 0x1B9D
{
	int iVar0;
...
bool func_27(var uParam0)//Position - 0x1BCA
{
	return uParam0->f_4F == 1;
}

int func_28(int iParam0)//Position - 0x1BD8
{
	switch (iParam0)
	{
		case 60:
...
bool func_29(int iParam0)//Position - 0x1C28
{
	return Global_8C41 == iParam0;
}

int func_30(int iParam0, int iParam1)//Position - 0x1C36
{
	int iVar0;
...
void func_31(int iParam0, int iParam1)//Position - 0x1C87
{
	int iVar0;
...
void func_32(int iParam0, int iParam1)//Position - 0x1CAA
{
	int iVar0;
...
void func_34(char* sParam0, int iParam1, int iParam2)//Position - 0x1D7C
{
	iParam2 = iParam2;
...
void func_35(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0x1D95
{
	iParam3 = iParam3;
	unk_0x3714DE83381EADC2(sParam0);
...
int func_36(int iParam0, int iParam1)//Position - 0x1DB4
{
...
void func_37(char* sParam0, int iParam1)//Position - 0x1DCF
{
...
void func_38(float fParam0, float fParam1, char* sParam2, int iParam3, int iParam4)//Position - 0x1E12
{
...
void func_39(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1E30
{
...
int func_40(int iParam0, int iParam1, bool bParam2, int iParam3)//Position - 0x1E6F
{
	if (func_46())
	{
		return 0;
...
int func_41(var uParam0, var uParam1, bool bParam2, int iParam3)//Position - 0x1E9A
{
...
void func_42(int iParam0)//Position - 0x1EFE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_43()//Position - 0x1F78
{
}

int func_44()//Position - 0x1F80
{
	int iVar0;
	...
	while (iVar0 < 2)
	{
		...
		{
			if (!func_45(Global_42C0[iVar0 /*9*/].f_2, Global_42C0[Global_4216 /*9*/].f_2))
			{
				Global_4216 = iVar0;
			}
		}
...
int func_45(struct<6> Param0, struct<6> Param1)//Position - 0x205A
{
	struct<4> Var0;
	struct<4> Var1;
	int iVar2;
...
int func_47(int iParam0, int iParam1, int iParam2)//Position - 0x216C
{
	if (Global_19B04.f_6D75[iParam0 /*29*/].f_11 == 3)
	{
		return 0;
	...
	return func_2(Global_19B04.f_6D75[iParam0 /*29*/].f_11, 0, iParam1, iParam2, 0);
}

int func_48(int iParam0)//Position - 0x21B5
{
	var uVar0;
