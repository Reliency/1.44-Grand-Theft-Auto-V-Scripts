...
int func_2()//Position - 0x10C
{
	...
	if (SYSTEM::VDIST(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_72) > 100f)
	{
		return 1;
	}
	return 0;
		...
		switch (iLocal_70[iParam1])
		{
			case 0:
				...
				if (unk_0xF4FCC3C1048FF2AB(iParam0, -1146898486) != 1)
				{
					...
					unk_0x22321800954A532E(iLocal_68[iParam1], true);
				}
				break;
			...
			case 1:
				...
				if (!unk_0xF1734B55490E9045(&(Local_71[iParam1 /*4*/])))
				{
			...
			case 3:
				...
				if (SYSTEM::VDIST2(unk_0x541C2AEF053615BC(iParam0, true), unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true)) > (50f * 50f))
				{
					iLocal_70[iParam1] = 0;
					return 1;
				}
...
int func_7(int iParam0, int iParam1)//Position - 0x431
{
	...
	if (!unk_0x7930B3E9C919E90F())
	{
		...
		else if (iParam1 == func_8(Global_16A45) && iParam1 != 0)
		{
			Global_16A45 = 0;
		}
	}
...
void func_20()//Position - 0x75F
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			if (!unk_0xF1734B55490E9045(&(Local_71[iVar0 /*4*/])))
			{
				unk_0x63831D2D5110C305(&(Local_71[iVar0 /*4*/]));
				if (!unk_0xACE95AD318CE412B(&(Local_71[iVar0 /*4*/])))
				{
					bVar2 = false;
				}
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0x01B3635C3E8EDD81(4, iLocal_69[iVar0], vLocal_72 + vLocal_74[iVar0 /*3*/], 0f, 1, true);
			unk_0x019CE76D5286C95C(iLocal_68[iVar0], (fLocal_73 + fLocal_75[iVar0]));
			...
			unk_0xF1FC2182A76AD7FC(iLocal_68[iVar0], 0);
		}
		iVar0++;
	}
}
...
void func_21()//Position - 0x88C
{
	...
	switch (iLocal_66)
	{
		case 97:
			...
			vLocal_74[3 /*3*/] = { Vector(45.5004f, unk_0x55AEFCD285ECC0F2(-205.8167f, -210.4254f), unk_0x55AEFCD285ECC0F2(-1416.54f, -1428.501f)) - vLocal_72 };
