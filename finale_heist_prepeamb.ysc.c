	...
	else if (unk_0xA7F138B5B1AB2CF6(Global_388A) == 1)
	{
		if (func_10())
		{
			if (func_9())
			{
				...
				iVar0 = unk_0xC27A95D32A8160C0();
				iVar4 = unk_0x105601648511CC64();
				while ((!unk_0x3B6BD69AB08B86C2(iVar0) && iVar6 == 0) && unk_0xA7F138B5B1AB2CF6(Global_388A) == 1)
				{
					SYSTEM::WAIT(0);
				...
				iVar1 = unk_0x6AE1427A38313694(iVar0);
		...
		if (!func_75(0f, 0f, 0f, vLocal_52, 0))
		{
			if (func_74(unk_0xBC25C936A095B5BA(), vLocal_52, 100f) && !func_73())
			{
				if (func_83(func_72(25)))
				{
					...
					unk_0x77815D3407C6700D(iLocal_51, true, 1);
					if (func_83(iLocal_51))
					{
...
void func_17()//Position - 0x8FC
{
	if (unk_0xFA30DFD0084E92FE(iLocal_49, 2) && unk_0xFA30DFD0084E92FE(iLocal_49, 0))
	{
		if (func_83(iLocal_51))
		{
			...
			{
				if (SYSTEM::VDIST2(unk_0x541C2AEF053615BC(iLocal_51, true), vLocal_52) >= 100f)
				{
					func_67(0);
				}
			}
...
int func_29()//Position - 0x2DBE
{
	return 0;
}

int func_30()//Position - 0x2DC7
{
	return 1;
}

int func_31()//Position - 0x2DD0
{
	return 1;
}

int func_32()//Position - 0x2DD9
{
...
int func_34(int iParam0)//Position - 0x2EAD
{
	int iVar0;
	char* sVar1;
...
int func_35(int iParam0)//Position - 0x2EF3
{
	int iVar0;
...
int func_36(int iParam0)//Position - 0x2F2E
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x2FAA
{
	int iVar0;
...
int func_38(int iParam0, int iParam1, bool bParam2)//Position - 0x3092
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_39(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x3103
{
...
void func_41(var uParam0, int iParam1)//Position - 0x3220
{
	if (iParam1 <= 0)
	{
		return;
...
void func_42(var uParam0, int iParam1)//Position - 0x32A6
{
...
void func_43(var uParam0, int iParam1)//Position - 0x32D9
{
	int iVar0;
	int iVar1;
...
int func_44(int iParam0, int iParam1)//Position - 0x332A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_45(int iParam0)//Position - 0x33CC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_46(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_46(bool bParam0, int iParam1, int iParam2)//Position - 0x33F1
{
	if (bParam0)
	{
		return iParam1;
...
int func_47(var uParam0)//Position - 0x3408
{
	return uParam0 & 15;
}

void func_48(var uParam0, int iParam1)//Position - 0x3415
{
...
void func_49(var uParam0, int iParam1)//Position - 0x344F
{
...
void func_50(var uParam0, int iParam1)//Position - 0x348A
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_51(var uParam0, int iParam1)//Position - 0x34C6
{
	int iVar0;
	int iVar1;
...
int func_52(int iParam0, int iParam1)//Position - 0x4BBD
{
	struct<82> Var0;
...
void func_53(int iParam0, var uParam1, int iParam2)//Position - 0x4BFF
{
	int iVar0;
...
bool func_54(int iParam0)//Position - 0x4E5B
{
	return iParam0 < 3;
}

void func_55(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x4E67
{
	if (func_51(&(Global_110A8.f_22B[0 /*21*/]), iParam0))
	{
...
void func_56(int iParam0, bool bParam1)//Position - 0x4F66
{
	if (iParam0 == -1)
	{
		return;
...
void func_57(int iParam0, int iParam1, bool bParam2)//Position - 0x4FC3
{
	if (iParam0 == -1)
	{
		return;
...
void func_58(var uParam0, var uParam1)//Position - 0x4FFE
{
...
void func_59(int iParam0)//Position - 0x50CA
{
	if (iParam0 == -1)
	{
		return;
...
int func_60(int iParam0)//Position - 0x5144
{
	int iVar0;
...
void func_61(int iParam0, var uParam1)//Position - 0x51A7
{
	int iVar0;
...
int func_62(int iParam0)//Position - 0x5452
{
	switch (iParam0)
	{
		case 1:
...
int func_63(int iParam0, var uParam1, var uParam2)//Position - 0x5502
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0)//Position - 0x55DC
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_65(var uParam0)//Position - 0x55FC
{
	int iVar0;
...
void func_66(int iParam0)//Position - 0x56AB
{
...
void func_67(bool bParam0)//Position - 0x56D2
{
	if (unk_0xFA30DFD0084E92FE(iLocal_49, 14))
	{
...
void func_68(int iParam0)//Position - 0x57B9
{
	int iVar0;
...
int func_69(int iParam0)//Position - 0x57D9
{
	int iVar0;
	int iVar1;
...
int func_70(int iParam0)//Position - 0x5816
{
	if (func_54(iParam0))
	{
...
bool func_71(int iParam0, int iParam1)//Position - 0x5840
{
	if (iParam0 == -1)
	{
		return 0;
...
int func_72(int iParam0)//Position - 0x5863
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_74(int iParam0, vector3 vParam1, float fParam2)//Position - 0x589B
{
	return SYSTEM::VDIST2(unk_0x541C2AEF053615BC(iParam0, true), vParam1) <= (fParam2 * fParam2);
}

bool func_75(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x58B8
{
	if (bParam2)
	{
...
void func_76(int iParam0, bool bParam1)//Position - 0x58FF
{
...
bool func_78(bool bParam0)//Position - 0x596E
{
...
void func_79(char* sParam0, int iParam1)//Position - 0x5999
{
...
bool func_82(int iParam0)//Position - 0x5B36
{
	return Global_8C41 == iParam0;
}

int func_83(int iParam0)//Position - 0x5B44
{
	if (func_84(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_84(int iParam0)//Position - 0x5B6E
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
void func_85(int iParam0, int iParam1)//Position - 0x5B8F
{
...
void func_86(bool bParam0)//Position - 0x5BCC
{
	char* sVar0;
...
int func_87()//Position - 0x5C3F
{
	func_81();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_88(char* sParam0)//Position - 0x5C58
{
	unk_0x57016C44F10111F0(sParam0);
	unk_0x64989E60CF560CA1();
}

void func_89(int iParam0, int iParam1)//Position - 0x5C6A
{
...
void func_92(int iParam0, int iParam1, int iParam2)//Position - 0x5D45
{
	bool bVar0;
...
int func_94()//Position - 0x62EE
{
	return Global_62BD;
}

int func_95(int iParam0, int iParam1)//Position - 0x62F9
{
	int iVar0;
...
int func_96(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x634A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_97()//Position - 0x6864
{
	return Global_1407E0;
}

int func_98()//Position - 0x6870
{
...
int func_101(int iParam0)//Position - 0x68FF
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return 0;
...
int func_105(int iParam0, int iParam1)//Position - 0x698A
{
	int iVar0;
	int iVar1;
...
void func_106(int iParam0)//Position - 0x69CB
{
	Global_11646 = iParam0;
	Global_11647 = iParam0;
}

void func_107()//Position - 0x69DF
{
	struct<6> Var0;
...
void func_108(bool bParam0)//Position - 0x6B58
{
	if (bParam0)
	{
...
int func_109(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x6BC9
{
	struct<15> Var0;
	int iVar1;
...
void func_110(int iParam0)//Position - 0x6D1A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_111(int iParam0)//Position - 0x6DDE
{
	switch (iParam0)
	{
		case 0:
...
void func_112(int iParam0)//Position - 0x6E48
{
...
void func_114(struct<6> Param0)//Position - 0x6EE9
{
	if (iLocal_42 == 0)
	{
		func_119(Param0);
...
void func_115(struct<6> Param0)//Position - 0x6F10
{
	if (func_99())
	{
		func_116(Param0, 1);
...
void func_116(var uParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, bool bParam6)//Position - 0x6F34
{
	struct<4> Var0;
...
struct<4> func_117(bool bParam0)//Position - 0x6FA4
{
	struct<4> Var0;
...
struct<4> func_118(bool bParam0)//Position - 0x700E
{
	struct<4> Var0;
...
void func_119(struct<6> Param0)//Position - 0x7078
{
	if (func_99())
	{
		if (func_120())
...
void func_122(bool bParam0)//Position - 0x712F
{
...
void func_123(char* sParam0, char* sParam1)//Position - 0x7143
{
	if (unk_0x58E7DDFF8D17A82A())
	{
		Global_3DF1 = 1;
...
struct<6> func_124()//Position - 0x7164
{
	struct<6> Var0;
...
void func_125()//Position - 0x7188
{
	func_126();
}

void func_126()//Position - 0x7194
{
	func_130();
	func_127();
}

void func_127()//Position - 0x71A4
{
	if (func_129() == 85)
	{
...
int func_129()//Position - 0x7205
{
	return Global_11648;
}

void func_130()//Position - 0x7211
{
	if (!func_75(vLocal_52, 0f, 0f, 0f, 0) && func_129() != func_131())
	{
		if (func_74(unk_0xBC25C936A095B5BA(), vLocal_52, 60f))
		{
			if (func_83(func_72(25)))
			{
				if (SYSTEM::VDIST2(unk_0x541C2AEF053615BC(func_72(25), true), vLocal_52) >= 100f)
				{
					func_67(0);
				}
			}
...
void func_132()//Position - 0x72BC
{
	func_16();
	func_107();
}

void func_133()//Position - 0x72CC
{
	func_147();
	func_143();
	func_140();
	func_107();
	if (func_74(unk_0xBC25C936A095B5BA(), vLocal_50, 150f) && !unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -176.9431f, -651.257f, 31.2136f, -150.9563f, -579.7476f, 35.4245f, 50f, 0, true, 0))
	{
		unk_0xEDAD35A0D81ED3FB(vLocal_50, 6f, 0, 1, 0, 0, false, 0);
		unk_0x379ACE23D404525C(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, false, 1);
	}
	if (!unk_0xFA30DFD0084E92FE(iLocal_49, 18))
	{
		if (!func_14(0) && !func_113())
		{
			func_139(sLocal_45[4], 7500, 0);
			unk_0xF0059F27F7BB6680(&iLocal_49, 18);
		}
	}
	if (unk_0xFA30DFD0084E92FE(iLocal_49, 0))
	{
		if (unk_0xFA30DFD0084E92FE(iLocal_49, 1))
		{
			...
			if (func_83(iLocal_51))
			{
				if (!unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), iLocal_51, 0))
				{
					if (unk_0xB66CFDE6B830965A(iLocal_51))
					{
						func_135();
						func_134(&uLocal_246);
						func_89(35, 0);
						...
						unk_0x379ACE23D404525C(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, true, 1);
						func_76(4, 0);
					}
				}
			}
	...
	{
		unk_0x7CB6FD92BE491AD9(&iLocal_49, 18);
		func_134(&uLocal_246);
		unk_0x379ACE23D404525C(-169.4253f, -622.0479f, 31.42444f, -162.2762f, -620.509f, 35.42448f, true, 1);
		func_76(0, 1);
	}
...
void func_134(var uParam0)//Position - 0x749A
{
	if (*uParam0 == -1)
	{
		return;
...
void func_135()//Position - 0x74D7
{
	if (!unk_0xFA30DFD0084E92FE(iLocal_49, 6))
	{
		if (func_83(iLocal_51))
		{
			vLocal_52 = { unk_0x541C2AEF053615BC(iLocal_51, true) };
...
int func_136(int iParam0)//Position - 0x753A
{
...
bool func_137(char* sParam0, int iParam1, char* sParam2)//Position - 0x756A
{
...
void func_138(int iParam0)//Position - 0x7588
{
...
void func_139(char* sParam0, int iParam1, int iParam2)//Position - 0x75A8
{
	iParam2 = iParam2;
...
void func_140()//Position - 0x75C1
{
	switch (iLocal_38)
	{
		case 0:
			if (((!unk_0x2DA8CA50A72528FB(iLocal_245) && unk_0xFA30DFD0084E92FE(iLocal_49, 0)) && !unk_0xFA30DFD0084E92FE(iLocal_49, 1)) && unk_0xFA30DFD0084E92FE(iLocal_49, 18))
			{
...
int func_141(vector3 vParam0, bool bParam1)//Position - 0x7639
{
	int iVar0;
...
float func_142(bool bParam0, float fParam1, float fParam2)//Position - 0x7665
{
	if (bParam0)
	{
		return fParam1;
	...
	if (func_101(35))
	{
		if (iLocal_38 == 0)
		{
			if (!unk_0xFA30DFD0084E92FE(iLocal_49, 1))
			{
				if (func_83(iLocal_51))
				{
					unk_0x4DBCE270B354E123(iLocal_51, vLocal_50, 4f, 4f, 2f, true, true, 0);
					if (unk_0x0C265B3C448E6954(iLocal_51, -168.8162f, -619.9002f, 31.42446f, -162.6423f, -622.0781f, 33.42446f, 4.14f, 0, true, 0))
					{
						func_146(24, 46);
			...
			{
				if (!func_74(iLocal_51, vLocal_50, 10f) || unk_0x8730A01B72F31307(iLocal_51))
				{
					unk_0x7CB6FD92BE491AD9(&iLocal_49, 1);
				}
			}
...
int func_144(float fParam0, int iParam1)//Position - 0x773E
{
	int iVar0;
...
int func_145(int iParam0)//Position - 0x77C2
{
	vector3 vVar0;
...
void func_146(int iParam0, int iParam1)//Position - 0x7877
{
	func_4(iParam0);
...
void func_147()//Position - 0x78C6
{
	int iVar0;
	int iVar1;
	
	if ((Global_8C41 == 15 && !func_163()) || func_101(35))
	{
		if (iLocal_38 == 0)
		{
							...
							if (func_83(iVar0))
							{
								if (!func_162(iVar0))
								{
									if (func_155(iVar0) && !func_154())
									{
										...
										{
											if (!unk_0xFA30DFD0084E92FE(iLocal_49, 19))
											{
												func_68(9);
												unk_0xF0059F27F7BB6680(&iLocal_49, 19);
											}
...
int func_148(int iParam0)//Position - 0x7BA2
{
...
void func_149(int iParam0)//Position - 0x7BD3
{
	if (Global_3943)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0x7C6A
{
	if (bParam0)
	{
		if (func_14(0))
...
int func_153(int iParam0)//Position - 0x7CFC
{
...
int func_155(int iParam0)//Position - 0x7D84
{
...
int func_156(int iParam0)//Position - 0x7DAE
{
	int iVar0;
...
int func_157(int iParam0)//Position - 0x7DCF
{
...
int func_158(int iParam0)//Position - 0x7DFC
{
	int iVar0;
...
int func_159(int iParam0)//Position - 0x7E50
{
	int iVar0;
...
int func_160(int iParam0)//Position - 0x7E95
{
	int iVar0;
...
int func_162(int iParam0)//Position - 0x7F57
{
	if (unk_0x3C03CFD5DD1E2D97(iParam0, "GetawayVehicleValid"))
	{
		return 1;
...
int func_165(var uParam0)//Position - 0x7FE2
{
	char* sVar0;
...
int func_166()//Position - 0x8029
{
	if (func_168(&uLocal_80, Local_44.f_8, sLocal_79, Local_44.f_4, 9, 1, 0, 0, 0))
	{
		iLocal_40 = 1;
		func_167(192, unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true));
		return 1;
	}
	return 0;
}

void func_167(int iParam0, vector3 vParam1)//Position - 0x8063
{
	int iVar0;
...
bool func_168(var uParam0, var uParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x80B2
{
...
int func_169(char* sParam0, int iParam1, bool bParam2)//Position - 0x8111
{
	Global_3DB9 = 0;
...
bool func_175(int iParam0, int iParam1)//Position - 0x8633
{
	switch (iParam0)
	{
		case 5:
...
void func_177(var uParam0, var uParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x86C5
{
	Global_3B96 = { *uParam0 };
	Global_68F = uParam1;
...
void func_179(int iParam0, var uParam1)//Position - 0x8735
{
	int iVar0;
	...
	func_180(&uLocal_80, Local_44, unk_0xBC25C936A095B5BA(), Local_44.f_1, 0, 1);
	func_180(&uLocal_80, Local_44.f_2, 0, Local_44.f_3, 0, 1);
	Local_44.f_4 = uParam1;
}

void func_180(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x88AB
{
...
void func_181(int iParam0, int iParam1, bool bParam2)//Position - 0x8946
{
	Global_BE9 = iParam0;
	if (Global_75[iParam0 /*10*/].f_8 != 144)
	{
...
void func_183(int iParam0)//Position - 0x8B6D
{
	Local_44.f_6 = unk_0xF07F972D1C76408A(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true));
	func_184(iParam0);
}

void func_184(int iParam0)//Position - 0x8B8C
{
...
char* func_185(int iParam0)//Position - 0xA41B
{
	char* sVar0;
...
int func_186(var uParam0)//Position - 0xA528
{
...
int func_187(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xA57A
{
	int iVar0;
...
void func_188(var uParam0, int iParam1)//Position - 0xA6B1
{
	int iVar0;
...
bool func_189(int iParam0)//Position - 0xA700
{
	return func_190(iParam0, Global_8C41);
}

int func_190(int iParam0, int iParam1)//Position - 0xA711
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_191(int iParam0)//Position - 0xA8F2
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_193(int iParam0)//Position - 0xA93D
{
	if (Global_4213 == 0)
	{
		return 0;
...
void func_195()//Position - 0xA9BC
{
	int iVar0;
	int iVar1;
	
	if (((((((Global_8C41 == 15 && iLocal_37 != 3) && unk_0xFA30DFD0084E92FE(iLocal_49, 5)) && !func_163()) && Global_1153F == -1) && !func_205()) && !func_82(9)) || func_101(35))
	{
		func_204();
		func_203();
		switch (iLocal_39)
	...
	else if (((((((Global_8C41 != 15 || Global_8C41 != 0) || Global_8C41 != 2) || Global_8C41 != 4) || Global_8C41 != 17) || func_163()) || Global_1153F == -1) || Global_19753)
	{
		iVar1 = 0;
		if (func_196())
		{
...
bool func_196()//Position - 0xAB4D
{
	return unk_0x3C406FC829C1E14A(Global_19B04.f_469A.f_18B);
}

void func_197(int iParam0, bool bParam1)//Position - 0xAB63
{
	switch (iLocal_39)
	{
		case 1:
...
void func_198(char* sParam0, int iParam1)//Position - 0xAC73
{
	unk_0x2F618BD43614DD0D(sParam0);
	unk_0x72F8FA06CC9EC899(0, 0, true, iParam1);
}

int func_199()//Position - 0xAC8A
{
...
int func_200(int iParam0)//Position - 0xACA4
{
	int iVar0;
...
int func_201(int iParam0)//Position - 0xACEE
{
	int iVar0;
...
void func_202(int iParam0, int iParam1)//Position - 0xADA5
{
	int iVar0;
	...
	if (iLocal_37 == 0 || iLocal_37 == 1)
	{
		switch (iLocal_38)
		{
			case 0:
				...
				{
					if (((((((!func_2(func_3(7)) && !func_2(func_3(8))) && !func_2(func_3(10))) && !func_2(func_3(11))) && !func_2(func_3(12))) && !func_2(func_3(13))) && !func_196()) && !Global_195B4)
					{
						unk_0xF0059F27F7BB6680(&iLocal_49, 15);
						unk_0x7456702622C62EA0(1);
					}
...
int func_213()//Position - 0xB2EF
{
	if (((((Global_8C41 == 15 && !func_163()) && Global_1153F == -1) && !func_196()) && !func_214(1112014848)) && !Global_19753)
	{
		return 1;
	}
	return 0;
...
int func_214(float fParam0)//Position - 0xB33D
{
	if (iLocal_42 == 1)
	{
...
int func_217(int iParam0)//Position - 0xB449
{
	return func_218(iParam0, 6, 1);
}

int func_218(int iParam0, int iParam1, bool bParam2)//Position - 0xB459
{
	if (bParam2)
	{
...
int func_219(int iParam0, int iParam1, int iParam2)//Position - 0xB4B9
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_269BC5[iParam0 /*3*/][func_220(iParam1)];
...
int func_220(var uParam0)//Position - 0xB4EB
{
	int iVar0;
	int iVar1;
...
int func_221(int iParam0)//Position - 0xB51F
{
	switch (iParam0)
	{
		case 0:
...
int func_222(int iParam0)//Position - 0xB813
{
	if (func_84(iParam0))
	{
...
void func_223(char* sParam0, int iParam1)//Position - 0xB833
{
	int iVar0;
	int iVar1;
	...
	while (iVar0 < Global_19B04.f_4F9D.f_91)
	{
		if (unk_0x3362CDE8460ED38B(sParam0, &(Global_19B04.f_4F9D[iVar0 /*16*/])))
		{
			...
			func_225((Global_19B04.f_4F9D.f_91 - 1));
...
void func_225(int iParam0)//Position - 0xBA00
{
...
void func_226(int iParam0, int iParam1)//Position - 0xBA98
{
...
int func_227(int iParam0)//Position - 0xBBA8
{
...
void func_228(int iParam0)//Position - 0xBBD4
{
	iLocal_42 = iParam0;
	if (iLocal_42 == 0)
	{
...
char* func_230(int iParam0)//Position - 0xBE77
{
	char* sVar0;
...
void func_231()//Position - 0xC03F
{
	...
	if (func_222(unk_0xBC25C936A095B5BA()))
	{
		sLocal_70 = unk_0xF07F972D1C76408A(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true));
	}
}

struct<8> func_232(char* sParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0xD379
{
	struct<8> Var0;
...
void func_233(int iParam0, bool bParam1)//Position - 0xD3A4
{
	if (func_83(iLocal_51))
	{
		func_19(&iLocal_51);
...
int func_234(int iParam0)//Position - 0xD3CC
{
	int iVar0;
	int iVar1;
...
void func_236(bool bParam0)//Position - 0xD44C
{
	char* sVar0;
...
void func_237()//Position - 0xD519
{
	StringCopy(&(Global_899[3 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_238()//Position - 0xD52F
{
	StringCopy(&(Global_899[2 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_239()//Position - 0xD545
{
	StringCopy(&(Global_899[1 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_240()//Position - 0xD55B
{
	StringCopy(&(Global_899[0 /*16*/].f_8), "CELL_SFUN_NULL", 32);
}

void func_241(char* sParam0)//Position - 0xD571
{
	StringCopy(&(Global_899[0 /*16*/].f_8), sParam0, 32);
}

void func_242(char* sParam0)//Position - 0xD585
{
	StringCopy(&(Global_899[2 /*16*/].f_8), sParam0, 32);
}

void func_243(char* sParam0)//Position - 0xD599
{
	StringCopy(&(Global_899[1 /*16*/].f_8), sParam0, 32);
}

void func_244(char* sParam0)//Position - 0xD5AD
{
	StringCopy(&(Global_899[3 /*16*/].f_8), sParam0, 32);
}

void func_245(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0xD5C1
{
	func_246(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_246(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0xD5E1
{
	int iVar0;
...
int func_247(var uParam0, int iParam1)//Position - 0xD7B3
{
	if (iParam1 == -1)
	{
		return 0;
...
float func_248(int iParam0)//Position - 0xD7FE
{
	if (iParam0 == -1)
	{
		return 0f;
...
Vector3 func_249(int iParam0)//Position - 0xD834
{
	if (iParam0 == -1)
	{
		return 0f, 0f, 0f;
...
int func_250(int iParam0)//Position - 0xD86E
{
	int iVar0;
	int iVar1;
