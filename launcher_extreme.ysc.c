...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_54 = -1;
	iLocal_56 = unk_0x2F079D1FC5F6CB99();
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_279(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_267(&Var0, 1);
	}
	...
	if (Var0 == 17)
	{
		iLocal_57 = unk_0x1DAA351326EA3537(vVar1 - Vector(40f, 40f, 40f), vVar1 + Vector(40f, 40f, 40f), 0, 1, 1, 1);
		unk_0xD0FC9D284379BED4("WORLD_VEHICLE_SALTON_DIRT_BIKE", 0);
	}
	else if (Var0 == 18)
	{
		iLocal_57 = unk_0x1DAA351326EA3537(-1040f, -2870f, 0f, -910f, -2740f, 50f, 0, 0, 1, 1);
	}
	...
	while (true)
	{
		...
		{
			func_191(&Var0);
			if (unk_0x1BD5EE88F32433CD(iLocal_56))
			{
				func_186(&Var0, vVar1, "EXT3AUD", "EXT_AMB", 3, "DOM", 8000, 1101004800);
			}
			if ((((((!func_185() && func_184(Var0.f_1C[0])) && !unk_0x8C2668F45F2BB3F2(Var0.f_1C[0])) && unk_0x1BD5EE88F32433CD(iLocal_56)) && unk_0x284F2ACE6839D3C0("EXTREME_04_DOM_A", false, -1)) && unk_0x284F2ACE6839D3C0("EXTREME_04_DOM_B", false, -1)) && unk_0x284F2ACE6839D3C0("EXTREME_04_DOM_C", false, -1))
			{
				unk_0xF2C27FE5A8B98CB5(iLocal_56, "DOM_BREATHING", Var0.f_1C[0], "EXTREME_03_SOUNDSET", 0, 0);
			}
			if ((iLocal_55 == 0 && func_184(unk_0xBC25C936A095B5BA())) && unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vVar1, Var0.f_F, Var0.f_F, Var0.f_F, false, false, 0))
			{
		...
		if (func_168(&Var0, 0) || func_166(&Var0))
		{
			...
			{
				unk_0x38FF8CB6377D36F6(iLocal_56);
			}
			if (func_1(&Var0))
			{
				func_267(&Var0, 0);
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x62D7
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x631E
{
...
bool func_70(int iParam0)//Position - 0x6379
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6389
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x63E9
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x66DD
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x66E8
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x66F8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x679A
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6D54
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6DB2
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6E60
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6EF5
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6F39
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x70BD
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x70CB
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7B92
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7C14
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7C72
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7C7B
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7E4E
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7E5E
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x80F9
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x810A
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x8150
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x81D6
{
...
void func_94(var uParam0, int iParam1)//Position - 0x8209
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x825A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x82FC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8321
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x8338
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x8345
{
...
void func_100(var uParam0, int iParam1)//Position - 0x837F
{
...
void func_101(var uParam0, int iParam1)//Position - 0x83BA
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x83F6
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x840F
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x8468
{
...
bool func_105(bool bParam0)//Position - 0x84AA
{
...
struct<2> func_106(int iParam0)//Position - 0x84D5
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8922
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9BFA
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9F40
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9FE4
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0xA07F
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0xA0DD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA136
{
...
int func_116(int iParam0)//Position - 0xA1B9
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA1EA
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA1FF
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA2B2
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA2CD
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA319
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA362
{
	if (func_184(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA382
{
	switch (iParam0)
	{
		case 5:
...
int func_126(int iParam0)//Position - 0xA452
{
	switch (iParam0)
	{
		case 5:
...
void func_127(var uParam0, bool bParam1, bool bParam2)//Position - 0xA4A5
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_184(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_184(uParam0->f_29[iVar0]))
		{
...
int func_128(int iParam0)//Position - 0xA59A
{
	switch (iParam0)
	{
		case 5:
...
void func_129(bool bParam0)//Position - 0xA605
{
	int iVar0;
...
void func_130(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA642
{
	if (bParam0)
	{
...
int func_133(int iParam0, bool bParam1)//Position - 0xA7D3
{
	int iVar0;
	int iVar1;
...
int func_134(int iParam0)//Position - 0xA814
{
...
bool func_135()//Position - 0xA856
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_136(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA867
{
	int iVar0;
...
void func_138(int iParam0)//Position - 0xA8C1
{
	if (iParam0 == 1)
	{
...
int func_139(char* sParam0)//Position - 0xA8E4
{
...
void func_140()//Position - 0xA921
{
	Global_394A = 0;
	func_141();
}

void func_141()//Position - 0xA931
{
...
int func_144(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA9F5
{
...
void func_145(int iParam0)//Position - 0xAB84
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_147(int iParam0)//Position - 0xAC01
{
...
void func_148(int iParam0)//Position - 0xAC2A
{
	if (Global_3943)
	{
		func_149(0, 0);
...
void func_149(bool bParam0, bool bParam1)//Position - 0xAC9A
{
	if (bParam0)
	{
		if (func_150(0))
...
int func_150(int iParam0)//Position - 0xAD0E
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_151(int iParam0)//Position - 0xAD68
{
...
int func_152(int iParam0)//Position - 0xADA9
{
	int iVar0;
	...
	iVar0 = func_154(&(Global_19773[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_153(int iParam0)//Position - 0xADEE
{
...
int func_154(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAE20
{
	int iVar0;
...
void func_155(var uParam0, int iParam1)//Position - 0xAF57
{
	int iVar0;
...
bool func_156(int iParam0)//Position - 0xAFA6
{
	return func_157(iParam0, Global_8C41);
}

int func_157(int iParam0, int iParam1)//Position - 0xAFB7
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_158(int iParam0)//Position - 0xB198
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_159()//Position - 0xB1BA
{
	return func_160(unk_0x1377080E9B0BD993(), 0);
}

int func_160(char* sParam0, int iParam1)//Position - 0xB1CB
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_162(int iParam0, int iParam1)//Position - 0xB238
{
	switch (iParam0)
	{
		case 0:
...
int func_163(vector3 vParam0, bool bParam1)//Position - 0xB6BF
{
	int iVar0;
	
	iVar0 = unk_0x390CF6C8AD6903B7(vParam0);
	unk_0x3F5F1772D71D5EC4(iVar0, func_164(unk_0x7AF0088ABFA713B6(), 1f, 1f));
	unk_0x0BBAABB52887CF8C(iVar0, bParam1);
	return iVar0;
}

float func_164(bool bParam0, float fParam1, float fParam2)//Position - 0xB6EB
{
	if (bParam0)
	{
		return fParam1;
...
int func_165(int iParam0)//Position - 0xB702
{
	switch (iParam0)
	{
		case 0:
...
int func_166(var uParam0)//Position - 0xB791
{
	if (*uParam0 == 18)
	{
		if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -954.5357f, -2760.553f, 11.91636f, -947.6847f, -2749.719f, 15.63161f, 26f, 0, true, 0))
		{
			if (!unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
			{
...
int func_167(int iParam0, int iParam1)//Position - 0xB838
{
	if (func_123(iParam0))
	{
...
int func_168(var uParam0, int iParam1)//Position - 0xB86B
{
	switch (uParam0->f_10)
	{
		case 0:
			if (*uParam0 == 12)
			{
				...
				else if (func_184(uParam0->f_1C[0]))
				{
					if (func_170(uParam0))
					{
						if (func_174(2))
...
void func_169()//Position - 0xC050
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_170(var uParam0)//Position - 0xC06B
{
	float fVar0;
...
void func_171(int iParam0, int iParam1)//Position - 0xC0F9
{
	if (iParam0 == 1)
	{
		if (!func_126(iParam1))
...
int func_172(bool bParam0)//Position - 0xC15D
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0xC1F4
{
	if (func_184(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
var func_175()//Position - 0xC93B
{
	return Global_16B42.f_1;
}

int func_176()//Position - 0xC949
{
	if (Global_15FA6 != -1)
	{
...
bool func_179()//Position - 0xC9B3
{
	return Global_16B4F.f_142 > 0;
}

bool func_180(int iParam0, int iParam1)//Position - 0xC9C4
{
	switch (iParam0)
	{
		case 5:
...
var func_181()//Position - 0xC9FF
{
	return Global_140856;
}

int func_182()//Position - 0xCA0B
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
void func_183(char* sParam0, int iParam1)//Position - 0xCA27
{
	unk_0x2F618BD43614DD0D(sParam0);
	unk_0x72F8FA06CC9EC899(0, 0, true, iParam1);
}

int func_184(int iParam0)//Position - 0xCA3E
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
...
int func_186(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCA81
{
	var uVar0;
	
	if ((((func_184(unk_0xBC25C936A095B5BA()) && func_184(iParam0->f_1C[0])) && !func_185()) && (unk_0x105601648511CC64() - iParam0->f_3C) > iParam6) && func_190(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_189(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_187(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCB09
{
...
void func_188(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCB44
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_189(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCB9A
{
...
float func_190(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCC35
{
	vector3 vVar0;
...
void func_191(int iParam0)//Position - 0xCC6F
{
	if (unk_0xA5A42DEC1470C5A9())
	{
		if (func_184(iParam0->f_1C[0]))
		{
			unk_0x2C5D30EE32747F1F("Dom", iParam0->f_1C[0], 0);
		}
	}
}

void func_192(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xCC9C
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_190(unk_0xBC25C936A095B5BA(), vParam2, 1) <= 100f)
				{
					func_195(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_190(unk_0xBC25C936A095B5BA(), vParam2, 1) > 120f)
				{
					func_197(iParam0);
				}
			}
...
void func_193(int iParam0, bool bParam1)//Position - 0xCD8D
{
	if (iParam0 == -1)
	{
		return;
...
int func_194(int iParam0)//Position - 0xCDC9
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_195(int iParam0, int iParam1)//Position - 0xCE02
{
	bool bVar0;
	int iVar1;
...
bool func_196()//Position - 0xCEA0
{
	return Global_16129;
}

void func_197(int iParam0)//Position - 0xCEAC
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_198(iParam0);
...
void func_198(int iParam0)//Position - 0xCEC3
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_199(int iParam0)//Position - 0xCFAB
{
	if (iParam0 == -1)
	{
		iParam0 = func_159();
...
int func_200(var uParam0, bool bParam1)//Position - 0xCFD3
{
	struct<27> Var0;
	...
	if ((func_237(*uParam0) || func_235(*uParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
	...
	if (func_204(&(uParam0->f_30)) && bParam1)
	{
		func_201(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_201(int iParam0, var uParam1, int iParam2)//Position - 0xD246
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_203(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_203(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_202(int iParam0)//Position - 0xD59E
{
...
int func_203(var uParam0)//Position - 0xD5BE
{
...
int func_204(var uParam0)//Position - 0xD5D6
{
...
void func_205(var uParam0)//Position - 0xD5FB
{
	int iVar0;
	int iVar1;
...
void func_206(int iParam0)//Position - 0xD8FF
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_207(var uParam0)//Position - 0xD92A
{
	int iVar0;
...
int func_208(var uParam0, bool bParam1, bool bParam2)//Position - 0xD9AA
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_209(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_209(int iParam0, int iParam1)//Position - 0xDB68
{
	int iVar0;
...
int func_210(var uParam0, bool bParam1, int iParam2)//Position - 0xDB98
{
	int iVar0;
	int iVar1;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_1C[iVar0]))
			{
				if (!unk_0x36CEFBE9B745A58D(uParam0->f_1C[iVar0]))
				{
					...
					if (func_229(*uParam0))
					{
						if (!func_151(*uParam0))
						{
							if (func_224(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_205(uParam0);
						...
						if (func_212(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_205(uParam0);
...
int func_211(int iParam0)//Position - 0xDE54
{
...
int func_212(int iParam0, float fParam1)//Position - 0xDE88
{
	float fVar0;
...
bool func_213(int iParam0, float fParam1)//Position - 0xDEFE
{
	return func_214(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_214(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDF16
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_215(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDFD7
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_216(int iParam0, int iParam1)//Position - 0xE103
{
	int iVar0;
...
int func_218(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE212
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_220(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_220(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_219(vector3 vParam0, vector3 vParam1)//Position - 0xE2A3
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_220(vector3 vParam0)//Position - 0xE2C4
{
	float fVar0;
	float fVar1;
...
void func_221(var uParam0)//Position - 0xE303
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_222(int iParam0, int iParam1)//Position - 0xE31E
{
	int iVar0;
...
int func_223(int iParam0)//Position - 0xE35D
{
...
int func_224(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE385
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_225(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE480
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_226(int iParam0, float fParam1)//Position - 0xE58C
{
	var uVar0;
	vector3 vVar1;
...
int func_227(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE621
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_220(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_228(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE6AF
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_229(int iParam0)//Position - 0xE6F7
{
...
void func_230(int iParam0)//Position - 0xE741
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xE7DE
{
	if (iParam0 == -1)
	{
		iParam0 = func_159();
...
int func_232(int iParam0)//Position - 0xE876
{
...
int func_235(int iParam0)//Position - 0xE8F8
{
	if ((func_236() && Global_16B1B.f_B == 6) && iParam0 == func_160(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_237(int iParam0)//Position - 0xE96A
{
	if (func_105(0))
	{
...
int func_238(int iParam0)//Position - 0xE992
{
	switch (*iParam0)
	{
		case 17:
...
int func_239(var uParam0)//Position - 0xEA07
{
	int iVar0[1];
	int iVar1;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_245(&(uParam0->f_30), "rcmextreme4", "idle_a", "idle_c");
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_244(&iVar0) || !func_243(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			func_240(&(uParam0->f_1C[0]), 1732.27f, 96.36f, 170.29f, -98.56f);
...
void func_240(int iParam0, vector3 vParam1, float fParam2)//Position - 0xEB0B
{
...
void func_241(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xEB3D
{
	func_242(iParam0);
	*iParam0 = unk_0x01B3635C3E8EDD81(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_242(int iParam0)//Position - 0xEB5E
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
int func_243(var uParam0)//Position - 0xEB9F
{
	if (func_204(uParam0))
	{
...
int func_244(int iParam0)//Position - 0xEBC9
{
	int iVar0;
...
void func_245(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xEBFA
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_246(var uParam0)//Position - 0xEC36
{
	int iVar0[1];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_245(&(uParam0->f_30), "rcmextreme3", "idle_calm", "fidget_02");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_247(&(uParam0->f_1C[0]), 52, -63.8f, -809.5f, 321.8f, -62f, "EXTREME LAUNCHER RC", 1))
				{
					unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[0], 118, false);
					unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[0], 208, true);
					unk_0x7A535CE1F001F3FE(uParam0->f_1C[0], joaat("gadget_parachute"), 1, false, false);
...
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xEDC9
{
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xEE25
{
	int iVar0;
...
int func_249(var uParam0, int iParam1)//Position - 0xEEB3
{
	int iVar0;
...
int func_250(var uParam0)//Position - 0xEEF9
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_245(&(uParam0->f_30), "rcmextreme2", "sitting_idle", "loop_punching");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_247(&(uParam0->f_1C[0]), 52, -954.19f, -2760.05f, 14.64f, -31.79f, "EXTREME LAUNCHER RC", 1))
				{
					unk_0xD5874E4A4BF782FC(uParam0->f_1C[0], -954.2f, -2760.05f, 14.04f, 1, 0, 1);
					unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[0], 118, false);
					unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[0], 208, true);
					unk_0x346478B12F69D4E3(uParam0->f_1C[0], true);
					unk_0xD434A01DEA38A939(uParam0->f_1C[0], false, 0);
					unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[0], 8, 1, 0, 0);
					unk_0xE896C0AD02364F2A(uParam0->f_1C[0], uParam0->f_30, uParam0->f_30.f_1, 8f, -8f, -1, 33281, 0, 0, 0, 0);
					if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
					{
						unk_0x56F2E1B5599188FA(uParam0->f_1C[0], unk_0xBC25C936A095B5BA(), -1, 48, 2);
					}
				}
				else
				{
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_251(&(uParam0->f_23[0]), iVar0[0], -950.8f, -2751.98f, 13.21f, 199.05f);
				unk_0xD421BC740C5340C3(uParam0->f_23[0], 2);
				unk_0x6012A6A4F2950585(uParam0->f_23[0], 0);
				unk_0x55AFEE10B3CE5C2C(uParam0->f_23[0], 0f);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_23[1]))
			{
				func_251(&(uParam0->f_23[1]), iVar0[0], -950.192f, -2755.96f, 13.3639f, -178.182f);
				unk_0xD421BC740C5340C3(uParam0->f_23[1], 2);
				unk_0x6012A6A4F2950585(uParam0->f_23[1], 1);
				unk_0x55AFEE10B3CE5C2C(uParam0->f_23[1], 0f);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_23[2]))
			{
				func_251(&(uParam0->f_23[2]), iVar0[1], -957.23f, -2764.89f, 14.04f, 147.61f);
				unk_0xD421BC740C5340C3(uParam0->f_23[2], 2);
				unk_0x6012A6A4F2950585(uParam0->f_23[2], 2);
				unk_0x55AFEE10B3CE5C2C(uParam0->f_23[2], 0f);
				unk_0x8300C56586249382(uParam0->f_23[2], 0);
				unk_0xD38EB677CBE7440A(uParam0->f_23[2], false, 0);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF1FD
{
	func_252(iParam0);
...
void func_252(int iParam0)//Position - 0xF23F
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x5CAE759AE8219D20(*iParam0))
...
int func_253(var uParam0)//Position - 0xF2DB
{
	int iVar0[1];
	int iVar1;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_245(&(uParam0->f_30), "rcm_extreme1", "idle_a", "idle_c");
			iLocal_51 = 1;
			break;
		...
		case 2:
			func_240(&(uParam0->f_1C[0]), -188.22f, 1296.1f, 302.86f, 43.7f);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				unk_0x2CA123B0622F495C(iVar0[iVar1]);
...
int func_254(int iParam0)//Position - 0xF3C7
{
	struct<27> Var0;
	int iVar1;
...
int func_255(int iParam0)//Position - 0xF41B
{
	char* sVar0;
...
int func_256(int iParam0)//Position - 0xF4D4
{
	var uVar0;
...
int func_257(int iParam0)//Position - 0xF595
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_258(int iParam0, char* sParam1)//Position - 0xF61A
{
...
bool func_259(int iParam0)//Position - 0xF6FC
{
...
bool func_260(int iParam0)//Position - 0xF72A
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_261(int iParam0)//Position - 0xF758
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_262(int iParam0)//Position - 0xF786
{
	if (func_232(iParam0))
	{
		return 0;
...
void func_263()//Position - 0xF7BB
{
	func_280("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_264(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF7D5
{
	int iVar0;
...
int func_265(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xF83A
{
	int iVar0;
	struct<7> Var1;
...
int func_266(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xF8B8
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_267(int iParam0, bool bParam1)//Position - 0xF933
{
	if (*iParam0 == 18)
	{
		if (func_184(iParam0->f_23[0]))
		{
			unk_0xD421BC740C5340C3(iParam0->f_23[0], 1);
		}
		if (func_184(iParam0->f_23[1]))
		{
			unk_0xD421BC740C5340C3(iParam0->f_23[1], 1);
		}
	}
	if (bParam1)
	{
...
int func_268(var uParam0)//Position - 0xFA14
{
	if (func_204(uParam0))
	{
		if (unk_0xF9E082857622D91E(*uParam0))
...
void func_269(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFA4A
{
...
void func_270(var uParam0, bool bParam1)//Position - 0xFA6A
{
	func_271(&(uParam0->f_29), bParam1);
}

void func_271(var uParam0, bool bParam1)//Position - 0xFA7C
{
	int iVar0;
...
void func_272(int iParam0, bool bParam1)//Position - 0xFABA
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_273(var uParam0, bool bParam1)//Position - 0xFAF5
{
	func_274(&(uParam0->f_23), bParam1);
}

void func_274(var uParam0, bool bParam1)//Position - 0xFB07
{
	int iVar0;
...
void func_275(int iParam0)//Position - 0xFB44
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_276(var uParam0, int iParam1)//Position - 0xFB7C
{
	func_277(&(uParam0->f_1C), iParam1);
}

void func_277(var uParam0, int iParam1)//Position - 0xFB8E
{
	int iVar0;
...
void func_278(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFBCF
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_279(var uParam0)//Position - 0xFC1F
{
	if (*uParam0 == -1)
	{
		return;
...
void func_280(char* sParam0)//Position - 0xFC5C
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_281(var uParam0)//Position - 0xFC6E
{
	*uParam0 = -1;
...
void func_282()//Position - 0xFCA1
{
	func_280("Running start routines.");
	Global_199EA++;
}

int func_283(int iParam0)//Position - 0xFCBB
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
