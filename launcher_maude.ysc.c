	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_264(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_248(&Var0, 1);
	}
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x60D5
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x611C
{
...
bool func_70(int iParam0)//Position - 0x6177
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6187
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x61E7
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x64DB
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x64E6
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x64F6
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6598
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6B52
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6BB0
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6C5E
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6CF3
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6D37
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6EBB
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6EC9
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7990
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7A12
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7A70
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7A79
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7C4C
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7C5C
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7EF6
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x7F07
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7F4D
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x7FD3
{
...
void func_94(var uParam0, int iParam1)//Position - 0x8007
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x8058
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x80FA
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x811F
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x8136
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x8143
{
...
void func_100(var uParam0, int iParam1)//Position - 0x817D
{
...
void func_101(var uParam0, int iParam1)//Position - 0x81B8
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x81F4
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x820D
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x8266
{
...
bool func_105(bool bParam0)//Position - 0x82A8
{
...
struct<2> func_106(int iParam0)//Position - 0x82D3
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8720
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x99F8
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9D3E
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9DE2
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9E7D
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9EDB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9F34
{
...
int func_116(int iParam0)//Position - 0x9FB7
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x9FE8
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x9FFD
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA0B0
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA0CB
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA117
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA160
{
	if (func_124(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA180
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA1A1
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA271
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA2C4
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA3B9
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA424
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA461
{
	if (bParam0)
	{
...
int func_134(int iParam0, bool bParam1)//Position - 0xA5F2
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA633
{
...
bool func_136()//Position - 0xA675
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA686
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA6E0
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA703
{
...
void func_141()//Position - 0xA740
{
	Global_394A = 0;
	func_142();
}

void func_142()//Position - 0xA750
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA836
{
...
void func_147(int iParam0)//Position - 0xA9C5
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAA42
{
...
void func_150(int iParam0)//Position - 0xAA6B
{
	if (Global_3943)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAADB
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAB4F
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xABA9
{
...
int func_154(int iParam0)//Position - 0xABEA
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAC2F
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAC61
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAD98
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xADE7
{
	return func_159(iParam0, Global_8C41);
}

int func_159(int iParam0, int iParam1)//Position - 0xADF8
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xAFD9
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_161()//Position - 0xAFFB
{
	return func_162(unk_0x1377080E9B0BD993(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB00C
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(var uParam0, int iParam1)//Position - 0xB079
{
	switch (uParam0->f_10)
	{
		case 0:
...
void func_165()//Position - 0xB85C
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB877
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB905
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xB969
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xBA00
{
	if (func_124(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_170(int iParam0)//Position - 0xBA2A
{
	int iVar0;
...
var func_171()//Position - 0xC149
{
	return Global_16B42.f_1;
}

int func_172()//Position - 0xC157
{
	if (Global_15FA6 != -1)
	{
...
bool func_175()//Position - 0xC1C1
{
	return Global_16B4F.f_142 > 0;
}

bool func_176(int iParam0, int iParam1)//Position - 0xC1D2
{
	switch (iParam0)
	{
		case 5:
...
var func_177()//Position - 0xC20D
{
	return Global_140856;
}

int func_178()//Position - 0xC219
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
void func_179(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC235
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
...
void func_180(int iParam0, bool bParam1)//Position - 0xC326
{
	if (iParam0 == -1)
	{
		return;
...
int func_181(int iParam0)//Position - 0xC362
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_182(int iParam0, int iParam1)//Position - 0xC39B
{
	bool bVar0;
	int iVar1;
...
float func_183(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC439
{
	vector3 vVar0;
...
bool func_184()//Position - 0xC473
{
	return Global_16129;
}

void func_185(int iParam0)//Position - 0xC47F
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_186(iParam0);
...
void func_186(int iParam0)//Position - 0xC496
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_187(int iParam0)//Position - 0xC57E
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_188(var uParam0, bool bParam1)//Position - 0xC5A6
{
	struct<27> Var0;
	...
	if ((func_225(*uParam0) || func_223(*uParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
	...
	if (func_192(&(uParam0->f_30)) && bParam1)
	{
		func_189(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_189(int iParam0, var uParam1, int iParam2)//Position - 0xC819
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_191(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_191(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_190(int iParam0)//Position - 0xCB71
{
...
int func_191(var uParam0)//Position - 0xCB91
{
...
int func_192(var uParam0)//Position - 0xCBA9
{
...
void func_193(var uParam0)//Position - 0xCBCE
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_194(&(uParam0->f_29[1]));
		func_194(&(uParam0->f_29[2]));
	}
...
void func_194(int iParam0)//Position - 0xCED2
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_195(var uParam0)//Position - 0xCEFD
{
	int iVar0;
...
int func_196(var uParam0, bool bParam1, bool bParam2)//Position - 0xCF7D
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_197(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_197(int iParam0, int iParam1)//Position - 0xD13B
{
	int iVar0;
...
int func_198(var uParam0, bool bParam1, int iParam2)//Position - 0xD16B
{
	int iVar0;
	int iVar1;
...
int func_199(int iParam0)//Position - 0xD427
{
...
int func_200(int iParam0, float fParam1)//Position - 0xD45B
{
	float fVar0;
...
bool func_201(int iParam0, float fParam1)//Position - 0xD4D1
{
	return func_202(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_202(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD4E9
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_203(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD5AA
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_204(int iParam0, int iParam1)//Position - 0xD6D6
{
	int iVar0;
...
int func_206(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xD7E5
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_208(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_208(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_207(vector3 vParam0, vector3 vParam1)//Position - 0xD876
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_208(vector3 vParam0)//Position - 0xD897
{
	float fVar0;
	float fVar1;
...
void func_209(var uParam0)//Position - 0xD8D6
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_210(int iParam0, int iParam1)//Position - 0xD8F1
{
	int iVar0;
...
int func_211(int iParam0)//Position - 0xD930
{
...
int func_212(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xD958
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_213(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDA53
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_214(int iParam0, float fParam1)//Position - 0xDB5F
{
	var uVar0;
	vector3 vVar1;
...
int func_215(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xDBF4
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_208(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_216(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDC82
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_217(int iParam0)//Position - 0xDCCA
{
...
void func_218(int iParam0)//Position - 0xDD14
{
	int iVar0;
...
int func_219(int iParam0)//Position - 0xDDB1
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_220(int iParam0)//Position - 0xDE49
{
...
int func_223(int iParam0)//Position - 0xDECB
{
	if ((func_224() && Global_16B1B.f_B == 6) && iParam0 == func_162(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_225(int iParam0)//Position - 0xDF3D
{
	if (func_105(0))
	{
...
int func_226(int iParam0)//Position - 0xDF65
{
	if (!func_227(iParam0))
	{
		return 0;
...
int func_227(var uParam0)//Position - 0xDF84
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				func_231(&(uParam0->f_29[0]), iVar0[1], 2728.35f, 4145.59f, 43.3f, -91.28f);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_29[1]))
			{
				func_231(&(uParam0->f_29[1]), iVar0[2], 2727.686f, 4145.715f, 44.08f, 71f);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (!func_228(&(uParam0->f_1C[0]), 62, 2728.33f, 4145.6f, 43.89f, 89.19f, "RC MAUDE 1", 1))
				{
					bVar2 = false;
				}
			}
		...
		case 3:
			if (func_123(uParam0->f_1C[0]) && func_124(uParam0->f_29[0]))
			{
...
int func_228(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xE21C
{
...
int func_229(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xE278
{
	int iVar0;
...
int func_230(var uParam0, int iParam1)//Position - 0xE306
{
	int iVar0;
...
void func_231(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE34C
{
	func_194(iParam0);
...
int func_232(int iParam0)//Position - 0xE373
{
	int iVar0;
...
void func_233(int iParam0, bool bParam1, bool bParam2)//Position - 0xE3A4
{
	vector3 vVar0;
	vector3 vVar1;
	...
	switch (iParam0)
	{
		case 31:
			if (bParam1)
			{
				iLocal_52 = unk_0x1DAA351326EA3537(vVar0, vVar1, 0, 1, 1, 1);
...
int func_234(int iParam0)//Position - 0xE4A4
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
...
int func_235(int iParam0)//Position - 0xE4CF
{
	struct<27> Var0;
	int iVar1;
...
int func_236(int iParam0)//Position - 0xE523
{
	char* sVar0;
...
int func_237(int iParam0)//Position - 0xE5DC
{
	var uVar0;
...
int func_238(int iParam0)//Position - 0xE69D
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_239(int iParam0, char* sParam1)//Position - 0xE722
{
...
bool func_240(int iParam0)//Position - 0xE804
{
...
bool func_241(int iParam0)//Position - 0xE832
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_242(int iParam0)//Position - 0xE860
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_243(int iParam0)//Position - 0xE88E
{
	if (func_220(iParam0))
	{
		return 0;
...
void func_244()//Position - 0xE8C3
{
	func_265("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_245(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE8DD
{
	int iVar0;
...
int func_246(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xE942
{
	int iVar0;
	struct<7> Var1;
...
int func_247(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xE9C0
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_248(int iParam0, bool bParam1)//Position - 0xEA3B
{
	if (bParam1)
	{
...
int func_249(var uParam0)//Position - 0xEAA0
{
	if (func_192(uParam0))
	{
...
void func_250(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEAD6
{
...
void func_251(var uParam0, bool bParam1)//Position - 0xEAF6
{
	func_252(&(uParam0->f_29), bParam1);
}

void func_252(var uParam0, bool bParam1)//Position - 0xEB08
{
	int iVar0;
...
void func_253(int iParam0, bool bParam1)//Position - 0xEB46
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_254(var uParam0, bool bParam1)//Position - 0xEB81
{
	func_255(&(uParam0->f_23), bParam1);
}

void func_255(var uParam0, bool bParam1)//Position - 0xEB93
{
	int iVar0;
...
void func_256(int iParam0)//Position - 0xEBD0
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_257(int iParam0)//Position - 0xEC08
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_258(var uParam0, int iParam1)//Position - 0xECA4
{
	func_259(&(uParam0->f_1C), iParam1);
}

void func_259(var uParam0, int iParam1)//Position - 0xECB6
{
	int iVar0;
...
void func_260(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xECF7
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_261(int iParam0)//Position - 0xED47
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_262(var uParam0)//Position - 0xED88
{
	if (unk_0x77FC50899603581D(uParam0->f_3B))
	{
		if (func_123(uParam0->f_1C[0]))
		{
			if (func_263(uParam0->f_1C[0], 1785177548))
			{
		...
		if (func_124(uParam0->f_29[0]))
		{
			unk_0x6C3BE67B02D72CDC(uParam0->f_29[0], -1000f, 1);
		}
	}
}

int func_263(int iParam0, int iParam1)//Position - 0xEDF9
{
	if (func_123(iParam0))
	{
...
void func_264(var uParam0)//Position - 0xEE2C
{
	if (*uParam0 == -1)
	{
		return;
...
void func_265(char* sParam0)//Position - 0xEE69
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_266(var uParam0)//Position - 0xEE7B
{
	*uParam0 = -1;
