...
void __EntryFunction__()//Position - 0x0
{
	...
	func_24(vVar0);
	bLocal_4 = func_4();
	vLocal_5 = { unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), false) };
	func_1();
	while (true)
	{
		SYSTEM::WAIT(0);
		...
		if (func_3(iVar0, &iVar1, &vVar2, &vVar3, &iVar5))
		{
			if (func_2(vVar3, 0f, 0f, 0f, 0))
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x249B372087B496EC(iVar1, vVar2, iVar4, iVar5, 1, 0);
					}
				}
				else if (SYSTEM::VDIST2(vVar2, vLocal_5) > 400f)
				{
					...
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
						{
							iLocal_3[iVar0] = unk_0x249B372087B496EC(iVar1, vVar2, iVar4, -1, 1, 0);
						}
					}
					else
					{
			...
			else
			{
				...
				if (iVar1 == joaat("pickup_money_case"))
				{
					if (bLocal_4)
					{
						iLocal_3[iVar0] = unk_0x37B86314BDCAA6F0(iVar1, vVar2, vVar3, iVar4, 10000, 2, 1, 0);
					}
				}
				else if (SYSTEM::VDIST2(vVar2, vLocal_5) > 400f)
				{
					if (iVar1 == joaat("pickup_armour_standard"))
					{
						iLocal_3[iVar0] = unk_0x37B86314BDCAA6F0(iVar1, vVar2, vVar3, iVar4, -1, 2, 1, 0);
					}
					else if ((iVar1 == joaat("pickup_weapon_grenadelauncher") || iVar1 == joaat("pickup_weapon_rpg")) || iVar1 == joaat("pickup_weapon_mg"))
					{
						if (bLocal_4)
...
int func_4()//Position - 0x17D8
{
	if (Global_2585E9 == -15)
	{
		Global_2585E9 = func_23();
		func_15(&Global_2585E9, 0, 0, 0, 1, 0, 0);
		return 1;
	}
	if (func_5(func_23(), Global_2585E9))
	{
		Global_2585E9 = func_23();
		func_15(&Global_2585E9, 0, 0, 0, 1, 0, 0);
		return 1;
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_12(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}
...
void func_27()//Position - 0x20E1
{
	...
	while (iVar0 < 20)
	{
		if (unk_0xA901403F1DB7A780(iLocal_3[iVar0]))
		{
			unk_0x9680DF46F29C0428(iLocal_3[iVar0]);
		}
		iVar0++;
	}
}
