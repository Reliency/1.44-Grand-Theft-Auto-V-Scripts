...
void __EntryFunction__()//Position - 0x0
{
	...
	else if (func_428(0))
	{
		...
		{
			func_426(unk_0xBC25C936A095B5BA(), vLocal_333, fLocal_117, 0, 0);
	...
	while (true)
	{
		if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
		{
			...
			vLocal_331 = { unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1) };
			func_415();
			func_414();
			switch (iLocal_58)
			{
		...
		switch (iLocal_58)
		{
			case 0:
				if (iLocal_60 == 1)
				{
					if (!func_69())
					{
						func_18(unk_0xBC25C936A095B5BA(), vLocal_334, fLocal_118, 0, 1);
						if (func_21(Local_68.f_9))
						{
							func_17(unk_0xBC25C936A095B5BA(), unk_0x541C2AEF053615BC(Local_68.f_9, 1));
						}
						unk_0xF3F01A78937DC905(0f);
						unk_0x2B9AEC08E469E384(0f, 1065353216);
						if (iLocal_104 == 0)
			...
			case 1:
				...
				if (iLocal_60 == 1)
				{
					if (!func_69())
					{
						func_18(unk_0xBC25C936A095B5BA(), vLocal_335, fLocal_119, 0, 1);
						unk_0xF3F01A78937DC905(0f);
						unk_0x2B9AEC08E469E384(0f, 1065353216);
						if (iLocal_104 == 0)
						{
					...
					Local_68.f_11 = (unk_0x105601648511CC64() - 5000);
					func_7();
					iLocal_60 = 2;
				}
				break;
				...
				if (iLocal_60 == 1)
				{
					...
					if (iLocal_132 > 0)
					{
						...
						while (iVar0 <= (iLocal_132 - 1))
						{
							...
							{
								unk_0x7938BAFD9CE579F9(Local_69[iVar0 /*19*/], joaat("weapon_sniperrifle"));
			...
			case 3:
				...
				if (iLocal_60 == 1)
				{
					...
					if (!func_69())
					{
						func_426(unk_0xBC25C936A095B5BA(), vLocal_330, 254.9762f, 0, 0);
						unk_0xF3F01A78937DC905(0f);
						unk_0x2B9AEC08E469E384(0f, 1065353216);
						if (iLocal_104 == 0)
						{
...
int func_3(int iParam0, float fParam1)//Position - 0x65F
{
	...
	if (func_21(iParam0))
	{
		if (func_4(unk_0x541C2AEF053615BC(iParam0, 1), &vVar0, fParam1, 0))
		{
...
bool func_4(vector3 vParam0, var uParam1, float fParam2, int iParam3)//Position - 0x6A7
{
	...
	vVar1 = { unk_0x89D97EB4FAE4A574(vParam0, unk_0x55AEFCD285ECC0F2(0f, 360f), 0f, fParam2, 0f) };
	if (unk_0x2084D4C6C2DF616F(vVar1, &uVar0, 0, 0))
	{
		vVar1.z = uVar0;
	}
	*uParam1 = { vVar1 };
	return unk_0xF5D5237E20BDAEE6(vVar1, iParam3, uParam1, 0);
}
...
void func_17(int iParam0, struct<2> Param1, float fParam2)//Position - 0x9B3
{
	...
	if (fVar3 != 0f)
	{
		fVar1 = unk_0xE8CFCB6B2165523B(fVar2, fVar3);
	}
	else if (fVar2 < 0f)
	{
		fVar1 = -90f;
	...
	fVar1 = (fVar1 * -1f);
	unk_0x019CE76D5286C95C(iParam0, fVar1);
}
...
void func_25(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xC0D
{
	if (bParam0)
	{
...
int func_28(int iParam0, bool bParam1)//Position - 0xD9E
{
	int iVar0;
	int iVar1;
...
int func_29()//Position - 0xDDF
{
	return Global_1407E0;
}

int func_30(int iParam0)//Position - 0xDEB
{
...
bool func_31()//Position - 0xE2D
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_32(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xE3E
{
	int iVar0;
...
void func_33(int iParam0)//Position - 0xE71
{
	if (iParam0 == 1)
	{
...
void func_34(int iParam0)//Position - 0xE94
{
	if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
	{
		switch (iParam0)
...
int func_35()//Position - 0xEF0
{
	if (func_57(vLocal_331, Local_75.f_1, 210f))
	{
		...
		if (!unk_0x724D816EA203A79E(Local_79))
		{
			if (func_57(vLocal_331, Local_79.f_1, 150f))
			{
				if (unk_0x70CF24CEFB0F53B0(Local_79.f_1, 10f, func_46(), 0))
				{
					Local_79 = unk_0xCE5CC3450F9879E0(Local_79.f_1, 10f, func_46(), 1, 0, 1);
					if (func_427(Local_79))
					{
						unk_0x641B19E156645A92(Local_79, func_45(), 1, 0, 0, 1);
						unk_0x019CE76D5286C95C(Local_79, func_44());
						unk_0x346478B12F69D4E3(Local_79, true);
					}
				}
			}
		}
		if (!unk_0x724D816EA203A79E(Local_80))
		{
			if (func_57(vLocal_331, Local_80.f_1, 150f))
			{
				if (unk_0x70CF24CEFB0F53B0(Local_80.f_1, 10f, func_43(), 0))
				{
					Local_80 = unk_0xCE5CC3450F9879E0(Local_80.f_1, 10f, func_43(), 1, 0, 1);
				}
			}
		}
	}
	else if (!unk_0x33CC9445B2DF9387(Local_75.f_1, 2.5f))
	{
		func_40(&Local_75, 1);
...
void func_36(int iParam0, bool bParam1)//Position - 0x10A5
{
	if (bParam1)
	{
		func_38(iParam0);
...
void func_37(int iParam0, bool bParam1)//Position - 0x10C2
{
...
void func_38(int iParam0)//Position - 0x10FD
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
char* func_39()//Position - 0x1128
{
	return "special_ped@maude@base";
}

void func_40(int iParam0, bool bParam1)//Position - 0x1133
{
	if (bParam1)
	{
		func_42(iParam0);
...
void func_41(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1152
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_42(int iParam0)//Position - 0x11A2
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_43()//Position - 0x11E3
{
	return 2057223314;
}

float func_44()//Position - 0x11F0
{
	return -92.17f;
}

Vector3 func_45()//Position - 0x11FD
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_46()//Position - 0x1214
{
	return -380698483;
}

void func_47()//Position - 0x1221
{
	int iVar0;
	int iVar1;
	...
	if (func_21(Local_75))
	{
		if (func_427(Local_77))
		{
			if (func_56(2))
			{
				iVar0 = unk_0xD0D858E538FD01C3(func_51(), func_50(), 2);
				unk_0xC2BF3DE5E47F801D(iVar0, true);
				unk_0x69D4A898629B0BDA(iVar0, 0);
				unk_0xB62398E536F695FC(Local_75, iVar0, func_39(), func_49(), 1000f, -8f, 4688, 0, 1148846080, 0);
				iVar1 = 0;
				iVar1 += 16;
				iVar1 += 64;
				iVar1 += 512;
				iVar1 += 4096;
				unk_0xBEBE356CCD6268A1(Local_77, iVar0, func_48(), func_39(), 1000f, -8f, iVar1, 1148846080);
				unk_0x2E35C4FA5F0ED22F(Local_75, 1);
				unk_0x8EF3D958386640FE(Local_75, 0);
				unk_0xB105531EDD3DE51B(Local_75, false);
				unk_0x4106FAF8AA1D69D5(Local_75, 1862763509);
				unk_0x95F58F57ACD332BA(Local_75, 0);
				unk_0x6757D726B4BAF0C4(Local_75, 0);
				unk_0x22321800954A532E(Local_75, 1);
				unk_0xC8FD3EBBB90E8D7F(Local_75, 118, false);
			}
		}
	}
}

char* func_48()//Position - 0x130D
{
	return "base_chair";
}

char* func_49()//Position - 0x1318
{
	return "base";
}

Vector3 func_50()//Position - 0x1323
{
	return 0f, 0f, -92.17f;
}

Vector3 func_51()//Position - 0x1332
{
	return 2727.4f, 4145.56f, 43.68f;
}

int func_52(var uParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6)//Position - 0x1349
{
...
void func_53(int iParam0, bool bParam1)//Position - 0x13CB
{
	if (iParam0 != 0)
	{
		if (bParam1)
...
int func_54(int iParam0)//Position - 0x13F6
{
	if (iParam0 == 0)
	{
		return 1;
...
int func_55(var uParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x141C
{
	if (!unk_0x724D816EA203A79E(*uParam0))
	{
		if (func_54(iParam1))
...
int func_56(int iParam0)//Position - 0x1487
{
	switch (iParam0)
	{
		case 0:
...
bool func_57(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x152B
{
	return SYSTEM::VDIST2(vParam0, vParam1) <= (fParam2 * fParam2);
}

int func_58(int iParam0, float fParam1, int iParam2)//Position - 0x1545
{
	int iVar0;
	...
	if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
	{
		...
		{
			if (!func_63(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
int func_62(int iParam0, int iParam1)//Position - 0x16AF
{
	if (func_21(iParam0))
	{
...
int func_63(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x16E2
{
...
void func_64(int iParam0)//Position - 0x1871
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_65()//Position - 0x189D
{
	if (func_427(Local_68.f_9))
	{
		if (unk_0xA5A42DEC1470C5A9())
		{
			unk_0x2C5D30EE32747F1F(sLocal_152, Local_68.f_9, 0);
		}
	}
	if (func_427(Local_75))
	{
		if (unk_0xA5A42DEC1470C5A9())
		{
			unk_0x2C5D30EE32747F1F(sLocal_151, Local_75, 0);
		}
	}
}

void func_66(char* sParam0)//Position - 0x18DF
{
	func_25(1, 1, 0, 0, 0);
	unk_0x04DD7A558FCF2C34(sParam0, 8);
}

void func_67(int iParam0, int iParam1, int iParam2)//Position - 0x18F8
{
	if (func_511() && func_69())
	{
...
void func_68(int iParam0)//Position - 0x19BC
{
	if (iParam0 == 1)
	{
...
bool func_69()//Position - 0x19E5
{
	return unk_0xFA30DFD0084E92FE(Global_16B1B.f_14, 13);
}

void func_70()//Position - 0x19F9
{
	char* sVar0;
	int iVar1;
		...
		case 0:
			...
			if (iLocal_62 == 4)
			{
				if (func_21(Local_75))
				{
					...
					func_105(Local_75, 0);
					if (!unk_0x9986AD62CA3DE747(Local_75))
					{
						if (func_104(Local_75, unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 0), 35f))
						{
							unk_0x0DEF5E53360637F2(Local_75, 0);
							func_102(Local_75, "GENERIC_FRIGHTENED_HIGH", "MAUDE", 3);
						}
					}
				}
				if (unk_0x724D816EA203A79E(Local_78))
				{
			...
			if (func_21(Local_68.f_9))
			{
				if (unk_0xD45C08B05D4687A7(Local_68.f_9))
				{
					unk_0x57EB4CC8F1928A47(Local_68.f_9);
				}
			...
			else if (!iLocal_100)
			{
				...
				if (iLocal_62 == 4)
				{
					...
					else if (func_21(Local_75))
					{
						...
						{
							if (!unk_0x889DA6CE8E4DB344(Local_75))
							{
								if (!unk_0x96044E39418AAF17(Local_75, func_101(), func_72(), 3))
								{
									func_71(&Local_75);
									unk_0x5558ED6D4A2DEC93(Local_75, unk_0xBC25C936A095B5BA(), 50f, -1, 0, 0);
									unk_0x22321800954A532E(Local_75, 1);
								}
							}
						}
...
void func_71(int iParam0)//Position - 0x1CA4
{
	if (func_21(*iParam0))
	{
...
char* func_72()//Position - 0x1D0D
{
	return "female_Flee_Table_Left_Maude";
}

int func_73(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D19
{
	if (iParam4 == 0)
	{
...
bool func_74(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x1D56
{
...
int func_75(char* sParam0, int iParam1, bool bParam2)//Position - 0x1DA4
{
	Global_3DB9 = 0;
...
int func_80()//Position - 0x2271
{
	func_81();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_81()//Position - 0x228A
{
	int iVar0;
	
	if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
	{
		if (func_84(Global_19B04.f_932.f_21B.f_10CD) != unk_0x6F79ECA8C83E4357(unk_0xBC25C936A095B5BA()))
		{
			iVar0 = func_83(unk_0xBC25C936A095B5BA());
			if (func_82(iVar0) && (!func_85(14) || Global_196EB))
			{
				if (Global_19B04.f_932.f_21B.f_10CD != iVar0 && func_82(Global_19B04.f_932.f_21B.f_10CD))
				{
...
bool func_82(int iParam0)//Position - 0x2387
{
	return iParam0 < 3;
}

int func_83(int iParam0)//Position - 0x2393
{
	int iVar0;
	int iVar1;
...
int func_84(int iParam0)//Position - 0x23D0
{
	if (func_82(iParam0))
	{
...
bool func_85(int iParam0)//Position - 0x23FA
{
	return Global_8C41 == iParam0;
}

void func_86()//Position - 0x2408
{
	int iVar0;
...
bool func_87(int iParam0, int iParam1)//Position - 0x245F
{
	switch (iParam0)
	{
		case 5:
...
void func_88(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x249A
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_89(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x24F0
{
...
void func_90(bool bParam0)//Position - 0x258B
{
	int iVar0;
	...
	if (func_21(Local_68.f_9))
	{
		if (unk_0xD45C08B05D4687A7(Local_68.f_9))
		{
			if (unk_0x9488E18994C5C83D(Local_68.f_9, unk_0x705BBFE5A8ADE4A9(unk_0xB5CEFD608600A09F())))
			{
				unk_0x57EB4CC8F1928A47(Local_68.f_9);
			}
		}
		unk_0xB71D41C0310C93DE(Local_68.f_9, 0, 1);
		unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 0);
		if (Global_195F9 == 0)
		{
			unk_0x22321800954A532E(Local_68.f_9, 0);
		}
		else
		{
			unk_0x22321800954A532E(Local_68.f_9, 1);
		}
	}
	func_40(&(Local_68.f_9), bParam0);
	if (func_21(Local_75))
	{
		unk_0x2E35C4FA5F0ED22F(Local_75, 0);
		unk_0x22321800954A532E(Local_75, 1);
	}
	...
	if (iLocal_132 > 0)
	{
		...
		while (iVar0 <= (iLocal_132 - 1))
		{
			if (iLocal_67 == 4)
			{
				if (func_21(Local_69[iVar0 /*19*/]))
				{
					unk_0x4106FAF8AA1D69D5(Local_69[iVar0 /*19*/], -2065892691);
					unk_0x2E35C4FA5F0ED22F(Local_69[iVar0 /*19*/], 0);
					if (Global_195F9 == 0)
					{
						unk_0x22321800954A532E(Local_69[iVar0 /*19*/], 0);
					}
					else
					{
						unk_0x22321800954A532E(Local_69[iVar0 /*19*/], 1);
					}
				}
			}
...
void func_91(int iParam0, bool bParam1)//Position - 0x275E
{
	if (bParam1)
	{
		func_93(iParam0);
...
void func_92(int iParam0)//Position - 0x277A
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_94(int iParam0)//Position - 0x284E
{
	if (func_427(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
void func_95(var uParam0)//Position - 0x2878
{
...
void func_97(char* sParam0)//Position - 0x28BE
{
...
void func_98(int iParam0, bool bParam1)//Position - 0x28FD
{
	if (func_21(iParam0))
	{
		unk_0x91629AC1E1F78419(iParam0, 5, 0);
		unk_0x91629AC1E1F78419(iParam0, 17, 1);
		unk_0xABA7AE40608505F2(iParam0, 512, false);
...
int func_99(int iParam0, int iParam1, int iParam2)//Position - 0x2978
{
	int iVar0;
...
char* func_100()//Position - 0x2AC4
{
	return "Female_Flee_Table_Left_Maude_Chair";
}

char* func_101()//Position - 0x2AD0
{
	return "special_ped@maude@exit_flee";
}

void func_102(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x2ADC
{
	unk_0x7E80A36CD8BDF4D1(iParam0, sParam1, sParam2, func_103(iParam3), 0);
}

int func_103(int iParam0)//Position - 0x2AF5
{
	int iVar0;
...
bool func_104(int iParam0, vector3 vParam1, float fParam2)//Position - 0x2CEA
{
	return SYSTEM::VDIST2(unk_0x541C2AEF053615BC(iParam0, 1), vParam1) <= (fParam2 * fParam2);
}

void func_105(int iParam0, bool bParam1)//Position - 0x2D07
{
	char* sVar0;
	int iVar1;
	int iVar2;
...
void func_106(var uParam0, int iParam1)//Position - 0x2D78
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
...
void func_108(int iParam0)//Position - 0x2DB9
{
	bool bVar0;
	struct<8> Var1;
...
void func_109(int iParam0)//Position - 0x2E2B
{
	if (unk_0x2DA8CA50A72528FB(*iParam0))
	{
...
void func_110(int iParam0)//Position - 0x2E4B
{
	int iVar0;
...
bool func_112(int iParam0, int iParam1)//Position - 0x2F37
{
	return (unk_0x105601648511CC64() - iParam0) > iParam1;
}

void func_113(int iParam0)//Position - 0x2F49
{
	if (func_21(Local_69[iParam0 /*19*/]))
	{
		if (unk_0x84788C4CA5E15BDC(Local_69[iParam0 /*19*/]) == iLocal_320)
		{
			unk_0x5AAB329BBC1053A1(Local_69[iParam0 /*19*/], 30f);
			unk_0x6CCBC1B22488DC0C(Local_69[iParam0 /*19*/], 30f);
			unk_0x1D772375218D2BDC(Local_69[iParam0 /*19*/], 30f);
			unk_0x80F51E5792576467(Local_69[iParam0 /*19*/], 0);
			unk_0x91629AC1E1F78419(Local_69[iParam0 /*19*/], 1, 0);
			unk_0x91629AC1E1F78419(Local_69[iParam0 /*19*/], 3, 1);
			unk_0x91629AC1E1F78419(Local_69[iParam0 /*19*/], 0, 1);
			unk_0x56F2E1B5599188FA(Local_69[iParam0 /*19*/], unk_0xBC25C936A095B5BA(), -1, 0, 2);
			if (!unk_0x889DA6CE8E4DB344(Local_69[iParam0 /*19*/]))
			{
				if (unk_0xD8BE87198802B1F7(Local_69[iParam0 /*19*/]))
				{
					unk_0x3D669AF9A68FF281(Local_69[iParam0 /*19*/]);
				}
				unk_0x44C98C11ED6DD327(Local_69[iParam0 /*19*/]);
				unk_0xD999D66C5AFA4BE3(Local_69[iParam0 /*19*/]);
				unk_0xA4E856A8CD53B8DF(Local_69[iParam0 /*19*/]);
				unk_0x2A2F7485FD2B9A29(Local_69[iParam0 /*19*/], -1, unk_0xBC25C936A095B5BA(), -1, 0);
			}
			unk_0x2E35C4FA5F0ED22F(Local_69[iParam0 /*19*/], 1);
			Local_69[iParam0 /*19*/].f_E = 2;
		}
		else
		{
			unk_0x91629AC1E1F78419(Local_69[iParam0 /*19*/], 13, 0);
			unk_0x91629AC1E1F78419(Local_69[iParam0 /*19*/], 5, 0);
			unk_0x91629AC1E1F78419(Local_69[iParam0 /*19*/], 17, 1);
			unk_0x91629AC1E1F78419(Local_69[iParam0 /*19*/], 0, 1);
			unk_0x2E35C4FA5F0ED22F(Local_69[iParam0 /*19*/], 0);
			Local_69[iParam0 /*19*/].f_E = 5;
		}
	}
}

void func_114(int iParam0)//Position - 0x308C
{
	func_22(500, 1);
...
void func_115(int iParam0, int iParam1, int iParam2)//Position - 0x30C1
{
	bool bVar0;
...
void func_116()//Position - 0x31A9
{
	...
	{
		func_119(13, SYSTEM::FLOOR(Global_19B04.f_27B5.f_F0D));
	}
...
int func_118()//Position - 0x36B5
{
	return Global_62BD;
}

int func_119(int iParam0, int iParam1)//Position - 0x36C0
{
	int iVar0;
...
int func_120(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x3711
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_121(int iParam0)//Position - 0x3C2B
{
	int iVar0;
	...
	switch (iLocal_60)
	{
		case 0:
			...
			if (func_35())
			{
				...
				{
					unk_0x538BB037E00A3AD9(unk_0xBC25C936A095B5BA(), sLocal_150, 0, 0, 0);
					if (func_427(Local_75))
					{
						unk_0x538BB037E00A3AD9(Local_75, sLocal_151, 0, 0, 0);
					}
					if (func_427(Local_68.f_9))
					{
						unk_0x538BB037E00A3AD9(Local_68.f_9, sLocal_152, 0, 0, 0);
					}
					if (func_427(Local_77))
					{
						unk_0x538BB037E00A3AD9(Local_77, sLocal_153, 0, 0, 0);
					}
					if (func_427(Local_78))
					{
						unk_0x538BB037E00A3AD9(Local_78, sLocal_154, 0, 0, 0);
					}
					...
					if (func_21(Local_68.f_9))
					{
						...
						unk_0xA4E856A8CD53B8DF(Local_68.f_9);
						unk_0x641B19E156645A92(Local_68.f_9, 2724.02f, 4145.08f, 43.29f, 1, 0, 0, 1);
						unk_0x019CE76D5286C95C(Local_68.f_9, -84.2f);
						unk_0xA4E856A8CD53B8DF(Local_68.f_9);
					}
					iLocal_60 = 1;
				}
		...
		case 1:
			if (func_427(Local_77))
			{
				if (func_21(Local_75))
				{
					if (unk_0x3F3252765FE36DA8(sLocal_151, 0) && unk_0x3F3252765FE36DA8(sLocal_153, 0))
					{
						func_47();
					}
				}
			}
			if (unk_0x3F3252765FE36DA8(sLocal_150, 0))
			{
				unk_0x3E2B7D349B5735D3(unk_0xBC25C936A095B5BA(), -668482597, 0, 1, 0);
		...
		case 2:
			...
			else
			{
				...
				if (func_21(Local_75))
				{
					unk_0x56F2E1B5599188FA(Local_75, unk_0xBC25C936A095B5BA(), -1, 0, 2);
					unk_0x22321800954A532E(Local_75, 1);
				}
...
void func_123(int iParam0)//Position - 0x3F65
{
	iLocal_58 = iParam0;
	iLocal_60 = 0;
}

void func_124(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x3F74
{
	vector3 vVar0;
	var uVar1;
	...
	if (unk_0x724D816EA203A79E(Global_17646.f_4))
	{
		...
		{
			if (func_176(24) != Global_17646.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_173(unk_0x541C2AEF053615BC(Global_17646.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_125(Global_17646.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_125(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)//Position - 0x3FEF
{
	struct<60> Var0;
...
void func_126(int iParam0, int iParam1, int iParam2)//Position - 0x411A
{
	int iVar0;
	...
	if (unk_0x724D816EA203A79E(iParam1))
	{
		if (unk_0xE59B7F5A03335350(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_19B04.f_7F22.f_12C1 = func_145();
			}
...
void func_127(int iParam0, int iParam1)//Position - 0x4237
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_167(iParam0, &(Global_19B04.f_7F22.f_1586));
}

int func_128(int iParam0)//Position - 0x4439
{
...
int func_129(int iParam0)//Position - 0x4516
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_130(int iParam0, bool bParam1)//Position - 0x46C7
{
	int iVar0;
	struct<2> Var1;
...
int func_131(int iParam0)//Position - 0x4855
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_133(int iParam0)//Position - 0x4938
{
	int iVar0;
	int iVar1;
...
int func_134()//Position - 0x63DF
{
	return 0;
}

int func_135()//Position - 0x63E8
{
	return 1;
}

int func_136()//Position - 0x63F1
{
	return 1;
}

int func_137()//Position - 0x63FA
{
...
int func_139(int iParam0)//Position - 0x64CE
{
	int iVar0;
	char* sVar1;
...
int func_140(int iParam0)//Position - 0x6514
{
	int iVar0;
...
int func_141(int iParam0)//Position - 0x654F
{
	int iVar0;
...
int func_142(int iParam0)//Position - 0x65CB
{
	int iVar0;
...
int func_143(int iParam0, int iParam1, bool bParam2)//Position - 0x66B3
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_144(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x6724
{
...
void func_146(var uParam0, int iParam1)//Position - 0x6842
{
	if (iParam1 <= 0)
	{
		return;
...
void func_147(var uParam0, int iParam1)//Position - 0x68C8
{
...
void func_148(var uParam0, int iParam1)//Position - 0x68FB
{
	int iVar0;
	int iVar1;
...
int func_149(int iParam0, int iParam1)//Position - 0x694C
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_150(int iParam0)//Position - 0x69EE
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_151(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_151(bool bParam0, int iParam1, int iParam2)//Position - 0x6A13
{
	if (bParam0)
	{
		return iParam1;
...
int func_152(var uParam0)//Position - 0x6A2A
{
	return uParam0 & 15;
}

void func_153(var uParam0, int iParam1)//Position - 0x6A37
{
...
void func_154(var uParam0, int iParam1)//Position - 0x6A71
{
...
void func_155(var uParam0, int iParam1)//Position - 0x6AAC
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_156(var uParam0, int iParam1)//Position - 0x6AE8
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = { 0f, 0f, 0f };
	...
	if (unk_0xFA30DFD0084E92FE(uParam0->f_9, 10))
	{
		...
		if (!func_166(Global_19B04.f_7F22.f_748[uParam0->f_E /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_166(Global_19B04.f_932.f_21B.f_DF0[1 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
	...
	{
		if (!func_166(Global_19B04.f_932.f_21B.f_DF0[0 /*10*/][uParam0->f_C /*3*/], 0f, 0f, 0f, 0))
		{
...
int func_157(int iParam0, int iParam1)//Position - 0x81E0
{
	struct<82> Var0;
...
void func_158(int iParam0, var uParam1, int iParam2)//Position - 0x8222
{
	int iVar0;
...
void func_159(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x847E
{
	if (func_156(&(Global_110A8.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			func_164(iParam0);
			func_163(uParam1, &(Global_19B04.f_7F22.f_45[Global_110A8.f_22B[0 /*21*/].f_E /*78*/]));
...
void func_160(int iParam0, bool bParam1)//Position - 0x857D
{
	if (iParam0 == -1)
	{
		return;
...
void func_161(int iParam0, int iParam1, bool bParam2)//Position - 0x85DA
{
	if (iParam0 == -1)
	{
		return;
...
bool func_162(int iParam0, int iParam1)//Position - 0x8615
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_163(var uParam0, var uParam1)//Position - 0x8638
{
...
void func_164(int iParam0)//Position - 0x8704
{
	if (iParam0 == -1)
	{
		return;
...
int func_165(int iParam0)//Position - 0x877E
{
	int iVar0;
...
bool func_166(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x87E1
{
	if (bParam2)
	{
...
void func_167(int iParam0, var uParam1)//Position - 0x8828
{
	int iVar0;
	...
	if (unk_0xE59B7F5A03335350(iParam0, 0))
	{
		...
		*uParam1 = unk_0x89FC8F09D6647DEC(iParam0);
		...
		if (uParam1->f_41 == -1 && !func_170(uParam1->f_42))
		{
			uParam1->f_41 = 0;
		}
		...
		func_169(&iParam0, &(uParam1->f_9), &(uParam1->f_3B));
		iVar0 = 0;
		while (iVar0 <= 11)
		{
			if (unk_0xFC8A228C62614C5C(iParam0, iVar0 + 1))
			{
				unk_0xF0059F27F7BB6680(&(uParam1->f_4D), func_168(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_168(int iParam0)//Position - 0x8AD3
{
	switch (iParam0)
	{
		case 1:
...
int func_169(int iParam0, var uParam1, var uParam2)//Position - 0x8B83
{
	int iVar0;
	int iVar1;
...
int func_170(int iParam0)//Position - 0x8C5D
{
	switch (iParam0)
	{
		case joaat("granger"):
...
void func_171(var uParam0)//Position - 0x8C7D
{
	int iVar0;
...
void func_172(int iParam0)//Position - 0x8D2D
{
...
int func_173(vector3 vParam0, int iParam1, var uParam2, var uParam3)//Position - 0x8D54
{
	int iVar0;
...
int func_174(vector3 vParam0, int iParam1, int iParam2)//Position - 0x8E6A
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_175(int iParam0)//Position - 0x8EF9
{
	return unk_0xFA30DFD0084E92FE(Global_19B04.f_1C20[iParam0], 0);
}

int func_176(int iParam0)//Position - 0x8F11
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_177(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, bool bParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9)//Position - 0x8F2D
{
	func_178(vParam0, vParam1, fParam2, vParam3, fParam4, 0f, 0f, 0f, bParam5, bParam6, bParam7, bParam8, bParam9);
}

void func_178(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x8F56
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_179(vector3 vParam0)//Position - 0x934A
{
...
int func_180(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0x9374
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_181(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x966A
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_182(vector3 vParam0)//Position - 0x971E
{
	float fVar0;
	float fVar1;
...
void func_183(int iParam0)//Position - 0x975D
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
bool func_184(vector3 vParam0, int iParam1)//Position - 0x97C2
{
	return func_185(Global_17646.f_B3B.f_C.f_42, vParam0, iParam1);
}

int func_185(int iParam0, vector3 vParam1, int iParam2)//Position - 0x97DF
{
	vector3 vVar0;
	vector3 vVar1;
...
Vector3 func_186()//Position - 0x9849
{
	return 2.55f, 5.665f, 2.55f;
}

Vector3 func_187()//Position - 0x9860
{
	return 3.01f, 11.01f, 6.01f;
}

int func_188(var uParam0, var uParam1, var uParam2)//Position - 0x9877
{
...
void func_189(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x98AE
{
	int iVar0;
...
Vector3 func_190(int iParam0)//Position - 0x9A6C
{
	return unk_0x541C2AEF053615BC(unk_0xA95CF30C72EB526E(iParam0), 0);
}

int func_191(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x9A7F
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_11489[1 /*14*/] = { func_241(iVar10, iParam1, iParam2) };
		if (!func_240(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_11489[1 /*14*/] = { func_241(iVar10, iVar0, uVar11[iVar0]) };
				if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_11489[1 /*14*/] = { func_241(iVar10, 14, uVar12[iVar1]) };
							func_211(iParam0, Global_11489[1 /*14*/].f_C, Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4);
							func_233(14);
							if (Global_11487 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							unk_0xB0031DDAE4FF0BC3(iParam0, func_201(iVar0), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, unk_0x41AF5D2DF638D88F(iParam0, func_201(iVar0)));
						}
						else
						{
							unk_0xB0031DDAE4FF0BC3(iParam0, func_201(iVar0), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, iParam4);
						}
						func_233(iVar0);
						if (Global_11487 == 1)
						{
			...
			{
				Global_11489[1 /*14*/] = { func_241(iVar10, iVar0, func_200(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_11489[1 /*14*/] = { func_241(iVar10, 14, uVar15[iVar1]) };
			func_211(iParam0, Global_11489[1 /*14*/].f_C, Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4);
			func_233(14);
			if (Global_11487 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			unk_0xB0031DDAE4FF0BC3(iParam0, func_201(iParam1), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, unk_0x41AF5D2DF638D88F(iParam0, func_201(iParam1)));
		}
		else
		{
			unk_0xB0031DDAE4FF0BC3(iParam0, func_201(iParam1), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, iParam4);
		}
		if (Global_11487 == 1)
		{
			iVar2 = 0;
...
int func_192(int iParam0, int iParam1, int iParam2)//Position - 0xA28B
{
	int iVar0;
	...
	{
		if (!func_305(iParam0, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_40, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_3F))
		{
...
int func_193(int iParam0)//Position - 0xA317
{
	switch (iParam0)
	{
...
void func_194(int iParam0, int iParam1, int iParam2)//Position - 0xA352
{
	int iVar0;
	int iVar1;
...
int func_195(int iParam0, int iParam1, int iParam2)//Position - 0xA3DC
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_196(int iParam0, int iParam1, int iParam2)//Position - 0xA4BA
{
	Global_11489[1 /*14*/] = { func_241(iParam0, iParam1, iParam2) };
	return unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 2);
}

int func_197(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xA4E4
{
	var uVar0;
	int iVar1;
...
int func_198(int iParam0, int iParam1, int iParam2)//Position - 0xAAE8
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_199(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAB81
{
	int iVar0;
	...
	{
		if (!func_305(iParam0, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_3D, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_3C) || iParam3 == 1)
		{
...
int func_200(int iParam0, int iParam1, int iParam2)//Position - 0xAC17
{
	int iVar0;
	int iVar1;
...
int func_201(int iParam0)//Position - 0xACB8
{
	switch (iParam0)
	{
		case 0:
...
int func_202(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xAD68
{
	int iVar0;
...
int func_203(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xB06F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_204(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xBC22
{
	int iVar0;
...
int func_205(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xBF06
{
	int iVar0;
...
int func_206(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC1CE
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC205
{
	int iVar0;
...
int func_208(int iParam0, int iParam1, int iParam2)//Position - 0xC22E
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_209(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC4F8
{
	int iVar0;
...
int func_210(int iParam0, int iParam1, int iParam2)//Position - 0xC782
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_211(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC8D9
{
	int iVar0;
...
int func_212(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xC971
{
	switch (iParam0)
	{
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCA3F
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar9 = unk_0x84E17E2A0638D182(iParam3, 6, -1, 0, -1, func_201(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_214(int iParam0, int iParam1)//Position - 0xCB9B
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_215(int iParam0)//Position - 0xCF42
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCFA3
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_217(int iParam0, int iParam1)//Position - 0xD09F
{
	int iVar0;
...
int func_218(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xD1DD
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x84E17E2A0638D182(iParam3, 6, -1, 0, -1, func_201(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
int func_219(int iParam0)//Position - 0xD2BD
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_220(int iParam0, int iParam1)//Position - 0xD343
{
	int iVar0;
	struct<10> Var1;
...
void func_221(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xDC72
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_222(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xDD9C
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_223(int iParam0, int iParam1)//Position - 0xDDE4
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_226(&Var1, -99, -99, Global_19B04.f_932.f_21B.f_C4[0], Global_19B04.f_932.f_21B.f_C8[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_226(&Var1, -99, -99, Global_19B04.f_932.f_21B.f_C4[1], Global_19B04.f_932.f_21B.f_C8[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_226(&Var1, -99, -99, Global_19B04.f_932.f_21B.f_C4[2], Global_19B04.f_932.f_21B.f_C8[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_224(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFC2C
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_225(int iParam0)//Position - 0xFE16
{
	switch (iParam0)
	{
		case 0:
...
void func_226(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xFEC6
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_227(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFF37
{
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 1) || unk_0xF062C4E30590463E(func_213(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 0) || unk_0xF062C4E30590463E(func_213(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 1) || unk_0xF062C4E30590463E(func_213(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 0) || unk_0xF062C4E30590463E(func_213(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x101B4
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_229(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x105D9
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_230(int iParam0, int iParam1)//Position - 0x108CC
{
	int iVar0;
	int iVar1;
...
int func_231(int iParam0, int iParam1)//Position - 0x10912
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_232(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10972
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_233(int iParam0)//Position - 0x109F6
{
	if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 1) && !unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 6))
	{
		func_239(iParam0, Global_11489[1 /*14*/].f_5, Global_11489[1 /*14*/].f_2, 2, Global_11489[1 /*14*/].f_1, 1, 0);
	}
	if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 1) && unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
		{
			func_234(Global_280004, 2, 1, 1, -1);
		}
		else if (iParam0 == 13)
		{
		}
...
void func_234(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x10AAE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_235(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x10AF8
{
	int iVar0;
	...
	iVar0 = Global_269BC5[iParam0 /*3*/][func_236(iParam2)];
	if (iVar0 != 0)
	{
...
int func_236(var uParam0)//Position - 0x10B28
{
	int iVar0;
	int iVar1;
...
int func_237(int iParam0, int iParam1, int iParam2)//Position - 0x10B5C
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_269BC5[iParam0 /*3*/][func_236(iParam1)];
...
bool func_238(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x10B8E
{
	int iVar0;
...
int func_239(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x12485
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_240(int iParam0)//Position - 0x133A3
{
	if (!unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_241(int iParam0, int iParam1, int iParam2)//Position - 0x133F4
{
	func_304();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_242(int iParam0, int iParam1)//Position - 0x13446
{
	switch (iParam0)
	{
		case 0:
...
void func_243(int iParam0)//Position - 0x13536
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_244(&(Global_11489[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_244(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x147AD
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_248(Global_280004, 1, 1, 1, -1))
			{
				unk_0x7CB6FD92BE491AD9(&(uParam0->f_6), 2);
			}
			if (!func_248(Global_280004, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_237(func_247(iParam1, uParam0->f_2), Global_11486, 0);
			if (unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
			{
				unk_0xF0059F27F7BB6680(&(uParam0->f_6), 1);
			}
			iVar0 = func_237(func_246(iParam1, uParam0->f_2), Global_11486, 0);
			if (unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
			{
				unk_0xF0059F27F7BB6680(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_237(iVar1, Global_11486, 0);
				if (!unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
				{
					unk_0xF0059F27F7BB6680(&(uParam0->f_6), 4);
				}
...
bool func_245(int iParam0, int iParam1, var uParam2)//Position - 0x14B3E
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_246(int iParam0, int iParam1)//Position - 0x14F43
{
	switch (iParam1)
	{
		case 0:
...
int func_247(int iParam0, int iParam1)//Position - 0x1533E
{
	switch (iParam1)
	{
		case 0:
...
int func_248(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x15739
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_249(int iParam0)//Position - 0x1577B
{
	switch (iParam0)
	{
		case -1:
...
void func_250(int iParam0, int iParam1, int iParam2)//Position - 0x1584F
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar3 < iVar5)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_244(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_244(&(Global_11489[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_244(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xF062C4E30590463E(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = unk_0x84E17E2A0638D182(iVar1, 6, -1, 0, -1, func_201(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var11;
					func_244(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xF062C4E30590463E(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
void func_251(int iParam0)//Position - 0x15ACA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_252(int iParam0)//Position - 0x15C20
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_253(int iParam0)//Position - 0x1612D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_254(int iParam0)//Position - 0x161A1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_255(int iParam0)//Position - 0x16214
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_256(int iParam0)//Position - 0x162FA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_257(int iParam0)//Position - 0x1665C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_258(int iParam0)//Position - 0x1686C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_259(int iParam0)//Position - 0x16A9B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0)//Position - 0x16BAA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_261(int iParam0)//Position - 0x17548
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x180BB
{
	if (iParam0 < 136)
	{
		func_264(iParam0);
...
void func_263(int iParam0)//Position - 0x180EF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x18CF3
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x19C01
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x19D2D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0, int iParam1)//Position - 0x19E2A
{
	switch (iParam0)
	{
		case 0:
...
void func_268(int iParam0)//Position - 0x19F1A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0)//Position - 0x1B40A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x1B55A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_271(int iParam0)//Position - 0x1BA64
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1C0D2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1C145
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x1C214
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0)//Position - 0x1C743
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_276(int iParam0)//Position - 0x1C8D9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1D0D6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1D1E5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1E10F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x1EE10
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x1F8B5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x206A6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x212EF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x21567
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0, int iParam1)//Position - 0x216AC
{
	switch (iParam0)
	{
		case 0:
...
void func_287(int iParam0)//Position - 0x2179C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0)//Position - 0x22525
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_289(int iParam0)//Position - 0x2269E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x22C14
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x2313D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x231B0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x2327F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0)//Position - 0x23756
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_295(int iParam0)//Position - 0x239BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x23C93
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0)//Position - 0x23E5B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x24B2C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x25775
{
	if (iParam0 < 60)
	{
		func_301(iParam0);
...
void func_300(int iParam0)//Position - 0x257A9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x26549
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x26BD5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x26CBB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304()//Position - 0x26DB8
{
...
int func_305(int iParam0, int iParam1, int iParam2)//Position - 0x26E31
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = unk_0x6F79ECA8C83E4357(iParam0);
	Global_11489[1 /*14*/] = { func_241(iVar0, iParam1, iParam2) };
	if (!unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_305(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_305(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_11489[2 /*14*/] = { func_241(iVar0, 14, iVar4) };
									if (Global_11489[2 /*14*/].f_C == iVar3)
									{
										if (func_305(iParam0, 14, iVar4))
										{
											if (!func_197(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_11489[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_11489[2 /*14*/] = { func_241(iVar0, iVar2, iVar1) };
						if (!func_197(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_11489[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_11489[1 /*14*/].f_3 == unk_0xA86A4D206EC8EB16(iParam0, func_201(iParam1)) && Global_11489[1 /*14*/].f_4 == unk_0x695D13ECF7DAEC22(iParam0, func_201(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_306(bool bParam0)//Position - 0x27089
{
	int iVar0;
...
void func_307()//Position - 0x270C6
{
	bool bVar0;
	vector3 vVar1;
	...
	if (func_21(Local_68.f_9))
	{
		vVar1 = { unk_0x541C2AEF053615BC(Local_68.f_9, 0) };
		func_375(Local_68.f_9, &iLocal_133, 1126825984, 7);
		func_367(Local_68.f_9, &(Local_68.f_13), 1126825984, 7);
		func_355();
		switch (iLocal_60)
		{
			case 0:
				unk_0xA902E18EDF6FA0C8(5, 1862763509, iLocal_320);
				unk_0xA902E18EDF6FA0C8(5, iLocal_320, 1862763509);
				iLocal_137 = unk_0x8D66276473ABD7CC(Local_68.f_9);
				vLocal_336 = { unk_0x541C2AEF053615BC(Local_68.f_9, 0) };
				func_354(&vLocal_337, vLocal_336);
				func_353(Local_68.f_9);
				if (Local_68.f_A != 13 && Local_68.f_A != 14)
				{
					unk_0xA4E856A8CD53B8DF(Local_68.f_9);
					Local_68.f_12 = (unk_0x105601648511CC64() - 3000);
					Local_68.f_A = 13;
				}
				if (func_21(Local_68.f_9))
				{
					if (!unk_0x2DA8CA50A72528FB(Local_68.f_8))
					{
						Local_68.f_8 = func_352(Local_68.f_9, 1, 0, 5);
					}
					unk_0x5502708AECB47F5D(Local_68.f_9);
				}
				iLocal_134 = -1;
				iLocal_135 = -1;
				iLocal_107 = 0;
				...
				iLocal_81 = 0;
				sLocal_146 = "BB4_J8";
				iLocal_122 = unk_0x105601648511CC64();
			...
			case 1:
				if (!iLocal_107)
				{
					...
					if (Local_68.f_A == 13 || Local_68.f_A == 14)
					{
						...
						if (func_319(Local_68.f_9, vLocal_331, bVar0, 0, 1, iLocal_137))
						{
							...
							{
								func_318();
								Local_68.f_11 = unk_0x105601648511CC64();
						...
						else
						{
							...
							{
								if (func_112(iLocal_122, unk_0x491B2241281A03B7(5000, 12000)))
								{
									if (func_104(Local_68.f_9, vLocal_331, 30f))
									{
										if (unk_0x889DA6CE8E4DB344(Local_68.f_9))
										{
				...
				else
				{
					...
					else
					{
						if (!iLocal_82)
						{
							if (!unk_0x2CDE18D6C89522AD(Local_68.f_9) && !unk_0x5237AF95232D78C5(Local_68.f_9, 0))
							{
			...
			case 2:
				...
				iLocal_82 = 1;
				func_318();
				unk_0xF5547CCC3D125DD6(5, 1862763509, iLocal_320);
				unk_0xF5547CCC3D125DD6(5, iLocal_320, 1862763509);
				func_109(&(Local_68.f_8));
				iLocal_82 = 1;
				Local_68.f_11 = unk_0x105601648511CC64();
				func_316(&uLocal_44, 0, 0);
...
int func_308(var uParam0)//Position - 0x275A1
{
	vector3 vVar0;
	
	if (func_21(*uParam0))
	{
		vVar0 = { unk_0x541C2AEF053615BC(*uParam0, 0) };
		if (!func_309(uParam0))
		{
			if (unk_0x876474582C5DECDE(vVar0 - Vector(7f, 7f, 7f), vVar0 + Vector(7f, 7f, 7f), 0))
			{
				return 1;
			}
		}
...
int func_309(var uParam0)//Position - 0x275E6
{
	if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
	{
...
bool func_310(char* sParam0, int iParam1, char* sParam2)//Position - 0x2761E
{
...
void func_311(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, bool bParam5, int iParam6)//Position - 0x2763C
{
...
void func_312(char* sParam0, int iParam1, int iParam2)//Position - 0x276E8
{
	iParam2 = iParam2;
...
int func_313(char* sParam0, bool bParam1)//Position - 0x27701
{
	struct<6> Var0;
...
struct<6> func_314()//Position - 0x2773C
{
	struct<6> Var0;
...
void func_315(int iParam0, vector3 vParam1, int iParam2, float fParam3)//Position - 0x27760
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	fVar2 = 625f;
	fVar3 = 16000f;
	fVar4 = SYSTEM::VDIST2(unk_0x541C2AEF053615BC(iParam0, 1), vParam1);
	iVar5 = (unk_0x105601648511CC64() - iParam2);
...
void func_316(var uParam0, int iParam1, int iParam2)//Position - 0x27845
{
	char* sVar0;
...
int func_317(char* sParam0)//Position - 0x27922
{
	unk_0xF07D20149ECBC61E(sParam0);
	return unk_0xA66DBDA0A072514A(0);
}

void func_318()//Position - 0x27935
{
	if (func_21(Local_68.f_9))
	{
		if (((Local_68.f_A != 23 && Local_68.f_A != 24) && Local_68.f_A != 21) && Local_68.f_A != 22)
		{
			...
			unk_0xD999D66C5AFA4BE3(Local_68.f_9);
			unk_0xA4E856A8CD53B8DF(Local_68.f_9);
			unk_0xBFDB9A018C6CE15A(Local_68.f_9);
			unk_0xEC9E10B23689A01D(Local_68.f_9, 1);
			unk_0x8E25082A46F87892(Local_68.f_9, joaat("weapon_unarmed"), true);
			unk_0xB499FECE23EEF9E4(Local_68.f_9, false);
			unk_0x6BBC364B0AA788E8(Local_68.f_9, 0);
			unk_0xABA7AE40608505F2(Local_68.f_9, 1, false);
			unk_0x91629AC1E1F78419(Local_68.f_9, 17, 1);
			unk_0x91629AC1E1F78419(Local_68.f_9, 0, 0);
			unk_0x91629AC1E1F78419(Local_68.f_9, 5, 0);
			if (unk_0x5237AF95232D78C5(Local_68.f_9, 1))
			{
				unk_0xA3981DED4FC2E56E(Local_68.f_9, 0, 0);
			}
...
int func_319(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x27A30
{
	int iVar0;
	...
	if (func_21(iParam0))
	{
		if (unk_0xD9C1758D86688CEA(iParam0, unk_0xBC25C936A095B5BA(), 1))
		{
			...
			unk_0x6CB22C1DB4505011(iParam0);
			unk_0x5502708AECB47F5D(iParam0);
			if (unk_0x8D66276473ABD7CC(iParam0) < iParam5)
			{
				return 1;
			}
...
int func_320(int iParam0, vector3 vParam1, float fParam2, float fParam3)//Position - 0x27BA6
{
	if (func_104(iParam0, vParam1, fParam2))
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
		{
			if (unk_0x04880508C862E589(unk_0x541C2AEF053615BC(iParam0, 1), fParam3, 1))
			{
				return 1;
			}
		}
...
int func_321(int iParam0, vector3 vParam1)//Position - 0x27BDE
{
	if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
	{
		if (unk_0x5BA05886E7FFF5CA(unk_0xB5CEFD608600A09F()) >= 0 && unk_0x5BA05886E7FFF5CA(unk_0xB5CEFD608600A09F()) < 500)
		{
			if (func_104(iParam0, vParam1, 3.5f) || unk_0xE921F8171F0733B3(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), iParam0))
			{
				return 1;
			}
		}
...
void func_322(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, int iParam5, bool bParam6)//Position - 0x27C3C
{
	func_323(uParam0, iParam1, sParam2, iParam3, bParam4, iParam5, bParam6);
}

void func_323(var uParam0, int iParam1, char* sParam2, int iParam3, bool bParam4, var uParam5, bool bParam6)//Position - 0x27C56
{
	func_324(uParam0, iParam1, 0f, 0f, 0f, sParam2, iParam3, bParam4, uParam5, bParam6);
}

void func_324(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x27C73
{
...
void func_325(var uParam0, int iParam1, vector3 vParam2, char* sParam3, int iParam4, bool bParam5, var uParam6, bool bParam7)//Position - 0x27CAB
{
	int iVar0;
	int iVar1;
...
void func_326(var uParam0)//Position - 0x28019
{
...
int func_327(var uParam0)//Position - 0x28082
{
	int iVar0;
...
int func_328(bool bParam0)//Position - 0x280AD
{
	switch (Global_8C41)
	{
		case 0:
...
void func_329(char* sParam0, int iParam1)//Position - 0x28157
{
	unk_0x2F618BD43614DD0D(sParam0);
	unk_0x72F8FA06CC9EC899(0, 0, true, iParam1);
}

int func_330(char* sParam0)//Position - 0x2816E
{
	if (!func_331(1, 1, 0))
	{
...
int func_331(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28207
{
	int iVar0;
	int iVar1;
	...
	if ((func_339() || func_338(Global_440000.f_243FE)) || func_337())
	{
		if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
		{
			iVar0 = unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0);
			iVar1 = func_336(unk_0xBC25C936A095B5BA(), 0);
			if (((unk_0xE8E192A5EFE0253F(iVar0, iVar1) || (unk_0x6F79ECA8C83E4357(iVar0) == 562680400 && iVar1 != -1)) || (unk_0x6F79ECA8C83E4357(iVar0) == 1181327175 && iVar1 != -1)) || (((unk_0x6F79ECA8C83E4357(iVar0) == -1693015116 && iVar1 == 0) && func_335(iVar0, 10)) && unk_0x3EB14CBD49DA0017(iVar0, 10) != -1))
			{
				return 0;
			}
		}
...
int func_332(int iParam0)//Position - 0x28455
{
	if (iParam0 != func_334())
	{
		...
		else if ((Global_140856 && iParam0 == unk_0xB5CEFD608600A09F()) && func_333(iParam0, 1, 0))
		{
			return Global_24FB5C[iParam0 /*406*/].f_131.f_1 != -1;
		}
	}
...
int func_333(int iParam0, bool bParam1, bool bParam2)//Position - 0x284BB
{
	int iVar0;
...
int func_334()//Position - 0x28505
{
	return -1;
}

int func_335(int iParam0, int iParam1)//Position - 0x2850E
{
	if (unk_0xE59B7F5A03335350(iParam0, 0))
	{
		if (unk_0xA6BE0954FC6BAA16(iParam0) > 0)
...
int func_336(int iParam0, int iParam1)//Position - 0x28570
{
	int iVar0;
	int iVar1;
	int iVar2;
...
var func_337()//Position - 0x285F5
{
	return Global_255A46.f_10;
}

bool func_338(int iParam0)//Position - 0x28603
{
	return iParam0 == 51;
}

var func_339()//Position - 0x28610
{
	return Global_255A46.f_F;
}

bool func_340()//Position - 0x2861E
{
	return unk_0x105601648511CC64() <= Global_43C1.f_1671 + 100;
}

void func_341(var uParam0, int iParam1, vector3 vParam2, int iParam3)//Position - 0x28633
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_342()//Position - 0x28743
{
	return func_343(unk_0xB5CEFD608600A09F());
}

int func_343(int iParam0)//Position - 0x28753
{
...
int func_344(var uParam0, bool bParam1, bool bParam2, bool bParam3)//Position - 0x28772
{
	if (uParam0->f_1)
	{
		if (unk_0x105601648511CC64() >= (uParam0->f_8 + uParam0->f_9))
...
int func_345(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28ADE
{
...
int func_346(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28B30
{
	if (!func_331(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_347(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28B79
{
	if (!func_331(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_348(bool bParam0, bool bParam1, bool bParam2)//Position - 0x28BD8
{
	if (!func_331(bParam0, bParam1, bParam2))
	{
		return 0;
...
int func_349(int iParam0)//Position - 0x28C2E
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
void func_350()//Position - 0x28C89
{
	unk_0xF0059F27F7BB6680(&Global_93C, 4);
}

void func_351(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28C99
{
	if (unk_0x2DA8CA50A72528FB(*uParam0))
	{
...
int func_352(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x28D94
{
	int iVar0;
	bool bVar1;
...
void func_353(int iParam0)//Position - 0x28DE6
{
	unk_0xC8FD3EBBB90E8D7F(iParam0, 177, true);
	unk_0xC8FD3EBBB90E8D7F(iParam0, 116, true);
	unk_0xC8FD3EBBB90E8D7F(iParam0, 42, true);
	unk_0xC8FD3EBBB90E8D7F(iParam0, 118, true);
	unk_0x566684DB6DAC0531(iParam0, true);
	unk_0x9C74359FED150B42(iParam0, 10f, 5);
	unk_0x2E35C4FA5F0ED22F(iParam0, 1);
}

void func_354(var uParam0, vector3 vParam1)//Position - 0x28E2C
{
	vector3 vVar0;
	vector3 vVar1;
	...
	if (unk_0x876474582C5DECDE(vVar0, vVar1, 0))
	{
		if (unk_0x91F0E599AED96A5E(vVar0, vVar1, joaat("weapon_grenade"), uParam0, 0))
		{
		}
		else if (unk_0x91F0E599AED96A5E(vVar0, vVar1, joaat("weapon_molotov"), uParam0, 0))
		{
		}
		else if (unk_0x91F0E599AED96A5E(vVar0, vVar1, joaat("weapon_smokegrenade"), uParam0, 0))
		{
		}
		else if (unk_0x91F0E599AED96A5E(vVar0, vVar1, joaat("weapon_bzgas"), uParam0, 0))
		{
		}
		else if (unk_0x91F0E599AED96A5E(vVar0, vVar1, joaat("weapon_stickybomb"), uParam0, 0))
		{
		}
		else if (unk_0x91F0E599AED96A5E(vVar0, vVar1, joaat("weapon_flare"), uParam0, 0))
		{
		}
		else
		{
...
void func_355()//Position - 0x28F09
{
	int iVar0;
	int iVar1;
	int iVar2;
		...
		if (iLocal_70 == 0)
		{
			...
			if (func_365())
			{
				if (iLocal_107 || iLocal_58 == 7)
				{
					if (bLocal_114)
					{
						unk_0x43B967881C60631D(Local_68.f_9, func_364(), 1048576000);
						iLocal_70 = 2;
					}
					else
					{
						unk_0x43B967881C60631D(Local_68.f_9, func_363(), 1048576000);
						iLocal_70 = 1;
					}
				}
			}
		...
		if (!unk_0xADA34C38F1319208(unk_0xBC25C936A095B5BA()))
		{
			switch (Local_68.f_A)
			{
				case 0:
					...
					{
						if (!unk_0x640A454FD54BBEF2(Local_68.f_9, unk_0xBC25C936A095B5BA()))
						{
							unk_0x56F2E1B5599188FA(Local_68.f_9, unk_0xBC25C936A095B5BA(), -1, 0, 2);
						}
					}
					else if (unk_0x640A454FD54BBEF2(Local_68.f_9, unk_0xBC25C936A095B5BA()))
					{
						unk_0x44C98C11ED6DD327(Local_68.f_9);
					}
					break;
				...
				case 3:
					if (func_112(Local_68.f_12, unk_0x491B2241281A03B7(250, 500)))
					{
						if (unk_0xD8BE87198802B1F7(Local_68.f_9))
						{
							unk_0x3D669AF9A68FF281(Local_68.f_9);
						}
						unk_0x56F2E1B5599188FA(Local_68.f_9, unk_0xBC25C936A095B5BA(), -1, 0, 2);
						unk_0x85DB484A637CEAB9(Local_68.f_9, unk_0xBC25C936A095B5BA(), -1);
						Local_68.f_A = 4;
					}
					break;
				...
				case 4:
					...
					{
						Local_68.f_12 = (unk_0x105601648511CC64() - 5000);
						Local_68.f_A = 3;
					}
					break;
				...
				case 5:
					...
					unk_0x9565F9267674873A(Local_68.f_9, unk_0xBC25C936A095B5BA(), 20000, 2.5f, 1f, 1073741824, 0);
					unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
					Local_68.f_A = 6;
					break;
				...
				case 6:
					if (!func_104(Local_68.f_9, vLocal_331, 3.5f))
					{
						...
						{
							unk_0x2AB5DAAC0FEF1B4F(Local_68.f_9, 1.1f);
						}
					}
				...
				case 7:
					if (func_112(Local_68.f_12, unk_0x491B2241281A03B7(250, 1000)))
					{
						if (unk_0xD8BE87198802B1F7(Local_68.f_9))
						{
							unk_0x3D669AF9A68FF281(Local_68.f_9);
						}
						unk_0x80F51E5792576467(Local_68.f_9, 0);
						unk_0x91629AC1E1F78419(Local_68.f_9, 5, 1);
						unk_0x91629AC1E1F78419(Local_68.f_9, 0, 0);
						unk_0xB8CBD998685C0685(Local_68.f_9, unk_0xBC25C936A095B5BA(), 0, 16);
						unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
						Local_68.f_A = 8;
					}
					break;
				...
				case 9:
					unk_0x91629AC1E1F78419(Local_68.f_9, 5, 0);
					unk_0xF1FC2182A76AD7FC(Local_68.f_9, 1);
					if (!unk_0x2CDE18D6C89522AD(Local_68.f_9))
					{
						unk_0x50FBC3BBBAC48D06(Local_68.f_9, 1000, 1000, 0, 1, 1, 0);
					}
					Local_68.f_A = 10;
					break;
				...
				case 10:
					if (!unk_0x2CDE18D6C89522AD(Local_68.f_9))
					{
						...
						{
							if (!unk_0x149E9368A11035DE(Local_68.f_9))
							{
								unk_0xDD8AD9DE28030E73(Local_68.f_9, "CODE_HUMAN_STAND_COWER");
								unk_0xEE7131C3C73E7282(Local_68.f_9, -1);
								unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
							}
						}
					}
				...
				case 29:
					unk_0x9CDD10270A1ACF6F(Local_68.f_9, &iVar0, 1);
					if (iVar0 == joaat("weapon_unarmed"))
					{
						unk_0x7A535CE1F001F3FE(Local_68.f_9, joaat("weapon_pistol"), -1, false, true);
					}
					unk_0x91629AC1E1F78419(Local_68.f_9, 0, 0);
					unk_0x80F51E5792576467(Local_68.f_9, 0);
					unk_0xFC3C88E2313FA926(Local_68.f_9, 15);
					unk_0xA4E856A8CD53B8DF(Local_68.f_9);
					unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
					Local_68.f_A = 30;
					break;
				...
				case 30:
					...
					{
						fVar3 = unk_0x55AEFCD285ECC0F2(5f, 8f);
						unk_0xC5A6DFE2B8987B17(&uLocal_143);
						unk_0xD008964AF03AE263(0, unk_0xBC25C936A095B5BA(), fVar3, 30f);
						unk_0x57D65255D3D3B6A7(0, unk_0xBC25C936A095B5BA(), 2000, 0);
						unk_0x535008C596714F9E(uLocal_143);
						unk_0xA8E6405305C0D7DF(Local_68.f_9, uLocal_143);
						unk_0x02DAF06EA4F08219(&uLocal_143);
						unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
					}
					break;
				...
				case 31:
					if (func_112(Local_68.f_12, unk_0x491B2241281A03B7(250, 500)))
					{
						unk_0xFC3C88E2313FA926(Local_68.f_9, 50);
						unk_0x9CDD10270A1ACF6F(Local_68.f_9, &iVar0, 1);
						if (iVar0 == joaat("weapon_unarmed"))
						{
							unk_0x7A535CE1F001F3FE(Local_68.f_9, joaat("weapon_pistol"), -1, false, true);
							unk_0x8E25082A46F87892(Local_68.f_9, joaat("weapon_pistol"), false);
						}
						unk_0xC5A6DFE2B8987B17(&uLocal_143);
						unk_0x57D65255D3D3B6A7(0, unk_0xBC25C936A095B5BA(), 1500, 0);
						unk_0x8744E2AAA4C44FDC(0, vLocal_332, unk_0xBC25C936A095B5BA(), 1f, 1, 0.5f, 4f, 1, 0, 0, -957453492, 20000);
						...
						unk_0x3C620BAB3C0E3267(0, vLocal_332, 50f);
						unk_0x535008C596714F9E(uLocal_143);
						unk_0xA8E6405305C0D7DF(Local_68.f_9, uLocal_143);
						unk_0x02DAF06EA4F08219(&uLocal_143);
						unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
				...
				case 33:
					if (func_112(Local_68.f_12, unk_0x491B2241281A03B7(250, 500)))
					{
						unk_0xFC3C88E2313FA926(Local_68.f_9, 10);
						unk_0x9CDD10270A1ACF6F(Local_68.f_9, &iVar0, 1);
						if (iVar0 == joaat("weapon_unarmed"))
						{
							unk_0x7A535CE1F001F3FE(Local_68.f_9, joaat("weapon_pistol"), -1, false, true);
						...
						unk_0x8744E2AAA4C44FDC(0, vLocal_332, unk_0xBC25C936A095B5BA(), 2f, 1, 0.5f, 4f, 1, 0, 0, -687903391, 20000);
				...
				case 35:
					if (func_112(Local_68.f_12, unk_0x491B2241281A03B7(250, 500)))
					{
						...
						unk_0xC5A6DFE2B8987B17(&uLocal_143);
						unk_0x57D65255D3D3B6A7(0, unk_0xBC25C936A095B5BA(), 750, 0);
						unk_0x8744E2AAA4C44FDC(0, vLocal_332, unk_0xBC25C936A095B5BA(), 2f, 1, 0.75f, 4f, 1, 0, 0, -687903391, 20000);
						unk_0x535008C596714F9E(uLocal_143);
						unk_0xA8E6405305C0D7DF(Local_68.f_9, uLocal_143);
						unk_0x02DAF06EA4F08219(&uLocal_143);
						unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
				...
				case 37:
					if (func_112(Local_68.f_12, unk_0x491B2241281A03B7(250, 750)))
					{
						unk_0x5AAB329BBC1053A1(Local_68.f_9, 30f);
						unk_0x6CCBC1B22488DC0C(Local_68.f_9, 30f);
						unk_0x1D772375218D2BDC(Local_68.f_9, 30f);
						unk_0x91629AC1E1F78419(Local_68.f_9, 1, 0);
						unk_0x91629AC1E1F78419(Local_68.f_9, 3, 1);
						unk_0x91629AC1E1F78419(Local_68.f_9, 5, 1);
						unk_0xABA7AE40608505F2(Local_68.f_9, 512, true);
						unk_0x91629AC1E1F78419(Local_68.f_9, 0, 1);
						unk_0x80F51E5792576467(Local_68.f_9, 1);
						unk_0x54480313BB3E8DD0(Local_68.f_9, 1);
						unk_0xFC3C88E2313FA926(Local_68.f_9, unk_0x491B2241281A03B7(10, 22));
						unk_0x479A4C6E23FBB038(Local_68.f_9, unk_0x491B2241281A03B7(30, 60));
						unk_0xF2BA021070DE727E(Local_68.f_9, 2055493265);
						unk_0x9CDD10270A1ACF6F(Local_68.f_9, &iVar0, 1);
						if (iVar0 == joaat("weapon_unarmed"))
						{
							unk_0x7A535CE1F001F3FE(Local_68.f_9, joaat("weapon_pistol"), -1, false, true);
				...
				case 13:
					if (func_112(Local_68.f_12, unk_0x491B2241281A03B7(0, 500)))
					{
						if (unk_0xD8BE87198802B1F7(Local_68.f_9))
						{
							unk_0x92F21EB7190F52E9(Local_68.f_9, vLocal_331);
						}
						unk_0x9CDD10270A1ACF6F(Local_68.f_9, &iVar0, 1);
						if (iVar0 != joaat("weapon_unarmed"))
						{
						...
						unk_0xABA7AE40608505F2(Local_68.f_9, 2, false);
						unk_0xABA7AE40608505F2(Local_68.f_9, 64, false);
						unk_0xABA7AE40608505F2(Local_68.f_9, 128, false);
						unk_0xABA7AE40608505F2(Local_68.f_9, 8, false);
						unk_0xABA7AE40608505F2(Local_68.f_9, 1, false);
						unk_0xABA7AE40608505F2(Local_68.f_9, 32, false);
						unk_0x91629AC1E1F78419(Local_68.f_9, 5, 0);
						unk_0x91629AC1E1F78419(Local_68.f_9, 17, 1);
						unk_0x5558ED6D4A2DEC93(Local_68.f_9, unk_0xBC25C936A095B5BA(), 200f, -1, 0, 0);
						unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
						unk_0x22321800954A532E(Local_68.f_9, 1);
						Local_68.f_A = 14;
					}
				...
				case 15:
					unk_0xABA7AE40608505F2(Local_68.f_9, 2, true);
					unk_0xABA7AE40608505F2(Local_68.f_9, 64, false);
					unk_0xABA7AE40608505F2(Local_68.f_9, 128, false);
					unk_0xABA7AE40608505F2(Local_68.f_9, 8, false);
					unk_0xABA7AE40608505F2(Local_68.f_9, 1, false);
					...
					unk_0x91629AC1E1F78419(Local_68.f_9, 5, 0);
					unk_0x91629AC1E1F78419(Local_68.f_9, 17, 1);
					unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 173, true);
					unk_0x2E9860A2B72187F5(Local_68.f_9, 237, 1);
					unk_0x1F6829714DE50304(Local_68.f_9, 3f);
					if (func_94(Local_71[0 /*6*/]))
					{
						if ((!unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), Local_71[0 /*6*/], 0) && func_104(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) && func_362(unk_0x349C94FFF43E2979(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
						{
							if (unk_0x62F3A07C43FFB568(Local_68.f_9, Local_71[0 /*6*/], 0) && !unk_0xA4813477CC5DD00F(Local_68.f_9))
							{
								Local_68.f_A = 16;
							}
							else if (func_112(Local_68.f_12, unk_0x491B2241281A03B7(250, 350)))
							{
								if (unk_0xD8BE87198802B1F7(Local_68.f_9))
								{
									unk_0x92F21EB7190F52E9(Local_68.f_9, vLocal_331);
								...
								unk_0xD179FA0466FA4FE3(Local_68.f_9, Local_71[0 /*6*/], 25000, -1, 2f, 8388608, 0);
								unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
								Local_68.f_A = 16;
							}
						}
				...
				case 16:
					...
					else if (((unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), Local_71[0 /*6*/], 0) || unk_0xA4813477CC5DD00F(Local_68.f_9)) || !func_104(Local_71[0 /*6*/], Local_71[0 /*6*/].f_1, 3f)) || !func_362(unk_0x349C94FFF43E2979(Local_71[0 /*6*/]), Local_71[0 /*6*/].f_4, 20f))
					{
						Local_68.f_A = 13;
					}
					else if (unk_0x25EF720B1CAB1E23(Local_68.f_9, Local_71[0 /*6*/]))
					{
						Local_68.f_A = 39;
					}
					...
					unk_0x1F6829714DE50304(Local_68.f_9, 2f);
					break;
				
				case 17:
					if (func_94(Local_71[0 /*6*/]) && unk_0x25EF720B1CAB1E23(Local_68.f_9, Local_71[0 /*6*/]))
					{
						unk_0x1A06AE15BF21D407(Local_68.f_9, Local_71[0 /*6*/], unk_0xBC25C936A095B5BA(), 8, 30f, 786468, 350f, 30f, 1);
						unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 173, false);
						unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
						Local_68.f_A = 18;
					}
					else if (!unk_0x8F1FDD0A40DC834A(Local_68.f_9))
					{
						Local_68.f_A = 13;
					}
					break;
				...
				case 21:
					if (func_360(Local_68.f_9, Local_68.f_13, 100f, 1, 1090519040, 1097859072, 0) || func_359())
					{
						Local_68.f_A = 23;
					}
					else if (unk_0xB3CF56CA25030EC5(func_358()))
					{
						if (unk_0xF4FCC3C1048FF2AB(Local_68.f_9, -1519143300) == 1)
						{
							unk_0x641068AE8FF724D5(Local_68.f_9, 500);
						}
						else
						{
							unk_0xA4E856A8CD53B8DF(Local_68.f_9);
						...
						if (!unk_0x9488E18994C5C83D(Local_68.f_9, func_358()))
						{
							unk_0x75E3FA28CC7D5707(Local_68.f_9, func_358());
						}
						unk_0xCF0A6E4BED1DBA5D(func_358(), 0);
						unk_0xB26291CA19AEC32C(func_358(), 1.5f, 3.5f, -1082130432);
						unk_0x59B9712C1EAB0092(Local_68.f_9, 0);
						unk_0x95F58F57ACD332BA(Local_68.f_9, 1);
						unk_0x11BCA0CA7D0CE293(Local_68.f_9, 1);
						unk_0xEDBBBB8EA1B1625E(Local_68.f_9, 1);
						unk_0x5056032BA0CF3AAD(Local_68.f_9, 1);
						unk_0x6757D726B4BAF0C4(Local_68.f_9, 0);
						unk_0x12B5924811F58165(Local_68.f_9, 1);
						unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 167, true);
						unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 118, true);
						unk_0xF82197F205B9D8FD(Local_68.f_9, 1);
						unk_0xB71D41C0310C93DE(Local_68.f_9, 1, 1);
						unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 42, true);
						unk_0x63ECE17EEAC84602(Local_68.f_9, 1);
						unk_0xB6A0EC6216225695(Local_68.f_9, 1);
						unk_0xB58463DD7085635A(Local_68.f_9, 2f);
						unk_0xA3ECE7AA42735A48(Local_68.f_9, 2f);
						unk_0x5056032BA0CF3AAD(Local_68.f_9, 1);
						unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 118, true);
						unk_0xABA7AE40608505F2(Local_68.f_9, 1, false);
						unk_0x91629AC1E1F78419(Local_68.f_9, 17, 1);
					...
					else
					{
						if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
						{
							if (func_357())
							{
								...
								if (!unk_0x62F3A07C43FFB568(Local_68.f_9, iVar1, 0))
								{
									...
									if (fVar4 < 1.75f && func_104(Local_68.f_9, vLocal_331, 8f))
									{
										if (!func_62(Local_68.f_9, -1794415470))
										{
											...
											{
												if (unk_0x1AAF0C23233C57AF(iVar1, 0, 0) && unk_0x2101FAC9A9D4C29D(Local_68.f_9, iVar1, 0, 1, 0))
												{
													iVar2 = 0;
												}
												else
											...
											if (iVar2 != -1)
											{
												unk_0xD179FA0466FA4FE3(Local_68.f_9, iVar1, 25000, iVar2, 2f, 1048577, 0);
											}
										}
										else if (unk_0x8F1FDD0A40DC834A(Local_68.f_9))
										{
											if (unk_0x25480ACDBB6DB8F1(Local_68.f_9) != iVar1)
											{
												unk_0xA4E856A8CD53B8DF(Local_68.f_9);
											}
										}
									...
									{
										if (!unk_0x8F1FDD0A40DC834A(Local_68.f_9))
										{
											unk_0xA4E856A8CD53B8DF(Local_68.f_9);
										}
									}
						...
						else if (!unk_0x5237AF95232D78C5(Local_68.f_9, 1))
						{
							if (!unk_0x8F1FDD0A40DC834A(Local_68.f_9))
							{
								unk_0x56F2E1B5599188FA(Local_68.f_9, unk_0xBC25C936A095B5BA(), -1, 0, 2);
				...
				case 23:
					if (func_360(Local_68.f_9, Local_68.f_13, 100f, 1, 1090519040, 1097859072, 0) || func_359())
					{
						if (unk_0xD45C08B05D4687A7(Local_68.f_9))
						{
							unk_0x57EB4CC8F1928A47(Local_68.f_9);
							unk_0xB71D41C0310C93DE(Local_68.f_9, 0, 1);
							unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 42, false);
							unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 118, true);
						}
						...
						if (((!unk_0x2CDE18D6C89522AD(Local_68.f_9) && !unk_0x687BD6F7DF82B377(Local_68.f_9, 0)) && !unk_0xA4813477CC5DD00F(Local_68.f_9)) && !func_62(Local_68.f_9, -828834893))
						{
							unk_0x56F2E1B5599188FA(Local_68.f_9, unk_0xBC25C936A095B5BA(), -1, 0, 2);
							if ((!func_356(Local_68.f_13, 10) && func_104(Local_68.f_9, vLocal_331, 50f)) || !func_112(iLocal_140, 2000))
							{
								if (unk_0x5237AF95232D78C5(Local_68.f_9, 0))
								{
									unk_0xA3981DED4FC2E56E(Local_68.f_9, 0, 0);
								}
								else if (((!unk_0x72C9157015C2151B(unk_0xBC25C936A095B5BA(), 6) && !unk_0x425BEBAA53B39EBF(unk_0xB5CEFD608600A09F(), Local_68.f_9)) && !func_359()) || unk_0x149E9368A11035DE(Local_68.f_9))
								{
									unk_0x85DB484A637CEAB9(Local_68.f_9, unk_0xBC25C936A095B5BA(), -1);
								}
								else if (unk_0xF4FCC3C1048FF2AB(Local_68.f_9, -1519143300) == 1)
								{
									unk_0x641068AE8FF724D5(Local_68.f_9, -1);
								}
								else
								{
									unk_0x2A2F7485FD2B9A29(Local_68.f_9, -1, unk_0xBC25C936A095B5BA(), -1, 0);
								}
							}
							else if (!unk_0x5237AF95232D78C5(Local_68.f_9, 0))
							{
								unk_0x85DB484A637CEAB9(Local_68.f_9, unk_0xBC25C936A095B5BA(), -1);
							}
							unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
					...
					if (func_360(Local_68.f_9, Local_68.f_13, 100f, 1, 1090519040, 1097859072, 0) || func_359())
					{
						if (!func_62(Local_68.f_9, -1519143300))
						{
							if (!func_62(Local_68.f_9, -875674219))
							{
								if (unk_0x5237AF95232D78C5(Local_68.f_9, 0))
								{
									if (!func_356(Local_68.f_13, 10) && func_104(Local_68.f_9, vLocal_331, 50f))
									{
										unk_0xA3981DED4FC2E56E(Local_68.f_9, 0, 0);
										Local_68.f_A = 23;
									}
							...
							else if (!func_356(Local_68.f_13, 10) && func_104(Local_68.f_9, vLocal_331, 50f))
							{
								if ((unk_0x72C9157015C2151B(unk_0xBC25C936A095B5BA(), 6) || unk_0x425BEBAA53B39EBF(unk_0xB5CEFD608600A09F(), Local_68.f_9)) || func_359())
								{
									Local_68.f_A = 23;
								}
							}
				...
				case 25:
					if (func_360(Local_68.f_9, Local_68.f_13, 100f, 1, 1090519040, 1097859072, 0))
					{
						Local_68.f_A = 23;
					}
					else
				...
				case 26:
					...
					else if (unk_0x149E9368A11035DE(Local_68.f_9))
					{
						unk_0x5056032BA0CF3AAD(Local_68.f_9, 1);
						unk_0xEDBBBB8EA1B1625E(Local_68.f_9, 0);
					}
					else if ((!unk_0x2CDE18D6C89522AD(Local_68.f_9) && !unk_0x69871CAEBDD20966(Local_68.f_9)) && unk_0x7214F4879DF8A314(Local_68.f_9))
					{
						if (!unk_0xC5B8A5F778E321DD(Local_68.f_9, unk_0xBC25C936A095B5BA(), 45f))
						{
							if (!func_62(Local_68.f_9, -875674219))
							{
								unk_0x85DB484A637CEAB9(Local_68.f_9, unk_0xBC25C936A095B5BA(), -1);
...
bool func_356(int iParam0, int iParam1)//Position - 0x2A3B3
{
	return (unk_0xC87A57742F7D3C06() - iParam0) > iParam1;
}

int func_357()//Position - 0x2A3C5
{
	int iVar0;
	int iVar1;
...
var func_358()//Position - 0x2A44B
{
	return unk_0x705BBFE5A8ADE4A9(unk_0xFC1CAE18F3ECBF2D());
}

int func_359()//Position - 0x2A45B
{
	if (!iLocal_82)
	{
		return 1;
	...
	if (unk_0x69871CAEBDD20966(Local_68.f_9) || unk_0x2CDE18D6C89522AD(Local_68.f_9))
	{
		iLocal_140 = unk_0x105601648511CC64();
		return 1;
	}
...
int func_360(int iParam0, int iParam1, float fParam2, bool bParam3, float fParam4, float fParam5, bool bParam6)//Position - 0x2A4C8
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	{
		vVar0 = { unk_0x541C2AEF053615BC(iParam0, 1) };
		if (unk_0x04880508C862E589(vVar0, fParam4, 1))
		{
			return 1;
		}
		...
		if (unk_0xC9FA5D38428AB6BE(-1, vVar0, fParam5))
		{
			return 1;
		}
		vVar1 = { vVar0 };
		...
		if (unk_0x876474582C5DECDE(vVar1, vVar2, 1))
		{
			return 1;
		}
	}
...
int func_361(bool bParam0, bool bParam1, bool bParam2)//Position - 0x2A67E
{
	int iVar0;
...
int func_362(float fParam0, float fParam1, float fParam2)//Position - 0x2A775
{
...
char* func_363()//Position - 0x2A791
{
	return "move_m@bail_bond_not_tazered";
}

char* func_364()//Position - 0x2A79D
{
	return "move_m@bail_bond_tazered";
}

int func_365()//Position - 0x2A7A9
{
...
void func_366(var uParam0, bool bParam1)//Position - 0x2A7DE
{
...
void func_367(int iParam0, var uParam1, float fParam2, int iParam3)//Position - 0x2A7F5
{
	if (func_427(iParam0))
	{
...
bool func_368(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2A821
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_369(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2A8E2
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
	...
	*uParam0 = 0;
	if (unk_0x386592AF38881675(iVar3))
	{
		...
		if (unk_0x399F7937FFE4DEBF(iVar3) == iParam2)
		{
			if (bLocal_57)
			{
				unk_0xD1FD19DF6D5B1300(vParam1, unk_0x541C2AEF053615BC(iParam2, 1), 255, 0, 0, 255, 0, 0, 255, 255);
			}
...
Vector3 func_370(int iParam0, int iParam1)//Position - 0x2AA0E
{
	int iVar0;
...
int func_372(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2AB1D
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_182(unk_0x541C2AEF053615BC(iParam1, 1) - unk_0x541C2AEF053615BC(iParam0, 1)) };
	...
	{
		vVar1 = { func_182(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_373(vector3 vParam0, vector3 vParam1)//Position - 0x2ABAE
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

int func_374(int iParam0, int iParam1)//Position - 0x2ABCF
{
	int iVar0;
...
void func_375(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2AC0E
{
	if (func_427(iParam0))
	{
...
void func_376()//Position - 0x2AC3A
{
	if (func_57(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1), vLocal_330, 100f))
	{
		if (!func_377())
		{
			unk_0x04DD7A558FCF2C34(&vLocal_325, 8);
			func_65();
			iLocal_111 = 1;
		}
	}
	...
	{
		if (!func_57(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), 1), vLocal_330, 120f))
		{
			if (unk_0xDC9E16E99286F31D())
			{
				unk_0xD103510B8989BEB2();
...
bool func_377()//Position - 0x2ACC4
{
	return Global_16129;
}

void func_378()//Position - 0x2ACD0
{
	func_35();
	func_376();
	if (func_21(Local_68.f_9))
			...
			case 1:
				if (!iLocal_108)
				{
					...
					if (!func_104(Local_68.f_9, vLocal_331, 25f))
					{
						...
						{
							Local_68.f_12 = unk_0x105601648511CC64();
							Local_68.f_A = 25;
						}
...
int func_379(int iParam0, vector3 vParam1, int iParam2, int iParam3, float fParam4)//Position - 0x2AFE4
{
	vector3 vVar0;
	var uVar1;
	char[] cVar2[8];
	...
	if (func_21(*iParam0))
	{
		if (!func_60())
		{
			...
			{
				if (unk_0x105601648511CC64() - *iParam2) > (iParam3 + unk_0x491B2241281A03B7(0, 2000))
				{
					uVar1 = 16;
...
void func_380(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2B071
{
...
void func_381()//Position - 0x2B0AC
{
	int iVar0;
	int iVar1;
	...
	if (func_21(Local_68.f_9))
	{
		...
		{
			iVar0 = unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0);
			if (unk_0x5237AF95232D78C5(Local_68.f_9, 0) && unk_0x9FE9D386222EEE47(Local_68.f_9, 0) == iVar0)
			{
				if (!unk_0x86B385F1E3450315(unk_0xB5CEFD608600A09F(), 0))
				{
					if (!iLocal_106)
					{
						if (!func_60())
						{
							iLocal_121 = unk_0x105601648511CC64();
							iLocal_106 = 1;
						}
					}
					else if (!iLocal_86[0])
					{
						if ((unk_0x105601648511CC64() - iLocal_121) > 7500)
						{
							func_384(0);
						}
					}
					...
					{
						if ((unk_0x105601648511CC64() - iLocal_121) > 10000)
						{
							func_384(1);
						}
					}
		...
		else
		{
			...
			else
			{
				...
				else if (Local_68.f_A == 24 && func_62(Local_68.f_9, -1519143300))
				{
					if (func_104(Local_68.f_9, vLocal_331, 25f))
					{
						if (!func_313("BB4_J11", 1))
						{
							if (func_112(iLocal_123, unk_0x491B2241281A03B7(2500, 5000)))
							{
								if (func_60())
								{
									func_5();
				...
				else
				{
					...
					if (!func_60())
					{
						if (func_112(iLocal_122, unk_0x491B2241281A03B7(3000, 6000)))
						{
							if (!func_104(Local_68.f_9, vLocal_331, 20f))
							{
...
int func_382(int iParam0)//Position - 0x2B508
{
	int iVar0;
...
void func_383(char* sParam0, int iParam1)//Position - 0x2B541
{
	if (func_317(sParam0))
	{
...
void func_384(int iParam0)//Position - 0x2B558
{
...
void func_385()//Position - 0x2B593
{
	func_35();
	func_376();
	if (func_21(Local_68.f_9))
			...
			case 1:
				if (!iLocal_108)
				{
					...
					else
					{
						...
						if (unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_330, 4f, 4f, 2f, 1, 1, 0))
						{
						}
						...
						if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
						{
							if (func_104(unk_0xBC25C936A095B5BA(), vLocal_330, 6.5f))
							{
								iLocal_60 = 2;
							}
						}
						else if (func_104(unk_0xBC25C936A095B5BA(), vLocal_330, 2.5f))
						{
							iLocal_60 = 2;
						}
					}
...
int func_386(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x2B968
{
	int iVar0;
...
bool func_387(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x2BA59
{
	vector3 vVar0;
...
int func_388(vector3 vParam0, int iParam1, bool bParam2)//Position - 0x2BA83
{
	int iVar0;
...
void func_389()//Position - 0x2BAB1
{
	bool bVar0;
...
void func_390(bool bParam0, var uParam1)//Position - 0x2BED0
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_391(int iParam0)//Position - 0x2BFBD
{
	int iVar0;
...
void func_392(int iParam0)//Position - 0x2C008
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_21(Local_69[iVar0 /*19*/]))
		{
			func_367(Local_69[iVar0 /*19*/], &(Local_69[iVar0 /*19*/].f_10), 1126825984, 7);
			switch (Local_69[iVar0 /*19*/].f_E)
			{
				...
				case 1:
					...
					if (func_112(Local_69[iVar0 /*19*/].f_F, iVar2))
					{
						func_113(iVar0);
					}
					break;
				...
				case 2:
					if (func_394(Local_69[iVar0 /*19*/], Local_69[iVar0 /*19*/].f_10, 50f, 1, 1, 12f, 15f))
					{
						if (!func_21(Local_68.f_9) || (unk_0x889DA6CE8E4DB344(Local_68.f_9) && unk_0x9692102E7020D903(Local_68.f_9) > 1f))
						{
							if (unk_0xF4FCC3C1048FF2AB(Local_69[iVar0 /*19*/], -1519143300) == 1)
							{
								if (iVar0 == 0)
								{
									iVar2 = 750;
								...
								unk_0x641068AE8FF724D5(Local_69[iVar0 /*19*/], iVar2);
							}
							else
							{
								unk_0xA4E856A8CD53B8DF(Local_69[iVar0 /*19*/]);
								unk_0xD999D66C5AFA4BE3(Local_69[iVar0 /*19*/]);
							}
							Local_69[iVar0 /*19*/].f_E = 4;
							func_108(&(Local_69[iVar0 /*19*/].f_6));
						}
					...
					else if (!func_62(Local_69[iVar0 /*19*/], 780511057))
					{
						...
						{
							if (!func_356(Local_69[iVar0 /*19*/].f_10, 10))
							{
								unk_0xE95574194EEDAEF7(Local_69[iVar0 /*19*/], unk_0x541C2AEF053615BC(Local_69[iVar0 /*19*/], 1), 5f, 0, 0);
								unk_0xB8CBD998685C0685(Local_69[iVar0 /*19*/], unk_0xBC25C936A095B5BA(), 0, 16);
								unk_0x2E35C4FA5F0ED22F(Local_69[iVar0 /*19*/], 1);
							}
						}
					}
					else
					{
						...
						{
							unk_0xA4E856A8CD53B8DF(Local_69[iVar0 /*19*/]);
							unk_0x56F2E1B5599188FA(Local_69[iVar0 /*19*/], unk_0xBC25C936A095B5BA(), -1, 0, 2);
							unk_0x85DB484A637CEAB9(Local_69[iVar0 /*19*/], unk_0xBC25C936A095B5BA(), -1);
							unk_0x2E35C4FA5F0ED22F(Local_69[iVar0 /*19*/], 0);
						}
				...
				case 4:
					...
					{
						if (!unk_0x889DA6CE8E4DB344(Local_69[iVar0 /*19*/]))
						{
...
int func_393(int iParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x2C35C
{
	if (iParam3 == 0)
	{
...
int func_394(int iParam0, int iParam1, float fParam2, bool bParam3, bool bParam4, float fParam5, float fParam6)//Position - 0x2C533
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (func_21(iParam0))
	{
		...
		{
			vVar0 = { unk_0x541C2AEF053615BC(iParam0, 1) };
			if (unk_0x04880508C862E589(vVar0, fParam5, 1))
			{
				return 1;
			}
			if (func_104(iParam0, vLocal_331, fParam2))
			...
			if (unk_0xC9FA5D38428AB6BE(-1, vVar0, fParam6))
			{
				return 1;
			}
			vVar1 = { vVar0 };
...
void func_395(int iParam0)//Position - 0x2C6CC
{
	int iVar0;
	...
	while (iVar0 <= (iParam0 - 1))
	{
		if (func_21(Local_69[iVar0 /*19*/]))
		{
			Local_69[iVar0 /*19*/].f_F = unk_0x105601648511CC64();
...
void func_396()//Position - 0x2C70B
{
	if (func_21(Local_68.f_9))
	{
		func_375(Local_68.f_9, &iLocal_133, 1126825984, 1);
		func_367(Local_68.f_9, &(Local_68.f_13), 120f, 7);
		func_355();
		switch (iLocal_60)
		{
			case 0:
			...
			case 1:
				switch (iLocal_61)
				{
					case 2:
							...
							if (func_104(Local_68.f_9, vLocal_331, 25f) && func_406(Local_68.f_9, vLocal_331, 10f))
							{
								if (unk_0xB3B744D2D9D757D1(unk_0xBC25C936A095B5BA()) || unk_0x74AAB09D79A6344E(unk_0xBC25C936A095B5BA(), 0))
								{
									if (func_405(&(Local_68.f_13)))
									{
										...
										{
											Local_68.f_12 = (unk_0x105601648511CC64() - 50000);
											Local_68.f_A = 3;
										}
									}
									else if (!unk_0xADA34C38F1319208(unk_0xBC25C936A095B5BA()) && unk_0xE921F8171F0733B3(unk_0xBC25C936A095B5BA(), Local_68.f_9))
									{
										iLocal_61 = 1;
										iLocal_91 = 0;
										if (Local_68.f_A != 3 && Local_68.f_A != 4)
						...
						if (func_360(Local_68.f_9, Local_68.f_13, 25f, 0, 1090519040, 1097859072, 0))
						{
							iLocal_60 = 2;
						}
						break;
					...
					case 1:
						...
						else if (!iLocal_87)
						{
							if (!func_313("BBC_T14", 1) && !func_313("BB4_J2", 1))
							{
								...
								else if (iLocal_61 == 1)
								{
									...
									{
										Local_68.f_11 = (unk_0x105601648511CC64() - 3000);
										iLocal_87 = 1;
									}
								}
							}
						...
						else if (func_112(Local_68.f_11, 500))
						{
							if (Local_68.f_A != 3 && Local_68.f_A != 4)
							{
								Local_68.f_12 = unk_0x105601648511CC64();
...
void func_397(bool bParam0)//Position - 0x2CBCF
{
...
void func_398()//Position - 0x2CBF3
{
	Global_394A = 0;
	func_399();
}

void func_399()//Position - 0x2CC03
{
	if (unk_0xE6711F601F11B66B())
	{
		unk_0x5C7DC611411E2CF9();
...
void func_400()//Position - 0x2CC27
{
	if (!iLocal_92)
	{
		if (!func_60())
		{
			if (func_104(Local_68.f_9, vLocal_331, (25f + 5f)))
			{
				...
				if (unk_0xF1734B55490E9045(&Local_329))
				{
...
struct<6> func_401()//Position - 0x2CD4C
{
	struct<6> Var0;
	int iVar1;
	int iVar2;
...
int func_402(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2CDF8
{
	if (iParam5 == 0)
	{
		if (unk_0x4B8E3E5901E59EB8())
...
bool func_403(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2CE35
{
...
int func_404(int iParam0, int iParam1, bool bParam2, float fParam3, float fParam4)//Position - 0x2CE89
{
	if (func_427(iParam0))
	{
		if (!func_356(iParam1, 10))
...
int func_405(var uParam0)//Position - 0x2CEEF
{
...
int func_406(int iParam0, vector3 vParam1, float fParam2)//Position - 0x2CF09
{
	vector3 vVar0;
	float fVar1;
	
	vVar0 = { unk_0x541C2AEF053615BC(iParam0, 0) };
	fVar1 = unk_0x357058E632979E65((vVar0.z - vParam1.z));
	if (fVar1 <= fParam2)
	{
		return 1;
	}
...
void func_407()//Position - 0x2CF38
{
	switch (iLocal_60)
	{
		case 0:
		...
		case 1:
			...
			if (func_21(Local_68.f_9))
			{
				...
				else if (unk_0xDF25D3BB3759E7D1(unk_0xB5CEFD608600A09F(), Local_68.f_9) || unk_0x425BEBAA53B39EBF(unk_0xB5CEFD608600A09F(), Local_68.f_9))
				{
					iLocal_61 = 2;
					iLocal_60 = 2;
				}
...
void func_408(var uParam0, var uParam1)//Position - 0x2D165
{
	if (!uParam0->f_7)
	{
...
char* func_409(int iParam0)//Position - 0x2D1F6
{
	switch (iParam0)
	{
		case 0:
...
char* func_410(int iParam0)//Position - 0x2D23B
{
	switch (iParam0)
	{
		case 0:
...
int func_411(int iParam0, int iParam1, int iParam2)//Position - 0x2D27E
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar1 = Global_90CE[iParam1 /*12*/].f_3;
	if (iVar1 >= 3)
	{
		return 0;
	}
	...
	iVar4 = iParam2;
	iVar3 = 0;
	while (iVar3 < Global_B522[iVar0 /*203*/].f_9)
	{
		if (Global_B522[iVar0 /*203*/].f_A[iVar3 /*48*/] == iParam1)
		{
			if (iVar4 == 0)
			{
				iVar2 = iVar3;
	...
	while (iVar3 < 16)
	{
		if ((Global_B3B8[iVar1 /*120*/].f_56[iVar3] && Global_B3B8[iVar1 /*120*/].f_12[iVar3] == Global_B522[iVar0 /*203*/].f_1) && Global_B3B8[iVar1 /*120*/].f_1[iVar3] == iVar2)
		{
			return Global_B3B8[iVar1 /*120*/].f_45[iVar3];
		}
		iVar3++;
	}
	return 0;
...
int func_412(int iParam0)//Position - 0x2D368
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_413(int iParam0)//Position - 0x2D3CC
{
	switch (iParam0)
	{
		case 0:
...
void func_414()//Position - 0x2D409
{
	if (bLocal_103)
	{
		if (((iLocal_58 != 9 && iLocal_58 != 4) && iLocal_58 != 5) && iLocal_58 != 8)
		{
			if (unk_0x724D816EA203A79E(Local_68.f_9))
			{
				if (unk_0x1D403DFADBC2DE3C(Local_68.f_9, 0) || unk_0x36CEFBE9B745A58D(Local_68.f_9))
				{
					func_123(8);
				}
			}
...
void func_415()//Position - 0x2D466
{
	if (bLocal_103)
	{
...
void func_416()//Position - 0x2D4B0
{
	if (unk_0x724D816EA203A79E(Local_75))
	{
		if (unk_0x1D403DFADBC2DE3C(Local_75, 0) || unk_0x36CEFBE9B745A58D(Local_75))
		{
			iLocal_62 = 3;
			return;
		}
	...
	if (iLocal_58 == 0)
	{
		...
		{
			if (unk_0x41A5D6415E2CC10E(Local_68.f_9))
			{
				iLocal_62 = 1;
				return;
			}
	...
	else if (unk_0x724D816EA203A79E(Local_68.f_9))
	{
		if (!unk_0x1D403DFADBC2DE3C(Local_68.f_9, 0) && !unk_0x36CEFBE9B745A58D(Local_68.f_9))
		{
...
int func_417(bool bParam0)//Position - 0x2D5EF
{
	if (func_21(Local_75))
	{
		if ((unk_0x48EBE45A9A7EB10C(Local_75) || unk_0x127812AA6652253F(Local_75)) || unk_0xA0ABD1D1512F5AFC(Local_75))
		{
			return 1;
		}
		if (unk_0xCBBE5AFE2CD2E9B6(unk_0xBC25C936A095B5BA()))
		{
			if (unk_0xE921F8171F0733B3(unk_0xBC25C936A095B5BA(), Local_75))
			{
				return 1;
			}
			if (unk_0x724D816EA203A79E(Local_77))
			{
				if (unk_0xE921F8171F0733B3(unk_0xBC25C936A095B5BA(), Local_77))
				{
					return 1;
				}
			}
			if (unk_0x724D816EA203A79E(Local_79))
			{
				if (unk_0xE921F8171F0733B3(unk_0xBC25C936A095B5BA(), Local_79))
				{
					return 1;
				}
			}
			if (unk_0x724D816EA203A79E(Local_78))
			{
				if (unk_0xE921F8171F0733B3(unk_0xBC25C936A095B5BA(), Local_78))
				{
					return 1;
				}
			}
		}
		if (unk_0xBF94E62A1FA7B7F3(Local_75, 60))
		{
			return 1;
		}
		if (unk_0x2CDE18D6C89522AD(Local_75))
		{
			if (unk_0xE642C1AC73CE364E(Local_75, unk_0xBC25C936A095B5BA(), 3f, 3f, 3f, 0, 1, 0))
			{
				return 1;
			}
		}
		if (unk_0xBF94E62A1FA7B7F3(Local_75, 50))
		{
			return 1;
		}
		...
		if (unk_0xC9FA5D38428AB6BE(-1, unk_0x541C2AEF053615BC(Local_75, 1), 15f))
		{
			return 1;
		}
		if (unk_0xBF94E62A1FA7B7F3(Local_75, 72))
		{
			return 1;
		}
		if (bParam0)
...
int func_418(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2D747
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_419(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2D842
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_420(int iParam0, float fParam1)//Position - 0x2D94E
{
	var uVar0;
	vector3 vVar1;
...
int func_421(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x2D9E3
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_182(vParam1 - unk_0x541C2AEF053615BC(iParam0, 1)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_422(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2DA71
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_423(int iParam0, float fParam1)//Position - 0x2DAB9
{
	float fVar0;
...
bool func_424(int iParam0, float fParam1)//Position - 0x2DB2F
{
	return func_368(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

int func_425(int iParam0)//Position - 0x2DB47
{
...
void func_426(int iParam0, vector3 vParam1, float fParam2, bool bParam3, bool bParam4)//Position - 0x2DB6F
{
...
int func_427(int iParam0)//Position - 0x2DB9D
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
...
bool func_428(bool bParam0)//Position - 0x2DBBE
{
...
void func_429(int iParam0, bool bParam1)//Position - 0x2DBE9
{
	func_439(bParam1, 1);
	if (bParam1)
	{
...
void func_430()//Position - 0x2DC78
{
	func_431(1, 0);
	if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
	{
...
void func_431(bool bParam0, bool bParam1)//Position - 0x2DCEA
{
	unk_0xEB233A3B7635D2AC();
	if (unk_0xF16DAFF595E80F7C())
	{
	...
	unk_0x483687B0FCA5415A(iLocal_141, 0);
	unk_0x02DD9F29D9655E48();
...
void func_432(bool bParam0)//Position - 0x2DE01
{
	if (bParam0)
	{
...
void func_433()//Position - 0x2DE3C
{
	unk_0x6984B170050030EF(func_363());
	unk_0x6984B170050030EF(func_364());
}

void func_434(bool bParam0, int iParam1, int iParam2)//Position - 0x2DE54
{
	bool bVar0;
...
void func_435(int iParam0)//Position - 0x2DEB3
{
	Global_16126 = iParam0;
}

void func_436(bool bParam0)//Position - 0x2DEC1
{
	if (bParam0)
	{
		unk_0xA902E18EDF6FA0C8(2, 1862763509, 296331235);
		unk_0xA902E18EDF6FA0C8(2, 1862763509, 1166638144);
		unk_0xA902E18EDF6FA0C8(2, 1862763509, 2037579709);
		unk_0xA902E18EDF6FA0C8(2, 1862763509, 2017343592);
		unk_0xA902E18EDF6FA0C8(2, 1862763509, -1821475077);
		unk_0xA902E18EDF6FA0C8(2, 1862763509, 1782292358);
		unk_0x74E34CCB87168855(unk_0xB5CEFD608600A09F(), 0);
	}
	else
	{
		unk_0xA902E18EDF6FA0C8(255, 1862763509, 296331235);
		unk_0xA902E18EDF6FA0C8(255, 1862763509, 1166638144);
		unk_0xA902E18EDF6FA0C8(255, 1862763509, 2037579709);
		unk_0xA902E18EDF6FA0C8(255, 1862763509, 2017343592);
		unk_0xA902E18EDF6FA0C8(255, 1862763509, -1821475077);
		unk_0xA902E18EDF6FA0C8(255, 1862763509, 1782292358);
		unk_0x74E34CCB87168855(unk_0xB5CEFD608600A09F(), 1);
	}
}

void func_437(bool bParam0)//Position - 0x2DF9D
{
	if (bParam0)
	{
		func_438();
...
void func_438()//Position - 0x2E000
{
...
void func_439(bool bParam0, bool bParam1)//Position - 0x2E029
{
	if (bParam0)
	{
		func_434(0, 1, 1);
...
void func_440(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x2E05C
{
	if (func_511())
	{
...
void func_441(int iParam0, vector3 vParam1, float fParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11)//Position - 0x2E0F1
{
	int iVar0;
	...
	else if (iParam7 == 1)
	{
		if (func_166(vParam1, 0f, 0f, 0f, 0))
		{
			vParam1 = { Global_181DF.f_B3B };
			fParam2 = Global_181DF.f_B3B.f_6;
		}
		...
		{
			unk_0xF243B7A14FCFD0F4(iParam8);
			while (!unk_0xD6513D668481290A(iParam8))
			{
				SYSTEM::WAIT(0);
			}
			*iParam0 = unk_0x61C05BF08A1E0EFE(iParam8, vParam1, fParam2, 1, 1, 0);
			if (unk_0x724D816EA203A79E(*iParam0) && !unk_0x1D403DFADBC2DE3C(*iParam0, 0))
			{
				...
				{
					unk_0x914C5DE0B15B8B59(*iParam0, iParam9, iParam9);
				}
			}
			unk_0x2CA123B0622F495C(iParam8);
		}
	}
	if (iParam3 == 1)
	{
...
int func_442(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4, int iParam5)//Position - 0x2E285
{
	int iVar0;
	var uVar1;
	struct<97> Var2;
	...
	if (func_82(iParam1))
	{
		...
		if (Global_19B04.f_932.f_21B.f_953[0 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			{
				*iParam0 = unk_0x61C05BF08A1E0EFE(Global_19B04.f_932.f_21B.f_953[0 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				unk_0xF0A40F19AAB79E88(*iParam0, 1084227584);
				...
				func_474(iParam0, &(Global_19B04.f_932.f_21B.f_953[0 /*295*/][iParam1 /*98*/].f_1F), &(Global_19B04.f_932.f_21B.f_953[0 /*295*/][iParam1 /*98*/].f_51));
		...
		else if (Global_19B04.f_932.f_21B.f_953[1 /*295*/][iParam1 /*98*/] == Var2)
		{
			...
			{
				*iParam0 = unk_0x61C05BF08A1E0EFE(Global_19B04.f_932.f_21B.f_953[1 /*295*/][iParam1 /*98*/], vParam2, fParam3, 0, 0, 0);
				unk_0xF0A40F19AAB79E88(*iParam0, 1084227584);
				unk_0x551DF575AE9A2969(*iParam0, 0);
				unk_0x2487C8A04B65E2BD(*iParam0, 0);
				unk_0xA73D1278857991A2(*iParam0, 1);
				...
				func_474(iParam0, &(Global_19B04.f_932.f_21B.f_953[1 /*295*/][iParam1 /*98*/].f_1F), &(Global_19B04.f_932.f_21B.f_953[1 /*295*/][iParam1 /*98*/].f_51));
				unk_0x0C95DC9BB0F56943(*iParam0, Var2.f_60);
				if (iParam1 == 2)
				{
					if (unk_0x6F79ECA8C83E4357(*iParam0) == joaat("bodhi2"))
		...
		else
		{
			...
			{
				bVar5 = true;
				*iParam0 = unk_0x61C05BF08A1E0EFE(Var2, vParam2, fParam3, 1, 1, 0);
				unk_0xF0A40F19AAB79E88(*iParam0, 1084227584);
				unk_0x551DF575AE9A2969(*iParam0, 0);
				unk_0x2487C8A04B65E2BD(*iParam0, 0);
				unk_0xA73D1278857991A2(*iParam0, 1);
				...
				func_474(iParam0, &(Var2.f_1F), &(Var2.f_51));
				unk_0x0C95DC9BB0F56943(*iParam0, Var2.f_60);
				if (iParam1 == 1)
				{
...
void func_443(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2F0C9
{
	var uVar0;
	int iVar1;
	int iVar2;
	...
	if ((func_82(iParam0) && unk_0x724D816EA203A79E(*iParam1)) && unk_0xE59B7F5A03335350(*iParam1, 0))
	{
		...
		{
			func_169(iParam1, &(Global_19B04.f_932.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_1F), &(Global_19B04.f_932.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_51));
			if (bParam3)
			{
				...
				Global_19B04.f_4E79[iParam0 /*43*/].f_1F = func_446(*iParam1);
				...
				func_444(Global_19B04.f_932.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_5, Global_19B04.f_932.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_7, iVar3, 1, &(Global_19B04.f_4E79[iParam0 /*43*/].f_1));
				...
				func_444(Global_19B04.f_932.f_21B.f_953[iParam2 /*295*/][iParam0 /*98*/].f_6, -1, iVar3, 0, &(Global_19B04.f_4E79[iParam0 /*43*/].f_2));
			}
		}
	}
}

int func_444(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4)//Position - 0x2FCDD
{
	int iVar0;
	int iVar1;
	char* sVar2;
...
bool func_445(int iParam0, char* sParam1, var uParam2, var uParam3, var uParam4)//Position - 0x2FD50
{
	*uParam2 = -1;
	*uParam3 = -1;
	*uParam4 = -1;
...
int func_447(int iParam0, bool bParam1, var uParam2)//Position - 0x3158F
{
	...
	*uParam2 = 0;
	...
	if (((((((unk_0x10A01B0B02B273EF(iParam0) && unk_0x6F79ECA8C83E4357(iParam0) != -32236122) && unk_0x6F79ECA8C83E4357(iParam0) != 177270108) && unk_0x6F79ECA8C83E4357(iParam0) != 387748548) && unk_0x6F79ECA8C83E4357(iParam0) != 1502869817) && unk_0x6F79ECA8C83E4357(iParam0) != -1881846085) && !bVar1) && !(func_450(unk_0x6F79ECA8C83E4357(iParam0)) && func_448(unk_0xB5CEFD608600A09F())))
	{
		*uParam2 = 2;
		return 0;
	}
...
int func_448(int iParam0)//Position - 0x3170C
{
	if (iParam0 != func_334())
	{
		if (func_333(iParam0, 1, 1))
		{
			...
			{
				return func_449(Global_24FB5C[iParam0 /*406*/].f_131.f_1) == 11;
			}
		}
	}
	return 0;
...
int func_449(int iParam0)//Position - 0x31753
{
	switch (iParam0)
	{
		case 0:
...
int func_450(int iParam0)//Position - 0x31A9F
{
...
int func_451(int iParam0)//Position - 0x31AE1
{
	if (iParam0 != func_334())
	{
		if (func_333(iParam0, 1, 1))
		{
			if (Global_24FB5C[iParam0 /*406*/].f_131.f_1 != -1)
			{
				return func_449(Global_24FB5C[iParam0 /*406*/].f_131.f_1) == 7;
			}
		}
	}
	return 0;
...
int func_452(int iParam0)//Position - 0x31B27
{
	switch (iParam0)
	{
		case -2118308144:
...
int func_453(int iParam0)//Position - 0x31B5C
{
...
int func_454(int iParam0)//Position - 0x31B8B
{
...
int func_455(int iParam0)//Position - 0x31C42
{
	if (!unk_0x724D816EA203A79E(iParam0) || !unk_0xE59B7F5A03335350(iParam0, 0))
	{
		return 0;
...
int func_456(int iParam0)//Position - 0x31C78
{
	switch (iParam0)
	{
		case 562680400:
...
int func_457(int iParam0, bool bParam1)//Position - 0x31CD1
{
	switch (unk_0x6F79ECA8C83E4357(iParam0))
	{
...
int func_458(int iParam0)//Position - 0x31D2C
{
	int iVar0;
...
int func_459(int iParam0, int iParam1)//Position - 0x31D66
{
	if (iParam1 == 0)
	{
...
bool func_460()//Position - 0x31F46
{
	return unk_0x7B2F21BFE86AEB61(2067165443);
}

bool func_461()//Position - 0x31F57
{
	return unk_0x7B2F21BFE86AEB61(-957277403);
}

bool func_462()//Position - 0x31F68
{
	return unk_0x7B2F21BFE86AEB61(210122941);
}

bool func_463()//Position - 0x31F79
{
	return unk_0x7B2F21BFE86AEB61(-1894522408);
}

bool func_464()//Position - 0x31F8A
{
	return unk_0x7B2F21BFE86AEB61(1630677557);
}

int func_465(int iParam0, int iParam1)//Position - 0x31F9B
{
	switch (iParam0)
	{
		case joaat("faction2"):
...
int func_466(int iParam0)//Position - 0x3220E
{
	if (iParam0 != func_334())
	{
		if (func_333(iParam0, 1, 1))
		{
			if (Global_24FB5C[iParam0 /*406*/].f_131.f_1 != -1 && Global_24FB5C[iParam0 /*406*/].f_131.f_4 != func_334())
			{
				return func_449(Global_24FB5C[iParam0 /*406*/].f_131.f_1) == 5;
			}
		}
	}
	return 0;
...
int func_467(int iParam0)//Position - 0x3226D
{
	if (iParam0 != func_334())
	{
		if (func_333(iParam0, 1, 1))
		{
			if (Global_24FB5C[iParam0 /*406*/].f_131.f_1 != -1 && Global_24FB5C[iParam0 /*406*/].f_131.f_4 != func_334())
			{
				return func_449(Global_24FB5C[iParam0 /*406*/].f_131.f_1) == 8;
			}
		}
	}
	return 0;
...
int func_468(int iParam0)//Position - 0x322CD
{
	if (iParam0 != func_334())
	{
		if (func_333(iParam0, 1, 1))
		{
			if (Global_24FB5C[iParam0 /*406*/].f_131.f_1 != -1)
			{
				return func_449(Global_24FB5C[iParam0 /*406*/].f_131.f_1) == 9;
			}
		}
	}
	return 0;
...
int func_469(int iParam0, bool bParam1, var uParam2)//Position - 0x32314
{
	bool bVar0;
...
int func_470(int iParam0)//Position - 0x3272C
{
	switch (iParam0)
	{
		case joaat("towtruck"):
...
void func_471(int iParam0, int iParam1)//Position - 0x32755
{
	int iVar0;
...
void func_472(int iParam0)//Position - 0x327D7
{
	if (!func_473(*iParam0))
	{
...
bool func_473(int iParam0)//Position - 0x32802
{
	return unk_0xFC8A228C62614C5C(iParam0, 5);
}

int func_474(int iParam0, var uParam1, var uParam2)//Position - 0x32811
{
	int iVar0;
	int iVar1;
	...
	if (func_465(unk_0x6F79ECA8C83E4357(*iParam0), 1) && unk_0x3EB14CBD49DA0017(*iParam0, 24) != func_477(*iParam0, ((*uParam1)[38] - 1)))
	{
		unk_0x5C9F67BE33A5A3EE(*iParam0, 24, func_477(*iParam0, ((*uParam1)[38] - 1)), false);
	}
	func_476(iParam0);
	if (func_475(*iParam0))
	{
...
int func_475(int iParam0)//Position - 0x3298F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_476(var uParam0)//Position - 0x32A6B
{
...
int func_477(int iParam0, int iParam1)//Position - 0x32AAB
{
	int iVar0;
	int iVar1;
	float fVar2;
...
int func_478(var uParam0, int iParam1)//Position - 0x32B90
{
	if (unk_0x7AF0088ABFA713B6())
	{
	}
...
void func_479(int iParam0, int iParam1)//Position - 0x32BD1
{
	int iVar0;
	...
	while (iVar0 < 9)
	{
		if (unk_0x724D816EA203A79E(Global_1613F[iVar0]))
		{
			...
			{
				if (iParam1 == 0 || unk_0x6F79ECA8C83E4357(Global_1613F[iVar0]) == func_157(iParam0, iParam1))
				{
...
void func_480(vector3 vParam0, float fParam1, bool bParam2)//Position - 0x32C6F
{
	int iVar0;
...
void func_481(int iParam0)//Position - 0x32CBF
{
	bool bVar0;
	...
	if (func_156(&(Global_110A8.f_22B[0 /*21*/]), iParam0))
	{
		...
		if (unk_0xFA30DFD0084E92FE(Global_110A8.f_22B[0 /*21*/].f_9, 13))
		{
			if (((((iParam0 == 24 && func_162(iParam0, 0)) && Global_11435.f_42 == 0) && Global_19B04.f_7F22.f_7A6[Global_110A8.f_22B[0 /*21*/].f_E] != 0) && Global_19B04.f_7F22.f_7A6[Global_110A8.f_22B[0 /*21*/].f_E] > 3) && (!func_482(0, Global_110A8.f_22B[0 /*21*/].f_C) || !func_482(1, Global_110A8.f_22B[0 /*21*/].f_C)))
			{
				func_163(&(Global_19B04.f_7F22.f_45[Global_110A8.f_22B[0 /*21*/].f_E /*78*/]), &Global_11435);
...
int func_482(int iParam0, int iParam1)//Position - 0x32E31
{
	int iVar0;
	...
	if (iParam0 < 0 || iParam0 >= func_483(&(Global_19B04.f_7F22.f_13AE[iVar0 /*157*/])))
	{
		return 0;
	}
	return func_130(Global_19B04.f_7F22.f_13AE[iVar0 /*157*/][iParam0 /*78*/].f_42, 0);
}

int func_483(var uParam0)//Position - 0x32EA3
{
	return *uParam0;
}

int func_484(vector3 vParam0, float fParam1)//Position - 0x32EAE
{
	return func_485(&(Global_181DF.f_B3B), vParam0, fParam1, 0);
}

int func_485(var uParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x32EC8
{
	int iVar0;
	vector3 vVar1;
	bool bVar2;
	...
	if (func_502(uParam0))
	{
		...
		if (func_501(uParam0))
		{
			...
			if (unk_0x724D816EA203A79E(iVar0))
			{
				...
				func_490(iVar0, &(uParam0->f_C), 0, 1);
				bVar2 = true;
				...
				else if ((!func_487(iVar0, uParam0->f_3, uParam0->f_8) && uParam0->f_A) && unk_0x3362CDE8460ED38B(unk_0x1377080E9B0BD993(), "startup_positioning"))
				{
...
int func_486(int iParam0)//Position - 0x3317A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_487(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x3323D
{
	int iVar0;
	var uVar1[3];
	int iVar2;
	...
	{
		case joaat("cargobob"):
			if (func_489(iParam0, Global_110A8.f_8B[38], 0))
			{
				func_481(38);
				return 1;
			}
		...
		case 1938952078:
			if (func_489(iParam0, Global_110A8.f_8B[43], 1))
			{
				func_481(43);
				return 1;
			}
		...
		case joaat("cuban800"):
			...
			while (iVar3 <= (iVar2 - 1))
			{
				if (func_489(iParam0, uVar1[iVar3], 1) && func_488(unk_0x541C2AEF053615BC(uVar1[iVar3], 1), 2136.133f, 4780.563f, 39.9702f, 5f, 0))
				{
					if ((!bParam2 || func_166(vParam1, 0f, 0f, 0f, 0)) || unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(iParam0, 1), unk_0x541C2AEF053615BC(uVar1[iVar3], 1), true) < 10f)
					{
						unk_0xCF6040807CC0E4A5(&iParam0);
						return 1;
					}
...
int func_488(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x33445
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
int func_489(int iParam0, int iParam1, bool bParam2)//Position - 0x334C0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_490(int iParam0, var uParam1, bool bParam2, bool bParam3)//Position - 0x33521
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (unk_0xE59B7F5A03335350(iParam0, 0))
	{
		...
		{
			iVar0 = 1;
			if (unk_0xFA30DFD0084E92FE(uParam1->f_4D, func_168(iVar0 + 1)))
			{
			}
			else
			{
		...
		{
			iVar1 = 1;
			if (unk_0xFA30DFD0084E92FE(uParam1->f_4D, func_168(iVar1 + 1)))
			{
			}
			else
			{
				unk_0xF0059F27F7BB6680(&(uParam1->f_4D), func_168(iVar1 + 1));
			}
		}
		...
		if (((unk_0xFA30DFD0084E92FE(uParam1->f_4D, 15) || func_493(iParam0)) || (((uParam1->f_3E == 0 && uParam1->f_3F == 0) && uParam1->f_40 == 0) && uParam1->f_9[20] > 0)) && func_492())
		{
			uParam1->f_3E = 0;
			uParam1->f_3F = 0;
			uParam1->f_40 = 0;
		...
		if (bParam3)
		{
			func_474(&iParam0, &(uParam1->f_9), &(uParam1->f_3B));
		}
		if (!unk_0x8C1A6E7D5F410F4A(uParam1->f_42) && !unk_0xE7B3A320107C1379(uParam1->f_42))
		{
			...
			while (iVar2 <= 11)
			{
				if (unk_0xFA30DFD0084E92FE(uParam1->f_4D, func_168(iVar2 + 1)))
				{
...
void func_491(int iParam0, int iParam1)//Position - 0x33A71
{
	int iVar0;
	int iVar1;
...
bool func_492()//Position - 0x33AD6
{
	return unk_0x7B2F21BFE86AEB61(-1691188696);
}

int func_493(int iParam0)//Position - 0x33AE7
{
	int iVar0;
...
int func_494(int iParam0)//Position - 0x33B32
{
	if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
	{
...
int func_495(int iParam0)//Position - 0x33BB9
{
...
int func_496(int iParam0)//Position - 0x33BE8
{
...
int func_497(int iParam0)//Position - 0x33C05
{
...
int func_498(int iParam0, int iParam1)//Position - 0x33C28
{
...
int func_499(int iParam0)//Position - 0x33C63
{
	if (func_498(iParam0, 0))
	{
...
int func_500(int iParam0, int iParam1)//Position - 0x33C86
{
	int iVar0;
...
int func_501(var uParam0)//Position - 0x33CD3
{
	if (func_502(uParam0))
	{
...
int func_502(var uParam0)//Position - 0x33D08
{
	if (uParam0->f_C.f_42 == 0)
	{
		return 0;
	}
	if (!func_130(uParam0->f_C.f_42, 0))
	{
		return 0;
	}
	if (uParam0->f_C.f_42 == joaat("stunt") && func_488(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
bool func_503()//Position - 0x33D67
{
	return func_501(&(Global_181DF.f_B3B));
}

void func_504()//Position - 0x33D7A
{
	func_505(&(Global_181DF.f_B3B));
}

void func_505(var uParam0)//Position - 0x33D8D
{
	if (func_502(uParam0))
	{
...
int func_506(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x33DAB
{
	if (unk_0xE7B3A320107C1379(Global_181DF.f_B3B.f_C.f_42))
	{
		return 0;
	}
	if (iParam1 == 0 && unk_0x8C1A6E7D5F410F4A(Global_181DF.f_B3B.f_C.f_42))
	{
		return 0;
	}
	if (iParam2 == 0 && func_508(Global_181DF.f_B3B.f_C.f_42))
	{
		return 0;
	}
	if (iParam3 == 0 && unk_0xA19D269B4B5A1532(Global_181DF.f_B3B.f_C.f_42))
	{
		return 0;
	}
	if (iParam0 == 1)
...
int func_507()//Position - 0x33E39
{
	...
	if ((unk_0xE7B3A320107C1379(Global_181DF.f_B3B.f_C.f_42) || unk_0xA19D269B4B5A1532(Global_181DF.f_B3B.f_C.f_42)) || unk_0xFF2234981505F7F4(Global_181DF.f_B3B.f_C.f_42))
	{
		return 0;
	}
	fVar0 = unk_0xB5AEE116EA91D2FA(Global_181DF.f_B3B.f_C.f_42);
	if (fVar0 < 37f)
	{
		return 0;
	}
...
int func_508(int iParam0)//Position - 0x33EAE
{
	switch (iParam0)
	{
		case joaat("police"):
...
bool func_509()//Position - 0x33F07
{
	return func_502(&(Global_181DF.f_B3B));
}

int func_510()//Position - 0x33F1A
{
...
void func_512()//Position - 0x33F68
{
	vector3 vVar0;
	vector3 vVar1;
	...
	unk_0xB2CB6EAA6B280A84("ENEMIES", &iLocal_320);
	unk_0xA902E18EDF6FA0C8(5, 1862763509, iLocal_320);
	unk_0xA902E18EDF6FA0C8(5, iLocal_320, 1862763509);
	vVar0 = { func_519(Local_63) };
	vVar1 = { func_518(Local_63) };
	unk_0xF16F7C45E0B1B52B(vVar0, vVar1);
	iLocal_141 = unk_0x1DAA351326EA3537(vVar0, vVar1, 0, 1, 1, 1);
	unk_0x6C5F5B5F6894CCE3(Local_63, 30f, 0, 0, 0, false);
	...
	if (func_21(unk_0xBC25C936A095B5BA()))
	{
		func_89(&uLocal_155, 2, unk_0xBC25C936A095B5BA(), "TREVOR", 0, 1);
		unk_0x7C7F4D01B6DB297B(unk_0xBC25C936A095B5BA(), 1);
	}
	if (func_21(Local_68.f_9))
	{
		func_89(&uLocal_155, 3, Local_68.f_9, sLocal_144, 0, 1);
		unk_0x7C7F4D01B6DB297B(Local_68.f_9, 1);
	}
}

void func_513()//Position - 0x340AE
{
	int iVar0;
	
	if (func_21(Local_68.f_9))
	{
		unk_0x0DEF5E53360637F2(Local_68.f_9, 1);
		unk_0x5056032BA0CF3AAD(Local_68.f_9, 1);
		unk_0x6BBC364B0AA788E8(Local_68.f_9, 100);
		unk_0x65E471E4A2D56226(Local_68.f_9, 200, 0);
		unk_0x6F81644465434992(Local_68.f_9, 1);
		unk_0xF82197F205B9D8FD(Local_68.f_9, 1);
		unk_0x63ECE17EEAC84602(Local_68.f_9, 1);
		unk_0xB6A0EC6216225695(Local_68.f_9, 1);
		unk_0xB58463DD7085635A(Local_68.f_9, 2f);
		...
		unk_0xEDBBBB8EA1B1625E(Local_68.f_9, 0);
		unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 118, true);
		unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 137, true);
		unk_0xC8FD3EBBB90E8D7F(Local_68.f_9, 281, true);
		unk_0xF7CDBCD11F31B71A(Local_68.f_9, 1);
		if (Local_68.f_C != 0)
		{
			unk_0x7A535CE1F001F3FE(Local_68.f_9, Local_68.f_C, -1, false, true);
		}
		func_353(Local_68.f_9);
		func_514(Local_68.f_9, "TARGET_", 0);
		Local_68.f_A = 0;
		unk_0xB0031DDAE4FF0BC3(Local_68.f_9, 0, 1, 1, 0);
		unk_0xB0031DDAE4FF0BC3(Local_68.f_9, 2, 1, 1, 0);
		unk_0xB0031DDAE4FF0BC3(Local_68.f_9, 3, 0, 1, 0);
		unk_0xB0031DDAE4FF0BC3(Local_68.f_9, 4, 0, 0, 0);
		unk_0xC5A6DFE2B8987B17(&uLocal_143);
		...
		unk_0xE896C0AD02364F2A(0, "oddjobs@bailbond_hobohang_out_street_c", "base", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		unk_0xE896C0AD02364F2A(0, "oddjobs@bailbond_hobohang_out_street_c", "idle_a", 8f, -1.5f, -1, 0, 0, 0, 0, 0);
		unk_0xAFD74A5E065F57E0(uLocal_143, 1);
		unk_0x535008C596714F9E(uLocal_143);
		unk_0xA8E6405305C0D7DF(Local_68.f_9, uLocal_143);
		unk_0x02DAF06EA4F08219(&uLocal_143);
	}
	...
	while (iVar0 <= 2)
	{
		if (func_21(Local_69[iVar0 /*19*/]))
		{
			...
			if (iVar0 == 0 || iVar0 == 2)
			{
				unk_0x4106FAF8AA1D69D5(Local_69[iVar0 /*19*/], iLocal_320);
			}
			...
			switch (iVar0)
			{
				case 0:
					...
					unk_0xAFD74A5E065F57E0(uLocal_143, 1);
					unk_0x535008C596714F9E(uLocal_143);
					unk_0xA8E6405305C0D7DF(Local_69[iVar0 /*19*/], uLocal_143);
					unk_0x02DAF06EA4F08219(&uLocal_143);
					break;
...
void func_514(int iParam0, char* sParam1, int iParam2)//Position - 0x345A5
{
	char cVar0[16];
	
	StringCopy(&cVar0, sParam1, 16);
	StringIntConCat(&cVar0, iParam2, 16);
	unk_0xF85FAED5BA864282(iParam0, &cVar0);
}

int func_515()//Position - 0x345C1
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	iVar0 = 0;
	iVar1 = 0;
	if (func_52(&(Local_68.f_9), Local_68.f_B, Local_68.f_D, Local_68.f_10, 1, 0, 0))
	{
		if (func_21(Local_68.f_9))
		{
			unk_0x2E35C4FA5F0ED22F(Local_68.f_9, 1);
	...
	if (iVar1 == iLocal_132)
	{
		...
		while (iVar2 <= (iLocal_132 - 1))
		{
			unk_0x2CA123B0622F495C(Local_69[iVar2 /*19*/].f_12);
			iVar2++;
		}
	}
	if (iLocal_129 > 0)
...
int func_516(var uParam0, int iParam1, vector3 vParam2, int iParam3, int iParam4, bool bParam5)//Position - 0x347F7
{
	if (!unk_0xA901403F1DB7A780(*uParam0))
	{
		if (func_54(iParam4))
		{
			*uParam0 = unk_0x249B372087B496EC(iParam1, vParam2, iParam3, -1, 1, iParam4);
			if (unk_0xA901403F1DB7A780(*uParam0))
			{
...
int func_517(var uParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x34868
{
	if (!unk_0x724D816EA203A79E(*uParam0))
	{
		if (func_54(iParam1))
		{
			*uParam0 = unk_0x61C05BF08A1E0EFE(iParam1, vParam2, fParam3, 1, 1, 0);
			if (unk_0x724D816EA203A79E(*uParam0))
			{
				...
				if (func_94(*uParam0))
				{
					unk_0x641B19E156645A92(*uParam0, vParam2, 1, 0, 0, 1);
					unk_0x019CE76D5286C95C(*uParam0, fParam3);
				}
...
Vector3 func_518(struct<5> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x34907
{
	switch (Param0.f_4)
	{
		case 0:
...
Vector3 func_519(struct<5> Param0, var uParam1, var uParam2, var uParam3)//Position - 0x3497B
{
	switch (Param0.f_4)
	{
		case 0:
...
void func_520()//Position - 0x349EF
{
	int iVar0;
...
float func_521()//Position - 0x34EB0
{
	return 75.15f;
}

Vector3 func_522()//Position - 0x34EBD
{
	return 2727.29f, 4145.9f, 44.16f;
}

float func_523()//Position - 0x34ED4
{
	return 71f;
}

Vector3 func_524()//Position - 0x34EE1
{
	return 2727.686f, 4145.715f, 44.08f;
}

int func_525()//Position - 0x34EF8
{
	return 1385417869;
}

float func_526()//Position - 0x34F05
{
	return -91.28f;
}

Vector3 func_527()//Position - 0x34F12
{
	return 2728.35f, 4145.59f, 43.3f;
}

int func_528()//Position - 0x34F29
{
	return -741944541;
}

float func_529()//Position - 0x34F36
{
	return 89.19f;
}

Vector3 func_530()//Position - 0x34F43
{
	return 2728.33f, 4145.6f, 43.89f;
}

int func_531(int iParam0)//Position - 0x34F5A
{
	if (!func_82(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
...
int func_532(bool bParam0)//Position - 0x34F85
{
...
int func_536(int iParam0)//Position - 0x350BD
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_535()) || Global_1974B) || Global_62BF) || func_541()) || func_87(8, -1)) || func_540()) || func_539()) || func_533()) || func_534()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_535()) || Global_62BF) || func_541()) || func_87(8, -1)) || func_533()) || func_540()) || func_539()) || func_534()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_535()) || Global_1974B) || Global_62BF) || func_541()) || func_87(8, -1)) || func_533()) || func_540()) || func_539()) || func_534()) || Global_19B04.f_1DEB.f_397[iVar0] == 5) || Global_8E64 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_535()) || Global_1974B) || Global_62BF) || func_541()) || func_87(8, -1)) || func_540()) || func_539()) || func_534()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_535() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_87(8, -1)) || func_534()) || func_538()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_535()) || Global_62BF) || func_541()) || func_87(8, -1)) || func_539()) || func_533()) || func_534()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || !unk_0x8CC5A4A5615C6420(unk_0xB5CEFD608600A09F())) || !unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F())) || !unk_0x726D9204B160D23E()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || func_535()) || func_539()) || Global_1974B) || Global_62BF) || func_541()) || Global_90C1) || func_87(8, -1)) || func_533()) || func_538()) || func_534()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_537()//Position - 0x357DA
{
	return Global_16B42.f_1;
}

int func_538()//Position - 0x357E8
{
	if (Global_15FA6 != -1)
	{
...
bool func_539()//Position - 0x3580E
{
	return Global_16B4F.f_142 > 0;
}

bool func_540()//Position - 0x3581F
{
	return Global_16B4F.f_141 > 0;
}

var func_541()//Position - 0x35830
{
	return Global_140856;
}

bool func_542(int iParam0)//Position - 0x3583C
{
	return func_543(iParam0, Global_8C41);
}

int func_543(int iParam0, int iParam1)//Position - 0x3584D
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_544(int iParam0)//Position - 0x35A2E
{
	func_569();
	if (!func_568())
	{
		...
		{
			Global_19B04.f_617D.f_4[iParam0]++;
		}
...
void func_545(char* sParam0)//Position - 0x35A79
{
	if (Global_16B1B != 12)
	{
...
int func_546(char* sParam0, int iParam1, int iParam2)//Position - 0x35A96
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_557())
	{
		...
		{
			iVar2 = func_547(unk_0x1377080E9B0BD993());
			if (iVar2 > -1)
			{
...
int func_547(char* sParam0)//Position - 0x35C28
{
...
void func_548(int iParam0, var uParam1)//Position - 0x35C7E
{
	switch (iParam0)
	{
		case 0:
...
int func_550(int iParam0)//Position - 0x36EC4
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_551(int iParam0)//Position - 0x3720A
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_552(int iParam0)//Position - 0x37241
{
	struct<2> Var0;
...
int func_553()//Position - 0x3768D
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_554(&(Global_16B1B.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_554(char* sParam0, bool bParam1)//Position - 0x376B1
{
	int iVar0;
	int iVar1;
...
int func_555(int iParam0, bool bParam1)//Position - 0x376DB
{
	int iVar0;
...
int func_557()//Position - 0x37761
{
	...
	{
		if (func_547(&(Global_16B1B.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_558(int iParam0)//Position - 0x377CD
{
	if (iParam0 == 1)
	{
		Global_8E66 = 1;
...
void func_559(bool bParam0)//Position - 0x377E6
{
	unk_0x59B038076F830627(bParam0);
	unk_0x43F06392C4EF25E0(bParam0);
}

void func_560(int iParam0)//Position - 0x377FA
{
	if (iParam0 == 1)
	{
		unk_0x3169E2C5E6A096BC();
...
void func_561(int iParam0)//Position - 0x37837
{
	if (iParam0 == 1)
	{
...
void func_562()//Position - 0x37874
{
	Global_4336.f_5 = 1;
}

void func_563()//Position - 0x37882
{
	Global_4336.f_5 = 0;
}

void func_564()//Position - 0x37890
{
	Global_154EC = 0;
	Global_154ED = 0;
}

void func_565()//Position - 0x378A2
{
	Global_16B1B = 13;
	Global_16B1B.f_1 = -1;
	Global_16B1B.f_2 = 0;
...
void func_569()//Position - 0x3798D
{
	Global_16B3E = 1;
...
void func_570()//Position - 0x37A7A
{
	if (iLocal_109)
	{
		func_431(0, 1);
