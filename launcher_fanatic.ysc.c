	...
	while (true)
	{
		...
		if (iLocal_55 == 0)
		{
			if (Var0 == 22)
			{
				...
				{
					if (func_193(Var0.f_1C[1]))
					{
						func_285("Trying to set Mary Ann boyfriend component variation");
						unk_0x2C5D30EE32747F1F("MaryAnnes_Friend", Var0.f_1C[1], 0);
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x61C5
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x620C
{
...
bool func_70(int iParam0)//Position - 0x6267
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6277
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x62D7
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x65CB
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x65D6
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x65E6
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6688
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6C42
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6CA0
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6D4E
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6DE3
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6E27
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6FAB
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6FB9
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7A80
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7B02
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7B60
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7B69
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7D3C
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7D4C
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7FE6
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x7FF7
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x803F
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x80C5
{
...
void func_94(var uParam0, int iParam1)//Position - 0x80F8
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x8149
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x81EB
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8210
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x8227
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x8234
{
...
void func_100(var uParam0, int iParam1)//Position - 0x826E
{
...
void func_101(var uParam0, int iParam1)//Position - 0x82A9
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x82E5
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x82FE
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x8357
{
...
bool func_105(bool bParam0)//Position - 0x8399
{
...
struct<2> func_106(int iParam0)//Position - 0x83C4
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8811
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9AE9
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9E2F
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9ED3
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9F6E
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9FCC
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA025
{
...
int func_116(int iParam0)//Position - 0xA0A8
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA0D9
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA0EE
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA1A1
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA1BC
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA208
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA251
{
	if (func_193(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA271
{
	switch (iParam0)
	{
		case 5:
...
int func_126(int iParam0)//Position - 0xA341
{
	switch (iParam0)
	{
		case 5:
...
void func_127(var uParam0, bool bParam1, bool bParam2)//Position - 0xA394
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_193(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_193(uParam0->f_23[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_193(uParam0->f_29[iVar0]))
		{
...
int func_128(int iParam0)//Position - 0xA489
{
	switch (iParam0)
	{
		case 5:
...
void func_129(bool bParam0)//Position - 0xA4F4
{
	int iVar0;
...
void func_130(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA531
{
	if (bParam0)
	{
...
int func_133(int iParam0, bool bParam1)//Position - 0xA6C2
{
	int iVar0;
	int iVar1;
...
int func_134(int iParam0)//Position - 0xA703
{
...
bool func_135()//Position - 0xA745
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_136(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA756
{
	int iVar0;
...
void func_138(int iParam0)//Position - 0xA7B0
{
	if (iParam0 == 1)
	{
...
int func_139(char* sParam0)//Position - 0xA7D3
{
...
void func_140()//Position - 0xA810
{
	Global_394A = 0;
	func_141();
}

void func_141()//Position - 0xA820
{
...
int func_145(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA906
{
...
void func_146(int iParam0)//Position - 0xAA95
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_148(int iParam0)//Position - 0xAB12
{
...
void func_149(int iParam0)//Position - 0xAB3B
{
	if (Global_3943)
	{
		func_150(0, 0);
...
void func_150(bool bParam0, bool bParam1)//Position - 0xABAB
{
	if (bParam0)
	{
		if (func_151(0))
...
int func_151(int iParam0)//Position - 0xAC1F
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_152(int iParam0)//Position - 0xAC79
{
...
int func_153(int iParam0)//Position - 0xACBA
{
	int iVar0;
...
void func_154(int iParam0)//Position - 0xACFF
{
...
int func_155(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAD31
{
	int iVar0;
...
void func_156(var uParam0, int iParam1)//Position - 0xAE68
{
	int iVar0;
...
bool func_157(int iParam0)//Position - 0xAEB7
{
	return func_158(iParam0, Global_8C41);
}

int func_158(int iParam0, int iParam1)//Position - 0xAEC8
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_159(int iParam0)//Position - 0xB0A9
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_160()//Position - 0xB0CB
{
	return func_161(unk_0x1377080E9B0BD993(), 0);
}

int func_161(char* sParam0, int iParam1)//Position - 0xB0DC
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_163(int iParam0, int iParam1)//Position - 0xB149
{
	switch (iParam0)
	{
		case 0:
...
int func_164(vector3 vParam0, bool bParam1)//Position - 0xB5D0
{
	int iVar0;
...
float func_165(bool bParam0, float fParam1, float fParam2)//Position - 0xB5FC
{
	if (bParam0)
	{
		return fParam1;
...
int func_166(int iParam0)//Position - 0xB613
{
	switch (iParam0)
	{
		case 0:
...
int func_167(int iParam0, int iParam1)//Position - 0xB6A2
{
	switch (iParam0->f_10)
	{
		case 0:
			if (*iParam0 == 12)
			{
				...
				else if (func_193(iParam0->f_1C[0]))
				{
					if (func_169(iParam0))
					{
						if (func_173(2))
...
void func_168()//Position - 0xBE85
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_169(var uParam0)//Position - 0xBEA0
{
	float fVar0;
...
void func_170(int iParam0, int iParam1)//Position - 0xBF2E
{
	if (iParam0 == 1)
	{
		if (!func_126(iParam1))
...
int func_171(bool bParam0)//Position - 0xBF92
{
	int iVar0;
...
int func_172(int iParam0)//Position - 0xC02A
{
	if (func_193(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_173(int iParam0)//Position - 0xC054
{
	int iVar0;
...
var func_174()//Position - 0xC771
{
	return Global_16B42.f_1;
}

int func_175()//Position - 0xC77F
{
	if (Global_15FA6 != -1)
	{
...
bool func_178()//Position - 0xC7E9
{
	return Global_16B4F.f_142 > 0;
}

bool func_179(int iParam0, int iParam1)//Position - 0xC7FA
{
	switch (iParam0)
	{
		case 5:
...
var func_180()//Position - 0xC835
{
	return Global_140856;
}

int func_181()//Position - 0xC841
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
void func_182(int iParam0)//Position - 0xC85D
{
	if (iLocal_57 == -1)
	{
		iLocal_57 = unk_0x105601648511CC64();
	}
	if ((unk_0x105601648511CC64() - iLocal_57) >= 900)
	{
		if (func_193(iParam0->f_1C[0]))
		{
			if (!func_142())
			{
				func_183(iParam0->f_1C[0], "PUSHUP_BREATH", "MARYANN", 6);
				iLocal_57 = unk_0x105601648511CC64();
			}
		}
	}
...
void func_183(int iParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xC8AD
{
	unk_0x7E80A36CD8BDF4D1(iParam0, sParam1, sParam2, func_184(iParam3), 0);
}

int func_184(int iParam0)//Position - 0xC8C6
{
	int iVar0;
...
int func_185(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCABB
{
	var uVar0;
	
	if ((((func_193(unk_0xBC25C936A095B5BA()) && func_193(iParam0->f_1C[0])) && !func_142()) && (unk_0x105601648511CC64() - iParam0->f_3C) > iParam6) && func_189(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_186(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCB43
{
...
void func_187(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCB7E
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_188(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCBD4
{
...
float func_189(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCC6F
{
	vector3 vVar0;
...
int func_190(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)//Position - 0xCCA9
{
	var uVar0;
	...
	if (func_173(2))
	{
		if (!func_142())
		{
			if (((func_193(unk_0xBC25C936A095B5BA()) && func_193(iParam0->f_1C[0])) && (unk_0x105601648511CC64() - iParam0->f_3C) > iParam6) && func_189(unk_0xBC25C936A095B5BA(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_188(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
				func_186(&uVar0, cParam2, sParam3, 7, 0, 0);
		...
		else if (func_191(sParam3))
		{
			...
			{
				if (func_189(unk_0xBC25C936A095B5BA(), vParam1, 1) >= 20f)
				{
					func_140();
				}
			}
...
int func_191(char* sParam0)//Position - 0xCD6B
{
	struct<6> Var0;
...
struct<6> func_192()//Position - 0xCD8B
{
	struct<6> Var0;
...
int func_193(int iParam0)//Position - 0xCDAF
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
...
void func_194(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xCDD0
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_189(unk_0xBC25C936A095B5BA(), vParam2, 1) <= 100f)
				{
					func_197(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_189(unk_0xBC25C936A095B5BA(), vParam2, 1) > 120f)
				{
					func_199(iParam0);
				}
			}
...
void func_195(int iParam0, bool bParam1)//Position - 0xCEC1
{
	if (iParam0 == -1)
	{
		return;
...
int func_196(int iParam0)//Position - 0xCEFD
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_197(int iParam0, int iParam1)//Position - 0xCF36
{
	bool bVar0;
	int iVar1;
...
bool func_198()//Position - 0xCFD4
{
	return Global_16129;
}

void func_199(int iParam0)//Position - 0xCFE0
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_200(iParam0);
...
void func_200(int iParam0)//Position - 0xCFF7
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_201(int iParam0)//Position - 0xD0DF
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
int func_202(var uParam0, bool bParam1)//Position - 0xD107
{
	struct<27> Var0;
	...
	if (func_206(&(uParam0->f_30)) && bParam1)
	{
		func_203(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_203(int iParam0, var uParam1, int iParam2)//Position - 0xD37A
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_205(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_205(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_204(int iParam0)//Position - 0xD6D2
{
...
int func_205(var uParam0)//Position - 0xD6F2
{
...
int func_206(var uParam0)//Position - 0xD70A
{
...
void func_207(var uParam0)//Position - 0xD72F
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_208(&(uParam0->f_29[1]));
		func_208(&(uParam0->f_29[2]));
	}
	if (func_193(unk_0xBC25C936A095B5BA()))
	{
		iVar0 = 0;
...
void func_208(int iParam0)//Position - 0xDA33
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_209(var uParam0)//Position - 0xDA5E
{
	int iVar0;
...
int func_210(var uParam0, bool bParam1, bool bParam2)//Position - 0xDADE
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_211(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_211(int iParam0, int iParam1)//Position - 0xDC9C
{
	int iVar0;
...
int func_212(var uParam0, bool bParam1, int iParam2)//Position - 0xDCCC
{
	int iVar0;
	int iVar1;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_1C[iVar0]))
			{
				if (!unk_0x36CEFBE9B745A58D(uParam0->f_1C[iVar0]))
				{
					...
					if (func_231(*uParam0))
					{
						if (!func_152(*uParam0))
						{
							if (func_226(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_207(uParam0);
						...
						if (func_214(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_207(uParam0);
...
int func_213(int iParam0)//Position - 0xDF88
{
...
int func_214(int iParam0, float fParam1)//Position - 0xDFBC
{
	float fVar0;
...
bool func_215(int iParam0, float fParam1)//Position - 0xE032
{
	return func_216(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_216(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE04A
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_217(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE10B
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_218(int iParam0, int iParam1)//Position - 0xE237
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE346
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_222(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_222(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_221(vector3 vParam0, vector3 vParam1)//Position - 0xE3D7
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_222(vector3 vParam0)//Position - 0xE3F8
{
	float fVar0;
	float fVar1;
...
void func_223(var uParam0)//Position - 0xE437
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_224(int iParam0, int iParam1)//Position - 0xE452
{
	int iVar0;
...
int func_225(int iParam0)//Position - 0xE491
{
...
int func_226(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE4B9
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_227(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE5B4
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_228(int iParam0, float fParam1)//Position - 0xE6C0
{
	var uVar0;
	vector3 vVar1;
...
int func_229(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE755
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_222(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_230(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE7E3
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_231(int iParam0)//Position - 0xE82B
{
...
void func_232(int iParam0)//Position - 0xE875
{
	int iVar0;
...
int func_233(int iParam0)//Position - 0xE912
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
int func_234(int iParam0)//Position - 0xE9AA
{
...
int func_237(int iParam0)//Position - 0xEA2C
{
	if ((func_238() && Global_16B1B.f_B == 6) && iParam0 == func_161(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_239(int iParam0)//Position - 0xEA9E
{
	if (func_105(0))
	{
...
int func_240(int iParam0)//Position - 0xEAC6
{
	switch (*iParam0)
	{
		case 21:
...
int func_242(var uParam0)//Position - 0xEB79
{
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_30), "rcmfanatic3", "ef_3_rcm_loop_maryann", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (func_243(&(uParam0->f_1C[0]), 61, -915.6f, 6139.192f, 5.525f, 111.24f, "FANATIC LAUNCHER RC", 1))
				{
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_29[0]))
			{
				...
				uParam0->f_29[0] = unk_0xB6896943DA475493(iVar0[1], vVar3, true, true, false);
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_29[1]))
			{
				...
				uParam0->f_29[1] = unk_0xB6896943DA475493(iVar0[2], vVar3, true, true, false);
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_29[2]))
			{
				...
				uParam0->f_29[2] = unk_0xB6896943DA475493(iVar0[3], vVar3, true, true, false);
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_29[3]))
			{
				...
				uParam0->f_29[3] = unk_0xB6896943DA475493(iVar0[4], vVar3, true, true, false);
...
int func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xEF39
{
...
int func_244(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xEF95
{
	int iVar0;
...
int func_245(var uParam0, int iParam1)//Position - 0xF023
{
	int iVar0;
...
int func_246(var uParam0)//Position - 0xF069
{
	if (func_206(uParam0))
	{
...
int func_247(int iParam0)//Position - 0xF093
{
	int iVar0;
...
void func_248(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF0C4
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_249(var uParam0)//Position - 0xF100
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_30), "rcm_fanatic2", "ef_2_rcm__maryann_biking_maryann", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (!func_243(&(uParam0->f_1C[0]), 61, 809.66f, 1279.76f, 360.49f, 122.53f, "FANATIC LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_253(&(uParam0->f_1C[1]), iVar0[1], 808.43f, 1279.16f, 360.47f, -79.11f, 26);
				if (func_193(uParam0->f_1C[1]))
				{
			...
			{
				func_251(&(uParam0->f_23[0]), iVar0[2], 808.35f, 1277.2f, 360.15f, 216.5f);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_23[1]))
			{
				func_251(&(uParam0->f_23[1]), iVar0[2], 807.89f, 1275.73f, 360.18f, 208.2f);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			...
			while (iVar1 <= 1)
			{
				if (func_193(uParam0->f_23[iVar1]))
				{
...
void func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF444
{
	func_252(iParam0);
...
void func_252(int iParam0)//Position - 0xF486
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_253(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xF522
{
	func_254(iParam0);
	*iParam0 = unk_0x01B3635C3E8EDD81(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_254(int iParam0)//Position - 0xF543
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
int func_255(var uParam0)//Position - 0xF584
{
	int iVar0[1];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_248(&(uParam0->f_30), "rcmfanatic1", "ef_1_rcm_mary_ann_streching_base", 0);
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_243(&(uParam0->f_1C[0]), 61, -1878.27f, -440.55f, 46.23f, 165.94f, "FANATIC LAUNCHER RC", 1))
				{
...
int func_256(int iParam0)//Position - 0xF6DF
{
	struct<27> Var0;
	int iVar1;
...
int func_257(int iParam0)//Position - 0xF733
{
	char* sVar0;
...
int func_258(int iParam0)//Position - 0xF7EC
{
	var uVar0;
...
int func_259(int iParam0)//Position - 0xF8AD
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_260(int iParam0, char* sParam1)//Position - 0xF932
{
...
bool func_261(int iParam0)//Position - 0xFA14
{
...
bool func_262(int iParam0)//Position - 0xFA42
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_263(int iParam0)//Position - 0xFA70
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_264(int iParam0)//Position - 0xFA9E
{
	if (func_234(iParam0))
	{
		return 0;
...
void func_265()//Position - 0xFAD3
{
	func_285("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_266(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xFAED
{
	int iVar0;
...
int func_267(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xFB52
{
	int iVar0;
	struct<7> Var1;
...
int func_268(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xFBD0
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_269(int iParam0, bool bParam1)//Position - 0xFC4B
{
	char* sVar0;
	...
	if (*iParam0 == 22)
	{
		unk_0x483687B0FCA5415A(iLocal_53, 0);
	}
	if (iLocal_54 != -1)
	{
...
void func_270(char* sParam0)//Position - 0xFCEF
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
		if (func_191(sParam0))
...
void func_271()//Position - 0xFD0E
{
	Global_394A = 0;
	func_272();
}

void func_272()//Position - 0xFD1E
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
int func_273(var uParam0)//Position - 0xFD3F
{
	if (func_206(uParam0))
	{
		if (unk_0xF9E082857622D91E(*uParam0))
...
void func_274(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFD75
{
...
void func_275(var uParam0, bool bParam1)//Position - 0xFD95
{
	func_276(&(uParam0->f_29), bParam1);
}

void func_276(var uParam0, bool bParam1)//Position - 0xFDA7
{
	int iVar0;
...
void func_277(int iParam0, bool bParam1)//Position - 0xFDE5
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_278(var uParam0, bool bParam1)//Position - 0xFE20
{
	func_279(&(uParam0->f_23), bParam1);
}

void func_279(var uParam0, bool bParam1)//Position - 0xFE32
{
	int iVar0;
...
void func_280(int iParam0)//Position - 0xFE6F
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_281(var uParam0, int iParam1)//Position - 0xFEA7
{
	func_282(&(uParam0->f_1C), iParam1);
}

void func_282(var uParam0, int iParam1)//Position - 0xFEB9
{
	int iVar0;
...
void func_283(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFEFA
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_284(var uParam0)//Position - 0xFF4A
{
	if (*uParam0 == -1)
	{
		return;
...
void func_285(char* sParam0)//Position - 0xFF87
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_286(var uParam0)//Position - 0xFF99
{
	*uParam0 = -1;
...
void func_287()//Position - 0xFFCC
{
	func_285("Running start routines.");
	Global_199EA++;
}

int func_288(int iParam0)//Position - 0xFFE6
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
