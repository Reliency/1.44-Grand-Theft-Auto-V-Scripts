...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_310(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
	...
	while (true)
	{
		...
		{
			func_197(Var0.f_1C[1], &uLocal_56, Var0);
		}
		if (Var0 == 37)
		{
		...
		{
			func_186(&Var3, &(Var0.f_23[0]), &(Var0.f_1C[1]));
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x626C
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x62B3
{
...
bool func_70(int iParam0)//Position - 0x630E
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x631E
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x637E
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6672
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x667D
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x668D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x672F
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6CE9
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6D47
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6DF5
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6E8A
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6ECE
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x7052
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x7060
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7B27
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7BA9
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7C07
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7C10
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7DE3
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7DF3
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x808F
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x80A0
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x80E6
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x816C
{
...
void func_94(var uParam0, int iParam1)//Position - 0x819F
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x81F0
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x8292
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x82B7
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x82CE
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x82DB
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8315
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8350
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x838C
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x83A5
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x83FE
{
...
bool func_105(bool bParam0)//Position - 0x8440
{
...
struct<2> func_106(int iParam0)//Position - 0x846B
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x88B8
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9B90
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9ED6
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9F7A
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0xA015
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0xA073
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA0CC
{
...
int func_116(int iParam0)//Position - 0xA14F
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA180
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA195
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA248
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA263
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA2AF
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA2F8
{
	if (func_124(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA318
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA339
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA409
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA45C
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA551
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA5BC
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA5F9
{
	if (bParam0)
	{
...
int func_134(int iParam0, bool bParam1)//Position - 0xA78A
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA7CB
{
...
bool func_136()//Position - 0xA80D
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_137()//Position - 0xA81E
{
...
void func_138(int iParam0)//Position - 0xA845
{
	if (iParam0 == 1)
	{
...
int func_139(char* sParam0)//Position - 0xA868
{
...
void func_140()//Position - 0xA8A5
{
	Global_394A = 0;
	func_141();
}

void func_141()//Position - 0xA8B5
{
...
int func_145(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA99B
{
...
void func_146(int iParam0)//Position - 0xAB2A
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_148(int iParam0)//Position - 0xABA7
{
...
void func_149(int iParam0)//Position - 0xABD0
{
	if (Global_3943)
	{
		func_150(0, 0);
...
void func_150(bool bParam0, bool bParam1)//Position - 0xAC40
{
	if (bParam0)
	{
		if (func_151(0))
...
int func_151(int iParam0)//Position - 0xACB4
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_152(int iParam0)//Position - 0xAD0E
{
...
int func_153(int iParam0)//Position - 0xAD4F
{
	int iVar0;
	...
	iVar0 = func_155(&(Global_19773[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_154(int iParam0)//Position - 0xAD94
{
...
int func_155(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xADC6
{
	int iVar0;
...
void func_156(var uParam0, int iParam1)//Position - 0xAEFD
{
	int iVar0;
...
bool func_157(int iParam0)//Position - 0xAF4C
{
	return func_158(iParam0, Global_8C41);
}

int func_158(int iParam0, int iParam1)//Position - 0xAF5D
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_159(int iParam0)//Position - 0xB13E
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_160()//Position - 0xB160
{
	return func_161(unk_0x1377080E9B0BD993(), 0);
}

int func_161(char* sParam0, int iParam1)//Position - 0xB171
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_163(int iParam0, int iParam1)//Position - 0xB1DE
{
	switch (iParam0)
	{
		case 0:
...
int func_164(vector3 vParam0, bool bParam1)//Position - 0xB665
{
	int iVar0;
	
	iVar0 = unk_0x390CF6C8AD6903B7(vParam0);
	unk_0x3F5F1772D71D5EC4(iVar0, func_165(unk_0x7AF0088ABFA713B6(), 1f, 1f));
	unk_0x0BBAABB52887CF8C(iVar0, bParam1);
	return iVar0;
}

float func_165(bool bParam0, float fParam1, float fParam2)//Position - 0xB691
{
	if (bParam0)
	{
		return fParam1;
...
int func_166(int iParam0)//Position - 0xB6A8
{
	switch (iParam0)
	{
		case 0:
...
int func_167(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB737
{
	int iVar0;
...
int func_168(int iParam0, int iParam1)//Position - 0xB76A
{
	switch (iParam0->f_10)
	{
		case 0:
				...
				if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					if (func_124(iParam0->f_1C[0]))
					{
						if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0->f_1C[0], true), true) < 3f)
						{
							if (func_174(2))
							{
								if (func_172(iParam0->f_1B))
								{
									func_171(iParam0->f_1B, *iParam0);
...
void func_169()//Position - 0xBF4D
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_170(var uParam0)//Position - 0xBF68
{
	float fVar0;
...
void func_171(int iParam0, int iParam1)//Position - 0xBFF6
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_172(bool bParam0)//Position - 0xC05C
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0xC0F3
{
	if (func_124(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_174(int iParam0)//Position - 0xC11D
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_182()) || Global_1974B) || Global_62BF) || func_181()) || func_180(8, -1)) || func_90()) || func_179()) || func_178()) || func_177()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_182()) || Global_62BF) || func_181()) || func_180(8, -1)) || func_178()) || func_90()) || func_179()) || func_177()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_182()) || Global_1974B) || Global_62BF) || func_181()) || func_180(8, -1)) || func_178()) || func_90()) || func_179()) || func_177()) || Global_19B04.f_1DEB.f_397[iVar0] == 5) || Global_8E64 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_182()) || Global_1974B) || Global_62BF) || func_181()) || func_180(8, -1)) || func_90()) || func_179()) || func_177()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_182() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_180(8, -1)) || func_177()) || func_176()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_182()) || Global_62BF) || func_181()) || func_180(8, -1)) || func_179()) || func_178()) || func_177()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || !unk_0x8CC5A4A5615C6420(unk_0xB5CEFD608600A09F())) || !unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F())) || !unk_0x726D9204B160D23E()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || func_182()) || func_179()) || Global_1974B) || Global_62BF) || func_181()) || Global_90C1) || func_180(8, -1)) || func_178()) || func_176()) || func_177()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_175()//Position - 0xC83A
{
	return Global_16B42.f_1;
}

int func_176()//Position - 0xC848
{
	if (Global_15FA6 != -1)
	{
...
bool func_179()//Position - 0xC8B2
{
	return Global_16B4F.f_142 > 0;
}

bool func_180(int iParam0, int iParam1)//Position - 0xC8C3
{
	switch (iParam0)
	{
		case 5:
...
var func_181()//Position - 0xC8FE
{
	return Global_140856;
}

int func_182()//Position - 0xC90A
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
int func_183(int iParam0)//Position - 0xC926
{
	int iVar0;
	...
	if (func_124(unk_0xBC25C936A095B5BA()))
	{
		...
		{
			if (unk_0x724D816EA203A79E(iParam0->f_1C[iVar0]))
			{
				if (func_124(iParam0->f_1C[iVar0]))
				{
					if (unk_0xD9C1758D86688CEA(iParam0->f_1C[iVar0], unk_0xBC25C936A095B5BA(), 1) || unk_0x04880508C862E589(unk_0x541C2AEF053615BC(iParam0->f_1C[iVar0], true), 7.5f, 1))
					{
						if (func_174(2))
						{
							func_171(iParam0->f_1B, *iParam0);
...
int func_184(int iParam0, var uParam1)//Position - 0xC9EA
{
	if (func_185(uParam1, unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true)))
	{
		if (func_174(2))
		{
			if (func_172(iParam0->f_1B))
...
bool func_185(var uParam0, struct<2> Param1, float fParam2)//Position - 0xCA27
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_186(int iParam0, var uParam1, var uParam2)//Position - 0xCAE3
{
	if (func_124(*uParam1))
	{
		switch (*iParam0)
		{
			case 0:
				if (unk_0x284F2ACE6839D3C0("CAR_TRUNK_THUMPS", false, -1))
				{
			...
			case 2:
				if ((unk_0x105601648511CC64() - iParam0->f_6) > iParam0->f_7)
				{
					...
					iParam0->f_9 = (0.5f * SYSTEM::TO_FLOAT(unk_0x491B2241281A03B7(-2, 3)));
...
int func_187(int iParam0)//Position - 0xCC4E
{
	int iVar0;
...
int func_188(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCE43
{
	var uVar0;
	
	if ((((func_124(unk_0xBC25C936A095B5BA()) && func_124(iParam0->f_1C[0])) && !func_142()) && (unk_0x105601648511CC64() - iParam0->f_3C) > iParam6) && func_192(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_189(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCECB
{
...
void func_190(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCF06
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_191(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCF5C
{
...
float func_192(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCFF7
{
	vector3 vVar0;
...
int func_193(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xD031
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_174(2))
		{
			if (!func_142())
			{
				if (((func_124(unk_0xBC25C936A095B5BA()) && func_124(iParam0->f_1C[0])) && func_124(iParam0->f_1C[1])) && func_192(unk_0xBC25C936A095B5BA(), vParam1, 1) < 20f)
				{
					...
					{
						func_191(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
						func_191(&uVar0, iParam6, iParam0->f_1C[1], sParam7, 0, 1);
						func_189(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
			...
			else if (((func_195(sParam3) && !*uParam8 == 1) && func_124(unk_0xBC25C936A095B5BA())) && func_192(unk_0xBC25C936A095B5BA(), vParam1, 1) >= 20f)
			{
				func_311("pause conversation");
				func_194(1);
				*uParam8 = 1;
			}
			if (func_192(unk_0xBC25C936A095B5BA(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_194(int iParam0)//Position - 0xD17C
{
	Global_41AB = iParam0;
}

int func_195(char* sParam0)//Position - 0xD189
{
	struct<6> Var0;
...
struct<6> func_196()//Position - 0xD1A9
{
	struct<6> Var0;
...
void func_197(int iParam0, var uParam1, int iParam2)//Position - 0xD1CD
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_199(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_199(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_198(int iParam0)//Position - 0xD525
{
...
int func_199(var uParam0)//Position - 0xD545
{
...
int func_200(var uParam0)//Position - 0xD55D
{
...
int func_201()//Position - 0xD582
{
	return joaat("u_m_m_aldinapoli");
}

char* func_202()//Position - 0xD58F
{
	return "Al_DiNapoli";
}

void func_203(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xD59B
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_192(unk_0xBC25C936A095B5BA(), vParam2, 1) <= 100f)
				{
					func_206(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_192(unk_0xBC25C936A095B5BA(), vParam2, 1) > 120f)
				{
					func_208(iParam0);
				}
			}
...
void func_204(int iParam0, bool bParam1)//Position - 0xD68C
{
	if (iParam0 == -1)
	{
		return;
...
int func_205(int iParam0)//Position - 0xD6C8
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_206(int iParam0, int iParam1)//Position - 0xD701
{
	bool bVar0;
	int iVar1;
...
bool func_207()//Position - 0xD79F
{
	return Global_16129;
}

void func_208(int iParam0)//Position - 0xD7AB
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_209(iParam0);
...
void func_209(int iParam0)//Position - 0xD7C2
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_210(int iParam0)//Position - 0xD8AA
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
int func_211(var uParam0, bool bParam1)//Position - 0xD8D2
{
	struct<27> Var0;
	...
	if ((func_244(*uParam0) || func_242(*uParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
	...
	if (func_200(&(uParam0->f_30)) && bParam1)
	{
		func_197(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_212(var uParam0)//Position - 0xDB45
{
	int iVar0;
	int iVar1;
...
void func_213(int iParam0)//Position - 0xDE49
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_214(var uParam0)//Position - 0xDE74
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, bool bParam2)//Position - 0xDEF4
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (bParam2)
				{
					if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
					{
						...
						if (func_173(iVar2))
						{
							...
							{
								if (func_173(uParam0->f_23[iVar0]))
								{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_216(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_216(int iParam0, int iParam1)//Position - 0xE0B2
{
	int iVar0;
...
int func_217(var uParam0, bool bParam1, int iParam2)//Position - 0xE0E2
{
	int iVar0;
	int iVar1;
...
int func_218(int iParam0)//Position - 0xE39E
{
...
int func_219(int iParam0, float fParam1)//Position - 0xE3D2
{
	float fVar0;
...
bool func_220(int iParam0, float fParam1)//Position - 0xE448
{
	return func_221(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_221(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE460
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_222(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE521
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_223(int iParam0, int iParam1)//Position - 0xE64D
{
	int iVar0;
...
int func_225(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE75C
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_227(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_227(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_226(vector3 vParam0, vector3 vParam1)//Position - 0xE7ED
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_227(vector3 vParam0)//Position - 0xE80E
{
	float fVar0;
	float fVar1;
...
void func_228(var uParam0)//Position - 0xE84D
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_229(int iParam0, int iParam1)//Position - 0xE868
{
	int iVar0;
...
int func_231(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE8CF
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_232(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE9CA
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_233(int iParam0, float fParam1)//Position - 0xEAD6
{
	var uVar0;
	vector3 vVar1;
...
int func_234(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xEB6B
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_227(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_235(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xEBF9
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_236(int iParam0)//Position - 0xEC41
{
...
void func_237(int iParam0)//Position - 0xEC8B
{
	int iVar0;
...
int func_238(int iParam0)//Position - 0xED28
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
int func_239(int iParam0)//Position - 0xEDC0
{
...
int func_242(int iParam0)//Position - 0xEE42
{
	if ((func_243() && Global_16B1B.f_B == 6) && iParam0 == func_161(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_244(int iParam0)//Position - 0xEEB4
{
	if (func_105(0))
	{
...
int func_245(int iParam0, var uParam1)//Position - 0xEEDC
{
	switch (*iParam0)
	{
		case 37:
...
int func_246(var uParam0)//Position - 0xEF98
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_255(&(uParam0->f_30), "rcmnigel3", "base", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_250(&(uParam0->f_1C[0]), 64, -44.6f, -1289.86f, 29.16f, 22.9f, "RC NIGEL", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_248(&(uParam0->f_23[0]), iLocal_55, -39.9688f, -1285.962f, 28.3505f, 181.02f);
				if (func_124(uParam0->f_23[0]))
				{
			...
			if (!func_247(&(uParam0->f_1C[1]), &(uParam0->f_23[0])))
			{
				bVar2 = false;
			}
			if (bVar2)
...
int func_247(var uParam0, var uParam1)//Position - 0xF17F
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	if (unk_0x724D816EA203A79E(*uParam1) && unk_0xD6513D668481290A(iLocal_54))
	{
		*uParam0 = unk_0x01B3635C3E8EDD81(26, joaat("u_m_m_aldinapoli"), -59.7094f, -1330.129f, 32.1963f, 0f, 1, true);
		unk_0xF85FAED5BA864282(*uParam0, "NI3_LNCH_CELEB");
		unk_0xB0031DDAE4FF0BC3(*uParam0, 4, 0, 0, 0);
		unk_0x2E35C4FA5F0ED22F(*uParam0, true);
		vVar0 = { unk_0xA4455714F3DCE207(*uParam1, -0.2f, -1.8f, -1f) };
		fVar2 = (-90f + unk_0x349C94FFF43E2979(*uParam1));
		vVar1 = { 0f, 0f, fVar2 };
		unk_0xD5874E4A4BF782FC(*uParam0, vVar0, 0, 0, 1);
		unk_0x784C605D172817C8(*uParam0, vVar1, 2, 1);
...
void func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF253
{
	func_249(iParam0);
...
void func_249(int iParam0)//Position - 0xF295
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_250(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xF331
{
...
int func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xF38D
{
	int iVar0;
...
int func_252(var uParam0, int iParam1)//Position - 0xF41B
{
	int iVar0;
...
int func_253(var uParam0)//Position - 0xF461
{
	if (func_200(uParam0))
	{
...
int func_254(int iParam0)//Position - 0xF48B
{
	int iVar0;
...
void func_255(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xF4BC
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_256(var uParam0)//Position - 0xF4F8
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_257(42, 1);
			func_255(&(uParam0->f_30), "rcmnigel2", "base_nigel", "base_nigel");
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
				unk_0xF243B7A14FCFD0F4(iVar0[iVar1]);
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (!func_250(&(uParam0->f_1C[0]), 64, -1310.65f, -640.17f, 26.52f, 153.43f, "RC NIGEL", 1))
				{
					bVar2 = false;
				}
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_248(&(uParam0->f_23[0]), iLocal_55, -1304.01f, -644.58f, 25.91f, 127.67f);
				if (func_124(uParam0->f_23[0]))
				{
					unk_0x914C5DE0B15B8B59(uParam0->f_23[0], 65, 0);
					unk_0x155EA453CD198E4B(uParam0->f_23[0], 5, false);
			...
			{
				func_248(&(uParam0->f_23[1]), iVar0[2], -1290.73f, -634.603f, 26.1004f, 126.961f);
				if (func_124(uParam0->f_23[1]))
				{
					unk_0x914C5DE0B15B8B59(uParam0->f_23[1], 0, 0);
					unk_0xD421BC740C5340C3(uParam0->f_23[1], 10);
				}
			}
			if (bVar2)
			{
...
void func_257(int iParam0, bool bParam1)//Position - 0xF713
{
	switch (iParam0)
	{
		case 37:
			...
			{
				unk_0x483687B0FCA5415A(iLocal_67, 0);
		...
		case 38:
			if (bParam1)
			{
				iLocal_67 = unk_0x1DAA351326EA3537(-577.274f, 270.6505f, 77f, -543.1793f, 315.2973f, 94f, 0, 1, 1, 1);
				unk_0xD0FC9D284379BED4("WORLD_HUMAN_GUARD_STAND", 0);
				unk_0xD0FC9D284379BED4("WORLD_HUMAN_CLIPBOARD", 0);
				unk_0xD0FC9D284379BED4("WORLD_VEHICLE_DRIVE_SOLO", 0);
		...
		case 39:
			if (bParam1)
			{
				iLocal_67 = unk_0x1DAA351326EA3537(-1073.19f, 342.05f, 63.32832f, -966.24f, 411.05f, 84.82043f, 0, 1, 1, 1);
		...
		case 41:
			if (bParam1)
			{
				iLocal_67 = unk_0x1DAA351326EA3537(-1122.202f, 48.5724f, 51.4652f, -1076.233f, 92.1041f, 60.0617f, 0, 1, 1, 1);
		...
		case 42:
			if (bParam1)
			{
				iLocal_67 = unk_0x1DAA351326EA3537(-1319.566f, -650.077f, 23.53715f, -1301.789f, -634.0721f, 38.18122f, 0, 1, 1, 1);
...
void func_258(bool bParam0)//Position - 0xFB28
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_261(var uParam0, var uParam1)//Position - 0xFC11
{
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_254(&iVar0) || !unk_0xF9E082857622D91E(uParam0->f_30)) || !unk_0xF9E082857622D91E(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
...
void func_262(var uParam0)//Position - 0x10202
{
	int iVar0;
	float fVar1;
...
void func_263(var uParam0, vector3 vParam1)//Position - 0x102A2
{
	if (uParam0->f_33 == 0)
	{
	}
...
void func_264(var uParam0)//Position - 0x102D3
{
	if (uParam0->f_33)
	{
	}
...
int func_265(var uParam0)//Position - 0x102FA
{
	int iVar0[2];
	int iVar1;
	char* sVar2;
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_254(&iVar0) || !unk_0xF9E082857622D91E(sVar2))
			{
				return 0;
			}
			iLocal_51 = 2;
...
int func_266(var uParam0)//Position - 0x10628
{
	int iVar0[6];
	int iVar1;
	char* sVar2;
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if ((!func_254(&iVar0) || !unk_0xF9E082857622D91E(uParam0->f_30)) || !unk_0xF9E082857622D91E(sVar2))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_248(&(uParam0->f_23[0]), iVar0[3], -1010.97f, 359.91f, 70.65f, 331.46f);
				if (func_124(uParam0->f_23[0]))
				{
					unk_0xF0A40F19AAB79E88(uParam0->f_23[0], 1084227584);
					unk_0x914C5DE0B15B8B59(uParam0->f_23[0], 97, 97);
					unk_0x55AFEE10B3CE5C2C(uParam0->f_23[0], 13.5f);
					unk_0x155EA453CD198E4B(uParam0->f_23[0], 2, false);
					unk_0x1C5BDB4E5D257D63(uParam0->f_23[0], 2, 0, 1);
					unk_0x1E6686599BFBEC90(uParam0->f_23[0], 2, 0, 1f);
					unk_0x366257F907116AD9(uParam0->f_23[0]);
					return 0;
				}
			}
			if (func_124(uParam0->f_23[0]))
			{
				fVar3 = unk_0x9BA320A867CC80B3(uParam0->f_23[0], 2);
				if (!unk_0x5D4A2D469411FA21(uParam0->f_23[0], 2) && fVar3 < 0.8f)
				{
					unk_0x1E6686599BFBEC90(uParam0->f_23[0], 2, 0, 1f);
				}
				else
		...
		case 3:
			if (func_124(uParam0->f_23[0]))
			{
				if (!unk_0x96044E39418AAF17(uParam0->f_23[0], sVar2, "idle_speedo", 3))
				{
					if (unk_0xF9E082857622D91E(sVar2))
					{
						unk_0x49F5DE8A61175187(uParam0->f_23[0], sVar2, "idle_speedo");
						return 0;
					}
					else
					{
			...
			func_248(&(uParam0->f_23[1]), iVar0[4], -1018.26f, 357.76f, 70.2f, 339.52f);
			if (func_124(uParam0->f_23[1]))
			{
				unk_0x914C5DE0B15B8B59(uParam0->f_23[1], 27, 27);
			}
			func_268(&(uParam0->f_1C[0]), iVar0[0], -1054.7f, 355.94f, 68.35f, 23.67f, 26);
			if (func_123(uParam0->f_1C[0]))
			{
				unk_0x63ECE17EEAC84602(uParam0->f_1C[0], 0);
				unk_0xD5874E4A4BF782FC(uParam0->f_1C[0], -1054.7f, 355.94f, 68.35f, 0, 0, 1);
				unk_0x019CE76D5286C95C(uParam0->f_1C[0], 23.67f);
				unk_0xE896C0AD02364F2A(uParam0->f_1C[0], sVar2, "Swimming_Idle", 8f, -8f, -1, 0, 0, 0, 0, 0);
			}
			func_268(&(uParam0->f_1C[1]), iVar0[1], -1058.43f, 362.78f, 69.86f, 130.45f, 26);
			if (func_123(uParam0->f_1C[1]))
			{
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 0, 0, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 2, 0, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 3, 0, 2, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 4, 0, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 8, 0, 1, 0);
				unk_0x63ECE17EEAC84602(uParam0->f_1C[1], 0);
				uParam0->f_3B = unk_0xD0D858E538FD01C3(-1059f, 360.976f, 69f, 0f, 0f, -1.08f, 2);
				unk_0xC2BF3DE5E47F801D(uParam0->f_3B, true);
				unk_0x69D4A898629B0BDA(uParam0->f_3B, false);
				unk_0xB62398E536F695FC(uParam0->f_1C[1], uParam0->f_3B, uParam0->f_30, "base_girl", 1000f, -8f, 592, 0, 1148846080, 0);
			}
			func_268(&(uParam0->f_1C[2]), iVar0[2], -1012.57f, 357.48f, 70.62f, -28.55f, 26);
			if (func_123(uParam0->f_1C[2]))
			{
				unk_0xDC3C88A35B53F90B(uParam0->f_1C[2]);
				unk_0xD5874E4A4BF782FC(uParam0->f_1C[2], -1012.57f, 357.48f, 70.62f, 0, 0, 1);
				unk_0x65E471E4A2D56226(uParam0->f_1C[2], 160, 0);
				if (unk_0xF9E082857622D91E(sVar2))
				{
					unk_0xE896C0AD02364F2A(uParam0->f_1C[2], sVar2, "idle_gardener", 1000f, -8f, -1, 270337, 0, 0, 0, 0);
				}
			}
			func_267(&(uParam0->f_29[0]), iVar0[5], -1050.03f, 368.95f, 69.29f, -11.27f);
			if (func_124(uParam0->f_29[0]))
			{
				unk_0x784C605D172817C8(uParam0->f_29[0], 0f, 0f, -11.27f, 2, 1);
				unk_0x30034548191398D0(uParam0->f_29[0], false);
				unk_0x1E5C2A1EAB944289(uParam0->f_29[0], true);
				unk_0xAA65393F1ED3B2D7(uParam0->f_29[0], 0);
			...
			unk_0x4EA570997E107F35(uParam0->f_30);
			unk_0x4EA570997E107F35(sVar2);
			return 1;
			break;
	}
	return 0;
...
void func_267(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x10B8A
{
	func_213(iParam0);
...
void func_268(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x10BB1
{
	func_269(iParam0);
	*iParam0 = unk_0x01B3635C3E8EDD81(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_269(int iParam0)//Position - 0x10BD2
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
int func_270(var uParam0)//Position - 0x10C13
{
	int iVar0[7];
	int iVar1;
	int iVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			uParam0->f_3B = -1;
			func_257(38, 1);
			iVar2 = unk_0x5E29F9399E0829A3(-555.5934f, 285.7738f, 81.1763f, "v_rockclub");
			if (unk_0xBF697FA7422C0621(iVar2))
			{
				unk_0x2C200845CC871354(iVar2);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
		...
		case 1:
			if (!func_254(&iVar0) || !unk_0xF9E082857622D91E(uParam0->f_30))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			func_268(&(uParam0->f_1C[0]), iVar0[0], -552.66f, 287.75f, 82.18f, 123.75f, 26);
			func_268(&(uParam0->f_1C[1]), iVar0[1], -553.46f, 287.34f, 82.18f, -65.86f, 26);
			if (func_123(uParam0->f_1C[1]))
			{
				unk_0xB105531EDD3DE51B(uParam0->f_1C[1], false);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 0, 1, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 2, 0, 2, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 3, 1, 2, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 4, 0, 1, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 7, 0, 1, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 8, 1, 0, 0);
			}
			uParam0->f_3B = unk_0xD0D858E538FD01C3(-552.18f, 285.476f, 81.976f, 0f, 0f, 79.5f, 2);
			unk_0xC2BF3DE5E47F801D(uParam0->f_3B, true);
			unk_0x69D4A898629B0BDA(uParam0->f_3B, false);
			if (func_123(uParam0->f_1C[0]))
			{
				unk_0xB62398E536F695FC(uParam0->f_1C[0], uParam0->f_3B, uParam0->f_30, "BASE_02_Willie", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			if (func_123(uParam0->f_1C[1]))
			{
				unk_0xB62398E536F695FC(uParam0->f_1C[1], uParam0->f_3B, uParam0->f_30, "BASE_02_GIRL", 1000f, -8f, 17, 0, 1148846080, 0);
			}
			func_268(&(uParam0->f_1C[2]), iVar0[2], -559.94f, 285.99f, 85.38f, -59.06f, 26);
			func_268(&(uParam0->f_1C[3]), iVar0[3], -558.87f, 289.79f, 85.38f, 162.44f, 26);
			func_268(&(uParam0->f_1C[4]), iVar0[4], -559f, 286.09f, 85.38f, 65.92f, 26);
			func_268(&(uParam0->f_1C[5]), iVar0[5], -558.84f, 288.97f, 85.38f, -7.72f, 26);
			if (func_123(uParam0->f_1C[2]))
			{
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[2], 0, 0, 1, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[2], 2, 1, 2, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[2], 3, 1, 1, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[2], 4, 1, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[2], 7, 1, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[2], 8, 1, 0, 0);
			}
			if (func_123(uParam0->f_1C[3]))
			{
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 0, 1, 1, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 2, 1, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 3, 1, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 4, 1, 1, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 7, 1, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 8, 1, 0, 0);
			}
			if (func_123(uParam0->f_1C[4]))
			{
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[4], 0, 0, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[4], 2, 0, 2, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[4], 3, 0, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[4], 4, 0, 1, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[4], 8, 0, 0, 0);
			}
			if (func_123(uParam0->f_1C[5]))
			{
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[5], 0, 1, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[5], 2, 2, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[5], 3, 0, 3, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[5], 4, 1, 0, 0);
				unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[5], 8, 0, 2, 0);
			}
			func_248(&(uParam0->f_23[0]), iVar0[6], -553.55f, 308.61f, 82.81f, 202.78f);
			if (func_124(uParam0->f_23[0]))
			{
				unk_0x6012A6A4F2950585(uParam0->f_23[0], 1);
				unk_0xD421BC740C5340C3(uParam0->f_23[0], 1);
				unk_0xAA65393F1ED3B2D7(uParam0->f_23[0], 0);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_271(int iParam0, bool bParam1)//Position - 0x11161
{
	char* sVar0;
	int iVar1;
...
int func_272(int iParam0)//Position - 0x11207
{
	struct<2> Var0;
...
struct<2> func_273(var uParam0)//Position - 0x1123B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_274(int iParam0, bool bParam1)//Position - 0x1128D
{
	struct<2> Var0;
...
var func_275(int iParam0, int iParam1)//Position - 0x112D0
{
	struct<5> Var0;
...
struct<5> func_276(int iParam0)//Position - 0x112F5
{
	struct<5> Var0;
	vector3 vVar1;
...
struct<6> func_277(int iParam0, bool bParam1)//Position - 0x135E7
{
	struct<6> Var0;
...
int func_278(var uParam0)//Position - 0x141A1
{
	int iVar0[3];
	int iVar1;
	int iVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_255(&(uParam0->f_30), "rcmnigel1", "base_nigel", "base_nigel");
		...
		case 2:
			bVar3 = true;
			if (!func_250(&(uParam0->f_1C[0]), 64, -1100.5f, 789.8f, 164.34f, 1.82f, "RC: NIGEL", 1))
			{
				bVar3 = false;
			}
			if (!func_250(&(uParam0->f_1C[1]), 63, -1099.35f, 789.15f, 164.47f, 0f, "RC: MRS THORNHILL", 1))
			{
				bVar3 = false;
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_248(&(uParam0->f_23[0]), iLocal_55, -1077.959f, 793.9361f, 164.6374f, 172.8563f);
				if (func_124(uParam0->f_23[0]))
				{
					unk_0x914C5DE0B15B8B59(uParam0->f_23[0], 65, 0);
					unk_0x155EA453CD198E4B(uParam0->f_23[0], 5, false);
		...
		case 3:
			if (func_124(uParam0->f_1C[0]) && func_124(uParam0->f_1C[1]))
			{
				unk_0x2E35C4FA5F0ED22F(uParam0->f_1C[0], true);
				unk_0x2E35C4FA5F0ED22F(uParam0->f_1C[1], true);
...
int func_279(int iParam0)//Position - 0x14442
{
	struct<27> Var0;
	int iVar1;
...
int func_280(int iParam0)//Position - 0x14496
{
	char* sVar0;
...
int func_281(int iParam0)//Position - 0x1454F
{
	var uVar0;
...
int func_282(int iParam0)//Position - 0x14610
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_283(int iParam0, char* sParam1)//Position - 0x14695
{
...
bool func_284(int iParam0)//Position - 0x14777
{
...
bool func_285(int iParam0)//Position - 0x147A5
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_286(int iParam0)//Position - 0x147D3
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_287(int iParam0)//Position - 0x14801
{
	if (func_239(iParam0))
	{
		return 0;
...
void func_288()//Position - 0x14836
{
	func_311("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_289(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x14850
{
	int iVar0;
...
int func_290(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0x148B5
{
	int iVar0;
	struct<7> Var1;
...
int func_291(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x14933
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_292(int iParam0, int iParam1, bool bParam2)//Position - 0x149AE
{
	char* sVar0;
	
	if (*iParam0 == 43)
	{
		func_269(&(iParam0->f_1C[1]));
	}
...
void func_293(char* sParam0)//Position - 0x14A98
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
		if (func_195(sParam0))
...
void func_294()//Position - 0x14AB7
{
	Global_394A = 0;
	func_295();
}

void func_295()//Position - 0x14AC7
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
int func_296(var uParam0)//Position - 0x14AE8
{
	if (func_200(uParam0))
	{
		if (unk_0xF9E082857622D91E(*uParam0))
...
void func_297(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x14B1E
{
...
void func_298(var uParam0, bool bParam1)//Position - 0x14B3E
{
	func_299(&(uParam0->f_29), bParam1);
}

void func_299(var uParam0, bool bParam1)//Position - 0x14B50
{
	int iVar0;
...
void func_300(int iParam0, bool bParam1)//Position - 0x14B8E
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_301(var uParam0, bool bParam1)//Position - 0x14BC9
{
	func_302(&(uParam0->f_23), bParam1);
}

void func_302(var uParam0, bool bParam1)//Position - 0x14BDB
{
	int iVar0;
...
void func_303(int iParam0)//Position - 0x14C18
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_304(var uParam0, int iParam1)//Position - 0x14C50
{
	func_305(&(uParam0->f_1C), iParam1);
}

void func_305(var uParam0, int iParam1)//Position - 0x14C62
{
	int iVar0;
...
void func_306(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x14CA3
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_307(var uParam0)//Position - 0x14CF3
{
	if (unk_0x77FC50899603581D(uParam0->f_3B))
	{
		if (func_123(uParam0->f_1C[1]))
		{
			if (func_308(uParam0->f_1C[1], 1785177548))
			{
				unk_0xA4E856A8CD53B8DF(uParam0->f_1C[1]);
			}
			unk_0x6C3BE67B02D72CDC(uParam0->f_1C[1], -1000f, 1);
		}
	}
}

int func_308(int iParam0, int iParam1)//Position - 0x14D44
{
	if (func_123(iParam0))
	{
...
void func_309(var uParam0)//Position - 0x14D77
{
	if (unk_0x77FC50899603581D(uParam0->f_3B))
	{
		if (func_123(uParam0->f_1C[0]))
		{
			if (func_308(uParam0->f_1C[0], 1785177548))
			{
				unk_0xA4E856A8CD53B8DF(uParam0->f_1C[0]);
			}
			unk_0x6C3BE67B02D72CDC(uParam0->f_1C[0], -1000f, 1);
		}
		if (func_123(uParam0->f_1C[1]))
		{
			if (func_308(uParam0->f_1C[1], 1785177548))
...
void func_310(var uParam0)//Position - 0x14E06
{
	if (*uParam0 == -1)
	{
		return;
...
void func_311(char* sParam0)//Position - 0x14E43
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_312(var uParam0)//Position - 0x14E55
{
	*uParam0 = -1;
...
void func_313()//Position - 0x14E88
{
	func_311("Running start routines.");
	Global_199EA++;
}

int func_314(int iParam0)//Position - 0x14EA2
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
