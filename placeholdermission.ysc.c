...
void func_3()//Position - 0xFC
{
	...
	if (Global_19B04.f_2360 || func_18(0))
	{
		if (!func_17())
		{
			iVar0 = func_16();
...
void func_6()//Position - 0x26B
{
	...
	{
		if (func_10(Global_19B04.f_932.f_21B.f_10CD) != unk_0x6F79ECA8C83E4357(unk_0xBC25C936A095B5BA()))
		{
			iVar0 = func_9(unk_0xBC25C936A095B5BA());
			if (func_8(iVar0) && (!func_7(14) || Global_196EB))
			{
				if (Global_19B04.f_932.f_21B.f_10CD != iVar0 && func_8(Global_19B04.f_932.f_21B.f_10CD))
				{
...
int func_11(int iParam0)//Position - 0x3E9
{
	...
	func_12(&(Global_19B04.f_932.f_21B), iVar1);
...
void func_12(var uParam0, int iParam1)//Position - 0x500
{
	...
	while (iVar0 < 3)
	{
		...
		else
		{
			vVar2 = { 0f, 0f, 0f };
			fVar3 = 0f;
			if (!func_14(Global_19B04.f_4848[iVar0], &vVar2, &fVar3))
			{
