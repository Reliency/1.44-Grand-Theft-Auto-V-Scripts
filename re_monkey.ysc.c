...
int func_12()//Position - 0xE59
{
	return Global_1407E0;
}

int func_13(int iParam0, int iParam1)//Position - 0xE65
{
	switch (iParam0)
	{
		case 0:
...
int func_14(int iParam0)//Position - 0x11D9
{
	switch (iParam0)
	{
		case 29:
...
void func_15(int iParam0)//Position - 0x1208
{
	int iVar0;
	int iVar1;
...
void func_16(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x124A
{
	func_17(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_17(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x126C
{
	int iVar0;
...
bool func_21(int iParam0)//Position - 0x16A3
{
	return Global_8C41 == iParam0;
}

bool func_22(int iParam0)//Position - 0x16B1
{
	return iParam0 < 3;
}

int func_23(int iParam0)//Position - 0x16BD
{
	int iVar0;
	int iVar1;
...
int func_24(int iParam0)//Position - 0x16FA
{
	if (func_22(iParam0))
	{
...
int func_25(int iParam0)//Position - 0x1724
{
	int iVar0;
	int iVar1;
...
void func_26(int iParam0, int iParam1)//Position - 0x1767
{
	unk_0xF0059F27F7BB6680(&(Global_19B04.f_6186.f_8[iParam0]), iParam1);
}

int func_27(int iParam0)//Position - 0x1782
{
	int iVar0;
...
int func_29(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x1850
{
...
void func_30()//Position - 0x1A2A
{
	func_31(1751306471, 6, func_34(), 133, 30000, 10000, -1, 0, -1, 0, 0);
}

int func_31(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10)//Position - 0x1A4E
{
	struct<14> Var0;
...
void func_32(int iParam0)//Position - 0x1B69
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_33(int iParam0)//Position - 0x1C2D
{
	switch (iParam0)
	{
		case 0:
...
int func_35(int iParam0)//Position - 0x1CCF
{
	int iVar0;
	int iVar1;
...
void func_36(int iParam0)//Position - 0x1DF6
{
	int iVar0;
	struct<10> Var1;
...
void func_37(int iParam0)//Position - 0x1EAF
{
	int iVar0;
	struct<14> Var1;
...
void func_38(int iParam0)//Position - 0x1F77
{
	struct<15> Var0;
	int iVar1;
	int iVar2;
...
void func_39(int iParam0)//Position - 0x2024
{
	struct<15> Var0;
	int iVar1;
	int iVar2;
	...
	while (iVar1 < Global_19B04.f_1DEB.f_C6)
	{
		...
		{
			func_40(Global_19B04.f_1DEB.f_89[iVar1 /*15*/].f_6);
			iVar2 = iVar1;
...
int func_40(int iParam0)//Position - 0x20E0
{
	int iVar0;
...
void func_41(int iParam0, int iParam1)//Position - 0x2151
{
	if (Global_75[iParam0 /*10*/].f_8 != 144)
	{
		if (iParam1 > 3)
...
void func_42(int iParam0)//Position - 0x2194
{
	int iVar0;
	int iVar1;
	struct<15> Var2;
...
void func_43(int iParam0, vector3 vParam1, float fParam2)//Position - 0x226F
{
	unk_0x641B19E156645A92(iParam0, vParam1, 1, false, 0, 1);
	unk_0x019CE76D5286C95C(iParam0, fParam2);
}

int func_44(int iParam0)//Position - 0x228D
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
void func_45()//Position - 0x22AE
{
	...
	while (iVar0 < 4)
	{
		...
		switch (iVar1)
		{
			...
			case 1:
				iLocal_58[iVar1] = unk_0xB6896943DA475493(joaat("prop_paints_can02"), -335.66f, -95.24f, 46.16f, true, true, false);
				unk_0xD5874E4A4BF782FC(iLocal_58[iVar1], -335.66f, -95.24f, 46.16f, 0, 0, 1);
				unk_0x784C605D172817C8(iLocal_58[iVar1], -2.32f, 0.66f, -0.8f, 2, 1);
				break;
			
			case 2:
				iLocal_58[iVar1] = unk_0xB6896943DA475493(joaat("prop_paint_brush05"), -336.04f, -94.9f, 46.02f, true, true, false);
				unk_0xD5874E4A4BF782FC(iLocal_58[iVar1], -336.04f, -94.9f, 46.02f, 0, 0, 1);
				unk_0x784C605D172817C8(iLocal_58[iVar1], 0.01f, 3.85f, 2.72f, 2, 1);
				break;
			
			case 3:
				iLocal_58[iVar1] = unk_0xB6896943DA475493(joaat("prop_paint_spray01b"), -336.34f, -95.66f, 46.02f, true, true, false);
				unk_0xD5874E4A4BF782FC(iLocal_58[iVar1], -336.34f, -95.66f, 46.02f, 0, 0, 1);
				unk_0x784C605D172817C8(iLocal_58[iVar1], -2.86f, 0.76f, 28.89f, 2, 1);
				break;
		}
		iVar0++;
	}
...
int func_49()//Position - 0x246D
{
	...
	else if (iLocal_46 == 2)
	{
		...
		{
			if (unk_0x610A1308608A0F91(iLocal_48, 1))
			{
				func_144();
			}
		}
		...
		switch (iLocal_47)
		{
			...
			case 1:
				if (func_50())
				{
					...
					{
						if (unk_0x2BFC801314CA1A73(30f, 31086, 0.8f, 0.7f, 0.25f, 1090519040, 1051361018, 31086, 24818) == iLocal_48)
						{
							iLocal_69 = unk_0x105601648511CC64() + 2000;
							iLocal_47++;
						}
					}
				}
			...
			case 2:
				if (iLocal_69 < unk_0x105601648511CC64())
				{
					iLocal_52 = 1;
					iLocal_47++;
				}
...
int func_51()//Position - 0x25AC
{
	...
	{
		unk_0xF243B7A14FCFD0F4(1813637474);
		if (unk_0xD6513D668481290A(1813637474))
		{
			iLocal_48 = unk_0x01B3635C3E8EDD81(26, 1813637474, vLocal_49, fLocal_50, 1, true);
			unk_0x2CA123B0622F495C(1813637474);
			iLocal_58[0] = unk_0xB6896943DA475493(joaat("prop_cs_spray_can"), vLocal_59, true, true, false);
			unk_0x5DBE04849460E608(iLocal_58[0], iLocal_48, unk_0xFA18E720A39243D0(iLocal_48, 28422), 0f, -0.01f, -0.02f, vLocal_66, 1, 1, 0, 0, 2, 1);
			unk_0x22321800954A532E(iLocal_48, true);
			unk_0xC8FD3EBBB90E8D7F(iLocal_48, 42, true);
			iLocal_53 = func_62(iLocal_48, 0, 145);
			func_52(1);
			unk_0x4106FAF8AA1D69D5(iLocal_48, 1862763509);
			unk_0x4A506C72BFC368E4(iLocal_48, 2.5f);
		}
	}
	return 0;
}

int func_52(int iParam0)//Position - 0x266D
{
	if (func_56())
	{
		Global_19AFA = 1;
...
void func_53(int iParam0)//Position - 0x26C0
{
	switch (iParam0)
	{
		case 0:
...
void func_54(char* sParam0, int iParam1)//Position - 0x27A1
{
	unk_0x2F618BD43614DD0D(sParam0);
	unk_0x72F8FA06CC9EC899(0, 0, true, iParam1);
}

char* func_55(int iParam0)//Position - 0x27B8
{
	char* sVar0;
...
int func_56()//Position - 0x27FC
{
	switch (func_57(&Global_62F8, 0, 5, 0, unk_0x8A55B15F4133C912()))
	{
		case 1:
			return 1;
			break;
...
int func_57(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2832
{
	int iVar0;
...
void func_58(var uParam0, int iParam1)//Position - 0x2969
{
	int iVar0;
...
bool func_59(int iParam0)//Position - 0x29B8
{
	return func_60(iParam0, Global_8C41);
}

int func_60(int iParam0, int iParam1)//Position - 0x29C9
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_61(int iParam0)//Position - 0x2BAA
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_62(int iParam0, bool bParam1, int iParam2)//Position - 0x2BCC
{
	int iVar0;
...
int func_63(int iParam0, bool bParam1, bool bParam2)//Position - 0x2C1E
{
	int iVar0;
	...
	{
		unk_0x3F5F1772D71D5EC4(iVar0, func_64(unk_0x7AF0088ABFA713B6(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x3F5F1772D71D5EC4(iVar0, func_64(unk_0x7AF0088ABFA713B6(), 0.7f, 0.7f));
		unk_0xF9C2945DB5BAB4BF(iVar0, bParam1);
	}
...
float func_64(bool bParam0, float fParam1, float fParam2)//Position - 0x2CC2
{
	if (bParam0)
	{
		return fParam1;
...
void func_65()//Position - 0x2CD9
{
	func_66();
	if (!unk_0x684B06333594F9EA() && iLocal_51 < 3)
	{
		func_144();
	}
}

void func_66()//Position - 0x2CFA
{
	bool bVar0;
	bool bVar1;
	vector3 vVar2;
	...
	if (func_44(iLocal_48))
	{
		...
		vVar2 = { unk_0x541C2AEF053615BC(iLocal_48, false) };
		fVar4 = 7.5f;
		vVar5 = { fVar4, fVar4, fVar4 };
		if (bVar1)
		{
			vVar3 = { unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), false) };
			bVar6 = unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0);
			bVar7 = unk_0xE3CA72BD77D43B09(unk_0xBC25C936A095B5BA());
		}
		if (iLocal_51 < 3)
		{
			if (unk_0x04880508C862E589(vVar2, fVar4, 0) || unk_0x876474582C5DECDE(vVar2 - vVar5, vVar2 + vVar5, 0))
			{
				iLocal_51 = 3;
			}
		}
		...
		{
			case 0:
				unk_0x522053D86D6E1C7A(sLocal_62);
				if (unk_0xF9E082857622D91E(sLocal_62))
				{
					unk_0x2E35C4FA5F0ED22F(iLocal_48, true);
					unk_0xE896C0AD02364F2A(iLocal_48, sLocal_62, sLocal_63, 1000f, -8f, -1, 8193, 0, 0, 0, 0);
					iLocal_51++;
				}
				break;
			...
			case 1:
				...
				if (func_76(unk_0xBC25C936A095B5BA(), iLocal_48, 35f))
				{
					unk_0xC5A6DFE2B8987B17(&iLocal_68);
					unk_0xE896C0AD02364F2A(0, sLocal_62, sLocal_64, 8f, -8f, -1, 8192, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sLocal_62, sLocal_65, 8f, -2f, -1, 8193, 0, 0, 0, 0);
					unk_0x535008C596714F9E(iLocal_68);
					unk_0xA8E6405305C0D7DF(iLocal_48, iLocal_68);
					unk_0x02DAF06EA4F08219(&iLocal_68);
					unk_0x4EA570997E107F35(sLocal_62);
					iLocal_51++;
				}
				break;
			...
			case 2:
				...
				if ((bVar0 && bVar1) && func_76(unk_0xBC25C936A095B5BA(), iLocal_48, fVar8))
				{
					iLocal_51 = 3;
				}
				if (iLocal_52)
			...
			case 4:
				unk_0xABA7AE40608505F2(iLocal_48, 8, true);
				unk_0xABA7AE40608505F2(iLocal_48, 32, true);
				unk_0xC5A6DFE2B8987B17(&iLocal_68);
			...
			case 5:
				...
				if (!unk_0xD1DC4B08247A4317(iLocal_48) && SYSTEM::VDIST2(vVar2, unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), false)) > 2500f)
				{
					iLocal_67 = unk_0xA20E4A82503CECB3(vVar3, vVar2, 1, 0, 7);
					iLocal_51++;
				}
				break;
			...
			case 6:
				...
				iVar13 = unk_0xB0695CD48A28A3A9(iLocal_67, &iVar9, &uVar10, &uVar11, &uVar12);
				if (iVar13 == 2)
				{
					if (iVar9 == 1)
					{
	...
	else if (unk_0x724D816EA203A79E(iLocal_48))
	{
		unk_0x346478B12F69D4E3(iLocal_48, false);
	}
}

int func_67()//Position - 0x3021
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	{
		case 0:
			if (unk_0x96044E39418AAF17(iLocal_48, sLocal_62, sLocal_65, 3))
			{
				fLocal_54 = 0.349f;
				iLocal_55 = 900;
				vLocal_57 = { vVar0 };
			...
			else if (unk_0x96044E39418AAF17(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				fLocal_54 = unk_0x4A3B2CF8BADDD74E(iLocal_48, sLocal_62, sLocal_64);
				...
				if (fLocal_54 != 0.2f)
				{
					...
					vLocal_57 = { unk_0x541C2AEF053615BC(iLocal_48, false) - Vector(1f, 0f, 0f) };
					iLocal_56 = 1;
				}
				else
				{
		...
		case 1:
			...
			unk_0xE896C0AD02364F2A(iLocal_48, sLocal_62, sLocal_64, 4f, -8f, -1, 0, fLocal_54, 1, 0, 0);
			iLocal_69 = unk_0x105601648511CC64();
			func_70(&iLocal_53);
			func_69();
			if (unk_0x724D816EA203A79E(iLocal_58[0]))
			{
				unk_0x17175087F2DB6AC8(iLocal_58[0], 1, true);
			}
			iLocal_56++;
			break;
		
		case 2:
			if (unk_0x96044E39418AAF17(iLocal_48, sLocal_62, sLocal_64, 3))
			{
				iVar3 = (unk_0x105601648511CC64() - iLocal_69);
				...
				unk_0x68567B14F012CF3E(iLocal_48, sLocal_62, sLocal_64, fVar5);
				fVar6 = (fVar4 - 0.12f);
				fVar6 = func_71(fVar6, 0f, 0.8f);
				vVar7 = { func_68(vLocal_57, vVar1, fVar6) };
				unk_0x641B19E156645A92(iLocal_48, vVar7, 0, true, 0, 1);
				if (fVar5 == 0.161f)
				{
					unk_0x346478B12F69D4E3(iLocal_48, false);
					return 1;
...
Vector3 func_68(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x322F
{
	return FtoV((1f - fParam2)) * vParam0 + Vector(fParam2, fParam2, fParam2) * vParam1;
}

void func_69()//Position - 0x324A
{
	if (iLocal_60 != 0)
	{
		unk_0x2CA8D9DC16C6AF09(iLocal_60, 0);
		iLocal_60 = 0;
	}
}

void func_70(int iParam0)//Position - 0x3262
{
...
float func_71(float fParam0, float fParam1, float fParam2)//Position - 0x3282
{
	if (fParam0 > fParam2)
	{
		return fParam2;
...
void func_72()//Position - 0x32A9
{
	float fVar0;
	
	if (unk_0x96044E39418AAF17(iLocal_48, sLocal_62, sLocal_64, 3))
	{
		fVar0 = unk_0x4A3B2CF8BADDD74E(iLocal_48, sLocal_62, sLocal_64);
		if (fVar0 < 0.383793f)
		{
			func_69();
		}
	...
	else if (unk_0x96044E39418AAF17(iLocal_48, sLocal_62, sLocal_65, 3))
	{
		fVar0 = unk_0x4A3B2CF8BADDD74E(iLocal_48, sLocal_62, sLocal_65);
		if (fVar0 < 0.1124f)
		{
			func_69();
		}
...
void func_73()//Position - 0x336A
{
	if (iLocal_60 == 0)
	{
		iLocal_60 = unk_0xD0F8470A5BFEECF7(sLocal_61, iLocal_58[0], vLocal_66, vLocal_66, 1065353216, 0, 0, 0);
		unk_0x42918D3B3281AA2C(iLocal_60, 1f, 1f, 1f, 0);
		unk_0x1A918116D6CF2C56(iLocal_60, 0.2f);
	}
}

bool func_74(vector3 vParam0, vector3 vParam1)//Position - 0x33AA
{
	float fVar0;
	float fVar1;
	float fVar2;
...
bool func_75()//Position - 0x3403
{
	return (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -334.4651f, -93.42171f, 48.57328f, -332.2641f, -82.78552f, 45.8103f, 3f, 0, true, 0) && !unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -329.1134f, -83.87273f, 45.79989f, -331.0937f, -88.05348f, 48.71878f, 3f, 0, true, 0));
}

int func_76(int iParam0, int iParam1, float fParam2)//Position - 0x3465
{
	float fVar0;
	...
	if (unk_0x724D816EA203A79E(iParam0) && unk_0x724D816EA203A79E(iParam1))
	{
		...
		return SYSTEM::VDIST2(unk_0x541C2AEF053615BC(iParam0, false), unk_0x541C2AEF053615BC(iParam1, false)) <= fVar0;
	}
	return 0;
}

int func_77(int iParam0)//Position - 0x34A1
{
	if (!func_78(iLocal_48, iParam0) && !func_78(iLocal_48, 1805844857))
	{
		func_70(&iLocal_53);
		unk_0x5558ED6D4A2DEC93(iLocal_48, unk_0xBC25C936A095B5BA(), 9999f, -1, 1, 0);
		return 1;
	}
	return 0;
}

bool func_78(int iParam0, int iParam1)//Position - 0x34E3
{
	int iVar0;
...
void func_79(vector3 vParam0)//Position - 0x3503
{
	if (func_83(vParam0))
	{
		func_80(33);
...
void func_80(int iParam0)//Position - 0x3527
{
	if (iParam0 == -1)
	{
		iParam0 = func_28();
...
void func_82(int iParam0)//Position - 0x359A
{
	Global_19AF9 = iParam0;
}

int func_83(vector3 vParam0)//Position - 0x35A8
{
...
bool func_85()//Position - 0x3697
{
	return func_86(func_87(), 5);
}

bool func_86(int iParam0, int iParam1)//Position - 0x36A8
{
	if (iParam0 == -1)
	{
		return 0;
...
bool func_88(int iParam0)//Position - 0x3706
{
...
int func_89(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x3734
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()) && !unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
		{
			...
			if (SYSTEM::VMAG2(unk_0xB5D9AE572C19509E(unk_0xBC25C936A095B5BA())) > 1369f && !func_143())
			{
				return 0;
			}
		}
		...
		if (!func_127(Global_19B04.f_6186.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_90(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x3ACE
{
	if (bParam2)
	{
...
bool func_91(int iParam0)//Position - 0x3B15
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x3B36
{
	return func_93(iParam0, 1);
}

int func_93(int iParam0, int iParam1)//Position - 0x3B45
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_94(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x3B98
{
	func_95(func_106(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_95(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x3BB6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_96(float fParam0, float fParam1, float fParam2)//Position - 0x3DB7
{
	float fVar0;
...
int func_97(int iParam0, int iParam1)//Position - 0x3DF9
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_98(int iParam0)//Position - 0x3E9B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_99(int iParam0)//Position - 0x3EAE
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_100(int iParam0)//Position - 0x3EC1
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_101(int iParam0)//Position - 0x3ED4
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_102(int iParam0)//Position - 0x3EE6
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_103(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_103(bool bParam0, int iParam1, int iParam2)//Position - 0x3F0B
{
	if (bParam0)
	{
		return iParam1;
...
int func_104(int iParam0)//Position - 0x3F22
{
	return iParam0 & 15;
}

int func_105(int iParam0, int iParam1)//Position - 0x3F2F
{
	int iVar0;
	int iVar1;
...
void func_107(var uParam0, int iParam1)//Position - 0x4084
{
	if (iParam1 <= 0)
	{
		return;
...
void func_108(var uParam0, int iParam1)//Position - 0x410A
{
...
void func_109(var uParam0, int iParam1)//Position - 0x413D
{
	int iVar0;
	int iVar1;
...
void func_110(var uParam0, int iParam1)//Position - 0x418E
{
...
void func_111(var uParam0, int iParam1)//Position - 0x41C8
{
...
void func_112(var uParam0, int iParam1)//Position - 0x4203
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_113(int iParam0)//Position - 0x423F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_114(int iParam0, int iParam1)//Position - 0x431B
{
...
int func_115(int iParam0)//Position - 0x433E
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_124()) || Global_1974B) || Global_62BF) || func_123()) || func_122(8, -1)) || func_121()) || func_120()) || func_119()) || func_118()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_124()) || Global_62BF) || func_123()) || func_122(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_124()) || Global_1974B) || Global_62BF) || func_123()) || func_122(8, -1)) || func_119()) || func_121()) || func_120()) || func_118()) || Global_19B04.f_1DEB.f_397[iVar0] == 5) || Global_8E64 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_124()) || Global_1974B) || Global_62BF) || func_123()) || func_122(8, -1)) || func_121()) || func_120()) || func_118()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_124() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_122(8, -1)) || func_118()) || func_117()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_124()) || Global_62BF) || func_123()) || func_122(8, -1)) || func_120()) || func_119()) || func_118()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || !unk_0x8CC5A4A5615C6420(unk_0xB5CEFD608600A09F())) || !unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F())) || !unk_0x726D9204B160D23E()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || func_124()) || func_120()) || Global_1974B) || Global_62BF) || func_123()) || Global_90C1) || func_122(8, -1)) || func_119()) || func_117()) || func_118()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_116()//Position - 0x4A5B
{
	return Global_16B42.f_1;
}

int func_117()//Position - 0x4A69
{
	if (Global_15FA6 != -1)
	{
...
bool func_120()//Position - 0x4AD3
{
	return Global_16B4F.f_142 > 0;
}

bool func_121()//Position - 0x4AE4
{
	return Global_16B4F.f_141 > 0;
}

bool func_122(int iParam0, int iParam1)//Position - 0x4AF5
{
	switch (iParam0)
	{
		case 5:
...
var func_123()//Position - 0x4B30
{
	return Global_140856;
}

int func_124()//Position - 0x4B3C
{
...
bool func_127(int iParam0)//Position - 0x4C22
{
	return func_105(func_106(), iParam0);
}

int func_128(int iParam0, int iParam1, int iParam2)//Position - 0x4C34
{
	int iVar0;
	int iVar1;
...
int func_129(int iParam0)//Position - 0x4D18
{
	if (!func_22(iParam0))
	{
		return 7;
...
bool func_130(int iParam0)//Position - 0x4D3C
{
	int iVar0;
	bool bVar1;
...
int func_131(float fParam0, bool bParam1)//Position - 0x4D9A
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_132(int iParam0, var uParam1)//Position - 0x4E51
{
	switch (iParam0)
	{
		case 0:
...
int func_134(int iParam0)//Position - 0x6129
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_135(int iParam0)//Position - 0x646F
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_136(int iParam0)//Position - 0x64A7
{
	struct<2> Var0;
...
int func_137()//Position - 0x68F4
{
	func_20();
	return Global_19B04.f_932.f_21B.f_10CD;
}

int func_138()//Position - 0x690D
{
	int iVar0;
...
bool func_140()//Position - 0x6983
{
	return Global_199EA > 0;
}

int func_141()//Position - 0x6991
{
	if (Global_15FA6 != -1)
	{
		return 1;
...
void func_145(int iParam0)//Position - 0x6A04
{
	char cVar0[64];
	...
	if (func_156())
	{
		...
		func_148(30000);
		StringCopy(&cVar0, func_147(Global_19AF9, 1), 64);
	...
	func_146(&Global_62F8);
	Global_19AFA = 0;
	func_82(-1);
}

void func_146(var uParam0)//Position - 0x6AB9
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_147(int iParam0, bool bParam1)//Position - 0x6AF6
{
	switch (iParam0)
	{
		case 0:
...
void func_148(int iParam0)//Position - 0x6D3F
{
	Global_8E68 = (unk_0x105601648511CC64() + iParam0);
}

void func_149(int iParam0)//Position - 0x6D51
{
	func_150(iParam0, 0, func_155(iParam0));
}

void func_150(int iParam0, int iParam1, int iParam2)//Position - 0x6D66
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_151(var uParam0)//Position - 0x6D95
{
	struct<16> Var0;
	int iVar1;
...
void func_152(int iParam0, var uParam1)//Position - 0x6E66
{
	Global_19B04.f_6186.f_2B[iParam0] = *uParam1;
}

void func_153(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x6E7E
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_154(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7000
{
...
int func_155(int iParam0)//Position - 0x7038
{
	int iVar0;
