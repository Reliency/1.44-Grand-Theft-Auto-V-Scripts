	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_282(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_264(&Var0, 1);
	}
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6140
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6187
{
...
bool func_70(int iParam0)//Position - 0x61E2
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x61F2
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x6252
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6546
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x6551
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6561
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6603
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6BBD
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6C1B
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6CC9
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6D5E
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6DA2
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6F26
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6F34
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x79FB
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7A7D
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7ADB
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7AE4
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7CB7
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7CC7
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7F61
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x7F72
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7FB8
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x803F
{
...
void func_94(var uParam0, int iParam1)//Position - 0x8072
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x80C3
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x8165
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x818A
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x81A1
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x81AE
{
...
void func_100(var uParam0, int iParam1)//Position - 0x81E8
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8223
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x825F
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x8278
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x82D1
{
...
bool func_105(bool bParam0)//Position - 0x8313
{
...
struct<2> func_106(int iParam0)//Position - 0x833E
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x878B
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9A63
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9DA9
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9E4D
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9EE8
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9F46
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9F9F
{
...
int func_116(int iParam0)//Position - 0xA022
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA053
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA068
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA11B
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA136
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA182
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA1CB
{
	if (func_124(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA1EB
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA20C
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA2DC
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA32F
{
	int iVar0;
...
void func_130(bool bParam0)//Position - 0xA48F
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA4CC
{
	if (bParam0)
	{
...
int func_134(int iParam0, bool bParam1)//Position - 0xA65D
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA69E
{
...
bool func_136()//Position - 0xA6E0
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA6F1
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA74B
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA76E
{
...
void func_141()//Position - 0xA7AB
{
	Global_394A = 0;
	func_142();
}

void func_142()//Position - 0xA7BB
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA8A1
{
...
void func_147(int iParam0)//Position - 0xAA30
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAAAD
{
...
void func_150(int iParam0)//Position - 0xAAD6
{
	if (Global_3943)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAB46
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xABBA
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAC14
{
...
int func_154(int iParam0)//Position - 0xAC55
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAC9A
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xACCC
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAE03
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAE52
{
	return func_159(iParam0, Global_8C41);
}

int func_159(int iParam0, int iParam1)//Position - 0xAE63
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xB044
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_161()//Position - 0xB066
{
	return func_162(unk_0x1377080E9B0BD993(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB077
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_165(int iParam0, int iParam1)//Position - 0xB185
{
	if (func_123(iParam0))
	{
...
float func_166(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xB1B8
{
	vector3 vVar0;
...
int func_167(int iParam0)//Position - 0xB1F2
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_175()) || Global_1974B) || Global_62BF) || func_174()) || func_173(8, -1)) || func_90()) || func_172()) || func_171()) || func_170()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_175()) || Global_62BF) || func_174()) || func_173(8, -1)) || func_171()) || func_90()) || func_172()) || func_170()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_175()) || Global_1974B) || Global_62BF) || func_174()) || func_173(8, -1)) || func_171()) || func_90()) || func_172()) || func_170()) || Global_19B04.f_1DEB.f_397[iVar0] == 5) || Global_8E64 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_175()) || Global_1974B) || Global_62BF) || func_174()) || func_173(8, -1)) || func_90()) || func_172()) || func_170()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_175() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_173(8, -1)) || func_170()) || func_169()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_175()) || Global_62BF) || func_174()) || func_173(8, -1)) || func_172()) || func_171()) || func_170()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || !unk_0x8CC5A4A5615C6420(unk_0xB5CEFD608600A09F())) || !unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F())) || !unk_0x726D9204B160D23E()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || func_175()) || func_172()) || Global_1974B) || Global_62BF) || func_174()) || Global_90C1) || func_173(8, -1)) || func_171()) || func_169()) || func_170()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_168()//Position - 0xB90F
{
	return Global_16B42.f_1;
}

int func_169()//Position - 0xB91D
{
	if (Global_15FA6 != -1)
	{
...
bool func_172()//Position - 0xB987
{
	return Global_16B4F.f_142 > 0;
}

bool func_173(int iParam0, int iParam1)//Position - 0xB998
{
	switch (iParam0)
	{
		case 5:
...
var func_174()//Position - 0xB9D3
{
	return Global_140856;
}

int func_175()//Position - 0xB9DF
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
int func_176(int iParam0, int iParam1)//Position - 0xB9FB
{
	switch (iParam0->f_10)
	{
		case 0:
				...
				if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					if (func_124(iParam0->f_1C[0]))
					{
						if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0->f_1C[0], true), true) < 3f)
						{
							if (func_167(2))
							{
								if (func_180(iParam0->f_1B))
								{
									func_179(iParam0->f_1B, *iParam0);
...
void func_177()//Position - 0xC1E0
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_178(var uParam0)//Position - 0xC1FB
{
	float fVar0;
...
void func_179(int iParam0, int iParam1)//Position - 0xC289
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_180(bool bParam0)//Position - 0xC2ED
{
	int iVar0;
...
int func_181(int iParam0)//Position - 0xC384
{
	if (func_124(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_182(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC3AE
{
	var uVar0;
	
	if ((((func_124(unk_0xBC25C936A095B5BA()) && func_124(iParam0->f_1C[0])) && !func_143()) && (unk_0x105601648511CC64() - iParam0->f_3C) > iParam6) && func_166(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_183(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC436
{
...
void func_184(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC471
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_185(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC4C7
{
...
void func_186(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC562
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_166(unk_0xBC25C936A095B5BA(), vParam2, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_166(unk_0xBC25C936A095B5BA(), vParam2, 1) > 120f)
				{
					func_191(iParam0);
				}
			}
...
void func_187(int iParam0, bool bParam1)//Position - 0xC653
{
	if (iParam0 == -1)
	{
		return;
...
int func_188(int iParam0)//Position - 0xC68F
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_189(int iParam0, int iParam1)//Position - 0xC6C8
{
	bool bVar0;
	int iVar1;
...
bool func_190()//Position - 0xC766
{
	return Global_16129;
}

void func_191(int iParam0)//Position - 0xC772
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_192(iParam0);
...
void func_192(int iParam0)//Position - 0xC789
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_193(int iParam0)//Position - 0xC871
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_194(var uParam0, bool bParam1)//Position - 0xC899
{
	struct<27> Var0;
	...
	if ((func_231(*uParam0) || func_229(*uParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
...
void func_195(int iParam0, var uParam1, int iParam2)//Position - 0xCB0C
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_197(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_197(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_196(int iParam0)//Position - 0xCE64
{
...
int func_197(var uParam0)//Position - 0xCE84
{
...
int func_198(var uParam0)//Position - 0xCE9C
{
...
void func_199(var uParam0)//Position - 0xCEC1
{
	int iVar0;
	int iVar1;
...
void func_200(int iParam0)//Position - 0xD1C5
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_201(var uParam0)//Position - 0xD1F0
{
	int iVar0;
...
int func_202(var uParam0, bool bParam1, bool bParam2)//Position - 0xD270
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_203(int iParam0, int iParam1)//Position - 0xD42E
{
	int iVar0;
...
int func_204(var uParam0, bool bParam1, int iParam2)//Position - 0xD45E
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0)//Position - 0xD71A
{
...
int func_206(int iParam0, float fParam1)//Position - 0xD74E
{
	float fVar0;
...
bool func_207(int iParam0, float fParam1)//Position - 0xD7C4
{
	return func_208(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_208(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD7DC
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_209(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD89D
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_210(int iParam0, int iParam1)//Position - 0xD9C9
{
	int iVar0;
...
int func_212(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDAD8
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_213(vector3 vParam0, vector3 vParam1)//Position - 0xDB69
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_214(vector3 vParam0)//Position - 0xDB8A
{
	float fVar0;
	float fVar1;
...
void func_215(var uParam0)//Position - 0xDBC9
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_216(int iParam0, int iParam1)//Position - 0xDBE4
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0xDC23
{
...
int func_218(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDC4B
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_219(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDD46
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_220(int iParam0, float fParam1)//Position - 0xDE52
{
	var uVar0;
	vector3 vVar1;
...
int func_221(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xDEE7
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_222(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDF75
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_223(int iParam0)//Position - 0xDFBD
{
...
void func_224(int iParam0)//Position - 0xE007
{
	int iVar0;
...
int func_225(int iParam0)//Position - 0xE0A4
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_226(int iParam0)//Position - 0xE13C
{
...
int func_229(int iParam0)//Position - 0xE1BE
{
	if ((func_230() && Global_16B1B.f_B == 6) && iParam0 == func_162(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_231(int iParam0)//Position - 0xE230
{
	if (func_105(0))
	{
...
int func_234(var uParam0)//Position - 0xE2A5
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_250(&(uParam0->f_30), "rcmcollect_paperleadinout@", "meditiate_idle", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			{
				if (!func_245(&(uParam0->f_1C[0]), 68, -1459.68f, 485.26f, 116.22f, -131.3f, "DREYFUSS LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_243(&(uParam0->f_23[0]), iVar0[1], vLocal_54, fLocal_55);
				if (func_124(uParam0->f_23[0]))
				{
					unk_0x6012A6A4F2950585(uParam0->f_23[0], 1);
					unk_0xEA0AB6C644C58C1D(uParam0->f_23[0], "DR3YFU55");
					unk_0x8510BC031C24B862(iLocal_53, true);
				}
			}
			if (bVar2)
			{
...
void func_235(bool bParam0)//Position - 0xE4BF
{
...
void func_236(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xE511
{
	if (iParam0 != 198)
	{
		if (Global_11542)
...
void func_237(int iParam0, int iParam1)//Position - 0xE56C
{
	switch (iParam0)
	{
		case 12:
...
void func_238(int iParam0, bool bParam1)//Position - 0xE655
{
	if (bParam1)
	{
...
bool func_239(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0xE67E
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_241()//Position - 0xF016
{
	return Global_62BE;
}

int func_242(var uParam0, int iParam1)//Position - 0xF021
{
	int iVar0;
...
void func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x12860
{
	func_244(iParam0);
...
void func_244(int iParam0)//Position - 0x128A2
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_245(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0x1293E
{
...
int func_246(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x1299A
{
	int iVar0;
...
int func_247(var uParam0, int iParam1)//Position - 0x12A28
{
	int iVar0;
...
int func_248(var uParam0)//Position - 0x12A6E
{
	if (func_198(uParam0))
	{
...
int func_249(int iParam0)//Position - 0x12A98
{
	int iVar0;
...
void func_250(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x12AC9
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_251(int iParam0)//Position - 0x12B05
{
	struct<27> Var0;
	int iVar1;
...
int func_252(int iParam0)//Position - 0x12B59
{
	char* sVar0;
...
int func_253(int iParam0)//Position - 0x12C12
{
	var uVar0;
...
int func_254(int iParam0)//Position - 0x12CD3
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_255(int iParam0, char* sParam1)//Position - 0x12D58
{
...
bool func_256(int iParam0)//Position - 0x12E3A
{
...
bool func_257(int iParam0)//Position - 0x12E68
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_258(int iParam0)//Position - 0x12E96
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_259(int iParam0)//Position - 0x12EC4
{
	if (func_226(iParam0))
	{
		return 0;
...
void func_260()//Position - 0x12EF9
{
	func_283("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_261(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x12F13
{
	int iVar0;
...
int func_262(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0x12F78
{
	int iVar0;
	struct<7> Var1;
...
int func_263(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x12FF6
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_264(int iParam0, bool bParam1)//Position - 0x13071
{
	char* sVar0;
	...
	func_265(sVar0);
	unk_0x8510BC031C24B862(iLocal_53, false);
...
void func_265(char* sParam0)//Position - 0x130F6
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
		if (func_268(sParam0))
...
void func_266()//Position - 0x13115
{
	Global_394A = 0;
	func_267();
}

void func_267()//Position - 0x13125
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
int func_268(char* sParam0)//Position - 0x13146
{
	struct<6> Var0;
...
struct<6> func_269()//Position - 0x13166
{
	struct<6> Var0;
...
int func_270(var uParam0)//Position - 0x1318A
{
	if (func_198(uParam0))
	{
		if (unk_0xF9E082857622D91E(*uParam0))
...
void func_271(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x131C0
{
...
void func_272(var uParam0, bool bParam1)//Position - 0x131E0
{
	func_273(&(uParam0->f_29), bParam1);
}

void func_273(var uParam0, bool bParam1)//Position - 0x131F2
{
	int iVar0;
...
void func_274(int iParam0, bool bParam1)//Position - 0x13230
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_275(var uParam0, bool bParam1)//Position - 0x1326B
{
	func_276(&(uParam0->f_23), bParam1);
}

void func_276(var uParam0, bool bParam1)//Position - 0x1327D
{
	int iVar0;
...
void func_277(int iParam0)//Position - 0x132BA
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_278(var uParam0, int iParam1)//Position - 0x132F2
{
	func_279(&(uParam0->f_1C), iParam1);
}

void func_279(var uParam0, int iParam1)//Position - 0x13304
{
	int iVar0;
...
void func_280(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x13345
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_281(int iParam0)//Position - 0x13395
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_282(var uParam0)//Position - 0x133D6
{
	if (*uParam0 == -1)
	{
		return;
...
void func_283(char* sParam0)//Position - 0x13413
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_284(var uParam0)//Position - 0x13425
{
	*uParam0 = -1;
...
void func_285()//Position - 0x13458
{
	func_283("Running start routines.");
	Global_199EA++;
}

int func_286(int iParam0)//Position - 0x13472
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
