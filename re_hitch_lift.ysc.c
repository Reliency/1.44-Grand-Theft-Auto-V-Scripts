...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_43 = 64;
	fLocal_45 = -1f;
	iLocal_53 = unk_0xD736C0AC62BF73AD();
	iLocal_54 = unk_0x880E0FAC08C6FA65();
	...
	if (unk_0xE8A79675302ED812(11))
	{
		...
		{
			if (unk_0xD45C08B05D4687A7(iLocal_71))
			{
				unk_0x57EB4CC8F1928A47(iLocal_71);
			}
		}
		func_245();
	}
	...
	{
		SYSTEM::WAIT(0);
		if (unk_0x684B06333594F9EA() || iLocal_89)
		{
			if (!func_212())
			{
				if (func_211())
						...
						switch (iLocal_56)
						{
							case 0:
								...
								switch (iLocal_57)
								{
									...
									case 9:
										if (!unk_0x36CEFBE9B745A58D(iLocal_71))
										{
											if (unk_0x4DBCE270B354E123(iLocal_71, vLocal_77, 200f, 200f, 200f, false, true, 0))
											{
												unk_0x346129B364057FF6(iLocal_71, vLocal_77, 1f, -1, 1048576000, 0, 1193033728);
											}
											else
											{
												unk_0x8CE2798B9A7027EC(iLocal_71, 1193033728, 0);
											}
								...
								if ((func_52() && !func_51()) && iLocal_57 != 10)
								{
									if (!unk_0x36CEFBE9B745A58D(iLocal_71))
									{
										if (unk_0x4DBCE270B354E123(iLocal_71, vLocal_79, 5f, 5f, 5f, false, true, 0))
										{
											func_50(0);
											SYSTEM::WAIT(0);
											func_48();
								...
								if (func_47())
								{
									...
									{
										unk_0xF845620A03C7425B(&iLocal_71);
									}
									func_18();
								}
								break;
							...
							case 1:
								...
								if (!unk_0x36CEFBE9B745A58D(iLocal_71))
								{
									...
									unk_0x5558ED6D4A2DEC93(iLocal_71, unk_0xBC25C936A095B5BA(), 1000f, -1, 0, 0);
									unk_0x22321800954A532E(iLocal_71, true);
									func_53();
								}
								break;
		...
		if (iLocal_57 > 2)
		{
			if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
			{
				if (unk_0x724D816EA203A79E(iLocal_71))
				{
					if (!unk_0x36CEFBE9B745A58D(iLocal_71))
					{
						if (!unk_0xE642C1AC73CE364E(iLocal_71, unk_0xBC25C936A095B5BA(), 100f, 100f, 100f, 0, 1, 0))
						{
							func_53();
						}
					}
		...
		if (iLocal_57 > 0 && iLocal_57 < 8)
		{
			if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
			{
				...
				else if (!unk_0x2CDE18D6C89522AD(iLocal_71))
				{
					if (unk_0xD9C1758D86688CEA(iLocal_71, unk_0xBC25C936A095B5BA(), 0))
					{
						unk_0xA4E856A8CD53B8DF(iLocal_71);
						unk_0x5558ED6D4A2DEC93(iLocal_71, unk_0xBC25C936A095B5BA(), 250f, -1, 0, 0);
						func_53();
					}
				}
			}
...
void func_25()//Position - 0x104A
{
	...
	{
		func_27(13, SYSTEM::FLOOR(Global_19B04.f_27B5.f_F0D));
	}
...
int func_29()//Position - 0x1A76
{
	return Global_1407E0;
}

int func_30(int iParam0, int iParam1)//Position - 0x1A82
{
	switch (iParam0)
	{
		case 0:
...
int func_31(int iParam0)//Position - 0x1DF6
{
	switch (iParam0)
	{
		case 29:
...
void func_32(int iParam0)//Position - 0x1E25
{
	int iVar0;
	int iVar1;
...
void func_33(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1E67
{
	func_34(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_34(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1E87
{
	int iVar0;
...
int func_37(int iParam0)//Position - 0x21BF
{
	int iVar0;
	int iVar1;
...
void func_38(int iParam0, int iParam1)//Position - 0x2202
{
	unk_0xF0059F27F7BB6680(&(Global_19B04.f_6186.f_8[iParam0]), iParam1);
}

int func_39(int iParam0)//Position - 0x221D
{
	int iVar0;
...
int func_41(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x22EB
{
...
void func_42(int iParam0, int iParam1, int iParam2)//Position - 0x24C5
{
	int iVar0;
	int iVar1;
...
void func_43(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x25B5
{
	int iVar0;
	...
	iVar0 = Global_269BC5[iParam0 /*3*/][func_44(iParam2)];
	if (iVar0 != 0)
	{
...
int func_44(int iParam0)//Position - 0x25E5
{
	int iVar0;
	int iVar1;
...
int func_45(int iParam0, int iParam1, int iParam2)//Position - 0x2619
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_269BC5[iParam0 /*3*/][func_44(iParam1)];
...
void func_48()//Position - 0x266C
{
	Global_394A = 0;
	func_49();
}

void func_49()//Position - 0x267C
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
void func_50(int iParam0)//Position - 0x269D
{
	Global_41AB = iParam0;
}

int func_51()//Position - 0x26AA
{
...
bool func_52()//Position - 0x26C6
{
	return Global_63A8;
}

void func_53()//Position - 0x26D1
{
	func_55();
	while (func_54())
	{
...
void func_55()//Position - 0x2712
{
	Global_394A = 0;
	func_56();
}

void func_56()//Position - 0x2722
{
	if (unk_0xE6711F601F11B66B())
	{
		unk_0x5C7DC611411E2CF9();
...
void func_57()//Position - 0x2746
{
	struct<6> Var0;
	
	if (!unk_0x36CEFBE9B745A58D(iLocal_72) && !unk_0x36CEFBE9B745A58D(iLocal_71))
	{
		if (!unk_0xE642C1AC73CE364E(unk_0xBC25C936A095B5BA(), iLocal_72, 25f, 25f, 25f, 0, 1, 0) && !unk_0xE642C1AC73CE364E(unk_0xBC25C936A095B5BA(), iLocal_71, 40f, 40f, 40f, 0, 1, 0))
		{
			unk_0xA4E856A8CD53B8DF(iLocal_72);
			unk_0x346129B364057FF6(iLocal_72, vLocal_77, 1f, -1, 1048576000, 0, 1193033728);
			func_18();
		}
	}
	if (!unk_0x36CEFBE9B745A58D(iLocal_72))
	...
	if (!unk_0x36CEFBE9B745A58D(iLocal_71))
	{
		if (unk_0x2CDE18D6C89522AD(iLocal_71))
		{
			unk_0xD999D66C5AFA4BE3(iLocal_71);
		}
		if (unk_0x36CEFBE9B745A58D(iLocal_72) && unk_0x4DBCE270B354E123(iLocal_71, unk_0x541C2AEF053615BC(iLocal_72, false), 1f, 1f, 5f, false, true, 0))
		{
			iLocal_127 = 5;
		}
	}
	else if (!unk_0x36CEFBE9B745A58D(iLocal_72))
	{
	...
	if (!iLocal_136)
	{
		if (unk_0x36CEFBE9B745A58D(iLocal_72))
		{
			if (unk_0x2DA8CA50A72528FB(iLocal_100))
			{
				unk_0x07B8ECB35A4ED3AC(&iLocal_100);
			}
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				iLocal_127 = 3;
	...
	if (!iLocal_138)
	{
		if (!unk_0x36CEFBE9B745A58D(iLocal_71) && !unk_0x36CEFBE9B745A58D(iLocal_72))
		{
		...
		if (unk_0x36CEFBE9B745A58D(iLocal_72))
		{
			...
			if (unk_0xD9C1758D86688CEA(iLocal_72, unk_0xBC25C936A095B5BA(), 1) && unk_0x72C9157015C2151B(unk_0xBC25C936A095B5BA(), 6))
			{
				iLocal_127 = 2;
			}
		}
		else if (!unk_0x1D403DFADBC2DE3C(iLocal_71, 0))
		{
			if (unk_0xD9C1758D86688CEA(iLocal_71, iLocal_72, 1))
			{
				iLocal_127 = 2;
			}
		}
	...
	switch (iLocal_127)
	{
		case 0:
			if (!iLocal_136)
			{
				if (!unk_0x36CEFBE9B745A58D(iLocal_71) && !unk_0x36CEFBE9B745A58D(iLocal_72))
				{
					if (!unk_0x5237AF95232D78C5(iLocal_71, 0) && unk_0xABB2AFD7539464EA(iLocal_72))
					{
						if (!iLocal_137)
						{
							unk_0xC5A6DFE2B8987B17(&iLocal_75);
							unk_0x56F2E1B5599188FA(0, iLocal_72, -1, 2052, 2);
							unk_0xE896C0AD02364F2A(0, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 49, 0, 0, 0, 0);
							unk_0x85DB484A637CEAB9(0, iLocal_72, -1);
							unk_0x535008C596714F9E(iLocal_75);
							unk_0xA8E6405305C0D7DF(iLocal_71, iLocal_75);
							unk_0x02DAF06EA4F08219(&iLocal_75);
							iLocal_137 = 1;
						}
					}
				}
		...
		case 1:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				unk_0xA3981DED4FC2E56E(iLocal_71, 0, 0);
				SYSTEM::SETTIMERB(0);
				iLocal_127 = 0;
			}
			break;
			...
			if (!iLocal_138)
			{
				if (!unk_0x36CEFBE9B745A58D(iLocal_71))
				{
					...
					if (!unk_0x36CEFBE9B745A58D(iLocal_71))
					{
						...
						if (!unk_0x36CEFBE9B745A58D(iLocal_72))
						{
							unk_0xAB1A796DCD561BF8(iLocal_72, 6, 0f, 0);
							unk_0x5558ED6D4A2DEC93(iLocal_72, unk_0xBC25C936A095B5BA(), 1000f, -1, 0, 0);
						}
					}
					func_18();
		...
		case 3:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				...
				if (!unk_0x36CEFBE9B745A58D(iLocal_71))
				{
					unk_0xAB1A796DCD561BF8(iLocal_71, 7, 0f, 0);
				}
				func_1(&uLocal_161, cLocal_146, "REHH3_BAS", 4, 0, 0, 0);
				if (!unk_0x36CEFBE9B745A58D(iLocal_71) && unk_0x724D816EA203A79E(iLocal_72))
				{
					unk_0xA4E856A8CD53B8DF(iLocal_71);
					unk_0xC5A6DFE2B8987B17(&iLocal_75);
					unk_0x44C98C11ED6DD327(0);
					unk_0xE896C0AD02364F2A(0, "random@hitch_lift", "f_distressed_loop", 2f, -2f, -1, 49, 0, 0, 0, 0);
					unk_0x56F2E1B5599188FA(0, iLocal_72, -1, 2052, 4);
					unk_0x346129B364057FF6(0, unk_0x541C2AEF053615BC(iLocal_72, false), 1f, -1, 3f, 0, 1193033728);
					unk_0x85DB484A637CEAB9(0, iLocal_72, -1);
		...
		case 4:
			if (func_58())
			{
				if (!unk_0x36CEFBE9B745A58D(iLocal_71))
				{
					if (unk_0xE642C1AC73CE364E(iLocal_71, unk_0xBC25C936A095B5BA(), 15f, 15f, 15f, 0, 1, 0))
					{
...
void func_59(var uParam0, int iParam1)//Position - 0x2CDD
{
...
struct<6> func_60()//Position - 0x2CFA
{
	struct<6> Var0;
	int iVar1;
...
void func_62()//Position - 0x2D6B
{
	if (unk_0x2DA8CA50A72528FB(iLocal_69))
	{
		unk_0x07B8ECB35A4ED3AC(&iLocal_69);
	}
	if (unk_0x2DA8CA50A72528FB(iLocal_70))
	{
		unk_0x07B8ECB35A4ED3AC(&iLocal_70);
	}
	if (iLocal_58 == 1)
	{
		unk_0x38FF8CB6377D36F6(iLocal_145);
		...
		if (!iLocal_102)
		{
			...
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				...
				func_81(198, 0);
				unk_0x56F2E1B5599188FA(unk_0xBC25C936A095B5BA(), iLocal_71, 8000, 2052, 4);
				unk_0xC5A6DFE2B8987B17(&iLocal_75);
				...
				unk_0xDF14F570C0180463(0, -1046.832f, -2518.146f, 12.9447f, 2f, -1, 1193033728, 0.5f);
		...
		if (unk_0x724D816EA203A79E(iLocal_71) || SYSTEM::TIMERB() > 15000)
		{
			if (unk_0x4DBCE270B354E123(iLocal_71, -1046.832f, -2518.146f, 12.9447f, 20f, 20f, 5f, false, true, 0) || SYSTEM::TIMERB() > 15000)
			{
				unk_0xF845620A03C7425B(&iLocal_71);
				func_18();
			}
	...
	else if (iLocal_58 == 2)
	{
		...
		if (!unk_0x36CEFBE9B745A58D(iLocal_71))
		{
			if (!unk_0x2CDE18D6C89522AD(iLocal_71))
			{
				...
				unk_0x346129B364057FF6(0, 3323.43f, 5166.832f, 17.406f, 1f, -1, 1048576000, 0, 1193033728);
				unk_0x346129B364057FF6(0, 3320.684f, 5186.017f, 17.4016f, 1f, -1, 1048576000, 0, 1193033728);
				unk_0x346129B364057FF6(0, 3303.612f, 5185.269f, 18.7155f, 1f, -1, 1048576000, 0, 1193033728);
				unk_0xA3A7138EAD2268A0(0, "WORLD_HUMAN_STAND_MOBILE", 0, 1);
				unk_0x535008C596714F9E(iLocal_75);
				unk_0xA8E6405305C0D7DF(iLocal_71, iLocal_75);
				unk_0x02DAF06EA4F08219(&iLocal_75);
				unk_0x22321800954A532E(iLocal_71, true);
				unk_0x56F2E1B5599188FA(unk_0xBC25C936A095B5BA(), iLocal_71, 5000, 2052, 2);
				unk_0x57EB4CC8F1928A47(iLocal_71);
				SYSTEM::WAIT(1000);
				unk_0xDDCAA2E64649E083(unk_0xB5CEFD608600A09F(), true, 0);
				if (func_8() == 0)
		...
		if (SYSTEM::TIMERA() > 1000)
		{
			if (func_1(&uLocal_161, cLocal_146, "REHH3_JB", 4, 0, 0, 0))
			{
				if (!unk_0x36CEFBE9B745A58D(iLocal_72))
				{
					...
					unk_0x535008C596714F9E(iLocal_75);
					unk_0xA8E6405305C0D7DF(iLocal_72, iLocal_75);
					unk_0x02DAF06EA4F08219(&iLocal_75);
					unk_0x22321800954A532E(iLocal_72, true);
					unk_0x2E35C4FA5F0ED22F(iLocal_72, false);
					unk_0xDDCAA2E64649E083(unk_0xB5CEFD608600A09F(), true, 0);
					unk_0xB2CB6EAA6B280A84("rghBoyfriend", &iLocal_160);
					unk_0x4106FAF8AA1D69D5(iLocal_72, iLocal_160);
					unk_0xA902E18EDF6FA0C8(4, -1533126372, iLocal_160);
					unk_0xA902E18EDF6FA0C8(1, -183807561, iLocal_160);
					unk_0xA902E18EDF6FA0C8(1, iLocal_160, -183807561);
					SYSTEM::SETTIMERA(0);
					iLocal_57 = 7;
				}
			}
	...
	else if (iLocal_58 == 5)
	{
		...
		if (!unk_0x36CEFBE9B745A58D(iLocal_71))
		{
			...
			unk_0x346129B364057FF6(0, -346.029f, 632.2272f, 171.2525f, 1f, -1, 1048576000, 0, 1193033728);
			unk_0x346129B364057FF6(0, -346.6342f, 627.3992f, 170.3573f, 1f, -1, 1048576000, 0, 1193033728);
			unk_0x346129B364057FF6(0, -355.2473f, 622.1964f, 170.3572f, 1f, -1, 1048576000, 0, 1193033728);
			unk_0x346129B364057FF6(0, -355.6499f, 615.3431f, 170.3572f, 1f, -1, 1048576000, 0, 1193033728);
			unk_0x346129B364057FF6(0, -350.163f, 605.0463f, 170.7292f, 1f, -1, 1048576000, 0, 1193033728);
			unk_0x346129B364057FF6(0, -333.177f, 594.991f, 170.7553f, 1f, -1, 1048576000, 0, 1193033728);
...
int func_63(int iParam0, bool bParam1, int iParam2)//Position - 0x33F7
{
	int iVar0;
...
int func_64(int iParam0, bool bParam1, bool bParam2)//Position - 0x3449
{
	int iVar0;
	...
	{
		unk_0x3F5F1772D71D5EC4(iVar0, func_65(unk_0x7AF0088ABFA713B6(), 1f, 1f));
		if (!bParam2)
		{
	...
	{
		unk_0x3F5F1772D71D5EC4(iVar0, func_65(unk_0x7AF0088ABFA713B6(), 0.7f, 0.7f));
		unk_0xF9C2945DB5BAB4BF(iVar0, bParam1);
	}
...
float func_65(bool bParam0, float fParam1, float fParam2)//Position - 0x34ED
{
	if (bParam0)
	{
		return fParam1;
...
void func_66(int iParam0, bool bParam1, int iParam2)//Position - 0x3504
{
	bool bVar0;
	int iVar1;
	...
	if (bParam1)
	{
		if (!bVar0)
		{
			...
			switch (iParam2)
			{
				...
				case 6:
				case 7:
					unk_0xF0059F27F7BB6680(&(Global_200000[func_73() /*12171*/].f_1E08.f_4F8), iParam0);
					func_70(15, 0);
					break;
			}
			func_69(iVar1);
...
void func_67(int iParam0, int iParam1)//Position - 0x3628
{
...
void func_68(int iParam0, int iParam1)//Position - 0x366B
{
	if (iParam1 > -1)
	{
...
void func_69(int iParam0)//Position - 0x36A8
{
	if (iParam0 != -1)
	{
...
void func_70(int iParam0, int iParam1)//Position - 0x36DF
{
	int iVar0;
...
int func_72(int iParam0, var uParam1)//Position - 0x3737
{
	if (Global_14084A)
	{
		return 0;
...
void func_74(int iParam0, int iParam1, bool bParam2)//Position - 0x37CA
{
	Global_BE9 = iParam0;
	if (Global_75[iParam0 /*10*/].f_8 != 144)
	{
...
void func_76(int iParam0, int iParam1)//Position - 0x39F1
{
	Global_19B04.f_F3[func_80() /*53*/].f_2[iParam0 /*5*/].f_1 = iParam1;
}

int func_77(int iParam0, int iParam1)//Position - 0x3A0F
{
...
int func_78(int iParam0)//Position - 0x3A34
{
	switch (iParam0)
	{
		case 0:
...
int func_79(int iParam0)//Position - 0x3AD1
{
	switch (iParam0)
	{
		case 0:
...
void func_81(int iParam0, int iParam1)//Position - 0x3BBB
{
...
void func_82(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x3BF8
{
	int iVar0;
	int iVar1;
...
int func_83(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x3CDF
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_84(bool bParam0)//Position - 0x42E5
{
	int iVar0;
	int iVar1;
...
void func_85(int iParam0)//Position - 0x4567
{
	int iVar0;
...
void func_86(int iParam0)//Position - 0x45C1
{
	bool bVar0;
	char cVar1[64];
	...
	else if (unk_0xFA30DFD0084E92FE(Global_19B04.f_5037.f_1D7, iParam0) || unk_0xFA30DFD0084E92FE(Global_200000[func_73() /*12171*/].f_1E08.f_A, iParam0))
	{
		bVar0 = true;
		unk_0x7CB6FD92BE491AD9(&(Global_19B04.f_5037.f_1D7), iParam0);
		unk_0x7CB6FD92BE491AD9(&(Global_200000[func_73() /*12171*/].f_1E08.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_87(int iParam0)//Position - 0x4696
{
	switch (iParam0)
	{
		case 0:
...
void func_88(int iParam0)//Position - 0x471C
{
	func_108(93, iParam0);
	func_108(29, iParam0);
	func_108(30, iParam0);
...
bool func_89(int iParam0)//Position - 0x473C
{
	if (iParam0 == 8)
	{
	...
	return unk_0xFA30DFD0084E92FE(Global_200000[func_73() /*12171*/].f_1E08.f_A, iParam0);
}

int func_90(int iParam0, int iParam1, int iParam2)//Position - 0x478A
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_91(int iParam0)//Position - 0x47C7
{
	int iVar0;
...
int func_92(int iParam0, int iParam1)//Position - 0x4AB3
{
	int iVar0;
...
int func_93(bool bParam0)//Position - 0x4D75
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_94(int iParam0, int iParam1)//Position - 0x4E2C
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_95(int iParam0, int iParam1)//Position - 0x4E47
{
	...
	if (func_105(&Global_411EB6))
	{
		if (func_103(&Global_411EB6, iParam0))
		{
			return 0;
		}
		if (func_96(&Global_411EB6, iParam0))
		{
			return 1;
		}
	}
...
int func_96(var uParam0, int iParam1)//Position - 0x4EE4
{
	int iVar0;
	var uVar1[78];
...
int func_97(var uParam0, int iParam1)//Position - 0x4F95
{
	int iVar0;
...
bool func_98(var uParam0, int iParam1)//Position - 0x5010
{
	return (*uParam0)[iParam1] == 78;
}

void func_99(var uParam0)//Position - 0x5021
{
	int iVar0;
	...
	func_101(uParam0, (Global_411EB5 - 0.5f));
}

void func_100(var uParam0, int iParam1)//Position - 0x5055
{
	(*uParam0)[iParam1] = 78;
}

void func_101(var uParam0, float fParam1)//Position - 0x5065
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_102(var uParam0)//Position - 0x5082
{
	return uParam0->f_50;
}

bool func_103(var uParam0, int iParam1)//Position - 0x508E
{
	return func_104(uParam0, iParam1) != -1;
}

int func_104(var uParam0, int iParam1)//Position - 0x50A0
{
	int iVar0;
...
bool func_105(var uParam0)//Position - 0x50CD
{
	return uParam0->f_4F == 1;
}

int func_106(int iParam0)//Position - 0x50DB
{
	switch (iParam0)
	{
		case 60:
...
void func_107(int iParam0, int iParam1)//Position - 0x512B
{
	int iVar0;
...
void func_108(int iParam0, int iParam1)//Position - 0x514E
{
	int iVar0;
	...
	if (!unk_0x36CEFBE9B745A58D(iLocal_71))
	{
		if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 1))
		{
			if (!func_117())
			{
				...
				if (unk_0xF4FCC3C1048FF2AB(iLocal_71, 1227113341) != 1 && unk_0xF4FCC3C1048FF2AB(iLocal_71, 1227113341) != 0)
				{
					unk_0x9565F9267674873A(iLocal_71, unk_0xBC25C936A095B5BA(), -1, 6f, 2f, 1073741824, 0);
				}
		...
		else if (!unk_0xD45C08B05D4687A7(iLocal_71))
		{
			unk_0x75E3FA28CC7D5707(iLocal_71, func_111());
			unk_0x0AB3C2863B144B82(iLocal_71, 1);
			unk_0x59B9712C1EAB0092(iLocal_71, 0);
		}
	}
}

int func_111()//Position - 0x53E7
{
	return unk_0x705BBFE5A8ADE4A9(unk_0xFC1CAE18F3ECBF2D());
}

void func_112(bool bParam0)//Position - 0x53F7
{
	if (bParam0)
	{
		if (iLocal_105)
	...
	else if ((!iLocal_105 && unk_0xE6711F601F11B66B()) && !func_114())
	{
		Local_107 = { func_113() };
		Local_106 = { func_60() };
		func_55();
...
struct<6> func_113()//Position - 0x5452
{
	struct<6> Var0;
...
int func_115(char* sParam0)//Position - 0x5704
{
	var uVar0;
...
bool func_116(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x572C
{
	...
	if ((iLocal_122 - iLocal_120) > 50000 && !iLocal_119)
	{
		...
		if (!func_54())
		{
			...
			else if (iLocal_58 == 3)
			{
				if (!unk_0x36CEFBE9B745A58D(iLocal_71))
				{
					if (!unk_0x580F3FB55E3185B1(iLocal_71))
					{
						unk_0xD999D66C5AFA4BE3(iLocal_71);
					}
				}
...
void func_119()//Position - 0x5A5D
{
	if (!unk_0x36CEFBE9B745A58D(iLocal_71))
	{
		if (unk_0x7214F4879DF8A314(iLocal_71))
		{
			if (!iLocal_115)
			{
...
void func_120()//Position - 0x5B9D
{
	if (!unk_0x36CEFBE9B745A58D(iLocal_71))
	{
		if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
		{
			if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0) && !unk_0x62F3A07C43FFB568(iLocal_71, unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), 0))
			{
				if (!unk_0x2DA8CA50A72528FB(iLocal_99))
				{
		...
		else if (!unk_0x2DA8CA50A72528FB(iLocal_99))
		{
			iLocal_99 = func_63(iLocal_71, 0, 145);
		}
		if (((unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0) && unk_0x5237AF95232D78C5(iLocal_71, 0)) || unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_77, 50f, 50f, 50f, false, true, 0)) || unk_0xEBE910FA7CB6EAF0(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x2DA8CA50A72528FB(iLocal_69))
			{
				iLocal_69 = func_121(vLocal_77, 1);
		...
		else if (!unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_77, 50f, 50f, 50f, false, true, 0))
		{
			if (unk_0x2DA8CA50A72528FB(iLocal_69))
			{
				unk_0x07B8ECB35A4ED3AC(&iLocal_69);
...
int func_121(vector3 vParam0, bool bParam1)//Position - 0x5CD3
{
	int iVar0;
...
void func_122()//Position - 0x5CFF
{
	if (!unk_0x36CEFBE9B745A58D(iLocal_71))
	{
		if ((unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 1) && unk_0x5237AF95232D78C5(iLocal_71, 1)) || unk_0xE642C1AC73CE364E(unk_0xBC25C936A095B5BA(), iLocal_71, 5f, 5f, 5f, 0, 1, 0))
		{
			if (func_124())
			{
				func_50(0);
		...
		else if (!unk_0x580F3FB55E3185B1(iLocal_71))
		{
		...
		if (unk_0x580F3FB55E3185B1(iLocal_71))
		{
			unk_0x507D422B09687FBF(iLocal_71, 0);
		}
		if (func_123("REHH3_CHT3_7"))
		{
			unk_0x419DE08DC356F2FD(iLocal_71, 1, 1);
		}
		if (func_123("REHH3_CHT6_5"))
		{
			unk_0x419DE08DC356F2FD(iLocal_71, 0, 1);
		}
...
int func_123(char* sParam0)//Position - 0x5DEA
{
	var uVar0;
...
void func_125()//Position - 0x5E29
{
	if (!unk_0x36CEFBE9B745A58D(iLocal_71))
	{
		if (iLocal_58 == 1)
		{
			...
			{
				if (unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), unk_0x3E12B546F3F2597A(), 0) && unk_0x62F3A07C43FFB568(iLocal_71, unk_0x3E12B546F3F2597A(), 0))
				{
		...
		if (!iLocal_112)
		{
			if (!unk_0x1D403DFADBC2DE3C(unk_0x3E12B546F3F2597A(), 0))
			{
				if (!unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), unk_0x3E12B546F3F2597A(), 1) && unk_0x62F3A07C43FFB568(iLocal_71, unk_0x3E12B546F3F2597A(), 0))
				{
					func_112(0);
					func_48();
					SYSTEM::WAIT(0);
...
int func_128(vector3 vParam0)//Position - 0x628B
{
	if (func_8() == 2)
	{
		if (func_52() && !Global_63AB)
		{
			if (fLocal_45 == -1f)
			{
	...
	if (!func_54())
	{
		switch (iLocal_86)
		{
			case 0:
				...
				{
					iLocal_88 = unk_0x105601648511CC64() + 2000;
				}
				else if (iLocal_58 == 5)
				{
					iLocal_88 = unk_0x105601648511CC64();
			...
			case 1:
				if (iLocal_88 < unk_0x105601648511CC64())
				{
					if (iLocal_58 == 1)
					{
			...
			case 3:
				...
				{
					iLocal_88 = unk_0x105601648511CC64() + 500;
				}
				else if (iLocal_58 == 5)
				{
					iLocal_88 = unk_0x105601648511CC64();
			...
			case 17:
				if (iLocal_58 == 3)
				{
					iLocal_88 = unk_0x105601648511CC64() + 700;
				}
				iLocal_86++;
				break;
			...
			case 20:
				if (iLocal_58 == 3)
				{
					iLocal_88 = unk_0x105601648511CC64() + 300;
				}
				iLocal_86++;
				break;
			...
			case 22:
				if (!unk_0x36CEFBE9B745A58D(iLocal_71))
				{
					unk_0xE896C0AD02364F2A(iLocal_71, "facials@gen_female@base", "mood_sleeping_1", 2f, -2f, -1, 33, 0, 0, 0, 0);
				}
				iLocal_86++;
				break;
			}
...
void func_130()//Position - 0x71D3
{
	if (iLocal_58 != 3)
	{
		if (func_133())
		{
			...
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_77, 3f, 3f, 2f, true, true, 0) && unk_0x4DBCE270B354E123(iLocal_71, vLocal_77, Global_13, false, true, 0))
				{
					if (func_132(1, 0, 1))
					{
						func_131();
	...
	else if (bLocal_90)
	{
		...
		if (!unk_0x36CEFBE9B745A58D(iLocal_71))
		{
			if (unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), 805.501f, 1269.926f, 361.4025f, 25f, 30f, 2f, false, true, 0) || (unk_0x4DBCE270B354E123(iLocal_71, 824.8886f, 1275.671f, 359.4312f, Global_13, true, true, 0) && unk_0xE642C1AC73CE364E(iLocal_71, unk_0xBC25C936A095B5BA(), 8f, 8f, 8f, 0, 1, 0)))
			{
				func_48();
				SYSTEM::WAIT(0);
...
void func_131()//Position - 0x73BB
{
	Global_394A = 0;
	func_16();
}

int func_132(bool bParam0, bool bParam1, bool bParam2)//Position - 0x73CB
{
	int iVar0;
...
int func_133()//Position - 0x74B0
{
	if (unk_0xCBBE5AFE2CD2E9B6(unk_0xBC25C936A095B5BA()))
	{
		if (unk_0xE59B7F5A03335350(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), 0))
		{
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (unk_0x25EF720B1CAB1E23(iLocal_71, unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0)))
				{
					return 1;
				}
			}
	...
	if (unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_77, 50f, 50f, 50f, false, true, 0) && !unk_0x36CEFBE9B745A58D(iLocal_71))
	{
		if (!unk_0x5237AF95232D78C5(iLocal_71, 0))
		{
			return 1;
...
void func_134()//Position - 0x7531
{
	if (bLocal_92)
	{
		if (unk_0x724D816EA203A79E(iLocal_72))
		{
			if ((((unk_0x36CEFBE9B745A58D(iLocal_72) || !unk_0xE642C1AC73CE364E(iLocal_72, unk_0xBC25C936A095B5BA(), 150f, 150f, 150f, 0, 1, 0)) || SYSTEM::VDIST(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_77) < 250f) || SYSTEM::VDIST(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_79) < 250f) || iLocal_94)
			{
				if (unk_0x2DA8CA50A72528FB(iLocal_100))
				{
					unk_0x07B8ECB35A4ED3AC(&iLocal_100);
				...
				unk_0x02537C8C1BEEB477(&iLocal_72);
				if (unk_0x724D816EA203A79E(iLocal_139))
				{
					unk_0x1E7A09C1710FB071(&iLocal_139);
				}
				bLocal_92 = false;
			}
			else
			{
				...
				if (!unk_0x36CEFBE9B745A58D(iLocal_72))
				{
					...
					func_135(iLocal_139, unk_0xD20EBB97FE8799ED(unk_0xBC25C936A095B5BA()), &uLocal_153, &uLocal_156, &vLocal_158, &fLocal_157, &uLocal_159, 0f, 0f, 0f, 1500, 0f);
					if (unk_0xE642C1AC73CE364E(iLocal_72, unk_0xBC25C936A095B5BA(), 30f, 30f, 30f, 0, 1, 0))
					{
						if (iLocal_87 < unk_0x105601648511CC64())
						{
							if (!func_54())
							{
								if (func_58())
								...
								iLocal_87 = unk_0x105601648511CC64() + 8000;
							}
						}
						if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
						{
						...
						if (unk_0x7214F4879DF8A314(unk_0xBC25C936A095B5BA()) && !unk_0x36CEFBE9B745A58D(iLocal_72))
						{
							if ((unk_0x7214F4879DF8A314(iLocal_72) && unk_0x72C9157015C2151B(unk_0xBC25C936A095B5BA(), 4)) && unk_0xC2D39D2C720A03B0(unk_0xB5CEFD608600A09F()))
							{
								iLocal_94 = 1;
							}
						}
					}
					if (!iLocal_93 && !unk_0x36CEFBE9B745A58D(iLocal_72))
					{
						if (unk_0x63276C96B907C69E(unk_0xBC25C936A095B5BA()) && unk_0xE642C1AC73CE364E(iLocal_72, unk_0xBC25C936A095B5BA(), 10f, 10f, 10f, 0, 1, 0))
						{
							unk_0xB8CBD998685C0685(iLocal_72, unk_0xBC25C936A095B5BA(), 0, 16);
							func_48();
							SYSTEM::WAIT(0);
...
void func_135(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, vector3 vParam7, int iParam8, float fParam9)//Position - 0x7812
{
	vector3 vVar0;
	...
	if (unk_0x724D816EA203A79E(iParam0) && unk_0xE59B7F5A03335350(iParam0, 0))
	{
		if (((((((unk_0x724D816EA203A79E(iParam1) && iParam0 != iParam1) && !unk_0xE7B3A320107C1379(unk_0x6F79ECA8C83E4357(iParam1))) && !unk_0xA19D269B4B5A1532(unk_0x6F79ECA8C83E4357(iParam1))) && !unk_0x8C1A6E7D5F410F4A(unk_0x6F79ECA8C83E4357(iParam1))) && !unk_0xFF2234981505F7F4(unk_0x6F79ECA8C83E4357(iParam1))) && unk_0x58F9E0EA914AEF2C(iParam1)) && func_140(iParam0))
		{
			if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(iParam1, true), *uParam4, true) > 20f)
			{
				...
				*uParam3 = func_139(unk_0x541C2AEF053615BC(iParam0, true), unk_0x541C2AEF053615BC(iParam1, true));
			...
			{
				if (func_137(iParam0, iParam1, 1) > fParam9 && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(iParam1, true), *uParam2, true) > 20f)
				{
					if (!func_136(*uParam2))
					{
						...
						{
							vVar0 = { unk_0x89D97EB4FAE4A574(vLocal_158, fLocal_157, vParam7) };
							if (!func_136(vVar0))
							{
								if (!unk_0x33CC9445B2DF9387(vVar0, 2f))
								{
									...
									unk_0x019CE76D5286C95C(iParam0, fLocal_157);
									unk_0xF0A40F19AAB79E88(iParam0, 1084227584);
									unk_0xA4DFFFD5B234240D(iParam0, 10f);
									unk_0x2D655AA68FA1736B(iParam0, true, true, 0);
									*uParam6 = unk_0x105601648511CC64();
...
int func_136(vector3 vParam0)//Position - 0x7A45
{
...
float func_137(int iParam0, int iParam1, bool bParam2)//Position - 0x7A6F
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_138(int iParam0, var uParam1, var uParam2)//Position - 0x7ACD
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
...
float func_139(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3)//Position - 0x7AFD
{
	return unk_0xFDC254CE02DB0919((Param2 - Param0), (Param2.f_1 - Param0.f_1));
}

int func_140(int iParam0)//Position - 0x7B17
{
	int iVar0;
...
void func_141(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7B62
{
	int iVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	if (unk_0x724D816EA203A79E(*iParam2))
	{
		if (unk_0xE59B7F5A03335350(*iParam2, 0))
		{
			...
			if (!unk_0x2DA8CA50A72528FB(*iParam3))
			{
				if (iVar0 == 1)
				{
					*iParam3 = func_121(unk_0x541C2AEF053615BC(*iParam2, true), 0);
			...
			else
			{
				...
				vVar2 = { unk_0x541C2AEF053615BC(*iParam2, true) };
...
void func_142(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x7CAD
{
	int iVar0;
	int iVar1;
...
void func_143()//Position - 0x7D9E
{
	if (!unk_0x36CEFBE9B745A58D(iLocal_72))
	{
		if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 655.7768f, 1282.45f, 359.048f, 802.4241f, 1278.077f, 382.4866f, 77f, 0, true, 0) || unk_0x0C265B3C448E6954(iLocal_72, 655.7768f, 1282.45f, 359.048f, 802.4241f, 1278.077f, 382.4866f, 77f, 0, true, 0))
		{
...
void func_144()//Position - 0x7EF6
{
	if (!bLocal_90)
	{
		if (iLocal_58 == 3)
		{
			if (unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_84, 200f, 200f, 200f, false, true, 0))
			{
				unk_0xF243B7A14FCFD0F4(iLocal_81);
				unk_0x37FA5A8A7F1136BA("move_m@brave");
				if (unk_0xD6513D668481290A(iLocal_81) && unk_0x320539481B2F0121("move_m@brave"))
				{
					iLocal_72 = unk_0x01B3635C3E8EDD81(26, iLocal_81, vLocal_84, fLocal_85, 1, true);
					unk_0xB0031DDAE4FF0BC3(iLocal_72, 0, 2, 1, 0);
					unk_0xB0031DDAE4FF0BC3(iLocal_72, 3, 0, 2, 0);
					unk_0x2E35C4FA5F0ED22F(iLocal_72, true);
					unk_0xC8FD3EBBB90E8D7F(iLocal_72, 42, true);
					unk_0x566684DB6DAC0531(iLocal_72, true);
					unk_0x43B967881C60631D(iLocal_72, "move_m@brave", 1048576000);
					unk_0xC8FD3EBBB90E8D7F(iLocal_72, 137, true);
					func_148(&uLocal_161, 4, iLocal_72, sLocal_148, 0, 1);
					unk_0xE896C0AD02364F2A(iLocal_72, "random@hitch_lift", "idle_a", 2f, -2f, -1, 1, 0, 0, 0, 0);
					unk_0x56F2E1B5599188FA(iLocal_72, unk_0xBC25C936A095B5BA(), -1, 2052, 4);
		...
		else if (iLocal_58 == 5)
		{
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_67, true) > 320f && unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
				{
					if (unk_0x62F3A07C43FFB568(iLocal_71, unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), 0))
					{
						if (unk_0x29EBF830A072263F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x491B2241281A03B7(2, 5), &vLocal_62, 1, 3f, 0f))
						{
							if (!unk_0x33CC9445B2DF9387(vLocal_62, 7f) && SYSTEM::VDIST(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_62) < 110f)
							{
								unk_0xF243B7A14FCFD0F4(iLocal_81);
								if (unk_0xD6513D668481290A(iLocal_81))
								{
									func_55();
									SYSTEM::WAIT(0);
									if (func_147(&uLocal_161, cLocal_146, "REHH5_CHS", "REHH5_CHS_1", 4, 0, 0) && !unk_0x36CEFBE9B745A58D(iLocal_71))
									{
										iLocal_139 = unk_0x61C05BF08A1E0EFE(iLocal_82, vLocal_62, func_145(vLocal_62, func_146(unk_0xB5CEFD608600A09F()), 1), true, true, false);
										unk_0x914C5DE0B15B8B59(iLocal_139, 134, 134);
										unk_0x55AFEE10B3CE5C2C(iLocal_139, 0f);
										iLocal_72 = unk_0xFD8987C090669BD5(iLocal_139, 26, iLocal_81, -1, 1, true);
										unk_0xB0031DDAE4FF0BC3(iLocal_72, 0, 1, 1, 0);
										unk_0xB0031DDAE4FF0BC3(iLocal_72, 2, 1, 0, 0);
										unk_0xC8FD3EBBB90E8D7F(iLocal_72, 42, true);
										unk_0x0DEF5E53360637F2(iLocal_72, 1);
										func_148(&uLocal_161, 4, iLocal_72, sLocal_148, 0, 1);
										unk_0xF0A40F19AAB79E88(iLocal_139, 1084227584);
										unk_0x1A06AE15BF21D407(iLocal_72, iLocal_139, iLocal_71, 6, 60f, 786468, -1f, -1f, 1);
										unk_0xB8CBD998685C0685(iLocal_72, unk_0xBC25C936A095B5BA(), 0, 16);
										unk_0x22321800954A532E(iLocal_72, true);
										unk_0x2CA123B0622F495C(iLocal_81);
										unk_0x2CA123B0622F495C(iLocal_82);
										unk_0xA4DFFFD5B234240D(iLocal_139, (unk_0x8910237449BB6F79(unk_0xBC25C936A095B5BA()) + 15f));
										if (unk_0x2DA8CA50A72528FB(iLocal_69))
										{
											unk_0x07B8ECB35A4ED3AC(&iLocal_69);
										}
...
float func_145(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, int iParam4)//Position - 0x81B8
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_146(int iParam0)//Position - 0x821D
{
	return unk_0x541C2AEF053615BC(unk_0xA95CF30C72EB526E(iParam0), false);
}

int func_147(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x8230
{
	func_17(uParam0, 145, sParam1, iParam5, iParam6, 0);
	if (iParam4 > 7)
	{
...
void func_148(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x8284
{
	if ((uParam0[iParam1 /*10*/])->f_7 == 1)
	{
	}
...
void func_150()//Position - 0x8925
{
	...
	if (iLocal_141 == 30)
	{
		if ((iLocal_142 == func_154(func_156()) && iLocal_141 == func_155(func_156()) + 30) || (((iLocal_142 >= 24 && iLocal_123 < 150000) && iLocal_142 == func_154(func_156()) + 24) && iLocal_141 == func_155(func_156()) + 30))
		{
			if (!iLocal_132)
			{
				...
				if (!iLocal_133)
				{
					iLocal_145 = unk_0x2F079D1FC5F6CB99();
					unk_0xC4BA30B532FE260F(iLocal_145, "VARIABLE_COUNTDOWN_CLOCK_wp", 0, true);
					unk_0x8B34879B92B3B225(iLocal_145, "countdown_fadein", 35f);
		...
		if ((iLocal_142 == func_154(func_156()) && iLocal_141 == func_155(func_156()) + 5) || (((iLocal_142 >= 24 && iLocal_123 < 150000) && iLocal_142 == func_154(func_156()) + 24) && iLocal_141 == func_155(func_156()) + 5))
		{
			if (!iLocal_134)
			{
				unk_0x8B34879B92B3B225(iLocal_145, "countdown_fast", 1f);
				iLocal_134 = 1;
			}
		}
	}
	...
	if (bLocal_143)
	{
		...
		if (!unk_0x36CEFBE9B745A58D(iLocal_71))
		{
			if (unk_0x5237AF95232D78C5(iLocal_71, 0))
			{
				unk_0x241D744C1CCBC526(unk_0x9FE9D386222EEE47(iLocal_71, 0), (10.5f + 2f), 2, 0);
				unk_0xA3981DED4FC2E56E(iLocal_71, 1, 0);
				unk_0x57EB4CC8F1928A47(iLocal_71);
				if (unk_0x2DA8CA50A72528FB(iLocal_69))
				{
					unk_0x07B8ECB35A4ED3AC(&iLocal_69);
...
void func_151(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)//Position - 0x8EE2
{
	int iVar0;
	int iVar1;
...
void func_152(int iParam0, int iParam1)//Position - 0x9030
{
	unk_0xF0059F27F7BB6680(&(Global_14D262.f_17E7[iParam0]), iParam1);
}

bool func_153(int iParam0, int iParam1)//Position - 0x9049
{
	return unk_0xFA30DFD0084E92FE(Global_14D262.f_17E7[iParam0], iParam1);
}

int func_154(int iParam0)//Position - 0x9062
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

int func_155(int iParam0)//Position - 0x9075
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 14) & 63;
}

int func_156()//Position - 0x9088
{
	var uVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0x90CE
{
	if (iParam1 <= 0)
	{
		return;
...
void func_158(var uParam0, int iParam1)//Position - 0x9154
{
...
void func_159(var uParam0, int iParam1)//Position - 0x9187
{
	int iVar0;
	int iVar1;
...
int func_160(int iParam0, int iParam1)//Position - 0x91D8
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
int func_161(int iParam0)//Position - 0x927A
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_162(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_162(bool bParam0, int iParam1, int iParam2)//Position - 0x929F
{
	if (bParam0)
	{
		return iParam1;
...
int func_163(int iParam0)//Position - 0x92B6
{
	return iParam0 & 15;
}

void func_164(var uParam0, int iParam1)//Position - 0x92C3
{
...
void func_165(var uParam0, int iParam1)//Position - 0x92FD
{
...
void func_166(var uParam0, int iParam1)//Position - 0x9338
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
			...
			if (unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), unk_0x3E12B546F3F2597A(), 0) && unk_0x62F3A07C43FFB568(iLocal_71, unk_0x3E12B546F3F2597A(), 0))
			{
				...
				if (((func_8() == 2 && !func_51()) && iLocal_58 != 1) && iLocal_58 != 4)
				{
					if (!unk_0x2DA8CA50A72528FB(iLocal_70))
					{
						...
						unk_0xBF0E22F3E083C33D(iLocal_70, 269);
						func_168();
					}
				}
				if (iLocal_58 == 1)
...
void func_169(char* sParam0, int iParam1)//Position - 0x9531
{
	unk_0x2F618BD43614DD0D(sParam0);
	unk_0x72F8FA06CC9EC899(0, 0, true, iParam1);
}

void func_170()//Position - 0x9548
{
	int iVar0;
	...
	switch (iLocal_108)
	{
		case 0:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (iLocal_88 < unk_0x105601648511CC64())
				{
					...
					iLocal_88 = (unk_0x105601648511CC64() + unk_0x491B2241281A03B7(4500, 6500));
				}
				if (unk_0xC5B8A5F778E321DD(iLocal_71, unk_0xBC25C936A095B5BA(), 90f))
				{
					if (func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 24f || (unk_0xD95B48C451FB1A20(unk_0xB5CEFD608600A09F()) && func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 30f))
					{
						fLocal_152 = func_137(iLocal_71, unk_0xBC25C936A095B5BA(), 1);
						if (fLocal_152 > 5f)
						{
						...
						unk_0x9565F9267674873A(0, unk_0xBC25C936A095B5BA(), -1, fLocal_152, 2f, 1073741824, 0);
						unk_0x535008C596714F9E(iLocal_75);
						unk_0xA8E6405305C0D7DF(iLocal_71, iLocal_75);
						unk_0x02DAF06EA4F08219(&iLocal_75);
						iLocal_108++;
				...
				else if (func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 12f || (unk_0xD95B48C451FB1A20(unk_0xB5CEFD608600A09F()) && func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 30f))
				{
					fLocal_152 = func_137(iLocal_71, unk_0xBC25C936A095B5BA(), 1);
		...
		case 1:
			if (unk_0x2DA8CA50A72528FB(iLocal_99))
			{
				unk_0x222805B89367761E(iLocal_99, true);
			}
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				unk_0x56F2E1B5599188FA(unk_0xBC25C936A095B5BA(), iLocal_71, 5000, 2052, 2);
				if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
				{
					iLocal_73 = unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0);
					if (unk_0xE59B7F5A03335350(iLocal_73, 0))
					{
						if (func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 25f || (unk_0xD95B48C451FB1A20(unk_0xB5CEFD608600A09F()) && func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 30f))
						{
							if (unk_0xC5B8A5F778E321DD(iLocal_71, unk_0xBC25C936A095B5BA(), 150f))
							{
								unk_0xD999D66C5AFA4BE3(iLocal_71);
								unk_0xC5A6DFE2B8987B17(&iLocal_75);
								unk_0x56F2E1B5599188FA(0, unk_0xBC25C936A095B5BA(), -1, 2052, 4);
								if (unk_0x1AAF0C23233C57AF(iLocal_73, 0, 0))
								{
									unk_0x96C0F2A7FFCD0DEF(0, iLocal_73, -1, 0, 2f);
								}
				...
				{
					unk_0x56F2E1B5599188FA(iLocal_71, unk_0xBC25C936A095B5BA(), 7000, 2052, 2);
		...
		case 2:
			...
			{
				iLocal_73 = unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0);
				if (!unk_0x36CEFBE9B745A58D(iLocal_71) && unk_0xE59B7F5A03335350(iLocal_73, 0))
				{
					if (func_137(iLocal_71, iLocal_73, 1) < 25f || (unk_0xD95B48C451FB1A20(unk_0xB5CEFD608600A09F()) && func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 30f))
					{
						if (unk_0x8910237449BB6F79(iLocal_73) < 2.5f)
						{
							if (!unk_0x36CEFBE9B745A58D(iLocal_71))
							{
		...
		case 3:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (unk_0xE642C1AC73CE364E(iLocal_71, unk_0xBC25C936A095B5BA(), 3f, 3f, 3f, 0, 1, 0))
				{
					unk_0xC5A6DFE2B8987B17(&iLocal_75);
					unk_0x56F2E1B5599188FA(0, unk_0xBC25C936A095B5BA(), -1, 2052, 2);
					unk_0x85DB484A637CEAB9(0, unk_0xBC25C936A095B5BA(), 0);
				...
				if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
				{
					...
					if (unk_0xE59B7F5A03335350(iLocal_73, 0))
					{
						if (unk_0x8910237449BB6F79(iLocal_73) < 2.5f && func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 25f)
						{
							if (!func_54())
							{
								if (func_8() == 0)
		...
		case 4:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0) && func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 25f)
				{
					if (func_117())
					{
						if (unk_0xE59B7F5A03335350(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), 0))
						{
							if (unk_0x1AAF0C23233C57AF(unk_0x3E12B546F3F2597A(), 0, 0))
							{
								...
								unk_0x0AB3C2863B144B82(iLocal_71, 1);
								unk_0x59B9712C1EAB0092(iLocal_71, 0);
								unk_0x56F2E1B5599188FA(iLocal_71, unk_0xBC25C936A095B5BA(), 10000, 2052, 2);
								unk_0xD179FA0466FA4FE3(iLocal_71, unk_0x3E12B546F3F2597A(), -1, 0, 2f, 1, 0);
								func_171();
								iLocal_108++;
							}
							else
							{
								...
								else
								{
									...
									unk_0x75E3FA28CC7D5707(iLocal_71, func_111());
									unk_0x0AB3C2863B144B82(iLocal_71, 1);
									unk_0x59B9712C1EAB0092(iLocal_71, 1);
									unk_0x56F2E1B5599188FA(iLocal_71, unk_0xBC25C936A095B5BA(), 10000, 2052, 2);
									iLocal_108++;
								}
							}
		...
		case 5:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (func_117())
				{
					if (unk_0x5237AF95232D78C5(iLocal_71, 0))
					{
						unk_0x44C98C11ED6DD327(iLocal_71);
						iLocal_89 = 1;
						iLocal_57 = 3;
					}
					...
					if (func_172(iLocal_71, unk_0xBC25C936A095B5BA()) > 100f)
					{
						func_53();
					}
				}
...
float func_172(int iParam0, int iParam1)//Position - 0x9BA4
{
	return func_137(iParam0, iParam1, 1);
}

void func_173()//Position - 0x9BB5
{
	int iVar0;
	...
	switch (iLocal_108)
	{
		case 0:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (unk_0xC5B8A5F778E321DD(iLocal_71, unk_0xBC25C936A095B5BA(), 90f))
				{
					if (func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 12f || (unk_0xD95B48C451FB1A20(unk_0xB5CEFD608600A09F()) && func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 30f))
					{
						fLocal_152 = func_137(iLocal_71, unk_0xBC25C936A095B5BA(), 1);
						if (fLocal_152 > 5f)
						{
				...
				else if (func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 8f || (unk_0xD95B48C451FB1A20(unk_0xB5CEFD608600A09F()) && func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 30f))
				{
					fLocal_152 = func_137(iLocal_71, unk_0xBC25C936A095B5BA(), 1);
					fLocal_152 = (fLocal_152 - 0.25f);
					unk_0xC5A6DFE2B8987B17(&iLocal_75);
					unk_0x56F2E1B5599188FA(0, unk_0xBC25C936A095B5BA(), -1, 2052, 2);
					unk_0x9565F9267674873A(0, unk_0xBC25C936A095B5BA(), -1, fLocal_152, 1f, 1073741824, 0);
					unk_0x535008C596714F9E(iLocal_75);
					unk_0xA8E6405305C0D7DF(iLocal_71, iLocal_75);
					unk_0x02DAF06EA4F08219(&iLocal_75);
					iLocal_108++;
		...
		case 1:
			...
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				...
				if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
				{
					...
					if (unk_0xE59B7F5A03335350(iLocal_73, 0))
					{
						if (func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 10f || (unk_0xD95B48C451FB1A20(unk_0xB5CEFD608600A09F()) && func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 30f))
						{
							if (unk_0xC5B8A5F778E321DD(iLocal_71, unk_0xBC25C936A095B5BA(), 150f))
							{
								unk_0xD999D66C5AFA4BE3(iLocal_71);
								...
								if (unk_0x1AAF0C23233C57AF(iLocal_73, 0, 0))
								{
									unk_0x96C0F2A7FFCD0DEF(0, iLocal_73, -1, 0, 1f);
								}
								unk_0x85DB484A637CEAB9(0, unk_0xBC25C936A095B5BA(), 0);
								unk_0x535008C596714F9E(iLocal_75);
								unk_0xA8E6405305C0D7DF(iLocal_71, iLocal_75);
		...
		case 2:
			if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
			{
				...
				if (!unk_0x36CEFBE9B745A58D(iLocal_71) && unk_0xE59B7F5A03335350(iLocal_73, 0))
				{
					if (func_137(iLocal_71, iLocal_73, 1) < 13f || (unk_0xD95B48C451FB1A20(unk_0xB5CEFD608600A09F()) && func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 30f))
					{
						if (unk_0x8910237449BB6F79(iLocal_73) < 2.5f)
						{
							if (!unk_0x36CEFBE9B745A58D(iLocal_71))
		...
		case 3:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (unk_0x8F1FDD0A40DC834A(iLocal_71))
				{
					unk_0xC5A6DFE2B8987B17(&iLocal_75);
					unk_0x56F2E1B5599188FA(0, unk_0xBC25C936A095B5BA(), -1, 2052, 2);
					unk_0x85DB484A637CEAB9(0, unk_0xBC25C936A095B5BA(), 0);
				...
				if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
				{
					...
					if (unk_0xE59B7F5A03335350(iLocal_73, 0))
					{
						if (unk_0x8910237449BB6F79(iLocal_73) < 2.5f && func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 15f)
						{
							if (!func_54())
							{
								if (func_8() == 0)
		...
		case 4:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0) && func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 15f)
				{
					if (func_117())
					{
						if (unk_0xE59B7F5A03335350(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), 0))
						{
							if (unk_0x1AAF0C23233C57AF(unk_0x3E12B546F3F2597A(), 0, 0))
							{
								...
								unk_0x59B9712C1EAB0092(iLocal_71, 0);
								unk_0x56F2E1B5599188FA(iLocal_71, unk_0xBC25C936A095B5BA(), 10000, 2052, 2);
								unk_0xD179FA0466FA4FE3(iLocal_71, unk_0x3E12B546F3F2597A(), -1, 0, 1f, 1, 0);
								func_171();
								iLocal_108++;
							}
							else
		...
		case 5:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (func_117())
				{
					unk_0xDBA0F5674ACCE43C(iLocal_71, 1f);
					if (unk_0x5237AF95232D78C5(iLocal_71, 0))
					{
						unk_0x44C98C11ED6DD327(iLocal_71);
						iLocal_89 = 1;
...
void func_175()//Position - 0xA830
{
	...
	switch (iLocal_108)
	{
		case 0:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				if (func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 12f || (unk_0xD95B48C451FB1A20(unk_0xB5CEFD608600A09F()) && func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 30f))
				{
					unk_0x56F2E1B5599188FA(unk_0xBC25C936A095B5BA(), iLocal_71, 5000, 2052, 2);
					if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
					{
						...
						{
							unk_0xC5A6DFE2B8987B17(&iLocal_75);
							unk_0x56F2E1B5599188FA(0, iLocal_73, 30000, 2054, 2);
							unk_0xE896C0AD02364F2A(iLocal_71, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0, 0, 0, 0);
							unk_0x535008C596714F9E(iLocal_75);
							unk_0xA8E6405305C0D7DF(iLocal_71, iLocal_75);
							unk_0x02DAF06EA4F08219(&iLocal_75);
						}
		...
		case 1:
			...
			if (func_117())
			{
				...
				{
					iLocal_73 = unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0);
					if (unk_0x8910237449BB6F79(iLocal_73) < 10f)
					{
						if (!unk_0x36CEFBE9B745A58D(iLocal_71))
						{
							if (unk_0xC5B8A5F778E321DD(iLocal_71, unk_0xBC25C936A095B5BA(), 150f))
							{
								...
								unk_0xC5A6DFE2B8987B17(&iLocal_75);
								unk_0x56F2E1B5599188FA(0, iLocal_73, 10000, 2054, 2);
								if (unk_0x1AAF0C23233C57AF(iLocal_73, 0, 0))
								{
									unk_0x96C0F2A7FFCD0DEF(0, iLocal_73, -1, 0, 1f);
								}
							...
							{
								unk_0x56F2E1B5599188FA(iLocal_71, iLocal_73, 10000, 2054, 2);
								iLocal_108++;
							}
						}
					}
		...
		case 4:
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				...
				if (func_172(iLocal_71, unk_0xBC25C936A095B5BA()) < 15f)
				{
					if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
					{
						iLocal_73 = unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0);
...
void func_176()//Position - 0xAE70
{
	int iVar0;
	
	if ((iLocal_126 - iLocal_125) > 1000)
	{
		iLocal_140 = unk_0x39827CF9BEAB804C(unk_0x541C2AEF053615BC(iLocal_71, false), 18f, 0, 4);
	}
	if (iLocal_140 != 0)
	{
		iLocal_124++;
		...
		if (iLocal_124 > iVar0)
		{
			unk_0x77815D3407C6700D(iLocal_140, true, 0);
			if (unk_0xE59B7F5A03335350(iLocal_140, 0))
			{
				if (!unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), iLocal_140, 0))
				{
					if (iLocal_58 == 1)
					{
						if (func_1(&uLocal_161, cLocal_146, "REHH1_STO", 4, 0, 0, 0))
						{
							if (!unk_0x36CEFBE9B745A58D(iLocal_71))
							{
								unk_0x56F2E1B5599188FA(iLocal_71, iLocal_140, 3000, 2052, 2);
							}
						}
		...
		{
			iLocal_151 = unk_0x105601648511CC64();
			if ((iLocal_151 - iLocal_150) > 3500)
			{
				unk_0x1E7A09C1710FB071(&iLocal_140);
			}
			iLocal_140 = 0;
		}
	}
...
void func_178()//Position - 0xB063
{
	if (iLocal_58 == 1)
	{
		if (unk_0x724D816EA203A79E(iLocal_71))
		{
			if (!unk_0x1D403DFADBC2DE3C(iLocal_71, 0))
			{
				if ((unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -3024.265f, 660.8264f, 1.1982f, -3140.823f, 803.707f, 35.131f, 93f, 0, true, 0) && !unk_0x41A5D6415E2CC10E(iLocal_71)) || func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 12f)
				{
					func_179();
					iLocal_57 = 2;
				}
	...
	else if (iLocal_58 == 2)
	{
		if (!iLocal_135)
		{
			if (unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_76, 100f, 100f, 100f, false, true, 0) && !unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				unk_0xC5A6DFE2B8987B17(&iLocal_75);
	...
	else if (iLocal_58 == 5)
	{
		if (!iLocal_135)
		{
			if (unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_76, 200f, 200f, 200f, false, true, 0) && !unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				unk_0xC5A6DFE2B8987B17(&iLocal_75);
	...
	if (iLocal_58 != 1)
	{
		if (unk_0x724D816EA203A79E(iLocal_71))
		{
			if (!unk_0x1D403DFADBC2DE3C(iLocal_71, 0))
			{
				if ((unk_0xE642C1AC73CE364E(unk_0xBC25C936A095B5BA(), iLocal_71, 95f, 95f, 50f, 0, 1, 0) && !unk_0x41A5D6415E2CC10E(iLocal_71)) || func_172(unk_0xBC25C936A095B5BA(), iLocal_71) < 12f)
				{
					func_179();
					iLocal_57 = 2;
				}
...
void func_179()//Position - 0xB35E
{
	if (unk_0x2DA8CA50A72528FB(iLocal_98))
	{
		unk_0x07B8ECB35A4ED3AC(&iLocal_98);
	}
	if (!unk_0x36CEFBE9B745A58D(iLocal_71))
	{
		if (!unk_0x2DA8CA50A72528FB(iLocal_99))
		{
			...
			{
				iLocal_99 = func_63(iLocal_71, 0, 145);
				unk_0x222805B89367761E(iLocal_99, false);
			}
		}
		if (!func_212())
		{
	...
	if (func_8() == 0)
	{
		func_148(&uLocal_161, 0, unk_0xBC25C936A095B5BA(), "MICHAEL", 0, 1);
	}
	else if (func_8() == 1)
	{
		func_148(&uLocal_161, 1, unk_0xBC25C936A095B5BA(), "FRANKLIN", 0, 1);
	}
	else if (func_8() == 2)
	{
		func_148(&uLocal_161, 2, unk_0xBC25C936A095B5BA(), "TREVOR", 0, 1);
	}
}

void func_180()//Position - 0xB412
{
	func_182(39, 1);
	func_182(40, 1);
	func_182(41, 1);
	...
	func_182(43, 1);
	func_182(44, 1);
	iLocal_71 = unk_0x01B3635C3E8EDD81(26, iLocal_80, vLocal_76, fLocal_78, 1, true);
	unk_0x2CA123B0622F495C(iLocal_80);
	unk_0x2E35C4FA5F0ED22F(iLocal_71, true);
	unk_0xB105531EDD3DE51B(iLocal_71, false);
	unk_0x36C3B58DA78A2679(iLocal_71, sLocal_149);
	unk_0xC8FD3EBBB90E8D7F(iLocal_71, 137, true);
	unk_0xC8FD3EBBB90E8D7F(iLocal_71, 206, true);
	unk_0xABA7AE40608505F2(iLocal_71, 1024, true);
	unk_0xABA7AE40608505F2(iLocal_71, 65536, true);
	unk_0xABA7AE40608505F2(iLocal_71, 2, false);
	unk_0x91629AC1E1F78419(iLocal_71, 17, true);
	unk_0xB58463DD7085635A(iLocal_71, 60f);
	unk_0x4A506C72BFC368E4(iLocal_71, 5f);
	if (iLocal_58 == 1)
	{
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 0, 0, 1, 0);
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 2, 1, 2, 0);
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 3, 0, 2, 0);
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 4, 0, 2, 0);
		unk_0x8510BC031C24B862(iLocal_82, true);
		iLocal_139 = unk_0x61C05BF08A1E0EFE(iLocal_82, -3088.068f, 730.4819f, 20.3028f, 332.2996f, true, true, false);
		unk_0xE6E403909F4BF47F(iLocal_139, 150f);
		unk_0x1C5BDB4E5D257D63(iLocal_139, 4, 0, 0);
		unk_0x8300C56586249382(iLocal_139, 0);
		unk_0x2CA123B0622F495C(iLocal_82);
		unk_0xE896C0AD02364F2A(iLocal_71, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0, 0, 0, 0);
	}
	else if (iLocal_58 == 2)
	{
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 0, 0, 1, 0);
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 2, 0, 1, 0);
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 3, 0, 0, 0);
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 4, 0, 1, 0);
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 8, 1, 0, 0);
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 10, 0, 0, 0);
		unk_0xE896C0AD02364F2A(iLocal_71, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0, 0, 0, 0);
		unk_0x1DAA351326EA3537(vLocal_77 - Vector(20f, 50f, 50f), vLocal_77 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
		func_181(1);
	}
	else if (iLocal_58 == 3)
	{
		...
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 3, 0, 0, 0);
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 4, 1, 0, 0);
		unk_0xB0031DDAE4FF0BC3(iLocal_71, 8, 0, 0, 0);
		unk_0xE896C0AD02364F2A(iLocal_71, "random@hitch_lift", "idle_f", 2f, -2f, -1, 49, 0, 0, 0, 0);
		unk_0x1DAA351326EA3537(vLocal_77 - Vector(20f, 50f, 50f), vLocal_77 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
	}
	else if (iLocal_58 == 5)
...
void func_181(bool bParam0)//Position - 0xB678
{
	if (bParam0)
	{
...
void func_182(int iParam0, bool bParam1)//Position - 0xB6A4
{
	if (bParam1)
	{
...
void func_183(int iParam0, int iParam1, bool bParam2)//Position - 0xB6DB
{
	int iVar0;
...
int func_184(int iParam0)//Position - 0xB744
{
	switch (iParam0)
	{
		case 0:
...
void func_185(int iParam0, int iParam1, bool bParam2)//Position - 0xBA38
{
	int iVar0;
...
int func_186(int iParam0, int iParam1, bool bParam2)//Position - 0xBAA1
{
	if (bParam2)
	{
...
int func_187(int iParam0)//Position - 0xBB01
{
	if (func_190())
	{
		Global_19AFA = 1;
		Global_19AF7 = unk_0x105601648511CC64();
		if (func_31(Global_19AF9))
		{
			func_188(0);
		}
		unk_0x3FF92BBF0607A406(1, "RE_TITLE");
		if (iParam0 && func_31(Global_19AF9))
		{
...
void func_188(int iParam0)//Position - 0xBB54
{
	switch (iParam0)
	{
		case 0:
...
char* func_189(int iParam0)//Position - 0xBC35
{
	char* sVar0;
...
int func_190()//Position - 0xBC77
{
	switch (func_191(&Global_62F8, 0, 5, 0, unk_0x8A55B15F4133C912()))
	{
		case 1:
			return 1;
			break;
...
int func_191(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xBCAD
{
	int iVar0;
...
void func_192(var uParam0, int iParam1)//Position - 0xBDE4
{
	int iVar0;
...
bool func_193(int iParam0)//Position - 0xBE33
{
	return func_194(iParam0, Global_8C41);
}

int func_194(int iParam0, int iParam1)//Position - 0xBE44
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_195(int iParam0)//Position - 0xC025
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_196()//Position - 0xC047
{
	...
	if (!unk_0x1D403DFADBC2DE3C(iLocal_71, 0))
	{
		...
		if (!unk_0x1D403DFADBC2DE3C(unk_0x3E12B546F3F2597A(), 0))
		{
			if (unk_0xD9C1758D86688CEA(iLocal_71, unk_0x3E12B546F3F2597A(), 1))
			{
				return 1;
			}
		}
		if (!bLocal_92)
		{
			if (unk_0x04880508C862E589(unk_0x541C2AEF053615BC(iLocal_71, true), 10f, 1) || unk_0x876474582C5DECDE(unk_0x541C2AEF053615BC(iLocal_71, true) - Vector(10f, 10f, 10f), unk_0x541C2AEF053615BC(iLocal_71, true) + Vector(10f, 10f, 10f), 0))
			{
				return 1;
			}
		}
		else if (unk_0x36CEFBE9B745A58D(iLocal_72) && unk_0x724D816EA203A79E(iLocal_72))
		{
			if (unk_0xD9C1758D86688CEA(iLocal_72, unk_0xBC25C936A095B5BA(), 1) && unk_0x72C9157015C2151B(unk_0xBC25C936A095B5BA(), 7))
			{
				if (!unk_0x36CEFBE9B745A58D(iLocal_71))
				{
					unk_0xAB1A796DCD561BF8(iLocal_71, 6, 0f, 0);
				}
				return 1;
			}
		}
		if ((!unk_0xD45C08B05D4687A7(iLocal_71) && unk_0xC5B8A5F778E321DD(iLocal_71, unk_0xBC25C936A095B5BA(), 90f)) && unk_0xE642C1AC73CE364E(iLocal_71, unk_0xBC25C936A095B5BA(), 50f, 50f, 50f, 0, 1, 0))
		{
			if (unk_0x425BEBAA53B39EBF(unk_0xB5CEFD608600A09F(), iLocal_71) || unk_0xDF25D3BB3759E7D1(unk_0xB5CEFD608600A09F(), iLocal_71))
			{
				return 1;
			}
		}
...
void func_197()//Position - 0xC19D
{
	...
	if (iLocal_58 == 1)
	{
		...
		unk_0x284F2ACE6839D3C0("timer", false, -1);
	}
	else if (iLocal_58 == 3)
	{
		unk_0x522053D86D6E1C7A("facials@gen_female@base");
	}
	if (unk_0xD6513D668481290A(iLocal_80) && unk_0xF9E082857622D91E("random@hitch_lift"))
	{
		if (iLocal_58 == 1 || iLocal_58 == 5)
		{
			if (unk_0xD6513D668481290A(iLocal_82))
			{
				bLocal_59 = true;
			}
		}
...
int func_199()//Position - 0xC400
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()) && !unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
	{
		...
		if (SYSTEM::VMAG2(unk_0xB5D9AE572C19509E(unk_0xBC25C936A095B5BA())) > 1369f && !func_210())
		{
			return 0;
		}
	}
...
int func_200(float fParam0, bool bParam1)//Position - 0xC486
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_201(int iParam0, var uParam1)//Position - 0xC53D
{
	switch (iParam0)
	{
		case 0:
...
int func_203(int iParam0)//Position - 0xD743
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_204(int iParam0)//Position - 0xDA89
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_205(int iParam0)//Position - 0xDABF
{
	struct<2> Var0;
...
bool func_207()//Position - 0xDF3C
{
	return Global_199EA > 0;
}

int func_208()//Position - 0xDF4A
{
	if (Global_15FA6 != -1)
	{
		return 1;
...
int func_212()//Position - 0xE004
{
	if ((Global_19AF9 == func_40() && unk_0x8520DF5301DD9811()) && Global_19AFA)
	{
		return 1;
	}
	return 0;
...
void func_213(int iParam0)//Position - 0xE02F
{
	if (iParam0 == -1)
	{
		iParam0 = func_40();
...
void func_215(int iParam0)//Position - 0xE0A2
{
	Global_19AF9 = iParam0;
}

int func_216(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xE0B0
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_239(Global_19B04.f_6186.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_217(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0xE44A
{
	if (bParam2)
	{
...
bool func_218(int iParam0)//Position - 0xE491
{
	int iVar0;
...
int func_220(int iParam0, int iParam1)//Position - 0xE4C1
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_221(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0xE514
{
	func_222(func_156(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_222(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0xE532
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_223(float fParam0, float fParam1, float fParam2)//Position - 0xE733
{
	float fVar0;
...
int func_224(int iParam0)//Position - 0xE775
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 20) & 63;
}

int func_225(int iParam0)//Position - 0xE788
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 4) & 31;
}

int func_226(int iParam0, int iParam1)//Position - 0xE79A
{
	int iVar0;
	int iVar1;
...
int func_227(int iParam0)//Position - 0xE8A6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_228(int iParam0, int iParam1)//Position - 0xE982
{
...
int func_229(int iParam0)//Position - 0xE9A5
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_237()) || Global_1974B) || Global_62BF) || func_236()) || func_15(8, -1)) || func_235()) || func_234()) || func_233()) || func_232()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_237()) || Global_62BF) || func_236()) || func_15(8, -1)) || func_233()) || func_235()) || func_234()) || func_232()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_237()) || Global_1974B) || Global_62BF) || func_236()) || func_15(8, -1)) || func_233()) || func_235()) || func_234()) || func_232()) || Global_19B04.f_1DEB.f_397[iVar0] == 5) || Global_8E64 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_237()) || Global_1974B) || Global_62BF) || func_236()) || func_15(8, -1)) || func_235()) || func_234()) || func_232()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_237() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_15(8, -1)) || func_232()) || func_231()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_237()) || Global_62BF) || func_236()) || func_15(8, -1)) || func_234()) || func_233()) || func_232()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || !unk_0x8CC5A4A5615C6420(unk_0xB5CEFD608600A09F())) || !unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F())) || !unk_0x726D9204B160D23E()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || func_237()) || func_234()) || Global_1974B) || Global_62BF) || func_236()) || Global_90C1) || func_15(8, -1)) || func_233()) || func_231()) || func_232()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_230()//Position - 0xF0C2
{
	return Global_16B42.f_1;
}

int func_231()//Position - 0xF0D0
{
	if (Global_15FA6 != -1)
	{
...
bool func_234()//Position - 0xF13A
{
	return Global_16B4F.f_142 > 0;
}

bool func_235()//Position - 0xF14B
{
	return Global_16B4F.f_141 > 0;
}

var func_236()//Position - 0xF15C
{
	return Global_140856;
}

int func_237()//Position - 0xF168
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
bool func_239(int iParam0)//Position - 0xF1AC
{
	return func_226(func_156(), iParam0);
}

int func_240(int iParam0, int iParam1, int iParam2)//Position - 0xF1BE
{
	int iVar0;
	int iVar1;
...
int func_241(int iParam0)//Position - 0xF2A2
{
	if (!func_10(iParam0))
	{
		return 7;
...
bool func_242(int iParam0)//Position - 0xF2C6
{
	int iVar0;
	bool bVar1;
...
void func_245()//Position - 0xF423
{
	if (iLocal_111)
	{
		...
		if (unk_0x724D816EA203A79E(iLocal_71))
		{
			if (!unk_0x36CEFBE9B745A58D(iLocal_71))
			{
				unk_0xC8FD3EBBB90E8D7F(iLocal_71, 317, true);
				if (!unk_0x5237AF95232D78C5(iLocal_71, 0))
				{
					unk_0x9E410F8AFFC2894E(iLocal_71);
				}
				if (iLocal_58 != 2)
				{
					unk_0xD999D66C5AFA4BE3(iLocal_71);
				}
				if (unk_0xF4FCC3C1048FF2AB(iLocal_71, 1805844857) != 1 && unk_0xF4FCC3C1048FF2AB(iLocal_71, 1805844857) != 0)
				{
					unk_0x2E35C4FA5F0ED22F(iLocal_71, false);
				}
				unk_0xB105531EDD3DE51B(iLocal_71, true);
				if (unk_0xD45C08B05D4687A7(iLocal_71))
				{
					unk_0x57EB4CC8F1928A47(iLocal_71);
				}
		...
		if (unk_0x724D816EA203A79E(iLocal_72))
		{
			if (!unk_0x36CEFBE9B745A58D(iLocal_72))
			{
				if (!unk_0x889DA6CE8E4DB344(iLocal_72))
				{
					unk_0x2E35C4FA5F0ED22F(iLocal_72, false);
				}
			}
...
void func_246(int iParam0)//Position - 0xF5C1
{
	char cVar0[64];
	...
	if (func_212())
	{
		...
		func_249(30000);
		StringCopy(&cVar0, func_248(Global_19AF9, 1), 64);
		if (func_39(Global_19AF9) > 0)
		{
	...
	func_247(&Global_62F8);
	Global_19AFA = 0;
	func_215(-1);
}

void func_247(var uParam0)//Position - 0xF676
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_248(int iParam0, bool bParam1)//Position - 0xF6B3
{
	switch (iParam0)
	{
		case 0:
...
void func_249(int iParam0)//Position - 0xF8FC
{
	Global_8E68 = (unk_0x105601648511CC64() + iParam0);
}

void func_250(int iParam0)//Position - 0xF90E
{
	func_251(iParam0, 0, func_256(iParam0));
}

void func_251(int iParam0, int iParam1, int iParam2)//Position - 0xF923
{
	var uVar0;
	struct<16> Var1;
...
struct<16> func_252(var uParam0)//Position - 0xF952
{
	struct<16> Var0;
	int iVar1;
...
void func_253(int iParam0, var uParam1)//Position - 0xFA21
{
	Global_19B04.f_6186.f_2B[iParam0] = *uParam1;
}

void func_254(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xFA39
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_255(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xFBBB
{
...
int func_256(int iParam0)//Position - 0xFBF3
{
	int iVar0;
...
void func_257(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xFD96
{
	if (bParam0)
	{
...
int func_260(int iParam0, bool bParam1)//Position - 0xFF27
{
	int iVar0;
	int iVar1;
...
int func_261(int iParam0)//Position - 0xFF68
{
...
bool func_262()//Position - 0xFFAA
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_263(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xFFBB
{
	int iVar0;
...
void func_264(int iParam0)//Position - 0xFFEE
{
	if (iParam0 == 1)
	{
...
void func_265()//Position - 0x10013
{
	Global_63A8 = 0;
	Global_63A9 = 0;
	Global_63AB = 0;
...
void func_266(bool bParam0)//Position - 0x1002F
{
	int iVar0;
...
Vector3 func_267()//Position - 0x10052
{
	float fVar0;
	
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		fVar0 = unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_64, true);
		iLocal_63 = 1;
		if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_65, true) < fVar0)
		{
			fVar0 = unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_65, true);
			iLocal_63 = 2;
		}
		if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_66, true) < fVar0)
		{
			fVar0 = unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_66, true);
			iLocal_63 = 3;
		}
		if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_67, true) < fVar0)
		{
			fVar0 = unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_67, true);
			iLocal_63 = 5;
		}
		if (iLocal_63 == 1)
		{
