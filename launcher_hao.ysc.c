...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_266(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_254(&Var0, 1);
	}
	...
	iLocal_54 = unk_0x1DAA351326EA3537(-103.0011f, -1281.636f, 26.3686f, -23.246f, -1241.361f, 30.335f, 0, 1, 1, 1);
	...
	while (true)
	{
		...
		if (func_195(Var0.f_23[0]))
		{
			if (!func_194(-72.323f, -1258.643f, 28.648f, unk_0x541C2AEF053615BC(Var0.f_23[0], true), 1056964608))
			{
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x61B6
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x61FD
{
...
bool func_70(int iParam0)//Position - 0x6258
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6268
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x62C8
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x65BC
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x65C7
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x65D7
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6679
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6C33
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6C91
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6D3F
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6DD4
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6E18
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6F9C
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6FAA
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7A71
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7AF3
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7B51
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7B5A
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7D2D
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7D3D
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7FD7
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x7FE8
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x8031
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x80B7
{
...
void func_94(var uParam0, int iParam1)//Position - 0x80EA
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x813B
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x81DD
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8202
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x8219
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x8226
{
...
void func_100(var uParam0, int iParam1)//Position - 0x8260
{
...
void func_101(var uParam0, int iParam1)//Position - 0x829B
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x82D7
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x82F0
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x8349
{
...
bool func_105(bool bParam0)//Position - 0x838B
{
...
struct<2> func_106(int iParam0)//Position - 0x83B6
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8803
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9ADB
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9E21
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9EC5
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9F60
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9FBE
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA017
{
...
int func_116(int iParam0)//Position - 0xA09A
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA0CB
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA0E0
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA193
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA1AE
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA1FA
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA243
{
	if (func_124(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA263
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA284
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA3A7
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA49C
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA507
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA544
{
	if (bParam0)
	{
...
int func_134(int iParam0, bool bParam1)//Position - 0xA6D5
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA716
{
...
bool func_136()//Position - 0xA758
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA769
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA7C3
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA7E6
{
...
void func_141()//Position - 0xA823
{
	Global_394A = 0;
	func_142();
}

void func_142()//Position - 0xA833
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA919
{
...
void func_147(int iParam0)//Position - 0xAAA8
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAB25
{
...
void func_150(int iParam0)//Position - 0xAB4E
{
	if (Global_3943)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xABBE
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAC32
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAC8C
{
...
int func_154(int iParam0)//Position - 0xACCD
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAD12
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAD44
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAE7B
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAECA
{
	return func_159(iParam0, Global_8C41);
}

int func_159(int iParam0, int iParam1)//Position - 0xAEDB
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xB0BC
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_161()//Position - 0xB0DE
{
	return func_162(unk_0x1377080E9B0BD993(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB0EF
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(var uParam0, int iParam1)//Position - 0xB15C
{
	switch (uParam0->f_10)
	{
		case 0:
				...
				if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					if (func_124(uParam0->f_1C[0]))
					{
						if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(uParam0->f_1C[0], true), true) < 3f)
						{
							if (func_169(2))
							{
								if (func_168(uParam0->f_1B))
								{
									func_167(uParam0->f_1B, *uParam0);
...
void func_165()//Position - 0xB93F
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB95A
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB9E8
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xBA4C
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xBAE3
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_177()) || Global_1974B) || Global_62BF) || func_176()) || func_175(8, -1)) || func_90()) || func_174()) || func_173()) || func_172()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_177()) || Global_62BF) || func_176()) || func_175(8, -1)) || func_173()) || func_90()) || func_174()) || func_172()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_177()) || Global_1974B) || Global_62BF) || func_176()) || func_175(8, -1)) || func_173()) || func_90()) || func_174()) || func_172()) || Global_19B04.f_1DEB.f_397[iVar0] == 5) || Global_8E64 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_177()) || Global_1974B) || Global_62BF) || func_176()) || func_175(8, -1)) || func_90()) || func_174()) || func_172()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_177() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_175(8, -1)) || func_172()) || func_171()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_177()) || Global_62BF) || func_176()) || func_175(8, -1)) || func_174()) || func_173()) || func_172()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || !unk_0x8CC5A4A5615C6420(unk_0xB5CEFD608600A09F())) || !unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F())) || !unk_0x726D9204B160D23E()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || func_177()) || func_174()) || Global_1974B) || Global_62BF) || func_176()) || Global_90C1) || func_175(8, -1)) || func_173()) || func_171()) || func_172()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_170()//Position - 0xC201
{
	return Global_16B42.f_1;
}

int func_171()//Position - 0xC20F
{
	if (Global_15FA6 != -1)
	{
...
bool func_174()//Position - 0xC279
{
	return Global_16B4F.f_142 > 0;
}

bool func_175(int iParam0, int iParam1)//Position - 0xC28A
{
	switch (iParam0)
	{
		case 5:
...
var func_176()//Position - 0xC2C5
{
	return Global_140856;
}

int func_177()//Position - 0xC2D1
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
int func_178(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC2ED
{
	var uVar0;
	
	if ((((func_124(unk_0xBC25C936A095B5BA()) && func_124(uParam0->f_1C[0])) && !func_143()) && (unk_0x105601648511CC64() - uParam0->f_3C) > iParam6) && func_182(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_181(&uVar0, iParam4, uParam0->f_1C[0], sParam5, 0, 1);
...
void func_179(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC375
{
...
void func_180(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC3B0
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_181(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC406
{
...
float func_182(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC4A1
{
	vector3 vVar0;
...
void func_183(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC4DB
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_182(unk_0xBC25C936A095B5BA(), vParam2, 1) <= 100f)
				{
					func_186(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_182(unk_0xBC25C936A095B5BA(), vParam2, 1) > 120f)
				{
					func_188(iParam0);
				}
			}
...
void func_184(int iParam0, bool bParam1)//Position - 0xC5CC
{
	if (iParam0 == -1)
	{
		return;
...
int func_185(int iParam0)//Position - 0xC608
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_186(int iParam0, int iParam1)//Position - 0xC641
{
	bool bVar0;
	int iVar1;
...
bool func_187()//Position - 0xC6DF
{
	return Global_16129;
}

void func_188(int iParam0)//Position - 0xC6EB
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_189(iParam0);
...
void func_189(int iParam0)//Position - 0xC702
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_190(int iParam0)//Position - 0xC7EA
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
void func_191(var uParam0)//Position - 0xC812
{
	int iVar0;
	int iVar1;
...
void func_192(int iParam0)//Position - 0xCB16
{
	int iVar0;
...
void func_193(int iParam0)//Position - 0xCBB3
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_194(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3, float fParam4)//Position - 0xCBDE
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
int func_195(int iParam0)//Position - 0xCC17
{
	if (func_124(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_196(var uParam0, bool bParam1)//Position - 0xCC41
{
	struct<27> Var0;
	...
	if ((func_230(*uParam0) || func_228(*uParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
...
void func_197(int iParam0, var uParam1, int iParam2)//Position - 0xCEB4
{
	int iVar0;
	int iVar1;
...
int func_198(int iParam0)//Position - 0xD20C
{
...
int func_199(var uParam0)//Position - 0xD22C
{
...
int func_200(var uParam0)//Position - 0xD244
{
...
void func_201(var uParam0)//Position - 0xD269
{
	int iVar0;
...
int func_202(var uParam0, bool bParam1, bool bParam2)//Position - 0xD2E9
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (bParam2)
				{
					if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
					{
						...
						if (func_195(iVar2))
						{
							...
							{
								if (func_195(uParam0->f_23[iVar0]))
								{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_203(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_203(int iParam0, int iParam1)//Position - 0xD4A7
{
	int iVar0;
...
int func_204(var uParam0, bool bParam1, int iParam2)//Position - 0xD4D7
{
	int iVar0;
	int iVar1;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_1C[iVar0]))
			{
				if (!unk_0x36CEFBE9B745A58D(uParam0->f_1C[iVar0]))
				{
					...
					if (func_223(*uParam0))
					{
						if (!func_153(*uParam0))
						{
							if (func_218(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_191(uParam0);
						...
						if (func_206(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_191(uParam0);
...
int func_205(int iParam0)//Position - 0xD793
{
...
int func_206(int iParam0, float fParam1)//Position - 0xD7C7
{
	float fVar0;
...
bool func_207(int iParam0, float fParam1)//Position - 0xD83D
{
	return func_208(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_208(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD855
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_209(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD916
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_210(int iParam0, int iParam1)//Position - 0xDA42
{
	int iVar0;
...
int func_212(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDB51
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_214(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_214(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_213(vector3 vParam0, vector3 vParam1)//Position - 0xDBE2
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_214(vector3 vParam0)//Position - 0xDC03
{
	float fVar0;
	float fVar1;
...
void func_215(var uParam0)//Position - 0xDC42
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_216(int iParam0, int iParam1)//Position - 0xDC5D
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0xDC9C
{
...
int func_218(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDCC4
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_219(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDDBF
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_220(int iParam0, float fParam1)//Position - 0xDECB
{
	var uVar0;
	vector3 vVar1;
...
int func_221(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xDF60
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_214(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_222(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDFEE
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_223(int iParam0)//Position - 0xE036
{
...
int func_224(int iParam0)//Position - 0xE080
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_225(int iParam0)//Position - 0xE118
{
...
int func_228(int iParam0)//Position - 0xE19A
{
	if ((func_229() && Global_16B1B.f_B == 6) && iParam0 == func_162(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_230(int iParam0)//Position - 0xE20C
{
	if (func_105(0))
	{
...
int func_231(int iParam0)//Position - 0xE234
{
	if (!func_232(iParam0))
	{
		return 0;
...
int func_232(var uParam0)//Position - 0xE253
{
	int iVar0[4];
	int iVar1;
	int iVar2;
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_239(&iVar0) || !unk_0xF9E082857622D91E(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (!func_236(&(uParam0->f_1C[0]), 53, -71.93684f, -1259.7f, 28.19359f, -177.55f, "HAO LAUNCHER RC - HAO", 1))
				{
					bVar4 = false;
				}
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_234(&(uParam0->f_23[0]), iVar0[1], -72.3226f, -1258.643f, 28.1915f, 90.8326f);
				unk_0x914C5DE0B15B8B59(uParam0->f_23[0], 38, 0);
				unk_0x4C59702AC1076A88(uParam0->f_23[0], 91, 0);
				unk_0x1345B3BF11EDB0CF(uParam0->f_23[0], 0);
				unk_0xAC5CA95BB98F2400(uParam0->f_23[0], 0, 2);
				unk_0xAC5CA95BB98F2400(uParam0->f_23[0], 1, 1);
				unk_0xAC5CA95BB98F2400(uParam0->f_23[0], 2, 1);
				unk_0xAC5CA95BB98F2400(uParam0->f_23[0], 3, 1);
				unk_0xAC5CA95BB98F2400(uParam0->f_23[0], 4, 1);
				unk_0xAC5CA95BB98F2400(uParam0->f_23[0], 6, 0);
				unk_0xAC5CA95BB98F2400(uParam0->f_23[0], 7, 2);
				unk_0xAC5CA95BB98F2400(uParam0->f_23[0], 10, 0);
				unk_0xAC5CA95BB98F2400(uParam0->f_23[0], 23, 20);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_23[0], 0, 2, false);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_23[0], 1, 1, false);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_23[0], 2, 1, false);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_23[0], 3, 1, false);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_23[0], 4, 1, false);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_23[0], 6, 0, false);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_23[0], 7, 2, false);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_23[0], 10, 0, false);
				unk_0x5C9F67BE33A5A3EE(uParam0->f_23[0], 23, 20, false);
				unk_0xB25E25030D61B529(uParam0->f_23[0], 18, true);
				unk_0xB25E25030D61B529(uParam0->f_23[0], 17, true);
				unk_0xB25E25030D61B529(uParam0->f_23[0], 22, true);
				unk_0xD421BC740C5340C3(uParam0->f_23[0], 3);
				unk_0x17BBC63824839F77(uParam0->f_23[0], 0);
				unk_0x93D3868AE0D83B7C(uParam0->f_23[0], 2);
			...
			{
				func_234(&(uParam0->f_23[1]), iVar0[3], -91.07f, -1273.45f, 28.86f, 0.57f);
				unk_0x6012A6A4F2950585(uParam0->f_23[1], 10);
			}
			if (func_124(uParam0->f_1C[0]))
			{
				func_233(&(uParam0->f_29[0]), iVar0[2], -71.93684f, -1259.078f, 28.19359f, -177.55f);
				unk_0x5DBE04849460E608(uParam0->f_29[0], uParam0->f_1C[0], unk_0xFA18E720A39243D0(uParam0->f_1C[0], 60309), 0f, 0f, 0f, 0f, 0f, 0f, 1, 1, 0, 0, 2, 1);
			}
			if (bVar4)
			{
				iLocal_51 = 3;
		...
		case 3:
			if (func_123(uParam0->f_1C[0]) && func_195(uParam0->f_23[0]))
			{
				iVar5 = unk_0xB5B60A04E1654409(uParam0->f_23[0], "chassis_dummy");
				vVar6 = { unk_0x3EA3A28A85F8C32F(uParam0->f_23[0], iVar5) };
				iVar2 = unk_0xD0D858E538FD01C3(vVar6, unk_0xD7490CDEF40F3DA2(uParam0->f_23[0], 2), 2);
				unk_0xC2BF3DE5E47F801D(iVar2, true);
				unk_0x69D4A898629B0BDA(iVar2, false);
				unk_0xB62398E536F695FC(uParam0->f_1C[0], iVar2, sVar3, "hao_base", 8f, -8f, 9, 16, 1148846080, 0);
...
void func_233(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE6BC
{
	func_193(iParam0);
...
void func_234(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE6E3
{
	func_235(iParam0);
...
void func_235(int iParam0)//Position - 0xE725
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_236(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xE7C1
{
...
int func_237(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xE81D
{
	int iVar0;
...
int func_238(var uParam0, int iParam1)//Position - 0xE8AB
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xE8F1
{
	int iVar0;
...
int func_240(int iParam0)//Position - 0xE922
{
	int iVar0;
...
int func_241(int iParam0)//Position - 0xE98A
{
	struct<27> Var0;
	int iVar1;
...
int func_242(int iParam0)//Position - 0xE9DE
{
	char* sVar0;
...
int func_243(int iParam0)//Position - 0xEA97
{
	var uVar0;
...
bool func_245(int iParam0, char* sParam1)//Position - 0xEBDD
{
...
bool func_246(int iParam0)//Position - 0xECBF
{
...
bool func_247(int iParam0)//Position - 0xECED
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_248(int iParam0)//Position - 0xED1B
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_249(int iParam0)//Position - 0xED49
{
	if (func_225(iParam0))
	{
		return 0;
...
void func_250()//Position - 0xED7E
{
	func_267("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_251(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xED98
{
	int iVar0;
...
int func_252(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xEDFD
{
	int iVar0;
	struct<7> Var1;
...
int func_253(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xEE7B
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_254(int iParam0, bool bParam1)//Position - 0xEEF6
{
	if (bParam1)
	{
	...
	unk_0x483687B0FCA5415A(iLocal_54, 0);
	if (bParam1)
	{
		func_190(*iParam0);
	}
...
void func_255(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEF4A
{
...
void func_256(var uParam0, bool bParam1)//Position - 0xEF6A
{
	func_257(&(uParam0->f_29), bParam1);
}

void func_257(var uParam0, bool bParam1)//Position - 0xEF7C
{
	int iVar0;
...
void func_258(int iParam0, bool bParam1)//Position - 0xEFBA
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_259(var uParam0, bool bParam1)//Position - 0xEFF5
{
	func_260(&(uParam0->f_23), bParam1);
}

void func_260(var uParam0, bool bParam1)//Position - 0xF007
{
	int iVar0;
...
void func_261(int iParam0)//Position - 0xF044
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_262(var uParam0, int iParam1)//Position - 0xF07C
{
	func_263(&(uParam0->f_1C), iParam1);
}

void func_263(var uParam0, int iParam1)//Position - 0xF08E
{
	int iVar0;
...
void func_264(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF0CF
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_265(int iParam0)//Position - 0xF11F
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_266(var uParam0)//Position - 0xF160
{
	if (*uParam0 == -1)
	{
		return;
...
void func_267(char* sParam0)//Position - 0xF19D
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_268(var uParam0)//Position - 0xF1AF
{
	*uParam0 = -1;
...
void func_269()//Position - 0xF1E2
{
	func_267("Running start routines.");
	Global_199EA++;
}

int func_270(int iParam0)//Position - 0xF1FC
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
