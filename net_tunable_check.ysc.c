...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		if (func_6() || Global_1992D6 == 1)
		{
			func_5();
		}
		if (func_1(&uLocal_21, &Global_45E50))
		{
			func_5();
		}
		SYSTEM::WAIT(0);
			...
			while (iVar2 <= iVar6)
			{
				if (iVar2 < iVar5)
				{
					...
					if (iVar2 >= Var3.f_4 && iVar2 != 27)
					{
						...
						{
							if (unk_0xB9793C8C873D8F73(iVar7, Var3.f_5, &fVar0))
							{
							...
							else if (unk_0xBB289F583CADD055(iVar7, Var3.f_5, &iVar1))
							{
