...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_283(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_266(&Var0, 1);
	}
	...
	while (true)
	{
		...
		{
			case 0:
				func_188(&Var2, &(Var0.f_1C[0]), "SONAR_PRE");
				break;
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6188
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x61CF
{
...
bool func_70(int iParam0)//Position - 0x622A
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x623A
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x629A
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x658E
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x6599
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x65A9
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x664B
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6C05
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6C63
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6D11
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6DA6
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6DEA
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6F6E
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6F7C
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7A43
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7AC5
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7B23
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7B2C
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7CFF
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7D0F
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7FA9
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x7FBA
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x8000
{
	if (iParam1 <= 0)
	{
		return;
...
void func_104(char* sParam0, var uParam1, int iParam2)//Position - 0x8318
{
...
int func_183(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC83F
{
	var uVar0;
	
	if ((((func_124(unk_0xBC25C936A095B5BA()) && func_124(uParam0->f_1C[0])) && !func_143()) && (unk_0x105601648511CC64() - uParam0->f_3C) > iParam6) && func_187(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_184(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC8C7
{
...
void func_185(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC902
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_186(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC958
{
...
float func_187(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC9F3
{
	vector3 vVar0;
...
void func_188(int iParam0, var uParam1, char* sParam2)//Position - 0xCA2D
{
	if (func_124(*uParam1) && func_124(unk_0xBC25C936A095B5BA()))
	{
		...
		{
			case 0:
				iParam0->f_A6 = (unk_0x105601648511CC64() + unk_0x491B2241281A03B7(1000, 2000));
				func_186(&(iParam0->f_1), 3, *uParam1, "ABIGAIL", 0, 1);
				unk_0xE896C0AD02364F2A(*uParam1, cLocal_55, "base", 1000f, -8f, -1, 1, 0, 0, 0, 0);
				*iParam0 = 1;
				break;
			
			case 1:
				if (unk_0x105601648511CC64() > iParam0->f_A6)
				{
					if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						unk_0xE896C0AD02364F2A(*uParam1, cLocal_55, "intro", 8f, -8f, -1, 2, 0, 0, 0, 0);
						*iParam0 = 3;
					}
				...
				if (unk_0x96044E39418AAF17(*uParam1, cLocal_55, "outro", 3) && unk_0x4A3B2CF8BADDD74E(*uParam1, cLocal_55, "outro") > 0.99f)
				{
					unk_0xE896C0AD02364F2A(*uParam1, cLocal_55, "base", 8f, -8f, -1, 1, 0, 0, 0, 0);
				}
				break;
			
			case 3:
				if (unk_0x96044E39418AAF17(*uParam1, cLocal_55, "intro", 3) && unk_0x4A3B2CF8BADDD74E(*uParam1, cLocal_55, "intro") > 0.99f)
				{
					*iParam0 = 4;
				}
				break;
			...
			case 4:
				if (func_189(&(iParam0->f_1), "SONARAU", sParam2, 4, 0, 0, 0))
				{
					if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						unk_0xE896C0AD02364F2A(*uParam1, cLocal_55, "loop_talk", 8f, -8f, -1, 1, 0, 0, 0, 0);
					}
					*iParam0 = 5;
				}
				break;
			...
			case 5:
				if (!func_143())
				{
					if (unk_0x96044E39418AAF17(*uParam1, cLocal_55, "loop_talk", 3))
					{
						if (unk_0x4A3B2CF8BADDD74E(*uParam1, cLocal_55, "loop_talk") > 0.99f)
						{
							iParam0->f_A6 = (unk_0x105601648511CC64() + unk_0x491B2241281A03B7(7000, 10000));
							if (!unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), vLocal_52, vLocal_53, 8f, 0, true, 0))
							{
								unk_0xE896C0AD02364F2A(*uParam1, cLocal_55, "outro", 8f, -8f, -1, 2, 0, 0, 0, 0);
								*iParam0 = 1;
							}
							else
							{
								unk_0xE896C0AD02364F2A(*uParam1, cLocal_55, "loop_look", 8f, -8f, -1, 1, 0, 0, 0, 0);
								*iParam0 = 2;
							}
						}
					}
			...
			case 2:
				if (unk_0x96044E39418AAF17(*uParam1, cLocal_55, "loop_look", 3) && unk_0x4A3B2CF8BADDD74E(*uParam1, cLocal_55, "loop_look") > 0.99f)
				{
					if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), vLocal_52, vLocal_53, 8f, 0, true, 0))
					{
						if (unk_0x105601648511CC64() > iParam0->f_A6)
...
bool func_189(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xCD29
{
...
int func_190(char* sParam0, int iParam1, bool bParam2)//Position - 0xCD77
{
	Global_3DB9 = 0;
...
float func_196(int iParam0, int iParam1, bool bParam2)//Position - 0xD29D
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_197(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xD2FB
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
...
void func_198(int iParam0, bool bParam1)//Position - 0xD3EC
{
	if (iParam0 == -1)
	{
		return;
...
int func_199(int iParam0)//Position - 0xD428
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_200(int iParam0, int iParam1)//Position - 0xD461
{
	bool bVar0;
	int iVar1;
...
bool func_201()//Position - 0xD4FF
{
	return Global_16129;
}

void func_202(int iParam0)//Position - 0xD50B
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_203(iParam0);
...
void func_203(int iParam0)//Position - 0xD522
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_204(int iParam0)//Position - 0xD60A
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_205(int iParam0, bool bParam1)//Position - 0xD632
{
	struct<27> Var0;
...
void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD8A5
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0)//Position - 0xDBFD
{
...
int func_208(var uParam0)//Position - 0xDC1D
{
...
int func_209(var uParam0)//Position - 0xDC35
{
...
void func_210(var uParam0)//Position - 0xDC5A
{
	int iVar0;
	int iVar1;
...
void func_211(int iParam0)//Position - 0xDF58
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_212(var uParam0)//Position - 0xDF83
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, bool bParam2)//Position - 0xE003
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1)//Position - 0xE1C1
{
	int iVar0;
...
int func_215(var uParam0, bool bParam1, int iParam2)//Position - 0xE1F1
{
	int iVar0;
	int iVar1;
...
int func_216(int iParam0)//Position - 0xE4AD
{
...
int func_217(int iParam0, float fParam1)//Position - 0xE4E1
{
	float fVar0;
...
bool func_218(int iParam0, float fParam1)//Position - 0xE557
{
	return func_219(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_219(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE56F
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_220(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE630
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_221(int iParam0, int iParam1)//Position - 0xE75C
{
	int iVar0;
...
int func_223(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE86B
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_224(vector3 vParam0, vector3 vParam1)//Position - 0xE8FC
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_225(vector3 vParam0)//Position - 0xE91D
{
	float fVar0;
	float fVar1;
...
void func_226(var uParam0)//Position - 0xE95C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_227(int iParam0, int iParam1)//Position - 0xE977
{
	int iVar0;
...
int func_228(int iParam0)//Position - 0xE9B6
{
...
int func_229(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE9DE
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_230(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEAD9
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_231(int iParam0, float fParam1)//Position - 0xEBE5
{
	var uVar0;
	vector3 vVar1;
...
int func_232(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xEC7A
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_233(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xED08
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_234(int iParam0)//Position - 0xED50
{
...
void func_235(int iParam0)//Position - 0xED9A
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0xEE37
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_237(int iParam0)//Position - 0xEECF
{
...
int func_240(int iParam0)//Position - 0xEF51
{
	if ((func_241() && Global_16B1B.f_B == 6) && iParam0 == func_162(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_242(int iParam0)//Position - 0xEFC3
{
	if (func_105(0))
	{
...
int func_243(int iParam0)//Position - 0xEFEB
{
	switch (*iParam0)
	{
		case 0:
...
int func_244(var uParam0)//Position - 0xF032
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			unk_0x522053D86D6E1C7A(cLocal_55);
			func_251(&(uParam0->f_30), cLocal_55, "base", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_250(&iVar0) || !unk_0xF9E082857622D91E(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (!func_247(&(uParam0->f_1C[0]), 16, -1596.09f, 5218.102f, 3.045f, 125.5f, "RC ABIGAIL 2", 1))
				{
					bVar2 = false;
				}
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_245(&(uParam0->f_23[0]), iVar0[1], -1584.013f, 5158.539f, 18.6057f, 210.5309f);
				unk_0xD421BC740C5340C3(uParam0->f_23[0], 3);
				unk_0x6012A6A4F2950585(uParam0->f_23[0], 1);
				unk_0x6FA721E3E050370C(uParam0->f_23[0], 1);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_245(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF1E4
{
	func_246(iParam0);
...
void func_246(int iParam0)//Position - 0xF226
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xF2C2
{
...
int func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xF31E
{
	int iVar0;
...
int func_249(var uParam0, int iParam1)//Position - 0xF3AC
{
	int iVar0;
...
int func_250(int iParam0)//Position - 0xF3F2
{
	int iVar0;
...
void func_251(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF423
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_252(var uParam0)//Position - 0xF45F
{
	int iVar0;
	bool bVar1;
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!unk_0xD6513D668481290A(iVar0) || !unk_0xF9E082857622D91E(cLocal_55))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (!func_247(&(uParam0->f_1C[0]), 16, -1607.918f, 5243.162f, 3.045f, 125.5f, "RC ABIGAIL 1", 1))
				{
					bVar1 = false;
				}
			}
...
int func_253(int iParam0)//Position - 0xF56A
{
	struct<27> Var0;
	int iVar1;
...
int func_254(int iParam0)//Position - 0xF5BE
{
	char* sVar0;
...
int func_255(int iParam0)//Position - 0xF677
{
	var uVar0;
...
int func_256(int iParam0)//Position - 0xF738
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_257(int iParam0, char* sParam1)//Position - 0xF7BD
{
...
bool func_258(int iParam0)//Position - 0xF89F
{
...
bool func_259(int iParam0)//Position - 0xF8CD
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_260(int iParam0)//Position - 0xF8FB
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_261(int iParam0)//Position - 0xF929
{
	if (func_237(iParam0))
	{
		return 0;
...
void func_262()//Position - 0xF95E
{
	func_284("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_263(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF978
{
	int iVar0;
...
int func_264(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xF9DD
{
	int iVar0;
	struct<7> Var1;
...
int func_265(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xFA5B
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_266(int iParam0, bool bParam1)//Position - 0xFAD6
{
	char* sVar0;
...
void func_267(char* sParam0)//Position - 0xFB5D
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
		if (func_270(sParam0))
...
void func_268()//Position - 0xFB7C
{
	Global_394A = 0;
	func_269();
}

void func_269()//Position - 0xFB8C
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
int func_270(char* sParam0)//Position - 0xFBAD
{
	struct<6> Var0;
...
struct<6> func_271()//Position - 0xFBCD
{
	struct<6> Var0;
...
void func_272(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFBF1
{
...
void func_273(var uParam0, bool bParam1)//Position - 0xFC11
{
	func_274(&(uParam0->f_29), bParam1);
}

void func_274(var uParam0, bool bParam1)//Position - 0xFC23
{
	int iVar0;
...
void func_275(int iParam0, bool bParam1)//Position - 0xFC61
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_276(var uParam0, bool bParam1)//Position - 0xFC9C
{
	func_277(&(uParam0->f_23), bParam1);
}

void func_277(var uParam0, bool bParam1)//Position - 0xFCAE
{
	int iVar0;
...
void func_278(int iParam0)//Position - 0xFCEB
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_279(var uParam0, int iParam1)//Position - 0xFD23
{
	func_280(&(uParam0->f_1C), iParam1);
}

void func_280(var uParam0, int iParam1)//Position - 0xFD35
{
	int iVar0;
...
void func_281(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFD76
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_282(int iParam0)//Position - 0xFDC6
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_283(var uParam0)//Position - 0xFE07
{
	if (*uParam0 == -1)
	{
		return;
...
void func_284(char* sParam0)//Position - 0xFE44
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_285(var uParam0)//Position - 0xFE56
{
	*uParam0 = -1;
...
void func_286()//Position - 0xFE89
{
	func_284("Running start routines.");
	Global_199EA++;
}

int func_287(int iParam0)//Position - 0xFEA3
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
