...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_373 = unk_0x20839301BD7D82F0(iLocal_368);
	iLocal_374 = unk_0x20839301BD7D82F0(iLocal_369);
	...
	while (true)
	{
		...
		func_461();
		if (unk_0x724D816EA203A79E(Local_48.f_2))
		{
...
void func_1()//Position - 0x3E3
{
	...
	switch (Local_43.f_1)
	{
		case 0:
			...
			if (unk_0x3362CDE8460ED38B(sVar0, sLocal_381))
			{
				func_500(1);
			}
			else
...
void func_2(bool bParam0)//Position - 0x4A3
{
	if (Local_45.f_4 == 1)
	{
		...
		{
			if (unk_0x724D816EA203A79E(Local_45))
			{
				if (func_460(Local_45))
				{
					unk_0x2E35C4FA5F0ED22F(Local_45, false);
...
void func_10(bool bParam0)//Position - 0x71B
{
	...
	{
		unk_0xB71D41C0310C93DE(Local_48.f_2, false, 1);
	}
	if (bParam0)
	{
		func_7(&(Local_48.f_2));
	...
	unk_0x38FF8CB6377D36F6(Local_48.f_6);
	unk_0x38FF8CB6377D36F6(Local_48.f_7);
	Local_48 = 0;
}
...
void func_17()//Position - 0x847
{
	switch (Local_43.f_1)
	{
		case 0:
			if (func_460(Local_48.f_2))
			{
				...
				if (func_220(&uLocal_199, "SAS1AUD", "SAS1_LEADOUT", 8, 0, 0, 0))
				{
					...
					iLocal_189 = unk_0x105601648511CC64() + 5000;
					Local_43.f_1 = 1;
				}
			}
			else
		...
		case 1:
			if ((unk_0x105601648511CC64() > iLocal_189 && !func_18()) || !func_460(Local_48.f_2))
			{
				func_19();
			}
			break;
...
void func_24()//Position - 0xBC2
{
	...
	{
		func_26(13, SYSTEM::FLOOR(Global_19B04.f_27B5.f_F0D));
	}
...
int func_28()//Position - 0x15F1
{
	return Global_1407E0;
}

void func_29()//Position - 0x15FD
{
	func_46();
	func_38();
	func_34();
...
void func_30(int iParam0)//Position - 0x1656
{
	if (iParam0 == 1)
	{
...
void func_32()//Position - 0x169D
{
	StringCopy(&Global_1162A, "", 16);
	StringCopy(&Global_1162E, "", 16);
}

void func_33()//Position - 0x16B7
{
	int iVar0;
...
void func_37(int iParam0)//Position - 0x1789
{
	if (iParam0 == 1)
	{
		Global_8E66 = 1;
...
void func_38()//Position - 0x17A2
{
	func_39(&Global_181DF);
}

void func_39(var uParam0)//Position - 0x17B2
{
	int iVar0;
	int iVar1;
...
void func_40(var uParam0)//Position - 0x1D42
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_41(var uParam0)//Position - 0x1D5D
{
	func_42(&(uParam0->f_C));
	*uParam0 = { 0f, 0f, 0f };
...
void func_42(var uParam0)//Position - 0x1D8C
{
	int iVar0;
...
void func_43(var uParam0)//Position - 0x1E3C
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_44(var uParam0)//Position - 0x1E5A
{
	int iVar0;
...
void func_45(var uParam0)//Position - 0x1F3A
{
	*uParam0 = -15;
}

void func_46()//Position - 0x1F48
{
	StringCopy(&Global_1763E, "", 32);
	func_39(&Global_17646);
}

void func_47()//Position - 0x1F61
{
...
int func_49(int iParam0, int iParam1, int iParam2)//Position - 0x209F
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_50(int iParam0, int iParam1, int iParam2)//Position - 0x225C
{
	int iVar0;
...
int func_52(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x2323
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_53(int iParam0, int iParam1, int iParam2)//Position - 0x2B2F
{
	int iVar0;
	int iVar1;
...
int func_54(int iParam0, int iParam1, int iParam2)//Position - 0x2BB9
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_55(int iParam0, int iParam1, int iParam2)//Position - 0x2C97
{
	Global_11489[1 /*14*/] = { func_100(iParam0, iParam1, iParam2) };
	return unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 2);
}

int func_56(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x2CC1
{
	var uVar0;
	int iVar1;
...
int func_57(int iParam0, int iParam1, int iParam2)//Position - 0x32C5
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_58(int iParam0, int iParam1, int iParam2)//Position - 0x335E
{
	int iVar0;
	int iVar1;
...
int func_59(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x33FF
{
	int iVar0;
...
int func_60(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x3706
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_61(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x42BA
{
	int iVar0;
...
int func_62(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x459E
{
	int iVar0;
...
int func_63(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4865
{
	int iVar0;
	int iVar1;
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x489C
{
	int iVar0;
...
int func_65(int iParam0, int iParam1, int iParam2)//Position - 0x48C5
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_66(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4B8F
{
	int iVar0;
...
int func_67(int iParam0, int iParam1, int iParam2)//Position - 0x4E19
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_68(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4F70
{
	int iVar0;
...
int func_69(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5008
{
	switch (iParam0)
	{
...
int func_70(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x50D6
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_71(int iParam0, int iParam1)//Position - 0x5232
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_72(int iParam0)//Position - 0x55D9
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_73(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x563A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_74(int iParam0, int iParam1)//Position - 0x5736
{
	int iVar0;
...
int func_75(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5874
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
...
int func_76(int iParam0)//Position - 0x5954
{
	switch (iParam0)
	{
		case 0:
...
int func_77(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x59DA
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5C57
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_79(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x607C
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_80(int iParam0, int iParam1)//Position - 0x636F
{
	int iVar0;
	int iVar1;
...
int func_81(int iParam0, int iParam1)//Position - 0x63B5
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_82(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6415
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_83(int iParam0)//Position - 0x6499
{
...
void func_84(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x6551
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_85(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x659B
{
	int iVar0;
...
int func_86(var uParam0)//Position - 0x65CB
{
	int iVar0;
	int iVar1;
...
int func_87(int iParam0, int iParam1, int iParam2)//Position - 0x65FF
{
	int iVar0;
	var uVar1;
...
bool func_88(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x6631
{
	int iVar0;
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x7F28
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_90(int iParam0)//Position - 0x8E48
{
	if (!unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_91(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x8E99
{
	int iVar0;
...
int func_92(int iParam0)//Position - 0x8F2F
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_93(int iParam0, int iParam1)//Position - 0x8FDF
{
	int iVar0;
	struct<10> Var1;
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x990E
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_95(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x9A38
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_96(int iParam0, int iParam1)//Position - 0x9A80
{
	int iVar0;
	struct<17> Var1;
...
void func_97(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xB8C8
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_98(int iParam0)//Position - 0xBAB2
{
	switch (iParam0)
	{
		case 0:
...
void func_99(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xBB62
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_100(int iParam0, int iParam1, int iParam2)//Position - 0xBBD3
{
	func_164();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_101(int iParam0, int iParam1)//Position - 0xBC25
{
	switch (iParam0)
	{
		case 0:
...
void func_102(int iParam0)//Position - 0xBD15
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_212(char* sParam0)//Position - 0x269A1
{
...
void func_215(int iParam0, int iParam1)//Position - 0x26BC5
{
...
int func_216(char* sParam0)//Position - 0x26C02
{
	int iVar0;
...
int func_217()//Position - 0x26C62
{
	return func_218(unk_0x1377080E9B0BD993(), 0);
}

int func_218(char* sParam0, int iParam1)//Position - 0x26C73
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_219(int iParam0)//Position - 0x26CBC
{
	bool bVar0;
	int iVar1;
...
bool func_220(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x26D2D
{
...
int func_221(char* sParam0, int iParam1, bool bParam2)//Position - 0x26D7B
{
	Global_3DB9 = 0;
...
void func_222()//Position - 0x27047
{
	int iVar0;
...
void func_223()//Position - 0x27078
{
...
void func_226()//Position - 0x271CD
{
	if (func_108(14))
	{
...
int func_227()//Position - 0x2726F
{
	func_171();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_228()//Position - 0x27288
{
	int iVar0;
...
bool func_229(int iParam0, int iParam1)//Position - 0x272DF
{
	switch (iParam0)
	{
		case 5:
...
void func_230()//Position - 0x2731A
{
...
void func_231(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27371
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_232(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x273C7
{
...
void func_233()//Position - 0x27462
{
	int iVar0;
	int iVar1;
	...
	if (Local_43.f_3 == 1)
	{
		...
		while (!unk_0x724D816EA203A79E(Local_48.f_2))
		{
			func_361();
			SYSTEM::WAIT(0);
		}
		...
		unk_0xF243B7A14FCFD0F4(iLocal_377);
		...
		{
			func_340(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), 1112014848, 12, 5000, 0, 0);
		}
		Local_43.f_3 = 0;
	}
	if (Local_43.f_1 == 0)
	{
		...
		if (func_350(1, 1093140480, 0))
		{
			if (bLocal_180)
			{
				...
				SYSTEM::WAIT(3000);
				if (unk_0x724D816EA203A79E(Local_48.f_2) && unk_0x36CEFBE9B745A58D(Local_48.f_2))
				{
					unk_0x40B3D329C98E709B(Local_48.f_2);
				}
				if (func_460(Local_48.f_2))
				{
					unk_0x65E471E4A2D56226(Local_48.f_2, 110, 0);
					unk_0x538BB037E00A3AD9(Local_48.f_2, "Orleans", 0, 0, 0);
				}
				unk_0x221770099EEC44A2(vLocal_49, 0);
				SYSTEM::WAIT(0);
				unk_0x2E94C9549322098D("SF_TheLastOne", 0);
			...
			else
			{
				...
				if (func_460(Local_48.f_2))
				{
					unk_0x65E471E4A2D56226(Local_48.f_2, 110, 0);
					unk_0x538BB037E00A3AD9(Local_48.f_2, "Orleans", 0, 0, 0);
					unk_0xC5B089214CCF7A47(Local_48.f_2, 0, 1, 1);
					unk_0xC5B089214CCF7A47(Local_48.f_2, 1, 1, 0);
					unk_0xC5B089214CCF7A47(Local_48.f_2, 8, 1, 0);
					unk_0xC5B089214CCF7A47(Local_48.f_2, 7, 1, 0);
				}
			...
			func_8(0);
			func_2(1);
			iLocal_411 = unk_0x105601648511CC64() + 500;
			iLocal_412 = 1;
			iVar0 = unk_0x3E12B546F3F2597A();
			unk_0x6C5F5B5F6894CCE3(vLocal_386, 200f, 1, 0, 0, false);
			iLocal_197 = (unk_0x076EEED630DD25B7() - 300);
			iLocal_198 = 1;
			if (func_328(iVar0))
			{
				unk_0x641B19E156645A92(iVar0, vLocal_386, 1, false, 0, 1);
				unk_0x019CE76D5286C95C(iVar0, fLocal_387);
	...
	if (Local_43.f_1 == 1)
	{
		...
		{
			iLocal_385 = unk_0x3E12B546F3F2597A();
			if (!func_328(iLocal_385) && unk_0xD6513D668481290A(iLocal_377))
			{
				iLocal_385 = unk_0x61C05BF08A1E0EFE(iLocal_377, vLocal_386, fLocal_387, true, true, false);
				if (func_328(iLocal_385))
				{
					unk_0x6012A6A4F2950585(iLocal_385, 1);
				}
			}
		}
		if (func_327())
		{
			if (iLocal_198)
			{
				if (unk_0xADE6C4641AFD481C() > iLocal_197)
				{
		...
		if (func_460(Local_48.f_2))
		{
			if (unk_0x3F3252765FE36DA8("Orleans", 0))
			{
				...
				unk_0xC8FD3EBBB90E8D7F(Local_48.f_2, 185, true);
				unk_0x12D2D85EBAC186AA(Local_48.f_2, 0);
				unk_0xC5A6DFE2B8987B17(&iVar1);
				unk_0xE896C0AD02364F2A(0, sLocal_380, "leadout_sas_3_rcm_sas", 1000f, -8f, -1, 17039368, 0, 0, 1, 0);
				unk_0xE896C0AD02364F2A(0, sLocal_380, "sas_idle_sit", 1000f, -1000f, -1, 17039369, 0, 0, 1, 0);
				unk_0x535008C596714F9E(iVar1);
				unk_0xA8E6405305C0D7DF(Local_48.f_2, iVar1);
				unk_0x02DAF06EA4F08219(&iVar1);
				unk_0x2EB4D46478766D87(Local_48.f_2, 1, 0);
				unk_0x8EF3D958386640FE(Local_48.f_2, 0);
				unk_0x84518BC4397AB1AC(Local_48.f_2, 1, 0.81f, 0.733f, 1);
				unk_0x84518BC4397AB1AC(Local_48.f_2, 0, 0.94f, 0.59f, 1);
				if (func_460(unk_0xBC25C936A095B5BA()) && unk_0x3F3252765FE36DA8("FRANKLIN", 0))
				{
					unk_0x56F2E1B5599188FA(unk_0xBC25C936A095B5BA(), Local_48.f_2, -1, 2050, 4);
					unk_0x56F2E1B5599188FA(Local_48.f_2, unk_0xBC25C936A095B5BA(), -1, 2050, 4);
				}
			}
			if (iLocal_412)
			{
				if (unk_0x105601648511CC64() > iLocal_411)
				{
					unk_0xB0031DDAE4FF0BC3(Local_48.f_2, 0, 1, 1, 0);
					unk_0xB0031DDAE4FF0BC3(Local_48.f_2, 1, 1, 0, 0);
					unk_0xB0031DDAE4FF0BC3(Local_48.f_2, 8, 1, 0, 0);
					unk_0xB0031DDAE4FF0BC3(Local_48.f_2, 7, 1, 0, 0);
					iLocal_412 = 0;
				}
			}
		}
...
void func_234()//Position - 0x27A5C
{
...
void func_235(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x27B25
{
	int iVar0;
...
int func_236(int iParam0)//Position - 0x27BCD
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
...
void func_237(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x27BEE
{
	if (bParam0)
	{
...
bool func_238()//Position - 0x27D17
{
	return unk_0xFA30DFD0084E92FE(Global_18402B[unk_0xB5CEFD608600A09F() /*770*/].f_27.f_12, 14);
}

bool func_239(int iParam0, int iParam1)//Position - 0x27D34
{
	bool bVar0;
...
int func_240(int iParam0, bool bParam1)//Position - 0x27D7F
{
	int iVar0;
	int iVar1;
...
int func_241(int iParam0)//Position - 0x27DC0
{
...
bool func_242()//Position - 0x27E02
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_243(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x27E13
{
	int iVar0;
...
void func_244(int iParam0)//Position - 0x27E46
{
	if (iParam0 == 1)
	{
...
void func_245(int iParam0)//Position - 0x27E69
{
	Local_43.f_8 = iParam0;
}

void func_246()//Position - 0x27E77
{
	func_366(1, 1);
	func_10(1);
	func_8(1);
	func_2(1);
	func_324(&(Local_44.f_23[0]));
	func_365();
	while (!func_364())
	{
		SYSTEM::WAIT(0);
	...
	unk_0x3F5F1772D71D5EC4(Local_48.f_3, 1f);
...
void func_247(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27FA7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_218(unk_0x1377080E9B0BD993(), 1);
			if (iVar4 != -1)
			{
...
void func_248(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2811D
{
	func_249(&Global_181DF, unk_0x1377080E9B0BD993(), iParam0, uParam1, iParam3, iParam2);
}

void func_249(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x28139
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_227();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_271())
		{
			func_267(unk_0xBC25C936A095B5BA(), &(uParam0->f_268[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
int func_250(var uParam0)//Position - 0x28FC1
{
...
void func_251(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28FE3
{
	int iVar0;
...
int func_252(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2906B
{
...
int func_253(int iParam0)//Position - 0x290AB
{
	int iVar0;
...
void func_254(var uParam0, int iParam1, int iParam2)//Position - 0x290D9
{
...
int func_255(int iParam0)//Position - 0x291B5
{
	int iVar0;
...
int func_256(int iParam0)//Position - 0x291F7
{
	int iVar0;
...
int func_257(int iParam0, int iParam1, int iParam2)//Position - 0x2925A
{
	int iVar0;
...
int func_258(int iParam0, int iParam1)//Position - 0x292E8
{
	struct<82> Var0;
...
void func_259(int iParam0, var uParam1, int iParam2)//Position - 0x2932A
{
	int iVar0;
...
void func_260(int iParam0, var uParam1)//Position - 0x29586
{
	int iVar0;
...
int func_261(int iParam0)//Position - 0x29831
{
	switch (iParam0)
	{
		case 1:
...
int func_262(int iParam0, var uParam1, var uParam2)//Position - 0x298E1
{
	int iVar0;
	int iVar1;
...
int func_263(int iParam0)//Position - 0x299BB
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_264(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x299DB
{
	char* sVar0;
...
int func_265(int iParam0, int iParam1, bool bParam2)//Position - 0x29B0A
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_266(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x29B7B
{
...
void func_267(int iParam0, var uParam1, int iParam2)//Position - 0x29C53
{
	int iVar0;
	int iVar1;
...
int func_268(int iParam0, int iParam1)//Position - 0x29DFD
{
	int iVar0;
	var uVar1;
	
	iVar0 = Global_2705A2[iParam0 /*3*/][func_86(iParam1)];
...
void func_269(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x29E29
{
	int iVar0;
...
void func_270(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2A371
{
	int iVar0;
...
int func_271()//Position - 0x2A5B2
{
	func_171();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_272(int iParam0, bool bParam1)//Position - 0x2A5CB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_168(iVar0) && !unk_0x36CEFBE9B745A58D(iParam0))
	{
		if (iParam0 == unk_0xBC25C936A095B5BA())
		{
			func_273(iParam0, &(Global_19B04.f_932.f_21B.f_12A[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_273(int iParam0, var uParam1)//Position - 0x2A6BE
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!unk_0x36CEFBE9B745A58D(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0xFEBBB8B5E3A12A20(iParam0, func_278(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
...
int func_274(int iParam0)//Position - 0x2A948
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_275(int iParam0)//Position - 0x2A9E3
{
	if (unk_0x7AF0088ABFA713B6())
	{
	}
...
int func_276(int iParam0, int iParam1)//Position - 0x2AB57
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_277(int iParam0, var uParam1)//Position - 0x2B6C8
{
	int iVar0;
	int iVar1;
...
int func_278(int iParam0)//Position - 0x2B703
{
	int iVar0;
...
void func_279(int iParam0)//Position - 0x2B977
{
	int iVar0;
...
void func_280(var uParam0, int iParam1)//Position - 0x2B9B3
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_281(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x2BF0E
{
	int iVar0;
	int iVar1;
...
bool func_282(int iParam0, var uParam1, var uParam2)//Position - 0x2BF52
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_283(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x2C6B9
{
	if (bParam2)
	{
...
int func_284(var uParam0)//Position - 0x2C700
{
...
bool func_285(int iParam0)//Position - 0x2C75B
{
	return func_286(iParam0, 0, 1);
}

int func_286(int iParam0, int iParam1, bool bParam2)//Position - 0x2C76B
{
	if (bParam2)
	{
...
int func_287(int iParam0)//Position - 0x2C7CB
{
	switch (iParam0)
	{
		case 0:
...
int func_288(int iParam0)//Position - 0x2CABF
{
	return func_286(iParam0, 5, 1);
}

int func_289(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x2CACF
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_290(int iParam0, bool bParam1)//Position - 0x2CB71
{
	switch (iParam0)
	{
		case -1:
...
int func_291(int iParam0)//Position - 0x2D12B
{
	if (iParam0 != func_300())
	{
...
Vector3 func_292(int iParam0, int iParam1)//Position - 0x2D189
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_293(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2D237
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_294(vector3 vParam0, float fParam1)//Position - 0x2D2CC
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_295(int iParam0)//Position - 0x2D310
{
	struct<6> Var0;
...
struct<6> func_296(int iParam0)//Position - 0x2D494
{
	return func_297(iParam0);
}

struct<6> func_297(int iParam0)//Position - 0x2D4A2
{
	struct<6> Var0;
...
int func_298(int iParam0, var uParam1)//Position - 0x2DF69
{
	switch (iParam0)
	{
		case 0:
...
int func_299(int iParam0)//Position - 0x2DFEB
{
	if (iParam0 != func_300())
	{
...
int func_300()//Position - 0x2E049
{
	return -1;
}

Vector3 func_301(int iParam0)//Position - 0x2E052
{
	switch (iParam0)
	{
		case 1:
...
int func_302(int iParam0)//Position - 0x2E225
{
	return func_286(iParam0, 0, 0);
}

int func_303(int iParam0)//Position - 0x2E235
{
	switch (iParam0)
	{
		case -1:
...
bool func_304()//Position - 0x2E4CF
{
	return Global_16B4F.f_141 > 0;
}

var func_305()//Position - 0x2E4E0
{
	var uVar0;
...
void func_306(var uParam0, int iParam1)//Position - 0x2E526
{
	if (iParam1 <= 0)
	{
		return;
...
void func_307(var uParam0, int iParam1)//Position - 0x2E5AC
{
...
void func_308(var uParam0, int iParam1)//Position - 0x2E5DF
{
	int iVar0;
	int iVar1;
...
int func_309(int iParam0, int iParam1)//Position - 0x2E630
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_310(int iParam0)//Position - 0x2E6D2
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_311(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_311(bool bParam0, int iParam1, int iParam2)//Position - 0x2E6F7
{
	if (bParam0)
	{
		return iParam1;
...
int func_312(var uParam0)//Position - 0x2E70E
{
	return uParam0 & 15;
}

void func_313(var uParam0, int iParam1)//Position - 0x2E71B
{
...
void func_315(var uParam0, int iParam1)//Position - 0x2E790
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_316(char* sParam0)//Position - 0x2E7CC
{
...
int func_317(int iParam0)//Position - 0x2E822
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_318(Global_19B04.f_2360.f_63.f_CD[10]);
			break;
		
		case 74:
		case 75:
			return func_318(Global_19B04.f_2360.f_63.f_CD[8]);
			break;
		
		case 84:
		case 85:
			return func_318(Global_19B04.f_2360.f_63.f_CD[11]);
			break;
		
		case 90:
			return func_318(Global_19B04.f_2360.f_63.f_CD[7]);
			break;
		
		case 93:
			return func_318(Global_19B04.f_2360.f_63.f_CD[9]);
			break;
	}
	return 0;
}

int func_318(int iParam0)//Position - 0x2E8DE
{
	switch (iParam0)
	{
		case 1:
...
int func_319(char* sParam0, bool bParam1)//Position - 0x2E932
{
	int iVar0;
	int iVar1;
...
int func_320(int iParam0, bool bParam1)//Position - 0x2E95C
{
	int iVar0;
...
void func_321(bool bParam0)//Position - 0x2E992
{
	int iVar0;
	int iVar1;
...
int func_322(int iParam0, bool bParam1, bool bParam2, int iParam3)//Position - 0x2EC14
{
	int iVar0;
	bool bVar1;
...
int func_323(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)//Position - 0x2EC66
{
	bool bVar0;
	float fVar1;
...
void func_324(int iParam0)//Position - 0x2ECC2
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x5CAE759AE8219D20(*iParam0))
...
Vector3 func_325(int iParam0, vector3 vParam1)//Position - 0x2ED5E
{
	var uVar0;
...
bool func_326(int iParam0)//Position - 0x2EDA4
{
	if (!unk_0x724D816EA203A79E(iParam0))
	{
		return 0;
...
int func_328(int iParam0)//Position - 0x2EDDB
{
	if (func_236(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
void func_329(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2EE05
{
	func_330(vParam0, vParam1, fParam2, vParam3, fParam4, vParam5, bParam6, bParam7, bParam8, bParam9, bParam10);
}

void func_330(vector3 vParam0, vector3 vParam1, float fParam2, vector3 vParam3, float fParam4, vector3 vParam5, bool bParam6, bool bParam7, bool bParam8, bool bParam9, bool bParam10)//Position - 0x2EE2F
{
	int iVar0;
	bool bVar1;
	bool bVar2;
...
int func_331(vector3 vParam0)//Position - 0x2F223
{
...
int func_332(int iParam0, vector3 vParam1, vector3 vParam2, float fParam3)//Position - 0x2F24D
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
...
int func_333(struct<2> Param0, var uParam1, struct<2> Param2, var uParam3, struct<2> Param4, var uParam5, struct<2> Param6, var uParam7)//Position - 0x2F543
{
	float fVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_334(vector3 vParam0)//Position - 0x2F5F7
{
	float fVar0;
	float fVar1;
...
void func_335(int iParam0)//Position - 0x2F636
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
Vector3 func_336()//Position - 0x2F69B
{
	return 2.55f, 5.665f, 2.55f;
}

void func_337(vector3 vParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, bool bParam6, bool bParam7, bool bParam8, int iParam9, bool bParam10)//Position - 0x2F6B2
{
	int iVar0;
...
Vector3 func_338(int iParam0)//Position - 0x2F870
{
	return unk_0x541C2AEF053615BC(unk_0xA95CF30C72EB526E(iParam0), false);
}

void func_339(bool bParam0)//Position - 0x2F883
{
	int iVar0;
...
void func_340(vector3 vParam0, int iParam1, int iParam2, int iParam3, bool bParam4, bool bParam5)//Position - 0x2F8C0
{
	int iVar0;
	int iVar1;
...
void func_341()//Position - 0x2F930
{
	Global_4336.f_6 = 1;
}

void func_342(int iParam0)//Position - 0x2F93E
{
...
void func_343(int iParam0)//Position - 0x2F967
{
	if (Global_3943)
	{
		func_344(0, 0);
...
void func_344(bool bParam0, bool bParam1)//Position - 0x2F9D7
{
	if (bParam0)
	{
		if (func_345(0))
...
int func_345(int iParam0)//Position - 0x2FA4B
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
void func_346(int iParam0, int iParam1, int iParam2)//Position - 0x2FAA5
{
...
void func_347(int iParam0, bool bParam1)//Position - 0x2FAD9
{
...
void func_348(int iParam0, int iParam1, int iParam2)//Position - 0x2FB15
{
...
bool func_349()//Position - 0x2FBD9
{
	return unk_0xFA30DFD0084E92FE(Global_16B1B.f_14, 13);
}

int func_350(int iParam0, float fParam1, int iParam2)//Position - 0x2FBED
{
	int iVar0;
	...
	if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
	{
		...
		{
			if (!func_355(unk_0x9FE9D386222EEE47(unk_0xBC25C936A095B5BA(), 0), fParam1, 1, 1056964608, 0, 1, 0))
			{
				iVar0 = 0;
			}
			else if (iParam2 == 1)
...
bool func_351()//Position - 0x2FCC1
{
	bool bVar0;
...
void func_352()//Position - 0x2FCE4
{
	Global_394A = 0;
	func_230();
}

void func_353()//Position - 0x2FCF4
{
...
int func_354(int iParam0, int iParam1)//Position - 0x2FD45
{
	if (func_460(iParam0))
	{
...
int func_355(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0x2FD78
{
...
void func_356(int iParam0)//Position - 0x2FF07
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_357(char* sParam0, bool bParam1)//Position - 0x2FF33
{
	func_339(bParam1);
	unk_0x04DD7A558FCF2C34(sParam0, 8);
}

int func_358()//Position - 0x2FF49
{
	if (Local_46.f_1)
	{
		return 1;
	...
	{
		unk_0xF243B7A14FCFD0F4(iLocal_376);
		if (unk_0xD6513D668481290A(iLocal_376))
		{
			Local_46 = unk_0x1E0CB5BD6231AB3D(iLocal_376, vLocal_388, true, true, false);
			if (unk_0x724D816EA203A79E(Local_46))
			{
				unk_0x784C605D172817C8(Local_46, vLocal_389, 2, 1);
				unk_0x2CA123B0622F495C(iLocal_376);
...
void func_360(int iParam0, bool bParam1)//Position - 0x2FFEC
{
...
int func_361()//Position - 0x30010
{
	if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
	{
		Local_48.f_2 = unk_0x01B3635C3E8EDD81(25, iLocal_370, Local_47.f_1[1 /*14*/].f_1, 0f, 1, true);
	}
	else
	{
		Local_48.f_2 = unk_0x01B3635C3E8EDD81(25, iLocal_370, Local_47.f_1[0 /*14*/].f_1, 0f, 1, true);
	}
	if (func_460(Local_48.f_2))
	{
		iLocal_188 = func_362(unk_0xBC25C936A095B5BA(), Local_48.f_2, 0f);
		unk_0xB71D41C0310C93DE(Local_48.f_2, true, 1);
		unk_0x30034548191398D0(Local_48.f_2, false);
		unk_0xB105531EDD3DE51B(Local_48.f_2, false);
		unk_0x2E35C4FA5F0ED22F(Local_48.f_2, true);
		unk_0x7A535CE1F001F3FE(Local_48.f_2, joaat("weapon_unarmed"), -1, true, true);
		unk_0x8EF3D958386640FE(Local_48.f_2, 0);
		unk_0xB0031DDAE4FF0BC3(Local_48.f_2, 0, 1, 0, 0);
		unk_0xB0031DDAE4FF0BC3(Local_48.f_2, 1, 0, 0, 0);
		unk_0xB0031DDAE4FF0BC3(Local_48.f_2, 8, 0, 0, 0);
		unk_0xC8FD3EBBB90E8D7F(Local_48.f_2, 185, true);
		unk_0x91629AC1E1F78419(Local_48.f_2, 46, true);
		unk_0x0DEF5E53360637F2(Local_48.f_2, 1);
		unk_0x3207596BE256C917(Local_48.f_2, 1);
		unk_0xEB061E1EBFED4D59(Local_48.f_2, 1);
		func_232(&uLocal_199, 3, Local_48.f_2, "ORLEANS", 0, 1);
		func_360(Local_48.f_2, 0);
		Local_48 = 0;
		Local_48.f_1 = 2;
		Local_48.f_4 = 0;
		Local_48.f_5 = unk_0x2F079D1FC5F6CB99();
		Local_48.f_6 = unk_0x2F079D1FC5F6CB99();
		Local_48.f_7 = unk_0x2F079D1FC5F6CB99();
		Local_48.f_B = 0;
		return 1;
	}
	return 0;
...
int func_362(int iParam0, int iParam1, float fParam2)//Position - 0x30172
{
	int iVar0;
...
int func_364()//Position - 0x30238
{
	if ((unk_0xD6513D668481290A(iLocal_370) && unk_0xF9E082857622D91E(sLocal_379)) && unk_0xF9E082857622D91E(sLocal_380))
	{
		return 1;
	}
	return 0;
...
void func_365()//Position - 0x30267
{
	unk_0xF243B7A14FCFD0F4(iLocal_370);
...
void func_366(bool bParam0, bool bParam1)//Position - 0x30284
{
	if (bParam0)
	{
		func_367(0, 1, 1);
...
void func_367(bool bParam0, int iParam1, int iParam2)//Position - 0x302B7
{
	bool bVar0;
...
void func_368()//Position - 0x30316
{
	if (Local_43.f_3 == 1)
	{
		func_366(1, 1);
		...
		{
			unk_0x641B19E156645A92(unk_0xBC25C936A095B5BA(), vLocal_402, 1, false, 0, 1);
			unk_0x019CE76D5286C95C(unk_0xBC25C936A095B5BA(), fLocal_403);
		}
		while (!func_359())
		{
			SYSTEM::WAIT(0);
	...
	if (Local_43.f_1 == 1)
	{
		...
		{
			if (unk_0xC9FA5D38428AB6BE(-1, unk_0x541C2AEF053615BC(Local_48.f_2, true), 4f) || iLocal_171)
			{
			...
			else
			{
				func_245(4);
				func_394();
				iLocal_364 = unk_0x105601648511CC64() + 3000;
				Local_43.f_1 = 3;
				func_11(&(Local_48.f_3));
			}
		}
		else if (unk_0xC9FA5D38428AB6BE(-1, unk_0x541C2AEF053615BC(Local_48.f_2, true), 4f))
		{
			if (unk_0x105601648511CC64() > iLocal_186)
			{
				iLocal_185++;
				iLocal_186 = unk_0x105601648511CC64() + 1000;
				func_393(807, 1, 0);
			}
		...
		else
		{
			...
			{
				Local_47 = 0;
				if (Local_47.f_160 == 0 && !unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
				{
					Local_47.f_160 = 2;
				}
				else
			...
			if (func_376(unk_0xBC25C936A095B5BA(), Local_47.f_1[10 /*14*/].f_5, 100f))
			{
				unk_0x04DD7A558FCF2C34("sas_2_rcm_t7", 8);
			}
			if (iLocal_170 == 0)
			{
				...
				iLocal_170 = 1;
				iLocal_184 = unk_0x105601648511CC64() + 1000;
			}
			else if (iLocal_183 == 0)
			{
				if (iLocal_184 < unk_0x105601648511CC64())
				{
					func_374("SAS1_H0", -1);
					iLocal_183 = 1;
				}
			...
			else if (iLocal_178 == 0)
			{
				if (Local_47.f_160 < 5)
				{
					...
					{
						func_232(&uLocal_199, 1, unk_0xBC25C936A095B5BA(), "FRANKLIN", 0, 1);
			...
			else if (iLocal_179 == 0)
			{
				...
				{
					if (!func_18() && unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_392, 35f, 35f, 35f, false, true, 0))
					{
						func_371();
						func_232(&uLocal_199, 1, unk_0xBC25C936A095B5BA(), "FRANKLIN", 0, 1);
						if (func_220(&uLocal_199, "SAS1AUD", "SAS1_CHASE3", 7, 0, 0, 0))
						{
							unk_0xFB46D0183648781E(Local_48.f_2, -1536.6f, 4543.7f, 45.5f, -1538.2f, 4536.2f, 48.6f, 5f, 0, 0);
							iLocal_179 = 1;
						}
					}
				}
			...
			if (iLocal_168 == 0)
			{
				if (!func_370(&uLocal_63, unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true)))
				{
					func_375("SAS1_C2", 7500, 0);
					iLocal_168 = 1;
					iLocal_172 = unk_0x105601648511CC64() + 30000;
				}
			}
			else if (unk_0x105601648511CC64() > iLocal_172)
			{
				if (func_370(&uLocal_63, unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true)))
				{
					iLocal_168 = 0;
...
void func_369()//Position - 0x30805
{
	unk_0xEB233A3B7635D2AC();
	func_11(&(Local_48.f_3));
	if (func_370(&uLocal_115, unk_0x541C2AEF053615BC(Local_48.f_2, false)))
	{
		bLocal_180 = false;
	}
	else
...
bool func_370(var uParam0, struct<2> Param1, float fParam2)//Position - 0x3083D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_371()//Position - 0x308F9
{
	int iVar0;
	...
	while (iVar0 < iLocal_60)
	{
		...
		{
			unk_0x5558ED6D4A2DEC93(Local_59[iVar0 /*16*/], unk_0xBC25C936A095B5BA(), 500f, -1, 0, 0);
			func_4(&(Local_59[iVar0 /*16*/]), 1, 0, 1);
		}
		iVar0++;
	}
...
void func_372(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x30948
{
...
bool func_373(int iParam0, int iParam1)//Position - 0x30983
{
	if (iParam0 == -1)
	{
		return 0;
	...
	return (unk_0x105601648511CC64() - Local_42[iParam0 /*13*/].f_4) < iParam1;
}

void func_374(char* sParam0, int iParam1)//Position - 0x309CF
{
	unk_0x2F618BD43614DD0D(sParam0);
	unk_0x72F8FA06CC9EC899(0, 0, true, iParam1);
}

void func_375(char* sParam0, int iParam1, int iParam2)//Position - 0x309E6
{
	iParam2 = iParam2;
...
bool func_376(int iParam0, vector3 vParam1, float fParam2)//Position - 0x309FF
{
	return SYSTEM::VDIST2(unk_0x541C2AEF053615BC(iParam0, true), vParam1) <= (fParam2 * fParam2);
}

void func_377()//Position - 0x30A1C
{
	if (unk_0xB7CB92A84A7518CD(unk_0x541C2AEF053615BC(Local_48.f_2, true), 1.5f, 1, 1))
	{
		if (Local_47.f_160 < (Local_47.f_161 - 1))
		{
			func_378();
	...
	else if (unk_0xB7CB92A84A7518CD(unk_0x541C2AEF053615BC(Local_48.f_2, true), 5f, 1, 1))
	{
		if (Local_47.f_160 < (Local_47.f_161 - 1))
		{
			if (!func_18())
...
void func_378()//Position - 0x30ADC
{
	if ((Local_48 == 3 && Local_48.f_1 == 1) && func_460(Local_48.f_2))
	{
		unk_0x38FF8CB6377D36F6(Local_48.f_6);
		unk_0xF2C27FE5A8B98CB5(Local_48.f_6, "WOUNDED", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
		Local_48.f_A = 1;
	}
}

void func_379()//Position - 0x30B2D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_380(int iParam0)//Position - 0x30BC5
{
	int iVar0;
...
void func_381()//Position - 0x30CD3
{
	int iVar0;
...
void func_382(int iParam0)//Position - 0x30D63
{
	...
	switch (iParam0->f_1)
	{
		case 1:
			...
			else if (func_383(*iParam0, unk_0xBC25C936A095B5BA(), iParam0->f_F, 1))
			{
...
bool func_383(int iParam0, int iParam1, float fParam2, bool bParam3)//Position - 0x30E58
{
	return SYSTEM::VDIST2(unk_0x541C2AEF053615BC(iParam0, bParam3), unk_0x541C2AEF053615BC(iParam1, bParam3)) <= (fParam2 * fParam2);
}

int func_384(int iParam0, var uParam1, int iParam2, int iParam3, bool bParam4, int iParam5, float fParam6, char* sParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x30E7A
{
	if (iParam3 == 0)
	{
...
void func_385(var uParam0)//Position - 0x31051
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	switch (Local_48)
	{
		case 1:
			if (func_460(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					unk_0x641B19E156645A92(Local_48.f_2, uParam0->f_1, 1, false, 0, 1);
					if (*uParam0 == 1)
					{
						func_391(Local_48.f_2, uParam0->f_5);
					}
					Local_48.f_4 = (unk_0x105601648511CC64() + iVar1);
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
				{
					...
					else if (unk_0x105601648511CC64() > Local_48.f_4)
					{
						Local_48 = 2;
						Local_48.f_1 = 0;
					}
		...
		case 2:
			if (func_460(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					Local_48.f_C = (unk_0x105601648511CC64() + 60000);
					Local_48.f_4 = 0;
					Local_48.f_1 = 1;
				}
				else if (fVar0 == -1f || func_383(Local_48.f_2, unk_0xBC25C936A095B5BA(), fVar0, 1))
				{
				...
				else if (unk_0x2DA8CA50A72528FB(Local_48.f_3))
				{
					iVar2 = (unk_0xB1D6718ACE798CBB(Local_48.f_3) - 5);
					if (iVar2 > 0)
					{
						unk_0x7781946F1FC054FA(Local_48.f_3, iVar2);
					}
					else
					{
						func_11(&(Local_48.f_3));
				...
				else if (unk_0x105601648511CC64() > Local_48.f_C)
				{
					Local_48.f_B = 1;
				}
				else if (unk_0x105601648511CC64() > Local_48.f_4)
				{
					if ((unk_0x1BD5EE88F32433CD(Local_48.f_6) && unk_0x1BD5EE88F32433CD(Local_48.f_6)) && unk_0x1BD5EE88F32433CD(Local_48.f_7))
					{
						unk_0xF2C27FE5A8B98CB5(Local_48.f_5, "ALERT", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
						unk_0x2266668B7AC1CCAA(unk_0x541C2AEF053615BC(Local_48.f_2, true), 30f, 6);
					}
					Local_48.f_4 = unk_0x105601648511CC64() + 7500;
				}
		...
		case 3:
			if (func_460(Local_48.f_2))
			{
				...
				{
					func_360(Local_48.f_2, 1);
					unk_0xDF14F570C0180463(Local_48.f_2, uParam0->f_5, 3f, -1, 1193033728, 0.5f);
					if ((unk_0x1BD5EE88F32433CD(Local_48.f_6) && unk_0x1BD5EE88F32433CD(Local_48.f_6)) && unk_0x1BD5EE88F32433CD(Local_48.f_7))
					{
						unk_0xF2C27FE5A8B98CB5(Local_48.f_6, "RUNNING", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
					}
					Local_48.f_A = 0;
					if (!unk_0x2DA8CA50A72528FB(Local_48.f_3))
					{
						Local_48.f_3 = func_322(Local_48.f_2, 1, 0, 5);
						unk_0x3F5F1772D71D5EC4(Local_48.f_3, 1f);
					}
					...
					{
						unk_0x7781946F1FC054FA(Local_48.f_3, 255);
					}
					if (Local_47.f_160 == (Local_47.f_161 - 1))
					{
						unk_0x30034548191398D0(Local_48.f_2, true);
						unk_0xB105531EDD3DE51B(Local_48.f_2, true);
						unk_0x65E471E4A2D56226(Local_48.f_2, 110, 0);
					}
					Local_48.f_1 = 1;
				}
				...
				{
					if ((Local_47.f_160 < (Local_47.f_161 - 1) && func_376(Local_48.f_2, uParam0->f_5, 4f)) && !func_354(Local_48.f_2, -2017877118))
					{
						unk_0xE896C0AD02364F2A(Local_48.f_2, sLocal_379, "tlo_leap_out", 8f, -8f, -1, 512, 0, 0, 0, 0);
						Local_48.f_1 = 2;
					}
					else if (Local_47.f_160 >= (Local_47.f_161 - 1) && func_376(Local_48.f_2, uParam0->f_5, 1.5f))
					{
						Local_48.f_1 = 2;
					}
					else if ((unk_0x1BD5EE88F32433CD(Local_48.f_6) && unk_0x1BD5EE88F32433CD(Local_48.f_6)) && unk_0x1BD5EE88F32433CD(Local_48.f_7))
					{
						if (Local_48.f_A == 0)
						{
							unk_0xF2C27FE5A8B98CB5(Local_48.f_6, "RUNNING", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
					...
					if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
					{
						...
						if (func_328(iVar3) && unk_0xE921F8171F0733B3(iVar3, Local_48.f_2))
						{
							Local_48 = 6;
							Local_48.f_1 = 0;
						}
				...
				{
					unk_0xA4E856A8CD53B8DF(Local_48.f_2);
					if (Local_47.f_160 < (Local_47.f_161 - 1))
					{
						if ((unk_0x1BD5EE88F32433CD(Local_48.f_6) && unk_0x1BD5EE88F32433CD(Local_48.f_6)) && unk_0x1BD5EE88F32433CD(Local_48.f_7))
						{
							unk_0xF2C27FE5A8B98CB5(Local_48.f_7, "COUGH", Local_48.f_2, "SASQUATCH_01_SOUNDSET", 0, 0);
						}
						Local_48 = 4;
						Local_48.f_1 = 0;
					}
		...
		case 4:
			...
			if (func_460(Local_48.f_2))
			{
				if (unk_0x2DA8CA50A72528FB(Local_48.f_3))
				{
					...
					iVar4 = (unk_0xB1D6718ACE798CBB(Local_48.f_3) - iVar5);
					if (iVar4 > 0)
					{
						unk_0x7781946F1FC054FA(Local_48.f_3, iVar4);
					}
					else
					{
						func_11(&(Local_48.f_3));
		...
		case 5:
			if (func_460(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					unk_0xA8E6405305C0D7DF(Local_48.f_2, iVar6);
					func_371();
					Local_48.f_1 = 1;
					Local_48.f_9 = 0;
				}
				else if (Local_48.f_1 == 1)
				{
					if (Local_48.f_9 == 0)
					{
						if (func_383(unk_0xBC25C936A095B5BA(), Local_48.f_2, 20f, 1))
						{
							unk_0x65E471E4A2D56226(Local_48.f_2, 110, 0);
							unk_0x4106FAF8AA1D69D5(Local_48.f_2, -2065892691);
							unk_0xC8FD3EBBB90E8D7F(Local_48.f_2, 185, true);
							func_371();
							iLocal_366 = 0;
					...
					{
						if (unk_0x105601648511CC64() > iLocal_367)
						{
							if (func_387(&uLocal_199, "SAS1AUD", "SAS1_LEADOUT", sLocal_365[iLocal_366], 7, 0, 0))
							{
								iLocal_367 = (unk_0x105601648511CC64() + unk_0x491B2241281A03B7(3000, 5000));
								iLocal_366 = unk_0x491B2241281A03B7(0, 4);
							}
						}
					}
					func_386();
		...
		case 6:
			if (func_460(Local_48.f_2))
			{
				if (Local_48.f_1 == 0)
				{
					...
					iLocal_171 = 1;
					unk_0xB8CBD998685C0685(Local_48.f_2, unk_0xBC25C936A095B5BA(), 0, 16);
					func_371();
					Local_48.f_1 = 1;
				}
				else if (Local_48.f_1 == 1)
...
void func_386()//Position - 0x31856
{
	if (unk_0xD9C1758D86688CEA(Local_48.f_2, unk_0xBC25C936A095B5BA(), 1))
	{
		unk_0x65E471E4A2D56226(Local_48.f_2, 99, 0);
	}
}

bool func_387(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3187B
{
...
void func_388()//Position - 0x318CF
{
	if (iLocal_191 < 0)
	{
		iLocal_191 = unk_0x105601648511CC64() + 7000;
		iLocal_192 = -1;
	}
	else if (unk_0x105601648511CC64() > iLocal_191)
	{
...
void func_389()//Position - 0x31938
{
	if (iLocal_192 < 0)
	{
		iLocal_192 = unk_0x105601648511CC64() + 7000;
		iLocal_191 = -1;
	}
	else if (unk_0x105601648511CC64() > iLocal_192)
	{
		if ((!func_18() && !unk_0x4B8E3E5901E59EB8()) && !unk_0x63276C96B907C69E(unk_0xBC25C936A095B5BA()))
		{
...
int func_390(var uParam0)//Position - 0x319A1
{
	vector3 vVar0;
	vector3 vVar1;
	vector3 vVar2;
	...
	vVar0 = { func_334(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true) - uParam0->f_1) };
	...
	if ((vVar0.x * vVar1.x) + (vVar0.y * vVar1.y)) < SYSTEM::COS(SYSTEM::TO_FLOAT(uParam0->f_B))
	{
		...
		return !unk_0x79E7A3A738247A8B(vVar2, vVar3, 0, 1, 0, 0, 0, 0, 0);
	}
	return 0;
}

void func_391(int iParam0, struct<2> Param1, var uParam2)//Position - 0x31AD7
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
int func_392(int iParam0)//Position - 0x31B36
{
	if (Local_48 == 0)
	{
...
void func_393(int iParam0, int iParam1, bool bParam2)//Position - 0x31B77
{
	int iVar0;
...
void func_394()//Position - 0x31C21
{
	Global_394A = 0;
	func_395();
}

void func_395()//Position - 0x31C31
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
bool func_396()//Position - 0x31C52
{
	return Local_48.f_B;
}

void func_397()//Position - 0x31C5F
{
	unk_0x2CA123B0622F495C(iLocal_378);
}

void func_398()//Position - 0x31C6E
{
	Local_47 = 0;
	if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
	{
...
void func_399()//Position - 0x31C97
{
	int iVar0;
	...
	while (iVar0 < iLocal_60)
	{
		Local_59[iVar0 /*16*/] = unk_0x01B3635C3E8EDD81(25, iLocal_378, Local_59[iVar0 /*16*/].f_B, Local_59[iVar0 /*16*/].f_E, 1, true);
		if (func_460(Local_59[iVar0 /*16*/]))
		{
			unk_0x2E35C4FA5F0ED22F(Local_59[iVar0 /*16*/], true);
			unk_0xEB061E1EBFED4D59(Local_59[iVar0 /*16*/], 1);
			unk_0xEFFE6F8EE5AA8DAD(Local_59[iVar0 /*16*/], Local_59[iVar0 /*16*/].f_B, 15f, 1077936128, 1086324736);
			unk_0x91629AC1E1F78419(Local_59[iVar0 /*16*/], 46, true);
			unk_0x7A853DA478E4882E(Local_59[iVar0 /*16*/], joaat("weapon_cougar"), -1, true);
...
bool func_400()//Position - 0x31D5B
{
	return unk_0xD6513D668481290A(iLocal_378);
}

void func_401()//Position - 0x31D6A
{
	unk_0xF243B7A14FCFD0F4(iLocal_378);
}

void func_402()//Position - 0x31D79
{
	bool bVar0;
	
	if (unk_0x105601648511CC64() > iLocal_187 && iLocal_187 > 0)
	{
		if (func_236(unk_0xBC25C936A095B5BA()))
		{
			unk_0xDDCAA2E64649E083(unk_0xB5CEFD608600A09F(), true, 0);
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_439())
		{
			...
			if (func_460(Local_45))
			{
				unk_0xC8FD3EBBB90E8D7F(Local_45, 185, true);
				unk_0x12D2D85EBAC186AA(Local_45, 0);
			}
			iLocal_61 = unk_0x489E7A92D55C10F8(vLocal_390, 75f);
			unk_0x0D5352939CC40C16(iLocal_61, 5);
			unk_0x7781946F1FC054FA(iLocal_61, 128);
			unk_0x222805B89367761E(iLocal_61, false);
			unk_0x6C5F5B5F6894CCE3(vLocal_404, 100f, 1, 0, 0, false);
			unk_0x6C5F5B5F6894CCE3(vLocal_405, 100f, 1, 0, 0, false);
			unk_0x6C5F5B5F6894CCE3(vLocal_406, 100f, 1, 0, 0, false);
			unk_0x6C5F5B5F6894CCE3(vLocal_407, 100f, 1, 0, 0, false);
			iLocal_167 = 0;
			iLocal_168 = 0;
			iLocal_169 = 0;
			iLocal_174 = 0;
			...
			iLocal_181 = 1;
			iLocal_182 = 1;
			iLocal_196 = (unk_0x105601648511CC64() + 40000);
	...
	if (Local_43.f_1 == 1)
	{
		...
		else if ((func_423(Local_45, 0, 70f, 170f, 1, 0, 0, 0) || !func_376(Local_45, vLocal_397, 1.5f)) || unk_0x2CDE18D6C89522AD(Local_45))
		{
			unk_0x4106FAF8AA1D69D5(Local_45, -2065892691);
			unk_0xB8CBD998685C0685(Local_45, unk_0xBC25C936A095B5BA(), 0, 16);
			func_394();
			func_245(6);
			Local_43.f_9 = 3;
			Local_43.f_1 = 3;
		...
		{
			bVar0 = func_370(&uLocal_63, unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true));
			if (iLocal_182 && func_376(unk_0xBC25C936A095B5BA(), vLocal_388, 250f))
			{
				func_365();
				func_401();
				iLocal_182 = 0;
			...
			else if (iLocal_175 == 0)
			{
				...
				{
					func_232(&uLocal_199, 4, Local_45, "HUNTER", 0, 1);
					if (unk_0xE642C1AC73CE364E(unk_0xBC25C936A095B5BA(), Local_45, 25f, 25f, 25f, 0, 1, 0))
					{
			...
			else if (iLocal_167 == 0)
			{
				...
				if (func_18())
				{
					if (func_404(unk_0xBC25C936A095B5BA(), Local_45) > 25f)
					{
						func_394();
					}
				}
			...
			else
			{
				if (iLocal_169 == 0)
				{
					if (func_376(unk_0xBC25C936A095B5BA(), vLocal_388, 5f))
					{
						func_232(&uLocal_199, 1, unk_0xBC25C936A095B5BA(), "FRANKLIN", 0, 1);
				...
				if (iLocal_176 == 0)
				{
					if (func_376(unk_0xBC25C936A095B5BA(), Local_47.f_1[0 /*14*/].f_1, 40f))
					{
						if (func_361())
						{
							func_11(&iLocal_61);
							Local_48.f_3 = func_322(Local_48.f_2, 1, 0, 5);
							unk_0x3F5F1772D71D5EC4(Local_48.f_3, 1f);
							unk_0x10B5C0C7337B8420(Local_48.f_5, "ALERT", -1541.965f, 4692.725f, 44.0651f, "SASQUATCH_01_SOUNDSET", 0, 0, 0);
							unk_0x2266668B7AC1CCAA(unk_0x541C2AEF053615BC(Local_48.f_2, true), 30f, 6);
							unk_0x4BED3C9D6EF14C38(unk_0xBC25C936A095B5BA(), Local_47.f_1[0 /*14*/].f_1, 6000, 1024, 2);
							iLocal_176 = 1;
							iLocal_190 = -1;
							func_403();
						}
				...
				else if (iLocal_177 == 0)
				{
					if (!func_18())
					{
						if (iLocal_190 < 0)
						{
							iLocal_190 = unk_0x105601648511CC64() + 2000;
						}
						else if (unk_0x105601648511CC64() > iLocal_190)
						{
							func_232(&uLocal_199, 1, unk_0xBC25C936A095B5BA(), "FRANKLIN", 0, 1);
...
void func_403()//Position - 0x323BB
{
	int iVar0;
	
	unk_0x6C5F5B5F6894CCE3(vLocal_404, 50f, 1, 0, 0, false);
	unk_0x6C5F5B5F6894CCE3(vLocal_405, 50f, 1, 0, 0, false);
	unk_0x6C5F5B5F6894CCE3(vLocal_406, 50f, 1, 0, 0, false);
	unk_0x6C5F5B5F6894CCE3(vLocal_407, 20f, 1, 0, 0, false);
	iVar0 = unk_0x3E12B546F3F2597A();
	if (unk_0x724D816EA203A79E(iVar0) && !unk_0x1D403DFADBC2DE3C(iVar0, 0))
	{
		...
		{
			unk_0x641B19E156645A92(iVar0, vLocal_383, 1, false, 0, 1);
			unk_0x019CE76D5286C95C(iVar0, fLocal_384);
			unk_0xF0A40F19AAB79E88(iVar0, 1084227584);
		}
	}
}

float func_404(int iParam0, int iParam1)//Position - 0x324A0
{
	return func_405(iParam0, iParam1, 1);
}

float func_405(int iParam0, int iParam1, bool bParam2)//Position - 0x324B1
{
	vector3 vVar0;
	vector3 vVar1;
...
void func_406()//Position - 0x3250F
{
	if (iLocal_173)
	{
		if (!func_328(Local_44.f_23[0]) && func_404(unk_0xBC25C936A095B5BA(), Local_45) < 25f)
		{
			func_394();
...
bool func_407(var uParam0, char* sParam1, char* sParam2, char* sParam3, char* sParam4, char* sParam5, char* sParam6, char* sParam7, int iParam8, int iParam9, int iParam10)//Position - 0x32560
{
	var uVar0;
	var uVar1;
...
int func_408(var uParam0, var uParam1, int iParam2, bool bParam3)//Position - 0x325BB
{
	int iVar0;
...
void func_409(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7, var uParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13, int iParam14, int iParam15, int iParam16)//Position - 0x32925
{
	Global_3DB5 = iParam0;
	Global_3DBF = 0;
	Global_3DC6 = 0;
...
void func_410()//Position - 0x329AD
{
	if (func_460(Local_45) && func_460(unk_0xBC25C936A095B5BA()))
	{
		if (func_383(unk_0xBC25C936A095B5BA(), Local_45, 50f, 1))
		{
			...
			if (unk_0xE921F8171F0733B3(unk_0xBC25C936A095B5BA(), Local_45))
			{
...
void func_411(int iParam0, int iParam1, char* sParam2)//Position - 0x32A41
{
...
int func_412(int iParam0, float fParam1)//Position - 0x32AA8
{
	float fVar0;
...
bool func_413(int iParam0, float fParam1)//Position - 0x32B1E
{
	return func_414(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_414(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x32B36
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_415(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x32BF7
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_416(int iParam0, int iParam1)//Position - 0x32D23
{
	int iVar0;
...
int func_418(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x32E32
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_334(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_334(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_419(vector3 vParam0, vector3 vParam1)//Position - 0x32EC3
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

void func_420(var uParam0)//Position - 0x32EE4
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_421(int iParam0, int iParam1)//Position - 0x32EFF
{
	int iVar0;
...
int func_422(int iParam0)//Position - 0x32F3E
{
...
int func_423(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x32F66
{
	vector3 vVar0;
...
bool func_424(int iParam0, int iParam1, float fParam2)//Position - 0x33021
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_425(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x33068
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_426(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x33163
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_427(int iParam0, float fParam1)//Position - 0x3326F
{
	var uVar0;
	vector3 vVar1;
...
int func_428(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x33304
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_334(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_429(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x33392
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
void func_430()//Position - 0x333DA
{
	int iVar0;
	
	if (iLocal_181 && func_460(Local_45))
	{
		if (unk_0x96044E39418AAF17(Local_45, sLocal_379, "hunter_leadout", 3))
		{
			if (unk_0x4A3B2CF8BADDD74E(Local_45, sLocal_379, "hunter_leadout") > 0.9f)
			{
				if (unk_0xF9E082857622D91E(sLocal_379))
				{
					unk_0xC5A6DFE2B8987B17(&iVar0);
					unk_0xE896C0AD02364F2A(0, sLocal_379, "hunter_idle", 8f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sLocal_379, "hunter_idle_action", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sLocal_379, "hunter_idle", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sLocal_379, "hunter_idle_look", 1000f, -1000f, -1, iLocal_382, 0, 0, 0, 0);
					unk_0xAFD74A5E065F57E0(iVar0, 1);
					unk_0x535008C596714F9E(iVar0);
					unk_0xA8E6405305C0D7DF(Local_45, iVar0);
...
void func_431()//Position - 0x3351F
{
	int iVar0;
	...
	while (iVar0 < Local_42)
	{
		if (!(Local_42[iVar0 /*13*/].f_B == 3 && unk_0x105601648511CC64() < Local_42[iVar0 /*13*/].f_A))
		{
			Local_42[iVar0 /*13*/].f_B = func_432(&(Local_42[iVar0 /*13*/]));
		}
		iVar0++;
	}
}

int func_432(var uParam0)//Position - 0x3356C
{
	vector3 vVar0;
	int iVar1;
	vector3 vVar2;
	...
	if (!func_236(uParam0->f_1) || !func_236(uParam0->f_2))
	{
		if (uParam0->f_5 != 0)
		{
			iVar5 = unk_0xB0695CD48A28A3A9(uParam0->f_5, &iVar1, &vVar2, &uVar3, &uVar4);
			uParam0->f_5 = 0;
		}
	...
	vVar7 = { unk_0x541C2AEF053615BC(uParam0->f_1, true) };
	vVar8 = { unk_0x541C2AEF053615BC(uParam0->f_2, true) };
	if (uParam0->f_3 > 0f)
	{
		vVar9 = { func_334(vVar8 - vVar7) };
		fVar10 = func_419(unk_0xF90427F311003E57(uParam0->f_1), vVar9);
	...
	if (uParam0->f_5 == 0)
	{
		vVar7 = { unk_0x823166D9421223CA(uParam0->f_1, 31086, 0f, 0.6f, 0f) };
		uParam0->f_7 = { vVar8 + unk_0xB5D9AE572C19509E(uParam0->f_2) * FtoV(unk_0x11F9F9006143871A()) };
		vVar0 = { uParam0->f_7 - vVar7 * Vector(1.25f, 1.25f, 1.25f) + vVar7 };
		uParam0->f_5 = unk_0xA20E4A82503CECB3(vVar7, vVar0, 511, 0, 7);
		return 2;
	}
	bVar12 = false;
	iVar5 = unk_0xB0695CD48A28A3A9(uParam0->f_5, &iVar1, &vVar2, &uVar3, &uVar4);
	...
	{
		fVar13 = unk_0x357058E632979E65((unk_0x8910237449BB6F79(uParam0->f_1) * unk_0x11F9F9006143871A()));
		fVar13 = 0f;
		fVar11 = unk_0xF0F2FC9DE291567F(uParam0->f_7, vVar2, false);
		...
		if (bVar12 && unk_0x357058E632979E65((uParam0->f_7.f_2 - vVar2.z)) > 1f)
		{
			bVar12 = false;
		}
		uParam0->f_6 = bVar12;
	...
	uParam0->f_A = (unk_0x105601648511CC64() + unk_0x491B2241281A03B7(64, 256));
	uParam0->f_5 = 0;
	return 3;
}

void func_433(int iParam0)//Position - 0x337F9
{
	int iVar0;
...
void func_434(var uParam0)//Position - 0x33847
{
	if (*uParam0 == 0)
	{
		*uParam0 = 0;
...
void func_435()//Position - 0x33878
{
	unk_0x2CA123B0622F495C(iLocal_371);
	unk_0x2CA123B0622F495C(iLocal_372);
	unk_0x2CA123B0622F495C(iLocal_373);
	unk_0x2CA123B0622F495C(iLocal_374);
	unk_0x2CA123B0622F495C(iLocal_375);
}

void func_436(bool bParam0)//Position - 0x338A3
{
	if (Local_45.f_4 == 0)
	{
		if (bParam0)
		{
			if (func_460(unk_0xBC25C936A095B5BA()) && !func_349())
			{
				unk_0x641B19E156645A92(unk_0xBC25C936A095B5BA(), vLocal_393, 1, false, 0, 1);
				unk_0x019CE76D5286C95C(unk_0xBC25C936A095B5BA(), fLocal_394);
				unk_0xF3F01A78937DC905(0f);
				unk_0x2B9AEC08E469E384(0f, 1065353216);
			}
			if (func_460(Local_44.f_1C[0]))
			{
				Local_45 = Local_44.f_1C[0];
				unk_0x641B19E156645A92(Local_45, vLocal_395, 1, false, 0, 1);
				unk_0x019CE76D5286C95C(Local_45, fLocal_396);
			}
			else
			{
				Local_45 = unk_0x01B3635C3E8EDD81(26, iLocal_371, vLocal_395, fLocal_396, 1, true);
			...
			if (func_438(Local_45, 1862763509, iLocal_368))
			{
				if (func_460(unk_0xBC25C936A095B5BA()))
				{
					unk_0x56F2E1B5599188FA(Local_45, unk_0xBC25C936A095B5BA(), -1, 1024, 2);
				}
			}
		}
		func_437();
...
void func_437()//Position - 0x33986
{
	int iVar0;
	
	iVar0 = 0;
	unk_0xF0059F27F7BB6680(&iVar0, 4);
	if (!unk_0xA901403F1DB7A780(Local_45.f_2))
	{
		Local_45.f_2 = unk_0x37B86314BDCAA6F0(joaat("pickup_weapon_sniperrifle"), vLocal_398, vLocal_399, iVar0, 100, 0, 1, 0);
	}
	if (!unk_0xA901403F1DB7A780(Local_45.f_3))
	{
		if (vLocal_400.z != 0f)
		{
			Local_45.f_3 = unk_0x37B86314BDCAA6F0(joaat("pickup_weapon_pumpshotgun"), vLocal_400, vLocal_401, iVar0, 48, 0, 1, 0);
		}
	}
}

int func_438(int iParam0, int iParam1, int iParam2)//Position - 0x339FA
{
	if (func_460(iParam0))
	{
		unk_0x4106FAF8AA1D69D5(iParam0, iParam1);
		unk_0xC8FD3EBBB90E8D7F(iParam0, 132, true);
		...
		{
			unk_0x7A535CE1F001F3FE(iParam0, iParam2, 100, true, true);
...
int func_439()//Position - 0x33A54
{
	if (((((((unk_0xD6513D668481290A(iLocal_371) && unk_0xD6513D668481290A(iLocal_372)) && unk_0xD6513D668481290A(iLocal_373)) && unk_0xD6513D668481290A(iLocal_374)) && unk_0xD6513D668481290A(iLocal_375)) && unk_0x317B2443006524C2(iLocal_372)) && unk_0xF9E082857622D91E(sLocal_379)) && unk_0xF9E082857622D91E(sLocal_380))
	{
		return 1;
	}
	return 0;
...
void func_440()//Position - 0x33ABF
{
	unk_0xF243B7A14FCFD0F4(iLocal_371);
	unk_0xF243B7A14FCFD0F4(iLocal_372);
	unk_0xF243B7A14FCFD0F4(iLocal_373);
	unk_0xF243B7A14FCFD0F4(iLocal_374);
	unk_0xF243B7A14FCFD0F4(iLocal_375);
	unk_0x3B6B082832176FA5(iLocal_372, 3);
	unk_0x522053D86D6E1C7A(sLocal_379);
	unk_0x522053D86D6E1C7A(sLocal_380);
}

void func_441(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x33B00
{
...
void func_442(var uParam0, bool bParam1)//Position - 0x33B20
{
	func_443(&(uParam0->f_29), bParam1);
}

void func_443(var uParam0, bool bParam1)//Position - 0x33B32
{
	int iVar0;
...
void func_444(var uParam0, bool bParam1)//Position - 0x33B70
{
	func_445(&(uParam0->f_23), bParam1);
}

void func_445(var uParam0, bool bParam1)//Position - 0x33B82
{
	int iVar0;
...
void func_446(int iParam0)//Position - 0x33BBF
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_447(var uParam0, int iParam1)//Position - 0x33BF7
{
	func_448(&(uParam0->f_1C), iParam1);
}

void func_448(var uParam0, int iParam1)//Position - 0x33C09
{
	int iVar0;
...
void func_449()//Position - 0x33C4A
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (Local_43.f_1 == 0)
	{
		...
		if (func_350(1, 1093140480, 0))
		{
			...
			if (func_460(Local_44.f_1C[0]))
			{
				unk_0x538BB037E00A3AD9(Local_44.f_1C[0], "Hunter", 0, 0, 0);
				iLocal_62 = func_451(Local_44.f_1C[0], 1, 0, 0, 0, 0);
				if (unk_0x724D816EA203A79E(iLocal_62))
				{
					unk_0x538BB037E00A3AD9(iLocal_62, "SAS_SniperRifle", 0, 0, 0);
				}
			}
			func_347(500, 0);
			unk_0x4BDC021CD4295F17(vLocal_408, vLocal_409, false, 0);
			unk_0xD0FC9D284379BED4("WORLD_HUMAN_HIKER", false);
			unk_0xD0FC9D284379BED4("WORLD_MOUNTAIN_LION_WANDER", false);
			func_450();
			unk_0x93B1CB6BD50812C7(0);
			SYSTEM::WAIT(0);
			unk_0x2E94C9549322098D("SF_TheLastOne", 0);
			...
			unk_0x6C5F5B5F6894CCE3(-1561.793f, 4668.806f, 48.04337f, 218.9074f, 1, 0, 0, false);
			func_440();
			if (func_236(unk_0xBC25C936A095B5BA()))
			{
		...
		if (func_460(Local_44.f_1C[0]))
		{
			if (unk_0x3F3252765FE36DA8("Hunter", 0))
			{
				...
				if (func_438(Local_45, 1862763509, iLocal_368))
				{
					if (unk_0xF9E082857622D91E(sLocal_379))
					{
						unk_0xE896C0AD02364F2A(Local_45, sLocal_379, "hunter_leadout", 1000f, -8f, -1, iLocal_382, 0, 0, 0, 0);
					}
				}
			}
		}
	...
	if (Local_43.f_1 == 3)
	{
		if (unk_0xD96732B3E060BAE1())
		{
			...
			func_491(&Local_44, 0, 1);
			func_5(&iLocal_62);
			iLocal_187 = unk_0x105601648511CC64() + 500;
			func_245(2);
			func_234();
		}
	}
...
void func_450()//Position - 0x33FB5
{
	int iVar0;
...
int func_451(int iParam0, int iParam1, bool bParam2, int iParam3, int iParam4, int iParam5)//Position - 0x33FD5
{
	int iVar0;
...
int func_452(int iParam0, int iParam1, int iParam2, bool bParam3, var uParam4, var uParam5, var uParam6, int iParam7, int iParam8)//Position - 0x33FFB
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	while (func_276(iVar2, iVar6) != 0)
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
		{
			if (unk_0x1D3364A4FCD401E3(iParam0, iVar2, func_276(iVar2, iVar6)))
			{
				if (func_455(func_276(iVar2, iVar6)))
				{
					iVar7 = unk_0xE756C4AA1BCB8705(func_276(iVar2, iVar6));
				}
			}
		}
		iVar6++;
	...
	while (func_276(iVar2, iVar6) != 0)
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
		{
			if (unk_0x1D3364A4FCD401E3(iParam0, iVar2, func_276(iVar2, iVar6)))
			{
				unk_0x112064CBEF6B2384(iVar1, func_276(iVar2, iVar6));
...
void func_453(int iParam0, int iParam1)//Position - 0x34174
{
	int iVar0;
...
int func_454(int iParam0)//Position - 0x34192
{
	switch (iParam0)
	{
		case 1550611612:
...
int func_455(int iParam0)//Position - 0x34318
{
...
float func_456(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x344F0
{
	vector3 vVar0;
...
void func_457()//Position - 0x3452A
{
	int iVar0;
	int iVar1;
	
	if ((((unk_0x284F2ACE6839D3C0("SCRIPT\SAS_BANK_01", false, -1) && unk_0x284F2ACE6839D3C0("SCRIPT\SAS_BANK_02", false, -1)) && unk_0x284F2ACE6839D3C0("SAS_BANK_03", false, -1)) && func_359()) && func_358())
	{
		if (unk_0x6F5E966540163A3D("AZ_DISTANT_SASQUATCH"))
		{
			unk_0xB00E8EBD8B946B23("AZ_DISTANT_SASQUATCH", 0, 1);
		}
		unk_0x23180B0A9E8D2951(iLocal_378, true);
		if (func_460(unk_0xBC25C936A095B5BA()))
		{
			func_232(&uLocal_199, 1, unk_0xBC25C936A095B5BA(), "FRANKLIN", 0, 1);
		}
		if (func_496())
		{
			...
			{
				iVar1 = unk_0x891A339D799A63D0(unk_0xBC25C936A095B5BA(), joaat("weapon_pumpshotgun"));
				if (unk_0x26775FE194CDA741(unk_0xBC25C936A095B5BA(), iVar1) < 8)
				{
					unk_0x7A535CE1F001F3FE(unk_0xBC25C936A095B5BA(), joaat("weapon_pumpshotgun"), 8, true, true);
				}
			}
			else
			{
...
void func_458(int iParam0)//Position - 0x34700
{
	Local_43.f_7 = iParam0;
	Local_43.f_6 = 1;
}

void func_459(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x34713
{
	if (func_496())
	{
		unk_0x6C87EFD58B261C6F(0);
		unk_0x7CB6FD92BE491AD9(&(Global_16B1B.f_14), 2);
		unk_0x121BBDEFA4F0C22B(true);
		if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
		{
			unk_0xDDCAA2E64649E083(unk_0xB5CEFD608600A09F(), false, 0);
		}
...
int func_460(int iParam0)//Position - 0x347A8
{
	if (func_236(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
void func_461()//Position - 0x347C8
{
	unk_0xF0059F27F7BB6680(&Global_93C, 4);
}

void func_462(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x347D8
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_11640 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x17FAADF9916EF741())
			{
				...
				Var4 = { func_464(Global_11641, Global_11643, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_463(char* sParam0)//Position - 0x34ABD
{
	unk_0xE746379C2AF24EF6(sParam0);
	return unk_0x2207C0EA517B975D(1);
}

struct<2> func_464(int iParam0, int iParam1, int iParam2)//Position - 0x34AD0
{
	struct<2> Var0;
	int iVar1;
...
char* func_465(int iParam0)//Position - 0x34BA6
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_466(int iParam0)//Position - 0x34CF9
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_467(int iParam0)//Position - 0x34D2C
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_468(int iParam0)//Position - 0x34D5F
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_469(int iParam0)//Position - 0x34D92
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_470(int iParam0)//Position - 0x34DC5
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_471(int iParam0)//Position - 0x34E02
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_472(int iParam0)//Position - 0x34E35
{
	struct<2> Var0;
...
int func_473(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x34E9E
{
	if (((!func_475(0) || Global_1164F) || Global_11644 == 1) || !unk_0x726D9204B160D23E())
	{
		return 0;
	}
	switch (Global_11640)
...
bool func_474(bool bParam0)//Position - 0x34FB6
{
	if (bParam0)
	{
...
int func_475(int iParam0)//Position - 0x34FDF
{
	if (Global_8C41 == 15)
	{
		return 0;
...
bool func_476(int iParam0)//Position - 0x35001
{
	return func_477(iParam0, Global_8C41);
}

int func_477(int iParam0, int iParam1)//Position - 0x35012
{
	if (iParam1 == 15)
	{
		return 1;
...
void func_478()//Position - 0x351F3
{
	Local_43.f_4 = 0;
	Local_43.f_5 = 0;
	Local_43.f_6 = 0;
...
void func_479()//Position - 0x35214
{
...
void func_480(var uParam0)//Position - 0x3572D
{
	int iVar0;
	float fVar1;
...
void func_481(var uParam0, vector3 vParam1)//Position - 0x357CD
{
	if (uParam0->f_33 == 0)
	{
	}
...
void func_482(var uParam0)//Position - 0x357FE
{
	if (uParam0->f_33)
	{
	}
...
void func_483(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x35825
{
	vLocal_391 = { vParam0 };
	vLocal_392 = { vParam1 };
	fParam2 = fParam2;
...
void func_484(vector3 vParam0, float fParam1, float fParam2)//Position - 0x35843
{
	int iVar0;
...
void func_485(vector3 vParam0, vector3 vParam1, float fParam2, float fParam3, int iParam4, int iParam5)//Position - 0x3588E
{
	func_486(1, vParam0, 0f, vParam1, fParam2, fParam3, iParam4, iParam5);
}

void func_486(int iParam0, vector3 vParam1, float fParam2, vector3 vParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x358AC
{
	int iVar0;
...
void func_487(vector3 vParam0, float fParam1)//Position - 0x3595B
{
	vLocal_402 = { vParam0 };
	fLocal_403 = fParam1;
}

void func_488(vector3 vParam0, vector3 vParam1)//Position - 0x35971
{
	vLocal_388 = { vParam0 };
	vLocal_389 = { vParam1 };
}

void func_489(vector3 vParam0, float fParam1)//Position - 0x3598B
{
	vLocal_395 = { vParam0 };
	fLocal_396 = fParam1;
}

void func_490(vector3 vParam0, float fParam1)//Position - 0x359A1
{
	vLocal_393 = { vParam0 };
	fLocal_394 = fParam1;
}

void func_491(var uParam0, bool bParam1, bool bParam2)//Position - 0x359B7
{
	int iVar0;
...
int func_492(var uParam0)//Position - 0x35AAC
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_37)
	{
		...
		case 2:
			bVar2 = true;
			uParam0->f_1C[0] = unk_0x01B3635C3E8EDD81(25, iLocal_38, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, true);
			if (func_460(uParam0->f_1C[0]))
			{
			...
			{
				func_493(&(uParam0->f_23[0]), iVar0[1], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (unk_0x724D816EA203A79E(uParam0->f_23[0]))
				{
...
void func_493(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x35C92
{
	func_324(iParam0);
...
int func_494(int iParam0)//Position - 0x35CD4
{
	int iVar0;
...
void func_497()//Position - 0x35D53
{
	func_450();
	if (func_499())
	{
	...
	unk_0x23180B0A9E8D2951(iLocal_378, false);
	func_10(0);
	func_8(0);
	func_2(0);
	func_446(&iLocal_385);
	unk_0x0B26CF9D19F91B70(vLocal_408, vLocal_409, 0);
	unk_0xD0FC9D284379BED4("WORLD_HUMAN_HIKER", true);
	unk_0xD0FC9D284379BED4("WORLD_MOUNTAIN_LION_WANDER", true);
	func_441(&Local_44, 0, 0, 0);
	unk_0x95E4B6F3ED223F5A();
}

void func_498()//Position - 0x35E09
{
	unk_0x2CA123B0622F495C(iLocal_370);
}

int func_499()//Position - 0x35E18
{
	int iVar0;
...
void func_500(bool bParam0)//Position - 0x35EB9
{
	int iVar0;
...
void func_501(char* sParam0, int iParam1)//Position - 0x35F89
{
	if (Global_16B1B != 12)
	{
...
int func_502(char* sParam0, int iParam1, int iParam2)//Position - 0x35FB1
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_505())
	{
		...
		{
			iVar2 = func_316(unk_0x1377080E9B0BD993());
			if (iVar2 > -1)
			{
...
int func_503()//Position - 0x36143
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_319(&(Global_16B1B.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_505()//Position - 0x361B7
{
	...
	{
		if (func_316(&(Global_16B1B.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_506(bool bParam0)//Position - 0x36223
{
	unk_0x59B038076F830627(bParam0);
	unk_0x43F06392C4EF25E0(bParam0);
}

void func_507(int iParam0)//Position - 0x36237
{
	if (iParam0 == 1)
	{
		unk_0x3169E2C5E6A096BC();
...
void func_508(int iParam0)//Position - 0x36274
{
	if (iParam0 == 1)
	{
...
void func_509()//Position - 0x362B1
{
	Global_4336.f_5 = 1;
}

void func_510()//Position - 0x362BF
{
	Global_4336.f_5 = 0;
}

void func_511(bool bParam0)//Position - 0x362CD
{
	if (bParam0)
	{
		func_512();
...
void func_512()//Position - 0x36330
{
...
void func_513()//Position - 0x36359
{
	Global_154EC = 0;
	Global_154ED = 0;
}

int func_514()//Position - 0x3636B
{
...
void func_515()//Position - 0x363A9
{
	Global_16B3E = 1;
...
void func_516(char* sParam0)//Position - 0x36496
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_517(var uParam0)//Position - 0x364A8
{
	func_518(&(uParam0->f_1C));
	func_518(&(uParam0->f_23));
	func_518(&(uParam0->f_29));
}

void func_518(var uParam0)//Position - 0x364C8
{
	int iVar0;
