...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_483(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_468(&Var0, 1);
	}
	...
	unk_0x6C5F5B5F6894CCE3(vVar1, Var0.f_F, 1, 0, 0, false);
	if (Var0 == 11)
	{
		func_422(&uLocal_58, 3, Var0.f_1C[0], "MARNIE", 0, 1);
	}
	if (Var0 == 12)
	{
		func_422(&uLocal_58, 4, Var0.f_1C[0], "MARNIE", 0, 1);
		func_422(&uLocal_58, 5, Var0.f_1C[1], "JIMMYBOSTON", 0, 1);
	...
	if (Var0 == 16)
	{
		func_422(&uLocal_58, 4, Var0.f_1C[0], "EPSGUARD5", 0, 1);
		func_422(&uLocal_58, 5, Var0.f_1C[1], "EPSGUARD6", 0, 1);
	}
	while (true)
	{
		SYSTEM::WAIT(0);
		if (!func_401(&Var0, 1))
		{
			if (Var0 == 16 && unk_0x684B06333594F9EA())
			{
		...
		{
			func_382();
			if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 237.926f, 360.2992f, 103.6515f, 244.6899f, 357.8277f, 107.3224f, 4.75f, 0, true, 0))
			{
		...
		{
			if (func_381(Var0.f_1C[0]))
			{
				if (!unk_0x889DA6CE8E4DB344(Var0.f_1C[0]) && !unk_0x2CDE18D6C89522AD(Var0.f_1C[0]))
				{
					func_380(&Var0, vVar1, "EPS3AUD", "EP3_AMB", 3, "MARNIE", 500, 1101004800);
				}
				if (func_361(Var0.f_1C[0], 1, 1116471296, 1126825984, 0, 0, 0, 0))
				{
					if (unk_0xF9E082857622D91E("rcmepsilonism3"))
					{
						unk_0xC5A6DFE2B8987B17(&iLocal_227);
						...
						unk_0x535008C596714F9E(iLocal_227);
						unk_0xA8E6405305C0D7DF(Var0.f_1C[0], iLocal_227);
					}
					else
					{
						unk_0x5558ED6D4A2DEC93(Var0.f_1C[0], unk_0xBC25C936A095B5BA(), 200f, -1, 0, 0);
					}
					unk_0x22321800954A532E(Var0.f_1C[0], true);
					unk_0x02537C8C1BEEB477(&(Var0.f_1C[0]));
					func_468(&Var0, 1);
				}
			}
		}
		else if (Var0 == 12)
		{
			...
			func_360();
			if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 1826.621f, 4698.734f, 41.36862f, 1831.158f, 4680.191f, 32.42626f, 16.5f, 0, true, 0))
			{
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x650C
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6553
{
...
bool func_70(int iParam0)//Position - 0x65AE
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x65BE
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x661E
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6912
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x691D
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x692D
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x69CF
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6F89
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6FE7
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x7095
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x712A
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x716E
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x72F2
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x7300
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7DC7
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7E49
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7EA7
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7EB0
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x8083
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x8093
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x832D
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x833E
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x8384
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x840A
{
...
void func_94(var uParam0, int iParam1)//Position - 0x843D
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x848E
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x8530
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8555
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x856C
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x8579
{
...
void func_100(var uParam0, int iParam1)//Position - 0x85B3
{
...
void func_101(var uParam0, int iParam1)//Position - 0x85EE
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x862A
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x8643
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x869C
{
...
bool func_105(bool bParam0)//Position - 0x86DE
{
...
struct<2> func_106(int iParam0)//Position - 0x8709
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8B56
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9E2E
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0xA174
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0xA218
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0xA2B3
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0xA311
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA36A
{
...
int func_116(int iParam0)//Position - 0xA3ED
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA41E
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA433
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA4E6
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA501
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA54D
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA596
{
	if (func_381(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA5B6
{
	switch (iParam0)
	{
		case 5:
...
int func_126(int iParam0)//Position - 0xA686
{
	switch (iParam0)
	{
		case 5:
...
void func_127(var uParam0, bool bParam1, bool bParam2)//Position - 0xA6D9
{
	int iVar0;
	...
	while (iVar0 < 6)
	{
		if (func_381(uParam0->f_1C[iVar0]))
		{
	...
	while (iVar0 < 5)
	{
		if (func_381(uParam0->f_23[iVar0]))
		{
	...
	while (iVar0 < 6)
	{
		if (func_381(uParam0->f_29[iVar0]))
		{
...
int func_128(int iParam0)//Position - 0xA7CE
{
	switch (iParam0)
	{
		case 5:
...
void func_129(bool bParam0)//Position - 0xA839
{
	int iVar0;
...
void func_130(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA876
{
	if (bParam0)
	{
...
int func_133(int iParam0, bool bParam1)//Position - 0xAA07
{
	int iVar0;
	int iVar1;
...
int func_134(int iParam0)//Position - 0xAA48
{
...
bool func_135()//Position - 0xAA8A
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_136(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xAA9B
{
	int iVar0;
...
void func_138(int iParam0)//Position - 0xAAF5
{
	if (iParam0 == 1)
	{
...
int func_139(char* sParam0)//Position - 0xAB18
{
...
int func_142(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xABC2
{
...
void func_143(int iParam0)//Position - 0xAD51
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_145(int iParam0)//Position - 0xADCE
{
...
void func_146(int iParam0)//Position - 0xADF7
{
	if (Global_3943)
	{
		func_147(0, 0);
...
void func_147(bool bParam0, bool bParam1)//Position - 0xAE67
{
	if (bParam0)
	{
		if (func_148(0))
...
int func_148(int iParam0)//Position - 0xAEDB
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_149(int iParam0)//Position - 0xAF35
{
...
int func_150(int iParam0)//Position - 0xAF76
{
	int iVar0;
	...
	iVar0 = func_152(&(Global_19773[iParam0 /*10*/].f_9), 1, 4, 0, 0);
	if (!iVar0 == 1)
	{
		return 0;
	}
...
void func_151(int iParam0)//Position - 0xAFBB
{
...
int func_152(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAFED
{
	int iVar0;
...
void func_153(var uParam0, int iParam1)//Position - 0xB124
{
	int iVar0;
...
bool func_154(int iParam0)//Position - 0xB173
{
	return func_155(iParam0, Global_8C41);
}

int func_155(int iParam0, int iParam1)//Position - 0xB184
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_156(int iParam0)//Position - 0xB365
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_157()//Position - 0xB387
{
	return func_158(unk_0x1377080E9B0BD993(), 0);
}

int func_158(char* sParam0, int iParam1)//Position - 0xB398
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_160(int iParam0, int iParam1)//Position - 0xB405
{
	switch (iParam0)
	{
		case 0:
			*iParam1 = func_161(-1604.668f, 5239.1f, 3.01f, 0);
			unk_0xBF0E22F3E083C33D(*iParam1, 66);
			unk_0x0D5352939CC40C16(*iParam1, 42);
			break;
		
		case 1:
			*iParam1 = func_161(-1592.84f, 5214.04f, 3.01f, 0);
			unk_0xBF0E22F3E083C33D(*iParam1, 400);
			unk_0x0D5352939CC40C16(*iParam1, 42);
			break;
		...
		case 3:
			*iParam1 = func_161(190.26f, -956.35f, 29.63f, 0);
			if ((unk_0xFA30DFD0084E92FE(Global_19B04.f_4871[2 /*6*/], 3) || unk_0xFA30DFD0084E92FE(Global_19B04.f_4871[4 /*6*/], 3)) || unk_0xFA30DFD0084E92FE(Global_19B04.f_4871[4 /*6*/], 3))
			{
				unk_0xBF0E22F3E083C33D(*iParam1, 381);
			}
			else
			{
				unk_0xBF0E22F3E083C33D(*iParam1, 66);
			...
			{
				unk_0x0D5352939CC40C16(*iParam1, 44);
			}
			break;
		
		case 4:
			*iParam1 = func_161(414f, -761f, 29f, 0);
			if (unk_0xFA30DFD0084E92FE(Global_19B04.f_4871[2 /*6*/], 3) || unk_0xFA30DFD0084E92FE(Global_19B04.f_4871[3 /*6*/], 3))
			{
				unk_0xBF0E22F3E083C33D(*iParam1, 381);
			}
			else
			...
			unk_0x0D5352939CC40C16(*iParam1, 43);
			break;
		...
		case 13:
			...
			unk_0xBF0E22F3E083C33D(*iParam1, 206);
			unk_0x0D5352939CC40C16(*iParam1, 42);
			break;
		...
		case 19:
			...
			unk_0xBF0E22F3E083C33D(*iParam1, 382);
			unk_0x0D5352939CC40C16(*iParam1, 43);
			break;
		...
		case 23:
			...
			if ((unk_0xFA30DFD0084E92FE(Global_19B04.f_4871[21 /*6*/], 3) || unk_0xFA30DFD0084E92FE(Global_19B04.f_4871[22 /*6*/], 3)) || unk_0xFA30DFD0084E92FE(Global_19B04.f_4871[23 /*6*/], 3))
			{
				unk_0xBF0E22F3E083C33D(*iParam1, 405);
			}
			else
			{
				unk_0xBF0E22F3E083C33D(*iParam1, 66);
		...
		case 30:
			*iParam1 = func_161(-1104.93f, 291.25f, 64.3f, 0);
			unk_0xBF0E22F3E083C33D(*iParam1, 385);
			unk_0x0D5352939CC40C16(*iParam1, 44);
			break;
		
		case 34:
			*iParam1 = func_161(-303.82f, 6211.29f, 31.05f, 0);
			unk_0xBF0E22F3E083C33D(*iParam1, 386);
			unk_0x0D5352939CC40C16(*iParam1, 44);
			break;
		
		case 43:
			*iParam1 = func_161(-44.75f, -1288.67f, 28.21f, 0);
			unk_0xBF0E22F3E083C33D(*iParam1, 149);
			unk_0x0D5352939CC40C16(*iParam1, 44);
			break;
		...
		case 48:
			...
			unk_0xBF0E22F3E083C33D(*iParam1, 389);
			unk_0x0D5352939CC40C16(*iParam1, 43);
			break;
	}
}

int func_161(vector3 vParam0, bool bParam1)//Position - 0xB88C
{
	int iVar0;
	
	iVar0 = unk_0x390CF6C8AD6903B7(vParam0);
	unk_0x3F5F1772D71D5EC4(iVar0, func_162(unk_0x7AF0088ABFA713B6(), 1f, 1f));
	unk_0x0BBAABB52887CF8C(iVar0, bParam1);
	return iVar0;
}

float func_162(bool bParam0, float fParam1, float fParam2)//Position - 0xB8B8
{
	if (bParam0)
	{
		return fParam1;
...
int func_163(int iParam0)//Position - 0xB8CF
{
	switch (iParam0)
	{
		case 0:
...
void func_164(var uParam0, int iParam1)//Position - 0xB95E
{
	if (*iParam1)
	{
		switch (*uParam0)
...
void func_165(char* sParam0, char* sParam1, int iParam2, int iParam3)//Position - 0xB9C7
{
	unk_0x2F618BD43614DD0D(sParam0);
	unk_0xC9C304D0AABE1335(sParam1);
	unk_0xAA5C5BF0489E5553(iParam2);
	unk_0x72F8FA06CC9EC899(0, 0, true, iParam3);
}

void func_166(char* sParam0, char* sParam1, int iParam2)//Position - 0xB9EA
{
	unk_0x2F618BD43614DD0D(sParam0);
	unk_0xC9C304D0AABE1335(sParam1);
...
int func_167(var uParam0)//Position - 0xBA07
{
	switch (*uParam0)
	{
		case 15:
		...
		case 16:
			...
			if (func_168(0) >= 50000 || Global_19B04.f_4871.f_183 == 1)
			{
				return func_315(*uParam0);
			}
			else
...
int func_168(int iParam0)//Position - 0xBAAC
{
	var uVar0;
...
void func_169(int iParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0xBB04
{
	int iVar0;
	int iVar1;
	...
	func_170(Global_19B04.f_6D75[iParam0 /*29*/].f_11, 1, iParam1, iParam2, 0);
	if (bParam3)
	{
		iVar0 = 0;
		if (bParam4)
...
int func_170(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xBBEB
{
	float fVar0;
	int iVar1;
	int iVar2;
...
void func_171(bool bParam0)//Position - 0xC1EC
{
	int iVar0;
	int iVar1;
...
void func_172(int iParam0)//Position - 0xC46E
{
	int iVar0;
...
void func_173(int iParam0)//Position - 0xC4C8
{
	bool bVar0;
	char cVar1[64];
	...
	else if (unk_0xFA30DFD0084E92FE(Global_19B04.f_5037.f_1D7, iParam0) || unk_0xFA30DFD0084E92FE(Global_200000[func_175() /*12171*/].f_1E08.f_A, iParam0))
	{
		bVar0 = true;
		unk_0x7CB6FD92BE491AD9(&(Global_19B04.f_5037.f_1D7), iParam0);
		unk_0x7CB6FD92BE491AD9(&(Global_200000[func_175() /*12171*/].f_1E08.f_A), iParam0);
	}
	if (bVar0)
	{
...
char* func_174(int iParam0)//Position - 0xC59F
{
	switch (iParam0)
	{
		case 0:
...
int func_176(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xC634
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_177(int iParam0)//Position - 0xCB4E
{
	func_198(93, iParam0);
	func_198(29, iParam0);
	func_198(30, iParam0);
...
bool func_178(int iParam0)//Position - 0xCB6E
{
	if (iParam0 == 8)
	{
	...
	return unk_0xFA30DFD0084E92FE(Global_200000[func_175() /*12171*/].f_1E08.f_A, iParam0);
}

int func_179(int iParam0, int iParam1, int iParam2)//Position - 0xCBBC
{
	int iVar0;
	int iVar1;
	var uVar2;
...
int func_180(int iParam0)//Position - 0xCBF9
{
	int iVar0;
...
int func_181(int iParam0, int iParam1)//Position - 0xCEE5
{
	int iVar0;
...
int func_182(bool bParam0)//Position - 0xD1B2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_183(int iParam0, int iParam1)//Position - 0xD269
{
	if (iParam0 >= 78)
	{
		return 0;
...
int func_184(int iParam0, int iParam1)//Position - 0xD284
{
	...
	if (func_194(&Global_411EB6))
	{
		if (func_192(&Global_411EB6, iParam0))
		{
			return 0;
		}
		if (func_185(&Global_411EB6, iParam0))
		{
			return 1;
		}
	}
...
int func_185(var uParam0, int iParam1)//Position - 0xD321
{
	int iVar0;
	var uVar1[78];
...
int func_186(var uParam0, int iParam1)//Position - 0xD3D2
{
	int iVar0;
...
bool func_187(var uParam0, int iParam1)//Position - 0xD44D
{
	return (*uParam0)[iParam1] == 78;
}

void func_188(var uParam0)//Position - 0xD45E
{
	int iVar0;
	...
	func_190(uParam0, (Global_411EB5 - 0.5f));
}

void func_189(var uParam0, int iParam1)//Position - 0xD492
{
	(*uParam0)[iParam1] = 78;
}

void func_190(var uParam0, float fParam1)//Position - 0xD4A2
{
	if (fParam1 == 0f)
	{
		uParam0->f_50 = 0f;
...
float func_191(var uParam0)//Position - 0xD4BF
{
	return uParam0->f_50;
}

bool func_192(var uParam0, int iParam1)//Position - 0xD4CB
{
	return func_193(uParam0, iParam1) != -1;
}

int func_193(var uParam0, int iParam1)//Position - 0xD4DD
{
	int iVar0;
...
bool func_194(var uParam0)//Position - 0xD50A
{
	return uParam0->f_4F == 1;
}

int func_195(int iParam0)//Position - 0xD518
{
	switch (iParam0)
	{
		case 60:
...
int func_196(int iParam0, int iParam1)//Position - 0xD568
{
	int iVar0;
...
void func_197(int iParam0, int iParam1)//Position - 0xD5B9
{
	int iVar0;
...
void func_198(int iParam0, int iParam1)//Position - 0xD5DC
{
	int iVar0;
...
int func_200(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xD6AE
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_11489[1 /*14*/] = { func_249(iVar10, iParam1, iParam2) };
		if (!func_248(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_11489[1 /*14*/] = { func_249(iVar10, iVar0, uVar11[iVar0]) };
				if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_11489[1 /*14*/] = { func_249(iVar10, 14, uVar12[iVar1]) };
							func_221(iParam0, Global_11489[1 /*14*/].f_C, Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4);
							func_243(14);
							if (Global_11487 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							unk_0xB0031DDAE4FF0BC3(iParam0, func_211(iVar0), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, unk_0x41AF5D2DF638D88F(iParam0, func_211(iVar0)));
						}
						else
						{
							unk_0xB0031DDAE4FF0BC3(iParam0, func_211(iVar0), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, iParam4);
						}
						func_243(iVar0);
						if (Global_11487 == 1)
						{
			...
			{
				Global_11489[1 /*14*/] = { func_249(iVar10, iVar0, func_210(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_11489[1 /*14*/] = { func_249(iVar10, 14, uVar15[iVar1]) };
			func_221(iParam0, Global_11489[1 /*14*/].f_C, Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4);
			func_243(14);
			if (Global_11487 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			unk_0xB0031DDAE4FF0BC3(iParam0, func_211(iParam1), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, unk_0x41AF5D2DF638D88F(iParam0, func_211(iParam1)));
		}
		else
		{
			unk_0xB0031DDAE4FF0BC3(iParam0, func_211(iParam1), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, iParam4);
		}
		if (Global_11487 == 1)
		{
			iVar2 = 0;
...
int func_201(int iParam0, int iParam1, int iParam2)//Position - 0xDEBA
{
	int iVar0;
	...
	{
		if (!func_202(iParam0, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_40, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_3F))
		{
...
int func_202(int iParam0, int iParam1, int iParam2)//Position - 0xDF46
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	Global_11489[1 /*14*/] = { func_249(iVar0, iParam1, iParam2) };
	if (!unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0))
	{
		return 0;
	}
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_202(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_202(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_11489[2 /*14*/] = { func_249(iVar0, 14, iVar4) };
									if (Global_11489[2 /*14*/].f_C == iVar3)
									{
										if (func_202(iParam0, 14, iVar4))
										{
											if (!func_207(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_11489[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_11489[2 /*14*/] = { func_249(iVar0, iVar2, iVar1) };
						if (!func_207(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_11489[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_11489[1 /*14*/].f_3 == unk_0xA86A4D206EC8EB16(iParam0, func_211(iParam1)) && Global_11489[1 /*14*/].f_4 == unk_0x695D13ECF7DAEC22(iParam0, func_211(iParam1)))
	{
		return 1;
	}
	return 0;
...
int func_203(int iParam0)//Position - 0xE19E
{
	switch (iParam0)
	{
...
void func_204(int iParam0, int iParam1, int iParam2)//Position - 0xE1D9
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0, int iParam1, int iParam2)//Position - 0xE263
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_206(int iParam0, int iParam1, int iParam2)//Position - 0xE341
{
	Global_11489[1 /*14*/] = { func_249(iParam0, iParam1, iParam2) };
	return unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 2);
}

int func_207(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0xE36B
{
	var uVar0;
	int iVar1;
...
int func_208(int iParam0, int iParam1, int iParam2)//Position - 0xE96F
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_209(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEA08
{
	int iVar0;
	...
	{
		if (!func_202(iParam0, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_3D, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_3C) || iParam3 == 1)
		{
...
int func_210(int iParam0, int iParam1, int iParam2)//Position - 0xEA9E
{
	int iVar0;
	int iVar1;
...
int func_211(int iParam0)//Position - 0xEB3F
{
	switch (iParam0)
	{
		case 0:
...
int func_212(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xEBEF
{
	int iVar0;
...
int func_213(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEEF6
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_214(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0xFAA9
{
	int iVar0;
...
int func_215(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xFD8D
{
	int iVar0;
...
int func_216(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10055
{
	int iVar0;
	int iVar1;
...
int func_217(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1008C
{
	int iVar0;
...
int func_218(int iParam0, int iParam1, int iParam2)//Position - 0x100B5
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_219(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1037F
{
	int iVar0;
...
int func_220(int iParam0, int iParam1, int iParam2)//Position - 0x10609
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_221(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10760
{
	int iVar0;
...
int func_222(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x107F8
{
	switch (iParam0)
	{
...
int func_223(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x108C6
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar9 = unk_0x84E17E2A0638D182(iParam3, 6, -1, 0, -1, func_211(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_224(int iParam0, int iParam1)//Position - 0x10A22
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_225(int iParam0)//Position - 0x10DC9
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_226(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x10E2A
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_227(int iParam0, int iParam1)//Position - 0x10F26
{
	int iVar0;
...
int func_228(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11064
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x84E17E2A0638D182(iParam3, 6, -1, 0, -1, func_211(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
int func_229(int iParam0)//Position - 0x11144
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_230(int iParam0, int iParam1)//Position - 0x111CA
{
	int iVar0;
	struct<10> Var1;
...
void func_231(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x11AF9
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_232(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x11C23
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_233(int iParam0, int iParam1)//Position - 0x11C6B
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_236(&Var1, -99, -99, Global_19B04.f_932.f_21B.f_C4[0], Global_19B04.f_932.f_21B.f_C8[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_236(&Var1, -99, -99, Global_19B04.f_932.f_21B.f_C4[1], Global_19B04.f_932.f_21B.f_C8[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_236(&Var1, -99, -99, Global_19B04.f_932.f_21B.f_C4[2], Global_19B04.f_932.f_21B.f_C8[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_234(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13AB3
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_235(int iParam0)//Position - 0x13C9D
{
	switch (iParam0)
	{
		case 0:
...
void func_236(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x13D4D
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
int func_237(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x13DBE
{
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 1) || unk_0xF062C4E30590463E(func_223(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 0) || unk_0xF062C4E30590463E(func_223(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 1) || unk_0xF062C4E30590463E(func_223(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 0) || unk_0xF062C4E30590463E(func_223(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_238(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1403D
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_239(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x14462
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_240(int iParam0, int iParam1)//Position - 0x14755
{
	int iVar0;
	int iVar1;
...
int func_241(int iParam0, int iParam1)//Position - 0x1479B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_242(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x147FB
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_243(int iParam0)//Position - 0x1487F
{
	if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 1) && !unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 6))
	{
		func_247(iParam0, Global_11489[1 /*14*/].f_5, Global_11489[1 /*14*/].f_2, 2, Global_11489[1 /*14*/].f_1, 1, 0);
	}
	if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 1) && unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
		{
			func_244(Global_280004, 2, 1, 1, -1);
		}
		else if (iParam0 == 13)
		{
		}
...
void func_244(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x14937
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_245(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x14981
{
	int iVar0;
	...
	iVar0 = Global_269BC5[iParam0 /*3*/][func_49(iParam2)];
	if (iVar0 != 0)
	{
...
bool func_246(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x149B1
{
	int iVar0;
...
int func_247(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x162A8
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_248(int iParam0)//Position - 0x171C6
{
	if (!unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0))
	{
		return 0;
...
struct<14> func_249(int iParam0, int iParam1, int iParam2)//Position - 0x17217
{
	func_312();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_250(int iParam0, int iParam1)//Position - 0x17269
{
	switch (iParam0)
	{
		case 0:
...
void func_251(int iParam0)//Position - 0x17359
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_252(&(Global_11489[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_252(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x185D1
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_256(Global_280004, 1, 1, 1, -1))
			{
				unk_0x7CB6FD92BE491AD9(&(uParam0->f_6), 2);
			}
			if (!func_256(Global_280004, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_48(func_255(iParam1, uParam0->f_2), Global_11486, 0);
			if (unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
			{
				unk_0xF0059F27F7BB6680(&(uParam0->f_6), 1);
			}
			iVar0 = func_48(func_254(iParam1, uParam0->f_2), Global_11486, 0);
			if (unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
			{
				unk_0xF0059F27F7BB6680(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_48(iVar1, Global_11486, 0);
				if (!unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
				{
					unk_0xF0059F27F7BB6680(&(uParam0->f_6), 4);
				}
...
bool func_253(int iParam0, int iParam1, var uParam2)//Position - 0x18962
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_254(int iParam0, int iParam1)//Position - 0x18D67
{
	switch (iParam1)
	{
		case 0:
...
int func_255(int iParam0, int iParam1)//Position - 0x19162
{
	switch (iParam1)
	{
		case 0:
...
int func_256(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x1955D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_257(int iParam0)//Position - 0x1959F
{
	switch (iParam0)
	{
		case -1:
...
void func_258(int iParam0, int iParam1, int iParam2)//Position - 0x19673
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar3 < iVar5)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_252(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_252(&(Global_11489[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_252(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xF062C4E30590463E(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = unk_0x84E17E2A0638D182(iVar1, 6, -1, 0, -1, func_211(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var11;
					func_252(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xF062C4E30590463E(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
void func_259(int iParam0)//Position - 0x198EE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_260(int iParam0)//Position - 0x19A44
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_261(int iParam0)//Position - 0x19F51
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_262(int iParam0)//Position - 0x19FC5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_263(int iParam0)//Position - 0x1A038
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_264(int iParam0)//Position - 0x1A11E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_265(int iParam0)//Position - 0x1A480
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_266(int iParam0)//Position - 0x1A690
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_267(int iParam0)//Position - 0x1A8BF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_268(int iParam0)//Position - 0x1A9CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_269(int iParam0)//Position - 0x1B36C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_270(int iParam0)//Position - 0x1BEDE
{
	if (iParam0 < 136)
	{
		func_272(iParam0);
...
void func_271(int iParam0)//Position - 0x1BF12
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_272(int iParam0)//Position - 0x1CBDD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_273(int iParam0)//Position - 0x1DAEB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_274(int iParam0)//Position - 0x1DC17
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_275(int iParam0, int iParam1)//Position - 0x1DD14
{
	switch (iParam0)
	{
		case 0:
...
void func_276(int iParam0)//Position - 0x1DE04
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_277(int iParam0)//Position - 0x1F2F4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_278(int iParam0)//Position - 0x1F444
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_279(int iParam0)//Position - 0x1F94E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_280(int iParam0)//Position - 0x1FFBB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_281(int iParam0)//Position - 0x20030
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_282(int iParam0)//Position - 0x200FF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_283(int iParam0)//Position - 0x2062E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_284(int iParam0)//Position - 0x207C4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_285(int iParam0)//Position - 0x20FC1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_286(int iParam0)//Position - 0x210D0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_287(int iParam0)//Position - 0x21FFA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_288(int iParam0)//Position - 0x22CB6
{
	if (iParam0 < 107)
	{
		func_291(iParam0);
...
void func_289(int iParam0)//Position - 0x22CFB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_290(int iParam0)//Position - 0x237A0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_291(int iParam0)//Position - 0x24591
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_292(int iParam0)//Position - 0x251DA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_293(int iParam0)//Position - 0x25452
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_294(int iParam0, int iParam1)//Position - 0x25597
{
	switch (iParam0)
	{
		case 0:
...
void func_295(int iParam0)//Position - 0x25687
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_296(int iParam0)//Position - 0x26410
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_297(int iParam0)//Position - 0x26589
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_298(int iParam0)//Position - 0x26AFF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_299(int iParam0)//Position - 0x27028
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_300(int iParam0)//Position - 0x2709B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_301(int iParam0)//Position - 0x2716A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_302(int iParam0)//Position - 0x27641
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_303(int iParam0)//Position - 0x278A9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_304(int iParam0)//Position - 0x27B7E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_305(int iParam0)//Position - 0x27D46
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_306(int iParam0)//Position - 0x2889B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_307(int iParam0)//Position - 0x294E4
{
	if (iParam0 < 60)
	{
		func_309(iParam0);
...
void func_308(int iParam0)//Position - 0x29518
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_309(int iParam0)//Position - 0x2A2B8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_310(int iParam0)//Position - 0x2A944
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_311(int iParam0)//Position - 0x2AA2A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_312()//Position - 0x2AB27
{
...
int func_313(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x2ABA0
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0) && !unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_247(iParam1, Global_11489[1 /*14*/].f_5, Global_11489[1 /*14*/].f_2, 1, Global_11489[1 /*14*/].f_1, 1, 0);
			if (iParam1 == 12)
			{
				iVar0 = 1;
				if (iParam0 == joaat("player_zero"))
		...
		{
			func_247(iParam1, Global_11489[1 /*14*/].f_5, Global_11489[1 /*14*/].f_2, 1, Global_11489[1 /*14*/].f_1, 0, 1);
		}
...
int func_314(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x2AF87
{
	Global_11489[1 /*14*/] = { func_249(iParam0, iParam1, iParam2) };
	if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0) && !unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 6))
	{
		if (bParam3)
		{
			func_247(iParam1, Global_11489[1 /*14*/].f_5, Global_11489[1 /*14*/].f_2, 0, Global_11489[1 /*14*/].f_1, 1, 0);
		}
		else
		{
			func_247(iParam1, Global_11489[1 /*14*/].f_5, Global_11489[1 /*14*/].f_2, 0, Global_11489[1 /*14*/].f_1, 0, 1);
		}
		return 1;
	}
	return 0;
...
int func_315(int iParam0)//Position - 0x2B022
{
...
int func_316(var uParam0, int iParam1)//Position - 0x2B08B
{
	switch (uParam0->f_10)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					if (func_381(uParam0->f_1C[0]))
					{
						if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(uParam0->f_1C[0], true), true) < 3f)
						{
							if (func_322(2))
							{
								if (func_320(uParam0->f_1B))
								{
									func_319(uParam0->f_1B, *uParam0);
				...
				else if (func_381(uParam0->f_1C[0]))
				{
					if (func_318(uParam0))
					{
						if (func_322(2))
...
void func_317()//Position - 0x2B86E
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_318(var uParam0)//Position - 0x2B889
{
	float fVar0;
...
void func_319(int iParam0, int iParam1)//Position - 0x2B917
{
	if (iParam0 == 1)
	{
		if (!func_126(iParam1))
...
int func_320(bool bParam0)//Position - 0x2B97B
{
	int iVar0;
...
int func_321(int iParam0)//Position - 0x2BA12
{
	if (func_381(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_322(int iParam0)//Position - 0x2BA3C
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_330()) || Global_62BF) || func_329()) || func_328(8, -1)) || func_326()) || func_90()) || func_327()) || func_325()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_330()) || Global_1974B) || Global_62BF) || func_329()) || func_328(8, -1)) || func_326()) || func_90()) || func_327()) || func_325()) || Global_19B04.f_1DEB.f_397[iVar0] == 5) || Global_8E64 != -1)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_330() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_328(8, -1)) || func_325()) || func_324()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_330()) || Global_62BF) || func_329()) || func_328(8, -1)) || func_327()) || func_326()) || func_325()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || !unk_0x8CC5A4A5615C6420(unk_0xB5CEFD608600A09F())) || !unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F())) || !unk_0x726D9204B160D23E()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || func_330()) || func_327()) || Global_1974B) || Global_62BF) || func_329()) || Global_90C1) || func_328(8, -1)) || func_326()) || func_324()) || func_325()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_323()//Position - 0x2C159
{
	return Global_16B42.f_1;
}

int func_324()//Position - 0x2C167
{
	if (Global_15FA6 != -1)
	{
...
bool func_327()//Position - 0x2C1D1
{
	return Global_16B4F.f_142 > 0;
}

bool func_328(int iParam0, int iParam1)//Position - 0x2C1E2
{
	switch (iParam0)
	{
		case 5:
...
var func_329()//Position - 0x2C21D
{
	return Global_140856;
}

int func_330()//Position - 0x2C229
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
void func_331(var uParam0, int iParam1)//Position - 0x2C245
{
	if (!*iParam1)
	{
		if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), uParam0->f_11[0 /*3*/], true) > 25f)
				{
...
void func_332(int iParam0, char* sParam1, vector3 vParam2)//Position - 0x2C297
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_336(unk_0xBC25C936A095B5BA(), vParam2, 1) <= 100f)
				{
					func_335(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_336(unk_0xBC25C936A095B5BA(), vParam2, 1) > 120f)
				{
					func_338(iParam0);
				}
			}
...
void func_333(int iParam0, bool bParam1)//Position - 0x2C388
{
	if (iParam0 == -1)
	{
		return;
...
int func_334(int iParam0)//Position - 0x2C3C4
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_335(int iParam0, int iParam1)//Position - 0x2C3FD
{
	bool bVar0;
	int iVar1;
...
float func_336(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x2C49B
{
	vector3 vVar0;
...
bool func_337()//Position - 0x2C4D5
{
	return Global_16129;
}

void func_338(int iParam0)//Position - 0x2C4E1
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_339(iParam0);
...
void func_339(int iParam0)//Position - 0x2C4F8
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_340(int iParam0)//Position - 0x2C5E0
{
	if (iParam0 == -1)
	{
		iParam0 = func_157();
...
void func_341()//Position - 0x2C608
{
	switch (iLocal_57)
	{
		case 0:
			if ((unk_0x105601648511CC64() - iLocal_223) > 20000)
			{
				iLocal_57 = 1;
			}
			break;
...
bool func_342(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x2C6C7
{
...
int func_343(char* sParam0, int iParam1, bool bParam2)//Position - 0x2C715
{
	Global_3DB9 = 0;
...
void func_344()//Position - 0x2C9E1
{
	int iVar0;
...
void func_345()//Position - 0x2CA13
{
...
void func_347()//Position - 0x2CB41
{
	if (func_56(14))
	{
		if (!unk_0x1D403DFADBC2DE3C(unk_0xBC25C936A095B5BA(), 0))
...
void func_348()//Position - 0x2CBE3
{
	int iVar0;
...
void func_349()//Position - 0x2CC3B
{
...
void func_350(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2CC92
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_351(int iParam0)//Position - 0x2CCE8
{
	if (func_381(iParam0->f_1C[0]))
	{
		switch (iLocal_232)
		{
			case 0:
				...
				{
					unk_0xE896C0AD02364F2A(iParam0->f_1C[0], "rcmepsilonism6", "cultist_upperstatic", 8f, -8f, -1, 49, 0, 0, 0, 0);
					iLocal_232 = 1;
			...
			case 1:
				if (!func_359(iParam0->f_1C[0], 713668775))
				{
					unk_0x346129B364057FF6(iParam0->f_1C[0], vLocal_234[iLocal_233 /*3*/], 1f, 20000, 1048576000, 0, 1193033728);
			...
			case 2:
				if (func_336(iParam0->f_1C[0], vLocal_234[iLocal_233 /*3*/], 1) <= 1.2f)
				{
					iLocal_232 = 3;
			...
			case 3:
				unk_0xA4E856A8CD53B8DF(iParam0->f_1C[0]);
				unk_0xE896C0AD02364F2A(iParam0->f_1C[0], "rcmepsilonism6", "cultist_idle_a", 16f, -2f, -1, 131072, 0, 0, 0, 0);
				unk_0x2EB4D46478766D87(iParam0->f_1C[0], 0, 0);
				iLocal_232 = 4;
				func_484("Eps 6: Done Tom idle anim");
				break;
			
			case 4:
				if (unk_0x96044E39418AAF17(iParam0->f_1C[0], "rcmepsilonism6", "cultist_idle_a", 3))
				{
					if (unk_0x4A3B2CF8BADDD74E(iParam0->f_1C[0], "rcmepsilonism6", "cultist_idle_a") >= 0.98f)
					{
						if (iLocal_233 >= 2)
						{
							iLocal_233 = 0;
						...
						unk_0xE896C0AD02364F2A(iParam0->f_1C[0], "rcmepsilonism6", "cultist_upperstatic", 16f, -8f, -1, 49, 0, 0, 0, 0);
						unk_0x2EB4D46478766D87(iParam0->f_1C[0], 0, 0);
						iLocal_232 = 1;
...
void func_352()//Position - 0x2CF47
{
	Global_394A = 0;
	func_349();
}

int func_353()//Position - 0x2CF57
{
...
int func_354(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)//Position - 0x2CF79
{
	var uVar0;
	...
	if (func_322(2))
	{
		if (!func_353())
		{
			if (((func_381(unk_0xBC25C936A095B5BA()) && func_381(uParam0->f_1C[0])) && (unk_0x105601648511CC64() - uParam0->f_3C) > iParam6) && func_336(unk_0xBC25C936A095B5BA(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
				func_422(&uVar0, iParam4, uParam0->f_1C[0], sParam5, 0, 1);
				func_357(&uVar0, cParam2, sParam3, 7, 0, 0);
				uParam0->f_3C = unk_0x105601648511CC64();
				return 1;
			}
		}
		else if (func_355(sParam3))
		{
			if (func_381(unk_0xBC25C936A095B5BA()))
			{
				if (func_336(unk_0xBC25C936A095B5BA(), vParam1, 1) >= 20f)
				{
					func_352();
				}
			}
...
int func_355(char* sParam0)//Position - 0x2D03B
{
	struct<6> Var0;
...
struct<6> func_356()//Position - 0x2D05B
{
	struct<6> Var0;
...
void func_357(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2D07F
{
...
void func_358()//Position - 0x2D0BA
{
	switch (iLocal_57)
	{
		case 0:
		...
		case 1:
			if (func_336(unk_0xBC25C936A095B5BA(), 1826.45f, 4699.58f, 38.15f, 1) <= 25f && iLocal_224 == 0)
			{
...
int func_359(int iParam0, int iParam1)//Position - 0x2D165
{
	if (func_123(iParam0))
	{
...
void func_360()//Position - 0x2D198
{
	unk_0x29CD142125FE177B(iLocal_228, "SET_COLOUR");
	...
	unk_0x29CD142125FE177B(iLocal_228, "SET_DISTANCE");
	unk_0xD44E04EBBDC4CE88(10f);
	unk_0xF9FBC2F3F73D94C9();
	unk_0xF14A31FD690DC3B0(iLocal_229);
	unk_0x65E432C782E7E702(iLocal_228, 0.1f, 0.24f, 0.21f, 0.51f, 100, 100, 100, 255, 0);
	if ((unk_0x105601648511CC64() - iLocal_230) > 1250)
	{
		unk_0x10B5C0C7337B8420(iLocal_231, "IDLE_BEEP_NPC", 1827.06f, 4700.52f, 39.16f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_230 = unk_0x105601648511CC64();
	}
}

int func_361(int iParam0, bool bParam1, float fParam2, float fParam3, bool bParam4, bool bParam5, bool bParam6, bool bParam7)//Position - 0x2D25E
{
	vector3 vVar0;
...
int func_362(int iParam0, float fParam1)//Position - 0x2D319
{
	float fVar0;
...
bool func_363(int iParam0, float fParam1)//Position - 0x2D38F
{
	return func_364(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_364(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0x2D3A7
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_365(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2D468
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_366(int iParam0, int iParam1)//Position - 0x2D594
{
	int iVar0;
...
int func_368(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x2D6A3
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_370(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_370(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_369(vector3 vParam0, vector3 vParam1)//Position - 0x2D734
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_370(vector3 vParam0)//Position - 0x2D755
{
	float fVar0;
	float fVar1;
...
void func_371(var uParam0)//Position - 0x2D794
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_372(int iParam0, int iParam1)//Position - 0x2D7AF
{
	int iVar0;
...
int func_373(int iParam0)//Position - 0x2D7EE
{
...
bool func_374(int iParam0, int iParam1, float fParam2)//Position - 0x2D816
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_375(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x2D85D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_376(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0x2D958
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_377(int iParam0, float fParam1)//Position - 0x2DA64
{
	var uVar0;
	vector3 vVar1;
...
int func_378(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0x2DAF9
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_370(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_379(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0x2DB87
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_380(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0x2DBCF
{
	var uVar0;
	
	if ((((func_381(unk_0xBC25C936A095B5BA()) && func_381(uParam0->f_1C[0])) && !func_353()) && (unk_0x105601648511CC64() - uParam0->f_3C) > iParam6) && func_336(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_422(&uVar0, iParam4, uParam0->f_1C[0], sParam5, 0, 1);
		func_357(&uVar0, cParam2, sParam3, 7, 0, 0);
...
int func_381(int iParam0)//Position - 0x2DC57
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
...
void func_382()//Position - 0x2DC78
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (unk_0x7214F4879DF8A314(unk_0xBC25C936A095B5BA()))
	...
	if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 244.9669f, 374.6696f, 104.4579f, 239.6119f, 360.3045f, 107.7523f, 9.0625f, 0, true, 0))
	{
		Global_940 = 1;
	}
	else
...
void func_383(int iParam0, int iParam1)//Position - 0x2DCF8
{
	int iVar0;
...
void func_384(int iParam0)//Position - 0x2DDF1
{
...
void func_385(int iParam0)//Position - 0x2DE3F
{
	struct<7> Var0;
	bool bVar1;
	bool bVar2;
...
int func_387(int iParam0)//Position - 0x2E3A1
{
	int iVar0;
...
int func_388(int iParam0)//Position - 0x2E5F6
{
	int iVar0;
...
int func_389(int iParam0)//Position - 0x2E662
{
	return iParam0;
}

void func_390(int iParam0, var uParam1)//Position - 0x2E66C
{
	int iVar0;
	int iVar1;
	...
	switch (iParam0)
	{
		...
		case 71:
		case 72:
			if (!func_391(iParam0) && unk_0xB731B8C5BCE89836(Global_147B0[26 /*34*/].f_6) == 0)
			{
				Global_19B04.f_1C40[iParam0] = 1;
				unk_0xF72F6BB050622804(uParam1->f_5, Global_19B04.f_1C40[iParam0], 1, 1);
			}
...
bool func_391(int iParam0)//Position - 0x2F007
{
	struct<7> Var0;
	int iVar1;
...
int func_392(int iParam0)//Position - 0x2F03B
{
	return SYSTEM::SHIFT_RIGHT(iParam0, 9) & 31;
}

struct<7> func_393(int iParam0)//Position - 0x2F04E
{
	struct<7> Var0;
...
int func_395()//Position - 0x31C88
{
	return Global_62BE;
}

void func_396(int iParam0, bool bParam1)//Position - 0x31C93
{
	if (iParam0 == -1)
	{
		return;
...
void func_397(int iParam0, int iParam1, bool bParam2)//Position - 0x31CF0
{
	if (iParam0 == -1)
	{
		return;
...
bool func_398(int iParam0, int iParam1)//Position - 0x31D2B
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_399()//Position - 0x31D4E
{
...
void func_400(int iParam0)//Position - 0x31DC1
{
	int iVar0;
	...
	if (func_381(unk_0xBC25C936A095B5BA()))
	{
		...
		{
			if (func_123(iParam0->f_1C[iVar0]))
			{
				unk_0x91629AC1E1F78419(iParam0->f_1C[iVar0], 1, false);
				unk_0x2E35C4FA5F0ED22F(iParam0->f_1C[iVar0], false);
				unk_0x22321800954A532E(iParam0->f_1C[iVar0], true);
				unk_0xB8CBD998685C0685(iParam0->f_1C[iVar0], unk_0xBC25C936A095B5BA(), 0, 16);
				unk_0x02537C8C1BEEB477(&(iParam0->f_1C[iVar0]));
			}
			iVar0++;
		}
	}
...
int func_401(var uParam0, bool bParam1)//Position - 0x31E41
{
	struct<27> Var0;
	...
	if ((func_420(*uParam0) || func_418(*uParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
	...
	if (func_405(&(uParam0->f_30)) && bParam1)
	{
		func_402(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_402(int iParam0, var uParam1, int iParam2)//Position - 0x320B4
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_404(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_404(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_403(int iParam0)//Position - 0x3240C
{
...
int func_404(var uParam0)//Position - 0x3242C
{
...
int func_405(var uParam0)//Position - 0x32444
{
...
void func_406(var uParam0)//Position - 0x32469
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_407(&(uParam0->f_29[1]));
		func_407(&(uParam0->f_29[2]));
	}
	if (func_381(unk_0xBC25C936A095B5BA()))
	{
		iVar0 = 0;
...
void func_407(int iParam0)//Position - 0x3276D
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_408(var uParam0, bool bParam1, bool bParam2)//Position - 0x32798
{
	int iVar0;
	int iVar1;
	int iVar2;
				...
				if (bParam2)
				{
					if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
					{
						...
						if (func_321(iVar2))
						{
							...
							{
								if (func_321(uParam0->f_23[iVar0]))
								{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_409(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_409(int iParam0, int iParam1)//Position - 0x32956
{
	int iVar0;
...
int func_410(var uParam0, bool bParam1, int iParam2)//Position - 0x32986
{
	int iVar0;
	int iVar1;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_1C[iVar0]))
			{
				if (!unk_0x36CEFBE9B745A58D(uParam0->f_1C[iVar0]))
				{
					...
					if (func_412(*uParam0))
					{
						if (!func_149(*uParam0))
						{
							if (func_375(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_406(uParam0);
						...
						if (func_362(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_406(uParam0);
...
int func_411(int iParam0)//Position - 0x32C42
{
...
int func_412(int iParam0)//Position - 0x32C76
{
...
void func_413(int iParam0)//Position - 0x32CC0
{
	int iVar0;
...
int func_414(int iParam0)//Position - 0x32D5D
{
	if (iParam0 == -1)
	{
		iParam0 = func_157();
...
int func_415(int iParam0)//Position - 0x32DF5
{
...
int func_418(int iParam0)//Position - 0x32E77
{
	if ((func_419() && Global_16B1B.f_B == 6) && iParam0 == func_158(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_420(int iParam0)//Position - 0x32EE9
{
	if (func_105(0))
	{
...
void func_421()//Position - 0x32F11
{
	iLocal_228 = unk_0x9934FEFB3B8C6DB8("digiscanner");
	while (!unk_0xA7F138B5B1AB2CF6(iLocal_228))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (unk_0x56B8298B48E2A713("digiscanner"))
	{
		iLocal_229 = unk_0xCE506A7684415A58("digiscanner");
	}
	iLocal_231 = unk_0x2F079D1FC5F6CB99();
	iLocal_230 = unk_0x105601648511CC64();
}

void func_422(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x32F7E
{
...
int func_423(int iParam0)//Position - 0x33019
{
	switch (*iParam0)
	{
		case 9:
...
int func_427(var uParam0)//Position - 0x331BD
{
	...
	switch (iLocal_51)
	{
		...
		case 2:
			func_430(&(uParam0->f_23[0]), iVar0[0], -686.5046f, 43.9098f, 42.2067f, 296.81f);
			unk_0xD421BC740C5340C3(uParam0->f_23[0], 3);
			unk_0x914C5DE0B15B8B59(uParam0->f_23[0], 157, 157);
			unk_0x4C59702AC1076A88(uParam0->f_23[0], 0, 0);
			unk_0xD7E19B03E0EB54E5(uParam0->f_23[0], 1);
			unk_0x5EDEB04A454C1C0C(uParam0->f_23[0], 0);
			func_430(&(uParam0->f_23[1]), iVar0[1], -697.3215f, 39.0406f, 42.86736f, -66.98854f);
			unk_0xD421BC740C5340C3(uParam0->f_23[1], 3);
			unk_0xEA0AB6C644C58C1D(uParam0->f_23[1], "K1FFL0M");
			unk_0x914C5DE0B15B8B59(uParam0->f_23[1], 157, 157);
			unk_0x4C59702AC1076A88(uParam0->f_23[1], 0, 0);
			unk_0x5EDEB04A454C1C0C(uParam0->f_23[1], 0);
			func_428(&(uParam0->f_1C[0]), iVar0[2], -726.4555f, 33.33568f, 43.22695f, -147.8099f, 26);
			unk_0x7A535CE1F001F3FE(uParam0->f_1C[0], joaat("weapon_smg"), -1, false, false);
			unk_0x56F2E1B5599188FA(uParam0->f_1C[0], unk_0xBC25C936A095B5BA(), -1, 0, 2);
			unk_0xAE1FF40E420DDE25(uParam0->f_1C[0], 2);
			unk_0xA3A7138EAD2268A0(uParam0->f_1C[0], "WORLD_HUMAN_GUARD_STAND", 0, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[0], 0, 1, 1, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[0], 3, 0, 1, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[0], 4, 0, 1, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[0], 8, 1, 0, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[0], 11, 1, 0, 0);
			func_428(&(uParam0->f_1C[1]), iVar0[2], -666.5512f, 49.19759f, 42.07154f, -171.6803f, 26);
			unk_0x7A535CE1F001F3FE(uParam0->f_1C[1], joaat("weapon_smg"), -1, false, false);
			unk_0x56F2E1B5599188FA(uParam0->f_1C[1], unk_0xBC25C936A095B5BA(), -1, 0, 2);
			unk_0xAE1FF40E420DDE25(uParam0->f_1C[1], 2);
			unk_0xA3A7138EAD2268A0(uParam0->f_1C[1], "WORLD_HUMAN_GUARD_STAND", 0, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 0, 0, 0, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[1], 3, 0, 1, 0);
			...
			func_428(&(uParam0->f_1C[2]), iVar0[2], -690f, 42f, 42f, 0f, 26);
			func_428(&(uParam0->f_1C[3]), iVar0[2], -690f, 42f, 43f, 0f, 26);
			unk_0xBD53A029D0155A42(uParam0->f_1C[2], uParam0->f_23[0], -1);
			unk_0xBD53A029D0155A42(uParam0->f_1C[3], uParam0->f_23[0], 0);
			unk_0x7A535CE1F001F3FE(uParam0->f_1C[2], joaat("weapon_combatpistol"), -1, false, false);
			unk_0x7A535CE1F001F3FE(uParam0->f_1C[3], joaat("weapon_microsmg"), -1, false, false);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[2], 0, 0, 1, 0);
			...
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[2], 11, 0, 0, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 0, 1, 0, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 3, 0, 2, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 4, 0, 2, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 8, 1, 0, 0);
			unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[3], 11, 0, 1, 0);
			unk_0xB2CB6EAA6B280A84("gang", &iLocal_54);
			unk_0x4106FAF8AA1D69D5(uParam0->f_1C[0], iLocal_54);
			unk_0x4106FAF8AA1D69D5(uParam0->f_1C[1], iLocal_54);
			unk_0x4106FAF8AA1D69D5(uParam0->f_1C[2], iLocal_54);
			unk_0x4106FAF8AA1D69D5(uParam0->f_1C[3], iLocal_54);
			unk_0xEA2C4A582CD26EF5(uParam0->f_1C[0], 0);
			unk_0xEA2C4A582CD26EF5(uParam0->f_1C[1], 0);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
void func_428(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x3366C
{
	func_429(iParam0);
	*iParam0 = unk_0x01B3635C3E8EDD81(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_429(int iParam0)//Position - 0x3368D
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_430(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x336CE
{
	func_431(iParam0);
...
void func_431(int iParam0)//Position - 0x33710
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x5CAE759AE8219D20(*iParam0))
...
int func_432(int iParam0)//Position - 0x337AC
{
	int iVar0;
...
int func_433(var uParam0)//Position - 0x337DD
{
	uParam0->f_10 = 5;
...
int func_434(var uParam0)//Position - 0x33833
{
	int iVar0[2];
	int iVar1;
	int iVar2;
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_432(&iVar0) || !unk_0xF9E082857622D91E(sVar3))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				...
				else
				{
					...
					func_430(&(uParam0->f_23[0]), iVar0[0], -2892.93f, 3192.37f, 11.66f, -132.35f);
				}
			}
			func_396(37, 0);
			if (unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				unk_0x8510BC031C24B862(iVar0[0], true);
				...
				if (Global_11637)
				{
					if (!unk_0x1D403DFADBC2DE3C(unk_0xBC25C936A095B5BA(), 0))
					{
						unk_0x641B19E156645A92(unk_0xBC25C936A095B5BA(), -2907.29f, 3215.91f, 9.86f, 1, false, 0, 1);
			...
			func_428(&(uParam0->f_1C[0]), iVar0[1], -2881.755f, 3188.125f, 10.1136f, 254.1723f, 26);
			if (func_381(uParam0->f_1C[0]) && func_123(unk_0xBC25C936A095B5BA()))
			{
				...
				unk_0x2E35C4FA5F0ED22F(uParam0->f_1C[0], false);
			}
			else
			{
				bVar4 = false;
...
int func_435(var uParam0)//Position - 0x33B71
{
	int iVar0[1];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_440(&(uParam0->f_30), "rcm_epsilonism5", "ep_5_rcm_marnie_strokes_wall", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_432(&iVar0) || !func_439(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (func_436(&(uParam0->f_1C[0]), 60, 636.58f, 119.68f, 90.56f, 80.62f, "EPSILON LAUNCHER RC", 1) && func_123(unk_0xBC25C936A095B5BA()))
				{
					iVar3 = unk_0x84788C4CA5E15BDC(unk_0xBC25C936A095B5BA());
					unk_0x4106FAF8AA1D69D5(uParam0->f_1C[0], iVar3);
					unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[0], 132, true);
				}
				else
				{
...
int func_436(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0x33CF4
{
...
int func_437(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0x33D50
{
	int iVar0;
...
int func_438(var uParam0, int iParam1)//Position - 0x33DDE
{
	int iVar0;
...
int func_439(var uParam0)//Position - 0x33E24
{
	if (func_405(uParam0))
	{
...
void func_440(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0x33E4E
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_441(var uParam0)//Position - 0x33E8A
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_440(&(uParam0->f_30), "rcm_epsilonism4", "ep_4_rcm_marnie_base_marnie", "ep_4_rcm_marnie_lookaround_marnie");
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_436(&(uParam0->f_1C[0]), 60, 1826.13f, 4698.88f, 38.92f, 21.63f, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
					unk_0x4106FAF8AA1D69D5(uParam0->f_1C[0], iVar3);
					unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[0], 132, true);
				}
			...
			{
				if (func_436(&(uParam0->f_1C[1]), 55, 1827.24f, 4699.76f, 39.09f, 57.09f, "EPSILON LAUNCHER RC - JIMMY", 1))
				{
					unk_0x4106FAF8AA1D69D5(uParam0->f_1C[1], iVar3);
					unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[1], 132, true);
					unk_0x70FF586D857F1A81(uParam0->f_1C[1], 1, 0, 0, false);
					unk_0xA4E856A8CD53B8DF(uParam0->f_1C[1]);
					unk_0x7A535CE1F001F3FE(uParam0->f_1C[1], joaat("weapon_digiscanner"), -1, true, true);
					unk_0xE896C0AD02364F2A(uParam0->f_1C[1], "rcm_epsilonism4", "ep_4_rcm_jimmyboston_base_jb", 8f, -8f, -1, 1, 0, 0, 0, 0);
					func_442(uParam0->f_1C[1], 1827.24f, 4699.76f, 39.09f, 57.09f, 1, 1);
				}
				else
				{
					bVar2 = false;
...
int func_442(int iParam0, vector3 vParam1, float fParam2, bool bParam3, int iParam4)//Position - 0x340B1
{
	bool bVar0;
	float fVar1;
...
int func_443(var uParam0)//Position - 0x3410D
{
	int iVar0[1];
	int iVar1;
	vector3 vVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_440(&(uParam0->f_30), "rcmepsilonism3", "base_loop", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			bVar4 = true;
			unk_0xA0C0B32E74BE8DB7(vVar2, 35f, 0);
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_436(&(uParam0->f_1C[0]), 60, vVar2, fVar3, "EPSILON LAUNCHER RC - MARNIE", 1))
				{
					if (unk_0x724D816EA203A79E(uParam0->f_1C[0]) && func_123(unk_0xBC25C936A095B5BA()))
					{
						iVar5 = unk_0x84788C4CA5E15BDC(unk_0xBC25C936A095B5BA());
						unk_0x12D2D85EBAC186AA(uParam0->f_1C[0], 0);
						unk_0x4106FAF8AA1D69D5(uParam0->f_1C[0], iVar5);
						unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[0], 132, true);
						unk_0xE896C0AD02364F2A(uParam0->f_1C[0], "rcmepsilonism3", "ep_3_rcm_marnie_meditating", 1000f, -8f, -1, 786433, 0, 0, 0, 0);
					}
					else
					{
						bVar4 = false;
...
float func_444(float fParam0)//Position - 0x342D4
{
	return (fParam0 * 57.29578f);
}

int func_445(var uParam0)//Position - 0x342E4
{
	switch (iLocal_51)
	{
		case 0:
		...
		case 1:
			if (!unk_0x70CF24CEFB0F53B0(241.3607f, 361.0345f, 105.8884f, 4f, -1230442770, 0))
			{
				return 0;
			}
			iLocal_51 = 3;
...
void func_446(int iParam0, bool bParam1)//Position - 0x343A9
{
	char* sVar0;
	int iVar1;
...
int func_447(int iParam0)//Position - 0x3444F
{
	struct<2> Var0;
...
struct<2> func_448(var uParam0)//Position - 0x34483
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_449(int iParam0, bool bParam1)//Position - 0x344D5
{
	struct<2> Var0;
...
var func_450(int iParam0, int iParam1)//Position - 0x34518
{
	struct<5> Var0;
...
struct<5> func_451(int iParam0)//Position - 0x3453D
{
	struct<5> Var0;
	vector3 vVar1;
...
struct<6> func_452(int iParam0, bool bParam1)//Position - 0x36830
{
	struct<6> Var0;
...
void func_453(int iParam0, int iParam1)//Position - 0x373E6
{
...
int func_454(var uParam0)//Position - 0x3742B
{
	int iVar0[1];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_430(&(uParam0->f_23[0]), iVar0[0], -1619.53f, 4204.1f, 83.3f, 77.92f);
				if (unk_0x724D816EA203A79E(uParam0->f_23[0]))
				{
					unk_0xD421BC740C5340C3(uParam0->f_23[0], 2);
					unk_0x914C5DE0B15B8B59(uParam0->f_23[0], 27, 27);
					unk_0x8510BC031C24B862(iVar0[0], true);
...
int func_455(int iParam0)//Position - 0x37591
{
	struct<27> Var0;
	int iVar1;
...
int func_456(int iParam0)//Position - 0x375E5
{
	char* sVar0;
...
int func_457(int iParam0)//Position - 0x376A3
{
	var uVar0;
...
int func_458(int iParam0)//Position - 0x37764
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_459(int iParam0, char* sParam1)//Position - 0x377E9
{
...
bool func_460(int iParam0)//Position - 0x378D6
{
...
bool func_461(int iParam0)//Position - 0x37904
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_462(int iParam0)//Position - 0x37932
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_463(int iParam0)//Position - 0x37960
{
	if (func_415(iParam0))
	{
		return 0;
...
void func_464()//Position - 0x37995
{
	func_484("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_465(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x379B0
{
	int iVar0;
...
int func_466(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0x37A16
{
	int iVar0;
	struct<7> Var1;
...
int func_467(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x37A94
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_468(int iParam0, bool bParam1)//Position - 0x37B0F
{
	char* sVar0;
	...
	if (unk_0x2DA8CA50A72528FB(iLocal_226))
	{
		unk_0x07B8ECB35A4ED3AC(&iLocal_226);
	}
	if (iLocal_56 != -1)
	{
	...
	{
		unk_0x483687B0FCA5415A(iLocal_55, 0);
	}
	func_472(&(iParam0->f_30));
	switch (*iParam0)
	{
		case 9:
...
void func_469(char* sParam0)//Position - 0x37C1E
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
		if (func_355(sParam0))
...
void func_470()//Position - 0x37C3D
{
	Global_394A = 0;
	func_471();
}

void func_471()//Position - 0x37C4D
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
int func_472(var uParam0)//Position - 0x37C6E
{
	if (func_405(uParam0))
	{
		if (unk_0xF9E082857622D91E(*uParam0))
...
void func_473(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x37CA4
{
...
void func_474(var uParam0, bool bParam1)//Position - 0x37CC4
{
	func_475(&(uParam0->f_29), bParam1);
}

void func_475(var uParam0, bool bParam1)//Position - 0x37CD6
{
	int iVar0;
...
void func_476(int iParam0, bool bParam1)//Position - 0x37D14
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_477(var uParam0, bool bParam1)//Position - 0x37D4F
{
	func_478(&(uParam0->f_23), bParam1);
}

void func_478(var uParam0, bool bParam1)//Position - 0x37D61
{
	int iVar0;
...
void func_479(int iParam0)//Position - 0x37D9E
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_480(var uParam0, int iParam1)//Position - 0x37DD6
{
	func_481(&(uParam0->f_1C), iParam1);
}

void func_481(var uParam0, int iParam1)//Position - 0x37DE8
{
	int iVar0;
...
void func_482(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x37E29
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_483(var uParam0)//Position - 0x37E79
{
	if (*uParam0 == -1)
	{
		return;
...
void func_484(char* sParam0)//Position - 0x37EB6
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_485(var uParam0)//Position - 0x37EC8
{
	*uParam0 = -1;
...
void func_486()//Position - 0x37EFB
{
	func_484("Running start routines.");
	Global_199EA++;
}

int func_487(int iParam0)//Position - 0x37F16
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
