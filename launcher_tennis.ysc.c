...
void __EntryFunction__()//Position - 0x0
{
	...
	iLocal_62 = unk_0xA95CF30C72EB526E(unk_0xB5CEFD608600A09F());
	iLocal_68 = 0;
	func_185(&Global_195BF, 0);
	func_180();
	...
	if (unk_0xB731B8C5BCE89836(unk_0x2C087518F90303D5()) > 1 && !func_179(uLocal_67, 4194304))
	{
		if (iLocal_78 != 263)
		{
	...
	while (true)
	{
		...
		if (unk_0x724D816EA203A79E(iLocal_62) && !unk_0x1D403DFADBC2DE3C(iLocal_62, 0))
		{
			vLocal_64 = { unk_0x541C2AEF053615BC(iLocal_62, true) };
			...
			switch (iLocal_68)
			{
				...
				case 3:
					...
					if (!func_177(iLocal_73))
					{
						...
						{
							bVar1 = true;
							if (unk_0x3362CDE8460ED38B(&(Global_16B1B.f_3), &cLocal_53))
							{
								cLocal_53 = { Local_52 };
								bVar1 = false;
							}
					...
					if (fLocal_83 > (fLocal_75 * fLocal_75) && !Global_16B3D)
					{
						if (iLocal_78 != 263)
						{
					...
					else
					{
						...
						if (!func_164(3) && !Global_16B3D)
						{
							if (func_179(uLocal_67, 2097152))
							{
								if ((!func_179(uLocal_67, 1) || !unk_0x724D816EA203A79E(func_163())) && !Global_16B3D)
								{
									func_172(10);
									break;
								}
						...
						if ((!func_152(6) || Global_1974B) || func_151())
						{
							bVar2 = false;
						}
						if (!bLocal_91)
						...
						if (bVar2)
						{
							if (!unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), vLocal_86, vLocal_87, fLocal_88, 1, false, iLocal_76) || (fLocal_90 > 0f && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), func_138(vLocal_86, vLocal_87, 0.5f), false) > fLocal_90))
							{
								bVar2 = false;
							}
							else if (fLocal_89 > 0f)
							{
								if (unk_0x357058E632979E65((vLocal_64.z - vLocal_86.z)) > fLocal_89)
								{
									bVar2 = false;
								}
							}
							...
							if (bVar2)
							{
								...
								if (func_137(uLocal_63))
								{
									...
									else if (!func_179(uLocal_67, 2048) || !unk_0xF16DAFF595E80F7C())
									{
										func_135(&iLocal_69);
									...
									if (func_133(iLocal_69, 1))
									{
										...
										func_135(&iLocal_69);
										func_185(&uLocal_67, 2048);
										unk_0x63831D2D5110C305(&cLocal_53);
				...
				case 5:
					unk_0xD55638CE45B2B948(0, 51);
					if (unk_0xACE95AD318CE412B(&cLocal_53))
					{
						if (iLocal_69 != -1)
						{
							func_135(&iLocal_69);
						...
						if (iVar3 == 1)
						{
							...
							unk_0x91DEC7187FA01089(&cLocal_53);
							Local_52 = { cLocal_53 };
				...
				case 6:
					if (func_179(Global_195BF, 262144))
					{
						func_185(&Global_195BF, 262144);
						func_15();
					}
					if (func_179(uLocal_67, 2097152))
					{
						if (!func_164(3) && !unk_0x3C406FC829C1E14A(iLocal_51))
						{
							func_172(10);
						}
					}
					if (!unk_0x3C406FC829C1E14A(iLocal_51))
					{
						unk_0x739C5CCC39AE3137(SYSTEM::ROUND((func_11(&iLocal_80) * 1000f)), iLocal_72, 0);
						func_10(&iLocal_80);
						...
						if (iLocal_72 != -1)
						{
							if (func_179(Global_195BF, 0))
							{
								unk_0x1B7435D54924A668(func_19(iLocal_72), 0, Global_16B40, 0);
								func_7(func_19(iLocal_72), 0, Global_16B40, 1, 0);
							}
							else
							{
								unk_0x1B7435D54924A668(func_19(iLocal_72), 0, Global_16B40, 0);
								func_7(func_19(iLocal_72), 0, Global_16B40, 0, 0);
							}
						}
						func_6();
						func_185(&Global_195BF, 0);
				...
				case 7:
					...
					if (!unk_0xF1734B55490E9045(sLocal_74))
					{
						if (func_1(sLocal_74))
						{
...
void func_44(int iParam0, int iParam1, var uParam2)//Position - 0x151C
{
	...
	while (iVar0 <= 11)
	{
		...
		{
			unk_0xC5B089214CCF7A47(iParam0, iVar0, Var1.f_3, Var1.f_4);
		}
		iVar0++;
	}
	...
	while (iVar2 <= 8)
	{
		...
		if (uVar6[iVar2] != iVar5)
		{
			...
			{
				unk_0x0B92A57A4B252F15(iParam0, iVar4, Var1.f_3, Var1.f_4);
			}
		}
		iVar2++;
	}
...
int func_45(int iParam0)//Position - 0x15F6
{
	switch (iParam0)
	{
		case 0:
...
int func_46(int iParam0)//Position - 0x167C
{
	switch (iParam0)
	{
		case -1:
...
struct<10> func_47(int iParam0, int iParam1)//Position - 0x1750
{
	int iVar0;
	struct<10> Var1;
...
void func_48(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x207F
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
int func_49(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x21A9
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x84E17E2A0638D182(iParam3, 6, -1, 0, -1, func_51(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
int func_50(int iParam0, int iParam1)//Position - 0x2289
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_52(int iParam0)//Position - 0x26E0
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_53(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0x2741
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<14> func_54(int iParam0, int iParam1, int iParam2)//Position - 0x2789
{
	func_121();
...
void func_55(int iParam0, int iParam1)//Position - 0x27DB
{
	switch (iParam0)
	{
		case 0:
...
void func_56(int iParam0)//Position - 0x28CB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_57(&(Global_11489[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_57(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0x3AFF
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	if (bParam10)
	{
		...
		if (iParam1 == 12)
		{
			if (!func_65(Global_280004, 1, 1, 1, -1))
			{
				unk_0x7CB6FD92BE491AD9(&(uParam0->f_6), 2);
			}
			if (!func_65(Global_280004, 2, 1, 1, -1))
			{
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_60(func_63(iParam1, uParam0->f_2), Global_11486, 0);
			if (unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
			{
				unk_0xF0059F27F7BB6680(&(uParam0->f_6), 1);
			}
			iVar0 = func_60(func_59(iParam1, uParam0->f_2), Global_11486, 0);
			if (unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
			{
				unk_0xF0059F27F7BB6680(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_60(iVar1, Global_11486, 0);
				if (!unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
				{
					unk_0xF0059F27F7BB6680(&(uParam0->f_6), 4);
				}
...
bool func_58(int iParam0, int iParam1, var uParam2)//Position - 0x3E8F
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_59(int iParam0, int iParam1)//Position - 0x4295
{
	switch (iParam1)
	{
		case 0:
...
int func_60(int iParam0, int iParam1, int iParam2)//Position - 0x4690
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_269BC5[iParam0 /*3*/][func_61(iParam1)];
...
int func_61(var uParam0)//Position - 0x46C2
{
	int iVar0;
	int iVar1;
...
var func_62()//Position - 0x46F6
{
	return Global_1407E0;
}

int func_63(int iParam0, int iParam1)//Position - 0x4702
{
	switch (iParam1)
	{
		case 0:
...
int func_64(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x4AFD
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_65(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x5A1B
{
	int iVar0;
	int iVar1;
	int iVar2;
...
bool func_66(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x5A5D
{
	int iVar0;
...
void func_67(int iParam0, int iParam1, int iParam2)//Position - 0x7354
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar3 < iVar5)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_57(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_57(&(Global_11489[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_57(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xF062C4E30590463E(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = unk_0x84E17E2A0638D182(iVar1, 6, -1, 0, -1, func_51(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var11;
					func_57(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xF062C4E30590463E(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
void func_68(int iParam0)//Position - 0x75CE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_69(int iParam0)//Position - 0x771A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_70(int iParam0)//Position - 0x7C26
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_71(int iParam0)//Position - 0x7C99
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_72(int iParam0)//Position - 0x7D0B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_73(int iParam0)//Position - 0x7DF1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_74(int iParam0)//Position - 0x8133
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_75(int iParam0)//Position - 0x833A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_76(int iParam0)//Position - 0x8559
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_77(int iParam0)//Position - 0x8661
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_78(int iParam0)//Position - 0x8FF2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_79(int iParam0)//Position - 0x9B49
{
	if (iParam0 < 136)
	{
		func_81(iParam0);
...
void func_80(int iParam0)//Position - 0x9B7D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_81(int iParam0)//Position - 0xA781
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_82(int iParam0)//Position - 0xB681
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_83(int iParam0)//Position - 0xB7AD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_84(int iParam0, int iParam1)//Position - 0xB8A3
{
	switch (iParam0)
	{
		case 0:
...
void func_85(int iParam0)//Position - 0xB993
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_86(int iParam0)//Position - 0xCE60
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_87(int iParam0)//Position - 0xCFA6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_88(int iParam0)//Position - 0xD4AF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_89(int iParam0)//Position - 0xDB17
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_90(int iParam0)//Position - 0xDB89
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_91(int iParam0)//Position - 0xDC58
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_92(int iParam0)//Position - 0xE152
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_93(int iParam0)//Position - 0xE2E2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_94(int iParam0)//Position - 0xEAD0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_95(int iParam0)//Position - 0xEBD8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_96(int iParam0)//Position - 0xFAFA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_97(int iParam0)//Position - 0x107A7
{
	if (iParam0 < 107)
	{
		func_100(iParam0);
...
void func_98(int iParam0)//Position - 0x107EC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_99(int iParam0)//Position - 0x11290
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_100(int iParam0)//Position - 0x1207E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_101(int iParam0)//Position - 0x12CBD
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_102(int iParam0)//Position - 0x12F34
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_103(int iParam0, int iParam1)//Position - 0x1306F
{
	switch (iParam0)
	{
		case 0:
...
void func_104(int iParam0)//Position - 0x1315F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_105(int iParam0)//Position - 0x13EBC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_106(int iParam0)//Position - 0x1402B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_107(int iParam0)//Position - 0x1459B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_108(int iParam0)//Position - 0x14AC2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_109(int iParam0)//Position - 0x14B34
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_110(int iParam0)//Position - 0x14C03
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_111(int iParam0)//Position - 0x150B2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_112(int iParam0)//Position - 0x1530C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_113(int iParam0)//Position - 0x155CB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_114(int iParam0)//Position - 0x15785
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_115(int iParam0)//Position - 0x162CA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_116(int iParam0)//Position - 0x16EFB
{
	if (iParam0 < 60)
	{
		func_118(iParam0);
...
void func_117(int iParam0)//Position - 0x16F2F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_118(int iParam0)//Position - 0x17CC2
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_119(int iParam0)//Position - 0x18344
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_120(int iParam0)//Position - 0x18429
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_121()//Position - 0x1851F
{
...
int func_122(int iParam0)//Position - 0x18597
{
	switch (iParam0)
	{
		case 0:
...
struct<17> func_123(int iParam0, int iParam1)//Position - 0x18647
{
	int iVar0;
	struct<17> Var1;
...
void func_124(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1A48F
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
void func_125(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x1A679
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
void func_126(int iParam0)//Position - 0x1A6EA
{
	Global_19772 = (Global_19772 || iParam0);
}

bool func_127(int iParam0)//Position - 0x1A6FD
{
	return (Global_19772 && iParam0) != 0;
}

void func_128(int iParam0)//Position - 0x1A70E
{
	if (iLocal_68 < 5)
	{
		if (iParam0 != 263)
...
int func_130(int iParam0)//Position - 0x1A771
{
	int iVar0;
	int iVar1;
...
int func_131(int iParam0)//Position - 0x1A7AE
{
	if (func_132(iParam0))
	{
...
bool func_132(int iParam0)//Position - 0x1A7D8
{
	return iParam0 < 3;
}

int func_133(int iParam0, bool bParam1)//Position - 0x1A7E4
{
	int iVar0;
...
int func_134(int iParam0)//Position - 0x1A89C
{
	int iVar0;
...
void func_135(int iParam0)//Position - 0x1A8D7
{
	int iVar0;
...
void func_136(int iParam0, int iParam1, char* sParam2, int iParam3, char* sParam4, int iParam5, int iParam6)//Position - 0x1A92E
{
	int iVar0;
...
int func_137(var uParam0)//Position - 0x1AA59
{
	return 1;
}

Vector3 func_138(vector3 vParam0, vector3 vParam1, float fParam2)//Position - 0x1AA62
{
	return FtoV((1f - fParam2)) * vParam0 + Vector(fParam2, fParam2, fParam2) * vParam1;
}

var func_139()//Position - 0x1AA7D
{
	return Global_10AB8;
}

int func_140(int iParam0)//Position - 0x1AA89
{
	if (iParam0 == 1)
	{
...
bool func_141(int iParam0, int iParam1)//Position - 0x1AAE3
{
	switch (iParam0)
	{
		case 5:
...
bool func_142()//Position - 0x1AB1E
{
	return unk_0x105601648511CC64() <= Global_43C1.f_1671 + 100;
}

int func_143()//Position - 0x1AB33
{
...
bool func_144(bool bParam0)//Position - 0x1AB4D
{
	if (bParam0)
	{
...
int func_145()//Position - 0x1AB76
{
	if (func_166(6) || func_166(7))
	{
		if (!unk_0x1D403DFADBC2DE3C(unk_0xBC25C936A095B5BA(), 0))
		{
			switch (func_146(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true)))
			{
				case 1:
					return func_165(96);
					break;
...
int func_146(vector3 vParam0)//Position - 0x1AC45
{
	float fVar0;
	float fVar1;
	int iVar2;
...
Vector3 func_147(int iParam0)//Position - 0x1AC89
{
	int iVar0;
...
Vector3 func_148(int iParam0, int iParam1)//Position - 0x1AD67
{
	int iVar0;
...
void func_149(var uParam0, int iParam1)//Position - 0x1ADA5
{
	func_150(uParam0, iParam1);
}

void func_150(var uParam0, var uParam1)//Position - 0x1ADB5
{
	*uParam0 = (*uParam0 || uParam1);
}

bool func_151()//Position - 0x1ADC6
{
	int iVar0;
	bool bVar1;
...
int func_152(int iParam0)//Position - 0x1AED0
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_159()) || Global_1974B) || Global_62BF) || func_158()) || func_141(8, -1)) || func_157()) || func_156()) || func_155()) || func_143()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_159()) || Global_62BF) || func_158()) || func_141(8, -1)) || func_155()) || func_157()) || func_156()) || func_143()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_159()) || Global_1974B) || Global_62BF) || func_158()) || func_141(8, -1)) || func_157()) || func_156()) || func_143()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_159() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_141(8, -1)) || func_143()) || func_154()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_159()) || Global_62BF) || func_158()) || func_141(8, -1)) || func_156()) || func_155()) || func_143()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
					...
					case 7:
						if ((((((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || !unk_0x8CC5A4A5615C6420(unk_0xB5CEFD608600A09F())) || !unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F())) || !unk_0x726D9204B160D23E()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || func_159()) || func_156()) || Global_1974B) || Global_62BF) || func_158()) || Global_90C1) || func_141(8, -1)) || func_155()) || func_154()) || func_143()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
...
var func_153()//Position - 0x1B5ED
{
	return Global_16B42.f_1;
}

int func_154()//Position - 0x1B5FB
{
	if (Global_15FA6 != -1)
	{
...
bool func_156()//Position - 0x1B64B
{
	return Global_16B4F.f_142 > 0;
}

bool func_157()//Position - 0x1B65C
{
	return Global_16B4F.f_141 > 0;
}

var func_158()//Position - 0x1B66D
{
	return Global_140856;
}

int func_159()//Position - 0x1B679
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
var func_160()//Position - 0x1B695
{
	func_161();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_161()//Position - 0x1B6AE
{
	int iVar0;
	
	if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
	{
		if (func_131(Global_19B04.f_932.f_21B.f_10CD) != unk_0x6F79ECA8C83E4357(unk_0xBC25C936A095B5BA()))
		{
			iVar0 = func_130(unk_0xBC25C936A095B5BA());
			if (func_132(iVar0) && (!func_166(14) || Global_196EB))
			{
				if (Global_19B04.f_932.f_21B.f_10CD != iVar0 && func_132(Global_19B04.f_932.f_21B.f_10CD))
				{
...
var func_163()//Position - 0x1B7C5
{
	return Global_15B64;
}

int func_164(int iParam0)//Position - 0x1B7D1
{
	switch (iParam0)
	{
		case 0:
...
bool func_165(int iParam0)//Position - 0x1B843
{
	int iVar0;
...
bool func_166(int iParam0)//Position - 0x1B87F
{
	return Global_8C41 == iParam0;
}

void func_167(var uParam0, int iParam1)//Position - 0x1B88D
{
	*uParam0 = (*uParam0 || iParam1);
}

void func_168()//Position - 0x1B89E
{
	var uVar0;
	int iVar1;
	int iVar2[3];
	...
	if (bLocal_93 && unk_0xB731B8C5BCE89836(joaat("tennis_ambient")) == 0)
	{
		if (iLocal_92 == 1)
		{
			iVar1 = unk_0x491B2241281A03B7(1, 4);
			iVar2[0] = unk_0x491B2241281A03B7(2, 8);
			iVar3 = 1;
...
int func_169(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x1B944
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_171()//Position - 0x1B9D6
{
	if (bLocal_93)
	{
		if (iLocal_92 == 1)
...
void func_172(int iParam0)//Position - 0x1B9F1
{
	iLocal_68 = iParam0;
}

void func_173(int iParam0, bool bParam1, bool bParam2)//Position - 0x1B9FD
{
	int iVar0;
	bool bVar1;
...
bool func_176(int iParam0, int iParam1)//Position - 0x1BB49
{
	bool bVar0;
...
bool func_177(int iParam0)//Position - 0x1BB96
{
	return func_178(iParam0, Global_8C41);
}

int func_178(int iParam0, int iParam1)//Position - 0x1BBA7
{
	if (iParam1 == 15)
	{
		return 1;
...
bool func_179(var uParam0, int iParam1)//Position - 0x1BD88
{
	return (uParam0 && iParam1) != 0;
}

void func_180()//Position - 0x1BD97
{
	int iVar0;
	int iVar1;
...
int func_182(int iParam0)//Position - 0x1C1E7
{
	if (func_132(iParam0))
	{
		if ((Global_19B04.f_2360 || Global_3) || func_18(0))
		{
...
int func_183(vector3 vParam0)//Position - 0x1C235
{
	return func_184(func_146(vParam0));
}

int func_184(var uParam0)//Position - 0x1C249
{
	int iVar0;
...
void func_185(var uParam0, int iParam1)//Position - 0x1C2C1
{
	func_186(uParam0, iParam1);
}

void func_186(var uParam0, var uParam1)//Position - 0x1C2D1
{
	*uParam0 = (*uParam0 - (*uParam0 && uParam1));
}

void func_187(bool bParam0)//Position - 0x1C2E6
{
	if (bParam0)
	{
		if (iLocal_78 != 263)
...
void func_188()//Position - 0x1C32F
{
	func_185(&uLocal_67, 4);
	func_189();
	if (unk_0x3C406FC829C1E14A(iLocal_51))
	{
		unk_0x17631956147B5347(iLocal_51, 3);
	}
	if (!unk_0xEAEFBBEC1AEA464B(&cLocal_53))
	{
		if (unk_0x5D29F91E567588E2(&cLocal_53) != 0)
		{
			unk_0x91DEC7187FA01089(&cLocal_53);
		}
	}
...
void func_189()//Position - 0x1C36C
{
	func_4(128);
	if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
	{
