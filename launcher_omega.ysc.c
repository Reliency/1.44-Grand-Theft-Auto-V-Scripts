	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_278(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_262(&Var0, 1);
	}
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x614D
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6194
{
...
bool func_70(int iParam0)//Position - 0x61EF
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x61FF
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x625F
{
	switch (iParam0)
	{
		case 0:
...
int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x656E
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6610
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6BCA
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6C28
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6CD6
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6D6B
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6DAF
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6F33
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6F41
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7A08
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7A8A
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7AE8
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7AF1
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7CC4
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7CD4
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7F6E
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x7F7F
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7FC5
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x804E
{
...
void func_94(var uParam0, int iParam1)//Position - 0x8081
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x80D2
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x8174
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8199
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x81B0
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x81BD
{
...
void func_100(var uParam0, int iParam1)//Position - 0x81F7
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8232
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x826E
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x8287
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x82E0
{
...
bool func_105(bool bParam0)//Position - 0x8322
{
...
struct<2> func_106(int iParam0)//Position - 0x834D
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x879A
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9A72
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9DB8
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9E5C
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9EF7
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9F55
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9FAE
{
...
int func_116(int iParam0)//Position - 0xA031
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA062
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA077
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA12A
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA145
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA191
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA1DA
{
	if (func_124(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA1FA
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA21B
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA2EB
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA33E
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA433
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA49E
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA4DB
{
	if (bParam0)
	{
...
int func_134(int iParam0, bool bParam1)//Position - 0xA66C
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA6AD
{
...
bool func_136()//Position - 0xA6EF
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA700
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA75A
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA77D
{
...
void func_141()//Position - 0xA7BA
{
	Global_394A = 0;
	func_142();
}

void func_142()//Position - 0xA7CA
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA8B0
{
...
void func_147(int iParam0)//Position - 0xAA3F
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAABC
{
...
void func_150(int iParam0)//Position - 0xAAE5
{
	if (Global_3943)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAB55
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xABC9
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAC23
{
...
int func_154(int iParam0)//Position - 0xAC64
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xACA9
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xACDB
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAE12
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAE61
{
	return func_159(iParam0, Global_8C41);
}

int func_159(int iParam0, int iParam1)//Position - 0xAE72
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xB053
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_161()//Position - 0xB075
{
	return func_162(unk_0x1377080E9B0BD993(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB086
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(int iParam0, int iParam1)//Position - 0xB0F3
{
	switch (iParam0->f_10)
	{
		case 0:
...
void func_165()//Position - 0xB8D6
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB8F1
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB97F
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xB9E3
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xBA7A
{
	if (func_124(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_170(int iParam0)//Position - 0xBAA4
{
	int iVar0;
...
var func_171()//Position - 0xC1C2
{
	return Global_16B42.f_1;
}

int func_172()//Position - 0xC1D0
{
	if (Global_15FA6 != -1)
	{
...
bool func_175()//Position - 0xC23A
{
	return Global_16B4F.f_142 > 0;
}

bool func_176(int iParam0, int iParam1)//Position - 0xC24B
{
	switch (iParam0)
	{
		case 5:
...
var func_177()//Position - 0xC286
{
	return Global_140856;
}

int func_178()//Position - 0xC292
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
void func_179(int iParam0)//Position - 0xC2AE
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	...
	if ((unk_0x105601648511CC64() - iLocal_58) > 1250)
	{
		if (func_124(iParam0->f_1C[0]) && !unk_0xD1DC4B08247A4317(iParam0->f_1C[0]))
		{
			if (func_124(unk_0xBC25C936A095B5BA()) && !func_180(unk_0xBC25C936A095B5BA(), iParam0->f_1C[0], 50f, 1))
			{
				vVar0 = { unk_0x541C2AEF053615BC(iParam0->f_1C[0], true) };
				vVar1 = { unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true) };
				fVar3 = (vVar1.x - vVar0.x);
				fVar4 = (vVar1.y - vVar0.y);
				if (fVar4 != 0f)
				{
					fVar2 = unk_0xE8CFCB6B2165523B(fVar3, fVar4);
				}
				else if (fVar3 < 0f)
				{
					fVar2 = -90f;
				...
				unk_0x019CE76D5286C95C(iParam0->f_1C[0], fVar2);
			}
		}
...
void func_181()//Position - 0xC3B9
{
	...
	unk_0x29CD142125FE177B(iLocal_56, "SET_COLOUR");
	...
	unk_0x29CD142125FE177B(iLocal_56, "SET_DISTANCE");
	...
	unk_0x65E432C782E7E702(iLocal_56, fVar0, fVar1, fVar2, fVar3, 100, 100, 100, 255, 0);
	if ((unk_0x105601648511CC64() - iLocal_58) > 1250)
	{
		unk_0x10B5C0C7337B8420(iLocal_59, "IDLE_BEEP", 2468.51f, 3437.39f, 49.9f, "EPSILONISM_04_SOUNDSET", 0, 0, 0);
		iLocal_58 = unk_0x105601648511CC64();
	}
}

int func_182(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, var uParam6)//Position - 0xC4AB
{
	var uVar0;
	...
	if (!*uParam6 == 3)
	{
		if (func_170(2))
		{
			if (!func_143())
			{
				if ((func_124(unk_0xBC25C936A095B5BA()) && func_124(iParam0->f_1C[0])) && func_189(unk_0xBC25C936A095B5BA(), vParam1, 1) < 20f)
				{
			...
			if (func_189(unk_0xBC25C936A095B5BA(), vParam1, 1) < 20f && *uParam6 == 1)
			{
...
void func_183(int iParam0)//Position - 0xC5CD
{
	Global_41AB = iParam0;
}

int func_184(char* sParam0)//Position - 0xC5DA
{
	struct<6> Var0;
...
struct<6> func_185()//Position - 0xC5FA
{
	struct<6> Var0;
...
void func_186(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC61E
{
...
void func_187(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC659
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_188(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC6AF
{
...
float func_189(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC74A
{
	vector3 vVar0;
...
void func_190(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC784
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
...
void func_191(int iParam0, bool bParam1)//Position - 0xC875
{
	if (iParam0 == -1)
	{
		return;
...
int func_192(int iParam0)//Position - 0xC8B1
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_193(int iParam0, int iParam1)//Position - 0xC8EA
{
	bool bVar0;
	int iVar1;
...
bool func_194()//Position - 0xC988
{
	return Global_16129;
}

void func_195(int iParam0)//Position - 0xC994
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_196(iParam0);
...
void func_196(int iParam0)//Position - 0xC9AB
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_197(int iParam0)//Position - 0xCA93
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_198(int iParam0, bool bParam1)//Position - 0xCABB
{
	struct<27> Var0;
	...
	func_107(*iParam0, &Var0);
	if ((func_235(*iParam0) || func_233(*iParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
	...
	if (func_202(&(iParam0->f_30)) && bParam1)
	{
		func_199(iParam0->f_1C[0], &(iParam0->f_30), *iParam0);
	}
	return 1;
}

void func_199(int iParam0, var uParam1, int iParam2)//Position - 0xCD2E
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_201(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_201(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_200(int iParam0)//Position - 0xD086
{
...
int func_201(var uParam0)//Position - 0xD0A6
{
...
int func_202(var uParam0)//Position - 0xD0BE
{
...
void func_203(var uParam0)//Position - 0xD0E3
{
	int iVar0;
	int iVar1;
...
void func_204(int iParam0)//Position - 0xD3E7
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_205(var uParam0)//Position - 0xD412
{
	int iVar0;
...
int func_206(var uParam0, bool bParam1, bool bParam2)//Position - 0xD492
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_207(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_207(int iParam0, int iParam1)//Position - 0xD650
{
	int iVar0;
...
int func_208(var uParam0, bool bParam1, int iParam2)//Position - 0xD680
{
	int iVar0;
	int iVar1;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_1C[iVar0]))
			{
				if (!unk_0x36CEFBE9B745A58D(uParam0->f_1C[iVar0]))
				{
					...
					if (func_227(*uParam0))
					{
						if (!func_153(*uParam0))
						{
							if (func_222(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_203(uParam0);
						...
						if (func_210(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_203(uParam0);
...
int func_209(int iParam0)//Position - 0xD93C
{
...
int func_210(int iParam0, float fParam1)//Position - 0xD970
{
	float fVar0;
...
bool func_211(int iParam0, float fParam1)//Position - 0xD9E6
{
	return func_212(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_212(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD9FE
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_213(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDABF
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_214(int iParam0, int iParam1)//Position - 0xDBEB
{
	int iVar0;
...
int func_216(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDCFA
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_218(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_218(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_217(vector3 vParam0, vector3 vParam1)//Position - 0xDD8B
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_218(vector3 vParam0)//Position - 0xDDAC
{
	float fVar0;
	float fVar1;
...
void func_219(var uParam0)//Position - 0xDDEB
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_220(int iParam0, int iParam1)//Position - 0xDE06
{
	int iVar0;
...
int func_221(int iParam0)//Position - 0xDE45
{
...
int func_222(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDE6D
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_223(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDF68
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_224(int iParam0, float fParam1)//Position - 0xE074
{
	var uVar0;
	vector3 vVar1;
...
int func_225(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE109
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_218(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_226(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE197
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_227(int iParam0)//Position - 0xE1DF
{
...
void func_228(int iParam0)//Position - 0xE229
{
	int iVar0;
...
int func_229(int iParam0)//Position - 0xE2C6
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_230(int iParam0)//Position - 0xE35E
{
...
int func_233(int iParam0)//Position - 0xE3E0
{
	if ((func_234() && Global_16B1B.f_B == 6) && iParam0 == func_162(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_235(int iParam0)//Position - 0xE452
{
	if (func_105(0))
	{
...
void func_236()//Position - 0xE47A
{
	iLocal_58 = unk_0x105601648511CC64();
}

void func_237()//Position - 0xE488
{
	iLocal_56 = unk_0x9934FEFB3B8C6DB8("digiscanner");
	while (!unk_0xA7F138B5B1AB2CF6(iLocal_56))
	{
		SYSTEM::WAIT(0);
	}
	...
	if (unk_0x56B8298B48E2A713("digiscanner"))
	{
		iLocal_57 = unk_0xCE506A7684415A58("digiscanner");
	}
	iLocal_59 = unk_0x2F079D1FC5F6CB99();
	iLocal_58 = unk_0x105601648511CC64();
}

int func_238(int iParam0)//Position - 0xE4F0
{
	switch (*iParam0)
	{
		case 44:
...
int func_239(var uParam0)//Position - 0xE537
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_247(&(uParam0->f_30), "rcmrc_omega_2", "omega_idle_looking_around", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_246(&iVar0) || !func_245(&(uParam0->f_30)))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (!func_242(&(uParam0->f_1C[0]), 69, 2319.443f, 2583.588f, 46.7663f, 220f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			{
				func_240(&(uParam0->f_23[0]), iVar0[1], 2331.08f, 2573.53f, 46.13f, 358.61f);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_240(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE705
{
	func_241(iParam0);
...
void func_241(int iParam0)//Position - 0xE747
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_242(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xE7E3
{
...
int func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xE83F
{
	int iVar0;
...
int func_244(var uParam0, int iParam1)//Position - 0xE8CD
{
	int iVar0;
...
int func_245(var uParam0)//Position - 0xE913
{
	if (func_202(uParam0))
	{
...
int func_246(int iParam0)//Position - 0xE93D
{
	int iVar0;
...
void func_247(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xE96E
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_248(var uParam0)//Position - 0xE9AA
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_247(&(uParam0->f_30), "rcmrc_omega_1", "omega_idle_geiger_counter", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (!func_242(&(uParam0->f_1C[0]), 69, 2468.51f, 3437.39f, 49.9f, 180f, "OMEGA LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
			...
			if ((func_124(uParam0->f_1C[0]) && unk_0x724D816EA203A79E(uParam0->f_29[0])) && unk_0x724D816EA203A79E(uParam0->f_29[1]))
			{
...
int func_249(int iParam0)//Position - 0xEC2C
{
	struct<27> Var0;
	int iVar1;
...
int func_250(int iParam0)//Position - 0xEC80
{
	char* sVar0;
...
int func_251(int iParam0)//Position - 0xED39
{
	var uVar0;
...
int func_252(int iParam0)//Position - 0xEDFA
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_253(int iParam0, char* sParam1)//Position - 0xEE7F
{
...
bool func_254(int iParam0)//Position - 0xEF61
{
...
bool func_255(int iParam0)//Position - 0xEF8F
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_256(int iParam0)//Position - 0xEFBD
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_257(int iParam0)//Position - 0xEFEB
{
	if (func_230(iParam0))
	{
		return 0;
...
void func_258()//Position - 0xF020
{
	func_279("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_259(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF03A
{
	int iVar0;
...
int func_260(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xF09F
{
	int iVar0;
	struct<7> Var1;
...
int func_261(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xF11D
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_262(int iParam0, bool bParam1)//Position - 0xF198
{
	char* sVar0;
	...
	if (bParam1)
	{
		...
		if (*iParam0 == 44 && unk_0x724D816EA203A79E(iParam0->f_29[1]))
		{
			unk_0xF8ED8988FAF2823F(&(iParam0->f_29[1]));
		}
...
void func_263(char* sParam0)//Position - 0xF268
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
		if (func_184(sParam0))
...
void func_264()//Position - 0xF287
{
	Global_394A = 0;
	func_265();
}

void func_265()//Position - 0xF297
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
int func_266(var uParam0)//Position - 0xF2B8
{
	if (func_202(uParam0))
	{
		if (unk_0xF9E082857622D91E(*uParam0))
...
void func_267(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xF2EE
{
...
void func_268(var uParam0, bool bParam1)//Position - 0xF30E
{
	func_269(&(uParam0->f_29), bParam1);
}

void func_269(var uParam0, bool bParam1)//Position - 0xF320
{
	int iVar0;
...
void func_270(int iParam0, bool bParam1)//Position - 0xF35E
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_271(var uParam0, bool bParam1)//Position - 0xF399
{
	func_272(&(uParam0->f_23), bParam1);
}

void func_272(var uParam0, bool bParam1)//Position - 0xF3AB
{
	int iVar0;
...
void func_273(int iParam0)//Position - 0xF3E8
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_274(var uParam0, int iParam1)//Position - 0xF420
{
	func_275(&(uParam0->f_1C), iParam1);
}

void func_275(var uParam0, int iParam1)//Position - 0xF432
{
	int iVar0;
...
void func_276(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xF473
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_277(int iParam0)//Position - 0xF4C3
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_278(var uParam0)//Position - 0xF504
{
	if (*uParam0 == -1)
	{
		return;
...
void func_279(char* sParam0)//Position - 0xF541
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_280(var uParam0)//Position - 0xF553
{
	*uParam0 = -1;
...
void func_281()//Position - 0xF586
{
	func_279("Running start routines.");
	Global_199EA++;
}

int func_282(int iParam0)//Position - 0xF5A0
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
