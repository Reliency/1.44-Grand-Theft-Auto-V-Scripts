...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_297(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_280(&Var0, 1);
	}
	...
	if (Var0 == 27)
	{
		func_246(&uLocal_57, 5, Var0.f_1C[0], "JOSH", 0, 1);
	}
	else if (Var0 == 30)
	{
		func_246(&uLocal_57, 4, Var0.f_1C[0], "JOSH", 0, 1);
		func_246(&uLocal_57, 3, Var0.f_1C[1], "JOSHCOP", 0, 1);
			...
			if (iLocal_225 == 0)
			{
				if (unk_0xA5A42DEC1470C5A9())
				{
					if (func_196(Var0.f_1C[1]))
					{
						...
						unk_0x2C5D30EE32747F1F("Cop_standing_idle", Var0.f_1C[1], 0);
					}
					if (func_196(Var0.f_1C[2]))
					{
						func_298("Josh 4: Trying to set Cop 2 component variation");
						unk_0x2C5D30EE32747F1F("Cop_with_notepad", Var0.f_1C[2], 0);
					}
					iLocal_225 = 1;
				}
			}
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x62A3
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x62EA
{
...
bool func_70(int iParam0)//Position - 0x6345
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6355
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x63B5
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x66A9
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x66B4
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x66C4
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6766
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6D20
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6D7E
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6E2C
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6EC1
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6F05
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x7089
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x7097
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7B5E
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7BE0
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7C3E
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7C47
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7E1A
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7E2A
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x80C4
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x80D5
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x811B
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x81A1
{
...
void func_94(var uParam0, int iParam1)//Position - 0x81D4
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x8225
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x82C7
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x82EC
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x8303
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x8310
{
...
void func_100(var uParam0, int iParam1)//Position - 0x834A
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8385
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x83C1
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x83DA
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x8433
{
...
bool func_105(bool bParam0)//Position - 0x8475
{
...
struct<2> func_106(int iParam0)//Position - 0x84A0
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x88ED
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9BC5
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9F0B
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9FAF
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0xA04A
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0xA0A8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA101
{
...
int func_116(int iParam0)//Position - 0xA184
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA1B5
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA1CA
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA27D
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA298
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA2E4
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA32D
{
	if (func_196(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA34D
{
	switch (iParam0)
	{
		case 5:
...
int func_126(int iParam0)//Position - 0xA41D
{
	switch (iParam0)
	{
		case 5:
...
void func_127(var uParam0, bool bParam1, bool bParam2)//Position - 0xA470
{
	int iVar0;
...
int func_128(int iParam0)//Position - 0xA565
{
	switch (iParam0)
	{
		case 5:
...
void func_129(bool bParam0)//Position - 0xA5D0
{
	int iVar0;
...
void func_130(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA60D
{
	if (bParam0)
	{
...
int func_133(int iParam0, bool bParam1)//Position - 0xA79E
{
	int iVar0;
	int iVar1;
...
int func_134(int iParam0)//Position - 0xA7DF
{
...
bool func_135()//Position - 0xA821
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_136(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA832
{
	int iVar0;
...
void func_138(int iParam0)//Position - 0xA88C
{
	if (iParam0 == 1)
	{
...
int func_139(char* sParam0)//Position - 0xA8AF
{
...
void func_140()//Position - 0xA8EC
{
	Global_394A = 0;
	func_141();
}

void func_141()//Position - 0xA8FC
{
...
int func_145(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA9E2
{
...
void func_146(int iParam0)//Position - 0xAB71
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_148(int iParam0)//Position - 0xABEE
{
...
void func_150(bool bParam0, bool bParam1)//Position - 0xAC87
{
	if (bParam0)
	{
		if (func_151(0))
...
int func_151(int iParam0)//Position - 0xACFB
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_152(int iParam0)//Position - 0xAD55
{
...
int func_153(int iParam0)//Position - 0xAD96
{
	int iVar0;
...
void func_154(int iParam0)//Position - 0xADDB
{
...
int func_155(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAE0D
{
	int iVar0;
...
void func_156(var uParam0, int iParam1)//Position - 0xAF44
{
	int iVar0;
...
bool func_157(int iParam0)//Position - 0xAF93
{
	return func_158(iParam0, Global_8C41);
}

int func_158(int iParam0, int iParam1)//Position - 0xAFA4
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_159(int iParam0)//Position - 0xB185
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_160()//Position - 0xB1A7
{
	return func_161(unk_0x1377080E9B0BD993(), 0);
}

int func_161(char* sParam0, int iParam1)//Position - 0xB1B8
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_163(int iParam0, int iParam1)//Position - 0xB225
{
	switch (iParam0)
	{
		case 0:
...
int func_164(vector3 vParam0, bool bParam1)//Position - 0xB6AC
{
	int iVar0;
...
float func_165(bool bParam0, float fParam1, float fParam2)//Position - 0xB6D8
{
	if (bParam0)
	{
		return fParam1;
...
int func_166(int iParam0)//Position - 0xB6EF
{
	switch (iParam0)
	{
		case 0:
...
int func_167(var uParam0)//Position - 0xB77E
{
	if (*uParam0 == 30)
	{
		if (func_196(uParam0->f_1C[0]))
		{
			if (bLocal_223)
			{
				if (!unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
				{
					if (func_168(unk_0xBC25C936A095B5BA(), uParam0->f_1C[0], 1) <= 15f)
					{
						func_298("Special launching Josh 4 (not in vehicle)");
						return 1;
					}
				}
				else if (func_168(unk_0xBC25C936A095B5BA(), uParam0->f_1C[0], 1) <= 10f)
				{
...
float func_168(int iParam0, int iParam1, bool bParam2)//Position - 0xB7FD
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_169(var uParam0)//Position - 0xB85B
{
	if (*uParam0 == 29)
	{
...
int func_170(int iParam0, int iParam1)//Position - 0xB8EE
{
	if (func_123(iParam0))
	{
...
int func_171(var uParam0)//Position - 0xB921
{
	if (*uParam0 == 28)
	{
...
int func_172(var uParam0, int iParam1)//Position - 0xB9B8
{
	switch (uParam0->f_10)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					if (func_196(uParam0->f_1C[0]))
					{
						if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(uParam0->f_1C[0], true), true) < 3f)
						{
							if (func_178(2))
							{
								if (func_176(uParam0->f_1B))
								{
									func_175(uParam0->f_1B, *uParam0);
				...
				else if (func_196(uParam0->f_1C[0]))
				{
					if (func_174(uParam0))
					{
						if (func_178(2))
...
void func_173()//Position - 0xC1A0
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_174(var uParam0)//Position - 0xC1BB
{
	float fVar0;
...
void func_175(int iParam0, int iParam1)//Position - 0xC249
{
	if (iParam0 == 1)
	{
		if (!func_126(iParam1))
...
int func_176(bool bParam0)//Position - 0xC2AD
{
	int iVar0;
...
int func_177(int iParam0)//Position - 0xC344
{
	if (func_196(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_178(int iParam0)//Position - 0xC36E
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_186()) || Global_1974B) || Global_62BF) || func_185()) || func_184(8, -1)) || func_90()) || func_183()) || func_182()) || func_181()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_186()) || Global_62BF) || func_185()) || func_184(8, -1)) || func_182()) || func_90()) || func_183()) || func_181()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_186()) || Global_1974B) || Global_62BF) || func_185()) || func_184(8, -1)) || func_182()) || func_90()) || func_183()) || func_181()) || Global_19B04.f_1DEB.f_397[iVar0] == 5) || Global_8E64 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_186()) || Global_1974B) || Global_62BF) || func_185()) || func_184(8, -1)) || func_90()) || func_183()) || func_181()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_186() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_184(8, -1)) || func_181()) || func_180()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_186()) || Global_62BF) || func_185()) || func_184(8, -1)) || func_183()) || func_182()) || func_181()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_179()//Position - 0xCA8B
{
	return Global_16B42.f_1;
}

int func_180()//Position - 0xCA99
{
	if (Global_15FA6 != -1)
	{
...
bool func_183()//Position - 0xCB03
{
	return Global_16B4F.f_142 > 0;
}

bool func_184(int iParam0, int iParam1)//Position - 0xCB14
{
	switch (iParam0)
	{
		case 5:
...
var func_185()//Position - 0xCB4F
{
	return Global_140856;
}

int func_186()//Position - 0xCB5B
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
void func_187()//Position - 0xCB77
{
	switch (iLocal_56)
	{
		case 0:
			if ((unk_0x105601648511CC64() - iLocal_222) > 100 && bLocal_223 == 0)
			{
				iLocal_56 = 1;
			}
			break;
...
bool func_188(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xCC43
{
...
int func_189(char* sParam0, int iParam1, bool bParam2)//Position - 0xCC91
{
	Global_3DB9 = 0;
...
void func_195(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD1B7
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
int func_196(int iParam0)//Position - 0xD20D
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
...
int func_197(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xD22E
{
	var uVar0;
	
	if ((((func_196(unk_0xBC25C936A095B5BA()) && func_196(iParam0->f_1C[0])) && !func_142()) && (unk_0x105601648511CC64() - iParam0->f_3C) > iParam6) && func_208(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_246(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_198(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD2B6
{
...
void func_199(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xD2F1
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_208(unk_0xBC25C936A095B5BA(), vParam2, 1) <= 100f)
				{
					func_202(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_208(unk_0xBC25C936A095B5BA(), vParam2, 1) > 120f)
				{
					func_204(iParam0);
				}
			}
...
void func_200(int iParam0, bool bParam1)//Position - 0xD3E2
{
	if (iParam0 == -1)
	{
		return;
...
int func_201(int iParam0)//Position - 0xD41E
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_202(int iParam0, int iParam1)//Position - 0xD457
{
	bool bVar0;
	int iVar1;
...
bool func_203()//Position - 0xD4F5
{
	return Global_16129;
}

void func_204(int iParam0)//Position - 0xD501
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_205(iParam0);
...
void func_205(int iParam0)//Position - 0xD518
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_206(int iParam0)//Position - 0xD600
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
void func_207(int iParam0)//Position - 0xD628
{
	int iVar0;
...
float func_208(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xD6A8
{
	vector3 vVar0;
...
int func_209(var uParam0, bool bParam1)//Position - 0xD6E2
{
	struct<27> Var0;
	...
	if ((func_245(*uParam0) || func_243(*uParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
	...
	if (func_213(&(uParam0->f_30)) && bParam1)
	{
		func_210(uParam0->f_1C[0], &(uParam0->f_30), *uParam0);
	}
	return 1;
}

void func_210(int iParam0, var uParam1, int iParam2)//Position - 0xD955
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_212(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_212(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_211(int iParam0)//Position - 0xDCAD
{
...
int func_212(var uParam0)//Position - 0xDCCD
{
...
int func_213(var uParam0)//Position - 0xDCE5
{
...
void func_214(var uParam0)//Position - 0xDD0A
{
	int iVar0;
	int iVar1;
...
void func_215(int iParam0)//Position - 0xE00E
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_216(var uParam0, bool bParam1, bool bParam2)//Position - 0xE039
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_217(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_217(int iParam0, int iParam1)//Position - 0xE1F7
{
	int iVar0;
...
int func_218(var uParam0, bool bParam1, int iParam2)//Position - 0xE227
{
	int iVar0;
	int iVar1;
...
int func_219(int iParam0)//Position - 0xE4E3
{
...
int func_220(int iParam0, float fParam1)//Position - 0xE517
{
	float fVar0;
...
bool func_221(int iParam0, float fParam1)//Position - 0xE58D
{
	return func_222(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_222(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE5A5
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_223(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE666
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_224(int iParam0, int iParam1)//Position - 0xE792
{
	int iVar0;
...
int func_226(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE8A1
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_228(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_228(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_227(vector3 vParam0, vector3 vParam1)//Position - 0xE932
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_228(vector3 vParam0)//Position - 0xE953
{
	float fVar0;
	float fVar1;
...
void func_229(var uParam0)//Position - 0xE992
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_230(int iParam0, int iParam1)//Position - 0xE9AD
{
	int iVar0;
...
int func_231(int iParam0)//Position - 0xE9EC
{
...
int func_232(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEA14
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_233(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xEB0F
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_234(int iParam0, float fParam1)//Position - 0xEC1B
{
	var uVar0;
	vector3 vVar1;
...
int func_235(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xECB0
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_228(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_236(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xED3E
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_237(int iParam0)//Position - 0xED86
{
...
void func_238(int iParam0)//Position - 0xEDD0
{
	int iVar0;
...
int func_239(int iParam0)//Position - 0xEE6D
{
	if (iParam0 == -1)
	{
		iParam0 = func_160();
...
int func_240(int iParam0)//Position - 0xEF05
{
...
int func_243(int iParam0)//Position - 0xEF87
{
	if ((func_244() && Global_16B1B.f_B == 6) && iParam0 == func_161(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_245(int iParam0)//Position - 0xEFF9
{
	if (func_105(0))
	{
...
void func_246(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xF021
{
...
int func_247(int iParam0)//Position - 0xF0BC
{
	switch (*iParam0)
	{
		case 27:
...
int func_248(var uParam0)//Position - 0xF131
{
	int iVar0[4];
	int iVar1;
	float fVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_261(&(uParam0->f_30), "rcmjosh4", "beckon_a_josh", 0);
			iLocal_51 = 1;
			break;
		
		case 1:
			if (!func_260(&iVar0) || !func_259(&(uParam0->f_30)))
			{
				return 0;
			}
			if (!func_258(0, 1))
		...
		case 2:
			...
			{
				if (func_254(&(uParam0->f_1C[0]), 58, -1103.6f, 290.81f, 64.31f, -99.24f, "JOSH LAUNCHER RC", 1))
				{
			...
			{
				func_252(&(uParam0->f_1C[1]), iVar0[2], -1102.92f, 290.12f, 64.28f, 40.46f, 6);
			...
			{
				func_252(&(uParam0->f_1C[2]), iVar0[2], -1102.73f, 290.91f, 64.28f, 92.06f, 6);
				if (func_196(uParam0->f_1C[2]))
				{
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_250(&(uParam0->f_23[0]), iVar0[3], -1107.5f, 280.33f, 64.01f, 97.97f);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_23[1]))
			{
				func_249(&(uParam0->f_23[1]), 0);
				if (func_177(uParam0->f_23[1]))
				{
...
void func_249(int iParam0, bool bParam1)//Position - 0xF526
{
	vector3 vVar0;
	float fVar1;
...
void func_250(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF59A
{
	func_251(iParam0);
...
void func_251(int iParam0)//Position - 0xF5DC
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_252(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xF678
{
	func_253(iParam0);
	*iParam0 = unk_0x01B3635C3E8EDD81(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_253(int iParam0)//Position - 0xF699
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
int func_254(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xF6DA
{
...
int func_255(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xF736
{
	int iVar0;
...
int func_256(var uParam0, int iParam1)//Position - 0xF7C4
{
	int iVar0;
...
int func_257(bool bParam0, bool bParam1)//Position - 0xF80A
{
	int iVar0;
...
int func_258(bool bParam0, bool bParam1)//Position - 0xF878
{
	int iVar0;
...
int func_259(var uParam0)//Position - 0xF91E
{
	if (func_213(uParam0))
	{
...
int func_260(int iParam0)//Position - 0xF948
{
	int iVar0;
...
void func_261(var uParam0, char* sParam1, char* sParam2, int iParam3)//Position - 0xF979
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = iParam3;
...
int func_262(var uParam0)//Position - 0xF9B5
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (!func_254(&(uParam0->f_1C[0]), 58, 566.1639f, -1773.817f, 29f, 14.4f, "JOSH LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
		...
		case 3:
			if (func_196(uParam0->f_1C[0]))
			{
				unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[0], 118, false);
				unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[0], 208, true);
				uParam0->f_3B = unk_0xD0D858E538FD01C3(563.76f, -1773.86f, 28.36f, 0f, 0.05f, -110.7f, 2);
				unk_0xB62398E536F695FC(uParam0->f_1C[0], uParam0->f_3B, "rcmjosh3", "sit_stairs_idle", 8f, -8f, 17, 0, 1148846080, 0);
...
void func_263(int iParam0)//Position - 0xFB9D
{
...
int func_264(var uParam0)//Position - 0xFBE3
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (!func_254(&(uParam0->f_1C[0]), 58, 565.3901f, -1772.838f, 29.80087f, 62.50156f, "JOSH LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
		...
		case 3:
			if (func_196(uParam0->f_1C[0]))
			{
				...
				iLocal_54 = unk_0xD0D858E538FD01C3(563.76f, -1773.86f, 28.36f, 0.02f, 0.02f, -110.7f, 2);
				unk_0xC2BF3DE5E47F801D(iLocal_54, true);
				unk_0xB62398E536F695FC(uParam0->f_1C[0], iLocal_54, "rcmjosh2", "josh_wait_loop", 2f, -4f, 0, 0, 1148846080, 0);
			}
...
int func_265(var uParam0)//Position - 0xFE06
{
	int iVar0[2];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_261(&(uParam0->f_30), "rcmjosh1", "idle", 0);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (!func_254(&(uParam0->f_1C[0]), 58, -1104.72f, 291.02f, 64.39f, 138.35f, "JOSH LAUNCHER RC", 1))
				{
					bVar2 = false;
				}
			}
...
int func_266(bool bParam0, bool bParam1)//Position - 0xFF73
{
	int iVar0;
...
int func_267(int iParam0)//Position - 0xFFE1
{
	struct<27> Var0;
	int iVar1;
...
int func_268(int iParam0)//Position - 0x10036
{
	char* sVar0;
...
int func_269(int iParam0)//Position - 0x100EF
{
	var uVar0;
...
int func_270(int iParam0)//Position - 0x101B0
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_271(int iParam0, char* sParam1)//Position - 0x10235
{
...
bool func_272(int iParam0)//Position - 0x10317
{
...
bool func_273(int iParam0)//Position - 0x10345
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_274(int iParam0)//Position - 0x10373
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_275(int iParam0)//Position - 0x103A1
{
	if (func_240(iParam0))
	{
		return 0;
...
void func_276()//Position - 0x103D6
{
	func_298("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_277(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x103F0
{
	int iVar0;
...
int func_278(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0x10455
{
	int iVar0;
	struct<7> Var1;
...
int func_279(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x104D3
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_280(int iParam0, bool bParam1)//Position - 0x1054E
{
	char* sVar0;
	...
	if (unk_0x2DA8CA50A72528FB(iLocal_224))
	{
		unk_0x07B8ECB35A4ED3AC(&iLocal_224);
	}
	func_286(&(iParam0->f_30));
	if (iLocal_55 != -1)
	{
...
void func_281(char* sParam0)//Position - 0x105FC
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
		if (func_284(sParam0))
...
void func_282()//Position - 0x1061B
{
	Global_394A = 0;
	func_283();
}

void func_283()//Position - 0x1062B
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
int func_284(char* sParam0)//Position - 0x1064C
{
	struct<6> Var0;
...
struct<6> func_285()//Position - 0x1066C
{
	struct<6> Var0;
...
int func_286(var uParam0)//Position - 0x10690
{
	if (func_213(uParam0))
	{
		if (unk_0xF9E082857622D91E(*uParam0))
...
void func_287(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x106C6
{
...
void func_288(var uParam0, bool bParam1)//Position - 0x106E6
{
	func_289(&(uParam0->f_29), bParam1);
}

void func_289(var uParam0, bool bParam1)//Position - 0x106F8
{
	int iVar0;
...
void func_290(int iParam0, bool bParam1)//Position - 0x10736
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_291(var uParam0, bool bParam1)//Position - 0x10771
{
	func_292(&(uParam0->f_23), bParam1);
}

void func_292(var uParam0, bool bParam1)//Position - 0x10783
{
	int iVar0;
...
void func_293(int iParam0)//Position - 0x107C0
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_294(var uParam0, int iParam1)//Position - 0x107F8
{
	func_295(&(uParam0->f_1C), iParam1);
}

void func_295(var uParam0, int iParam1)//Position - 0x1080A
{
	int iVar0;
...
void func_296(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1084B
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_297(var uParam0)//Position - 0x1089B
{
	if (*uParam0 == -1)
	{
		return;
...
void func_298(char* sParam0)//Position - 0x108D8
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_299(var uParam0)//Position - 0x108EA
{
	*uParam0 = -1;
...
void func_300()//Position - 0x1091D
{
	func_298("Running start routines.");
	Global_199EA++;
}

int func_301(int iParam0)//Position - 0x10937
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
