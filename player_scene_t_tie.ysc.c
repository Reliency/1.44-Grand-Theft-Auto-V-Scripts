...
int func_2()//Position - 0x108
{
	...
	fVar0 = SYSTEM::VDIST2(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_70);
	if (fVar0 > (100f * 100f))
	{
		return 1;
	}
...
int func_6(int iParam0, int iParam1)//Position - 0x217
{
	...
	if (!unk_0x7930B3E9C919E90F())
	{
		...
		else if (iParam1 == func_7(Global_16A45) && iParam1 != 0)
		{
			Global_16A45 = 0;
		}
	}
...
void func_19()//Position - 0x545
{
	...
	while (!bVar2 && iVar1 < 400)
	{
		...
		while (iVar0 < iLocal_69)
		{
			...
			{
				unk_0xF243B7A14FCFD0F4(iLocal_69[iVar0]);
				if (!unk_0xD6513D668481290A(iLocal_69[iVar0]))
				{
					unk_0xF243B7A14FCFD0F4(iLocal_69[iVar0]);
					bVar2 = false;
				}
		...
		if (!unk_0xF1734B55490E9045(&cLocal_75))
		{
			unk_0x522053D86D6E1C7A(&cLocal_75);
			if (!unk_0xF9E082857622D91E(&cLocal_75))
			{
				unk_0x522053D86D6E1C7A(&cLocal_75);
				bVar2 = false;
			}
	...
	while (iVar0 < iLocal_68)
	{
		if (iLocal_69[iVar0] != 0)
		{
			iLocal_68[iVar0] = unk_0x01B3635C3E8EDD81(26, iLocal_69[iVar0], vLocal_70 + vLocal_72[iVar0 /*3*/], 0f, 1, true);
			unk_0x784C605D172817C8(iLocal_68[iVar0], Vector(uLocal_71, 0f, 0f) + vLocal_73[iVar0 /*3*/], 2, 1);
			unk_0x7D314AB19CA29C96(iLocal_68[iVar0], 0);
			if (iLocal_66 == 288)
			{
				unk_0xB0031DDAE4FF0BC3(iLocal_68[iVar0], 3, 1, 0, 0);
				unk_0xB0031DDAE4FF0BC3(iLocal_68[iVar0], 4, 0, 0, 0);
			}
			else
			{
				unk_0x7D314AB19CA29C96(iLocal_68[iVar0], 0);
			}
			unk_0x91629AC1E1F78419(iLocal_68[iVar0], 13, false);
			...
			unk_0x16F091616F4E9EA0(iLocal_68[iVar0], &cLocal_75, &(Local_80[iVar0 /*8*/]), vLocal_70 + vLocal_72[iVar0 /*3*/], Vector(uLocal_71, 0f, 0f) + vLocal_73[iVar0 /*3*/], 1000f, -8f, -1, iLocal_81, 0, 2, 0);
			unk_0x2EB4D46478766D87(iLocal_68[iVar0], 0, 0);
			unk_0x22321800954A532E(iLocal_68[iVar0], true);
			unk_0x2E9860A2B72187F5(iLocal_68[iVar0], 55, true);
			if (iLocal_83[iVar0] > 0)
			{
				unk_0xCD89A719B6E23DE8(iLocal_68[iVar0], 1, 0.36f, 0.71f, "ShotgunSmall");
				unk_0x84518BC4397AB1AC(iLocal_68[iVar0], 1, 0.81f, 0.733f, 4);
				unk_0x84518BC4397AB1AC(iLocal_68[iVar0], 0, 0.94f, 0.59f, 3);
				unk_0x84518BC4397AB1AC(iLocal_68[iVar0], 3, 0.24f, 0.62f, 4);
				unk_0x84518BC4397AB1AC(iLocal_68[iVar0], 2, 0f, 0.15f, 2);
				unk_0x84518BC4397AB1AC(iLocal_68[iVar0], 5, 0.46f, 0.853f, 3);
				unk_0x84518BC4397AB1AC(iLocal_68[iVar0], 4, 0.308f, 0.786f, 3);
				unk_0x17F107392C2BF056(iLocal_68[iVar0], 3, 0.375f, 0.398f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x17F107392C2BF056(iLocal_68[iVar0], 3, 0.5f, 0.6f, 0f, 1f, -1, 0f, "BasicSlash");
				unk_0x17F107392C2BF056(iLocal_68[iVar0], 3, 0.6f, 0.25f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0x17F107392C2BF056(iLocal_68[iVar0], 3, 0.65f, 0.325f, 50f, 0.5f, -1, 0f, "BasicSlash");
				unk_0x17F107392C2BF056(iLocal_68[iVar0], 0, 0.58f, 0.704f, 0f, 1f, -1, 0f, "ShotgunLarge");
			}
		}
		iVar0++;
	}
	...
	while (iVar0 < iLocal_82)
	{
		if (iLocal_83[iVar0] > 0)
		{
			...
			fVar10 = 1f;
			fVar11 = -1f;
			iLocal_82[iVar0] = unk_0x86901CB45E45CCB8(iLocal_83[iVar0], vLocal_70 + vLocal_84[iVar0 /*3*/], vVar3, vVar4, fVar5, fVar6, fVar7, fVar8, fVar9, fVar10, fVar11, 0, 0, 0);
			SYSTEM::WAIT(0);
		}
		iVar0++;
	}
...
void func_21()//Position - 0x90C
{
	...
	switch (iLocal_66)
	{
		case 280:
			...
			iLocal_83[4] = 1015;
			iLocal_83[5] = 1015;
			vLocal_84[4 /*3*/] = { vLocal_84[0 /*3*/] + vLocal_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x55AEFCD285ECC0F2(0.5f, 0.5f), unk_0x55AEFCD285ECC0F2(0.5f, 0.5f)) };
			vLocal_84[5 /*3*/] = { vLocal_84[1 /*3*/] + vLocal_84[2 /*3*/] / Vector(2f, 2f, 2f) + Vector(0f, unk_0x55AEFCD285ECC0F2(0.5f, 0.5f), unk_0x55AEFCD285ECC0F2(0.5f, 0.5f)) };
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_23(uParam1, 17, 1785177548, 1785177548, unk_0x55AEFCD285ECC0F2(-5f, 5f), unk_0x55AEFCD285ECC0F2(-5f, 5f), 0f, unk_0x55AEFCD285ECC0F2(-180f, 180f));
			uParam1->f_76 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_23(uParam1, 144, 1785177548, 1785177548, unk_0x55AEFCD285ECC0F2(-5f, 5f), unk_0x55AEFCD285ECC0F2(-5f, 5f), 0f, unk_0x55AEFCD285ECC0F2(-180f, 180f));
			uParam1->f_76 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_23(uParam1, 43, 1785177548, 1785177548, unk_0x55AEFCD285ECC0F2(-5f, 5f), unk_0x55AEFCD285ECC0F2(-5f, 5f), 0f, unk_0x55AEFCD285ECC0F2(-180f, 180f));
			uParam1->f_76 = 1;
			return 1;
			break;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19B04.f_932.f_21B.f_8F2[0];
			StringCopy(sParam2, func_32(Global_19B04.f_932.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19B04.f_932.f_21B.f_8F2[1];
			StringCopy(sParam2, func_32(Global_19B04.f_932.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19B04.f_932.f_21B.f_8F2[2];
			StringCopy(sParam2, func_32(Global_19B04.f_932.f_21B.f_8F6[2]), 32);
			return 1;
			break;
...
void func_33()//Position - 0x91F9
{
	...
	while (iVar0 < iLocal_69)
	{
		if (iLocal_69[iVar0] != 0)
		{
			unk_0x2CA123B0622F495C(iLocal_69[iVar0]);
		}
		iVar0++;
	}
	if (!unk_0xF1734B55490E9045(&cLocal_75))
	{
		unk_0x4EA570997E107F35(&cLocal_75);
	}
	iVar0 = 0;
	while (iVar0 < iLocal_82)
	{
		if (unk_0x04BFA7CE4506ECEE(iLocal_82[iVar0]))
		{
		}
		iVar0++;
	}
