...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_284(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_268(&Var0, 1);
	}
	...
	if (Var0 == 32)
	{
		unk_0x379ACE23D404525C(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), false, 1);
		unk_0xDD56BACCCF835044(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), 0);
		unk_0x6C5F5B5F6894CCE3(vVar1, 40f, 1, 0, 0, false);
	}
	else if (Var0 == 34)
	{
		iLocal_57 = func_240();
	...
	while (true)
	{
		...
		{
			func_204();
			if (func_203(Var0.f_23[1]))
			{
				if (!func_202(329.513f, 3402.691f, 36.258f, unk_0x541C2AEF053615BC(Var0.f_23[1], true), 1056964608))
				{
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6266
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x62AD
{
...
bool func_70(int iParam0)//Position - 0x6308
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6318
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x6378
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x666C
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x6677
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x6687
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6729
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6CE3
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6D41
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6DEF
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6E84
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6EC8
{
	struct<6> Var0;
...
struct<6> func_83(int iParam0)//Position - 0x705A
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7B21
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7BA3
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7C01
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7C0A
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7DDD
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7DED
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x8088
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x8099
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x80DF
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x8165
{
...
void func_94(var uParam0, int iParam1)//Position - 0x8198
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x81E9
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x828B
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x82B0
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x82C7
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x82D4
{
...
void func_100(var uParam0, int iParam1)//Position - 0x830E
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8349
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x8385
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x839E
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x83F7
{
...
bool func_105(bool bParam0)//Position - 0x8439
{
...
struct<2> func_106(int iParam0)//Position - 0x8464
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x88B1
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9B89
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9ECF
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9F73
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0xA00E
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0xA06C
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA0C5
{
...
int func_116(int iParam0)//Position - 0xA148
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA179
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA18E
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA241
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA25C
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA2A8
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA2F1
{
	if (func_124(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA311
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA332
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA402
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA455
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA54A
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA5B5
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA5F2
{
	if (bParam0)
	{
...
int func_134(int iParam0, bool bParam1)//Position - 0xA783
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA7C4
{
...
bool func_136()//Position - 0xA806
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA817
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA871
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA894
{
...
void func_141()//Position - 0xA8D1
{
	Global_394A = 0;
	func_142();
}

void func_142()//Position - 0xA8E1
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA9C7
{
...
void func_147(int iParam0)//Position - 0xAB56
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xABD3
{
...
void func_150(int iParam0)//Position - 0xABFC
{
	if (Global_3943)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAC6C
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xACE0
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAD3A
{
...
int func_154(int iParam0)//Position - 0xAD7B
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xADC0
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xADF2
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAF29
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAF78
{
	return func_159(iParam0, Global_8C41);
}

int func_159(int iParam0, int iParam1)//Position - 0xAF89
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xB16A
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_161()//Position - 0xB18C
{
	return func_162(unk_0x1377080E9B0BD993(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB19D
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_164(int iParam0, int iParam1)//Position - 0xB20A
{
	switch (iParam0)
	{
		case 0:
...
int func_165(vector3 vParam0, bool bParam1)//Position - 0xB691
{
	int iVar0;
...
float func_166(bool bParam0, float fParam1, float fParam2)//Position - 0xB6BD
{
	if (bParam0)
	{
		return fParam1;
...
int func_167(int iParam0)//Position - 0xB6D4
{
	switch (iParam0)
	{
		case 0:
...
int func_168(int iParam0, int iParam1)//Position - 0xB763
{
	switch (iParam0->f_10)
	{
		case 0:
...
void func_169()//Position - 0xBF46
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_170(var uParam0)//Position - 0xBF61
{
	float fVar0;
...
void func_171(int iParam0, int iParam1)//Position - 0xBFEF
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_172(bool bParam0)//Position - 0xC053
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0xC0EA
{
	int iVar0;
...
var func_174()//Position - 0xC807
{
	return Global_16B42.f_1;
}

int func_175()//Position - 0xC815
{
	if (Global_15FA6 != -1)
	{
...
bool func_178()//Position - 0xC87F
{
	return Global_16B4F.f_142 > 0;
}

bool func_179(int iParam0, int iParam1)//Position - 0xC890
{
	switch (iParam0)
	{
		case 5:
...
var func_180()//Position - 0xC8CB
{
	return Global_140856;
}

int func_181()//Position - 0xC8D7
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
int func_182(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xC8F3
{
	var uVar0;
	
	if ((((func_124(unk_0xBC25C936A095B5BA()) && func_124(iParam0->f_1C[0])) && !func_143()) && (unk_0x105601648511CC64() - iParam0->f_3C) > iParam6) && func_186(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
...
void func_183(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC97B
{
...
void func_184(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC9B6
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_185(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCA0C
{
...
float func_186(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCAA7
{
	vector3 vVar0;
...
int func_187(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, char* sParam7, var uParam8)//Position - 0xCAE1
{
	var uVar0;
	...
	if (!*uParam8 == 3)
	{
		if (func_173(2))
		{
			if (!func_143())
			{
				if (((func_124(unk_0xBC25C936A095B5BA()) && func_124(iParam0->f_1C[0])) && func_124(iParam0->f_1C[1])) && func_186(unk_0xBC25C936A095B5BA(), vParam1, 1) < 20f)
				{
					...
					{
						func_185(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
						func_185(&uVar0, iParam6, iParam0->f_1C[1], sParam7, 0, 1);
						func_183(&uVar0, cParam2, sParam3, 7, 0, 0);
						*uParam8 = 2;
					}
					else if (*uParam8 == 2)
			...
			else if (((func_189(sParam3) && !*uParam8 == 1) && func_124(unk_0xBC25C936A095B5BA())) && func_186(unk_0xBC25C936A095B5BA(), vParam1, 1) >= 20f)
			{
				func_285("pause conversation");
				func_188(1);
				*uParam8 = 1;
			}
			if (func_186(unk_0xBC25C936A095B5BA(), vParam1, 1) < 20f && *uParam8 == 1)
			{
...
void func_188(int iParam0)//Position - 0xCC2C
{
	Global_41AB = iParam0;
}

int func_189(char* sParam0)//Position - 0xCC39
{
	struct<6> Var0;
...
struct<6> func_190()//Position - 0xCC59
{
	struct<6> Var0;
...
void func_191(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xCC7D
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_186(unk_0xBC25C936A095B5BA(), vParam2, 1) <= 100f)
				{
					func_194(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_186(unk_0xBC25C936A095B5BA(), vParam2, 1) > 120f)
				{
					func_196(iParam0);
				}
			}
...
void func_192(int iParam0, bool bParam1)//Position - 0xCD6E
{
	if (iParam0 == -1)
	{
		return;
...
int func_193(int iParam0)//Position - 0xCDAA
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_194(int iParam0, int iParam1)//Position - 0xCDE3
{
	bool bVar0;
	int iVar1;
...
bool func_195()//Position - 0xCE81
{
	return Global_16129;
}

void func_196(int iParam0)//Position - 0xCE8D
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_197(iParam0);
...
void func_197(int iParam0)//Position - 0xCEA4
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_198(int iParam0)//Position - 0xCF8C
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
void func_199(var uParam0)//Position - 0xCFB4
{
	int iVar0;
	int iVar1;
...
void func_200(int iParam0)//Position - 0xD2B8
{
	int iVar0;
...
void func_201(int iParam0)//Position - 0xD355
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_202(struct<2> Param0, float fParam1, struct<2> Param2, float fParam3, float fParam4)//Position - 0xD380
{
	if (fParam4 < 0f)
	{
		fParam4 = 0f;
...
int func_203(int iParam0)//Position - 0xD3B9
{
	if (func_124(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_205(var uParam0, bool bParam1)//Position - 0xD416
{
	struct<27> Var0;
	...
	if ((func_239(*uParam0) || func_237(*uParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
...
void func_206(int iParam0, var uParam1, int iParam2)//Position - 0xD689
{
	int iVar0;
	int iVar1;
...
int func_207(int iParam0)//Position - 0xD9E1
{
...
int func_208(var uParam0)//Position - 0xDA01
{
...
int func_209(var uParam0)//Position - 0xDA19
{
...
void func_210(var uParam0)//Position - 0xDA3E
{
	int iVar0;
...
int func_211(var uParam0, bool bParam1, bool bParam2)//Position - 0xDABE
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_212(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_212(int iParam0, int iParam1)//Position - 0xDC7C
{
	int iVar0;
...
int func_213(var uParam0, bool bParam1, int iParam2)//Position - 0xDCAC
{
	int iVar0;
	int iVar1;
...
int func_214(int iParam0)//Position - 0xDF68
{
...
int func_215(int iParam0, float fParam1)//Position - 0xDF9C
{
	float fVar0;
...
bool func_216(int iParam0, float fParam1)//Position - 0xE012
{
	return func_217(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_217(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xE02A
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_218(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xE0EB
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_219(int iParam0, int iParam1)//Position - 0xE217
{
	int iVar0;
...
int func_221(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xE326
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_223(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_223(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_222(vector3 vParam0, vector3 vParam1)//Position - 0xE3B7
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_223(vector3 vParam0)//Position - 0xE3D8
{
	float fVar0;
	float fVar1;
...
void func_224(var uParam0)//Position - 0xE417
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_225(int iParam0, int iParam1)//Position - 0xE432
{
	int iVar0;
...
int func_226(int iParam0)//Position - 0xE471
{
...
int func_227(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE499
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_228(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE594
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_229(int iParam0, float fParam1)//Position - 0xE6A0
{
	var uVar0;
	vector3 vVar1;
...
int func_230(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE735
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_223(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_231(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE7C3
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_232(int iParam0)//Position - 0xE80B
{
...
int func_233(int iParam0)//Position - 0xE855
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_234(int iParam0)//Position - 0xE8ED
{
...
int func_237(int iParam0)//Position - 0xE96F
{
	if ((func_238() && Global_16B1B.f_B == 6) && iParam0 == func_162(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_239(int iParam0)//Position - 0xE9E1
{
	if (func_105(0))
	{
...
int func_242(var uParam0)//Position - 0xEA95
{
	int iVar0[5];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			func_251(&(uParam0->f_30), "rcmminute3base", "base", "beckon");
		...
		case 2:
			...
			{
				func_248(&(uParam0->f_29[0]), iVar0[3], -303.74f, 6211.56f, 30.49f, -176.77f);
			...
			{
				if (func_245(&(uParam0->f_1C[0]), 59, uParam0->f_30.f_5, -2.8f, "RCM MINUTE - MANUEL", 1))
				{
					unk_0x70FF586D857F1A81(uParam0->f_1C[0], 0, 0, 0, false);
					unk_0x12D2D85EBAC186AA(uParam0->f_1C[0], 0);
					if (func_123(unk_0xBC25C936A095B5BA()))
					{
						unk_0x56F2E1B5599188FA(uParam0->f_1C[0], unk_0xBC25C936A095B5BA(), -1, 2050, 4);
					}
				}
				else
				{
			...
			{
				func_243(&(uParam0->f_23[0]), iVar0[0], -281.93f, 6198.32f, 30.77f, -135.32f);
				unk_0x6012A6A4F2950585(uParam0->f_23[0], 1);
				unk_0x8510BC031C24B862(iVar0[0], true);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_23[1]))
			{
				func_243(&(uParam0->f_23[1]), iVar0[1], -291.72f, 6208.33f, 30.87f, -134.5016f);
				unk_0x6012A6A4F2950585(uParam0->f_23[1], 0);
				unk_0x8510BC031C24B862(iVar0[1], true);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_29[1]))
			{
				func_248(&(uParam0->f_29[1]), iVar0[4], -303.74f, 6211.56f, 30.49f, -176.77f);
				unk_0x5DBE04849460E608(uParam0->f_29[1], uParam0->f_1C[0], unk_0xFA18E720A39243D0(uParam0->f_1C[0], 18905), 0.12f, 0f, 0.03f, 90f, 0f, 90f, 0, 0, 0, 0, 2, 1);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
...
void func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xEDB6
{
	func_244(iParam0);
...
void func_244(int iParam0)//Position - 0xEDF8
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_245(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xEE94
{
...
int func_246(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xEEF0
{
	int iVar0;
...
int func_247(var uParam0, int iParam1)//Position - 0xEF7E
{
	int iVar0;
...
void func_248(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xEFC4
{
	func_201(iParam0);
...
int func_249(var uParam0)//Position - 0xEFEB
{
	if (func_209(uParam0))
	{
...
int func_250(int iParam0)//Position - 0xF015
{
	int iVar0;
...
void func_251(var uParam0, char* sParam1, char* sParam2, char* sParam3)//Position - 0xF046
{
	*uParam0 = sParam1;
	uParam0->f_1 = sParam2;
	uParam0->f_2 = sParam3;
...
int func_252(var uParam0)//Position - 0xF082
{
	int iVar0[1];
	int iVar1;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			func_243(&(uParam0->f_23[0]), iVar0[0], 20.8f, 4532.65f, 104.66f, 284.7f);
			if (unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				unk_0xD421BC740C5340C3(uParam0->f_23[0], 2);
				unk_0x155EA453CD198E4B(uParam0->f_23[0], 5, false);
				unk_0x55AFEE10B3CE5C2C(uParam0->f_23[0], 14f);
				unk_0x8510BC031C24B862(iVar0[0], true);
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
...
int func_253(var uParam0)//Position - 0xF195
{
	int iVar0[4];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		case 0:
			...
			unk_0x522053D86D6E1C7A("rcmminute1");
			unk_0x6C5F5B5F6894CCE3(321.69f, 3408.64f, 35.34f, 10f, 1, 0, 0, false);
			iLocal_51 = 1;
			break;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_245(&(uParam0->f_1C[0]), 56, 329.3f, 3404.2f, 35.8f, -174.9f, "RCM MINUTE - JOE", 1))
				{
			...
			{
				if (func_245(&(uParam0->f_1C[1]), 57, 328.1f, 3403.8f, 35.8f, -149.6f, "RCM MINUTE - JOSEF", 1))
				{
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_243(&(uParam0->f_23[0]), iVar0[0], 321.69f, 3408.64f, 35.34f, -105.8f);
				func_254(uParam0->f_23[0], iVar0[0]);
			}
			if (!unk_0x724D816EA203A79E(uParam0->f_23[1]))
			{
				func_243(&(uParam0->f_23[1]), iVar0[1], 329.49f, 3402.71f, 36.29f, 284.36f);
				func_254(uParam0->f_23[1], iVar0[1]);
				unk_0x8300C56586249382(uParam0->f_23[1], 0);
			}
			if (bVar2)
			{
				iLocal_51 = 3;
		...
		case 3:
			if (unk_0xF9E082857622D91E("rcmminute1"))
			{
				...
				{
					if (!unk_0x96044E39418AAF17(uParam0->f_1C[0], "rcmminute1", "base_joe", 3))
					{
						unk_0xA4E856A8CD53B8DF(uParam0->f_1C[0]);
						unk_0xE896C0AD02364F2A(uParam0->f_1C[0], "rcmminute1", "base_joe", 8f, -8f, -1, 1, 0, 0, 0, 0);
						unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[0], 185, true);
					}
				}
				if (func_124(uParam0->f_1C[1]))
				{
					unk_0xA4E856A8CD53B8DF(uParam0->f_1C[1]);
					unk_0xE896C0AD02364F2A(uParam0->f_1C[1], "rcmminute1", "base_josef", 8f, -8f, -1, 1, 0, 0, 0, 0);
					unk_0xC8FD3EBBB90E8D7F(uParam0->f_1C[1], 185, true);
				}
			}
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
...
int func_256(int iParam0)//Position - 0xF540
{
	char* sVar0;
...
int func_258(int iParam0)//Position - 0xF6BA
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_259(int iParam0, char* sParam1)//Position - 0xF73F
{
...
bool func_260(int iParam0)//Position - 0xF821
{
...
bool func_261(int iParam0)//Position - 0xF84F
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_262(int iParam0)//Position - 0xF87D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_263(int iParam0)//Position - 0xF8AB
{
	if (func_234(iParam0))
	{
		return 0;
...
void func_264()//Position - 0xF8E0
{
	func_285("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_265(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xF8FA
{
	int iVar0;
...
int func_266(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xF95F
{
	int iVar0;
	struct<7> Var1;
...
int func_267(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xF9DD
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_268(int iParam0, bool bParam1)//Position - 0xFA58
{
	char* sVar0;
	...
	if (*iParam0 == 32)
	{
		unk_0x379ACE23D404525C(Vector(35f, 3409f, 322f) - Vector(20f, 20f, 20f), Vector(35f, 3409f, 322f) + Vector(20f, 20f, 20f), true, 1);
	}
	else if (*iParam0 == 34)
	{
		unk_0x483687B0FCA5415A(iLocal_57, 0);
	}
	func_272(&(iParam0->f_30));
	if (iLocal_56 != -1)
	{
...
void func_269(char* sParam0)//Position - 0xFB45
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
		if (func_189(sParam0))
...
void func_270()//Position - 0xFB64
{
	Global_394A = 0;
	func_271();
}

void func_271()//Position - 0xFB74
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
int func_272(var uParam0)//Position - 0xFB95
{
	if (func_209(uParam0))
	{
		if (unk_0xF9E082857622D91E(*uParam0))
...
void func_273(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFBCB
{
...
void func_274(var uParam0, bool bParam1)//Position - 0xFBEB
{
	func_275(&(uParam0->f_29), bParam1);
}

void func_275(var uParam0, bool bParam1)//Position - 0xFBFD
{
	int iVar0;
...
void func_276(int iParam0, bool bParam1)//Position - 0xFC3B
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_277(var uParam0, bool bParam1)//Position - 0xFC76
{
	func_278(&(uParam0->f_23), bParam1);
}

void func_278(var uParam0, bool bParam1)//Position - 0xFC88
{
	int iVar0;
...
void func_279(int iParam0)//Position - 0xFCC5
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_280(var uParam0, int iParam1)//Position - 0xFCFD
{
	func_281(&(uParam0->f_1C), iParam1);
}

void func_281(var uParam0, int iParam1)//Position - 0xFD0F
{
	int iVar0;
...
void func_282(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xFD50
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_283(int iParam0)//Position - 0xFDA0
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_284(var uParam0)//Position - 0xFDE1
{
	if (*uParam0 == -1)
	{
		return;
...
void func_285(char* sParam0)//Position - 0xFE1E
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_286(var uParam0)//Position - 0xFE30
{
	*uParam0 = -1;
...
void func_287()//Position - 0xFE63
{
	func_285("Running start routines.");
	Global_199EA++;
}

int func_288(int iParam0)//Position - 0xFE7D
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
