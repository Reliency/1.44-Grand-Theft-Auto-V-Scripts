...
void func_3(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)//Position - 0x10B
{
	...
	iLocal_29[iParam0] = unk_0x37B86314BDCAA6F0(iParam1, func_4(iParam0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x9A9085F6BA00814E(iLocal_29[iParam0], 600000);
}
...
void func_7(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)//Position - 0x1E7
{
	...
	iLocal_27[iParam0] = unk_0x37B86314BDCAA6F0(iParam1, func_8(iParam0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x9A9085F6BA00814E(iLocal_27[iParam0], 600000);
}
...
void func_11(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4)//Position - 0x3FC
{
	...
	iLocal_24[iParam0] = unk_0x37B86314BDCAA6F0(iParam1, func_12(iParam0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x9A9085F6BA00814E(iLocal_24[iParam0], 600000);
}
...
void func_14()//Position - 0x5B9
{
	switch (Global_63AE)
	{
		...
		case 1:
			...
			{
				case 0:
					if (unk_0xA901403F1DB7A780(iLocal_20[Global_63B0]) && unk_0x0C1FBBAF5CF75B09(iLocal_20[Global_63B0]))
					{
						Global_63B1 = 0;
					}
					else
				...
				case 1:
					if (unk_0xA901403F1DB7A780(iLocal_22[Global_63B0]) && unk_0x0C1FBBAF5CF75B09(iLocal_22[Global_63B0]))
					{
						Global_63B1 = 0;
					}
					else
				...
				case 2:
					if (unk_0xA901403F1DB7A780(iLocal_23[Global_63B0]) && unk_0x0C1FBBAF5CF75B09(iLocal_23[Global_63B0]))
					{
						Global_63B1 = 0;
					}
					else
...
void func_16()//Position - 0x6E2
{
	...
	while (iVar0 < 1)
	{
		if (unk_0xA901403F1DB7A780(iLocal_29[iVar0]))
		{
			unk_0x9680DF46F29C0428(iLocal_29[iVar0]);
		}
		iVar0++;
	}
	iLocal_30 = 0;
...
void func_17()//Position - 0x719
{
	...
	while (iVar0 < 1)
	{
		if (unk_0xA901403F1DB7A780(iLocal_27[iVar0]))
		{
			unk_0x9680DF46F29C0428(iLocal_27[iVar0]);
		}
		iVar0++;
	}
	iLocal_28 = 0;
...
void func_18()//Position - 0x750
{
	...
	while (iVar0 < 9)
	{
		if (unk_0xA901403F1DB7A780(iLocal_24[iVar0]))
		{
			unk_0x9680DF46F29C0428(iLocal_24[iVar0]);
		}
		iVar0++;
	}
	iLocal_25 = 0;
...
void func_19()//Position - 0x788
{
	...
	while (iVar0 < 102)
	{
		if (unk_0xA901403F1DB7A780(iLocal_23[iVar0]))
		{
			unk_0x9680DF46F29C0428(iLocal_23[iVar0]);
		}
		iVar0++;
	}
}
...
void func_20()//Position - 0x7BA
{
	...
	while (iVar0 < 76)
	{
		if (unk_0xA901403F1DB7A780(iLocal_22[iVar0]))
		{
			unk_0x9680DF46F29C0428(iLocal_22[iVar0]);
		}
		iVar0++;
	}
}
...
void func_21()//Position - 0x7EC
{
	...
	while (iVar0 < 19)
	{
		if (unk_0xA901403F1DB7A780(iLocal_21[iVar0]))
		{
			unk_0x9680DF46F29C0428(iLocal_21[iVar0]);
		}
		iVar0++;
	}
}
...
void func_22()//Position - 0x81E
{
	...
	while (iVar0 < 45)
	{
		if (unk_0xA901403F1DB7A780(iLocal_20[iVar0]))
		{
			unk_0x9680DF46F29C0428(iLocal_20[iVar0]);
		}
		iVar0++;
	}
}
...
void func_26(int iParam0, int iParam1, vector3 vParam2, bool bParam3, bool bParam4, bool bParam5)//Position - 0xFF8
{
	...
	iLocal_23[iParam0] = unk_0x37B86314BDCAA6F0(iParam1, func_28(iParam0, 0), vParam2, iVar0, -1, 2, 1, 0);
	unk_0x9A9085F6BA00814E(iLocal_23[iParam0], 600000);
	if (bParam4)
	{
		unk_0xED487BB7EB176F2C(iLocal_23[iParam0], func_27(iParam0));
	}
}
...
void func_30(int iParam0, vector3 vParam1, bool bParam2, bool bParam3)//Position - 0x243A
{
	...
	iLocal_22[iParam0] = unk_0x37B86314BDCAA6F0(joaat("pickup_health_standard"), func_32(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
	unk_0x9A9085F6BA00814E(iLocal_22[iParam0], 600000);
	if (bParam3)
	{
		unk_0xED487BB7EB176F2C(iLocal_22[iParam0], func_31(iParam0));
	}
}
...
void func_34(int iParam0, vector3 vParam1, bool bParam2)//Position - 0x3435
{
	...
	iLocal_21[iParam0] = unk_0x37B86314BDCAA6F0(joaat("pickup_weapon_petrolcan"), func_35(iParam0), vParam1, iVar0, -1, 2, 1, 0);
	unk_0x9A9085F6BA00814E(iLocal_21[iParam0], 600000);
}
...
void func_37(int iParam0, vector3 vParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0x3935
{
	...
	iLocal_20[iParam0] = unk_0x37B86314BDCAA6F0(joaat("pickup_armour_standard"), func_39(iParam0, 0), vParam1, iVar0, -1, 2, 1, 0);
	unk_0x9A9085F6BA00814E(iLocal_20[iParam0], 600000);
	if (bParam3)
	{
		unk_0xED487BB7EB176F2C(iLocal_20[iParam0], func_38(iParam0));
	}
}
