...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0x724D816EA203A79E(Local_79.f_23[0]))
	{
		if (!unk_0x1D403DFADBC2DE3C(Local_79.f_23[0], 0))
		{
			unk_0xD38EB677CBE7440A(Local_79.f_23[0], 1, 0);
			func_454(&(Local_97.f_4), &(Local_79.f_23[0]));
			unk_0xB71D41C0310C93DE(Local_97.f_4, 1, 1);
			func_453(Local_97.f_4, 0);
		}
	}
	func_452(&iLocal_106, &(Local_79.f_29[0]));
	func_443();
	if (unk_0x724D816EA203A79E(Local_79.f_23[1]))
	{
		func_454(&(Local_117[6 /*7*/].f_4), &(Local_79.f_23[1]));
	}
	if (func_442())
	{
		iVar0 = func_441();
...
void func_1()//Position - 0x2FE
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			if (unk_0x0C265B3C448E6954(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, 1, 0))
			{
				iLocal_95 = 2;
			}
			else
...
int func_2()//Position - 0x3CF
{
	if (func_408(iLocal_114) && func_408(Local_97.f_4))
	{
		if (func_3())
		{
			if (unk_0x3E7A19282640095F(iLocal_114) && unk_0xAEA754DE0733E937(iLocal_114, Local_97.f_4))
			{
				bLocal_110 = true;
				return 1;
			}
		}
		else if (unk_0x27C9F6C1391327CF(iLocal_114, Local_97.f_4))
		{
			bLocal_110 = true;
			return 1;
		}
...
int func_3()//Position - 0x42B
{
	...
	iVar0 = unk_0x6F79ECA8C83E4357(iLocal_114);
...
int func_4()//Position - 0x467
{
	...
	if (unk_0x724D816EA203A79E(iLocal_114) && unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), iLocal_114, 0))
	{
		return 1;
	}
	else if (unk_0x5237AF95232D78C5(unk_0xBC25C936A095B5BA(), 0))
	{
		...
		if (func_408(iVar0))
		{
			...
			{
				bVar2 = false;
				if (unk_0x724D816EA203A79E(iLocal_114))
				{
					if (iLocal_102)
					{
						unk_0xBF86DE1BFE3AA5CF(iLocal_114);
						iLocal_102 = 0;
					}
					unk_0x1E7A09C1710FB071(&iLocal_114);
				}
				iLocal_120 = 0;
				while (iLocal_120 <= 7)
				{
					if (func_408(Local_117[iLocal_120 /*7*/].f_4) && unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), Local_117[iLocal_120 /*7*/].f_4, 0))
					{
						bVar2 = true;
				...
				unk_0x0E622862E5E566BB(iLocal_114);
				iLocal_102 = 1;
				unk_0xD38EB677CBE7440A(iLocal_114, 0, 0);
				iLocal_304 = 0;
				return 1;
			}
		}
...
void func_5(bool bParam0)//Position - 0x598
{
	...
	else
	{
		...
		while (iLocal_120 <= 7)
		{
			if (unk_0x724D816EA203A79E(Local_117[iLocal_120 /*7*/].f_4))
			{
				if (!func_9(unk_0xBC25C936A095B5BA(), Local_117[iLocal_120 /*7*/], 175f) && func_8(unk_0xBC25C936A095B5BA(), Local_117[iLocal_120 /*7*/].f_4, 1) > 175f)
				{
					func_6(&(Local_117[iLocal_120 /*7*/].f_4));
				}
			}
			else if (!Local_117[iLocal_120 /*7*/].f_6 && func_9(unk_0xBC25C936A095B5BA(), Local_117[iLocal_120 /*7*/], 100f))
			{
				Local_117[iLocal_120 /*7*/].f_4 = unk_0x61C05BF08A1E0EFE(joaat("towtruck"), Local_117[iLocal_120 /*7*/], Local_117[iLocal_120 /*7*/].f_3, 1, 1, 0);
				if (iLocal_120 == 6)
				{
					unk_0x914C5DE0B15B8B59(Local_117[iLocal_120 /*7*/].f_4, 39, 43);
				}
				else
				{
					unk_0x6012A6A4F2950585(Local_117[iLocal_120 /*7*/].f_4, 0);
				}
				unk_0xF0A40F19AAB79E88(Local_117[iLocal_120 /*7*/].f_4, 1084227584);
				unk_0xD38EB677CBE7440A(Local_117[iLocal_120 /*7*/].f_4, 0, 0);
				unk_0xA73D1278857991A2(Local_117[iLocal_120 /*7*/].f_4, 1);
			}
			iLocal_120++;
		}
	}
...
void func_17()//Position - 0x942
{
	if (!iLocal_298)
	{
		if (unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), Local_97.f_4, 0))
		{
			iLocal_298 = 1;
			bLocal_297 = false;
			iLocal_294 = 0;
		...
		else if (unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), Local_97.f_4, 1))
		{
			func_18();
		}
	}
	else
	{
		...
		{
			if (!bLocal_297 && unk_0xF7DDAAF0EFDAFA22(0, 75))
			{
				bLocal_297 = true;
			}
			switch (iLocal_294)
			{
				case 0:
					...
					{
						unk_0x522053D86D6E1C7A(sLocal_299);
						if (unk_0x284F2ACE6839D3C0("BARRY3C_IGNITION_FAIL", false, -1) && unk_0xF9E082857622D91E(sLocal_299))
						{
							if (unk_0x3187EF5798B5D209(Local_97.f_4, -1, 0) == unk_0xBC25C936A095B5BA())
							{
								iLocal_294 = 1;
							}
						}
				...
				case 2:
					unk_0xC5A6DFE2B8987B17(&uLocal_300);
					unk_0xE896C0AD02364F2A(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, 1500, 9, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
					unk_0x535008C596714F9E(uLocal_300);
					unk_0xA4E856A8CD53B8DF(unk_0xBC25C936A095B5BA());
					unk_0xA8E6405305C0D7DF(unk_0xBC25C936A095B5BA(), uLocal_300);
					unk_0x02DAF06EA4F08219(&uLocal_300);
					iLocal_291 = unk_0x105601648511CC64() + 2000;
					iLocal_294 = 3;
					break;
				...
				case 3:
					...
					{
						unk_0xF2C27FE5A8B98CB5(iLocal_296, "IGNITION_FAIL", Local_97.f_4, "BARRY_03_SOUNDSET", 0, 0);
						unk_0x8B34879B92B3B225(iLocal_296, "HOLD TIME", 1.5f);
						iLocal_291 = unk_0x105601648511CC64() + 2400;
						iLocal_294 = 4;
					}
					break;
				...
				case 7:
					if (unk_0x105601648511CC64() > iLocal_291 && !unk_0x74BCB6EDB1FFBFBA(unk_0xBC25C936A095B5BA(), 2))
					{
						unk_0xA4E856A8CD53B8DF(unk_0xBC25C936A095B5BA());
						unk_0x932E201A82D2EDB8(unk_0xBC25C936A095B5BA(), Local_97.f_4, 0);
						unk_0xDDCAA2E64649E083(unk_0xB5CEFD608600A09F(), true, 0);
					}
					break;
				}
	...
	switch (iLocal_95)
	{
		case 0:
			...
			if (func_408(iLocal_114))
			{
				...
				unk_0x0BBAABB52887CF8C(iLocal_96, true);
				if (bLocal_110)
				{
					func_12(7);
				}
				if ((!func_15() && iLocal_304) && !unk_0x8FCEEB789599BD9B(0, 74))
				{
					iLocal_301 = 0;
				}
				iLocal_95 = 1;
		...
		case 1:
			...
			else if (unk_0x0C265B3C448E6954(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, 0, 0) && !unk_0x2A348A3A98B80B13(Local_97.f_4))
			{
				vVar0 = { unk_0x541C2AEF053615BC(Local_97.f_4, 1) };
				if (vVar0.z < 6.7f)
				{
					iLocal_94 = 12;
					iLocal_95 = 0;
...
void func_29()//Position - 0x12F9
{
	...
	if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
	{
		if (func_32(Global_19B04.f_932.f_21B.f_10CD) != unk_0x6F79ECA8C83E4357(unk_0xBC25C936A095B5BA()))
		{
			...
			if (func_30(iVar0) && (!func_33(14) || Global_196EB))
			{
		...
		case 2:
			...
			if (func_4())
			{
				if (func_2())
				{
					...
					else if (unk_0x0C265B3C448E6954(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, 1, 0))
					{
						iLocal_94 = 6;
					}
					else
...
void func_43()//Position - 0x17B7
{
	...
	switch (iLocal_95)
	{
		...
		case 2:
			unk_0xEB233A3B7635D2AC();
			if (!unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), iLocal_114, 0))
			{
				iLocal_94 = 8;
			}
			else if (!unk_0x27C9F6C1391327CF(iLocal_114, Local_97.f_4))
...
{
	unk_0xBB5629E7D44054AE(vLocal_308[iParam0 /*3*/].f_2);
}
...
void func_45()//Position - 0x1871
{
	...
	switch (iLocal_95)
	{
		...
		case 1:
			if (unk_0x0C265B3C448E6954(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, 1, 0))
			{
				if (!func_242(unk_0xBC25C936A095B5BA(), Local_97.f_4, 150f, 1) && !func_15())
				{
					iLocal_95 = 2;
				}
...
void func_47(int iParam0, bool bParam1)//Position - 0x199D
{
	...
	{
		func_208(&(Global_19773[iVar0 /*10*/].f_9));
	}
	if (bParam1)
	{
		if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
...
void func_50()//Position - 0x1C07
{
	...
	{
		func_52(13, SYSTEM::FLOOR(Global_19B04.f_27B5.f_F0D));
	}
...
int func_54()//Position - 0x2639
{
	return Global_1407E0;
}

void func_55()//Position - 0x2645
{
	func_72();
	func_64();
	func_60();
...
void func_56(int iParam0)//Position - 0x269E
{
	if (iParam0 == 1)
	{
...
void func_58()//Position - 0x26E5
{
	StringCopy(&Global_1162A, "", 16);
	StringCopy(&Global_1162E, "", 16);
}

void func_59()//Position - 0x26FF
{
	int iVar0;
...
void func_63(int iParam0)//Position - 0x27D1
{
	if (iParam0 == 1)
	{
		Global_8E66 = 1;
...
{
	func_65(&Global_181DF);
}

void func_65(var uParam0)//Position - 0x27FA
{
	int iVar0;
	int iVar1;
...
void func_66(var uParam0)//Position - 0x2D8A
{
	*uParam0 = -1;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
void func_67(var uParam0)//Position - 0x2DA5
{
	func_68(&(uParam0->f_C));
	*uParam0 = { 0f, 0f, 0f };
...
void func_68(var uParam0)//Position - 0x2DD4
{
	int iVar0;
...
void func_69(var uParam0)//Position - 0x2E84
{
	*uParam0 = { 0f, 0f, 0f };
	uParam0->f_3 = 0f;
	uParam0->f_4 = 0;
...
void func_70(var uParam0)//Position - 0x2EA2
{
	int iVar0;
...
void func_71(var uParam0)//Position - 0x2F82
{
	*uParam0 = -15;
}

void func_72()//Position - 0x2F90
{
	StringCopy(&Global_1763E, "", 32);
	func_65(&Global_17646);
}

void func_73()//Position - 0x2FA9
{
...
int func_75(int iParam0, int iParam1, int iParam2)//Position - 0x30E7
{
	int iVar0;
	int iVar1;
	var uVar2;
	...
	Global_11489[1 /*14*/] = { func_126(iVar0, iParam1, iParam2) };
	...
	else
	{
		...
		Global_11489[1 /*14*/] = { func_126(iVar0, iParam1, uVar6[iParam1]) };
		if (unk_0x366048FAE8D7AE6C(iParam0, func_118(iParam1)) > 0 && unk_0x57C0F4ECF269EEB9(iParam0, func_118(iParam1), Global_11489[1 /*14*/].f_3) > 0)
		{
			unk_0xB0031DDAE4FF0BC3(iParam0, func_118(iParam1), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, 0);
		}
	}
...
int func_76(int iParam0, int iParam1, int iParam2)//Position - 0x32A4
{
	int iVar0;
	...
	{
		if (!func_190(iParam0, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_40, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_3F))
		{
...
int func_77(int iParam0)//Position - 0x3330
{
	switch (iParam0)
	{
...
int func_78(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0x336B
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iParam5 == 0)
	{
		Global_11489[1 /*14*/] = { func_126(iVar10, iParam1, iParam2) };
		if (!func_116(iParam3))
		{
	...
	if (iParam1 == 12)
	{
		...
		while (iVar0 <= 14)
		{
			if (uVar11[iVar0] != -99)
			{
				Global_11489[1 /*14*/] = { func_126(iVar10, iVar0, uVar11[iVar0]) };
				if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0))
				{
					if (iVar0 == 13)
					{
						...
						while (iVar1 <= 8)
						{
							Global_11489[1 /*14*/] = { func_126(iVar10, 14, uVar12[iVar1]) };
							func_94(iParam0, Global_11489[1 /*14*/].f_C, Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4);
							func_109(14);
							if (Global_11487 == 1)
							{
								iVar2 = 0;
					...
					else if (iVar0 != 14 && iVar0 != 12)
					{
						...
						if (iParam4 == -1)
						{
							unk_0xB0031DDAE4FF0BC3(iParam0, func_118(iVar0), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, unk_0x41AF5D2DF638D88F(iParam0, func_118(iVar0)));
						}
						else
						{
							unk_0xB0031DDAE4FF0BC3(iParam0, func_118(iVar0), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, iParam4);
						}
						func_109(iVar0);
						if (Global_11487 == 1)
						{
			...
			{
				Global_11489[1 /*14*/] = { func_126(iVar10, iVar0, func_84(iParam0, iVar0, -1)) };
	...
	else if (iParam1 == 13)
	{
		...
		while (iVar1 <= 8)
		{
			Global_11489[1 /*14*/] = { func_126(iVar10, 14, uVar15[iVar1]) };
			func_94(iParam0, Global_11489[1 /*14*/].f_C, Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4);
			func_109(14);
			if (Global_11487 == 1)
			{
	...
	else
	{
		if (iParam4 == -1)
		{
			unk_0xB0031DDAE4FF0BC3(iParam0, func_118(iParam1), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, unk_0x41AF5D2DF638D88F(iParam0, func_118(iParam1)));
		}
		else
		{
			unk_0xB0031DDAE4FF0BC3(iParam0, func_118(iParam1), Global_11489[1 /*14*/].f_3, Global_11489[1 /*14*/].f_4, iParam4);
		}
		if (Global_11487 == 1)
		{
			iVar2 = 0;
...
void func_79(int iParam0, int iParam1, int iParam2)//Position - 0x3B77
{
	int iVar0;
	int iVar1;
...
int func_80(int iParam0, int iParam1, int iParam2)//Position - 0x3C01
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 4)
...
bool func_81(int iParam0, int iParam1, int iParam2)//Position - 0x3CDF
{
	Global_11489[1 /*14*/] = { func_126(iParam0, iParam1, iParam2) };
	return unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 2);
}

int func_82(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4, var uParam5)//Position - 0x3D09
{
	var uVar0;
	int iVar1;
...
int func_83(int iParam0, int iParam1, int iParam2)//Position - 0x430E
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_84(int iParam0, int iParam1, int iParam2)//Position - 0x43A7
{
	int iVar0;
	int iVar1;
...
int func_85(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x4448
{
	int iVar0;
...
int func_86(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x474F
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_87(int iParam0, int iParam1, int iParam2, int iParam3, var uParam4)//Position - 0x5302
{
	int iVar0;
...
int func_88(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x55E6
{
	int iVar0;
...
int func_89(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x58AD
{
	int iVar0;
	int iVar1;
...
int func_90(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x58E4
{
	int iVar0;
...
int func_91(int iParam0, int iParam1, int iParam2)//Position - 0x590D
{
	*iParam2 = -99;
	switch (iParam0)
	{
...
int func_92(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5BD7
{
	int iVar0;
...
int func_93(int iParam0, int iParam1, int iParam2)//Position - 0x5E61
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
void func_94(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x5FB8
{
	int iVar0;
...
int func_95(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6050
{
	switch (iParam0)
	{
...
int func_96(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x611E
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar9 = unk_0x84E17E2A0638D182(iParam3, 6, -1, 0, -1, func_118(iParam2));
		iVar6 = 0;
		while (iVar6 < iVar9)
		{
...
int func_97(int iParam0, int iParam1)//Position - 0x627A
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_98(int iParam0)//Position - 0x6621
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_99(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6682
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_100(int iParam0, int iParam1)//Position - 0x677E
{
	int iVar0;
...
int func_101(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x68BC
{
	struct<2> Var0;
	int iVar1;
	int iVar2;
	...
	else
	{
		...
		iVar6 = 0;
		iVar7 = unk_0x84E17E2A0638D182(iParam3, 6, -1, 0, -1, func_118(iParam2));
		iVar5 = 0;
		while (iVar5 < iVar7)
		{
...
int func_102(int iParam0)//Position - 0x699C
{
	switch (iParam0)
	{
		case 0:
...
int func_103(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6A22
{
	switch (iParam0)
	{
		case joaat("player_zero"):
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 1) || unk_0xF062C4E30590463E(func_96(iParam0, iParam2, 14, 3), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 0) || unk_0xF062C4E30590463E(func_96(iParam0, iParam2, 1, 3), -1842686353, 0));
					}
					break;
			}
			break;
			...
			switch (iParam1)
			{
				case 14:
					...
					else if (iParam2 >= 327)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 1) || unk_0xF062C4E30590463E(func_96(iParam0, iParam2, 14, 4), -1842686353, 1));
					}
					break;
				...
				case 1:
					if (iParam2 >= 26)
					{
						...
						return (unk_0xF062C4E30590463E(iParam3, -1757550583, 0) || unk_0xF062C4E30590463E(func_96(iParam0, iParam2, 1, 4), -1842686353, 0));
					}
					break;
			}
			break;
...
int func_104(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x6C9F
{
	if (iParam0 == joaat("player_zero"))
	{
		if (iParam1 == 6)
...
int func_105(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x70C4
{
	switch (iParam0)
	{
		case joaat("player_zero"):
...
int func_106(int iParam0, int iParam1)//Position - 0x73B7
{
	int iVar0;
	int iVar1;
...
int func_107(int iParam0, int iParam1)//Position - 0x73FD
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_108(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x745D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_109(int iParam0)//Position - 0x74E1
{
	if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 1) && !unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 6))
	{
		func_115(iParam0, Global_11489[1 /*14*/].f_5, Global_11489[1 /*14*/].f_2, 2, Global_11489[1 /*14*/].f_1, 1, 0);
	}
	if (unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 1) && unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 6))
	{
		if (iParam0 == 12)
...
void func_110(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0x7599
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_111(int iParam0, int iParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x75E3
{
	int iVar0;
	...
	iVar0 = Global_269BC5[iParam0 /*3*/][func_112(iParam2)];
	if (iVar0 != 0)
	{
...
int func_112(var uParam0)//Position - 0x7613
{
	int iVar0;
	int iVar1;
...
int func_113(int iParam0, int iParam1, int iParam2)//Position - 0x7647
{
	int iVar0;
	var uVar1;
	...
	iVar0 = Global_269BC5[iParam0 /*3*/][func_112(iParam1)];
...
bool func_114(int iParam0, int iParam1, var uParam2, var uParam3, bool bParam4, bool bParam5)//Position - 0x7679
{
	int iVar0;
...
int func_115(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x9316
{
	if (iParam0 == 0)
	{
		if (iParam5 == 1)
...
int func_116(int iParam0)//Position - 0xA234
{
	if (!unk_0xFA30DFD0084E92FE(Global_11489[1 /*14*/].f_6, 0))
	{
		return 0;
...
int func_117(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xA285
{
	int iVar0;
	...
	{
		if (!func_190(iParam0, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_3D, Global_19B04.f_932.f_21B[iVar0 /*65*/].f_3C) || iParam3 == 1)
		{
...
int func_118(int iParam0)//Position - 0xA31B
{
	switch (iParam0)
	{
		case 0:
...
struct<10> func_119(int iParam0, int iParam1)//Position - 0xA3CB
{
	int iVar0;
	struct<10> Var1;
...
void func_120(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0xACFA
{
	int iVar0;
	struct<4> Var1;
	vector3 vVar2;
...
void func_121(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9)//Position - 0xAE24
{
	(*iParam0)[0] = iParam1;
	(*iParam0)[1] = iParam2;
	(*iParam0)[2] = iParam3;
...
struct<17> func_122(int iParam0, int iParam1)//Position - 0xAE6C
{
	int iVar0;
	struct<17> Var1;
	...
	switch (iParam0)
	{
		case joaat("player_zero"):
			switch (iParam1)
			{
				...
				case 5:
					func_125(&Var1, -99, -99, Global_19B04.f_932.f_21B.f_C4[0], Global_19B04.f_932.f_21B.f_C8[0], 6, 3, 0, 0, 0, -99, 0, 0, 3);
					break;
		...
		case joaat("player_one"):
			switch (iParam1)
			{
				...
				case 2:
					func_125(&Var1, -99, -99, Global_19B04.f_932.f_21B.f_C4[1], Global_19B04.f_932.f_21B.f_C8[1], 17, 2, 26, 0, 0, -99, 0, 45, 31);
					break;
		...
		case joaat("player_two"):
			switch (iParam1)
			{
				...
				case 4:
					func_125(&Var1, -99, -99, Global_19B04.f_932.f_21B.f_C4[2], Global_19B04.f_932.f_21B.f_C8[2], 8, 0, 0, 0, 0, -99, 0, 0, 31);
					break;
...
void func_123(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0xCCB5
{
	int iVar0;
	struct<5> Var1;
	vector3 vVar2;
...
int func_124(int iParam0)//Position - 0xCE9F
{
	switch (iParam0)
	{
		case 0:
...
void func_125(var uParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, int iParam9, int iParam10, int iParam11, int iParam12, int iParam13)//Position - 0xCF4F
{
	(*uParam0)[0] = iParam1;
	(*uParam0)[2] = iParam2;
	(*uParam0)[3] = iParam3;
...
struct<14> func_126(int iParam0, int iParam1, int iParam2)//Position - 0xCFC0
{
	func_189();
	if (iParam0 == joaat("player_zero"))
	{
...
void func_127(int iParam0, int iParam1)//Position - 0xD012
{
	switch (iParam0)
	{
		case 0:
...
void func_128(int iParam0)//Position - 0xD102
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
	...
	func_129(&(Global_11489[0 /*14*/]), iVar7, iParam0, &Var2, iVar3, iVar4, iVar1, bVar0, iVar5, iVar6, 0);
}

void func_129(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7, int iParam8, int iParam9, bool bParam10)//Position - 0xE378
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = iParam9;
	...
	else
	{
		...
		if ((((((((((iParam1 == 11 || iParam1 == 4) || iParam1 == 6) || iParam1 == 1) || iParam1 == 14) || iParam1 == 2) || iParam1 == 8) || iParam1 == 9) || iParam1 == 10) || iParam1 == 7) || iParam1 == 12)
		{
			...
			iVar0 = func_113(func_132(iParam1, uParam0->f_2), Global_11486, 0);
			if (unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
			{
				unk_0xF0059F27F7BB6680(&(uParam0->f_6), 1);
			}
			iVar0 = func_113(func_131(iParam1, uParam0->f_2), Global_11486, 0);
			if (unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
			{
				unk_0xF0059F27F7BB6680(&(uParam0->f_6), 2);
			}
			...
			{
				iVar0 = func_113(iVar1, Global_11486, 0);
				if (!unk_0xFA30DFD0084E92FE(iVar0, uParam0->f_1))
				{
					unk_0xF0059F27F7BB6680(&(uParam0->f_6), 4);
				}
...
bool func_130(int iParam0, int iParam1, var uParam2)//Position - 0xE709
{
	*uParam2 = 978;
	switch (iParam1)
	{
...
int func_131(int iParam0, int iParam1)//Position - 0xEB0E
{
	switch (iParam1)
	{
		case 0:
...
int func_132(int iParam0, int iParam1)//Position - 0xEF09
{
	switch (iParam1)
	{
		case 0:
...
int func_133(int iParam0, int iParam1, bool bParam2, bool bParam3, int iParam4)//Position - 0xF304
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_134(int iParam0)//Position - 0xF346
{
	switch (iParam0)
	{
		case -1:
...
void func_135(int iParam0, int iParam1, int iParam2)//Position - 0xF41A
{
	int iVar0;
	int iVar1;
	struct<8> Var2;
		...
		while (iVar3 < iVar5)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var2))
			{
				if (iVar4 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var2;
					func_129(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var2.f_7), 0, 0, Var2.f_2, 0, -1, 2, 1);
					return;
				}
				iVar4++;
			}
	...
	{
		func_129(&(Global_11489[0 /*14*/]), iParam0, iParam1, "NO_LABEL", 0, 0, 0, 1, -1, 2, 1);
	}
	else if (iParam0 == 14)
	{
		...
		while (iVar8 < iVar10)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var6))
			{
				if (iVar9 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var6;
					func_129(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var6.f_9), Var6.f_3, Var6.f_4, Var6.f_5, unk_0xF062C4E30590463E(Var6.f_1, -2050632586, 0), iVar7, 2, Var6.f_1 != 0);
					return;
				}
				iVar9++;
			}
	...
	else
	{
		...
		iVar13 = 0;
		iVar14 = unk_0x84E17E2A0638D182(iVar1, 6, -1, 0, -1, func_118(iParam0));
		iVar12 = 0;
		while (iVar12 < iVar14)
		{
			...
			if (!unk_0xD90F58A58682ED2F(Var11))
			{
				if (iVar13 == (iParam1 - iParam2))
				{
					...
					Global_280005 = Var11;
					func_129(&(Global_11489[0 /*14*/]), iParam0, iParam1, &(Var11.f_9), Var11.f_3, Var11.f_4, Var11.f_5, unk_0xF062C4E30590463E(Var11.f_1, -2050632586, 0), -1, 2, Var11.f_1 != 0);
					return;
				}
				iVar13++;
			}
...
void func_136(int iParam0)//Position - 0xF695
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_137(int iParam0)//Position - 0xF7EB
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_138(int iParam0)//Position - 0xFCF8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_139(int iParam0)//Position - 0xFD6C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_140(int iParam0)//Position - 0xFDDF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_141(int iParam0)//Position - 0xFEC5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_142(int iParam0)//Position - 0x10228
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_143(int iParam0)//Position - 0x10438
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_144(int iParam0)//Position - 0x10667
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_145(int iParam0)//Position - 0x10776
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_146(int iParam0)//Position - 0x11114
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_147(int iParam0)//Position - 0x11C86
{
	if (iParam0 < 136)
	{
		func_149(iParam0);
...
void func_148(int iParam0)//Position - 0x11CBA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_149(int iParam0)//Position - 0x128BE
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_150(int iParam0)//Position - 0x137CC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_151(int iParam0)//Position - 0x138F8
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_152(int iParam0, int iParam1)//Position - 0x139F5
{
	switch (iParam0)
	{
		case 0:
...
void func_153(int iParam0)//Position - 0x13AE5
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_154(int iParam0)//Position - 0x14FD6
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_155(int iParam0)//Position - 0x15126
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_156(int iParam0)//Position - 0x15630
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_157(int iParam0)//Position - 0x15C9D
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_158(int iParam0)//Position - 0x15D10
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_159(int iParam0)//Position - 0x15DDF
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_160(int iParam0)//Position - 0x1630E
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_161(int iParam0)//Position - 0x164A4
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_162(int iParam0)//Position - 0x16CA1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_163(int iParam0)//Position - 0x16DB0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_164(int iParam0)//Position - 0x17CDA
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_165(int iParam0)//Position - 0x18997
{
	if (iParam0 < 107)
	{
		func_168(iParam0);
...
void func_166(int iParam0)//Position - 0x189DC
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_167(int iParam0)//Position - 0x19481
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_168(int iParam0)//Position - 0x1A270
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_169(int iParam0)//Position - 0x1AEB9
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_170(int iParam0)//Position - 0x1B131
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_171(int iParam0, int iParam1)//Position - 0x1B276
{
	switch (iParam0)
	{
		case 0:
...
void func_172(int iParam0)//Position - 0x1B366
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_173(int iParam0)//Position - 0x1C0F1
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_174(int iParam0)//Position - 0x1C26A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_175(int iParam0)//Position - 0x1C7E0
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_176(int iParam0)//Position - 0x1CD09
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_177(int iParam0)//Position - 0x1CD7C
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_178(int iParam0)//Position - 0x1CE4B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_179(int iParam0)//Position - 0x1D322
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_180(int iParam0)//Position - 0x1D58A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_181(int iParam0)//Position - 0x1D85F
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_182(int iParam0)//Position - 0x1DA27
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_183(int iParam0)//Position - 0x1E57A
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_184(int iParam0)//Position - 0x1F1C3
{
	if (iParam0 < 60)
	{
		func_186(iParam0);
...
void func_185(int iParam0)//Position - 0x1F1F7
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_186(int iParam0)//Position - 0x1FF97
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_187(int iParam0)//Position - 0x20665
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_188(int iParam0)//Position - 0x2074B
{
	bool bVar0;
	int iVar1;
	struct<2> Var2;
...
void func_189()//Position - 0x20848
{
...
int func_190(int iParam0, int iParam1, int iParam2)//Position - 0x208C1
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if ((uVar5[iVar2] != -99 && iVar2 != 12) && iVar2 != 14)
			{
				if (!func_190(iParam0, iVar2, uVar5[iVar2]))
				{
					if (iVar2 == 13)
					{
						...
						while (iVar3 <= 8)
						{
							if (!func_190(iParam0, 14, uVar6[iVar3]))
							{
								...
								while (iVar4 <= 19)
								{
									Global_11489[2 /*14*/] = { func_126(iVar0, 14, iVar4) };
									if (Global_11489[2 /*14*/].f_C == iVar3)
									{
										if (func_190(iParam0, 14, iVar4))
										{
											if (!func_82(iVar0, iParam2, 14, iVar4, &uVar5, &(Global_11489[2 /*14*/])))
											{
												return 0;
											}
										}
					...
					else
					{
						...
						Global_11489[2 /*14*/] = { func_126(iVar0, iVar2, iVar1) };
						if (!func_82(iVar0, iParam2, iVar2, iVar1, &uVar5, &(Global_11489[2 /*14*/])))
						{
							return 0;
						}
					}
	...
	else if (Global_11489[1 /*14*/].f_3 == unk_0xA86A4D206EC8EB16(iParam0, func_118(iParam1)) && Global_11489[1 /*14*/].f_4 == unk_0x695D13ECF7DAEC22(iParam0, func_118(iParam1)))
	{
		return 1;
	}
	return 0;
...
void func_191(char* sParam0, int iParam1)//Position - 0x20B19
{
...
struct<2> func_193(int iParam0)//Position - 0x20BB9
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_194(int iParam0)//Position - 0x20BF0
{
	struct<2> Var0;
...
void func_195(int iParam0, int iParam1)//Position - 0x2103C
{
...
void func_196(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x21086
{
...
void func_197(int iParam0, int iParam1, int iParam2)//Position - 0x21123
{
	struct<4> Var0;
	char* sVar1;
	...
	if (iParam0 != -1)
	{
		...
		func_198(&sVar1, Var0.f_3, Global_16B40, iParam1, iParam2);
	}
}

void func_198(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4)//Position - 0x21162
{
...
void func_199(int iParam0, var uParam1)//Position - 0x211A6
{
	switch (iParam0)
	{
		case 0:
...
int func_201(int iParam0)//Position - 0x223EC
{
	switch (iParam0)
	{
		case 0:
...
void func_202(int iParam0)//Position - 0x22732
{
	Global_8E68 = (unk_0x105601648511CC64() + iParam0);
}

void func_203()//Position - 0x22744
{
	if (Global_1612C)
	{
		func_29();
		unk_0xCA61267ED7652063(func_204(Global_19B04.f_932.f_21B.f_10CD));
	}
	else
	{
...
char* func_204(var uParam0)//Position - 0x22776
{
	uParam0 = uParam0;
	return "";
}

void func_205()//Position - 0x22785
{
	vector3 vVar0[24];
...
void func_206(int iParam0, int iParam1)//Position - 0x227C8
{
	Global_16127 = iParam0;
	Global_16128 = iParam1;
}

void func_207()//Position - 0x227DC
{
	if (Global_11640 != 6)
	{
	}
...
void func_208(var uParam0)//Position - 0x22814
{
	if (*uParam0 == -1)
	{
		return;
...
void func_209(int iParam0, bool bParam1)//Position - 0x22851
{
	struct<26> Var0;
	int iVar1;
	bool bVar2;
...
int func_210(int iParam0)//Position - 0x229D7
{
	switch (iParam0)
	{
		case 0:
...
void func_211(int iParam0)//Position - 0x22D5E
{
	func_213(iParam0, 1);
	Global_19B04.f_4871[iParam0 /*6*/].f_3 = func_212();
	Global_19B04.f_4871.f_17C++;
}

int func_212()//Position - 0x22D94
{
	return (Global_19B04.f_2703.f_15 + Global_19B04.f_4871.f_17C);
}

void func_213(var uParam0, bool bParam1)//Position - 0x22DB0
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_214(int iParam0)//Position - 0x230D4
{
...
void func_215(int iParam0)//Position - 0x23107
{
	switch (iParam0)
	{
		case 30:
...
void func_216(int iParam0, bool bParam1)//Position - 0x2313C
{
	if (iParam0 == -1)
	{
		return;
...
void func_217(int iParam0, int iParam1, bool bParam2)//Position - 0x23199
{
	if (iParam0 == -1)
	{
		return;
...
bool func_218(int iParam0, int iParam1)//Position - 0x231D4
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_219(int iParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x231F7
{
	if (iParam0 != 198)
	{
		if (Global_11542)
...
void func_220(int iParam0, int iParam1)//Position - 0x23252
{
	switch (iParam0)
	{
		case 12:
...
void func_221(int iParam0, bool bParam1)//Position - 0x2333B
{
	if (bParam1)
	{
...
bool func_222(int iParam0, bool bParam1, int iParam2, bool bParam3)//Position - 0x23364
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
int func_224()//Position - 0x23CE6
{
	return Global_62BE;
}

int func_225(var uParam0, int iParam1)//Position - 0x23CF1
{
	int iVar0;
...
int func_226(int iParam0)//Position - 0x276D7
{
	switch (iParam0)
	{
		case 46:
...
void func_227(int iParam0, bool bParam1)//Position - 0x277C9
{
	switch (iParam0)
	{
		case 46:
...
void func_228(int iParam0, bool bParam1)//Position - 0x2781A
{
	int iVar0;
...
void func_229(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x27880
{
	func_230(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_230(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x278A1
{
	int iVar0;
...
int func_232(int iParam0)//Position - 0x27B94
{
	int iVar0;
	int iVar1;
...
int func_235(int iParam0)//Position - 0x27DCE
{
...
void func_236(int iParam0, int iParam1)//Position - 0x27DFB
{
...
int func_237(char* sParam0)//Position - 0x27E38
{
	int iVar0;
...
int func_238()//Position - 0x27E98
{
	return func_239(unk_0x1377080E9B0BD993(), 0);
}

int func_239(char* sParam0, int iParam1)//Position - 0x27EA9
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_240(int iParam0)//Position - 0x27EF2
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_241(bool bParam0)//Position - 0x27F1D
{
	if (bParam0)
	{
		unk_0xD38EB677CBE7440A(Local_97.f_4, 0, 0);
		unk_0x6FA721E3E050370C(Local_97.f_4, 1);
	}
	else
	{
		unk_0xD38EB677CBE7440A(Local_97.f_4, 1, 0);
		unk_0x6FA721E3E050370C(Local_97.f_4, 0);
	}
}

bool func_242(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0x27F55
{
	return SYSTEM::VDIST2(unk_0x541C2AEF053615BC(iParam0, iParam3), unk_0x541C2AEF053615BC(iParam1, iParam3)) <= (fParam2 * fParam2);
}

void func_243()//Position - 0x27F77
{
	if (unk_0x105601648511CC64() > iLocal_292)
	{
...
void func_244(int iParam0, char* sParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x27FB7
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (iVar0 == 1)
	{
		...
		{
			iVar4 = func_239(unk_0x1377080E9B0BD993(), 1);
			if (iVar4 != -1)
			{
			...
			{
				iVar6 = func_313(&(Global_16B1B.f_3));
				if (iVar6 > -1)
				{
...
void func_245(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2812F
{
	func_246(&Global_181DF, unk_0x1377080E9B0BD993(), iParam0, uParam1, iParam3, iParam2);
}

void func_246(var uParam0, char* sParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x2814B
{
	int iVar0;
	int iVar1;
	...
	*uParam0 = func_28();
	...
	while (iVar1 < 3)
	{
		...
		if (iVar1 == func_268())
		{
			func_264(unk_0xBC25C936A095B5BA(), &(uParam0->f_268[iVar1 /*65*/]), 1);
		}
		else
		{
			iVar0 = 0;
...
int func_247(var uParam0)//Position - 0x28FD3
{
...
void func_248(var uParam0, var uParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x28FF5
{
	int iVar0;
...
int func_249(var uParam0, var uParam1, int iParam2, int iParam3)//Position - 0x2907D
{
...
int func_250(int iParam0)//Position - 0x290BD
{
	int iVar0;
...
void func_251(var uParam0, int iParam1, int iParam2)//Position - 0x290EB
{
...
int func_252(int iParam0)//Position - 0x291C7
{
	int iVar0;
...
int func_253(int iParam0)//Position - 0x29209
{
	int iVar0;
...
int func_254(int iParam0, int iParam1, int iParam2)//Position - 0x2926C
{
	int iVar0;
...
int func_255(int iParam0, int iParam1)//Position - 0x292FA
{
	struct<82> Var0;
...
void func_256(int iParam0, var uParam1, int iParam2)//Position - 0x2933C
{
	int iVar0;
...
void func_257(int iParam0, var uParam1)//Position - 0x29598
{
	int iVar0;
	...
	if (unk_0xE59B7F5A03335350(iParam0, 0))
	{
		...
		*uParam1 = unk_0x89FC8F09D6647DEC(iParam0);
		...
		if (uParam1->f_41 == -1 && !func_260(uParam1->f_42))
		{
			uParam1->f_41 = 0;
		}
		...
		while (iVar0 <= 11)
		{
			...
			{
				unk_0xF0059F27F7BB6680(&(uParam1->f_4D), func_258(iVar0 + 1));
			}
			iVar0++;
		}
...
int func_258(int iParam0)//Position - 0x29843
{
	switch (iParam0)
	{
		case 1:
...
int func_259(int iParam0, var uParam1, var uParam2)//Position - 0x298F3
{
	int iVar0;
	int iVar1;
...
int func_260(int iParam0)//Position - 0x299CD
{
	switch (iParam0)
	{
		case joaat("granger"):
...
int func_261(int iParam0, var uParam1, int iParam2, int iParam3)//Position - 0x299ED
{
	char* sVar0;
...
int func_262(int iParam0, int iParam1, bool bParam2)//Position - 0x29B1C
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_263(int iParam0, int iParam1, char* sParam2, var uParam3)//Position - 0x29B8D
{
...
void func_264(int iParam0, var uParam1, int iParam2)//Position - 0x29C65
{
	int iVar0;
	int iVar1;
	...
	if (!unk_0x36CEFBE9B745A58D(iParam0))
	{
		...
		else if (unk_0x7AF0088ABFA713B6() && unk_0x6F79ECA8C83E4357(iParam0) == unk_0x6F79ECA8C83E4357(unk_0xBC25C936A095B5BA()))
		{
			if (func_265(161, -1))
			{
				uParam1->f_3B = func_113(2051, Global_11486, 0);
			}
			else
			{
				uParam1->f_3B = func_113(752, Global_11486, 0);
			}
			uParam1->f_3C = func_113(753, Global_11486, 0);
			uParam1->f_3D = func_113(754, Global_11486, 0);
		}
...
int func_265(int iParam0, int iParam1)//Position - 0x29E0F
{
	var uVar0;
	var uVar1;
	
	uVar0 = Global_2705A2[iParam0 /*3*/][func_112(iParam1)];
...
void func_266(int iParam0, int iParam1, var uParam2, var uParam3, int iParam4, int iParam5)//Position - 0x29E3B
{
	int iVar0;
...
void func_267(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, int iParam5, int iParam6)//Position - 0x2A383
{
	int iVar0;
...
int func_268()//Position - 0x2A5C4
{
	func_29();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_269(int iParam0, bool bParam1)//Position - 0x2A5DD
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (func_30(iVar0) && !unk_0x36CEFBE9B745A58D(iParam0))
	{
		if (iParam0 == unk_0xBC25C936A095B5BA())
		{
			func_270(iParam0, &(Global_19B04.f_932.f_21B.f_12A[iVar0 /*472*/]));
			iVar2 = 0;
			while (iVar2 <= (8 - 1))
			{
...
void func_270(int iParam0, var uParam1)//Position - 0x2A6D0
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	if (!unk_0x36CEFBE9B745A58D(iParam0))
	{
		...
		while (iVar0 <= (44 - 1))
		{
			...
			if (iVar3 != 0)
			{
				Var4 = unk_0xFEBBB8B5E3A12A20(iParam0, func_275(iVar0));
				Var4.f_1 = 0;
				Var4.f_2 = 0;
				Var4.f_3 = 0;
				Var4.f_4 = 0;
		...
		while (iVar5 < iVar6)
		{
			if ((unk_0x6740839132C4BD08(iVar5, &Var7) && !func_272(Var7.f_1)) && iVar9 < 50)
			{
...
int func_271(int iParam0)//Position - 0x2A95A
{
	switch (iParam0)
	{
		case -1258515792:
...
int func_272(int iParam0)//Position - 0x2A9F5
{
...
int func_273(int iParam0, int iParam1)//Position - 0x2AB69
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_274(int iParam0, var uParam1)//Position - 0x2B6DA
{
	int iVar0;
	int iVar1;
...
int func_275(int iParam0)//Position - 0x2B715
{
	int iVar0;
...
void func_276(int iParam0)//Position - 0x2B989
{
	int iVar0;
...
void func_277(var uParam0, int iParam1)//Position - 0x2B9C5
{
	int iVar0;
	vector3 vVar1;
	var uVar2;
...
int func_278(vector3 vParam0, char* sParam1, vector3 vParam2)//Position - 0x2BF20
{
	int iVar0;
	int iVar1;
...
bool func_279(int iParam0, var uParam1, var uParam2)//Position - 0x2BF64
{
	*uParam1 = { 0f, 0f, 0f };
	*uParam2 = 0f;
	switch (iParam0)
...
bool func_280(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x2C6B9
{
	if (bParam2)
	{
...
int func_281(var uParam0)//Position - 0x2C700
{
...
bool func_282(int iParam0)//Position - 0x2C75B
{
	return func_283(iParam0, 0, 1);
}

int func_283(int iParam0, int iParam1, bool bParam2)//Position - 0x2C76B
{
	if (bParam2)
	{
...
int func_284(int iParam0)//Position - 0x2C7CB
{
	switch (iParam0)
	{
		case 0:
...
int func_285(int iParam0)//Position - 0x2CABF
{
	return func_283(iParam0, 5, 1);
}

int func_286(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x2CACF
{
	int iVar0;
	float fVar1;
	float fVar2;
	...
	while (iVar0 <= 48)
	{
		if (iParam1 == 6 || iParam1 == func_300(iVar0))
		{
			...
			{
				fVar1 = unk_0xF0F2FC9DE291567F(vParam0, func_287(iVar0, 0), true);
...
Vector3 func_287(int iParam0, bool bParam1)//Position - 0x2CB71
{
	switch (iParam0)
	{
		case -1:
		...
		case 45:
			return func_298(Global_1732A);
			break;
		
		case 46:
			if (Global_183F8F != func_297())
			{
				if (func_296(Global_183F8F))
				{
					return func_289(2, 2);
				}
				else if (func_288(Global_183F8F))
				{
...
int func_288(int iParam0)//Position - 0x2D12B
{
	if (iParam0 != func_297())
	{
...
Vector3 func_289(int iParam0, int iParam1)//Position - 0x2D189
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_290(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x2D237
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_291(vector3 vParam0, float fParam1)//Position - 0x2D2CC
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_292(int iParam0)//Position - 0x2D310
{
	struct<6> Var0;
...
struct<6> func_293(int iParam0)//Position - 0x2D494
{
	return func_294(iParam0);
}

struct<6> func_294(int iParam0)//Position - 0x2D4A2
{
	struct<6> Var0;
...
int func_295(int iParam0, var uParam1)//Position - 0x2DF69
{
	switch (iParam0)
	{
		case 0:
...
int func_296(int iParam0)//Position - 0x2DFEB
{
	if (iParam0 != func_297())
	{
...
int func_297()//Position - 0x2E049
{
	return -1;
}

Vector3 func_298(int iParam0)//Position - 0x2E052
{
	switch (iParam0)
	{
		case 1:
...
int func_299(int iParam0)//Position - 0x2E225
{
	return func_283(iParam0, 0, 0);
}

int func_300(int iParam0)//Position - 0x2E235
{
	switch (iParam0)
	{
		case -1:
...
bool func_301()//Position - 0x2E4CF
{
	return Global_16B4F.f_141 > 0;
}

var func_302()//Position - 0x2E4E0
{
	var uVar0;
...
void func_303(var uParam0, int iParam1)//Position - 0x2E526
{
	if (iParam1 <= 0)
	{
		return;
...
void func_304(var uParam0, int iParam1)//Position - 0x2E5AC
{
...
void func_305(var uParam0, int iParam1)//Position - 0x2E5DF
{
	int iVar0;
	int iVar1;
...
int func_306(int iParam0, int iParam1)//Position - 0x2E630
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_307(int iParam0)//Position - 0x2E6D2
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_308(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_308(bool bParam0, int iParam1, int iParam2)//Position - 0x2E6F7
{
	if (bParam0)
	{
		return iParam1;
...
int func_309(var uParam0)//Position - 0x2E70E
{
	return uParam0 & 15;
}

void func_310(var uParam0, int iParam1)//Position - 0x2E71B
{
...
void func_311(var uParam0, int iParam1)//Position - 0x2E755
{
...
void func_312(var uParam0, int iParam1)//Position - 0x2E790
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_313(char* sParam0)//Position - 0x2E7CC
{
...
int func_314(int iParam0)//Position - 0x2E822
{
	switch (iParam0)
	{
		case 69:
		case 70:
			return func_315(Global_19B04.f_2360.f_63.f_CD[10]);
			break;
		
		case 74:
		case 75:
			return func_315(Global_19B04.f_2360.f_63.f_CD[8]);
			break;
		
		case 84:
		case 85:
			return func_315(Global_19B04.f_2360.f_63.f_CD[11]);
			break;
		
		case 90:
			return func_315(Global_19B04.f_2360.f_63.f_CD[7]);
			break;
		
		case 93:
			return func_315(Global_19B04.f_2360.f_63.f_CD[9]);
			break;
	}
	return 0;
}

int func_315(int iParam0)//Position - 0x2E8DE
{
	switch (iParam0)
	{
		case 1:
...
int func_316(char* sParam0, bool bParam1)//Position - 0x2E932
{
	int iVar0;
	int iVar1;
...
int func_317(int iParam0, bool bParam1)//Position - 0x2E95C
{
	int iVar0;
...
void func_318(bool bParam0)//Position - 0x2E992
{
	int iVar0;
	int iVar1;
...
bool func_319(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, int iParam7, bool bParam8)//Position - 0x2EC14
{
...
void func_320()//Position - 0x2EC73
{
	func_17();
	switch (iLocal_95)
	{
		...
		case 1:
			...
			else if (!unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), iLocal_114, 0))
			{
				iLocal_95 = 2;
			}
			else if (func_2())
			{
				if (unk_0x0C265B3C448E6954(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, 1, 0))
				{
					...
					if (!iLocal_290)
					{
						if ((unk_0x105601648511CC64() - iLocal_293) > 1000)
						{
				...
				else if (!unk_0x0C265B3C448E6954(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, 1, 0))
				{
					iLocal_94 = 10;
					iLocal_95 = 0;
				}
		...
		case 2:
			...
			else if (!unk_0x27C9F6C1391327CF(iLocal_114, Local_97.f_4))
			{
				if (unk_0x0C265B3C448E6954(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, 1, 0))
				{
					...
					{
						iLocal_292 = unk_0x105601648511CC64() + 5000;
						iLocal_94 = 12;
					}
				}
				else
...
void func_321(int iParam0)//Position - 0x2EE1E
{
	bool bVar0;
	int iVar1;
...
void func_322(bool bParam0, int iParam1)//Position - 0x2EE8F
{
	int iVar0;
...
void func_323(char* sParam0, int iParam1)//Position - 0x2EF29
{
	unk_0x2F618BD43614DD0D(sParam0);
	unk_0x72F8FA06CC9EC899(0, 0, true, iParam1);
}

void func_324()//Position - 0x2EF40
{
	vector3 vVar0;
	...
	switch (iLocal_95)
	{
		...
		case 1:
			...
			else if (!func_2())
			{
				if (func_3())
				{
					if (unk_0x0C265B3C448E6954(Local_97.f_4, Local_305[1 /*7*/][0 /*3*/], Local_305[1 /*7*/][1 /*3*/], fLocal_306[1], 0, 0, 0))
					{
						if (!unk_0x2A348A3A98B80B13(Local_97.f_4))
						{
							vVar0 = { unk_0x541C2AEF053615BC(Local_97.f_4, 1) };
							if (vVar0.z < 6.7f)
							{
			...
			else if (unk_0x0C265B3C448E6954(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 1, 1, 0))
			{
				iLocal_95 = 2;
			}
			else if (iLocal_309)
		...
		case 2:
			...
			{
				if (func_3() && unk_0x0C265B3C448E6954(Local_97.f_4, Local_305[0 /*7*/][0 /*3*/], Local_305[0 /*7*/][1 /*3*/], fLocal_306[0], 0, 0, 0))
				{
					if (!unk_0x2A348A3A98B80B13(Local_97.f_4))
					{
						vVar0 = { unk_0x541C2AEF053615BC(Local_97.f_4, 1) };
...
int func_325(vector3 vParam0, int iParam1, bool bParam2)//Position - 0x2F17C
{
	int iVar0;
...
void func_326()//Position - 0x2F1AA
{
	func_17();
	switch (iLocal_95)
	{
		case 0:
			...
			if (iLocal_118)
			{
				...
				else
				{
					...
					if (!unk_0x2DA8CA50A72528FB(iLocal_96))
					{
						iLocal_96 = func_40(Local_97.f_4, 1, 5);
					}
					iLocal_95 = 1;
		...
		case 1:
			if (((!iLocal_289 && unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), -458.11f, -1725.3f, 17.67f, -456.71f, -1701.81f, 22f, 17.5f, 0, 1, 0)) && !func_2()) && !func_3())
			{
				func_323("B3CTTHB", -1);
				iLocal_289 = 1;
			}
...
void func_327(int iParam0, bool bParam1)//Position - 0x2F365
{
	int iVar0;
...
void func_328(int iParam0)//Position - 0x2F3AF
{
...
void func_329()//Position - 0x2F3D5
{
	switch (iLocal_95)
	{
		case 0:
			...
			{
				func_17();
				if (!iLocal_286 && (unk_0x105601648511CC64() - iLocal_292) > 8000)
				{
				...
				else if (!iLocal_287 && (unk_0x105601648511CC64() - iLocal_292) > 120000)
				{
					if (!func_331())
					{
				...
				else if (!iLocal_288 && (unk_0x105601648511CC64() - iLocal_292) > 160000)
				{
...
bool func_330(var uParam0, int iParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6, bool bParam7)//Position - 0x2F5D4
{
...
int func_331()//Position - 0x2F622
{
	...
	while (iLocal_120 <= 7)
	{
		if (!Local_117[iLocal_120 /*7*/].f_6 && func_9(unk_0xBC25C936A095B5BA(), Local_117[iLocal_120 /*7*/], 8f))
		{
			return 1;
		}
		iLocal_120++;
...
void func_332()//Position - 0x2F6A3
{
	if (!iLocal_119)
	{
...
void func_333(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x2F6BF
{
	vector3 vVar0;
	var uVar1;
	...
	if (unk_0x724D816EA203A79E(Global_17646.f_4))
	{
		...
		{
			if (func_360(24) != Global_17646.f_4)
			{
				if (iParam2 == 1)
				{
					if (func_357(unk_0x541C2AEF053615BC(Global_17646.f_4, 1), iParam3, &vVar0, &uVar1))
					{
						vParam0 = { vVar0 };
						fParam1 = uVar1;
					}
				}
				func_334(Global_17646.f_4, vParam0, fParam1, 24, 0);
			}
		}
	}
}

void func_334(int iParam0, vector3 vParam1, float fParam2, int iParam3, bool bParam4)//Position - 0x2F73A
{
	struct<60> Var0;
...
void func_335(int iParam0, int iParam1, int iParam2)//Position - 0x2F863
{
	int iVar0;
	...
	if (!func_352(&(Global_110A8.f_22B[0 /*21*/]), iParam0))
	{
		return;
	}
	...
	if (unk_0x724D816EA203A79E(iParam1))
	{
		if (unk_0xE59B7F5A03335350(iParam1, 0))
		{
			...
			if (iParam0 == 24)
			{
				Global_19B04.f_7F22.f_12C1 = func_302();
			}
...
void func_336(int iParam0, int iParam1)//Position - 0x2F980
{
	int iVar0;
	int iVar1;
	int iVar2;
	...
	func_257(iParam0, &(Global_19B04.f_7F22.f_1586));
}

int func_337(int iParam0)//Position - 0x2FB82
{
...
int func_338(int iParam0)//Position - 0x2FC5F
{
	if (iParam0 == 0)
	{
		return 0;
...
int func_339(int iParam0, bool bParam1)//Position - 0x2FE10
{
	int iVar0;
	struct<2> Var1;
...
int func_340(int iParam0)//Position - 0x2FF9E
{
	int iVar0;
	var uVar1;
	char cVar2[64];
...
int func_342(int iParam0)//Position - 0x30082
{
	int iVar0;
	int iVar1;
...
int func_343()//Position - 0x31B29
{
	return 0;
}

int func_344()//Position - 0x31B32
{
	return 1;
}

int func_345()//Position - 0x31B3B
{
	return 1;
}

int func_346()//Position - 0x31B44
{
...
int func_348(int iParam0)//Position - 0x31C18
{
	int iVar0;
	char* sVar1;
...
int func_349(int iParam0)//Position - 0x31C5E
{
	int iVar0;
...
int func_350(int iParam0)//Position - 0x31C99
{
	int iVar0;
...
int func_351(int iParam0)//Position - 0x31D15
{
	int iVar0;
...
int func_352(var uParam0, int iParam1)//Position - 0x31DFD
{
	int iVar0;
	int iVar1;
...
void func_353(int iParam0, var uParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0x334F4
{
	if (func_352(&(Global_110A8.f_22B[0 /*21*/]), iParam0))
	{
		...
		{
			func_355(iParam0);
			func_354(uParam1, &(Global_19B04.f_7F22.f_45[Global_110A8.f_22B[0 /*21*/].f_E /*78*/]));
...
void func_354(var uParam0, var uParam1)//Position - 0x335F3
{
...
void func_355(int iParam0)//Position - 0x336BF
{
	if (iParam0 == -1)
	{
		return;
...
void func_356(int iParam0)//Position - 0x33739
{
...
int func_357(vector3 vParam0, int iParam1, var uParam2, var uParam3)//Position - 0x33760
{
	int iVar0;
...
int func_358(vector3 vParam0, int iParam1, int iParam2)//Position - 0x33876
{
	int iVar0;
	float fVar1;
	float fVar2;
...
bool func_359(int iParam0)//Position - 0x33905
{
	return unk_0xFA30DFD0084E92FE(Global_19B04.f_1C20[iParam0], 0);
}

int func_360(int iParam0)//Position - 0x3391D
{
	if (iParam0 == -1)
	{
		return 0;
...
void func_361()//Position - 0x33939
{
	switch (iLocal_95)
	{
		case 0:
...
void func_362()//Position - 0x33A24
{
	switch (iLocal_95)
	{
		case 0:
			...
			if (func_4())
			{
				...
				func_328(3);
				func_328(4);
				unk_0xE365C09E06B55C51(Local_97.f_4, 0);
				unk_0x7387EA04915F201E(Local_97.f_4, 0);
				if (func_2())
				{
					iLocal_95 = 0;
					iLocal_94 = 5;
		...
		case 1:
			if (((!bLocal_297 && iLocal_294 != 0) && (iLocal_295 > 0 && iLocal_295 < 4)) && unk_0xF7DDAAF0EFDAFA22(0, 75))
			{
				bLocal_297 = true;
			}
			switch (iLocal_294)
			{
				case 0:
					if (unk_0x284F2ACE6839D3C0("BARRY3C_IGNITION_FAIL", false, -1) && unk_0xF9E082857622D91E(sLocal_299))
					{
						if (unk_0x3187EF5798B5D209(Local_97.f_4, -1, 0) == unk_0xBC25C936A095B5BA())
						{
							if (!iLocal_103)
							{
								unk_0x0E622862E5E566BB(Local_97.f_4);
								iLocal_103 = 1;
							}
							iLocal_295 = 0;
							iLocal_296 = unk_0x2F079D1FC5F6CB99();
							iLocal_294 = 2;
						}
					}
					break;
				...
				case 2:
					if (unk_0x3187EF5798B5D209(Local_97.f_4, -1, 0) == unk_0xBC25C936A095B5BA() && unk_0x25EF720B1CAB1E23(unk_0xBC25C936A095B5BA(), Local_97.f_4))
					{
						if (iLocal_295 == 3)
						{
							unk_0xC5A6DFE2B8987B17(&uLocal_300);
							unk_0xE896C0AD02364F2A(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
							unk_0xE896C0AD02364F2A(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, 8000, 9, 0, 0, 0, 0);
							unk_0xE896C0AD02364F2A(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
							unk_0x535008C596714F9E(uLocal_300);
							unk_0xA8E6405305C0D7DF(unk_0xBC25C936A095B5BA(), uLocal_300);
							unk_0x02DAF06EA4F08219(&uLocal_300);
						...
						else if (iLocal_295 == 2)
						{
							if (func_21(&uLocal_121, "BAR3CAU", "BAR3C_C1", 7, 0, 0, 0))
							{
								unk_0xC5A6DFE2B8987B17(&uLocal_300);
								unk_0xE896C0AD02364F2A(0, sLocal_299, "franklinfailingtostartcar_enter", 8f, -8f, 2000, 8, 0, 0, 0, 0);
								unk_0xE896C0AD02364F2A(0, sLocal_299, "franklinfailingtostartcar_loop", 8f, -8f, (1200 + iLocal_295 * 250), 9, 0, 0, 0, 0);
								unk_0xE896C0AD02364F2A(0, sLocal_299, "franklinfailingtostartcar_exit", 8f, -8f, 766, 8, 0, 0, 0, 0);
								unk_0x535008C596714F9E(uLocal_300);
								unk_0xA8E6405305C0D7DF(unk_0xBC25C936A095B5BA(), uLocal_300);
								unk_0x02DAF06EA4F08219(&uLocal_300);
				...
				case 3:
					if (unk_0x105601648511CC64() > iLocal_291)
					{
						...
						{
							unk_0xF2C27FE5A8B98CB5(iLocal_296, "IGNITION_FAIL", Local_97.f_4, "BARRY_03_SOUNDSET", 0, 0);
							unk_0x8B34879B92B3B225(iLocal_296, "HOLD TIME", 3f);
							iLocal_291 = unk_0x105601648511CC64() + 9100;
						}
						else
						{
							unk_0xF2C27FE5A8B98CB5(iLocal_296, "IGNITION_FAIL", Local_97.f_4, "BARRY_03_SOUNDSET", 0, 0);
							unk_0x8B34879B92B3B225(iLocal_296, "HOLD TIME", (SYSTEM::TO_FLOAT((1200 + iLocal_295 * 250)) / 1000f));
							iLocal_291 = (unk_0x105601648511CC64() + iLocal_295 * 250) + 1200 + 766;
						}
						iLocal_294 = 4;
					}
					break;
				...
				case 4:
					if (unk_0x105601648511CC64() > iLocal_291)
					{
						...
						else
						{
							...
							if (iLocal_295 == 4)
							{
								unk_0xE896C0AD02364F2A(unk_0xBC25C936A095B5BA(), sLocal_299, "franklinfailingtostartcar_slamwheel", 1000f, -8f, 3300, 0, 0, 0, 0, 0);
								iLocal_291 = unk_0x105601648511CC64() + 330;
								iLocal_294 = 5;
							}
							else
							{
				...
				case 5:
					if (unk_0x105601648511CC64() > iLocal_291)
					{
						unk_0x840ADECDE0532B84(Local_97.f_4, 500, unk_0x56BEECB328B6D29D("NORMAL"), 0);
						iLocal_291 = unk_0x105601648511CC64() + 2000;
						iLocal_294 = 8;
					}
					break;
				...
				case 6:
					if (unk_0x25EF720B1CAB1E23(unk_0xBC25C936A095B5BA(), Local_97.f_4))
					{
						if (!func_15())
						{
		...
		case 2:
			if (!func_15() && (unk_0x105601648511CC64() - iLocal_291) > 2500)
			{
				iLocal_95 = 0;
				iLocal_94 = 2;
			}
...
void func_363(int iParam0, bool bParam1)//Position - 0x33F31
{
...
void func_364()//Position - 0x33F6D
{
	switch (iLocal_95)
	{
		case 0:
			if (unk_0xFA9040D29FE330BD(0))
			{
				...
				else
				{
					...
					func_12(0);
					iLocal_95 = 1;
					unk_0x284F2ACE6839D3C0("BARRY3C_IGNITION_FAIL", false, -1);
				}
			}
			break;
...
void func_365(var uParam0, var uParam1, char* sParam2, char* sParam3, char* sParam4)//Position - 0x3407F
{
	switch (*uParam0)
	{
		case 0:
...
bool func_366(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0x34190
{
...
void func_367()//Position - 0x341E4
{
	Global_394A = 0;
	func_36();
}

struct<6> func_368()//Position - 0x341F4
{
	struct<6> Var0;
	int iVar1;
	int iVar2;
...
struct<6> func_369()//Position - 0x342A0
{
	struct<6> Var0;
...
void func_370()//Position - 0x342C4
{
}

int func_371()//Position - 0x342CC
{
	if (!func_408(unk_0xBC25C936A095B5BA()))
	{
		return 1;
	}
	if (unk_0x724D816EA203A79E(Local_97.f_4))
	{
		if (unk_0x1D403DFADBC2DE3C(Local_97.f_4, 0))
		{
		...
		{
			if (unk_0xE7259E40522CC260(Local_97.f_4))
			{
				if (iLocal_100)
				{
					if ((unk_0x105601648511CC64() - iLocal_104) > 7000)
					{
	...
	if (unk_0x724D816EA203A79E(iLocal_114))
	{
		if (unk_0x1D403DFADBC2DE3C(iLocal_114, 0) && iLocal_307 == 0)
		{
			if (func_3())
			{
		...
		{
			if (unk_0xE7259E40522CC260(iLocal_114))
			{
				if (iLocal_101)
				{
					if ((unk_0x105601648511CC64() - iLocal_105) > 7000)
					{
						if (func_3())
						{
...
void func_372()//Position - 0x343F9
{
	switch (iLocal_95)
	{
		case 0:
			func_41(&iLocal_96);
			if (unk_0xF1734B55490E9045(sLocal_310))
			{
				sLocal_310 = "DEFAULT";
			}
			if (unk_0x3362CDE8460ED38B(sLocal_310, "DEFAULT"))
			{
				func_457(1);
			}
			else
		...
		case 1:
			if (func_388())
			{
				if ((func_408(Local_97.f_4) && func_408(iLocal_114)) && unk_0xB6A16B5E7EB81F9B(Local_97.f_4, iLocal_114))
				{
					unk_0xBD2B21F4319C9475(Local_97.f_4);
				}
				func_373();
				func_455();
			}
...
void func_373()//Position - 0x3448F
{
	if (func_408(Local_97.f_4))
	{
		unk_0xB71D41C0310C93DE(Local_97.f_4, 0, 1);
	}
	func_10(&iLocal_114);
...
void func_374(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x344D2
{
...
void func_375(var uParam0, bool bParam1)//Position - 0x344F2
{
	func_376(&(uParam0->f_29), bParam1);
}

void func_376(var uParam0, bool bParam1)//Position - 0x34504
{
	int iVar0;
...
void func_377(int iParam0, bool bParam1)//Position - 0x34542
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_378(var uParam0, bool bParam1)//Position - 0x3457D
{
	func_379(&(uParam0->f_23), bParam1);
}

void func_379(var uParam0, bool bParam1)//Position - 0x3458F
{
	int iVar0;
...
void func_380(var uParam0, int iParam1)//Position - 0x345CC
{
	func_381(&(uParam0->f_1C), iParam1);
}

void func_381(var uParam0, int iParam1)//Position - 0x345DE
{
	int iVar0;
...
void func_382(int iParam0, int iParam1, int iParam2, int iParam3)//Position - 0x3461F
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_383(int iParam0)//Position - 0x3466F
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_384(bool bParam0)//Position - 0x346B0
{
	func_385(39, bParam0);
	func_385(40, bParam0);
	func_385(41, bParam0);
...
void func_385(int iParam0, bool bParam1)//Position - 0x346E8
{
	if (bParam1)
	{
...
void func_386(int iParam0, int iParam1, bool bParam2)//Position - 0x3471F
{
	int iVar0;
...
void func_387(int iParam0, int iParam1, bool bParam2)//Position - 0x34788
{
	int iVar0;
...
void func_389(char* sParam0, bool bParam1)//Position - 0x3481E
{
	func_390(sParam0);
	func_457(bParam1);
}

void func_390(char* sParam0)//Position - 0x34832
{
...
void func_391(struct<6> Param0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x34871
{
	float fVar0;
	int iVar1;
	int iVar2;
	...
	if (Global_11640 != 6)
	{
		...
		else
		{
			...
			if (iVar1 < 9000 && !unk_0x17FAADF9916EF741())
			{
				...
				Var4 = { func_393(Global_11641, Global_11643, iParam5) };
				if (fVar6 == -0.014f)
				{
				}
...
float func_392(char* sParam0)//Position - 0x34B56
{
	unk_0xE746379C2AF24EF6(sParam0);
	return unk_0x2207C0EA517B975D(1);
}

struct<2> func_393(int iParam0, int iParam1, int iParam2)//Position - 0x34B69
{
	struct<2> Var0;
	int iVar1;
...
char* func_394(int iParam0)//Position - 0x34C3F
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_395(int iParam0)//Position - 0x34D92
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_396(int iParam0)//Position - 0x34DC5
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_397(int iParam0)//Position - 0x34DF8
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_398(int iParam0)//Position - 0x34E2B
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_399(int iParam0)//Position - 0x34E5E
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_400(int iParam0)//Position - 0x34E9B
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_401(int iParam0)//Position - 0x34ECE
{
	struct<2> Var0;
...
int func_402(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x34F37
{
...
bool func_403(bool bParam0)//Position - 0x3504F
{
	if (bParam0)
	{
...
int func_404(int iParam0)//Position - 0x35078
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_405(int iParam0)//Position - 0x350D2
{
	if (Global_8C41 == 15)
	{
		return 0;
...
bool func_406(int iParam0)//Position - 0x350F4
{
	return func_407(iParam0, Global_8C41);
}

int func_407(int iParam0, int iParam1)//Position - 0x35105
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_408(int iParam0)//Position - 0x352E6
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
...
bool func_409(bool bParam0)//Position - 0x35307
{
...
void func_410(bool bParam0)//Position - 0x35332
{
	if (bParam0)
	{
		if (func_425())
...
void func_411(int iParam0, int iParam1, int iParam2)//Position - 0x35503
{
...
bool func_412()//Position - 0x355C7
{
	return unk_0xFA30DFD0084E92FE(Global_16B1B.f_14, 13);
}

void func_413(vector3 vParam0, float fParam1, bool bParam2)//Position - 0x355DB
{
	if (func_408(unk_0xBC25C936A095B5BA()))
	{
		if (bParam2)
	...
	while (!unk_0xD6513D668481290A(iLocal_115))
	{
		SYSTEM::WAIT(0);
	}
	iLocal_114 = unk_0x61C05BF08A1E0EFE(iLocal_115, vParam0, fParam1, 1, 1, 0);
	unk_0x2CA123B0622F495C(iLocal_115);
	unk_0x6012A6A4F2950585(iLocal_114, iLocal_116);
	unk_0xF0A40F19AAB79E88(iLocal_114, 1084227584);
	if (bParam2)
	{
		func_414(unk_0xBC25C936A095B5BA(), iLocal_114, -1);
	}
	unk_0xE365C09E06B55C51(iLocal_114, 0);
	unk_0x7387EA04915F201E(iLocal_114, 0);
	unk_0xA73D1278857991A2(iLocal_114, 1);
	if (!unk_0x1D403DFADBC2DE3C(iLocal_114, 0))
	{
		unk_0x0E622862E5E566BB(iLocal_114);
		iLocal_102 = 1;
	}
...
void func_414(int iParam0, int iParam1, int iParam2)//Position - 0x3569C
{
	if (func_415(iParam0))
	{
		if (func_408(iParam1))
...
int func_415(int iParam0)//Position - 0x356DE
{
	if (func_408(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
void func_416(vector3 vParam0, float fParam1)//Position - 0x356FE
{
	unk_0xF243B7A14FCFD0F4(Local_97.f_5);
	if (unk_0x724D816EA203A79E(Local_97.f_4))
	{
		if (iLocal_103)
		{
			unk_0xBF86DE1BFE3AA5CF(Local_97.f_4);
			iLocal_103 = 0;
		}
	}
	while (!unk_0xD6513D668481290A(Local_97.f_5))
	{
		SYSTEM::WAIT(0);
	}
	func_240(&iLocal_106);
	func_6(&(Local_97.f_4));
	Local_97.f_4 = unk_0x61C05BF08A1E0EFE(Local_97.f_5, vParam0, fParam1, 1, 1, 0);
	unk_0x2CA123B0622F495C(Local_97.f_5);
	unk_0xF0A40F19AAB79E88(Local_97.f_4, 1084227584);
	unk_0xE365C09E06B55C51(Local_97.f_4, 0);
	unk_0x7387EA04915F201E(Local_97.f_4, 0);
	unk_0x6012A6A4F2950585(Local_97.f_4, 1);
	unk_0x0BD7089C3E314AEA(Local_97.f_4, 1);
	unk_0xA73D1278857991A2(Local_97.f_4, 1);
	unk_0xB71D41C0310C93DE(Local_97.f_4, 1, 1);
	if (!unk_0x1D403DFADBC2DE3C(Local_97.f_4, 0))
	{
		unk_0x0E622862E5E566BB(Local_97.f_4);
	...
	iLocal_106 = unk_0xB6896943DA475493(iLocal_109, vParam0 + vLocal_107, true, true, 0);
	unk_0x5DBE04849460E608(iLocal_106, Local_97.f_4, 0, vLocal_107, vLocal_108, 0, 0, 0, 0, 2, 1);
}

void func_417()//Position - 0x357F2
{
	if (func_408(unk_0xBC25C936A095B5BA()))
	{
		if (unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0)
...
void func_418()//Position - 0x35824
{
	unk_0xEB233A3B7635D2AC();
	unk_0x7456702622C62EA0(1);
	if (func_15())
...
void func_419(int iParam0)//Position - 0x35845
{
	if (Global_3943)
	{
		func_420(0, 0);
...
void func_420(bool bParam0, bool bParam1)//Position - 0x358B5
{
	if (bParam0)
	{
		if (func_404(0))
...
void func_421()//Position - 0x35929
{
	Global_394A = 0;
	func_422();
}

void func_422()//Position - 0x35939
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
void func_423(vector3 vParam0, float fParam1, int iParam2, int iParam3)//Position - 0x3595A
{
	if (func_442())
	{
...
int func_424()//Position - 0x359EF
{
	return Global_181DF.f_B3B.f_C.f_42;
}

bool func_425()//Position - 0x35A02
{
	return func_426(&(Global_181DF.f_B3B));
}

int func_426(var uParam0)//Position - 0x35A15
{
	if (uParam0->f_C.f_42 == 0)
	{
		return 0;
	}
	if (!func_339(uParam0->f_C.f_42, 0))
	{
		return 0;
	}
	if (uParam0->f_C.f_42 == joaat("stunt") && func_427(*uParam0, 1694.62f, 3276.27f, 41.31f, 1056964608, 0))
	{
		return 0;
	}
	return 1;
...
int func_427(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x35A74
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_428(bool bParam0)//Position - 0x35AEF
{
	if (bParam0)
	{
		if (func_425())
	...
	{
		iLocal_307 = 0;
		iLocal_292 = unk_0x105601648511CC64() + 3000;
		iLocal_94 = 12;
	}
	iLocal_95 = 0;
	iLocal_120 = 0;
...
void func_429(bool bParam0)//Position - 0x35D36
{
	if (bParam0)
	{
		if (func_425())
	...
	else if (unk_0x62F3A07C43FFB568(unk_0xBC25C936A095B5BA(), Local_97.f_4, 0))
	{
		unk_0x641B19E156645A92(unk_0xBC25C936A095B5BA(), Local_97, 1, 0, 0, 1);
	}
	func_418();
	func_417();
	func_41(&iLocal_96);
	...
	if (bParam0)
	{
		...
		{
			unk_0xEA3E0D06F73398CE(iLocal_114, 0f);
		}
		while (!unk_0xFA9040D29FE330BD(0))
		{
			SYSTEM::WAIT(0);
...
void func_430(int iParam0, int iParam1, int iParam2)//Position - 0x35FB1
{
...
void func_431(int iParam0, int iParam1, int iParam2, bool bParam3)//Position - 0x35FE5
{
	int iVar0;
...
void func_432(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0x3608D
{
	if (bParam0)
	{
...
bool func_433()//Position - 0x361B6
{
	return unk_0xFA30DFD0084E92FE(Global_18402B[unk_0xB5CEFD608600A09F() /*770*/].f_27.f_12, 14);
}

bool func_434(int iParam0, int iParam1)//Position - 0x361D3
{
	bool bVar0;
...
int func_435(int iParam0, bool bParam1)//Position - 0x3621E
{
	int iVar0;
	int iVar1;
...
int func_436(int iParam0)//Position - 0x3625F
{
...
bool func_437()//Position - 0x362A1
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_438(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0x362B2
{
	int iVar0;
...
void func_439(int iParam0)//Position - 0x362E5
{
	if (iParam0 == 1)
	{
...
void func_440(bool bParam0)//Position - 0x36308
{
	if (bParam0)
	{
		func_423(Local_97, Local_97.f_3, 1, 0);
	...
	else
	{
		...
		func_416(Local_97, Local_97.f_3);
		unk_0xBD53A029D0155A42(unk_0xBC25C936A095B5BA(), Local_97.f_4, -1);
	}
}

int func_441()//Position - 0x36445
{
...
void func_443()//Position - 0x36493
{
	...
	iLocal_80 = func_451();
	iLocal_113[0] = unk_0x1DAA351326EA3537(-1156.9f, -1274f, 0f, -1141.5f, -1239.6f, 8f, 0, 1, 1, 1);
	iLocal_113[1] = unk_0x1DAA351326EA3537(-1177f, -1292f, 0f, -1160f, -1273.3f, 8f, 0, 1, 1, 1);
	...
	if (func_408(unk_0xBC25C936A095B5BA()))
	{
		func_449(&uLocal_121, 1, unk_0xBC25C936A095B5BA(), "FRANKLIN", 0, 1);
	}
...
void func_444(int iParam0, int iParam1, bool bParam2)//Position - 0x36780
{
	Global_BE9 = iParam0;
...
void func_445()//Position - 0x3692A
{
	char cVar0[64];
	char cVar1[64];
	char* sVar2;
...
void func_446()//Position - 0x369A9
{
...
void func_447()//Position - 0x369D9
{
...
Vector3 func_448(char* sParam0, int iParam1)//Position - 0x36A7B
{
	vector3 vVar0;
...
void func_449(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x36A96
{
...
struct<7> func_450(vector3 vParam0, float fParam1)//Position - 0x36B31
{
	struct<7> Var0;
...
int func_451()//Position - 0x36B59
{
	return unk_0x1DAA351326EA3537(-564f, -1758.1f, 16.5f, -419.31f, -1649f, 23f, 0, 1, 1, 1);
}

void func_452(var uParam0, var uParam1)//Position - 0x36B87
{
	*uParam0 = *uParam1;
	*uParam1 = 0;
}

void func_453(var uParam0, int iParam1)//Position - 0x36B99
{
	Global_16B1B.f_16[iParam1] = uParam0;
}

void func_454(int iParam0, var uParam1)//Position - 0x36BAD
{
	*iParam0 = *uParam1;
	*uParam1 = 0;
}

void func_455()//Position - 0x36BBF
{
	if (func_456())
	{
	}
	unk_0xDF53A66AEE1401AA(1f);
	func_374(&Local_79, 1, 0, 0);
	unk_0x483687B0FCA5415A(iLocal_80, 0);
	unk_0x483687B0FCA5415A(iLocal_113[0], 0);
	unk_0x483687B0FCA5415A(iLocal_113[1], 0);
...
void func_457(bool bParam0)//Position - 0x36CAF
{
	int iVar0;
...
void func_458(char* sParam0, int iParam1)//Position - 0x36D7F
{
	if (Global_16B1B != 12)
	{
...
int func_459(char* sParam0, int iParam1, int iParam2)//Position - 0x36DA7
{
	int iVar0;
	struct<32> Var1;
	int iVar2;
	...
	if (func_462())
	{
		...
		{
			iVar2 = func_313(unk_0x1377080E9B0BD993());
			if (iVar2 > -1)
			{
...
int func_460()//Position - 0x36F39
{
	int iVar0;
	int iVar1;
	
	iVar0 = func_316(&(Global_16B1B.f_3), 0);
	iVar1 = 0;
	if (iVar0 == 53)
	{
		iVar1 = 1;
...
int func_462()//Position - 0x36FAD
{
	...
	{
		if (func_313(&(Global_16B1B.f_3)) > -1)
		{
			return 1;
		}
	}
...
void func_463(bool bParam0)//Position - 0x37019
{
	unk_0x59B038076F830627(bParam0);
	unk_0x43F06392C4EF25E0(bParam0);
}

void func_464(int iParam0)//Position - 0x3702D
{
	if (iParam0 == 1)
	{
		unk_0x3169E2C5E6A096BC();
...
void func_465(int iParam0)//Position - 0x3706A
{
	if (iParam0 == 1)
	{
...
void func_466()//Position - 0x370A7
{
	Global_4336.f_5 = 1;
}

void func_467()//Position - 0x370B5
{
	Global_4336.f_5 = 0;
}

void func_468(bool bParam0)//Position - 0x370C3
{
	if (bParam0)
	{
		func_469();
...
void func_469()//Position - 0x37126
{
...
void func_470()//Position - 0x3714F
{
	Global_154EC = 0;
	Global_154ED = 0;
}

int func_471()//Position - 0x37161
{
...
void func_472()//Position - 0x3719F
{
	Global_16B3E = 1;
...
void func_473(char* sParam0)//Position - 0x3728C
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_474()//Position - 0x3729E
{
	int iVar0;
...
void func_475(var uParam0)//Position - 0x372BE
{
...
void func_476(var uParam0)//Position - 0x372DE
{
	int iVar0;
...
int func_477(int iParam0)//Position - 0x37318
{
	if (!func_30(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
