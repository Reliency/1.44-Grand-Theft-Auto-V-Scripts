...
int func_2()//Position - 0x11B
{
	...
	if (!func_3(&uVar0))
	{
		vVar1 = { unk_0x541C2AEF053615BC(iLocal_68, false) };
		fVar2 = SYSTEM::VDIST2(vLocal_170 + vLocal_173, vVar1);
		if (fVar2 < (4.5f * 4.5f))
		{
			unk_0x204BA7B1C7DD25F4(iLocal_68, iLocal_70, fLocal_171, 786599);
			return 1;
		}
	}
	return 0;
...
int func_4()//Position - 0x1B6
{
	...
	if (!func_3(&uVar0))
	{
		...
		else if (unk_0x77FC50899603581D(Global_1613E))
		{
			...
			if (!func_5(Global_16A45, iLocal_70, 2))
			{
				if (fVar1 >= 0.9f)
				{
					unk_0xBD53A029D0155A42(Global_16A45, iLocal_70, 2);
				}
			}
			if (!iLocal_172)
			{
			...
			unk_0x194CCBD594974E0D(iLocal_68, iLocal_70, 6, 50);
		}
		else
		{
			if (!func_5(Global_16A45, iLocal_70, 2))
			...
			unk_0x6C3BE67B02D72CDC(iLocal_70, -8f, 1);
			SYSTEM::WAIT(100);
			if (!func_3(&uVar0))
			{
				unk_0xC5A6DFE2B8987B17(&iVar2);
				unk_0x194CCBD594974E0D(0, iLocal_70, 24, 50);
				unk_0x61E7E913658B4389(0, 2000);
				unk_0x509F549022512095(0, iLocal_70, vLocal_170 + vLocal_173, fLocal_171, 0, iLocal_71, 786599, ((4.5f / 2f) - 1f), 10f);
				unk_0x535008C596714F9E(iVar2);
				unk_0xA8E6405305C0D7DF(iLocal_68, iVar2);
...
int func_8(int iParam0, int iParam1)//Position - 0x36D
{
	...
	if (!unk_0x7930B3E9C919E90F())
	{
		...
		else if (iParam1 == func_9(Global_16A45) && iParam1 != 0)
		{
			Global_16A45 = 0;
		}
	}
...
void func_21()//Position - 0x69B
{
	...
	unk_0x8510BC031C24B862(iLocal_69, true);
	iLocal_70 = unk_0x67FCE1EB536A0735(vLocal_173 + vLocal_169, 15f, iLocal_71, 2);
	iVar0 = 0;
	while ((!unk_0x724D816EA203A79E(Global_16A45) || !unk_0x724D816EA203A79E(iLocal_70)) || (!unk_0xD6513D668481290A(iLocal_69) && iVar0 < 400))
	{
	...
	{
		unk_0x4106FAF8AA1D69D5(Global_16A45, Global_15828);
		unk_0x36C3B58DA78A2679(Global_16A45, "A_F_Y_BevHills_01_White_FULL_01");
	}
	if (!unk_0x1D403DFADBC2DE3C(iLocal_70, 0))
	{
		unk_0x2D655AA68FA1736B(iLocal_70, true, true, 0);
		unk_0xD421BC740C5340C3(iLocal_70, 2);
		unk_0xF0A40F19AAB79E88(iLocal_70, 1084227584);
		iLocal_68 = unk_0xFD8987C090669BD5(iLocal_70, 4, iLocal_69, -1, 1, true);
		unk_0x7D314AB19CA29C96(iLocal_68, 0);
	...
	switch (Param0.f_2)
	{
		...
		case 155:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_26(uParam1, 17, 1785177548, 1785177548, unk_0x55AEFCD285ECC0F2(-5f, 5f), unk_0x55AEFCD285ECC0F2(-5f, 5f), 0f, unk_0x55AEFCD285ECC0F2(-180f, 180f));
			uParam1->f_76 = 1;
			return 1;
			break;
		...
		case 158:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_26(uParam1, 144, 1785177548, 1785177548, unk_0x55AEFCD285ECC0F2(-5f, 5f), unk_0x55AEFCD285ECC0F2(-5f, 5f), 0f, unk_0x55AEFCD285ECC0F2(-180f, 180f));
			uParam1->f_76 = 1;
			return 1;
			break;
	...
	switch (Param0.f_2)
	{
		...
		case 196:
			*uParam1 = { Param0 };
			uParam1->f_6D = 1785177548;
			uParam1->f_6E = 1785177548;
			func_26(uParam1, 43, 1785177548, 1785177548, unk_0x55AEFCD285ECC0F2(-5f, 5f), unk_0x55AEFCD285ECC0F2(-5f, 5f), 0f, unk_0x55AEFCD285ECC0F2(-180f, 180f));
			uParam1->f_76 = 1;
			return 1;
			break;
...
int func_30(int iParam0, var uParam1, int iParam2)//Position - 0x7A59
{
	...
	if (!func_31(Global_16908[iParam0 /*98*/], 0))
	{
		func_29(iParam0, uParam1, iParam2);
		uParam1->f_5B = iParam2;
		return 1;
...
int func_35()//Position - 0x99A9
{
	return 0;
}

int func_36()//Position - 0x99B2
{
	return 1;
}

int func_37()//Position - 0x99BB
{
	return 1;
}

int func_38()//Position - 0x99C4
{
...
int func_40(int iParam0)//Position - 0x9A98
{
...
int func_41(int iParam0, var uParam1, var uParam2, char* sParam3)//Position - 0x9D18
{
	int iVar0;
...
bool func_42(var uParam0)//Position - 0x9F13
{
	int iVar0;
	vector3 vVar1;
	float fVar2;
...
bool func_43(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x9FCE
{
	if (bParam2)
	{
...
int func_44(int iParam0, var uParam1, char* sParam2)//Position - 0xA015
{
	vector3 vVar0;
	int iVar1;
	var uVar2;
	...
	switch (iParam0)
	{
		...
		case 5:
			*uParam1 = Global_19B04.f_932.f_21B.f_8F2[0];
			StringCopy(sParam2, func_48(Global_19B04.f_932.f_21B.f_8F6[0]), 32);
			return 1;
			break;
		
		case 6:
			*uParam1 = Global_19B04.f_932.f_21B.f_8F2[1];
			StringCopy(sParam2, func_48(Global_19B04.f_932.f_21B.f_8F6[1]), 32);
			return 1;
			break;
		
		case 7:
			*uParam1 = Global_19B04.f_932.f_21B.f_8F2[2];
			StringCopy(sParam2, func_48(Global_19B04.f_932.f_21B.f_8F6[2]), 32);
			return 1;
			break;
...
int func_45(int iParam0, int iParam1, var uParam2, var uParam3)//Position - 0xC617
{
	switch (iParam1)
	{
		case 0:
...
int func_47(int iParam0, var uParam1, var uParam2)//Position - 0xE585
{
	switch (iParam0)
	{
		case 11:
...
char* func_48(int iParam0)//Position - 0xEEF4
{
	switch (iParam0)
	{
		case 2014101067:
...
void func_49()//Position - 0xEF87
{
	if (!unk_0x1D403DFADBC2DE3C(iLocal_68, 0) && unk_0xB248FAA35ED47DB9(iLocal_68, 1))
	{
		unk_0x02537C8C1BEEB477(&iLocal_68);
	}
	if (!unk_0x1D403DFADBC2DE3C(iLocal_70, 0) && unk_0xB248FAA35ED47DB9(iLocal_70, 1))
	{
		unk_0x1E7A09C1710FB071(&iLocal_70);
	}
	unk_0x8510BC031C24B862(iLocal_69, false);
	unk_0x2CA123B0622F495C(iLocal_69);
