...
void func_37(bool bParam0, bool bParam1)//Position - 0x2898
{
	if (bParam0)
	{
		if (func_38(0))
...
int func_38(int iParam0)//Position - 0x290C
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
void func_42(int iParam0)//Position - 0x2A9C
{
...
void func_43(char* sParam0)//Position - 0x2AFF
{
	unk_0x4EA570997E107F35(sParam0);
}

void func_44(int iParam0)//Position - 0x2B0D
{
	if (iParam0 != 0)
	{
...
char* func_46(int iParam0)//Position - 0x2B96
{
	char* sVar0;
...
char* func_47(int iParam0)//Position - 0x2BAC
{
	char* sVar0;
...
void func_48(var uParam0)//Position - 0x2BC1
{
	int iVar0;
...
void func_49(int iParam0)//Position - 0x2C0D
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_50(var uParam0)//Position - 0x2C4E
{
	int iVar0;
...
void func_51(int iParam0)//Position - 0x2C77
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
