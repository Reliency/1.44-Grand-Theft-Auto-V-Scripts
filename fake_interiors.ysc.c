...
void __EntryFunction__()//Position - 0x0
{
	...
	while (true)
	{
		...
		{
			iLocal_31 = unk_0xBC25C936A095B5BA();
		}
		if (unk_0x1D403DFADBC2DE3C(iLocal_31, 0))
		{
		}
		func_1();
	}
...
void func_1()//Position - 0xB1
{
	...
	{
		vVar0 = { unk_0x541C2AEF053615BC(iLocal_31, false) };
		...
		if (SYSTEM::VDIST2(vVar1, vVar0) < IntToFloat(func_18(iLocal_29)))
		{
			...
			while (iVar3 < func_17(iLocal_29))
			{
				if (!bVar2)
				{
					if (unk_0x0C265B3C448E6954(iLocal_31, func_16(iLocal_29, iVar3), func_15(iLocal_29, iVar3), func_14(iLocal_29, iVar3), 0, true, 0))
					{
						bVar2 = true;
					}
				}
			...
			if (bVar2)
			{
				unk_0xE79A93A1A9ABDBEC(unk_0x56BEECB328B6D29D(func_13(iLocal_29)), vVar1.x, vVar1.y, func_12(iLocal_29), func_11(iLocal_29));
				func_10(iLocal_29);
			}
		}
	}
	if (unk_0x7AF0088ABFA713B6())
	{
		if (func_2())
		{
			if (unk_0xFA30DFD0084E92FE(iLocal_32, 1))
			{
				unk_0x7CB6FD92BE491AD9(&iLocal_32, 1);
			}
			if (unk_0xE186ACC7BE9B244E())
			{
				if (!unk_0xFA30DFD0084E92FE(iLocal_32, 0))
				{
					unk_0xF6A0278DBC4BF32C(15, 1, -1);
					unk_0xF0059F27F7BB6680(&iLocal_32, 0);
				}
			}
			else if (unk_0xFA30DFD0084E92FE(iLocal_32, 0))
			{
				unk_0xF6A0278DBC4BF32C(15, 0, -1);
				unk_0x7CB6FD92BE491AD9(&iLocal_32, 0);
			}
		}
		else if (!unk_0xFA30DFD0084E92FE(iLocal_32, 1))
		{
			unk_0xF6A0278DBC4BF32C(15, 0, -1);
			unk_0x7CB6FD92BE491AD9(&iLocal_32, 0);
			unk_0xF0059F27F7BB6680(&iLocal_32, 1);
		}
	}
}
...
bool func_5(int iParam0, bool bParam1)//Position - 0x251
{
	...
	return Global_18C80F[iParam0 /*558*/].f_B != func_3();
}
...
int func_6(int iParam0)//Position - 0x27C
{
	if (iParam0 != func_3())
	{
		if (Global_18C80F[iParam0 /*558*/].f_B != func_3())
		{
...
void func_10(int iParam0)//Position - 0x332
{
	...
	vVar0 = { unk_0x541C2AEF053615BC(iLocal_31, false) };
	unk_0x5486330E523547E2(vVar0.x, vVar0.y);
	switch (iParam0)
	{
		case 0:
			break;
