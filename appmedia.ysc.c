	...
	while (true)
	{
		...
		if (iLocal_24 == 0)
		{
			if (Global_389D.f_1 != 9)
			{
				...
				{
					case 7:
						if ((iLocal_31 == 0 && iLocal_32 == 0) && Global_41C3 == 0)
						{
							func_22();
							func_16();
						}
					...
					case 8:
						if ((func_15(2, Global_387D, 0) && iLocal_31 == 0) && iLocal_32 == 0)
						{
							func_14();
							Global_3887 = 1;
							if (Global_389D.f_1 > 3)
							{
								if (unk_0xFA30DFD0084E92FE(Global_93C, 15))
								{
								}
								func_13();
							}
...
void func_3()//Position - 0x19C
{
	...
	func_7(Global_388A, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	...
	while (iLocal_22 < iLocal_21)
	{
		...
		{
			func_6(Global_388A, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(iVar0), SYSTEM::TO_FLOAT(0), -1f, -1f, &(Local_27[iLocal_22 /*6*/]), 0, 0, 0, 0);
			iLocal_26[iVar0] = iLocal_22;
			iVar0++;
		}
		iLocal_22++;
	}
	func_7(Global_388A, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
	func_4(Global_388A, "SET_HEADER", "CELL_MSMENU_1", 0, 0, 0, 0);
	if (Global_3891)
	{
		func_6(Global_388A, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
		func_6(Global_388A, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
	}
	else
	{
		func_6(Global_388A, "SET_SOFT_KEYS", 2f, 1f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
		func_6(Global_388A, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, 0, 0, 0, 0, 0);
	}
...
void func_8()//Position - 0x451
{
	if (iLocal_31 == 0 && iLocal_32 == 1)
	{
		...
		unk_0xF960832D272B97D4(vLocal_30, 0);
	}
}

void func_9()//Position - 0x539
{
	if ((iLocal_31 == 1 && iLocal_32 == 0) && Global_41C3 == 6)
	{
		if (iLocal_33)
		{
			vLocal_30.x = (vLocal_30.x - 1f);
	...
	if (unk_0xFA30DFD0084E92FE(Global_93C, 15))
	{
		...
		iLocal_32 = 0;
		func_7(Global_388A, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
		func_6(Global_388A, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_MSMENU_3", 0, 0, 0, 0);
		if (Global_3891)
		{
			func_6(Global_388A, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
			func_6(Global_388A, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
		}
		else
		{
			func_6(Global_388A, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
			func_6(Global_388A, "SET_SOFT_KEYS", 3f, 1f, 4f, -1f, -1f, 0, 0, 0, 0, 0);
		}
		func_6(Global_388A, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
		unk_0x7CB6FD92BE491AD9(&Global_93B, 17);
		func_7(Global_388A, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
		func_4(Global_388A, "SET_HEADER", &(Local_27[iLocal_23 /*6*/]), 0, 0, 0, 0);
	}
}
...
void func_13()//Position - 0x776
{
	if (iLocal_31 == 0)
	{
		unk_0x59FA1842E06428BC(&vLocal_30, 0);
		vLocal_29 = { Global_3875 };
		iLocal_32 = 1;
		iLocal_36 = 1;
		iLocal_37 = 1;
		iLocal_38 = 1;
...
void func_16()//Position - 0x833
{
	...
	if (iLocal_28 == 0)
	{
		if (func_15(2, Global_3885, 0))
		{
			func_20();
			iLocal_28 = 1;
			SYSTEM::SETTIMERA(0);
		}
		if (func_15(2, Global_3886, 0))
		{
			func_17();
			iLocal_28 = 1;
			SYSTEM::SETTIMERA(0);
...
{
	func_7(Global_388A, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(3), -1082130432, -1082130432, -1082130432, -1082130432);
...
{
	func_7(Global_388A, "SET_INPUT_EVENT", SYSTEM::TO_FLOAT(1), -1082130432, -1082130432, -1082130432, -1082130432);
	unk_0xC4BA30B532FE260F(-1, "Menu_Navigate", &Global_3892, 1);
	func_21();
}
...
void func_22()//Position - 0x9AB
{
	...
	if (Global_3887 == 0)
	{
		if (func_15(2, Global_387E, 0))
		{
			unk_0x7CB6FD92BE491AD9(&Global_93C, 15);
			func_24();
			Global_3887 = 1;
			...
			if (iVar0 > -1)
			{
				...
				if (Global_389D.f_1 > 3)
				{
					...
					{
						func_7(Global_388A, "SET_DATA_SLOT_EMPTY", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_6(Global_388A, "SET_DATA_SLOT", SYSTEM::TO_FLOAT(18), SYSTEM::TO_FLOAT(0), SYSTEM::TO_FLOAT(0), -1f, -1f, "CELL_MSMENU_2", 0, 0, 0, 0);
						func_7(Global_388A, "DISPLAY_VIEW", 18f, -1082130432, -1082130432, -1082130432, -1082130432);
						func_4(Global_388A, "SET_HEADER", &(Local_27[iLocal_23 /*6*/]), 0, 0, 0, 0);
						if (Global_3891)
						{
							func_6(Global_388A, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, "CELL_205", 0, 0, 0, 0);
							func_6(Global_388A, "SET_SOFT_KEYS", 3f, 0f, 4f, -1f, -1f, "CELL_206", 0, 0, 0, 0);
						}
						else
						{
							func_6(Global_388A, "SET_SOFT_KEYS", 2f, 0f, 2f, -1f, -1f, 0, 0, 0, 0, 0);
							func_6(Global_388A, "SET_SOFT_KEYS", 3f, 0f, 4f, -1f, -1f, 0, 0, 0, 0, 0);
						}
						func_6(Global_388A, "SET_SOFT_KEYS", 1f, 0f, 1f, -1f, -1f, 0, 0, 0, 0, 0);
						unk_0x7CB6FD92BE491AD9(&Global_93B, 17);
						Global_41C7 = iLocal_23;
						Global_41C3 = 12;
						Global_389D.f_1 = 8;
						func_23();
					}
