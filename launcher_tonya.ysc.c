...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_274(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_259(&Var0, 1);
	}
	...
	unk_0x6C5F5B5F6894CCE3(vLocal_52, 5f, 1, 0, 0, false);
	while (true)
	{
		SYSTEM::WAIT(0);
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x61B0
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x61F7
{
...
bool func_70(int iParam0)//Position - 0x6252
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6262
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x62C2
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x65B6
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x65C1
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x65D1
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x6673
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6C2D
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6C8B
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6D39
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6DCE
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6E12
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6F96
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6FA4
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x7A6B
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7AED
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7B4B
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7B54
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7D27
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7D37
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7FD1
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x7FE2
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x802B
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x80B1
{
...
void func_94(var uParam0, int iParam1)//Position - 0x80E4
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x8135
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x81D7
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x81FC
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x8213
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x8220
{
...
void func_100(var uParam0, int iParam1)//Position - 0x825A
{
...
void func_101(var uParam0, int iParam1)//Position - 0x8295
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x82D1
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x82EA
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x8343
{
...
bool func_105(bool bParam0)//Position - 0x8385
{
...
struct<2> func_106(int iParam0)//Position - 0x83B0
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x87FD
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9AD5
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9E1B
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9EBF
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9F5A
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9FB8
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0xA011
{
...
int func_116(int iParam0)//Position - 0xA094
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA0C5
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA0DA
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA18D
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA1A8
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA1F4
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA23D
{
	if (func_124(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA25D
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA27E
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA34E
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA3A1
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA496
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA501
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA53E
{
	if (bParam0)
	{
...
int func_134(int iParam0, bool bParam1)//Position - 0xA6CF
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA710
{
...
bool func_136()//Position - 0xA752
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA763
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA7BD
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA7E0
{
...
void func_141()//Position - 0xA81D
{
	Global_394A = 0;
	func_142();
}

void func_142()//Position - 0xA82D
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA913
{
...
void func_147(int iParam0)//Position - 0xAAA2
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAB1F
{
...
void func_150(int iParam0)//Position - 0xAB48
{
	if (Global_3943)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xABB8
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAC2C
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAC86
{
...
int func_154(int iParam0)//Position - 0xACC7
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAD0C
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAD3E
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAE75
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAEC4
{
	return func_159(iParam0, Global_8C41);
}

int func_159(int iParam0, int iParam1)//Position - 0xAED5
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xB0B6
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_161()//Position - 0xB0D8
{
	return func_162(unk_0x1377080E9B0BD993(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB0E9
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(var uParam0, int iParam1)//Position - 0xB156
{
	switch (uParam0->f_10)
	{
		case 0:
...
void func_165()//Position - 0xB939
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB954
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB9E2
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xBA46
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xBADD
{
	if (func_124(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_170(int iParam0)//Position - 0xBB07
{
	int iVar0;
...
var func_171()//Position - 0xC225
{
	return Global_16B42.f_1;
}

int func_172()//Position - 0xC233
{
	if (Global_15FA6 != -1)
	{
...
bool func_175()//Position - 0xC29D
{
	return Global_16B4F.f_142 > 0;
}

bool func_176(int iParam0, int iParam1)//Position - 0xC2AE
{
	switch (iParam0)
	{
		case 5:
...
var func_177()//Position - 0xC2E9
{
	return Global_140856;
}

int func_178()//Position - 0xC2F5
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
void func_179(var uParam0)//Position - 0xC311
{
	float fVar0;
	...
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		fVar0 = SYSTEM::VDIST2(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), vLocal_52);
		if (fVar0 < (20f * 20f) && iLocal_56)
		{
			switch (iLocal_57)
			{
				case 0:
					if (!func_143())
					{
						func_196(&uLocal_58, 3, uParam0->f_1C[0], "TONYA", 0, 1);
						if (*uParam0 == 58)
						{
							func_195(&uLocal_58, "TOWAUD", "TONYA_BECK_1", 4, 0, 0, 0);
							if (!unk_0x1D403DFADBC2DE3C(uParam0->f_1C[0], 0))
							{
								...
								unk_0xA8E6405305C0D7DF(uParam0->f_1C[0], iLocal_54);
								unk_0x02DAF06EA4F08219(&iLocal_54);
							}
						}
						else if (*uParam0 == 59)
				...
				case 1:
					if (!func_143())
					{
						if (func_186(&iLocal_223))
						{
							if (!unk_0x1D403DFADBC2DE3C(unk_0xBC25C936A095B5BA(), 0) && !unk_0x1D403DFADBC2DE3C(uParam0->f_1C[0], 0))
							{
								unk_0x56F2E1B5599188FA(uParam0->f_1C[0], unk_0xBC25C936A095B5BA(), -1, 0, 4);
							}
							func_183(&iLocal_223);
							iLocal_57 = 2;
						}
				...
				case 2:
					if (func_186(&iLocal_223))
					{
						if (func_180(&iLocal_223) > unk_0x55AEFCD285ECC0F2(9f, 15f))
						{
							iLocal_226++;
							switch (iLocal_226)
							{
...
float func_180(int iParam0)//Position - 0xD0C2
{
	if (func_186(iParam0))
	{
		if (func_182(iParam0))
		...
		{
			return (func_181(unk_0xFA30DFD0084E92FE(*iParam0, 4)) - iParam0->f_1);
		}
	}
	return iParam0->f_1;
}

float func_181(bool bParam0)//Position - 0xD101
{
	float fVar0;
	float fVar1;
	int iVar2;
...
bool func_182(int iParam0)//Position - 0xD159
{
	return unk_0xFA30DFD0084E92FE(*iParam0, 2);
}

void func_183(int iParam0)//Position - 0xD169
{
	func_184(iParam0, 0f);
}

void func_184(int iParam0, float fParam1)//Position - 0xD178
{
	iParam0->f_1 = (func_181(unk_0xFA30DFD0084E92FE(*iParam0, 4)) - fParam1);
	unk_0xF0059F27F7BB6680(iParam0, 1);
	unk_0x7CB6FD92BE491AD9(iParam0, 2);
	iParam0->f_2 = 0f;
}

void func_185(int iParam0)//Position - 0xD1A6
{
	if (!func_186(iParam0))
	{
		func_183(iParam0);
...
bool func_186(int iParam0)//Position - 0xD1BE
{
	return unk_0xFA30DFD0084E92FE(*iParam0, 1);
}

int func_187(var uParam0, char* sParam1, char* sParam2, char* sParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD1CE
{
...
int func_188(char* sParam0, int iParam1, bool bParam2)//Position - 0xD222
{
	Global_3DB9 = 0;
...
void func_194(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD748
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
int func_195(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0xD79E
{
...
void func_196(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xD7EC
{
...
void func_197(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xD887
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_201(unk_0xBC25C936A095B5BA(), vParam2, 1) <= 100f)
				{
					func_200(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_201(unk_0xBC25C936A095B5BA(), vParam2, 1) > 120f)
				{
					func_203(iParam0);
				}
			}
...
void func_198(int iParam0, bool bParam1)//Position - 0xD978
{
	if (iParam0 == -1)
	{
		return;
...
int func_199(int iParam0)//Position - 0xD9B4
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_200(int iParam0, int iParam1)//Position - 0xD9ED
{
	bool bVar0;
	int iVar1;
...
float func_201(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xDA8B
{
	vector3 vVar0;
...
bool func_202()//Position - 0xDAC5
{
	return Global_16129;
}

void func_203(int iParam0)//Position - 0xDAD1
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_204(iParam0);
...
void func_204(int iParam0)//Position - 0xDAE8
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_205(int iParam0)//Position - 0xDBD0
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_206(int iParam0, bool bParam1)//Position - 0xDBF8
{
	struct<27> Var0;
	...
	func_107(*iParam0, &Var0);
	if ((func_243(*iParam0) || func_241(*iParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
	...
	if (func_210(&(iParam0->f_30)) && bParam1)
	{
		func_207(iParam0->f_1C[0], &(iParam0->f_30), *iParam0);
	}
	return 1;
}

void func_207(int iParam0, var uParam1, int iParam2)//Position - 0xDE6B
{
	int iVar0;
	int iVar1;
		...
		switch (uParam1->f_3)
		{
			...
			case 2:
				if (!func_209(uParam1) || !unk_0x96044E39418AAF17(iParam0, *uParam1, uParam1->f_2, 3))
				{
					...
					else if ((func_209(uParam1) && uParam1->f_4 == 0) && unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(iParam0, true), true) < 20f)
					{
						uParam1->f_3 = 3;
					}
				}
...
int func_208(int iParam0)//Position - 0xE1C3
{
...
int func_209(var uParam0)//Position - 0xE1E3
{
...
int func_210(var uParam0)//Position - 0xE1FB
{
...
void func_211(var uParam0)//Position - 0xE220
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_212(&(uParam0->f_29[1]));
		func_212(&(uParam0->f_29[2]));
	}
...
void func_212(int iParam0)//Position - 0xE524
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_213(var uParam0)//Position - 0xE54F
{
	int iVar0;
...
int func_214(var uParam0, bool bParam1, bool bParam2)//Position - 0xE5CF
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_215(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_215(int iParam0, int iParam1)//Position - 0xE78D
{
	int iVar0;
...
int func_216(var uParam0, bool bParam1, int iParam2)//Position - 0xE7BD
{
	int iVar0;
	int iVar1;
...
int func_217(int iParam0)//Position - 0xEA79
{
...
int func_218(int iParam0, float fParam1)//Position - 0xEAAD
{
	float fVar0;
...
bool func_219(int iParam0, float fParam1)//Position - 0xEB23
{
	return func_220(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_220(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xEB3B
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_221(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xEBFC
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_222(int iParam0, int iParam1)//Position - 0xED28
{
	int iVar0;
...
int func_224(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xEE37
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_226(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_226(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_225(vector3 vParam0, vector3 vParam1)//Position - 0xEEC8
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_226(vector3 vParam0)//Position - 0xEEE9
{
	float fVar0;
	float fVar1;
...
void func_227(var uParam0)//Position - 0xEF28
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_228(int iParam0, int iParam1)//Position - 0xEF43
{
	int iVar0;
...
int func_229(int iParam0)//Position - 0xEF82
{
...
int func_230(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xEFAA
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_231(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xF0A5
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_232(int iParam0, float fParam1)//Position - 0xF1B1
{
	var uVar0;
	vector3 vVar1;
...
int func_233(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xF246
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_226(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_234(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xF2D4
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_235(int iParam0)//Position - 0xF31C
{
...
void func_236(int iParam0)//Position - 0xF366
{
	int iVar0;
...
int func_237(int iParam0)//Position - 0xF403
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_238(int iParam0)//Position - 0xF49B
{
...
int func_241(int iParam0)//Position - 0xF51D
{
	if ((func_242() && Global_16B1B.f_B == 6) && iParam0 == func_162(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_243(int iParam0)//Position - 0xF58F
{
	if (func_105(0))
	{
...
int func_244(int iParam0)//Position - 0xF5B7
{
	if (!func_245(iParam0))
	{
		return 0;
	}
	iLocal_53 = unk_0x1DAA351326EA3537(vLocal_52 - Vector(10f, 10f, 10f), vLocal_52 + Vector(10f, 10f, 10f), 0, 1, 1, 1);
	iLocal_55 = 1;
	func_275("Created initial scene");
	return 1;
}

int func_245(var uParam0)//Position - 0xF60B
{
	bool bVar0;
	int iVar1;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			{
				uParam0->f_1C[0] = unk_0x01B3635C3E8EDD81(5, joaat("ig_tonya"), -16.53f, -1473.12f, 29.61f, 319.56f, 1, true);
				if (func_124(uParam0->f_1C[0]))
				{
					unk_0x2E35C4FA5F0ED22F(uParam0->f_1C[0], true);
					unk_0xB71D41C0310C93DE(uParam0->f_1C[0], true, 1);
					unk_0x23180B0A9E8D2951(joaat("ig_tonya"), true);
		...
		case 3:
			if (func_124(uParam0->f_1C[0]) && unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
			{
				unk_0x02DAF06EA4F08219(&iVar1);
				unk_0xC5A6DFE2B8987B17(&iVar1);
				...
				unk_0x535008C596714F9E(iVar1);
				unk_0xA8E6405305C0D7DF(uParam0->f_1C[0], iVar1);
				unk_0x02DAF06EA4F08219(&iVar1);
				unk_0x56F2E1B5599188FA(uParam0->f_1C[0], unk_0xBC25C936A095B5BA(), -1, 0, 4);
			}
...
int func_246(int iParam0)//Position - 0xF8C1
{
	int iVar0;
...
int func_247(int iParam0)//Position - 0xF929
{
	struct<27> Var0;
	int iVar1;
...
int func_248(int iParam0)//Position - 0xF97D
{
	char* sVar0;
...
int func_249(int iParam0)//Position - 0xFA36
{
	var uVar0;
...
int func_250(int iParam0)//Position - 0xFAF7
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_251(int iParam0, char* sParam1)//Position - 0xFB7C
{
...
bool func_252(int iParam0)//Position - 0xFC5E
{
...
bool func_253(int iParam0)//Position - 0xFC8C
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_254(int iParam0)//Position - 0xFCBA
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_255(int iParam0)//Position - 0xFCE8
{
	if (func_238(iParam0))
	{
		return 0;
...
int func_256(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xFD1D
{
	int iVar0;
...
int func_257(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xFD82
{
	int iVar0;
	struct<7> Var1;
...
int func_258(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xFE00
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_259(int iParam0, bool bParam1)//Position - 0xFE7B
{
	func_272();
	if (bParam1)
	{
...
void func_260(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xFF4F
{
...
void func_261(var uParam0, bool bParam1)//Position - 0xFF6F
{
	func_262(&(uParam0->f_29), bParam1);
}

void func_262(var uParam0, bool bParam1)//Position - 0xFF81
{
	int iVar0;
...
void func_263(int iParam0, bool bParam1)//Position - 0xFFBF
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_264(var uParam0, bool bParam1)//Position - 0xFFFA
{
	func_265(&(uParam0->f_23), bParam1);
}

void func_265(var uParam0, bool bParam1)//Position - 0x1000D
{
	int iVar0;
...
void func_266(int iParam0)//Position - 0x1004A
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_267(int iParam0)//Position - 0x10082
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_268(var uParam0, int iParam1)//Position - 0x1011E
{
	func_269(&(uParam0->f_1C), iParam1);
}

void func_269(var uParam0, int iParam1)//Position - 0x10130
{
	int iVar0;
...
void func_270(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10171
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_271(int iParam0)//Position - 0x101C1
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_272()//Position - 0x10202
{
	Global_394A = 0;
	func_273();
}

void func_273()//Position - 0x10212
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
void func_274(var uParam0)//Position - 0x10233
{
	if (*uParam0 == -1)
	{
		return;
...
void func_275(char* sParam0)//Position - 0x10270
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_276(var uParam0)//Position - 0x10282
{
	*uParam0 = -1;
