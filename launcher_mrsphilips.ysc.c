...
void __EntryFunction__()//Position - 0x0
{
	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_254(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_241(&Var0, 1);
	}
	...
	func_226(&Var0);
	iLocal_52 = unk_0x1DAA351326EA3537(vVar1 - Vector(20f, 20f, 20f), vVar1 + Vector(20f, 20f, 20f), 0, 1, 1, 1);
...
bool func_105(bool bParam0)//Position - 0x8312
{
...
struct<2> func_106(int iParam0)//Position - 0x833D
{
	struct<2> Var0;
...
int func_109(int iParam0)//Position - 0x99CF
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9D15
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9DB9
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9E54
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9EB2
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9F0B
{
...
int func_116(int iParam0)//Position - 0x9F8E
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0x9FBF
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0x9FD4
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA087
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA0A2
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA0EE
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA137
{
	if (func_124(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA157
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA178
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA248
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA29B
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA390
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA3FB
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA438
{
	if (bParam0)
	{
...
int func_134(int iParam0, bool bParam1)//Position - 0xA5C9
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA60A
{
...
bool func_136()//Position - 0xA64C
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA65D
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA6B7
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA6DA
{
...
void func_141()//Position - 0xA717
{
	Global_394A = 0;
	func_142();
}

void func_142()//Position - 0xA727
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA80D
{
...
void func_147(int iParam0)//Position - 0xA99C
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAA19
{
...
void func_150(int iParam0)//Position - 0xAA42
{
	if (Global_3943)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAAB2
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAB26
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAB80
{
...
int func_154(int iParam0)//Position - 0xABC1
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAC06
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAC38
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAD6F
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xADBE
{
	return func_159(iParam0, Global_8C41);
}

int func_159(int iParam0, int iParam1)//Position - 0xADCF
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xAFB0
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_161()//Position - 0xAFD2
{
	return func_162(unk_0x1377080E9B0BD993(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xAFE3
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(var uParam0, int iParam1)//Position - 0xB050
{
	switch (uParam0->f_10)
	{
		case 0:
...
void func_165()//Position - 0xB833
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB84E
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB8DC
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xB940
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xB9D7
{
	if (func_124(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_170(int iParam0)//Position - 0xBA01
{
	int iVar0;
...
var func_171()//Position - 0xC120
{
	return Global_16B42.f_1;
}

int func_172()//Position - 0xC12E
{
	if (Global_15FA6 != -1)
	{
...
bool func_175()//Position - 0xC198
{
	return Global_16B4F.f_142 > 0;
}

bool func_176(int iParam0, int iParam1)//Position - 0xC1A9
{
	switch (iParam0)
	{
		case 5:
...
var func_177()//Position - 0xC1E4
{
	return Global_140856;
}

int func_178()//Position - 0xC1F0
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
void func_179(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC20C
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
...
void func_180(int iParam0, bool bParam1)//Position - 0xC2FD
{
	if (iParam0 == -1)
	{
		return;
...
int func_181(int iParam0)//Position - 0xC339
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_182(int iParam0, int iParam1)//Position - 0xC372
{
	bool bVar0;
	int iVar1;
...
float func_183(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC410
{
	vector3 vVar0;
...
bool func_184()//Position - 0xC44A
{
	return Global_16129;
}

void func_185(int iParam0)//Position - 0xC456
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_186(iParam0);
...
void func_186(int iParam0)//Position - 0xC46D
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_187(int iParam0)//Position - 0xC555
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_188(var uParam0, bool bParam1)//Position - 0xC57D
{
	struct<27> Var0;
...
void func_189(int iParam0, var uParam1, int iParam2)//Position - 0xC7F0
{
	int iVar0;
	int iVar1;
...
int func_190(int iParam0)//Position - 0xCB48
{
...
int func_191(var uParam0)//Position - 0xCB68
{
...
int func_192(var uParam0)//Position - 0xCB80
{
...
void func_193(var uParam0)//Position - 0xCBA5
{
	int iVar0;
	int iVar1;
...
void func_194(int iParam0)//Position - 0xCEA9
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_195(var uParam0)//Position - 0xCED4
{
	int iVar0;
...
int func_196(var uParam0, bool bParam1, bool bParam2)//Position - 0xCF54
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_197(int iParam0, int iParam1)//Position - 0xD112
{
	int iVar0;
...
int func_198(var uParam0, bool bParam1, int iParam2)//Position - 0xD142
{
	int iVar0;
	int iVar1;
...
int func_199(int iParam0)//Position - 0xD3FE
{
...
int func_200(int iParam0, float fParam1)//Position - 0xD432
{
	float fVar0;
...
bool func_201(int iParam0, float fParam1)//Position - 0xD4A8
{
	return func_202(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_202(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD4C0
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_203(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD581
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_204(int iParam0, int iParam1)//Position - 0xD6AD
{
	int iVar0;
...
int func_206(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xD7BC
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_207(vector3 vParam0, vector3 vParam1)//Position - 0xD84D
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_208(vector3 vParam0)//Position - 0xD86E
{
	float fVar0;
	float fVar1;
...
void func_209(var uParam0)//Position - 0xD8AD
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_210(int iParam0, int iParam1)//Position - 0xD8C8
{
	int iVar0;
...
int func_211(int iParam0)//Position - 0xD907
{
...
int func_212(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xD92F
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_213(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDA2A
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_214(int iParam0, float fParam1)//Position - 0xDB36
{
	var uVar0;
	vector3 vVar1;
...
int func_215(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xDBCB
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_216(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDC59
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_217(int iParam0)//Position - 0xDCA1
{
...
void func_218(int iParam0)//Position - 0xDCEB
{
	int iVar0;
...
int func_219(int iParam0)//Position - 0xDD88
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_220(int iParam0)//Position - 0xDE20
{
...
int func_223(int iParam0)//Position - 0xDEA2
{
...
int func_225(int iParam0)//Position - 0xDF14
{
	if (func_105(0))
	{
...
void func_226(int iParam0)//Position - 0xDF3C
{
	if (!unk_0x684B06333594F9EA())
	{
...
void func_227(int iParam0)//Position - 0xDF69
{
	iParam0->f_10 = 5;
...
int func_228(int iParam0)//Position - 0xDFBE
{
	struct<27> Var0;
	int iVar1;
...
int func_229(int iParam0)//Position - 0xE012
{
	char* sVar0;
...
int func_230(int iParam0)//Position - 0xE0CB
{
	var uVar0;
...
int func_231(int iParam0)//Position - 0xE18C
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_232(int iParam0, char* sParam1)//Position - 0xE211
{
...
bool func_233(int iParam0)//Position - 0xE2F1
{
...
bool func_234(int iParam0)//Position - 0xE31F
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_235(int iParam0)//Position - 0xE34D
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_236(int iParam0)//Position - 0xE37B
{
	if (func_220(iParam0))
	{
		return 0;
...
void func_237()//Position - 0xE3B0
{
	func_255("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_238(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE3CA
{
	int iVar0;
...
int func_239(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xE42F
{
	int iVar0;
	struct<7> Var1;
...
int func_240(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xE4AD
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_241(int iParam0, bool bParam1)//Position - 0xE528
{
	if (bParam1)
	{
...
void func_242(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xE57C
{
...
void func_243(var uParam0, bool bParam1)//Position - 0xE59C
{
	func_244(&(uParam0->f_29), bParam1);
}

void func_244(var uParam0, bool bParam1)//Position - 0xE5AE
{
	int iVar0;
...
void func_245(int iParam0, bool bParam1)//Position - 0xE5EC
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_246(var uParam0, bool bParam1)//Position - 0xE627
{
	func_247(&(uParam0->f_23), bParam1);
}

void func_247(var uParam0, bool bParam1)//Position - 0xE639
{
	int iVar0;
...
void func_248(int iParam0)//Position - 0xE676
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_249(int iParam0)//Position - 0xE6AE
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_250(var uParam0, int iParam1)//Position - 0xE74A
{
	func_251(&(uParam0->f_1C), iParam1);
}

void func_251(var uParam0, int iParam1)//Position - 0xE75C
{
	int iVar0;
...
void func_252(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xE79D
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_253(int iParam0)//Position - 0xE7ED
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_254(var uParam0)//Position - 0xE82E
{
	if (*uParam0 == -1)
	{
		return;
...
void func_255(char* sParam0)//Position - 0xE86B
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_256(var uParam0)//Position - 0xE87D
{
	*uParam0 = -1;
