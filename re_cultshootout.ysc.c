...
void __EntryFunction__()//Position - 0x0
{
	...
	{
		SYSTEM::WAIT(0);
		if ((unk_0x684B06333594F9EA() || iLocal_60) || (func_105() && unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_46, 500f, 500f, 500f, false, true, 0)))
		{
			if (!func_105())
			{
				if (func_104())
...
void func_1()//Position - 0x18C
{
	if (iLocal_54 && !iLocal_53)
	{
		...
		while (iLocal_71 < 6)
		{
			if (!unk_0x36CEFBE9B745A58D(iLocal_63[iLocal_71]))
			{
				if (unk_0x2DA8CA50A72528FB(uLocal_68[iLocal_71]))
				{
					unk_0x07B8ECB35A4ED3AC(&(uLocal_68[iLocal_71]));
				}
				unk_0x02537C8C1BEEB477(&(iLocal_63[iLocal_71]));
			}
			iLocal_71++;
		}
	...
	if (SYSTEM::VDIST(func_2(unk_0xB5CEFD608600A09F()), vLocal_46) > 150f)
	{
		func_136();
	}
}
...
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_6(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}
...
{
	Global_19B04.f_6186.f_7 = iParam0;
}
...
void func_24()//Position - 0x866
{
	...
	{
		case 0:
			if (unk_0xA901403F1DB7A780(iLocal_65))
			{
				if (unk_0x2DA8CA50A72528FB(iLocal_66))
				{
					if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0))
					{
						func_66();
						if (!bLocal_61)
						{
			...
			if (bLocal_61)
			{
				if ((unk_0x105601648511CC64() - iLocal_76) > 6000)
				{
					if (!iLocal_62)
					{
		...
		case 1:
			if ((((unk_0x36CEFBE9B745A58D(iLocal_63[0]) && unk_0x36CEFBE9B745A58D(iLocal_63[1])) && unk_0x36CEFBE9B745A58D(iLocal_63[2])) && unk_0x36CEFBE9B745A58D(iLocal_63[3])) && unk_0x36CEFBE9B745A58D(iLocal_63[4]))
			{
				func_25();
			}
			else if (!unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), vLocal_46, 100f, 100f, 100f, false, true, 0))
			{
				func_25();
			}
			break;
...
void func_32()//Position - 0xC74
{
	...
	{
		func_34(13, SYSTEM::FLOOR(Global_19B04.f_27B5.f_F0D));
	}
...
int func_36()//Position - 0x16A0
{
	return Global_1407E0;
}

int func_37(int iParam0, int iParam1)//Position - 0x16AC
{
	switch (iParam0)
	{
		case 0:
...
int func_38(int iParam0)//Position - 0x1A20
{
	switch (iParam0)
	{
		case 29:
...
void func_39(int iParam0)//Position - 0x1A4F
{
	int iVar0;
	int iVar1;
...
void func_40(char* sParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8)//Position - 0x1A91
{
	func_41(sParam0, "", iParam1, iParam2, iParam3, iParam4, iParam5, iParam6, iParam7, iParam8);
}

void func_41(char* sParam0, char* sParam1, var uParam2, int iParam3, int iParam4, int iParam5, int iParam6, int iParam7, int iParam8, var uParam9)//Position - 0x1AB2
{
	int iVar0;
...
void func_44()//Position - 0x1DEB
{
	...
	if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
	{
		if (func_48(Global_19B04.f_932.f_21B.f_10CD) != unk_0x6F79ECA8C83E4357(unk_0xBC25C936A095B5BA()))
		{
			...
			if (func_46(iVar0) && (!func_45(14) || Global_196EB))
			{
...
bool func_45(int iParam0)//Position - 0x1EE8
{
	return Global_8C41 == iParam0;
}

bool func_46(int iParam0)//Position - 0x1EF6
{
	return iParam0 < 3;
}

int func_47(int iParam0)//Position - 0x1F02
{
	int iVar0;
	int iVar1;
...
int func_48(int iParam0)//Position - 0x1F3F
{
	if (func_46(iParam0))
	{
...
int func_49(int iParam0)//Position - 0x1F69
{
	int iVar0;
	int iVar1;
...
void func_50(int iParam0, int iParam1)//Position - 0x1FAC
{
	unk_0xF0059F27F7BB6680(&(Global_19B04.f_6186.f_8[iParam0]), iParam1);
}

int func_51(int iParam0)//Position - 0x1FC7
{
	int iVar0;
...
int func_53(char[4] cParam0, char[4] cParam1, char[4] cParam2, char[4] cParam3, char[4] cParam4, char[4] cParam5, char[4] cParam6, char[4] cParam7, char[4] cParam8, char[4] cParam9, char[4] cParam10, char[4] cParam11, char[4] cParam12, char[4] cParam13, char[4] cParam14, char[4] cParam15)//Position - 0x2095
{
...
int func_54()//Position - 0x226F
{
	return 1;
}

int func_55()//Position - 0x2278
{
...
void func_56(char* sParam0, int iParam1)//Position - 0x229A
{
	unk_0x2F618BD43614DD0D(sParam0);
	unk_0x72F8FA06CC9EC899(0, 0, true, iParam1);
}

int func_57(int iParam0)//Position - 0x22B1
{
	if (func_60())
	{
		Global_19AFA = 1;
		Global_19AF7 = unk_0x105601648511CC64();
		if (func_38(Global_19AF9))
		{
			func_58(0);
		}
		unk_0x3FF92BBF0607A406(1, "RE_TITLE");
		if (iParam0 && func_38(Global_19AF9))
		{
...
void func_58(int iParam0)//Position - 0x2304
{
	switch (iParam0)
	{
		case 0:
...
char* func_59(int iParam0)//Position - 0x23E5
{
	char* sVar0;
...
int func_61(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0x245E
{
	int iVar0;
...
void func_62(var uParam0, int iParam1)//Position - 0x2595
{
	int iVar0;
...
bool func_63(int iParam0)//Position - 0x25E4
{
	return func_64(iParam0, Global_8C41);
}

int func_64(int iParam0, int iParam1)//Position - 0x25F5
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_65(int iParam0)//Position - 0x27D6
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_67(int iParam0)//Position - 0x282A
{
	int iVar0;
	...
	unk_0x3F5F1772D71D5EC4(iVar0, func_68(unk_0x7AF0088ABFA713B6(), 0.7f, 0.7f));
	return iVar0;
}

float func_68(bool bParam0, float fParam1, float fParam2)//Position - 0x2862
{
	if (bParam0)
	{
		return fParam1;
...
void func_69()//Position - 0x2879
{
	if (unk_0xF1B911222059B1A1(iLocal_65))
	{
		if (unk_0x2DA8CA50A72528FB(iLocal_66))
		{
			unk_0x07B8ECB35A4ED3AC(&iLocal_66);
...
void func_70()//Position - 0x28A7
{
	...
	while (iLocal_71 < 6)
	{
		...
		{
			if ((func_89() && iLocal_73 != 2) || (iLocal_73 == 1 && unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA())))
			{
				func_87();
				SYSTEM::WAIT(0);
				if (func_86())
			...
			switch (iLocal_73)
			{
				case 0:
					...
					{
						if ((unk_0xE642C1AC73CE364E(iLocal_63[iLocal_71], unk_0xBC25C936A095B5BA(), 15f, 15f, 40f, 0, 1, 0) && unk_0x0921C54CF8DFC6E7(unk_0xB5CEFD608600A09F(), iLocal_63[iLocal_71])) || unk_0x1028B6250119A74B(iLocal_63[iLocal_71], unk_0xBC25C936A095B5BA()))
						{
							if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0) || unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), 2205.918f, 5633.455f, 55.7472f, 15f, 15f, 40f, false, true, 0))
							{
								if (!func_55())
								{
								...
								{
									unk_0x3D669AF9A68FF281(iLocal_63[iLocal_71]);
									unk_0xC5A6DFE2B8987B17(&iLocal_70);
									unk_0x56F2E1B5599188FA(0, unk_0xBC25C936A095B5BA(), -1, 0, 2);
									unk_0xD0231395241DBA85(0, unk_0xBC25C936A095B5BA(), unk_0xBC25C936A095B5BA(), 1f, 0, 4f, 1082130432, 1, 0, -957453492);
									unk_0x57D65255D3D3B6A7(0, unk_0xBC25C936A095B5BA(), -1, 0);
									unk_0x535008C596714F9E(iLocal_70);
									unk_0xA8E6405305C0D7DF(iLocal_63[iVar0], iLocal_70);
									unk_0x02DAF06EA4F08219(&iLocal_70);
									unk_0x69194304DB679A9C(iLocal_63[iVar0], true, -1, 0);
									iVar0++;
								}
				...
				case 1:
					...
					while (iVar1 < iLocal_63)
					{
						if (!iLocal_56[iVar1])
						{
							...
							unk_0x57D65255D3D3B6A7(0, unk_0xBC25C936A095B5BA(), -1, 0);
							unk_0x535008C596714F9E(iLocal_70);
							unk_0xA8E6405305C0D7DF(iLocal_63[iVar1], iLocal_70);
							unk_0x02DAF06EA4F08219(&iLocal_70);
							unk_0x69194304DB679A9C(iLocal_63[iVar1], true, -1, 0);
							iLocal_56[iVar1] = 1;
						}
						iVar1++;
					}
					if (!unk_0x36CEFBE9B745A58D(iLocal_63[iLocal_71]))
					{
						if (!unk_0xC5B8A5F778E321DD(iLocal_63[iLocal_71], unk_0xBC25C936A095B5BA(), 50f))
						{
							unk_0x56F2E1B5599188FA(iLocal_63[iLocal_71], unk_0xBC25C936A095B5BA(), -1, 0, 2);
							unk_0x22321800954A532E(iLocal_63[iLocal_71], true);
						}
					}
					...
					{
						if ((unk_0x105601648511CC64() - iLocal_76) > 12000)
						{
							if (!func_55())
							{
								func_85(&uLocal_77, 3, iLocal_63[iLocal_71], "SalvadorGang", 0, 1);
					...
					if (iLocal_56[iLocal_71])
					{
						if (((unk_0x105601648511CC64() - iLocal_76) > 18000 || (iLocal_75 - iLocal_74) > 5000) || unk_0x8F97799512B006B7(iLocal_63[iLocal_71], 0))
						{
							if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0) || unk_0xE642C1AC73CE364E(iLocal_63[iLocal_71], unk_0xBC25C936A095B5BA(), 15f, 15f, 5f, 0, 1, 0))
							{
								func_87();
								SYSTEM::WAIT(0);
								if (func_86())
							...
							{
								if (!unk_0x8F97799512B006B7(iLocal_63[iLocal_71], 0))
								{
									unk_0xA4E856A8CD53B8DF(iLocal_63[iLocal_71]);
									if (!unk_0x36CEFBE9B745A58D(iLocal_63[0]))
									{
										unk_0xC5A6DFE2B8987B17(&iLocal_70);
										...
										unk_0xAFD74A5E065F57E0(iLocal_70, 1);
										unk_0x535008C596714F9E(iLocal_70);
										unk_0xA8E6405305C0D7DF(iLocal_63[0], iLocal_70);
										unk_0x02DAF06EA4F08219(&iLocal_70);
										unk_0x69194304DB679A9C(iLocal_63[0], false, -1, 0);
									}
									if (!unk_0x36CEFBE9B745A58D(iLocal_63[1]))
									{
										unk_0xC5A6DFE2B8987B17(&iLocal_70);
										...
										unk_0xAFD74A5E065F57E0(iLocal_70, 1);
										unk_0x535008C596714F9E(iLocal_70);
										unk_0xA8E6405305C0D7DF(iLocal_63[1], iLocal_70);
										unk_0x02DAF06EA4F08219(&iLocal_70);
										unk_0x69194304DB679A9C(iLocal_63[1], false, -1, 0);
									}
									if (!unk_0x36CEFBE9B745A58D(iLocal_63[2]))
									{
										unk_0xC5A6DFE2B8987B17(&iLocal_70);
										...
										unk_0xAFD74A5E065F57E0(iLocal_70, 1);
										unk_0x535008C596714F9E(iLocal_70);
										unk_0xA8E6405305C0D7DF(iLocal_63[2], iLocal_70);
										unk_0x02DAF06EA4F08219(&iLocal_70);
										unk_0x69194304DB679A9C(iLocal_63[2], false, -1, 0);
									}
									if (!unk_0x36CEFBE9B745A58D(iLocal_63[3]) && !unk_0x36CEFBE9B745A58D(iLocal_63[4]))
									{
										unk_0xC5A6DFE2B8987B17(&iLocal_70);
										unk_0x9565F9267674873A(0, iLocal_63[4], -1, 2f, 1f, 1073741824, 0);
										unk_0x85DB484A637CEAB9(0, iLocal_63[4], 0);
										unk_0xA3A7138EAD2268A0(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										unk_0x535008C596714F9E(iLocal_70);
										unk_0xA8E6405305C0D7DF(iLocal_63[3], iLocal_70);
										unk_0x02DAF06EA4F08219(&iLocal_70);
										unk_0x69194304DB679A9C(iLocal_63[3], false, -1, 0);
									}
									if (!unk_0x36CEFBE9B745A58D(iLocal_63[4]))
									{
										unk_0xC5A6DFE2B8987B17(&iLocal_70);
										unk_0x9565F9267674873A(0, iLocal_63[3], -1, 2f, 1f, 1073741824, 0);
										unk_0x85DB484A637CEAB9(0, iLocal_63[3], 0);
										unk_0xA3A7138EAD2268A0(0, "WORLD_HUMAN_HANG_OUT_STREET", 0, 1);
										unk_0x535008C596714F9E(iLocal_70);
										unk_0xA8E6405305C0D7DF(iLocal_63[4], iLocal_70);
										unk_0x02DAF06EA4F08219(&iLocal_70);
										unk_0x69194304DB679A9C(iLocal_63[4], false, -1, 0);
									}
									if (!unk_0x36CEFBE9B745A58D(iLocal_63[5]))
									{
										unk_0x2513C0D7A88E6C01(iLocal_63[5], 0f, 3f, 1);
										unk_0x69194304DB679A9C(iLocal_63[5], false, -1, 0);
									}
								}
								iVar1 = 0;
				...
				case 2:
					...
					while (iLocal_71 < 6)
					{
						if (!unk_0x36CEFBE9B745A58D(iLocal_63[iLocal_71]))
						{
							...
							{
								unk_0x3D669AF9A68FF281(iLocal_63[iLocal_71]);
								unk_0xB8CBD998685C0685(iLocal_63[iLocal_71], unk_0xBC25C936A095B5BA(), 0, 16);
								unk_0x22321800954A532E(iLocal_63[iLocal_71], true);
								if (!unk_0x2DA8CA50A72528FB(uLocal_68[iLocal_71]))
								{
...
int func_71(int iParam0, bool bParam1, int iParam2)//Position - 0x3112
{
	int iVar0;
...
int func_72(int iParam0, bool bParam1, bool bParam2)//Position - 0x3164
{
	int iVar0;
	...
	{
		unk_0x3F5F1772D71D5EC4(iVar0, func_68(unk_0x7AF0088ABFA713B6(), 1f, 1f));
		if (!bParam2)
		{
...
int func_73(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5, int iParam6)//Position - 0x3208
{
...
int func_74(char* sParam0, int iParam1, bool bParam2)//Position - 0x3256
{
	Global_3DB9 = 0;
...
int func_80()//Position - 0x374A
{
	func_44();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_81()//Position - 0x3763
{
	int iVar0;
...
bool func_82(int iParam0, int iParam1)//Position - 0x37BA
{
	switch (iParam0)
	{
		case 5:
...
void func_84(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, var uParam5)//Position - 0x384C
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_85(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0x38A2
{
...
bool func_86()//Position - 0x393D
{
	return Global_19B04.f_6186.f_7;
}

void func_87()//Position - 0x394E
{
	Global_394A = 0;
	func_88();
}

void func_88()//Position - 0x395E
{
	unk_0x5C7DC611411E2CF9();
	Global_41AB = 0;
	if (unk_0xE6711F601F11B66B())
...
int func_89()//Position - 0x397F
{
	...
	{
		if (unk_0xE59B7F5A03335350(iLocal_64[iVar0], 0))
		{
			if (unk_0xD9C1758D86688CEA(iLocal_64[iVar0], unk_0xBC25C936A095B5BA(), 1))
			{
				return 1;
			}
		}
	...
	while (iVar0 < iLocal_63)
	{
		...
		{
			if (unk_0x1028B6250119A74B(iLocal_63[iVar0], unk_0xBC25C936A095B5BA()))
			{
				if (unk_0xDF25D3BB3759E7D1(unk_0xB5CEFD608600A09F(), iLocal_63[iVar0]) || unk_0x425BEBAA53B39EBF(unk_0xB5CEFD608600A09F(), iLocal_63[iVar0]))
				{
					return 1;
				}
			}
			if ((((((unk_0x04880508C862E589(unk_0x541C2AEF053615BC(iLocal_63[iVar0], true), 5f, 1) || unk_0xD9C1758D86688CEA(iLocal_63[iVar0], unk_0xBC25C936A095B5BA(), 1)) || unk_0xE921F8171F0733B3(unk_0xBC25C936A095B5BA(), iLocal_63[iVar0])) || unk_0x1749F74D4E70A733(unk_0x541C2AEF053615BC(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), unk_0x541C2AEF053615BC(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_smokegrenade"), 1)) || unk_0x1749F74D4E70A733(unk_0x541C2AEF053615BC(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), unk_0x541C2AEF053615BC(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_grenade"), 1)) || unk_0x1749F74D4E70A733(unk_0x541C2AEF053615BC(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), unk_0x541C2AEF053615BC(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_grenadelauncher"), 1)) || unk_0x1749F74D4E70A733(unk_0x541C2AEF053615BC(iLocal_63[iVar0], true) - Vector(15f, 15f, 15f), unk_0x541C2AEF053615BC(iLocal_63[iVar0], true) + Vector(15f, 15f, 15f), joaat("weapon_stickybomb"), 1))
			{
				return 1;
			}
		}
	...
	if (unk_0x6E65ED1DEEDEE6F8(-1, vLocal_49, vLocal_50, fLocal_51))
	{
		return 1;
	}
	if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), vLocal_49, vLocal_50, fLocal_51, 0, true, 0))
	...
	if (unk_0x4DBCE270B354E123(unk_0xBC25C936A095B5BA(), 2202.498f, 5603.424f, 52.7476f, 20f, 20f, 20f, false, true, 0))
	{
...
void func_90()//Position - 0x3BF2
{
	...
	{
		unk_0x1DAA351326EA3537(vLocal_46 - Vector(20f, 50f, 50f), vLocal_46 + Vector(20f, 50f, 50f), 0, 1, 1, 1);
		unk_0x8510BC031C24B862(joaat("bobcatxl"), true);
		unk_0xDF53A66AEE1401AA(0f);
		unk_0xE85B33FB221A23CD(3, false);
		iLocal_64[0] = unk_0x61C05BF08A1E0EFE(joaat("bobcatxl"), 2209.17f, 5572.897f, 52.7565f, 255.5161f, true, true, false);
		unk_0x77815D3407C6700D(iLocal_64[0], true, 0);
		unk_0xF0A40F19AAB79E88(iLocal_64[0], 1084227584);
		unk_0xE54F7105CEA81918(iLocal_64[0], 1, true);
		iLocal_64[1] = unk_0x61C05BF08A1E0EFE(joaat("bobcatxl"), 2195.473f, 5607.506f, 52.5648f, 168.4012f, true, true, false);
		unk_0x77815D3407C6700D(iLocal_64[1], true, 0);
		unk_0xE54F7105CEA81918(iLocal_64[1], 1, false);
		iVar0 = 0;
		unk_0xF0059F27F7BB6680(&iVar0, 1);
		iLocal_65 = unk_0x37B86314BDCAA6F0(joaat("pickup_money_case"), vLocal_47, -1.368082f, 0.230633f, 176.8749f, iVar0, unk_0x491B2241281A03B7(40000, 100000), 2, 1, joaat("prop_cash_case_01"));
		...
		unk_0xB2CB6EAA6B280A84("DrugCult", &iLocal_69);
		unk_0xA902E18EDF6FA0C8(3, iLocal_69, -1533126372);
		unk_0xA902E18EDF6FA0C8(3, -1533126372, iLocal_69);
		unk_0xA902E18EDF6FA0C8(5, iLocal_69, 1862763509);
		iLocal_71 = 0;
		while (iLocal_71 < 6)
		{
			iLocal_63[iLocal_71] = unk_0x01B3635C3E8EDD81(26, joaat("g_m_y_salvagoon_01"), vLocal_48[iLocal_71 /*3*/], fLocal_52[iLocal_71], 1, true);
			unk_0x2E35C4FA5F0ED22F(iLocal_63[iLocal_71], true);
			unk_0x54480313BB3E8DD0(iLocal_63[iLocal_71], 2);
			unk_0x91629AC1E1F78419(iLocal_63[iLocal_71], 50, true);
			unk_0x80F51E5792576467(iLocal_63[iLocal_71], 0);
			unk_0xFC3C88E2313FA926(iLocal_63[iLocal_71], 13);
			unk_0x4106FAF8AA1D69D5(iLocal_63[iLocal_71], iLocal_69);
			iLocal_72 = unk_0x491B2241281A03B7(0, 3);
			if (iLocal_72 == 0)
			{
				unk_0x7A535CE1F001F3FE(iLocal_63[iLocal_71], joaat("weapon_sawnoffshotgun"), -1, true, true);
			}
			else if (iLocal_72 == 1)
			{
				unk_0x7A535CE1F001F3FE(iLocal_63[iLocal_71], joaat("weapon_microsmg"), -1, true, true);
			}
			else
			{
				unk_0x7A535CE1F001F3FE(iLocal_63[iLocal_71], joaat("weapon_assaultrifle"), -1, true, true);
			}
			unk_0xC8FD3EBBB90E8D7F(iLocal_63[iLocal_71], 42, true);
			func_85(&uLocal_77, 3, iLocal_63[iLocal_71], "SalvadorGang", 0, 1);
			iLocal_71++;
		}
		if (!unk_0x36CEFBE9B745A58D(iLocal_63[0]))
		...
		unk_0xF85FAED5BA864282(iLocal_63[0], "piDrugCult[0]");
		if (!unk_0x36CEFBE9B745A58D(iLocal_63[1]))
		{
			unk_0xC5A6DFE2B8987B17(&iLocal_70);
			unk_0x346129B364057FF6(0, 2210.584f, 5580.684f, 52.8132f, 1f, -1, 1048576000, 0, 1193033728);
		...
		unk_0xF85FAED5BA864282(iLocal_63[1], "piDrugCult[1]");
		if (!unk_0x36CEFBE9B745A58D(iLocal_63[2]))
		{
			unk_0xC5A6DFE2B8987B17(&iLocal_70);
		...
		unk_0xF85FAED5BA864282(iLocal_63[2], "piDrugCult[2]");
		if (!unk_0x36CEFBE9B745A58D(iLocal_63[3]) && !unk_0x36CEFBE9B745A58D(iLocal_63[4]))
		{
			unk_0xC5A6DFE2B8987B17(&iLocal_70);
			unk_0x9565F9267674873A(0, iLocal_63[4], -1, 2f, 1f, 1073741824, 0);
		...
		unk_0xF85FAED5BA864282(iLocal_63[3], "piDrugCult[3]");
		if (!unk_0x36CEFBE9B745A58D(iLocal_63[4]))
		{
			unk_0xC5A6DFE2B8987B17(&iLocal_70);
			unk_0x9565F9267674873A(0, iLocal_63[3], -1, 2f, 1f, 1073741824, 0);
		...
		unk_0xF85FAED5BA864282(iLocal_63[4], "piDrugCult[4]");
		unk_0x2513C0D7A88E6C01(iLocal_63[5], 0f, 3f, 1);
		unk_0xF85FAED5BA864282(iLocal_63[5], "piDrugCult[5]");
		iLocal_66 = func_91(vLocal_47, 0);
		unk_0xBF0E22F3E083C33D(iLocal_66, 140);
		func_56("DRUG_BLIP_START", -1);
		iLocal_44 = 1;
	}
}

int func_91(vector3 vParam0, bool bParam1)//Position - 0x4231
{
	int iVar0;
...
int func_92()//Position - 0x425D
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()) && !unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
	{
		...
		if (SYSTEM::VMAG2(unk_0xB5D9AE572C19509E(unk_0xBC25C936A095B5BA())) > 1369f && !func_103())
		{
			return 0;
		}
	}
...
int func_93(float fParam0, bool bParam1)//Position - 0x42E3
{
	struct<27> Var0;
	int iVar1;
	int iVar2;
...
void func_94(int iParam0, var uParam1)//Position - 0x439A
{
	switch (iParam0)
	{
		case 0:
...
int func_96(int iParam0)//Position - 0x55E0
{
	switch (iParam0)
	{
		case 0:
...
struct<2> func_97(int iParam0)//Position - 0x5926
{
	struct<2> Var0;
	char[] cVar1[8];
...
struct<2> func_98(int iParam0)//Position - 0x595D
{
	struct<2> Var0;
...
bool func_100()//Position - 0x5DDB
{
	return Global_199EA > 0;
}

int func_101()//Position - 0x5DE9
{
	if (Global_15FA6 != -1)
	{
		return 1;
...
void func_106(int iParam0)//Position - 0x5ECE
{
	if (iParam0 == -1)
	{
		iParam0 = func_52();
...
void func_108(int iParam0)//Position - 0x5F41
{
	Global_19AF9 = iParam0;
}

int func_109(vector3 vParam0, int iParam1, int iParam2, bool bParam3, bool bParam4)//Position - 0x5F4F
{
	bool bVar0;
	vector3 vVar1;
	int iVar2;
	...
	if (!bVar0)
	{
		...
		if (!func_130(Global_19B04.f_6186.f_2B[iParam1]))
		{
			return 0;
		}
...
bool func_110(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x62E9
{
	if (bParam2)
	{
...
bool func_111(int iParam0)//Position - 0x6330
{
	int iVar0;
...
int func_112(int iParam0)//Position - 0x6351
{
	return func_113(iParam0, 1);
}

int func_113(int iParam0, int iParam1)//Position - 0x6360
{
	var uVar0;
	var uVar1;
	int iVar2;
...
void func_114(int iParam0, var uParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6)//Position - 0x63B3
{
	func_115(func_22(), iParam0, uParam1, uParam2, uParam3, uParam4, uParam5, uParam6);
}

void func_115(int iParam0, int iParam1, var uParam2, var uParam3, var uParam4, var uParam5, var uParam6, var uParam7)//Position - 0x63D1
{
	int iVar0;
	int iVar1;
	int iVar2;
...
float func_116(float fParam0, float fParam1, float fParam2)//Position - 0x65D2
{
	float fVar0;
...
int func_117(int iParam0, int iParam1)//Position - 0x6614
{
	int iVar0;
	int iVar1;
...
int func_118(int iParam0)//Position - 0x6720
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_119(int iParam0, int iParam1)//Position - 0x67FC
{
...
int func_120(int iParam0)//Position - 0x681F
{
	int iVar0;
		...
		if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
		{
			if (!unk_0x36CEFBE9B745A58D(unk_0xBC25C936A095B5BA()))
			{
				...
				switch (iParam0)
				{
					case 9:
					case 0:
						if (((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_128()) || Global_1974B) || Global_62BF) || func_127()) || func_82(8, -1)) || func_126()) || func_125()) || func_124()) || func_123()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 1:
						if (((((((((unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1) || func_128()) || Global_62BF) || func_127()) || func_82(8, -1)) || func_124()) || func_126()) || func_125()) || func_123()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 2:
						if ((((((((((((((((((!unk_0x17E283E7CFFB759B(unk_0xB5CEFD608600A09F()) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x8F1FDD0A40DC834A(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_128()) || Global_1974B) || Global_62BF) || func_127()) || func_82(8, -1)) || func_124()) || func_126()) || func_125()) || func_123()) || Global_19B04.f_1DEB.f_397[iVar0] == 5) || Global_8E64 != -1)
						{
							return 0;
						}
						break;
					...
					case 3:
						if ((((((((((((unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA()) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0)) || func_128()) || Global_1974B) || Global_62BF) || func_127()) || func_82(8, -1)) || func_126()) || func_125()) || func_123()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 4:
						if (((((func_128() || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || func_82(8, -1)) || func_123()) || func_122()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
						{
							return 0;
						}
						break;
					...
					case 6:
						if (unk_0x724D816EA203A79E(unk_0xBC25C936A095B5BA()))
						{
							if ((((((((((((((unk_0x8F97799512B006B7(unk_0xBC25C936A095B5BA(), 0) || unk_0x904E94842BB9E173(unk_0xB5CEFD608600A09F()) > 0) || unk_0x2A348A3A98B80B13(unk_0xBC25C936A095B5BA())) || unk_0x2CDE18D6C89522AD(unk_0xBC25C936A095B5BA())) || unk_0x16E28377989A37E9(unk_0xBC25C936A095B5BA())) || unk_0xAC82A41596D67472(unk_0xB5CEFD608600A09F(), 1)) || unk_0xFA46778B5FBCC3BB(unk_0xB5CEFD608600A09F())) || func_128()) || Global_62BF) || func_127()) || func_82(8, -1)) || func_125()) || func_124()) || func_123()) || Global_19B04.f_1DEB.f_397[iVar0] == 5)
							{
								return 0;
							}
						}
...
var func_121()//Position - 0x6F3C
{
	return Global_16B42.f_1;
}

int func_122()//Position - 0x6F4A
{
	if (Global_15FA6 != -1)
	{
...
bool func_125()//Position - 0x6FB4
{
	return Global_16B4F.f_142 > 0;
}

bool func_126()//Position - 0x6FC5
{
	return Global_16B4F.f_141 > 0;
}

var func_127()//Position - 0x6FD6
{
	return Global_140856;
}

int func_128()//Position - 0x6FE2
{
...
bool func_130(int iParam0)//Position - 0x7026
{
	return func_117(func_22(), iParam0);
}

int func_131(int iParam0, int iParam1, int iParam2)//Position - 0x7038
{
	int iVar0;
	int iVar1;
...
int func_132(int iParam0)//Position - 0x711C
{
	if (!func_46(iParam0))
	{
		return 7;
...
bool func_133(int iParam0)//Position - 0x7140
{
	int iVar0;
	bool bVar1;
...
void func_137(int iParam0)//Position - 0x7339
{
	char cVar0[64];
	...
	if (func_105())
	{
		...
		func_140(30000);
		StringCopy(&cVar0, func_139(Global_19AF9, 1), 64);
	...
	func_138(&Global_62F8);
	Global_19AFA = 0;
	func_108(-1);
}

void func_138(var uParam0)//Position - 0x73EE
{
	if (*uParam0 == -1)
	{
		return;
...
char* func_139(int iParam0, bool bParam1)//Position - 0x742B
{
	switch (iParam0)
	{
		case 0:
...
void func_140(int iParam0)//Position - 0x7674
{
	Global_8E68 = (unk_0x105601648511CC64() + iParam0);
}

void func_141(int iParam0)//Position - 0x7686
{
	func_3(iParam0, 0, func_142(iParam0));
}

int func_142(int iParam0)//Position - 0x769B
{
	int iVar0;
