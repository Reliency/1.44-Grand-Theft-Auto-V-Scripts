	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_277(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_265(&Var0, 1);
	}
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x6187
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x61CE
{
...
bool func_70(int iParam0)//Position - 0x6229
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x6239
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x6299
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x658D
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x6598
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x65A8
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x664A
{
	switch (iParam0)
	{
		case -1:
...
int func_88(int iParam0)//Position - 0x7CFE
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7D0E
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7FA8
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x7FB9
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7FFF
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x8086
{
...
void func_94(var uParam0, int iParam1)//Position - 0x80B9
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x810A
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x81AC
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x81D1
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x81E8
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x81F5
{
...
void func_100(var uParam0, int iParam1)//Position - 0x822F
{
...
void func_101(var uParam0, int iParam1)//Position - 0x826A
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x82A6
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x82BF
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x8318
{
...
bool func_105(bool bParam0)//Position - 0x835A
{
...
struct<2> func_106(int iParam0)//Position - 0x8385
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x87D2
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9AAA
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9DF0
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9E94
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9F2F
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9F8D
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9FE6
{
...
int func_116(int iParam0)//Position - 0xA069
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA09A
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA0AF
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA162
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA17D
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA1C9
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA212
{
	if (func_124(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA232
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA253
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA323
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA376
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA46B
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA4D6
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA513
{
	if (bParam0)
	{
...
int func_134(int iParam0, bool bParam1)//Position - 0xA6A4
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA6E5
{
...
bool func_136()//Position - 0xA727
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA738
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA792
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA7B5
{
...
void func_141()//Position - 0xA7F2
{
	Global_394A = 0;
	func_142();
}

void func_142()//Position - 0xA802
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA8E8
{
...
void func_147(int iParam0)//Position - 0xAA77
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAAF4
{
...
void func_150(int iParam0)//Position - 0xAB1D
{
	if (Global_3943)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAB8D
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAC01
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xAC5B
{
...
int func_154(int iParam0)//Position - 0xAC9C
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xACE1
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xAD13
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xAE4A
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAE99
{
	return func_159(iParam0, Global_8C41);
}

int func_159(int iParam0, int iParam1)//Position - 0xAEAA
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xB08B
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_161()//Position - 0xB0AD
{
	return func_162(unk_0x1377080E9B0BD993(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB0BE
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
void func_164(int iParam0, int iParam1)//Position - 0xB12B
{
	switch (iParam0)
	{
		case 0:
...
int func_165(vector3 vParam0, bool bParam1)//Position - 0xB5B2
{
	int iVar0;
	
	iVar0 = unk_0x390CF6C8AD6903B7(vParam0);
	unk_0x3F5F1772D71D5EC4(iVar0, func_166(unk_0x7AF0088ABFA713B6(), 1f, 1f));
	unk_0x0BBAABB52887CF8C(iVar0, bParam1);
	return iVar0;
}

float func_166(bool bParam0, float fParam1, float fParam2)//Position - 0xB5DE
{
	if (bParam0)
	{
		return fParam1;
...
int func_167(int iParam0)//Position - 0xB5F5
{
	switch (iParam0)
	{
		case 0:
...
int func_168(var uParam0, int iParam1)//Position - 0xB684
{
	switch (uParam0->f_10)
	{
		case 0:
			if (*uParam0 == 12)
			{
				if (unk_0x0C265B3C448E6954(unk_0xBC25C936A095B5BA(), 1826.631f, 4699.115f, 35.38089f, 1812.878f, 4710.457f, 42.05354f, 23.75f, 0, true, 0))
				{
					if (func_124(uParam0->f_1C[0]))
					{
						if (unk_0xF0F2FC9DE291567F(unk_0x541C2AEF053615BC(unk_0xBC25C936A095B5BA(), true), unk_0x541C2AEF053615BC(uParam0->f_1C[0], true), true) < 3f)
						{
							if (func_174(2))
							{
								if (func_172(uParam0->f_1B))
								{
									func_171(uParam0->f_1B, *uParam0);
				...
				else if (func_124(uParam0->f_1C[0]))
				{
					if (func_170(uParam0))
					{
						if (func_174(2))
...
void func_169()//Position - 0xBE67
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_170(var uParam0)//Position - 0xBE82
{
	float fVar0;
...
void func_171(int iParam0, int iParam1)//Position - 0xBF10
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_172(bool bParam0)//Position - 0xBF74
{
	int iVar0;
...
int func_173(int iParam0)//Position - 0xC00C
{
	if (func_124(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_174(int iParam0)//Position - 0xC036
{
	int iVar0;
...
var func_175()//Position - 0xC753
{
	return Global_16B42.f_1;
}

int func_176()//Position - 0xC761
{
	if (Global_15FA6 != -1)
	{
...
bool func_179()//Position - 0xC7CB
{
	return Global_16B4F.f_142 > 0;
}

bool func_180(int iParam0, int iParam1)//Position - 0xC7DC
{
	switch (iParam0)
	{
		case 5:
...
var func_181()//Position - 0xC817
{
	return Global_140856;
}

int func_182()//Position - 0xC823
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
void func_183(int iParam0, char* sParam1, vector3 vParam2)//Position - 0xC83F
{
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam1))
		{
			...
			{
				if (func_187(unk_0xBC25C936A095B5BA(), vParam2, 1) <= 100f)
				{
					func_186(iParam0, 1);
				}
			}
			else
			{
				...
				if (func_187(unk_0xBC25C936A095B5BA(), vParam2, 1) > 120f)
				{
					func_189(iParam0);
				}
			}
...
void func_184(int iParam0, bool bParam1)//Position - 0xC930
{
	if (iParam0 == -1)
	{
		return;
...
int func_185(int iParam0)//Position - 0xC96C
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_186(int iParam0, int iParam1)//Position - 0xC9A5
{
	bool bVar0;
	int iVar1;
...
float func_187(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xCA43
{
	vector3 vVar0;
...
bool func_188()//Position - 0xCA7D
{
	return Global_16129;
}

void func_189(int iParam0)//Position - 0xCA89
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_190(iParam0);
...
void func_190(int iParam0)//Position - 0xCAA0
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
void func_191(int iParam0)//Position - 0xCB88
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_192(int iParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6, float fParam7)//Position - 0xCBB0
{
	var uVar0;
	
	if ((((func_124(unk_0xBC25C936A095B5BA()) && func_124(iParam0->f_1C[0])) && !func_143()) && (unk_0x105601648511CC64() - iParam0->f_3C) > iParam6) && func_187(unk_0xBC25C936A095B5BA(), vParam1, 1) < fParam7)
	{
		uVar0 = 16;
		func_195(&uVar0, iParam4, iParam0->f_1C[0], sParam5, 0, 1);
...
void func_193(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC38
{
...
void func_194(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xCC73
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_195(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xCCC9
{
...
int func_196(var uParam0, bool bParam1)//Position - 0xCD64
{
	struct<27> Var0;
	...
	if ((func_233(*uParam0) || func_231(*uParam0)) || Global_11637 == 1)
	{
		return 1;
	}
	if (!unk_0x684B06333594F9EA())
...
void func_197(int iParam0, var uParam1, int iParam2)//Position - 0xCFD7
{
	int iVar0;
	int iVar1;
...
int func_198(int iParam0)//Position - 0xD32F
{
...
int func_199(var uParam0)//Position - 0xD34F
{
...
int func_200(var uParam0)//Position - 0xD367
{
...
void func_201(var uParam0)//Position - 0xD38C
{
	int iVar0;
	int iVar1;
	...
	if (*uParam0 == 52)
	{
		func_202(&(uParam0->f_29[1]));
		func_202(&(uParam0->f_29[2]));
	}
...
void func_202(int iParam0)//Position - 0xD690
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_203(var uParam0)//Position - 0xD6BB
{
	int iVar0;
...
int func_204(var uParam0, bool bParam1, bool bParam2)//Position - 0xD73B
{
	int iVar0;
	int iVar1;
	int iVar2;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_23[iVar0]))
			{
				...
				if (bParam2)
				{
					...
					else
					{
						...
						if (*uParam0 == 16)
						{
							if (func_205(unk_0xBC25C936A095B5BA(), uParam0->f_23[iVar0]))
							{
...
int func_205(int iParam0, int iParam1)//Position - 0xD8F9
{
	int iVar0;
...
int func_206(var uParam0, bool bParam1, int iParam2)//Position - 0xD929
{
	int iVar0;
	int iVar1;
			...
			if (unk_0x724D816EA203A79E(uParam0->f_1C[iVar0]))
			{
				if (!unk_0x36CEFBE9B745A58D(uParam0->f_1C[iVar0]))
				{
					...
					if (func_225(*uParam0))
					{
						if (!func_153(*uParam0))
						{
							if (func_220(uParam0->f_1C[iVar0], 1, 0, 0, 0))
							{
								if (iParam2 == 0)
								{
									func_201(uParam0);
						...
						if (func_208(uParam0->f_1C[iVar0], 1126825984))
						{
							if (iParam2 == 0)
							{
								func_201(uParam0);
...
int func_207(int iParam0)//Position - 0xDBE5
{
...
int func_208(int iParam0, float fParam1)//Position - 0xDC19
{
	float fVar0;
...
bool func_209(int iParam0, float fParam1)//Position - 0xDC8F
{
	return func_210(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_210(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xDCA7
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_211(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xDD68
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_212(int iParam0, int iParam1)//Position - 0xDE94
{
	int iVar0;
...
int func_214(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDFA3
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_216(unk_0x541C2AEF053615BC(iParam1, true) - unk_0x541C2AEF053615BC(iParam0, true)) };
	...
	{
		vVar1 = { func_216(unk_0x823166D9421223CA(iParam0, 31086, 0f, 5f, 0f) - unk_0x823166D9421223CA(iParam0, 31086, 0f, 0f, 0f)) };
	}
...
float func_215(vector3 vParam0, vector3 vParam1)//Position - 0xE034
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_216(vector3 vParam0)//Position - 0xE055
{
	float fVar0;
	float fVar1;
...
void func_217(var uParam0)//Position - 0xE094
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_218(int iParam0, int iParam1)//Position - 0xE0AF
{
	int iVar0;
...
int func_219(int iParam0)//Position - 0xE0EE
{
...
int func_220(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xE116
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_221(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xE211
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_222(int iParam0, float fParam1)//Position - 0xE31D
{
	var uVar0;
	vector3 vVar1;
...
int func_223(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xE3B2
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
	
	vVar0 = { func_216(vParam1 - unk_0x541C2AEF053615BC(iParam0, true)) };
	if (fParam2 < 0.1f || fParam2 > 360f)
	{
		return 1;
	}
...
int func_224(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xE440
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_225(int iParam0)//Position - 0xE488
{
...
void func_226(int iParam0)//Position - 0xE4D2
{
	int iVar0;
...
int func_227(int iParam0)//Position - 0xE56F
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_228(int iParam0)//Position - 0xE607
{
...
int func_231(int iParam0)//Position - 0xE689
{
	if ((func_232() && Global_16B1B.f_B == 6) && iParam0 == func_162(&(Global_16B1B.f_3), 0))
	{
		return 1;
	}
	return 0;
...
int func_233(int iParam0)//Position - 0xE6FB
{
	if (func_105(0))
	{
...
int func_236(var uParam0)//Position - 0xE7F4
{
	int iVar0[7];
	char* sVar1;
	int iVar2;
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_245(&iVar0) || !unk_0xF9E082857622D91E(sVar1))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			{
				if (func_242(&(uParam0->f_1C[0]), 50, -490.809f, 232.39f, 82.018f, 33.84f, "PAPARAZZO LAUNCHER RC", 0))
				{
			...
			{
				func_240(&(uParam0->f_1C[1]), iVar0[3], -498.1656f, 228.6284f, 82.09948f, 292.9763f, 26);
			...
			{
				func_240(&(uParam0->f_1C[2]), iVar0[4], -498.309f, 227.9112f, 82.106f, 296.4216f, 26);
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_238(&(uParam0->f_23[0]), iVar0[1], -497.99f, 224.97f, 82.67f, 266.5f);
				if (func_173(uParam0->f_23[0]))
				{
			...
			{
				func_238(&(uParam0->f_23[1]), iVar0[2], -501.55f, 230.7f, 83.1f, 233.93f);
				if (func_173(uParam0->f_23[1]))
				{
			...
			{
				func_237(&(uParam0->f_29[0]), iVar0[5], -490.11f, 233.15f, 82.1f, 0f);
				if (func_124(uParam0->f_1C[0]) && unk_0x724D816EA203A79E(uParam0->f_29[0]))
				{
			...
			{
				func_237(&(uParam0->f_29[1]), iVar0[6], -490.11f, 233.15f, 82.1f, 0f);
				if (func_124(uParam0->f_1C[1]) && unk_0x724D816EA203A79E(uParam0->f_29[1]))
				{
...
void func_237(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xEDB7
{
	func_202(iParam0);
...
void func_238(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xEDDE
{
	func_239(iParam0);
...
void func_239(int iParam0)//Position - 0xEE20
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_240(int iParam0, int iParam1, vector3 vParam2, float fParam3, int iParam4)//Position - 0xEEBC
{
	func_241(iParam0);
	*iParam0 = unk_0x01B3635C3E8EDD81(iParam4, iParam1, vParam2, fParam3, 0, false);
}

void func_241(int iParam0)//Position - 0xEEDD
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
int func_242(int iParam0, int iParam1, vector3 vParam2, float fParam3, char* sParam4, int iParam5)//Position - 0xEF1E
{
...
int func_243(int iParam0, int iParam1, vector3 vParam2, float fParam3, bool bParam4)//Position - 0xEF7A
{
	int iVar0;
...
int func_244(var uParam0, int iParam1)//Position - 0xF008
{
	int iVar0;
...
int func_245(int iParam0)//Position - 0xF04E
{
	int iVar0;
...
int func_246(var uParam0)//Position - 0xF07F
{
	uParam0->f_10 = 3;
...
int func_247(var uParam0)//Position - 0xF0B3
{
	int iVar0[1];
	int iVar1;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			func_238(&(uParam0->f_23[0]), iVar0[0], 307.02f, 143.17f, 103.3f, 250.08f);
			unk_0x6012A6A4F2950585(uParam0->f_23[0], 2);
			iVar1 = 0;
			while (iVar1 <= (iVar0 - 1))
			{
...
int func_248(var uParam0)//Position - 0xF19E
{
	int iVar0[5];
	int iVar1[3];
	vector3 vVar2[3];
	...
	switch (iLocal_51)
	{
		...
		case 1:
			if (!func_245(&iVar0) || !unk_0xF9E082857622D91E(sVar4))
			{
				return 0;
			}
			iLocal_51 = 2;
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_242(&(uParam0->f_1C[0]), 50, -261f, 292.22f, 90.89f, 10.53f, "PAPARAZZO LAUNCHER RC", 1))
				{
					unk_0xDC3C88A35B53F90B(uParam0->f_1C[0]);
					unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[0], 9, 1, 0, 0);
					unk_0x2E35C4FA5F0ED22F(uParam0->f_1C[0], true);
			...
			if (func_123(uParam0->f_1C[0]))
			{
				...
				{
					func_237(&(uParam0->f_29[3]), iVar0[1], unk_0xA4455714F3DCE207(uParam0->f_1C[0], 0f, 0f, 2.5f), 0f);
					if (func_124(uParam0->f_29[3]))
					{
		...
		case 3:
			if (func_124(uParam0->f_29[0]))
			{
				iLocal_54 = unk_0xD0D858E538FD01C3(unk_0x541C2AEF053615BC(uParam0->f_29[0], true), unk_0xD7490CDEF40F3DA2(uParam0->f_29[0], 2), 2);
				unk_0xBEBE356CCD6268A1(uParam0->f_29[0], iLocal_54, "idle_closed_pap_3_rcm_dumpster", sVar4, 8f, -8f, 0, 1148846080);
				unk_0xC2BF3DE5E47F801D(iLocal_54, true);
				if (func_124(uParam0->f_1C[0]))
				{
					unk_0xB62398E536F695FC(uParam0->f_1C[0], iLocal_54, sVar4, "idle_closed_pap_3_rcm_beverly", 8f, -8f, 0, 0, 1148846080, 0);
				}
				if (func_124(uParam0->f_29[1]))
				{
					unk_0xBEBE356CCD6268A1(uParam0->f_29[1], iLocal_54, "idle_closed_pap_3_rcm_lid_l", sVar4, 8f, -8f, 0, 1148846080);
				}
				if (func_124(uParam0->f_29[2]))
				{
					unk_0xBEBE356CCD6268A1(uParam0->f_29[2], iLocal_54, "idle_closed_pap_3_rcm_lid_r", sVar4, 8f, -8f, 0, 1148846080);
				}
			}
			iVar5 = 0;
			while (iVar5 <= (iVar0 - 1))
...
int func_249(var uParam0)//Position - 0xF6DD
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_242(&(uParam0->f_1C[0]), 50, -71.283f, 301.557f, 106.711f, 4.659f, "PAPARAZZO LAUNCHER RC", 1))
				{
					unk_0xDC3C88A35B53F90B(uParam0->f_1C[0]);
					unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[0], 9, 1, 0, 0);
				}
			...
			if (func_123(uParam0->f_1C[0]))
			{
				if (!unk_0x724D816EA203A79E(uParam0->f_29[0]))
				{
					func_237(&(uParam0->f_29[0]), iVar0[2], unk_0xA4455714F3DCE207(uParam0->f_1C[0], 0f, 0f, 2.5f), 0f);
					if (func_124(uParam0->f_29[0]))
					{
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_238(&(uParam0->f_23[0]), iVar0[1], -78.0873f, 299.0679f, 105.3972f, 249.8696f);
				unk_0x6012A6A4F2950585(uParam0->f_23[0], 7);
				...
				unk_0xEA0AB6C644C58C1D(uParam0->f_23[0], "P4P4R4Z0");
		...
		case 3:
			if (func_124(uParam0->f_1C[0]) && func_124(unk_0xBC25C936A095B5BA()))
			{
				unk_0x56F2E1B5599188FA(uParam0->f_1C[0], unk_0xBC25C936A095B5BA(), -1, 0, 2);
				iLocal_54 = unk_0xD0D858E538FD01C3(-71.283f, 301.557f, 106.711f, 0f, 0f, 4.659f, 2);
				unk_0xC2BF3DE5E47F801D(iLocal_54, true);
				unk_0xB62398E536F695FC(uParam0->f_1C[0], iLocal_54, "rcmpaparazzo_2", "pap_2_rcm_base", 2f, -4f, 1, 0, 1148846080, 0);
...
int func_250(var uParam0)//Position - 0xFA1E
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_1C[0]))
			{
				if (func_242(&(uParam0->f_1C[0]), 50, -149.75f, 285.81f, 93.67f, 135f, "PAPARAZZO LAUNCHER RC", 1))
				{
					unk_0xDC3C88A35B53F90B(uParam0->f_1C[0]);
					unk_0xB0031DDAE4FF0BC3(uParam0->f_1C[0], 9, 1, 0, 0);
				}
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_238(&(uParam0->f_23[0]), iVar0[1], -159.56f, 275.41f, 93.14f, 102.75f);
				if (func_173(uParam0->f_23[0]))
				{
					unk_0x914C5DE0B15B8B59(uParam0->f_23[0], 62, 62);
				}
				else
				{
					bVar2 = false;
		...
		case 3:
			if (func_124(uParam0->f_1C[0]))
			{
				if (unk_0xF9E082857622D91E("rcmpaparazzo1beckon"))
				{
					...
					unk_0xE896C0AD02364F2A(0, sVar4, "pap_idle_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sVar4, "pap_idle_action_01", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sVar4, "pap_idle_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
					unk_0xE896C0AD02364F2A(0, sVar4, "pap_idle_action_02", 8f, -8f, -1, 0, 0, 0, 0, 0);
...
void func_251(int iParam0, bool bParam1)//Position - 0xFD41
{
	switch (iParam0)
	{
		case 46:
			if (bParam1)
			{
				unk_0x379ACE23D404525C(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, false, 1);
				unk_0xDD56BACCCF835044(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, 0);
			}
			else
			{
				unk_0x379ACE23D404525C(-190.0199f, 260.1082f, 85f, -131.572f, 285.8091f, 102f, true, 1);
			}
			break;
	}
}

int func_252(int iParam0)//Position - 0xFDCC
{
	struct<27> Var0;
	int iVar1;
...
int func_253(int iParam0)//Position - 0xFE20
{
	char* sVar0;
...
int func_254(int iParam0)//Position - 0xFED9
{
	var uVar0;
...
int func_255(int iParam0)//Position - 0xFF9A
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_256(int iParam0, char* sParam1)//Position - 0x10020
{
...
bool func_257(int iParam0)//Position - 0x10102
{
...
bool func_258(int iParam0)//Position - 0x10130
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_260(int iParam0)//Position - 0x1018C
{
	if (func_228(iParam0))
	{
		return 0;
...
void func_261()//Position - 0x101C1
{
	func_278("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_262(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0x101DB
{
	int iVar0;
...
int func_263(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0x10240
{
	int iVar0;
	struct<7> Var1;
...
int func_264(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0x102BE
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_265(int iParam0, bool bParam1)//Position - 0x10339
{
	if (bParam1)
	{
		...
		{
			case 46:
				unk_0x2CA123B0622F495C(iLocal_53);
				func_267(iParam0, 0, 0, 0);
				break;
			
			case 47:
				unk_0xD0FC9D284379BED4("WORLD_HUMAN_PAPARAZZI", 1);
				unk_0x483687B0FCA5415A(iLocal_56, 0);
				func_267(iParam0, 0, 0, 0);
				break;
			
			case 48:
				unk_0x466BFD40867F5065(-260.62f, 292.13f, 90.6f, 10f, joaat("prop_cs_dumpster_01a"), true);
				unk_0x466BFD40867F5065(-261.58f, 291.66f, 92.06f, 10f, joaat("prop_cs_dumpster_lidr"), true);
				unk_0x466BFD40867F5065(-261.54f, 292.54f, 92.1f, 10f, joaat("prop_cs_dumpster_lidl"), true);
				func_202(&(iParam0->f_29[3]));
...
int func_266(var uParam0)//Position - 0x104A7
{
	if (func_200(uParam0))
	{
...
void func_267(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0x104DD
{
...
void func_268(var uParam0, bool bParam1)//Position - 0x104FD
{
	func_269(&(uParam0->f_29), bParam1);
}

void func_269(var uParam0, bool bParam1)//Position - 0x1050F
{
	int iVar0;
...
void func_270(int iParam0, bool bParam1)//Position - 0x1054D
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_271(var uParam0, bool bParam1)//Position - 0x10588
{
	func_272(&(uParam0->f_23), bParam1);
}

void func_272(var uParam0, bool bParam1)//Position - 0x1059A
{
	int iVar0;
...
void func_273(int iParam0)//Position - 0x105D7
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_274(var uParam0, int iParam1)//Position - 0x1060F
{
	func_275(&(uParam0->f_1C), iParam1);
}

void func_275(var uParam0, int iParam1)//Position - 0x10621
{
	int iVar0;
...
void func_276(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x10662
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_277(var uParam0)//Position - 0x106B2
{
	if (*uParam0 == -1)
	{
		return;
...
void func_278(char* sParam0)//Position - 0x106EF
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_279(var uParam0)//Position - 0x10701
{
	*uParam0 = -1;
...
void func_280()//Position - 0x10734
{
	func_278("Running start routines.");
	Global_199EA++;
}

int func_281(int iParam0)//Position - 0x1074E
{
	if (!func_36(iParam0))
	{
		return Global_19B04.f_6D75[iParam0 /*29*/];
