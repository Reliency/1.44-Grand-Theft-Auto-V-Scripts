...
void func_5()//Position - 0x45A
{
	...
	{
		if (func_9(Global_19B04.f_932.f_21B.f_10CD) != unk_0x6F79ECA8C83E4357(unk_0xBC25C936A095B5BA()))
		{
			iVar0 = func_8(unk_0xBC25C936A095B5BA());
			if (func_7(iVar0) && (!func_6(14) || Global_196EB))
			{
			...
			if (!(iParam1[uParam0->f_A /*11*/])->f_A)
			{
				if (!bVar1)
				{
					if (uParam0->f_A == iLocal_49)
					{
						...
						{
							unk_0xED487BB7EB176F2C((iParam1[uParam0->f_A /*11*/])->f_1, "GtaMloRoomTun5");
						}
					}
...
int func_18(int iParam0)//Position - 0xBEF
{
	...
	if (iParam0 == 2)
	{
		...
		{
			if (unk_0xFA30DFD0084E92FE(Global_19B04.f_2724.f_6C, func_24(func_25(iParam0), iVar1)))
			{
				iVar0++;
			}
			iVar1++;
...
int func_21(int iParam0, int iParam1)//Position - 0xFE0
{
	int iVar0;
...
int func_22()//Position - 0x12A5
{
	return Global_1407E0;
}

int func_23(int iParam0)//Position - 0x12B1
{
	if (iParam0 == 3)
	{
		return 815;
...
int func_24(int iParam0, int iParam1)//Position - 0x12F8
{
	if (iParam1 < 32)
	{
		return iParam1;
...
int func_25(int iParam0)//Position - 0x1314
{
	if (iParam0 == 3)
	{
		return 30;
...
void func_26(int iParam0)//Position - 0x1364
{
...
int func_27(var uParam0, var uParam1, vector3 vParam2)//Position - 0x137E
{
	int iVar0;
	...
	{
		if ((SYSTEM::VDIST2(vParam2, unk_0x85EA1A40FC3A6769((uParam1[iVar0 /*11*/])->f_1)) > (60f * 60f) || func_6(13)) || func_6(14))
		{
...
void func_28(var uParam0)//Position - 0x143B
{
...
void func_29(var uParam0, var uParam1, int iParam2)//Position - 0x1454
{
	int iVar0;
...
void func_31(int iParam0, int iParam1)//Position - 0x154A
{
	Global_16B42.f_7 = iParam0;
	Global_16B42.f_8 = iParam1;
}

void func_32()//Position - 0x1562
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_33(int iParam0, int iParam1)//Position - 0x1605
{
	int iVar0;
...
int func_34(int iParam0)//Position - 0x1656
{
	if (iParam0 == 3)
	{
...
void func_35(var uParam0)//Position - 0x16A7
{
	int iVar0;
	int iVar1;
...
void func_36(int iParam0, int iParam1)//Position - 0x172A
{
...
int func_37(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0x1767
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_38(var uParam0, int iParam1)//Position - 0x1C79
{
	if (uParam0->f_3 <= 0)
	{
	}
...
void func_39(int iParam0, int iParam1, bool bParam2)//Position - 0x1CED
{
...
void func_40(int iParam0, int iParam1, bool bParam2)//Position - 0x1DD9
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return;
...
void func_41(int iParam0)//Position - 0x1E3A
{
...
int func_42(int iParam0)//Position - 0x1E5A
{
	int iVar0;
	int iVar1;
...
int func_43(int iParam0)//Position - 0x1EE6
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
void func_44(var uParam0, int iParam1, int iParam2, bool bParam3, bool bParam4, int iParam5)//Position - 0x1F07
{
	int iVar0;
...
void func_45(vector3 vParam0)//Position - 0x2020
{
	int iVar0;
...
bool func_46(var uParam0, int iParam1)//Position - 0x205E
{
	if (iParam1 < 0 || iParam1 >= 64)
	{
		return 0;
...
bool func_47(int iParam0)//Position - 0x209C
{
	if (!unk_0x724D816EA203A79E(iParam0))
	{
		return 0;
...
void func_48(var uParam0, int iParam1, int iParam2, int iParam3)//Position - 0x20BA
{
	uParam0->f_6 = iParam1;
	func_49(&(uParam0->f_1), iParam2, iParam3);
}

void func_49(int iParam0, var uParam1, var uParam2)//Position - 0x20D4
{
	int iVar0;
	int iVar1;
...
void func_50(var uParam0, int iParam1, int iParam2, char* sParam3)//Position - 0x213D
{
	*uParam0 = iParam1;
	uParam0->f_7 = iParam2;
	uParam0->f_8 = sParam3;
...
void func_51()//Position - 0x215B
{
	int iVar0;
	
	iLocal_50 = 0;
	Global_19B04.f_2724.f_7D.f_2 = 1;
	iVar0 = 0;
	while (iVar0 < 50)
	{
...
Vector3 func_52(int iParam0, int iParam1)//Position - 0x2468
{
	switch (iParam0)
	{
		case 0:
...
int func_53(int iParam0)//Position - 0x2CB4
{
	int iVar0;
	int iVar1;
...
void func_54()//Position - 0x2D0E
{
	int iVar0;
	
	Global_19B04.f_2724.f_7D.f_2 = 0;
	iVar0 = 0;
...
int func_55(int iParam0)//Position - 0x2D84
{
	int iVar0;
	int iVar1;
...
void func_56()//Position - 0x2DDE
{
	int iVar0;
	
	iVar0 = func_57(63);
	Global_24D643[iVar0 /*83*/] = 63;
	StringCopy(&(Global_24D643[iVar0 /*83*/].f_12[0 /*16*/]), "", 64);
}

int func_57(int iParam0)//Position - 0x2E0A
{
	int iVar0;
	int iVar1;
...
void func_58(int iParam0, int iParam1)//Position - 0x2E57
{
	if (iParam0 == 146 || iParam0 == -1)
	{
		return;
...
bool func_59(var uParam0)//Position - 0x2E9C
{
	if (uParam0->f_3 <= 0)
	{
	}
