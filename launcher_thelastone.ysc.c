	...
	if (unk_0xE8A79675302ED812(83))
	{
		...
		if (Var0 != -1)
		{
			if (Global_19773[Var0 /*10*/].f_9 != -1)
			{
				...
				func_263(&(Global_19773[Var0 /*10*/].f_9));
			}
		}
		func_250(&Var0, 1);
	}
...
bool func_68(vector3 vParam0, vector3 vParam1, bool bParam2)//Position - 0x611B
{
	if (bParam2)
	{
...
int func_69(var uParam0)//Position - 0x6162
{
...
bool func_70(int iParam0)//Position - 0x61BD
{
	return func_71(iParam0, 0, 1);
}

int func_71(int iParam0, int iParam1, bool bParam2)//Position - 0x61CD
{
	if (bParam2)
	{
...
int func_72(int iParam0)//Position - 0x622D
{
	switch (iParam0)
	{
		case 0:
...
int func_73()//Position - 0x6521
{
	return Global_62BD;
}

int func_74(int iParam0)//Position - 0x652C
{
	return func_71(iParam0, 5, 1);
}

int func_75(vector3 vParam0, int iParam1, int iParam2, bool bParam3, int iParam4, int iParam5)//Position - 0x653C
{
	int iVar0;
	float fVar1;
	float fVar2;
...
Vector3 func_76(int iParam0, bool bParam1)//Position - 0x65DE
{
	switch (iParam0)
	{
		case -1:
...
int func_77(int iParam0)//Position - 0x6B98
{
	if (iParam0 != func_86())
	{
...
Vector3 func_78(int iParam0, int iParam1)//Position - 0x6BF6
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_79(int iParam0, int iParam1, var uParam2, int iParam3, bool bParam4)//Position - 0x6CA4
{
	struct<4> Var0;
	vector3 vVar1;
	struct<4> Var2;
...
Vector3 func_80(vector3 vParam0, float fParam1)//Position - 0x6D39
{
	vector3 vVar0;
	float fVar1;
	float fVar2;
...
struct<6> func_81(int iParam0)//Position - 0x6D7D
{
	struct<6> Var0;
...
struct<6> func_82(int iParam0)//Position - 0x6F01
{
	return func_83(iParam0);
}

struct<6> func_83(int iParam0)//Position - 0x6F0F
{
	struct<6> Var0;
...
int func_84(int iParam0, var uParam1)//Position - 0x79D6
{
	switch (iParam0)
	{
		case 0:
...
int func_85(int iParam0)//Position - 0x7A58
{
	if (iParam0 != func_86())
	{
...
int func_86()//Position - 0x7AB6
{
	return -1;
}

Vector3 func_87(int iParam0)//Position - 0x7ABF
{
	switch (iParam0)
	{
		case 1:
...
int func_88(int iParam0)//Position - 0x7C92
{
	return func_71(iParam0, 0, 0);
}

int func_89(int iParam0)//Position - 0x7CA2
{
	switch (iParam0)
	{
		case -1:
...
bool func_90()//Position - 0x7F3C
{
	return Global_16B4F.f_141 > 0;
}

var func_91()//Position - 0x7F4D
{
	var uVar0;
...
void func_92(var uParam0, int iParam1)//Position - 0x7F93
{
	if (iParam1 <= 0)
	{
		return;
...
void func_93(var uParam0, int iParam1)//Position - 0x801B
{
...
void func_94(var uParam0, int iParam1)//Position - 0x804E
{
	int iVar0;
	int iVar1;
...
int func_95(int iParam0, int iParam1)//Position - 0x809F
{
	if (iParam1 < 0)
	{
		iParam1 = 0;
...
var func_96(int iParam0)//Position - 0x8141
{
	return (SYSTEM::SHIFT_RIGHT(iParam0, 26) & 31 * func_97(unk_0xFA30DFD0084E92FE(iParam0, 31), -1, 1)) + 2011;
}

int func_97(bool bParam0, int iParam1, int iParam2)//Position - 0x8166
{
	if (bParam0)
	{
		return iParam1;
...
int func_98(var uParam0)//Position - 0x817D
{
	return uParam0 & 15;
}

void func_99(var uParam0, int iParam1)//Position - 0x818A
{
...
void func_100(var uParam0, int iParam1)//Position - 0x81C4
{
...
void func_101(var uParam0, int iParam1)//Position - 0x81FF
{
	if (iParam1 < 0 || iParam1 >= 60)
	{
		return;
...
int func_102()//Position - 0x823B
{
	func_55();
	return Global_19B04.f_932.f_21B.f_10CD;
}

void func_103(int iParam0)//Position - 0x8254
{
	var uVar0;
	vector3 vVar1[24];
...
void func_104(char* sParam0, int iParam1, int iParam2)//Position - 0x82AD
{
...
bool func_105(bool bParam0)//Position - 0x82EF
{
...
struct<2> func_106(int iParam0)//Position - 0x831A
{
	struct<2> Var0;
...
void func_107(int iParam0, var uParam1)//Position - 0x8767
{
	switch (iParam0)
	{
		case 0:
...
int func_109(int iParam0)//Position - 0x9A3F
{
	switch (iParam0)
	{
		case 0:
...
int func_110(int iParam0)//Position - 0x9D85
{
	int iVar0;
...
void func_111(int iParam0)//Position - 0x9E29
{
	struct<2> Var0;
...
void func_112(int iParam0)//Position - 0x9EC4
{
	if (iParam0 < 63)
	{
		func_113();
...
void func_114(int iParam0)//Position - 0x9F22
{
	int iVar0;
	int iVar1;
	int iVar2;
...
void func_115(int iParam0)//Position - 0x9F7B
{
...
int func_116(int iParam0)//Position - 0x9FFE
{
	int iVar0;
...
void func_117(int iParam0, int iParam1, int iParam2)//Position - 0xA02F
{
	func_118(iParam0, iParam1, iParam2, 0, 0, 1);
}

void func_118(int iParam0, int iParam1, int iParam2, int iParam3, int iParam4, int iParam5)//Position - 0xA044
{
	int iVar0;
...
int func_120(int iParam0, int iParam1, int iParam2)//Position - 0xA0F7
{
...
int func_121(int iParam0, int iParam1, int iParam2)//Position - 0xA112
{
	int iVar0;
...
int func_122(int iParam0)//Position - 0xA15E
{
	int iVar0;
...
int func_123(int iParam0)//Position - 0xA1A7
{
	if (func_124(iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(iParam0))
...
int func_124(int iParam0)//Position - 0xA1C7
{
	if (unk_0x724D816EA203A79E(iParam0))
	{
...
int func_125(int iParam0)//Position - 0xA1E8
{
	switch (iParam0)
	{
		case 5:
...
int func_127(int iParam0)//Position - 0xA2B8
{
	switch (iParam0)
	{
		case 5:
...
void func_128(var uParam0, bool bParam1, bool bParam2)//Position - 0xA30B
{
	int iVar0;
...
int func_129(int iParam0)//Position - 0xA400
{
	switch (iParam0)
	{
		case 5:
...
void func_130(bool bParam0)//Position - 0xA46B
{
	int iVar0;
...
void func_131(bool bParam0, bool bParam1, int iParam2, int iParam3, bool bParam4)//Position - 0xA4A8
{
	if (bParam0)
	{
...
int func_134(int iParam0, bool bParam1)//Position - 0xA639
{
	int iVar0;
	int iVar1;
...
int func_135(int iParam0)//Position - 0xA67A
{
...
bool func_136()//Position - 0xA6BC
{
	return unk_0xFA30DFD0084E92FE(Global_240006, 3);
}

int func_137(int iParam0, int iParam1, var uParam2, int iParam3)//Position - 0xA6CD
{
	int iVar0;
...
void func_139(int iParam0)//Position - 0xA727
{
	if (iParam0 == 1)
	{
...
int func_140(char* sParam0)//Position - 0xA74A
{
...
void func_141()//Position - 0xA787
{
	Global_394A = 0;
	func_142();
}

void func_142()//Position - 0xA797
{
...
int func_146(int iParam0, float fParam1, int iParam2, float fParam3, int iParam4, bool bParam5, bool bParam6)//Position - 0xA87D
{
...
void func_147(int iParam0)//Position - 0xAA0C
{
	if (!unk_0x1D403DFADBC2DE3C(iParam0, 0))
	{
...
void func_149(int iParam0)//Position - 0xAA89
{
...
void func_150(int iParam0)//Position - 0xAAB2
{
	if (Global_3943)
	{
		func_151(0, 0);
...
void func_151(bool bParam0, bool bParam1)//Position - 0xAB22
{
	if (bParam0)
	{
		if (func_152(0))
...
int func_152(int iParam0)//Position - 0xAB96
{
	if (iParam0 == 1)
	{
		if (Global_389D.f_1 > 3)
...
int func_153(int iParam0)//Position - 0xABF0
{
...
int func_154(int iParam0)//Position - 0xAC31
{
	int iVar0;
...
void func_155(int iParam0)//Position - 0xAC76
{
...
int func_156(var uParam0, int iParam1, int iParam2, bool bParam3, int iParam4)//Position - 0xACA8
{
	int iVar0;
...
void func_157(var uParam0, int iParam1)//Position - 0xADDF
{
	int iVar0;
...
bool func_158(int iParam0)//Position - 0xAE2E
{
	return func_159(iParam0, Global_8C41);
}

int func_159(int iParam0, int iParam1)//Position - 0xAE3F
{
	if (iParam1 == 15)
	{
		return 1;
...
int func_160(int iParam0)//Position - 0xB020
{
	if (Global_8C41 == 15)
	{
		return 0;
...
int func_161()//Position - 0xB042
{
	return func_162(unk_0x1377080E9B0BD993(), 0);
}

int func_162(char* sParam0, int iParam1)//Position - 0xB053
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
int func_164(var uParam0, int iParam1)//Position - 0xB0C0
{
	switch (uParam0->f_10)
	{
		case 0:
...
void func_165()//Position - 0xB8A3
{
	func_27(&(Global_17646.f_B3B), &Global_17646, 0, 1, 1, 0);
}

int func_166(var uParam0)//Position - 0xB8BE
{
	float fVar0;
...
void func_167(int iParam0, int iParam1)//Position - 0xB94C
{
	if (iParam0 == 1)
	{
		if (!func_127(iParam1))
...
int func_168(bool bParam0)//Position - 0xB9B0
{
	int iVar0;
...
int func_169(int iParam0)//Position - 0xBA47
{
	if (func_124(iParam0))
	{
		if (unk_0xE59B7F5A03335350(iParam0, 0))
...
int func_170(int iParam0)//Position - 0xBA71
{
	int iVar0;
...
var func_171()//Position - 0xC190
{
	return Global_16B42.f_1;
}

int func_172()//Position - 0xC19E
{
	if (Global_15FA6 != -1)
	{
...
bool func_175()//Position - 0xC208
{
	return Global_16B4F.f_142 > 0;
}

bool func_176(int iParam0, int iParam1)//Position - 0xC219
{
	switch (iParam0)
	{
		case 5:
...
var func_177()//Position - 0xC254
{
	return Global_140856;
}

int func_178()//Position - 0xC260
{
	if (!unk_0x7AF0088ABFA713B6())
	{
...
int func_179(var uParam0, vector3 vParam1, char[4] cParam2, char* sParam3, int iParam4, char* sParam5, int iParam6)//Position - 0xC27C
{
	var uVar0;
	...
	if (func_170(2))
	{
		if (!func_143())
		{
			if (((func_124(unk_0xBC25C936A095B5BA()) && func_124(uParam0->f_1C[0])) && (unk_0x105601648511CC64() - uParam0->f_3C) > iParam6) && func_185(unk_0xBC25C936A095B5BA(), vParam1, 1) < 20f)
			{
				uVar0 = 16;
		...
		else if (func_180(sParam3))
		{
			...
			{
				if (func_185(unk_0xBC25C936A095B5BA(), vParam1, 1) >= 20f)
				{
					func_141();
				}
			}
...
int func_180(char* sParam0)//Position - 0xC33E
{
	struct<6> Var0;
...
struct<6> func_181()//Position - 0xC35E
{
	struct<6> Var0;
...
void func_182(var uParam0, char* sParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC382
{
...
void func_183(var uParam0, int iParam1, char* sParam2, int iParam3, int iParam4, int iParam5)//Position - 0xC3BD
{
	Global_3B96 = { *uParam0 };
	Global_68F = iParam1;
...
void func_184(var uParam0, int iParam1, int iParam2, char* sParam3, int iParam4, int iParam5)//Position - 0xC413
{
...
float func_185(int iParam0, vector3 vParam1, bool bParam2)//Position - 0xC4AE
{
	vector3 vVar0;
...
void func_186(int iParam0, var uParam1, char* sParam2, vector3 vParam3, vector3 vParam4, vector3 vParam5)//Position - 0xC4E8
{
	float fVar0;
	float fVar1;
	float fVar2;
	...
	if (unk_0x6A9CDB766DF7216F(unk_0xB5CEFD608600A09F()))
	{
		if (!unk_0xF1734B55490E9045(sParam2))
		{
			...
			{
				if (func_185(unk_0xBC25C936A095B5BA(), vParam3, 1) <= 100f)
				{
					func_189(iParam0, 1);
				}
			}
			else
			{
				...
				{
					fVar0 = func_185(unk_0xBC25C936A095B5BA(), vParam4, 1);
					fVar1 = func_185(unk_0xBC25C936A095B5BA(), vParam5, 1);
					fVar2 = (fVar0 - fVar1);
					if (fVar2 < 0f)
					{
						fVar2 = (fVar2 * -1f);
					...
					if (fVar2 > 0.5f)
					{
						if (fVar0 < fVar1)
						{
							...
							{
								unk_0xD103510B8989BEB2();
								unk_0x589EFAE8BD1B8B57(sParam2, 5, 8);
								func_187(*iParam0, 1);
								*uParam1 = 1;
							}
						}
						...
						{
							unk_0xD103510B8989BEB2();
							unk_0x589EFAE8BD1B8B57(sParam2, 6, 8);
							func_187(*iParam0, 1);
							*uParam1 = 2;
						}
					}
				}
				if (func_185(unk_0xBC25C936A095B5BA(), vParam3, 1) > 120f)
				{
					func_190(iParam0);
				}
			}
...
void func_187(int iParam0, bool bParam1)//Position - 0xC606
{
	if (iParam0 == -1)
	{
		return;
...
int func_188(int iParam0)//Position - 0xC642
{
	if (Global_1153E == iParam0)
	{
		if (Global_1153F == -1)
...
void func_189(int iParam0, int iParam1)//Position - 0xC67B
{
	bool bVar0;
	int iVar1;
...
void func_190(int iParam0)//Position - 0xC719
{
	unk_0x73F91C7985A4C83B(0);
	unk_0xD103510B8989BEB2();
	func_191(iParam0);
...
void func_191(int iParam0)//Position - 0xC730
{
	bool bVar0;
	int iVar1;
	int iVar2;
...
bool func_192()//Position - 0xC818
{
	return Global_16129;
}

void func_193(int iParam0)//Position - 0xC824
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_194(var uParam0, bool bParam1)//Position - 0xC84C
{
	struct<27> Var0;
...
void func_195(int iParam0, var uParam1, int iParam2)//Position - 0xCABF
{
	int iVar0;
	int iVar1;
...
int func_196(int iParam0)//Position - 0xCE17
{
...
int func_197(var uParam0)//Position - 0xCE37
{
...
int func_198(var uParam0)//Position - 0xCE4F
{
...
void func_199(var uParam0)//Position - 0xCE74
{
	int iVar0;
	int iVar1;
...
void func_200(int iParam0)//Position - 0xD178
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_201(var uParam0)//Position - 0xD1A3
{
	int iVar0;
...
int func_202(var uParam0, bool bParam1, bool bParam2)//Position - 0xD223
{
	int iVar0;
	int iVar1;
	int iVar2;
...
int func_203(int iParam0, int iParam1)//Position - 0xD3E1
{
	int iVar0;
...
int func_204(var uParam0, bool bParam1, int iParam2)//Position - 0xD411
{
	int iVar0;
	int iVar1;
...
int func_205(int iParam0)//Position - 0xD6CD
{
...
int func_206(int iParam0, float fParam1)//Position - 0xD701
{
	float fVar0;
...
bool func_207(int iParam0, float fParam1)//Position - 0xD777
{
	return func_208(iParam0, unk_0xBC25C936A095B5BA(), fParam1, 1, 250, 7);
}

bool func_208(int iParam0, int iParam1, float fParam2, int iParam3, int iParam4, int iParam5)//Position - 0xD78F
{
	var uVar0;
	vector3 vVar1;
	int iVar2;
...
int func_209(var uParam0, vector3 vParam1, int iParam2, var uParam3, int iParam4, int iParam5)//Position - 0xD850
{
	var uVar0;
	vector3 vVar1;
	var uVar2;
...
Vector3 func_210(int iParam0, int iParam1)//Position - 0xD97C
{
	int iVar0;
...
int func_212(int iParam0, int iParam1, float fParam2, int iParam3)//Position - 0xDA8B
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
float func_213(vector3 vParam0, vector3 vParam1)//Position - 0xDB1C
{
	return (((vParam0.x * vParam1.x) + (vParam0.y * vParam1.y)) + (vParam0.z * vParam1.z));
}

Vector3 func_214(vector3 vParam0)//Position - 0xDB3D
{
	float fVar0;
	float fVar1;
...
void func_215(var uParam0)//Position - 0xDB7C
{
	*uParam0 = 0;
	uParam0->f_1 = 0;
	uParam0->f_2 = 0;
...
int func_216(int iParam0, int iParam1)//Position - 0xDB97
{
	int iVar0;
...
int func_217(int iParam0)//Position - 0xDBD6
{
...
int func_218(int iParam0, bool bParam1, bool bParam2, bool bParam3, bool bParam4)//Position - 0xDBFE
{
	float fVar0;
	float fVar1;
	int iVar2;
...
int func_219(int iParam0, float fParam1, bool bParam2, bool bParam3)//Position - 0xDCF9
{
	vector3 vVar0;
	vector3 vVar1;
...
int func_220(int iParam0, float fParam1)//Position - 0xDE05
{
	var uVar0;
	vector3 vVar1;
...
int func_221(int iParam0, vector3 vParam1, float fParam2, int iParam3)//Position - 0xDE9A
{
	vector3 vVar0;
	vector3 vVar1;
	float fVar2;
...
int func_222(int iParam0, bool bParam1, float fParam2, float fParam3)//Position - 0xDF28
{
	if (bParam1)
	{
		if (unk_0x32E373675659FDB0(unk_0xBC25C936A095B5BA()))
...
int func_223(int iParam0)//Position - 0xDF70
{
...
void func_224(int iParam0)//Position - 0xDFBA
{
	int iVar0;
...
int func_225(int iParam0)//Position - 0xE057
{
	if (iParam0 == -1)
	{
		iParam0 = func_161();
...
int func_226(int iParam0)//Position - 0xE0EF
{
...
int func_229(int iParam0)//Position - 0xE171
{
...
int func_231(int iParam0)//Position - 0xE1E3
{
	if (func_105(0))
	{
...
int func_232(int iParam0)//Position - 0xE20B
{
	if (!func_233(iParam0))
	{
		return 0;
...
int func_233(var uParam0)//Position - 0xE22A
{
	int iVar0[3];
	int iVar1;
	bool bVar2;
	...
	switch (iLocal_51)
	{
		...
		case 2:
			bVar2 = true;
			uParam0->f_1C[0] = unk_0x01B3635C3E8EDD81(25, iLocal_52, -1299.02f, 4639.86f, 106.66f, 345.7769f, 1, true);
			if (func_123(uParam0->f_1C[0]))
			{
				unk_0x7A535CE1F001F3FE(uParam0->f_1C[0], joaat("weapon_sniperrifle"), 100, true, true);
				unk_0xE896C0AD02364F2A(uParam0->f_1C[0], "rcmlastone1", "idle_action_01", 8f, -8f, -1, 1, 0, 0, 0, 0);
			...
			if (!unk_0x724D816EA203A79E(uParam0->f_23[0]))
			{
				func_234(&(uParam0->f_23[0]), iVar0[1], -1303.163f, 4648.085f, 104.9664f, 293.1504f);
				if (unk_0x724D816EA203A79E(uParam0->f_23[0]))
				{
...
void func_234(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE416
{
	func_235(iParam0);
...
void func_235(int iParam0)//Position - 0xE458
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
int func_236(int iParam0)//Position - 0xE4F4
{
	int iVar0;
...
int func_237(int iParam0)//Position - 0xE525
{
	struct<27> Var0;
	int iVar1;
...
int func_238(int iParam0)//Position - 0xE579
{
	char* sVar0;
...
int func_239(int iParam0)//Position - 0xE632
{
	var uVar0;
...
int func_240(int iParam0)//Position - 0xE6F3
{
	int iVar0;
	char* sVar1;
	int iVar2;
...
bool func_241(int iParam0, char* sParam1)//Position - 0xE778
{
...
bool func_242(int iParam0)//Position - 0xE85A
{
...
bool func_243(int iParam0)//Position - 0xE888
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
bool func_244(int iParam0)//Position - 0xE8B6
{
	if (iParam0 == 63 || iParam0 == -1)
	{
		return 0;
...
int func_245(int iParam0)//Position - 0xE8E4
{
	if (func_226(iParam0))
	{
		return 0;
...
void func_246()//Position - 0xE919
{
	func_264("Running end routines.");
	Global_199EA = (Global_199EA - 1);
}

int func_247(int iParam0, int iParam1, vector3 vParam2, float fParam3)//Position - 0xE933
{
	int iVar0;
...
int func_248(int iParam0, vector3 vParam1, float fParam2, var uParam3)//Position - 0xE998
{
	int iVar0;
	struct<7> Var1;
...
int func_249(vector3 vParam0, vector3 vParam1, float fParam2, bool bParam3)//Position - 0xEA16
{
	if (fParam2 < 0f)
	{
		fParam2 = 0f;
...
void func_250(int iParam0, bool bParam1)//Position - 0xEA91
{
	if (bParam1)
	{
...
int func_251(var uParam0)//Position - 0xEAE7
{
	if (func_198(uParam0))
	{
...
void func_252(var uParam0, int iParam1, bool bParam2, bool bParam3)//Position - 0xEB1D
{
...
void func_253(var uParam0, bool bParam1)//Position - 0xEB3D
{
	func_254(&(uParam0->f_29), bParam1);
}

void func_254(var uParam0, bool bParam1)//Position - 0xEB4F
{
	int iVar0;
...
void func_255(int iParam0, bool bParam1)//Position - 0xEB8D
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (unk_0x2FAEA11D96CF14A3(*iParam0))
...
void func_256(var uParam0, bool bParam1)//Position - 0xEBC8
{
	func_257(&(uParam0->f_23), bParam1);
}

void func_257(var uParam0, bool bParam1)//Position - 0xEBDA
{
	int iVar0;
...
void func_258(int iParam0)//Position - 0xEC17
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
...
void func_259(var uParam0, int iParam1)//Position - 0xEC4F
{
	func_260(&(uParam0->f_1C), iParam1);
}

void func_260(var uParam0, int iParam1)//Position - 0xEC61
{
	int iVar0;
...
void func_261(int iParam0, bool bParam1, int iParam2, int iParam3)//Position - 0xECA2
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x36CEFBE9B745A58D(*iParam0))
...
void func_262(int iParam0)//Position - 0xECF2
{
	if (unk_0x724D816EA203A79E(*iParam0))
	{
		if (!unk_0x1D403DFADBC2DE3C(*iParam0, 0))
...
void func_263(var uParam0)//Position - 0xED33
{
	if (*uParam0 == -1)
	{
		return;
...
void func_264(char* sParam0)//Position - 0xED70
{
	if (!unk_0xF1734B55490E9045(sParam0))
	{
	}
...
void func_265(var uParam0)//Position - 0xED82
{
	*uParam0 = -1;
