...
{
	if (Global_63CF.f_1F < 10)
	{
		Global_63CF[Global_63CF.f_1F /*3*/] = { *iParam0 };
		Global_63CF.f_1F++;
		return 1;
	}
	return 0;
...
int func_4(int iParam0, var uParam1)//Position - 0xEA
{
	*uParam1 = 0;
	*uParam1 = 0;
	while (*uParam1 < Global_63CF.f_1F)
	{
		if (Global_63CF[*uParam1 /*3*/] == *iParam0 && Global_63CF[*uParam1 /*3*/].f_2 == iParam0->f_2)
		{
			return 1;
		}
		*uParam1++;
